...
public class ExtensionDeprecatedJDOMappingFactoryBeanDConfig extends BasicDConfigBean {
   ...
   public ExtensionDeprecatedJDOMappingFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ExtensionDeprecatedJDOMappingFactoryBean)btn;
      this.beanTree = btn;
