...
public class PersistenceMappingDefaultsBeanDConfig extends BasicDConfigBean {
   ...
   public PersistenceMappingDefaultsBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (PersistenceMappingDefaultsBean)btn;
      this.beanTree = btn;
