...
public class TableJDBCSeqBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private TableJDBCSeqBean beanTreeNode;

   public TableJDBCSeqBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (TableJDBCSeqBean)btn;
      this.beanTree = btn;
