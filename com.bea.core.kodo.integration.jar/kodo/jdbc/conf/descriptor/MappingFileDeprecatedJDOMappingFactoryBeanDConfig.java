...
public class MappingFileDeprecatedJDOMappingFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private MappingFileDeprecatedJDOMappingFactoryBean beanTreeNode;

   public MappingFileDeprecatedJDOMappingFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (MappingFileDeprecatedJDOMappingFactoryBean)btn;
      this.beanTree = btn;
   ...
   public boolean getSingleFile() {
      return this.beanTreeNode.getSingleFile();
   }

   public void setSingleFile(boolean value) {
      this.beanTreeNode.setSingleFile(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "SingleFile", (Object)null, (Object)null));
      this.setModified(true);
   }
   ...
   public String getFileName() {
      return this.beanTreeNode.getFileName();
   }

   public void setFileName(String value) {
      this.beanTreeNode.setFileName(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "FileName", (Object)null, (Object)null));
      this.setModified(true);
   }
