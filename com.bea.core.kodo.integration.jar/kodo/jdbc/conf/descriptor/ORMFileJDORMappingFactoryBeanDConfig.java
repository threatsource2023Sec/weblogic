...
public class ORMFileJDORMappingFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ORMFileJDORMappingFactoryBean beanTreeNode;

   public ORMFileJDORMappingFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ORMFileJDORMappingFactoryBean)btn;
      this.beanTree = btn;
