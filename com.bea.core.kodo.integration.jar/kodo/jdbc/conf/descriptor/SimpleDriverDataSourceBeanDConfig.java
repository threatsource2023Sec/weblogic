...
public class SimpleDriverDataSourceBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SimpleDriverDataSourceBean beanTreeNode;

   public SimpleDriverDataSourceBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (SimpleDriverDataSourceBean)btn;
      this.beanTree = btn;
