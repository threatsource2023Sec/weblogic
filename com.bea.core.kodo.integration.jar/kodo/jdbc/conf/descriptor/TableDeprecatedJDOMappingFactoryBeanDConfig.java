...
public class TableDeprecatedJDOMappingFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private TableDeprecatedJDOMappingFactoryBean beanTreeNode;

   public TableDeprecatedJDOMappingFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (TableDeprecatedJDOMappingFactoryBean)btn;
      this.beanTree = btn;
   ...
   public boolean getSingleRow() {
      return this.beanTreeNode.getSingleRow();
   }

   public void setSingleRow(boolean value) {
      this.beanTreeNode.setSingleRow(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "SingleRow", (Object)null, (Object)null));
      this.setModified(true);
   }
