...
public class DeprecatedJDOMappingDefaultsBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private DeprecatedJDOMappingDefaultsBean beanTreeNode;

   public DeprecatedJDOMappingDefaultsBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DeprecatedJDOMappingDefaultsBean)btn;
      this.beanTree = btn;
