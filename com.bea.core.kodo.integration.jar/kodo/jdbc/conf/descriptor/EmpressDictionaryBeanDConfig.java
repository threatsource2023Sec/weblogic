...
public class EmpressDictionaryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private EmpressDictionaryBean beanTreeNode;

   public EmpressDictionaryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (EmpressDictionaryBean)btn;
      this.beanTree = btn;
   ...
   public boolean getAllowConcurrentRead() {
      return this.beanTreeNode.getAllowConcurrentRead();
   }

   public void setAllowConcurrentRead(boolean value) {
      this.beanTreeNode.setAllowConcurrentRead(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "AllowConcurrentRead", (Object)null, (Object)null));
      this.setModified(true);
   }
