...
public class ClassTableJDBCSeqBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ClassTableJDBCSeqBean beanTreeNode;

   public ClassTableJDBCSeqBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ClassTableJDBCSeqBean)btn;
      this.beanTree = btn;
   ...
   public boolean getIgnoreVirtual() {
      return this.beanTreeNode.getIgnoreVirtual();
   }

   public void setIgnoreVirtual(boolean value) {
      this.beanTreeNode.setIgnoreVirtual(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "IgnoreVirtual", (Object)null, (Object)null));
      this.setModified(true);
   }

   public boolean getIgnoreUnmapped() {
      return this.beanTreeNode.getIgnoreUnmapped();
   }

   public void setIgnoreUnmapped(boolean value) {
      this.beanTreeNode.setIgnoreUnmapped(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "IgnoreUnmapped", (Object)null, (Object)null));
      this.setModified(true);
   }
   ...
   public boolean getUseAliases() {
      return this.beanTreeNode.getUseAliases();
   }

   public void setUseAliases(boolean value) {
      this.beanTreeNode.setUseAliases(value);
      this.firePropertyChange(new PropertyChangeEvent(this, "UseAliases", (Object)null, (Object)null));
      this.setModified(true);
   }
