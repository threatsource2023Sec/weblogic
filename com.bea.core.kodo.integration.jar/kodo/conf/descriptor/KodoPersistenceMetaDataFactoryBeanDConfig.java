...
public class KodoPersistenceMetaDataFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private KodoPersistenceMetaDataFactoryBean beanTreeNode;

   public KodoPersistenceMetaDataFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (KodoPersistenceMetaDataFactoryBean)btn;
      this.beanTree = btn;
