...
public class TangosolDataCacheBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private TangosolDataCacheBean beanTreeNode;

   public TangosolDataCacheBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (TangosolDataCacheBean)btn;
      this.beanTree = btn;
