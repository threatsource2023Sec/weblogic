...
public class PersistenceConfigurationPropertyBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private PersistenceConfigurationPropertyBean beanTreeNode;

   public PersistenceConfigurationPropertyBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (PersistenceConfigurationPropertyBean)btn;
      this.beanTree = btn;
