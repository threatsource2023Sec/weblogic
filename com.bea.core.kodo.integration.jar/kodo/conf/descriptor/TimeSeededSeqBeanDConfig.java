...
public class TimeSeededSeqBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private TimeSeededSeqBean beanTreeNode;

   public TimeSeededSeqBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (TimeSeededSeqBean)btn;
      this.beanTree = btn;
