...
public class DetachOptionsFetchGroupsBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private DetachOptionsFetchGroupsBean beanTreeNode;

   public DetachOptionsFetchGroupsBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DetachOptionsFetchGroupsBean)btn;
      this.beanTree = btn;
