...
public class VersionLockManagerBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private VersionLockManagerBean beanTreeNode;

   public VersionLockManagerBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (VersionLockManagerBean)btn;
      this.beanTree = btn;
