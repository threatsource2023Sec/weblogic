...
public class ExecutionContextNameProviderBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ExecutionContextNameProviderBean beanTreeNode;

   public ExecutionContextNameProviderBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ExecutionContextNameProviderBean)btn;
      this.beanTree = btn;
   ...
   public Class[] getExecutionContextNameProviderTypes() {
      return this.beanTreeNode.getExecutionContextNameProviderTypes();
   }

   public ExecutionContextNameProviderBean getExecutionContextNameProvider() {
      return this.beanTreeNode.getExecutionContextNameProvider();
   }
}
