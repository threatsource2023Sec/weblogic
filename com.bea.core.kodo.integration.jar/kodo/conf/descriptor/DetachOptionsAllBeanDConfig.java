...
public class DetachOptionsAllBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private DetachOptionsAllBean beanTreeNode;

   public DetachOptionsAllBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DetachOptionsAllBean)btn;
      this.beanTree = btn;
