...
public class DeprecatedJDOMetaDataFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private DeprecatedJDOMetaDataFactoryBean beanTreeNode;

   public DeprecatedJDOMetaDataFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DeprecatedJDOMetaDataFactoryBean)btn;
      this.beanTree = btn;
