...
public class LRUDataCacheBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private LRUDataCacheBean beanTreeNode;

   public LRUDataCacheBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (LRUDataCacheBean)btn;
      this.beanTree = btn;
