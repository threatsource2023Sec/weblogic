...
public class JDOMetaDataFactoryBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private JDOMetaDataFactoryBean beanTreeNode;

   public JDOMetaDataFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (JDOMetaDataFactoryBean)btn;
      this.beanTree = btn;
