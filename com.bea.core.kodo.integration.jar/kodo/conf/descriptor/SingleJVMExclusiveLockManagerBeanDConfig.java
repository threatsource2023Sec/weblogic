...
public class SingleJVMExclusiveLockManagerBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SingleJVMExclusiveLockManagerBean beanTreeNode;

   public SingleJVMExclusiveLockManagerBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (SingleJVMExclusiveLockManagerBean)btn;
      this.beanTree = btn;
