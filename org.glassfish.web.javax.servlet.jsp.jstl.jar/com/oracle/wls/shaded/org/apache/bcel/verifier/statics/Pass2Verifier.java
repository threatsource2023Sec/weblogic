...
import com.oracle.wls.shaded.org.apache.bcel.classfile.DescendingVisitor;
...
import com.oracle.wls.shaded.org.apache.bcel.verifier.VerifierFactory;
import com.oracle.wls.shaded.org.apache.bcel.verifier.exc.AssertionViolatedException;
import com.oracle.wls.shaded.org.apache.bcel.verifier.exc.ClassConstraintException;
...
public final class Pass2Verifier extends PassVerifier implements Constants {
   ...
   private class CPESSC_Visitor extends EmptyVisitor implements Visitor {
      ...
      private CPESSC_Visitor(JavaClass _jc) {
         ...
         this.CONST_Class = class$org$apache$bcel$classfile$ConstantClass == null ? (class$org$apache$bcel$classfile$ConstantClass = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantClass")) : class$org$apache$bcel$classfile$ConstantClass;
         this.CONST_Fieldref = class$org$apache$bcel$classfile$ConstantFieldref == null ? (class$org$apache$bcel$classfile$ConstantFieldref = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantFieldref")) : class$org$apache$bcel$classfile$ConstantFieldref;
         this.CONST_Methodref = class$org$apache$bcel$classfile$ConstantMethodref == null ? (class$org$apache$bcel$classfile$ConstantMethodref = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantMethodref")) : class$org$apache$bcel$classfile$ConstantMethodref;
         this.CONST_InterfaceMethodref = class$org$apache$bcel$classfile$ConstantInterfaceMethodref == null ? (class$org$apache$bcel$classfile$ConstantInterfaceMethodref = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantInterfaceMethodref")) : class$org$apache$bcel$classfile$ConstantInterfaceMethodref;
         this.CONST_String = class$org$apache$bcel$classfile$ConstantString == null ? (class$org$apache$bcel$classfile$ConstantString = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantString")) : class$org$apache$bcel$classfile$ConstantString;
         this.CONST_Integer = class$org$apache$bcel$classfile$ConstantInteger == null ? (class$org$apache$bcel$classfile$ConstantInteger = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantInteger")) : class$org$apache$bcel$classfile$ConstantInteger;
         this.CONST_Float = class$org$apache$bcel$classfile$ConstantFloat == null ? (class$org$apache$bcel$classfile$ConstantFloat = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantFloat")) : class$org$apache$bcel$classfile$ConstantFloat;
         this.CONST_Long = class$org$apache$bcel$classfile$ConstantLong == null ? (class$org$apache$bcel$classfile$ConstantLong = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantLong")) : class$org$apache$bcel$classfile$ConstantLong;
         this.CONST_Double = class$org$apache$bcel$classfile$ConstantDouble == null ? (class$org$apache$bcel$classfile$ConstantDouble = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantDouble")) : class$org$apache$bcel$classfile$ConstantDouble;
         this.CONST_NameAndType = class$org$apache$bcel$classfile$ConstantNameAndType == null ? (class$org$apache$bcel$classfile$ConstantNameAndType = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantNameAndType")) : class$org$apache$bcel$classfile$ConstantNameAndType;
         this.CONST_Utf8 = class$org$apache$bcel$classfile$ConstantUtf8 == null ? (class$org$apache$bcel$classfile$ConstantUtf8 = class$("com.oracle.wls.shaded.org.apache.bcel.classfile.ConstantUtf8")) : class$org$apache$bcel$classfile$ConstantUtf8;
