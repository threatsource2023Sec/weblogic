...
public class FuncSystemProperty extends FunctionOneArg {
   ...
   static final String XSLT_PROPERTIES = "com/oracle/wls/shaded/org/apache/xalan/res/XSLTInfo.properties";
   ...
   public XObject execute(XPathContext xctxt) throws TransformerException {
      ...
      this.loadPropertyFile("com/oracle/wls/shaded/org/apache/xalan/res/XSLTInfo.properties", xsltInfo);
      if (indexOfNSSep > 0) {
