...
public class RECompiler {
   ...
   int branch(int[] var1) throws RESyntaxException {
      int var2 = this.node('|', 0);
      int var3 = -1;
      int[] var4 = new int[1];

      boolean var5;
      int var6;
      for(var5 = true; this.idx < this.len && this.pattern.charAt(this.idx) != '|' && this.pattern.charAt(this.idx) != ')'; var3 = var6) {
         var4[0] = 0;
         var6 = this.closure(var4);
         if (var4[0] == 0) {
            var5 = false;
         }
   ...
   int characterClass() throws RESyntaxException {
                  ...
                  case 65533:
                     ...
                     switch (this.pattern.charAt(this.idx - 1)) {
                        ...
                        case 's':
                           ...
                           break;
                        case 'w':
                           var9.include(97, 122, var5);
                           var9.include(65, 90, var5);
                           var9.include('_', var5);
                        case 'd':
                           var9.include(48, 57, var5);
                     }
      ...
      ++this.idx;
      this.instruction[var1 + 1] = (char)var9.num;

      for(var10 = 0; var10 < var9.num; ++var10) {
         this.emit((char)var9.minRange[var10]);
         this.emit((char)var9.maxRange[var10]);
      }
