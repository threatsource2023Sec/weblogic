...
final class CopyOf extends Instruction {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      int cpy1 = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "copy", CPY1_SIG);
      String CPY2_SIG = "(I" + TRANSLET_OUTPUT_SIG + ")V";
      int cpy2 = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "copy", CPY2_SIG);
      String getDoc_SIG = "()I";
      int getDoc = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getDocument", "()I");
      if (tselect instanceof NodeSetType) {
         il.append(methodGen.loadDOM());
         this._select.translate(classGen, methodGen);
         this._select.startIterator(classGen, methodGen);
         il.append(methodGen.loadHandler());
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(cpy1, 3)));
      } else if (tselect instanceof NodeType) {
         il.append(methodGen.loadDOM());
         this._select.translate(classGen, methodGen);
         il.append(methodGen.loadHandler());
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(cpy2, 3)));
      } else if (tselect instanceof ResultTreeType) {
         this._select.translate(classGen, methodGen);
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(getDoc, 1)));
         il.append(methodGen.loadHandler());
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(cpy2, 3)));
         ...
         il.append(methodGen.loadDOM());
         int copy = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "copy", "(Ljava/lang/Object;" + TRANSLET_OUTPUT_SIG + "I" + "Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;" + ")V");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESTATIC(copy)));
      } else {
         il.append(classGen.loadTranslet());
         this._select.translate(classGen, methodGen);
         il.append(methodGen.loadHandler());
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEVIRTUAL(cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "characters", CHARACTERSW_SIG))));
      }
