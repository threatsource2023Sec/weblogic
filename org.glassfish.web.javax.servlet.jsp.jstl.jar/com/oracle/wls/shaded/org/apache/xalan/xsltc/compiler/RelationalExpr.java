...
final class RelationalExpr extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      if (!this.hasNodeSetArgs() && !this.hasReferenceArgs()) {
         ...
         int index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "compare", "(" + this._left.getType().toSignature() + this._right.getType().toSignature() + "I" + "Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;" + ")Z");
