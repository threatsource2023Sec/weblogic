...
import com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AttributeList;
...
public abstract class SyntaxTreeNode implements Constants {
   ...
   protected void compileResultTree(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      int index = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getResultTreeFrag", "(IIZ)Lorg/apache/xalan/xsltc/DOM;");
      ...
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(index, 4)));
      ...
      if (stylesheet.callsNodeset() && !DOM_CLASS.equals("com/oracle/wls/shaded/org/apache/xalan/xsltc/DOM")) {
         index = cpg.addMethodref("com/oracle/wls/shaded/org/apache/xalan/xsltc/dom/DOMAdapter", "<init>", "(Lorg/apache/xalan/xsltc/DOM;[Ljava/lang/String;[Ljava/lang/String;[I[Ljava/lang/String;)V");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new NEW(cpg.addClass("com/oracle/wls/shaded/org/apache/xalan/xsltc/dom/DOMAdapter"))));
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new DUP_X1()));
         ...
         if (!stylesheet.callsNodeset()) {
            ...
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "namesArray", "[Ljava/lang/String;"))));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)ALOAD_0);
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "urisArray", "[Ljava/lang/String;"))));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)ALOAD_0);
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "typesArray", "[I"))));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)ALOAD_0);
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "namespaceArray", "[Ljava/lang/String;"))));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESPECIAL(index)));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
            il.append(methodGen.loadDOM());
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new CHECKCAST(cpg.addClass(classGen.getDOMClass()))));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)SWAP);
            index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.dom.MultiDOM", "addDOMAdapter", "(Lorg/apache/xalan/xsltc/dom/DOMAdapter;)I");
