...
import com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler.util.NamedMethodGenerator;
...
final class Mode implements Constants {
   ...
   private void compileNamedTemplate(Template template, ClassGenerator classGen) {
      ...
      types[0] = Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;");
      types[1] = Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;");
   ...
   public static void compileGetChildren(ClassGenerator classGen, MethodGenerator methodGen, int node) {
      ...
      int git = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getChildren", "(I)Lorg/apache/xml/dtm/DTMAxisIterator;");
      il.append(methodGen.loadDOM());
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(node)));
   ...
   private InstructionList compileDefaultRecursion(ClassGenerator classGen, MethodGenerator methodGen, InstructionHandle next) {
      ...
      il.append(methodGen.loadDOM());
      il.append(methodGen.loadDOM());
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(this._currentIndex)));
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(git, 2)));
   ...
   private InstructionList compileDefaultText(ClassGenerator classGen, MethodGenerator methodGen, InstructionHandle next) {
      ConstantPoolGen cpg = classGen.getConstantPool();
      InstructionList il = new InstructionList();
      int chars = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "characters", CHARACTERS_SIG);
      il.append(methodGen.loadDOM());
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(this._currentIndex)));
      il.append(methodGen.loadHandler());
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(chars, 3)));
      il.append((BranchInstruction)(new GOTO_W(next)));
      return il;
   }
   ...
   private InstructionList compileNamespaces(ClassGenerator classGen, MethodGenerator methodGen, boolean[] isNamespace, boolean[] isAttribute, boolean attrFlag, InstructionHandle defaultTarget) {
      ...
      if (namespaceCount <= 0) {
         ...
         if (!compiled) {
            ...
            i = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getNamespaceType", "(I)I");
            il.append(methodGen.loadDOM());
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(this._currentIndex)));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(i, 2)));
   ...
   public void compileApplyTemplates(ClassGenerator classGen) {
      ...
      ConstantPoolGen cpg = classGen.getConstantPool();
      Vector names = xsltc.getNamesIndex();
      Type[] argTypes = new Type[]{Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;"), Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;"), Util.getJCRefType(TRANSLET_OUTPUT_SIG)};
      ...
      methodGen.addException("com.oracle.wls.shaded.org.apache.xalan.xsltc.TransletException");
      mainIL.append(NOP);
      ...
      ilLoop.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
      ilLoop.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ISTORE(this._currentIndex)));
      ...
      ifeq.setTarget(ilLoop.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)RETURN));
      ...
      i = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getExpandedTypeID", "(I)I");
      body.append(methodGen.loadDOM());
      body.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(this._currentIndex)));
      body.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(i, 2)));
   ...
   public void compileApplyImports(ClassGenerator classGen, int min, int max) {
      ...
      Type[] argTypes = new Type[]{Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;"), Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;"), Util.getJCRefType(TRANSLET_OUTPUT_SIG), Type.INT};
      ...
      LocalVariableGen current = methodGen.addLocalVariable2("current", Type.INT, (InstructionHandle)null);
      this._currentIndex = current.getIndex();
      mainIL.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ILOAD(methodGen.getLocalIndex("node"))));
      current.setStart(mainIL.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new ISTORE(this._currentIndex))));
      InstructionList body = new InstructionList();
      body.append(NOP);
      InstructionList ilLoop = new InstructionList();
      ilLoop.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)RETURN);
      InstructionHandle ihLoop = ilLoop.getStart();
      InstructionList ilRecurse = this.compileDefaultRecursion(classGen, methodGen, ihLoop);
      InstructionHandle ihRecurse = ilRecurse.getStart();
      InstructionList ilText = this.compileDefaultText(classGen, methodGen, ihLoop);
      ...
      while(iter.hasNext()) {
         ...
         try {
            if (!match[0].hasTargeters() && !match[1].hasTargeters() && !match[2].hasTargeters()) {
               com.oracle.wls.shaded.org.apache.bcel.generic.Instruction load_m = match[1].getInstruction();
         ...
         try {
            if (!match[1].hasTargeters()) {
               ...
               if (aload1.getIndex() == aload2.getIndex()) {
                  il.insert((InstructionHandle)match[1], (com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new DUP()));
                  il.delete(match[1]);
               }
            }
         } catch (TargetLostException var10) {
         }
      }
