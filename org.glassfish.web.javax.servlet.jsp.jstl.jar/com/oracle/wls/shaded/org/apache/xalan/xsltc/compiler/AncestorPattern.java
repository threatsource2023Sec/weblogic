...
final class AncestorPattern extends RelativePathPattern {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (this._right instanceof StepPattern) {
         ...
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)storeLocal);
         this._right.translate(classGen, methodGen);
         il.append(methodGen.loadDOM());
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)loadLocal);
      } else {
         this._right.translate(classGen, methodGen);
      ...
      if (this._left != null) {
         ...
         InstructionHandle parent = il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(getParent, 2)));
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)storeLocal);
         ...
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)POP2);
      }
