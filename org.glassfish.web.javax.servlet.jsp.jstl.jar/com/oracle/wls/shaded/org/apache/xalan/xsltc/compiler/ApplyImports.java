...
final class ApplyImports extends Instruction {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (stylesheet.hasLocalParams()) {
         il.append(classGen.loadTranslet());
         maxPrecedence = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "pushParamFrame", "()V");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEVIRTUAL(maxPrecedence)));
      }
      ...
      if (stylesheet.hasLocalParams()) {
         il.append(classGen.loadTranslet());
         int pushFrame = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "popParamFrame", "()V");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEVIRTUAL(pushFrame)));
      }
