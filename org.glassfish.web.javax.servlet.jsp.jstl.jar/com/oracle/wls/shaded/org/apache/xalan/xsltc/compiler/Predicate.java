...
import com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler.util.NumberType;
...
final class Predicate extends Expression implements Closure {
   ...
   private void compileFilter(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      FilterGenerator filterGen = new FilterGenerator(this._className, "java.lang.Object", this.toString(), 33, new String[]{"com.oracle.wls.shaded.org.apache.xalan.xsltc.dom.CurrentNodeListFilter"}, classGen.getStylesheet());
      ...
      for(int i = 0; i < length; ++i) {
         ...
         filterGen.addField(new Field(1, cpg.addUtf8(var.getEscapedName()), cpg.addUtf8(var.getType().toSignature()), (com.oracle.wls.shaded.org.apache.bcel.classfile.Attribute[])null, cpg.getConstantPool()));
      }

      InstructionList il = new InstructionList();
      TestGenerator testGen = new TestGenerator(17, com.oracle.wls.shaded.org.apache.bcel.generic.Type.BOOLEAN, new com.oracle.wls.shaded.org.apache.bcel.generic.Type[]{com.oracle.wls.shaded.org.apache.bcel.generic.Type.INT, com.oracle.wls.shaded.org.apache.bcel.generic.Type.INT, com.oracle.wls.shaded.org.apache.bcel.generic.Type.INT, com.oracle.wls.shaded.org.apache.bcel.generic.Type.INT, Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/runtime/AbstractTranslet;"), Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;")}, new String[]{"node", "position", "last", "current", "translet", "iterator"}, "test", this._className, il, cpg);
      LocalVariableGen local = testGen.addLocalVariable("document", Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;"), (InstructionHandle)null, (InstructionHandle)null);
      String className = classGen.getClassName();
      il.append(filterGen.loadTranslet());
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new CHECKCAST(cpg.addClass(className))));
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref(className, "_dom", "Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;"))));
   ...
   public void translateFilter(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESPECIAL(cpg.addMethodref(this._className, "<init>", "()V"))));
      int length = this._closureVars == null ? 0 : this._closureVars.size();
      ...
      for(int i = 0; i < length; ++i) {
         ...
         if (variableClosure != null) {
            ...
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new GETFIELD(cpg.addFieldref(variableClosure.getInnerClassName(), var.getEscapedName(), varType.toSignature()))));
         } else {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._nthPositionFilter && !this._nthDescendant) {
         if (this.isNodeValueTest() && this.getParent() instanceof Step) {
            ...
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new CHECKCAST(cpg.addClass("java.lang.String"))));
