...
public class XPathFunctionResolverImpl implements XPathFunctionResolver {
   ...
   private String getEXSLTClassName(String uri) {
      if (uri.equals("http://exslt.org/math")) {
         return "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltMath";
      } else if (uri.equals("http://exslt.org/sets")) {
         return "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltSets";
      } else if (uri.equals("http://exslt.org/strings")) {
         return "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltStrings";
      } else if (uri.equals("http://exslt.org/dates-and-times")) {
         return "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltDatetime";
      } else if (uri.equals("http://exslt.org/dynamic")) {
         return "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltDynamic";
      } else {
         return uri.equals("http://exslt.org/common") ? "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltCommon" : null;
      }
   }
}
