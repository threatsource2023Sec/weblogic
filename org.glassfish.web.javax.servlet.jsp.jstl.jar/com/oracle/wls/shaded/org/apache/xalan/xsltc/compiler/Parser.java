...
public class Parser implements Constants, ContentHandler {
   ...
   private void initStdClass(String elementName, String className) {
      this._instructionClasses.put(this.getQName("http://www.w3.org/1999/XSL/Transform", "xsl", elementName), "com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler." + className);
   }
   ...
   private void initExtClass(String elementName, String className) {
      this._instructionClasses.put(this.getQName("http://xml.apache.org/xalan/xsltc", "translet", elementName), "com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler." + className);
   }

   private void initExtClass(String namespace, String elementName, String className) {
      this._instructionClasses.put(this.getQName(namespace, "translet", elementName), "com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler." + className);
   }
