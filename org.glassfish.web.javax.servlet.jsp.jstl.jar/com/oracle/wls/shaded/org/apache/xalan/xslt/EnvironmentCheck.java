...
public class EnvironmentCheck {
   ...
   protected void checkProcessorVersion(Hashtable h) {
      ...
      Field f;
      try {
         XALAN2_2_VERSION_CLASS = "com.oracle.wls.shaded.org.apache.xalan.xslt.XSLProcessorVersion";
         clazz = ObjectFactory.findProviderClass("com.oracle.wls.shaded.org.apache.xalan.xslt.XSLProcessorVersion", ObjectFactory.findClassLoader(), true);
      ...
      try {
         XALAN2_2_VERSION_CLASS = "com.oracle.wls.shaded.org.apache.xalan.processor.XSLProcessorVersion";
         clazz = ObjectFactory.findProviderClass("com.oracle.wls.shaded.org.apache.xalan.processor.XSLProcessorVersion", ObjectFactory.findClassLoader(), true);
         buf = new StringBuffer();
         f = clazz.getField("S_VERSION");
         buf.append(f.get((Object)null));
      ...
      try {
         XALAN2_2_VERSION_CLASS = "com.oracle.wls.shaded.org.apache.xalan.Version";
         String XALAN2_2_VERSION_METHOD = "getVersion";
         Class[] noArgs = new Class[0];
         Class clazz = ObjectFactory.findProviderClass("com.oracle.wls.shaded.org.apache.xalan.Version", ObjectFactory.findClassLoader(), true);
