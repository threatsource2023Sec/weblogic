...
import com.oracle.wls.shaded.org.apache.xalan.extensions.ExpressionVisitor;
...
import com.oracle.wls.shaded.org.apache.xml.utils.NamespaceSupport2;
import com.oracle.wls.shaded.org.apache.xml.utils.NodeConsumer;
...
import com.oracle.wls.shaded.org.apache.xml.utils.XMLCharacterRecognizer;
...
public class StylesheetHandler extends DefaultHandler implements TemplatesHandler, PrefixResolver, NodeConsumer {
   ...
   public StylesheetHandler(TransformerFactoryImpl processor) throws TransformerConfigurationException {
      Class func = class$org$apache$xalan$templates$FuncDocument == null ? (class$org$apache$xalan$templates$FuncDocument = class$("com.oracle.wls.shaded.org.apache.xalan.templates.FuncDocument")) : class$org$apache$xalan$templates$FuncDocument;
      this.m_funcTable.installFunction("document", func);
      func = class$org$apache$xalan$templates$FuncFormatNumb == null ? (class$org$apache$xalan$templates$FuncFormatNumb = class$("com.oracle.wls.shaded.org.apache.xalan.templates.FuncFormatNumb")) : class$org$apache$xalan$templates$FuncFormatNumb;
   ...
   public void processingInstruction(String target, String data) throws SAXException {
      if (this.m_shouldProcess) {
         ...
         try {
            if ("xalan-doc-cache-off".equals(target) || "xalan:doc-cache-off".equals(target) || "doc-cache-off".equals(localName) && ns.equals("com.oracle.wls.shaded.org.apache.xalan.xslt.extensions.Redirect")) {
