...
import com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler.util.MethodType;
...
class FunctionCall extends Expression {
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this.isStandard() && !this.isExtension()) {
         if (this.unresolvedExternal) {
            index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "unresolved_externalF", "(Ljava/lang/String;)V");
            ...
            if (this._isExtConstructor) {
               ...
               il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)InstructionConstants.DUP);
               ...
               if (this._thisArgument != null && this._clazz.isInterface()) {
                  ...
                  il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKEINTERFACE(index, n + 1)));
               } else {
                  index = cpg.addMethodref(clazz, this._fname.getLocalPart(), buffer.toString());
                  il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(this._thisArgument != null ? new INVOKEVIRTUAL(index) : new INVOKESTATIC(index)));
               }
         ...
         if (clazz.equals("sumF")) {
            args = "Lcom/oracle/wls/shaded/org/apache/xalan/xsltc/DOM;";
         ...
         index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", clazz, this._chosenMethodType.toSignature(args));
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESTATIC(index)));
      }
   ...
   private void translateUnallowedExtension(ConstantPoolGen cpg, InstructionList il) {
      int index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "unallowed_extension_functionF", "(Ljava/lang/String;)V");
      il.append((CompoundInstruction)(new PUSH(cpg, this._fname.toString())));
      il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESTATIC(index)));
   }
   ...
   static {
      try {
         ...
         _extensionNamespaceTable.put("http://xml.apache.org/xalan", "com.oracle.wls.shaded.org.apache.xalan.lib.Extensions");
         _extensionNamespaceTable.put("http://exslt.org/common", "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltCommon");
         _extensionNamespaceTable.put("http://exslt.org/math", "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltMath");
         _extensionNamespaceTable.put("http://exslt.org/sets", "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltSets");
         _extensionNamespaceTable.put("http://exslt.org/dates-and-times", "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltDatetime");
         _extensionNamespaceTable.put("http://exslt.org/strings", "com.oracle.wls.shaded.org.apache.xalan.lib.ExsltStrings");
