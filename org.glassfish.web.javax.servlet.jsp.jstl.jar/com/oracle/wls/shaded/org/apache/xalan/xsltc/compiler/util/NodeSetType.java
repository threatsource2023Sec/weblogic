...
public final class NodeSetType extends Type {
   ...
   public String toSignature() {
      return "Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;";
   }

   public com.oracle.wls.shaded.org.apache.bcel.generic.Type toJCType() {
      return new com.oracle.wls.shaded.org.apache.bcel.generic.ObjectType("com.oracle.wls.shaded.org.apache.xml.dtm.DTMAxisIterator");
   }
   ...
   public void translateFrom(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
      ...
      if (clazz.getName().equals("org.w3c.dom.NodeList")) {
         ...
         convert = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "nodeList2Iterator", "(Lorg/w3c/dom/NodeList;Lorg/apache/xalan/xsltc/Translet;Lorg/apache/xalan/xsltc/DOM;)Lorg/apache/xml/dtm/DTMAxisIterator;");
         il.append((Instruction)(new INVOKESTATIC(convert)));
      } else if (clazz.getName().equals("org.w3c.dom.Node")) {
         il.append(classGen.loadTranslet());
         il.append(methodGen.loadDOM());
         convert = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "node2Iterator", "(Lorg/w3c/dom/Node;Lorg/apache/xalan/xsltc/Translet;Lorg/apache/xalan/xsltc/DOM;)Lorg/apache/xml/dtm/DTMAxisIterator;");
         il.append((Instruction)(new INVOKESTATIC(convert)));
      } else {
   ...
   public void translateTo(ClassGenerator classGen, MethodGenerator methodGen, Class clazz) {
      ...
      if (className.equals("org.w3c.dom.Node")) {
         next = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "makeNode", "(Lorg/apache/xml/dtm/DTMAxisIterator;)Lorg/w3c/dom/Node;");
         ...
         if (className.equals("java.lang.String")) {
            next = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xml.dtm.DTMAxisIterator", "next", "()I");
            int index = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "getStringValueX", "(I)Ljava/lang/String;");
         ...
         next = cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.DOM", "makeNodeList", "(Lorg/apache/xml/dtm/DTMAxisIterator;)Lorg/w3c/dom/NodeList;");
         il.append((Instruction)(new INVOKEINTERFACE(next, 2)));
      }
   ...
   private void getFirstNode(ClassGenerator classGen, MethodGenerator methodGen) {
      ConstantPoolGen cpg = classGen.getConstantPool();
      InstructionList il = methodGen.getInstructionList();
      il.append((Instruction)(new INVOKEINTERFACE(cpg.addInterfaceMethodref("com.oracle.wls.shaded.org.apache.xml.dtm.DTMAxisIterator", "next", "()I"), 1)));
   }
   ...
   public String getClassName() {
      return "com.oracle.wls.shaded.org.apache.xml.dtm.DTMAxisIterator";
   }
