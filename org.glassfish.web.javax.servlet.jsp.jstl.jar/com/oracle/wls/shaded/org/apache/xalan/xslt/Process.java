package com.oracle.wls.shaded.org.apache.xalan.xslt;

import com.oracle.wls.shaded.org.apache.xalan.Version;
...
public class Process {
   ...
   public static void main(String[] argv) {
      ...
      ResourceBundle resbundle = XSLMessages.loadResourceBundle("com.oracle.wls.shaded.org.apache.xalan.res.XSLTErrorResources");
      String flavor = "s2s";
      if (argv.length < 1) {
         ...
         if (useXSLTC) {
            ...
            String value = "com.oracle.wls.shaded.org.apache.xalan.xsltc.trax.TransformerFactoryImpl";
         ...
         } catch (TransformerFactoryConfigurationError var70) {
            var70.printStackTrace(diagnosticsWriter);
            ...
            if (!"-XSLTC".equalsIgnoreCase(argv[i])) {
               if ("-TT".equalsIgnoreCase(argv[i])) {
                  ...
                  if (i + 1 < argv.length && argv[i + 1].charAt(0) != '-') {
                     ++i;
                     int var77 = Integer.parseInt(argv[i]);
                  } else {
                     boolean var76 = false;
                  }
                  ...
                  if ("-V".equalsIgnoreCase(argv[i])) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var69) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var68) {
                     ...
                     if (i + 1 < argv.length) {
                        ...
                        } catch (ObjectFactory.ConfigurationError var67) {
                     ...
                     } catch (TransformerConfigurationException var66) {
                     }
                  } else {
         ...
         try {
            ...
            if (null != xslFileName) {
               if (flavor.equals("d2d")) {
                  ...
                  if (isSecureProcessing) {
                     ...
                     } catch (ParserConfigurationException var65) {
                     }
                  }
                  ...
                  if (flavor.equals("d2d")) {
                     ...
                     for(i = 0; i < 1; ++i) {
                        ...
                        try {
                           ...
                           throw new SAXException(var60);
                        } catch (FactoryConfigurationError var61) {
                           throw new SAXException(var61.toString());
                        } catch (NoSuchMethodError var62) {
                        } catch (AbstractMethodError var63) {
                        }
                        ...
                        } catch (SAXNotRecognizedException var57) {
                        } catch (SAXNotSupportedException var58) {
                        }
                     ...
                     } catch (FactoryConfigurationError var53) {
                        throw new SAXException(var53.toString());
                     } catch (NoSuchMethodError var54) {
                     } catch (AbstractMethodError var55) {
                     }
            ...
            Object throwable;
            for(throwable = var71; throwable instanceof WrappedRuntimeException; throwable = ((WrappedRuntimeException)throwable).getException()) {
            }
