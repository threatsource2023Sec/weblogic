...
import com.oracle.wls.shaded.org.apache.xpath.objects.XRTreeFrag;
...
public class MethodResolver {
   ...
   public static Constructor getConstructor(Class classObj, Object[] argsIn, Object[][] argsOut, ExpressionContext exprContext) throws NoSuchMethodException, SecurityException, TransformerException {
      ...
      for(int i = 0; i < nMethods; ++i) {
         ...
         if (numberMethodParams == argsIn.length + 1) {
            ...
            if (!(class$org$apache$xalan$extensions$ExpressionContext == null ? (class$org$apache$xalan$extensions$ExpressionContext = class$("com.oracle.wls.shaded.org.apache.xalan.extensions.ExpressionContext")) : class$org$apache$xalan$extensions$ExpressionContext).isAssignableFrom(javaClass)) {
               continue;
            }
   ...
   public static Method getElementMethod(Class classObj, String name) throws NoSuchMethodException, SecurityException, TransformerException {
      ...
      for(int i = 0; i < nMethods; ++i) {
         ...
         if (method.getName().equals(name)) {
            Class[] paramTypes = method.getParameterTypes();
            if (paramTypes.length == 2 && paramTypes[1].isAssignableFrom(class$org$apache$xalan$templates$ElemExtensionCall == null ? (class$org$apache$xalan$templates$ElemExtensionCall = class$("com.oracle.wls.shaded.org.apache.xalan.templates.ElemExtensionCall")) : class$org$apache$xalan$templates$ElemExtensionCall) && paramTypes[0].isAssignableFrom(class$org$apache$xalan$extensions$XSLProcessorContext == null ? (class$org$apache$xalan$extensions$XSLProcessorContext = class$("com.oracle.wls.shaded.org.apache.xalan.extensions.XSLProcessorContext")) : class$org$apache$xalan$extensions$XSLProcessorContext)) {
               ++bestScoreCount;
               if (bestScoreCount != 1) {
                  break;
               }
   ...
   public static void convertParams(Object[] argsIn, Object[][] argsOut, Class[] paramTypes, ExpressionContext exprContext) throws TransformerException {
      if (paramTypes == null) {
         ...
         int paramIndex = 0;
         if (nParams > 0 && (class$org$apache$xalan$extensions$ExpressionContext == null ? (class$org$apache$xalan$extensions$ExpressionContext = class$("com.oracle.wls.shaded.org.apache.xalan.extensions.ExpressionContext")) : class$org$apache$xalan$extensions$ExpressionContext).isAssignableFrom(paramTypes[0])) {
   ...
   private static String errString(String callType, String searchType, Class classObj, String funcName, int searchMethod, Object[] xsltArgs) {
      ...
      switch (searchMethod) {
         ...
         default:
            return callType.equals("function") ? resultString + classObj.getName() + "([ExpressionContext,] " + errArgs(xsltArgs, 0) + ")." : resultString + classObj.getName() + "." + funcName + "(org.apache.xalan.extensions.XSLProcessorContext, " + "com.oracle.wls.shaded.org.apache.xalan.templates.ElemExtensionCall).";
      }
   }
