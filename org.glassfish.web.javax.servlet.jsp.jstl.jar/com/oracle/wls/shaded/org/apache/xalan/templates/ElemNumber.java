...
import com.oracle.wls.shaded.org.apache.xalan.transformer.CountersTable;
import com.oracle.wls.shaded.org.apache.xalan.transformer.DecimalToRoman;
...
import com.oracle.wls.shaded.org.apache.xml.utils.res.CharArrayWrapper;
import com.oracle.wls.shaded.org.apache.xml.utils.res.IntArrayWrapper;
import com.oracle.wls.shaded.org.apache.xml.utils.res.LongArrayWrapper;
import com.oracle.wls.shaded.org.apache.xml.utils.res.StringArrayWrapper;
      ...
      switch (numberType) {
         case 'A':
            if (null == this.m_alphaCountTable) {
               thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", this.getLocale(transformer, contextNode));
         ...
         case 'i':
            ...
            break;
         case 'α':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("el", ""));
            ...
            break;
         case 'а':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("cy", ""));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
            ...
            break;
         case 'א':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("he", ""));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
            ...
            break;
         case '๑':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("th", ""));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
            ...
            break;
         case 'ა':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("ka", ""));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
            ...
            break;
         case 'あ':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("ja", "JP", "HA"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
            ...
            break;
         case 'い':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("ja", "JP", "HI"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               formattedNumber.append(this.int2singlealphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet")));
            ...
            break;
         case 'ア':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("ja", "JP", "A"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               formattedNumber.append(this.int2singlealphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet")));
            ...
            break;
         case 'イ':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("ja", "JP", "I"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               formattedNumber.append(this.int2singlealphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet")));
            ...
            break;
         case '一':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("zh", "CN"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
            ...
            break;
         case '壹':
            thisBundle = XResourceBundle.loadResourceBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResources", new Locale("zh", "TW"));
            if (letterVal != null && letterVal.equals("traditional")) {
               formattedNumber.append(this.tradAlphaCount(listElement, thisBundle));
            } else {
               this.int2alphaCount(listElement, (CharArrayWrapper)thisBundle.getObject("alphabet"), formattedNumber);
