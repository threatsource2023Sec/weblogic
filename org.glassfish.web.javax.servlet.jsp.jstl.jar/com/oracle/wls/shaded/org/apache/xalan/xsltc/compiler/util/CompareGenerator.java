...
public final class CompareGenerator extends MethodGenerator {
   ...
   public CompareGenerator(int access_flags, com.oracle.wls.shaded.org.apache.bcel.generic.Type return_type, com.oracle.wls.shaded.org.apache.bcel.generic.Type[] arg_types, String[] arg_names, String method_name, String class_name, InstructionList il, ConstantPoolGen cp) {
      ...
      LocalVariableGen iterator = this.addLocalVariable("iterator", Util.getJCRefType("Lcom/oracle/wls/shaded/org/apache/xml/dtm/DTMAxisIterator;"), (InstructionHandle)null, (InstructionHandle)null);
