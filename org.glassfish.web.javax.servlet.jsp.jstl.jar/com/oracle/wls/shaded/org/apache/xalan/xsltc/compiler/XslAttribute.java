   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      ...
      if (!this._ignore) {
         ...
         if (!this._isLiteral) {
            ...
            flags = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.BasisLibrary", "checkAttribQName", "(Ljava/lang/String;)V");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new INVOKESTATIC(flags)));
            il.append(methodGen.loadHandler());
