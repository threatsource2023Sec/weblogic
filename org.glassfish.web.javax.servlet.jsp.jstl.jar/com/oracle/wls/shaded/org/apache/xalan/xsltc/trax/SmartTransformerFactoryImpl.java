...
public class SmartTransformerFactoryImpl extends SAXTransformerFactory {
   ...
   private void createXalanTransformerFactory() {
      String xalanMessage = "com.oracle.wls.shaded.org.apache.xalan.xsltc.trax.SmartTransformerFactoryImpl could not create an org.apache.xalan.processor.TransformerFactoryImpl.";

      try {
         Class xalanFactClass = ObjectFactory.findProviderClass("com.oracle.wls.shaded.org.apache.xalan.processor.TransformerFactoryImpl", ObjectFactory.findClassLoader(), true);
         this._xalanFactory = (SAXTransformerFactory)xalanFactClass.newInstance();
      } catch (ClassNotFoundException var3) {
         System.err.println("com.oracle.wls.shaded.org.apache.xalan.xsltc.trax.SmartTransformerFactoryImpl could not create an org.apache.xalan.processor.TransformerFactoryImpl.");
