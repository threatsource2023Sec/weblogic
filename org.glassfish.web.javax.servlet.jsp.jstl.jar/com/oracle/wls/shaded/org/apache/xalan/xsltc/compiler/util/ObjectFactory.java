...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xalan$xsltc$compiler$util$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$util$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler.util.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$util$ObjectFactory) {
   ...
   static ClassLoader findClassLoader() throws ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xalan$xsltc$compiler$util$ObjectFactory == null ? (class$org$apache$xalan$xsltc$compiler$util$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xalan.xsltc.compiler.util.ObjectFactory")) : class$org$apache$xalan$xsltc$compiler$util$ObjectFactory).getClassLoader();
