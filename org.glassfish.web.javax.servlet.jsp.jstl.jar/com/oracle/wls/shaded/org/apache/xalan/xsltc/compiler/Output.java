...
import com.oracle.wls.shaded.org.apache.xml.serializer.Encodings;
   ...
   public void translate(ClassGenerator classGen, MethodGenerator methodGen) {
      if (!this._disabled) {
         ...
         if (this._version != null && !this._version.equals("1.0")) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_version", "Ljava/lang/String;");
            ...
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new PUTFIELD(field)));
         }

         if (this._method != null) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_method", "Ljava/lang/String;");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._encoding != null) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_encoding", "Ljava/lang/String;");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._omitHeader) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_omitHeader", "Z");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._standalone != null) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_standalone", "Ljava/lang/String;");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
            il.append((CompoundInstruction)(new PUSH(cpg, this._standalone)));
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new PUTFIELD(field)));
         }

         field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_doctypeSystem", "Ljava/lang/String;");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         il.append((CompoundInstruction)(new PUSH(cpg, this._doctypeSystem)));
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new PUTFIELD(field)));
         field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_doctypePublic", "Ljava/lang/String;");
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         il.append((CompoundInstruction)(new PUSH(cpg, this._doctypePublic)));
         il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)(new PUTFIELD(field)));
         if (this._mediaType != null) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_mediaType", "Ljava/lang/String;");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._indent) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_indent", "Z");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._indentamount != null && !this._indentamount.equals("")) {
            field = cpg.addFieldref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "_indentamount", "I");
            il.append((com.oracle.wls.shaded.org.apache.bcel.generic.Instruction)DUP);
         ...
         if (this._cdata != null) {
            int index = cpg.addMethodref("com.oracle.wls.shaded.org.apache.xalan.xsltc.runtime.AbstractTranslet", "addCdataElement", "(Ljava/lang/String;)V");
