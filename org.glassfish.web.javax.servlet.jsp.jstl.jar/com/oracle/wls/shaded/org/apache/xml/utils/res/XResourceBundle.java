package com.oracle.wls.shaded.org.apache.xml.utils.res;
...
public class XResourceBundle extends ListResourceBundle {
   public static final String ERROR_RESOURCES = "com.oracle.wls.shaded.org.apache.xalan.res.XSLTErrorResources";
   public static final String XSLT_RESOURCE = "com.oracle.wls.shaded.org.apache.xml.utils.res.XResourceBundle";
   public static final String LANG_BUNDLE_NAME = "com.oracle.wls.shaded.org.apache.xml.utils.res.XResources";
   ...
   public static final XResourceBundle loadResourceBundle(String className, Locale locale) throws MissingResourceException {
      ...
      try {
         ...
         try {
            return (XResourceBundle)ResourceBundle.getBundle("com.oracle.wls.shaded.org.apache.xml.utils.res.XResourceBundle", new Locale("en", "US"));
