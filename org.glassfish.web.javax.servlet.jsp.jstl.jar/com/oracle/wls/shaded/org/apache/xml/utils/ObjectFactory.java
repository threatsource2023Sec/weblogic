...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xml$utils$ObjectFactory == null ? (class$org$apache$xml$utils$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xml.utils.ObjectFactory")) : class$org$apache$xml$utils$ObjectFactory) {
   ...
   static ClassLoader findClassLoader() throws ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xml$utils$ObjectFactory == null ? (class$org$apache$xml$utils$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xml.utils.ObjectFactory")) : class$org$apache$xml$utils$ObjectFactory).getClassLoader();
