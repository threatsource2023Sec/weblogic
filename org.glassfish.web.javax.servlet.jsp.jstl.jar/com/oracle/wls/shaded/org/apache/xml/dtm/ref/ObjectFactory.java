...
final class ObjectFactory {
   ...
   static String lookUpFactoryClassName(String factoryId, String propertiesFilename, String fallbackClassName) {
      ...
      if (propertiesFilename == null) {
         ...
         synchronized(class$org$apache$xml$dtm$ref$ObjectFactory == null ? (class$org$apache$xml$dtm$ref$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory) {
   ...
   static ClassLoader findClassLoader() throws ConfigurationError {
      ...
      ClassLoader current = (class$org$apache$xml$dtm$ref$ObjectFactory == null ? (class$org$apache$xml$dtm$ref$ObjectFactory = class$("com.oracle.wls.shaded.org.apache.xml.dtm.ref.ObjectFactory")) : class$org$apache$xml$dtm$ref$ObjectFactory).getClassLoader();
