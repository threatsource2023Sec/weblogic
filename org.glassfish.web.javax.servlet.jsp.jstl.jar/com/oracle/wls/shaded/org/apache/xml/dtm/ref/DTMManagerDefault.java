...
import com.oracle.wls.shaded.org.apache.xml.dtm.ref.dom2dtm.DOM2DTM;
import com.oracle.wls.shaded.org.apache.xml.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode;
import com.oracle.wls.shaded.org.apache.xml.dtm.ref.sax2dtm.SAX2DTM;
         ...
         if (!isSAXSource && !isStreamSource) {
            ...
            try {
               ...
               if (this.m_incremental && incremental) {
                  ...
                  if (haveXercesParser) {
                     try {
                        coParser = (IncrementalSAXSource)Class.forName("com.oracle.wls.shaded.org.apache.xml.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
