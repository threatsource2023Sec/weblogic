...
public class ClientTLSValidationConfigurationCriterion implements Criterion {
   ...
   public ClientTLSValidationConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty List configurations) {
   ...
   public ClientTLSValidationConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty ClientTLSValidationConfiguration... configurations) {
      Constraint.isNotNull(configurations, "List of configurations cannot be null");
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof ClientTLSValidationConfigurationCriterion ? this.configs.equals(((ClientTLSValidationConfigurationCriterion)obj).getConfigurations()) : false;
      }
   }
}
