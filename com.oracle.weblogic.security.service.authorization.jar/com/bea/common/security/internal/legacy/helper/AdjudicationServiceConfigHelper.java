...
class AdjudicationServiceConfigHelper {
   static String getServiceName(RealmMBean realmMBean) {
      return AdjudicationServiceConfigHelper.class.getName() + "_" + realmMBean.getName();
   }
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, String lifecycleImplLoaderName, RealmMBean realmMBean, String serviceName) {
      ...
      if (providerMBean != null) {
         AdjudicationProviderConfigHelper.addToConfig(serviceEngineConfig, lifecycleImplLoaderName, providerMBean);
      }
      ...
      if (providerMBean != null) {
         faceName = AdjudicationProviderConfigHelper.getServiceName(providerMBean);
   ...
   private static String getImplName() {
      return "com.bea.common.security.internal.service.AdjudicationServiceImpl";
   }
