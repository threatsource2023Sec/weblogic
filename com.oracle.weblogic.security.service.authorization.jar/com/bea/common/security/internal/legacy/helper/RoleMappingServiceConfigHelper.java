...
class RoleMappingServiceConfigHelper {
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, String lifecycleImplLoaderName, RealmMBean realmMBean, String serviceName) {
      RoleMappingProviderConfigHelper.addToConfig(serviceEngineConfig, lifecycleImplLoaderName, getFaceMBeans(realmMBean));
      ...
      for(int i = 0; i < faceNames.length; ++i) {
         faceNames[i] = RoleMappingProviderConfigHelper.getServiceName(providerMBeans[i]);
