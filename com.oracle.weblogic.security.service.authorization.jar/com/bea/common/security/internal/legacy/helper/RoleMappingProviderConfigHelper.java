...
class RoleMappingProviderConfigHelper {
   static String getServiceName(RoleMapperMBean providerMBean) {
      return RoleMappingProviderConfigHelper.class.getName() + "_" + providerMBean.getRealm().getName() + "_" + providerMBean.getName();
   }
   ...
   private static String getImplName() {
      return "com.bea.common.security.internal.legacy.service.RoleMappingProviderImpl";
   }
