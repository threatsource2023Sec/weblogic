...
class BulkAccessDecisionProviderConfigHelper {
   static String getServiceName(AuthorizerMBean providerMBean) {
      return BulkAccessDecisionProviderConfigHelper.class.getName() + "_" + providerMBean.getRealm().getName() + "_" + providerMBean.getName();
   }
   ...
   private static String getImplName() {
      return "com.bea.common.security.internal.legacy.service.BulkAccessDecisionProviderImpl";
   }
