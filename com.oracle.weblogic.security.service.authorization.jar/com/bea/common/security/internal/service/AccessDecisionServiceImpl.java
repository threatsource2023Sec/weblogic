...
public class AccessDecisionServiceImpl implements ServiceLifecycleSpi, AccessDecisionService {
      ...
      if (config != null && config instanceof AccessDecisionServiceConfig) {
         ...
         if (names != null && names.length >= 1) {
            ...
            for(int i = 0; i < names.length; ++i) {
               ...
               this.accessDecisionClassNames[i] = provider.getAccessDecisionClassName();
            }

            return Delegator.getProxy("com.bea.common.security.service.AccessDecisionService", this);
         } else {
