...
public class SAFRemoteEndpointRuntimeMBeanImplBeanInfo extends SAFRemoteEndpointCustomizerBeanInfo {
   public static final Class INTERFACE_CLASS = JMSRemoteEndpointRuntimeMBean.class;

   public SAFRemoteEndpointRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jms.saf.SAFRemoteEndpointRuntimeMBeanImpl");
      ...
      String description = (new String("This class is used for monitoring a WebLogic SAF remote endpoint for a JMS imported destination. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.JMSRemoteEndpointRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BytesCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BytesCurrentCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("BytesHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BytesHighCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("BytesPendingCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BytesPendingCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("BytesReceivedCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BytesReceivedCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("BytesThresholdTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BytesThresholdTime", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DowntimeHigh")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DowntimeHigh", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DowntimeTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DowntimeTotal", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("EndpointType")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("EndpointType", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailedMessagesTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedMessagesTotal", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastException")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastException", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastTimeConnected")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastTimeConnected", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastTimeFailedToConnect")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastTimeFailedToConnect", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MessagesCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MessagesCurrentCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MessagesHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MessagesHighCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MessagesPendingCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MessagesPendingCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MessagesReceivedCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MessagesReceivedCount", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MessagesThresholdTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MessagesThresholdTime", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("OperationState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("OperationState", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("URL")) {
         getterName = "getURL";
         setterName = null;
         currentResult = new PropertyDescriptor("URL", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("UptimeHigh")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("UptimeHigh", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("UptimeTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("UptimeTotal", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PausedForForwarding")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PausedForForwarding", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PausedForIncoming")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PausedForIncoming", JMSRemoteEndpointRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("sort", String.class, Long.class, String[].class, Boolean[].class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("pauseIncoming");
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      String[] roleObjectArray;
      if (!descriptors.containsKey(methodKey)) {
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("resumeIncoming");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getCursorSize", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("closeCursor", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("pauseForwarding");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("resumeForwarding");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("expireAll");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("purge");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JMSRemoteEndpointRuntimeMBean.class.getMethod("getMessages", String.class, Integer.class);
