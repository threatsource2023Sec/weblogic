...
public class JMSMessageCursorRuntimeImplBeanInfo extends MessageCursorRuntimeImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSMessageCursorRuntimeMBean.class;

   public JMSMessageCursorRuntimeImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jms.backend.JMSMessageCursorRuntimeImpl");
      ...
      String description = (new String("This runtime MBean represents a handle to a server-side JMS message result set.  It is used for paging through large sets of messages. Messages are returned in an array of CompositeData objects that contain the message header fields and additional attributes. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.JMSMessageCursorRuntimeMBean");
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSMessageCursorRuntimeMBean.class.getMethod("getCursorStartPosition", String.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, String.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("sort", String.class, Long.class, String[].class, Boolean[].class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getCursorEndPosition", String.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getMessage", String.class, Long.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getItems", String.class, Long.class, Integer.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getNext", String.class, Integer.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getPrevious", String.class, Integer.class);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("getCursorSize", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      mth = JMSMessageCursorRuntimeMBean.class.getMethod("closeCursor", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("cursorHandle", "The cursor handle. ")};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
