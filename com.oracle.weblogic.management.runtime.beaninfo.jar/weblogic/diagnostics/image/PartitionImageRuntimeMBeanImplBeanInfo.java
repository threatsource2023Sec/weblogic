...
public class PartitionImageRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = WLDFPartitionImageRuntimeMBean.class;

   public PartitionImageRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public PartitionImageRuntimeMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.diagnostics.image.PartitionImageRuntimeMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.WLDFPartitionImageRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("AvailableCapturedImages")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AvailableCapturedImages", WLDFPartitionImageRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ImageCaptureTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ImageCaptureTasks", WLDFPartitionImageRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ImageDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ImageDir", WLDFPartitionImageRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ImageTimeout")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ImageTimeout", WLDFPartitionImageRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinFinderMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFPartitionImageRuntimeMBean.class.getMethod("lookupImageCaptureTask", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFPartitionImageRuntimeMBean.class.getMethod("captureImage");
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("captureImage", Integer.TYPE);
      ParameterDescriptor[] parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("lockoutMinutes", "number of minutes before the next image capture request will be accepted ")};
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("listImageCaptureTasks");
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("clearCompletedImageCaptureTasks");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("resetImageLockout");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("purgeCapturedImages", String.class);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("openImageDataStream", String.class, String.class);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("getNextImageDataChunk", String.class);
      ...
      mth = WLDFPartitionImageRuntimeMBean.class.getMethod("closeImageDataStream", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("imageStreamHandle", (String)null)};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
