...
public class DiagnosticAccessRuntimeBeanInfo extends AccessRuntimeBeanInfo {
   public static final Class INTERFACE_CLASS = WLDFAccessRuntimeMBean.class;

   public DiagnosticAccessRuntimeBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.diagnostics.accessor.DiagnosticAccessRuntime");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("AvailableDiagnosticDataAccessorNames")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AvailableDiagnosticDataAccessorNames", WLDFAccessRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DataAccessRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DataAccessRuntimes", WLDFAccessRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WLDFDataAccessRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WLDFDataAccessRuntimes", WLDFAccessRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinFinderMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFAccessRuntimeMBean.class.getMethod("lookupDataAccessRuntime", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFAccessRuntimeMBean.class.getMethod("lookupWLDFDataAccessRuntime", String.class);
