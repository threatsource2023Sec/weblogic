...
public class WLDFDataRetirementByAgeTaskImplBeanInfo extends DataRetirementTaskImplBeanInfo {
   public static final Class INTERFACE_CLASS = WLDFDataRetirementTaskRuntimeMBean.class;

   public WLDFDataRetirementByAgeTaskImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.diagnostics.archive.WLDFDataRetirementByAgeTaskImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.WLDFDataRetirementTaskRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BeginTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BeginTime", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Description")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Description", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("EndTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("EndTime", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Error")) {
         getterName = "getError";
         setterName = null;
         currentResult = new PropertyDescriptor("Error", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentTask", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Progress")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Progress", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RetiredRecordsCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RetiredRecordsCount", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Status")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Status", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SubTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SubTasks", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Running")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Running", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SystemTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SystemTask", WLDFDataRetirementTaskRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFDataRetirementTaskRuntimeMBean.class.getMethod("cancel");
      ...
      mth = WLDFDataRetirementTaskRuntimeMBean.class.getMethod("printLog", PrintWriter.class);
