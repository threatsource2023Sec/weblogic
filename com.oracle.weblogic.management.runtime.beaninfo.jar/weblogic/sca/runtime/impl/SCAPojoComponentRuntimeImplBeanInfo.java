...
public class SCAPojoComponentRuntimeImplBeanInfo extends ComponentRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = SCAPojoComponentRuntimeMBean.class;

   public SCAPojoComponentRuntimeImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.sca.runtime.impl.SCAPojoComponentRuntimeImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.SCAPojoComponentRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DeploymentState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentState", SCAPojoComponentRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ModuleId")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ModuleId", SCAPojoComponentRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("WorkManagerRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WorkManagerRuntimes", SCAPojoComponentRuntimeMBean.class, getterName, (String)setterName);
