...
public class AppClientComponentRuntimeMBeanImplBeanInfo extends ComponentRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = AppClientComponentRuntimeMBean.class;

   public AppClientComponentRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.j2eeclient.AppClientComponentRuntimeMBeanImpl");
      ...
      beanDescriptor.setValue("package", "weblogic.j2eeclient");
      String description = (new String("This is the ComponentRuntimeMBean for Java EE Application Client Containers. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.AppClientComponentRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DeploymentState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentState", AppClientComponentRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ModuleId")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ModuleId", AppClientComponentRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("WorkManagerRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WorkManagerRuntimes", AppClientComponentRuntimeMBean.class, getterName, (String)setterName);
