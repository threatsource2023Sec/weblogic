...
public class ResourceGroupLifeCycleTaskRuntimeBeanInfo extends TaskRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = ResourceGroupLifeCycleTaskRuntimeMBean.class;

   public ResourceGroupLifeCycleTaskRuntimeBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public ResourceGroupLifeCycleTaskRuntimeBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.server.ResourceGroupLifeCycleTaskRuntime");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.ResourceGroupLifeCycleTaskRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BeginTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BeginTime", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Description")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Description", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("EndTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("EndTime", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Error")) {
         getterName = "getError";
         setterName = null;
         currentResult = new PropertyDescriptor("Error", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Operation")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Operation", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentTask", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Progress")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Progress", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("Progress", currentResult);
         currentResult.setValue("description", "<p>The progress of this task.</p> ");
         currentResult.setValue("since", "12.2.1.0.0");
      }

      if (!descriptors.containsKey("ResourceGroupName")) {
         getterName = "getResourceGroupName";
         setterName = null;
         currentResult = new PropertyDescriptor("ResourceGroupName", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("ResourceGroupName", currentResult);
         currentResult.setValue("description", "Returns the name of the resource group being operated on. ");
         currentResult.setValue("owner", "");
      }
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion) && !descriptors.containsKey("ServerName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ServerName", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Status")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Status", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SubTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SubTasks", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Running")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Running", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SystemTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SystemTask", ResourceGroupLifeCycleTaskRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = ResourceGroupLifeCycleTaskRuntimeMBean.class.getMethod("cancel");
      ...
      mth = ResourceGroupLifeCycleTaskRuntimeMBean.class.getMethod("printLog", PrintWriter.class);
