...
public class JMSDescriptorMBeanImplBeanInfo extends DescriptorMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSDescriptorMBean.class;

   public JMSDescriptorMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public JMSDescriptorMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.mbeanservers.edit.internal.JMSDescriptorMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.mbeanservers.edit.JMSDescriptorMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      String getterName;
      Object setterName;
      if (!descriptors.containsKey("JMSDescriptor")) {
         getterName = "getJMSDescriptor";
         setterName = null;
         currentResult = new PropertyDescriptor("JMSDescriptor", JMSDescriptorMBean.class, getterName, (String)setterName);
         descriptors.put("JMSDescriptor", currentResult);
         currentResult.setValue("description", "Return the descriptor for *-jms.xml ");
      ...
      if (!descriptors.containsKey("Name")) {
         getterName = "getName";
         setterName = null;
         currentResult = new PropertyDescriptor("Name", JMSDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentAttribute")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentAttribute", JMSDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentService")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentService", JMSDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Path")) {
         getterName = "getPath";
         setterName = null;
         currentResult = new PropertyDescriptor("Path", JMSDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Type")) {
         getterName = "getType";
         setterName = null;
         currentResult = new PropertyDescriptor("Type", JMSDescriptorMBean.class, getterName, (String)setterName);
