...
public class DatasourceDescriptorMBeanImplBeanInfo extends DescriptorMBeanImplBeanInfo {
   ...
   public DatasourceDescriptorMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.mbeanservers.edit.internal.DatasourceDescriptorMBeanImpl");
      ...
      String description = (new String("This interface represents the deployment configuration.for a jdbc data source module ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      String getterName;
      Object setterName;
      if (!descriptors.containsKey("DatasourceDescriptor")) {
         getterName = "getDatasourceDescriptor";
         setterName = null;
         currentResult = new PropertyDescriptor("DatasourceDescriptor", DatasourceDescriptorMBean.class, getterName, (String)setterName);
         descriptors.put("DatasourceDescriptor", currentResult);
         currentResult.setValue("description", "Return the descriptor for *-jdbc.xml ");
      ...
      if (!descriptors.containsKey("Name")) {
         getterName = "getName";
         setterName = null;
         currentResult = new PropertyDescriptor("Name", DatasourceDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentAttribute")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentAttribute", DatasourceDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentService")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentService", DatasourceDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Path")) {
         getterName = "getPath";
         setterName = null;
         currentResult = new PropertyDescriptor("Path", DatasourceDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Type")) {
         getterName = "getType";
         setterName = null;
         currentResult = new PropertyDescriptor("Type", DatasourceDescriptorMBean.class, getterName, (String)setterName);
