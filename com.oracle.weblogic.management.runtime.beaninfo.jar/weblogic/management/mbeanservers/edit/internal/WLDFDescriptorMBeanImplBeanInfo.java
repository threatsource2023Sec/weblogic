...
public class WLDFDescriptorMBeanImplBeanInfo extends DescriptorMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = WLDFDescriptorMBean.class;

   public WLDFDescriptorMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public WLDFDescriptorMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.mbeanservers.edit.internal.WLDFDescriptorMBeanImpl");
      ...
      String description = (new String("This interface represents the deployment configuration.for a jms module ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.mbeanservers.edit.WLDFDescriptorMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Name")) {
         getterName = "getName";
         setterName = null;
         currentResult = new PropertyDescriptor("Name", WLDFDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentAttribute")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentAttribute", WLDFDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentService")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentService", WLDFDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Path")) {
         getterName = "getPath";
         setterName = null;
         currentResult = new PropertyDescriptor("Path", WLDFDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Type")) {
         getterName = "getType";
         setterName = null;
         currentResult = new PropertyDescriptor("Type", WLDFDescriptorMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WLDFDescriptor")) {
         getterName = "getWLDFDescriptor";
         setterName = null;
         currentResult = new PropertyDescriptor("WLDFDescriptor", WLDFDescriptorMBean.class, getterName, (String)setterName);
         descriptors.put("WLDFDescriptor", currentResult);
         currentResult.setValue("description", "Return the descriptor for weblogic-diagnostics.xml ");
