...
public class ServiceImplBeanInfo extends BeanInfoImpl {
   public static final Class INTERFACE_CLASS = Service.class;

   public ServiceImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.mbeanservers.internal.ServiceImpl");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Name")) {
         getterName = "getName";
         setterName = null;
         currentResult = new PropertyDescriptor("Name", Service.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentAttribute")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentAttribute", Service.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentService")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentService", Service.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Path")) {
         getterName = "getPath";
         setterName = null;
         currentResult = new PropertyDescriptor("Path", Service.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Type")) {
         getterName = "getType";
         setterName = null;
         currentResult = new PropertyDescriptor("Type", Service.class, getterName, (String)setterName);
