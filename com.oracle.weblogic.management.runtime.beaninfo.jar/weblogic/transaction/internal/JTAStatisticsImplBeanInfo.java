...
public class JTAStatisticsImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JTAStatisticsRuntimeMBean.class;

   public JTAStatisticsImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.transaction.internal.JTAStatisticsImpl");
      ...
      String description = (new String("This interface contains general JTA runtime statistics. ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("TransactionCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TransactionCommittedTotalCount", JTAStatisticsRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("TransactionHeuristicsTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TransactionHeuristicsTotalCount", JTAStatisticsRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("TransactionRolledBackTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TransactionRolledBackTotalCount", JTAStatisticsRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("TransactionTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TransactionTotalCount", JTAStatisticsRuntimeMBean.class, getterName, (String)setterName);
