...
public class OwsmSecurityPolicyRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = OwsmSecurityPolicyRuntimeMBean.class;

   public OwsmSecurityPolicyRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.wsee.policy.mbean.OwsmSecurityPolicyRuntimeMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.OwsmSecurityPolicyRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("AvailablePolicies")) {
         ...
         currentResult = new PropertyDescriptor("AvailablePolicies", OwsmSecurityPolicyRuntimeMBean.class, getterName, (String)setterName);
