...
public class WseeRuntimeMBeanImplBeanInfo extends WseeBaseRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = WseeRuntimeMBean.class;

   public WseeRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.wsee.monitoring.WseeRuntimeMBeanImpl");
      } catch (Throwable var4) {
         beanClass = INTERFACE_CLASS;
      }

      BeanDescriptor beanDescriptor = new BeanDescriptor(beanClass, (Class)null);
      beanDescriptor.setValue("deprecated", "Use WseeV2RuntimeMBean from the web app or EJB component runtime MBeans instead. ");
      beanDescriptor.setValue("package", "weblogic.wsee.monitoring");
      String description = (new String("<p>Encapsulates runtime information about a particular Web Service. This interface is used only for JAX-RPC and 'legacy' JAX-WS service consumers, and is parented off the ApplicationRuntimeMBean. New clients using JAX-WS web services should use WseeV2RuntimeMBean instead.</p>  <p>Note that the name of this MBean is calculated and of the form:</p>  <p><code>&lt;app name&gt;#&lt;app version&gt;!&lt;service name&gt;</code></p>  <p>Also, note that the serviceName attribute is the same as the name attribute.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.WseeRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ConversationInstanceCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConversationInstanceCount", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ImplementationType")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ImplementationType", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("OwsmSecurityPolicyRuntime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("OwsmSecurityPolicyRuntime", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PolicyFaults")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PolicyFaults", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PolicyRuntime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PolicyRuntime", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Ports")) {
         getterName = "getPorts";
         setterName = null;
         currentResult = new PropertyDescriptor("Ports", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ServiceName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ServiceName", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("StartTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("StartTime", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("TotalFaults")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TotalFaults", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("TotalSecurityFaults")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("TotalSecurityFaults", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("URI")) {
         getterName = "getURI";
         setterName = null;
         currentResult = new PropertyDescriptor("URI", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WebserviceDescriptionName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WebserviceDescriptionName", WseeRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WsType")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WsType", WseeRuntimeMBean.class, getterName, (String)setterName);
