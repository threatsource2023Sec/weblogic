...
public class ProxyDataSourceRuntimeImplBeanInfo extends DataSourceRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JDBCProxyDataSourceRuntimeMBean.class;

   public ProxyDataSourceRuntimeImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public ProxyDataSourceRuntimeImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jdbc.common.internal.ProxyDataSourceRuntimeImpl");
      ...
      String description = (new String("Runtime MBean that represents a Proxy JDBC data source. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.JDBCProxyDataSourceRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ActiveConnectionsAverageCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsAverageCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsCurrentCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsHighCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("CommitOutcomeRetryTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CommitOutcomeRetryTotalCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionDelayTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionDelayTime", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionsTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionsTotalCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacity")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacity", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacityHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacityHighCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductName", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductVersion", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DeploymentState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentState", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverName", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverVersion", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("FailedRepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedRepurposeCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailedReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedReserveRequestCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailuresToReconnectCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailuresToReconnectCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("HighestNumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumAvailable", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("HighestNumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumUnavailable", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("JDBCDriverRuntime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCDriverRuntime", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("JDBCReplayStatisticsRuntimeMBean")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCReplayStatisticsRuntimeMBean", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastTask", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LeakedConnectionCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LeakedConnectionCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ModuleId")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ModuleId", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumAvailable", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumUnavailable", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAccessCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAccessCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAddCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAddCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheCurrentSize")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheCurrentSize", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheDeleteCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheDeleteCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheHitCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheHitCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheMissCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheMissCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Properties")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Properties", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("RepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RepurposeCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ReserveRequestCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsCommittedTotalCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsNotCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsNotCommittedTotalCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("State")) {
         getterName = "getState";
         setterName = null;
         currentResult = new PropertyDescriptor("State", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tasks")) {
         getterName = "getTasks";
         setterName = null;
         currentResult = new PropertyDescriptor("Tasks", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("UnresolvedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("UnresolvedTotalCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("VersionJDBCDriver")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("VersionJDBCDriver", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitSecondsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitSecondsHighCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionCurrentCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionFailureTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionFailureTotal", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionHighCount", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionSuccessTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionSuccessTotal", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionTotal", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("WorkManagerRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WorkManagerRuntimes", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Enabled")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Enabled", JDBCProxyDataSourceRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("testPool");
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("shrink");
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("reset");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("suspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("forceSuspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("shutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("forceShutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("resume");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("start");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("poolExists", String.class);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("clearStatementCache");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("dumpPool");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("dumpPoolProfile");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("isOperationAllowed", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("suspend", Integer.TYPE);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("shutdown", Integer.TYPE);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("operationSecs", "The number of seconds to allow the operation to run before stopping processing.  If set to 0, the default is used. The default is to use Inactive Connection Timeout Seconds if set or 60 seconds.  If you want a minimal timeout, set the value to 1. If you want no timeout, set it to a large value (not recommended). ")};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCProxyDataSourceRuntimeMBean.class.getMethod("resetStatistics");
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
            currentResult.setValue("since", "12.2.1.1.0");
