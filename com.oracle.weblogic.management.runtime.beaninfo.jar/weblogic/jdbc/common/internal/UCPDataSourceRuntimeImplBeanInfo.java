...
public class UCPDataSourceRuntimeImplBeanInfo extends DataSourceRuntimeMBeanImplBeanInfo {
   ...
   public UCPDataSourceRuntimeImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jdbc.common.internal.UCPDataSourceRuntimeImpl");
      ...
      String description = (new String("Runtime MBean that represents a UCP JDBC data source. ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ActiveConnectionsAverageCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsAverageCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsCurrentCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsHighCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("CommitOutcomeRetryTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CommitOutcomeRetryTotalCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionDelayTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionDelayTime", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionsTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionsTotalCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacity")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacity", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacityHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacityHighCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductName", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductVersion", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DeploymentState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentState", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverName", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverVersion", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("FailedRepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedRepurposeCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailedReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedReserveRequestCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailuresToReconnectCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailuresToReconnectCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("HighestNumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumAvailable", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("HighestNumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumUnavailable", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("JDBCDriverRuntime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCDriverRuntime", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("JDBCReplayStatisticsRuntimeMBean")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCReplayStatisticsRuntimeMBean", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastTask", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LeakedConnectionCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LeakedConnectionCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ModuleId")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ModuleId", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumAvailable", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumUnavailable", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAccessCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAccessCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAddCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAddCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheCurrentSize")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheCurrentSize", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheDeleteCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheDeleteCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheHitCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheHitCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheMissCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheMissCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Properties")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Properties", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("RepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RepurposeCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ReserveRequestCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsCommittedTotalCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsNotCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsNotCommittedTotalCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("State")) {
         getterName = "getState";
         setterName = null;
         currentResult = new PropertyDescriptor("State", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tasks")) {
         getterName = "getTasks";
         setterName = null;
         currentResult = new PropertyDescriptor("Tasks", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("UnresolvedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("UnresolvedTotalCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("VersionJDBCDriver")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("VersionJDBCDriver", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitSecondsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitSecondsHighCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionCurrentCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionFailureTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionFailureTotal", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionHighCount", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionSuccessTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionSuccessTotal", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionTotal", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("WorkManagerRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WorkManagerRuntimes", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Enabled")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Enabled", JDBCUCPDataSourceRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("testPool");
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("shrink");
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("reset");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("suspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("forceSuspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("shutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("forceShutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("resume");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("start");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("poolExists", String.class);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("clearStatementCache");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("dumpPool");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("dumpPoolProfile");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("isOperationAllowed", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("suspend", Integer.TYPE);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("shutdown", Integer.TYPE);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("operationSecs", "The number of seconds to allow the operation to run before stopping processing.  If set to 0, the default is used. The default is to use Inactive Connection Timeout Seconds if set or 60 seconds.  If you want a minimal timeout, set the value to 1. If you want no timeout, set it to a large value (not recommended). ")};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCUCPDataSourceRuntimeMBean.class.getMethod("resetStatistics");
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
            currentResult.setValue("since", "12.2.1.1.0");
