...
public class DataSourceRuntimeMBeanImplBeanInfo extends ComponentRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JDBCDataSourceRuntimeMBean.class;

   public DataSourceRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jdbc.common.internal.DataSourceRuntimeMBeanImpl");
      ...
      String description = (new String("<p>This class is used for monitoring a WebLogic JDBC Data Source and its associated connection pool.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.JDBCDataSourceRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ActiveConnectionsAverageCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsAverageCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsCurrentCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ActiveConnectionsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActiveConnectionsHighCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("CommitOutcomeRetryTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CommitOutcomeRetryTotalCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionDelayTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionDelayTime", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ConnectionsTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ConnectionsTotalCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacity")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacity", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CurrCapacityHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("CurrCapacityHighCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductName", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DatabaseProductVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DatabaseProductVersion", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DeploymentState")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentState", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverName", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DriverVersion")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DriverVersion", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("FailedRepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedRepurposeCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailedReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailedReserveRequestCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("FailuresToReconnectCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("FailuresToReconnectCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("HighestNumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumAvailable", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("HighestNumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("HighestNumUnavailable", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("JDBCDriverRuntime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCDriverRuntime", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("JDBCReplayStatisticsRuntimeMBean")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCReplayStatisticsRuntimeMBean", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastTask", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LeakedConnectionCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LeakedConnectionCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ModuleId")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ModuleId", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumAvailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumAvailable", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("NumUnavailable")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("NumUnavailable", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAccessCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAccessCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheAddCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheAddCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheCurrentSize")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheCurrentSize", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheDeleteCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheDeleteCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheHitCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheHitCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("PrepStmtCacheMissCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PrepStmtCacheMissCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Properties")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Properties", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("RepurposeCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RepurposeCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ReserveRequestCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ReserveRequestCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsCommittedTotalCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("ResolvedAsNotCommittedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ResolvedAsNotCommittedTotalCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("State")) {
         getterName = "getState";
         setterName = null;
         currentResult = new PropertyDescriptor("State", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tasks")) {
         getterName = "getTasks";
         setterName = null;
         currentResult = new PropertyDescriptor("Tasks", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.3.0", (String)null, this.targetVersion) && !descriptors.containsKey("UnresolvedTotalCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("UnresolvedTotalCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("VersionJDBCDriver")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("VersionJDBCDriver", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitSecondsHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitSecondsHighCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionCurrentCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionCurrentCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionFailureTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionFailureTotal", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionHighCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionHighCount", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionSuccessTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionSuccessTotal", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("WaitingForConnectionTotal")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WaitingForConnectionTotal", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("9.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("WorkManagerRuntimes")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("WorkManagerRuntimes", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Enabled")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Enabled", JDBCDataSourceRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCDataSourceRuntimeMBean.class.getMethod("testPool");
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("shrink");
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("reset");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("suspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("forceSuspend");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("shutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("forceShutdown");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("resume");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("start");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("poolExists", String.class);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("clearStatementCache");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("dumpPool");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("dumpPoolProfile");
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
      ...
      mth = JDBCDataSourceRuntimeMBean.class.getMethod("isOperationAllowed", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCDataSourceRuntimeMBean.class.getMethod("suspend", Integer.TYPE);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCDataSourceRuntimeMBean.class.getMethod("shutdown", Integer.TYPE);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("operationSecs", "The number of seconds to allow the operation to run before stopping processing.  If set to 0, the default is used. The default is to use Inactive Connection Timeout Seconds if set or 60 seconds.  If you want a minimal timeout, set the value to 1. If you want no timeout, set it to a large value (not recommended). ")};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.1.0", (String)null, this.targetVersion)) {
         mth = JDBCDataSourceRuntimeMBean.class.getMethod("resetStatistics");
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
            currentResult.setValue("since", "12.2.1.1.0");
