...
public class JDBCDataSourceTaskRuntimeMBeanImplBeanInfo extends TaskRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JDBCDataSourceTaskRuntimeMBean.class;

   public JDBCDataSourceTaskRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.jdbc.common.internal.JDBCDataSourceTaskRuntimeMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.runtime.JDBCDataSourceTaskRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BeginTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BeginTime", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Description")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Description", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("EndTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("EndTime", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Error")) {
         getterName = "getError";
         setterName = null;
         currentResult = new PropertyDescriptor("Error", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentTask", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Progress")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Progress", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Status")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Status", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SubTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SubTasks", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Running")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Running", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SystemTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SystemTask", JDBCDataSourceTaskRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCDataSourceTaskRuntimeMBean.class.getMethod("cancel");
      ...
      mth = JDBCDataSourceTaskRuntimeMBean.class.getMethod("printLog", PrintWriter.class);
