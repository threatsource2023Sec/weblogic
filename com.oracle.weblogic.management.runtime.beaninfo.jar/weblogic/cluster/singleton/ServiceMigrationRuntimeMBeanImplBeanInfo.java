...
public class ServiceMigrationRuntimeMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = ServiceMigrationRuntimeMBean.class;

   public ServiceMigrationRuntimeMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.cluster.singleton.ServiceMigrationRuntimeMBeanImpl");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ClusterMasterName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ClusterMasterName", ServiceMigrationRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("MigrationData")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("MigrationData", ServiceMigrationRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ClusterMaster")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ClusterMaster", ServiceMigrationRuntimeMBean.class, getterName, (String)setterName);
