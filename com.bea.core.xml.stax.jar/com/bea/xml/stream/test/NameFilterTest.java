...
public class NameFilterTest extends BaseTestCase {
   ...
   public static Test suite() {
      return new TestSuite(class$com$bea$xml$stream$test$NameFilterTest == null ? (class$com$bea$xml$stream$test$NameFilterTest = class$("com.bea.xml.stream.test.NameFilterTest")) : class$com$bea$xml$stream$test$NameFilterTest);
   }
