...
public abstract class HeuristicRollbackHelper {
      ...
      if (__typeCode == null) {
         ...
         synchronized(TypeCode.class) {
            if (__typeCode == null) {
               ...
               __typeCode = ORB.init().create_exception_tc(id(), "HeuristicRollback", _members0);
               __active = false;
            }
         }
      }
   ...
   public static HeuristicRollback read(InputStream istream) {
      HeuristicRollback value = new HeuristicRollback();
      istream.read_string();
      return value;
   }
