...
public abstract class _OTSPolicyImplBase extends ObjectImpl implements OTSPolicy, InvokeHandler {
   ...
   static {
      ...
      __ids = new String[]{"IDL:omg.org/CosTransactions/OTSPolicy:1.0", "IDL:omg.org/CORBA/Policy:1.0"};
   }
}
