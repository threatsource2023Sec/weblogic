...
public class _OTSPolicyStub extends ObjectImpl implements OTSPolicy {
   private static String[] __ids = new String[]{"IDL:omg.org/CosTransactions/OTSPolicy:1.0", "IDL:omg.org/CORBA/Policy:1.0"};
   ...
   public short tpv() {
      ...
      short $result;
      try {
         OutputStream $out = this._request("_get_tpv", true);
         $in = this._invoke($out);
         $result = OTSPolicyValueHelper.read($in);
         short var4 = $result;
         return var4;
