...
public class ValidatingXMLInputStreamParser extends ValidatingBaseParser implements XMLStreamParser {
   ...
   public ValidatingXMLInputStreamParser(InputSource input, ElementFactory factory, ElementConsumer consumer) throws IOException, XMLStreamException {
      try {
   ...
   public ValidatingXMLInputStreamParser(InputSource input, ElementFactory factory, ElementConsumer consumer, Map namespaces) throws IOException, XMLStreamException {
      try {
         this.inputStreamFactory = factory;
         this.inputStreamFactory.setBaseParser(this);
         this.inputStreamConsumer = consumer;
         ...
         throw (XMLStreamException)this.inputStreamFactory.create(var6);
      }
   }
