...
public class XMLStreamPlayer implements XMLStreamReader, Location {
   EventState state;
   ...
   protected void advance() throws XMLStreamException {
      try {
         this.setState(this.scanner.readElement());
   ...
   protected void setState(EventState es) {
      this.state = es;
   }
   ...
   private Namespace getNamespaceInternal(int index) {
      return (Namespace)this.state.getNamespaces().get(index);
   }
   ...
   public String getNamespacePrefix(int index) {
      Namespace n = this.getNamespaceInternal(index);
      if (n == null) {
         return null;
      } else {
         return n.isDefaultNamespaceDeclaration() ? null : n.getName().getLocalPart();
      }
   }
