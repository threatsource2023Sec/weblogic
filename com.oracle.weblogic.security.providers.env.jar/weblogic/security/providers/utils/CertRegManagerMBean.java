...
public interface CertRegManagerMBean extends StandardInterface, DescriptorBean, ProviderMBean, ImportMBean, ExportMBean, NameListerMBean {
   ...
   String listAliases(String var1, int var2) throws InvalidCursorException, InvalidParameterException;

   X509Certificate getCertificate(String var1) throws NotFoundException, InvalidParameterException;

   boolean aliasExists(String var1) throws InvalidParameterException;
