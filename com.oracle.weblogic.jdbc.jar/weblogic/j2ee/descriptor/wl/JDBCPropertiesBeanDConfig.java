...
public class JDBCPropertiesBeanDConfig extends BasicDConfigBean {
   ...
   public JDBCPropertiesBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (JDBCPropertiesBean)btn;
      this.beanTree = btn;
