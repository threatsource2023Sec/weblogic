...
public class MX4JRemoteMBeanServerProxy implements MBeanServer {
   private static Localizer s_loc = Localizer.forPackage(MX4JRemoteMBeanServerProxy.class);
   private RemoteMBeanServer _rs;
   private Log _log;

   public MX4JRemoteMBeanServerProxy(RemoteMBeanServer rs, Log log) {
      this._rs = rs;
      this._log = log;
   }
