...
public class MX4JConnectDialog extends XDialog {
   ...
   public MX4JConnectDialog(String title, boolean modal, JMXTree jmxTree, Log log) {
      this.setTitle(title);
      this._log = log;
      ...
      this.okButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            try {
               MX4JRemoteMBeanServerFactory factory = new MX4JRemoteMBeanServerFactory();
               MBeanServer mbServer = factory.createRemoteMBeanServer(MX4JConnectDialog.this.jndiNameField.getText(), MX4JConnectDialog.this.hostField.getText(), Integer.parseInt(MX4JConnectDialog.this.portField.getText()), MX4JConnectDialog.this._log);
               MX4JConnectDialog.this._jmxTree.add(mbServer, MX4JConnectDialog.this.jndiNameField.getText() + " (" + MX4JConnectDialog.this.hostField.getText() + ":" + MX4JConnectDialog.this.portField.getText() + ")");
               MX4JConnectDialog.this.hide();
               MX4JConnectDialog.this.dispose();
               ...
               MX4JConnectDialog.this._log.error(MX4JConnectDialog._loc.get("cant-connect", MX4JConnectDialog.this.jndiNameField.getText(), MX4JConnectDialog.this.hostField.getText(), MX4JConnectDialog.this.portField.getText()), var4);
            }
