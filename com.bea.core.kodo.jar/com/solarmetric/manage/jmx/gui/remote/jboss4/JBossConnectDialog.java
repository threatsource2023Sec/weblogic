...
import com.solarmetric.manage.jmx.remote.jboss4.JBossRemoteMBeanServerFactory;
      ...
      this.okButton.addActionListener(new ActionListener() {
         public void actionPerformed(ActionEvent e) {
            try {
               ...
               MBeanServer mbServer = factory.createRemoteMBeanServer(JBossConnectDialog.this.jndiNameField.getText(), JBossConnectDialog.this.hostField.getText(), new Integer(JBossConnectDialog.this.portField.getText()), JBossConnectDialog.this._log);
