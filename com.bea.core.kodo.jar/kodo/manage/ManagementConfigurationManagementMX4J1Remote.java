...
public class ManagementConfigurationManagementMX4J1Remote extends ManagementConfigurationManagement {
   private static final Localizer _loc = Localizer.forPackage(ManagementConfigurationManagementMX4J1Remote.class);
   private static final String _adaptorClassName = "com.solarmetric.manage.jmx.remote.mx4j1.MX4JRemoteJMXAdaptorImpl";
   ...
   public void startConfiguration() {
      ...
      try {
         Class adaptorClass = Class.forName("com.solarmetric.manage.jmx.remote.mx4j1.MX4JRemoteJMXAdaptorImpl");
   ...
   public void setJNDIName(String jndiName) {
      this.setParameter("setJNDIName", String.class, jndiName);
   }
