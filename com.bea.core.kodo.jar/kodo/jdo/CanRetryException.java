...
class CanRetryException extends JDOCanRetryException implements ExceptionInfo, Serializable {
   public CanRetryException(String msg, Throwable[] nested, Object failed) {
   ...
   protected CanRetryException newSerializableInstance(String msg, Throwable[] nested, Object failed) {
      return new CanRetryException(msg, nested, failed);
   }
}
