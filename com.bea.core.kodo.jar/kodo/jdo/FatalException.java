...
class FatalException extends JDOFatalException implements ExceptionInfo, Serializable {
   public FatalException(String msg, Throwable[] nested, Object failed) {
   ...
   protected FatalException newSerializableInstance(String msg, Throwable[] nested, Object failed) {
      return new FatalException(msg, nested, failed);
   }
}
