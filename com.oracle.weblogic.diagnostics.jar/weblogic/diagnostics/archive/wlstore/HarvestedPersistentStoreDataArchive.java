...
public final class HarvestedPersistentStoreDataArchive extends PersistentStoreDataArchive {
   ...
   public HarvestedPersistentStoreDataArchive(String name, String storeDirectory, boolean readOnly) throws PersistentStoreException, ManagementException {
      super(name, ArchiveConstants.getColumns(2), "WLS_HVST", storeDirectory, readOnly);
   }
   ...
   public Iterator getDataRecords(long startTime, long endTime, String query) throws QueryException, DiagnosticDataAccessException, UnsupportedOperationException {
      return new HarvesterPersistentRecordIterator(this, startTime, endTime, query);
   }
   ...
   public Iterator getDataRecords(long startRecordId, long endrecordId, long endTime, String query) throws QueryException, DiagnosticDataAccessException, UnsupportedOperationException {
      return new HarvesterPersistentRecordIterator(this, startRecordId, endrecordId, endTime, query);
   }
   ...
   public static void main(String[] args) throws Exception {
      if (args.length < 3) {
         ...
         if (!DiagnosticStoreRepository.storeFileExists(storeDir)) {
            ...
            HarvestedPersistentStoreDataArchive archive = new HarvestedPersistentStoreDataArchive("HarvestedDataArchive", storeDir, !doDelete);
            int cnt = 0;
