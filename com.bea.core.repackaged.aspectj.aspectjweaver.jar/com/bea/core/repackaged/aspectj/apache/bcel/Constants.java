...
public interface Constants {
   ...
   short ACC_SYNTHETIC = 4096;
   short ACC_ANNOTATION = 8192;
   short ACC_ENUM = 16384;
   short ACC_BRIDGE = 64;
   short ACC_VARARGS = 128;
   short ACC_SUPER = 32;
   short MAX_ACC_FLAG = 2048;
   String[] ACCESS_NAMES = new String[]{"public", "private", "protected", "static", "final", "synchronized", "volatile", "transient", "native", "interface", "abstract", "strictfp"};
   ...
   String[] CONSTANT_NAMES = new String[]{"", "CONSTANT_Utf8", "", "CONSTANT_Integer", "CONSTANT_Float", "CONSTANT_Long", "CONSTANT_Double", "CONSTANT_Class", "CONSTANT_String", "CONSTANT_Fieldref", "CONSTANT_Methodref", "CONSTANT_InterfaceMethodref", "CONSTANT_NameAndType", "", "", "CONSTANT_MethodHandle", "CONSTANT_MethodType", "", "CONSTANT_InvokeDynamic"};
   ...
   String[] CLASS_TYPE_NAMES = new String[]{"<illegal type>", "<illegal type>", "<illegal type>", "<illegal type>", "java.lang.Boolean", "java.lang.Character", "java.lang.Float", "java.lang.Double", "java.lang.Byte", "java.lang.Short", "java.lang.Integer", "java.lang.Long", "java.lang.Void", "<illegal type>", "<illegal type>", "<illegal type>"};
   ...
   int POP_INST = 128;
   int STORE_INST = 256;
   long STACK_INST = 512L;
   long BRANCH_INSTRUCTION = 1024L;
   long TARGETER_INSTRUCTION = 2048L;
   long NEGATABLE = 4096L;
   long IF_INST = 8192L;
   long JSR_INSTRUCTION = 16384L;
   long RET_INST = 32768L;
   long EXCEPTION_THROWER = 65536L;
   byte[] iLen = new byte[256];
   byte UNDEFINED_LENGTH = 40;
   byte VARIABLE_LENGTH = 38;
   byte[] stackEntriesProduced = new byte[256];
   Type[] types = new Type[256];
   long[] instFlags = new long[256];
   Class[][] instExcs = new Class[256][];
