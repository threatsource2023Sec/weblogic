...
import com.bea.core.repackaged.aspectj.weaver.internal.tools.PointcutExpressionImpl;
...
public class PointcutParser {
   ...
   private PointcutParser(Set supportedPointcutKinds) {
      this.supportedPrimitives = supportedPointcutKinds;
      Iterator i$ = supportedPointcutKinds.iterator();

      PointcutPrimitive pointcutPrimitive;
      do {
         if (!i$.hasNext()) {
            this.setClassLoader(PointcutParser.class.getClassLoader());
            return;
         ...
         pointcutPrimitive = (PointcutPrimitive)i$.next();
      } while(pointcutPrimitive != PointcutPrimitive.IF && pointcutPrimitive != PointcutPrimitive.CFLOW && pointcutPrimitive != PointcutPrimitive.CFLOW_BELOW);
   ...
   protected void setClassLoader(ClassLoader aLoader) {
      ...
      this.world = new ReflectionWorld(this.classLoaderReference.getClassLoader());
   }
