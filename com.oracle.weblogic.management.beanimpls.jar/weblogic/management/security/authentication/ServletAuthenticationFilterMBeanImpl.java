...
public class ServletAuthenticationFilterMBeanImpl extends AuthenticationProviderMBeanImpl implements ServletAuthenticationFilterMBean, Serializable {
   ...
   public ServletAuthenticationFilterMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ServletAuthenticationFilterMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AuthenticationProviderMBeanImpl.Helper {
      ...
      protected Helper(ServletAuthenticationFilterMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ServletAuthenticationFilterMBeanImpl var2 = (ServletAuthenticationFilterMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ServletAuthenticationFilterMBeanImpl original = (ServletAuthenticationFilterMBeanImpl)event.getSourceBean();
            ServletAuthenticationFilterMBeanImpl proposed = (ServletAuthenticationFilterMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ServletAuthenticationFilterMBeanImpl copy = (ServletAuthenticationFilterMBeanImpl)initialCopy;
