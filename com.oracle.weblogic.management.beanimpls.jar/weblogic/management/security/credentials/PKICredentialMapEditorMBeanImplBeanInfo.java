...
public class PKICredentialMapEditorMBeanImplBeanInfo extends PKICredentialMapReaderMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = PKICredentialMapEditorMBean.class;

   public PKICredentialMapEditorMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.security.credentials.PKICredentialMapEditorMBeanImpl");
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = PKICredentialMapEditorMBean.class.getMethod("setKeypairCredential", String.class, String.class, Boolean.TYPE, String.class, String.class, char[].class);
      ...
      mth = PKICredentialMapEditorMBean.class.getMethod("setCertificateCredential", String.class, String.class, Boolean.TYPE, String.class, String.class);
      ...
      mth = PKICredentialMapEditorMBean.class.getMethod("removePKICredentialMapping", String.class, String.class, Boolean.TYPE, String.class, String.class);
