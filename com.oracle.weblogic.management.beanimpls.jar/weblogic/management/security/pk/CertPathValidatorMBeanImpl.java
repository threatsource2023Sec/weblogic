...
public class CertPathValidatorMBeanImpl extends CertPathProviderMBeanImpl implements CertPathValidatorMBean, Serializable {
   ...
   public CertPathValidatorMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CertPathValidatorMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends CertPathProviderMBeanImpl.Helper {
      ...
      protected Helper(CertPathValidatorMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CertPathValidatorMBeanImpl var2 = (CertPathValidatorMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CertPathValidatorMBeanImpl original = (CertPathValidatorMBeanImpl)event.getSourceBean();
            CertPathValidatorMBeanImpl proposed = (CertPathValidatorMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CertPathValidatorMBeanImpl copy = (CertPathValidatorMBeanImpl)initialCopy;
