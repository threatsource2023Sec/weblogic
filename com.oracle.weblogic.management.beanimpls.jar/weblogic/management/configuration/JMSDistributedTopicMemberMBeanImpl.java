...
public class JMSDistributedTopicMemberMBeanImpl extends JMSDistributedDestinationMemberMBeanImpl implements JMSDistributedTopicMemberMBean, Serializable {
   ...
   public JMSDistributedTopicMemberMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSDistributedTopicMemberMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public String getJMSTopicAsString() {
      AbstractDescriptorBean bean = (AbstractDescriptorBean)this.getJMSTopic();
   ...
   public void setJMSTopicAsString(String param0) {
      if (param0 != null && param0.length() != 0) {
         param0 = param0 == null ? null : param0.trim();
         this._getReferenceManager().registerUnresolvedReference(param0, JMSTopicMBean.class, new ReferenceManager.Resolver(this, 11) {
            public void resolveReference(Object value) {
               try {
                  JMSDistributedTopicMemberMBeanImpl.this.setJMSTopic((JMSTopicMBean)value);
         ...
         JMSTopicMBean _oldVal = this._JMSTopic;
         this._initializeProperty(11);
         this._postSet(11, _oldVal, this._JMSTopic);
      }

   }

   public void setJMSTopic(JMSTopicMBean param0) throws InvalidAttributeValueException {
      if (param0 != null) {
      ...
      JMSTopicMBean _oldVal = this.getJMSTopic();
      this._customizer.setJMSTopic(param0);
   ...
   public void putValue(String name, Object v) {
      ...
      } else if (name.equals("JMSTopic")) {
         JMSTopicMBean oldVal = this._JMSTopic;
         this._JMSTopic = (JMSTopicMBean)v;
         this._postSet(11, oldVal, this._JMSTopic);
      } else {
         String oldVal;
         if (name.equals("Name")) {
            oldVal = this._Name;
            ...
            JMSDistributedTopicMember oldVal = this._customizer;
            this._customizer = (JMSDistributedTopicMember)v;
         } else {
   ...
   protected static class Helper extends JMSDistributedDestinationMemberMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedTopicMemberMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSDistributedTopicMemberMBeanImpl otherTyped = (JMSDistributedTopicMemberMBeanImpl)other;
            this.computeDiff("JMSTopic", this.bean.getJMSTopic(), otherTyped.getJMSTopic(), true);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSDistributedTopicMemberMBeanImpl original = (JMSDistributedTopicMemberMBeanImpl)event.getSourceBean();
            JMSDistributedTopicMemberMBeanImpl proposed = (JMSDistributedTopicMemberMBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (prop.equals("JMSTopic")) {
                  original.setJMSTopicAsString(proposed.getJMSTopicAsString());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSDistributedTopicMemberMBeanImpl copy = (JMSDistributedTopicMemberMBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("JMSTopic")) && this.bean.isJMSTopicSet()) {
               copy._unSet(copy, 11);
               copy.setJMSTopicAsString(this.bean.getJMSTopicAsString());
            }
      ...
      protected void inferSubTree(Class clazz, Object annotation) {
         ...
         this.inferSubTree(this.bean.getJMSTopic(), clazz, annotation);
      }
   }
}
