...
public class JMSDistributedDestinationMBeanImpl extends JMSVirtualDestinationMBeanImpl implements JMSDistributedDestinationMBean, Serializable {
   ...
   private transient JMSDistributedDestination _customizer;
   ...
   public JMSDistributedDestinationMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSDistributedDestinationMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, TargetMBean.class, new ReferenceManager.Resolver(this, 10, param0) {
                  public void resolveReference(Object value) {
                     try {
                        JMSDistributedDestinationMBeanImpl.this.addTarget((TargetMBean)value);
                        JMSDistributedDestinationMBeanImpl.this._getHelper().reorderArrayObjects((Object[])JMSDistributedDestinationMBeanImpl.this._Targets, this.getHandbackObject());
   ...
   public void setTemplateAsString(String param0) {
      if (param0 != null && param0.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(param0, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 14) {
            public void resolveReference(Object value) {
               try {
                  JMSDistributedDestinationMBeanImpl.this.setTemplate((JMSTemplateMBean)value);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
      ...
      if (name.equals("DynamicallyCreated")) {
         ...
         if (name.equals("JMSTemplate")) {
            ...
            if (name.equals("JNDIName")) {
               ...
               JMSDistributedDestination oldVal = this._customizer;
               this._customizer = (JMSDistributedDestination)v;
            } else {
   ...
   protected static class Helper extends JMSVirtualDestinationMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedDestinationMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("JMSTemplate")) {
            return 13;
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSDistributedDestinationMBeanImpl otherTyped = (JMSDistributedDestinationMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSDistributedDestinationMBeanImpl original = (JMSDistributedDestinationMBeanImpl)event.getSourceBean();
            JMSDistributedDestinationMBeanImpl proposed = (JMSDistributedDestinationMBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (prop.equals("JMSTemplate")) {
                  if (type == 2) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSDistributedDestinationMBeanImpl copy = (JMSDistributedDestinationMBeanImpl)initialCopy;
