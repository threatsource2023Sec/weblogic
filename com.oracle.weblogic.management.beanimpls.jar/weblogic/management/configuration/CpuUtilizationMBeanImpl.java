...
public class CpuUtilizationMBeanImpl extends RCMResourceMBeanImpl implements CpuUtilizationMBean, Serializable {
   private FairShareConstraintMBean _FairShareConstraint;
   private static SchemaHelper2 _schemaHelper;

   public CpuUtilizationMBeanImpl() {
      this._initializeProperty(-1);
   }

   public CpuUtilizationMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CpuUtilizationMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void putValue(String name, Object v) {
      if (name.equals("FairShareConstraint")) {
         ...
         this._postSet(11, oldVal, this._FairShareConstraint);
      } else {
   ...
   public static class SchemaHelper2 extends RCMResourceMBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends RCMResourceMBeanImpl.Helper {
      private CpuUtilizationMBeanImpl bean;

      protected Helper(CpuUtilizationMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         return propName.equals("FairShareConstraint") ? 11 : super.getPropertyIndex(propName);
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CpuUtilizationMBeanImpl otherTyped = (CpuUtilizationMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CpuUtilizationMBeanImpl original = (CpuUtilizationMBeanImpl)event.getSourceBean();
            CpuUtilizationMBeanImpl proposed = (CpuUtilizationMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CpuUtilizationMBeanImpl copy = (CpuUtilizationMBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("FairShareConstraint")) && this.bean.isFairShareConstraintSet() && !copy._isSet(11)) {
