...
public class JMSTopicMBeanImplBeanInfo extends JMSDestinationMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSTopicMBean.class;

   public JMSTopicMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSTopicMBeanImpl");
      ...
      beanDescriptor.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.TopicBean} ");
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a JMS topic (Pub/Sub) destination for a JMS server. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSTopicMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BytesMaximum")) {
         ...
         currentResult = new PropertyDescriptor("BytesMaximum", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("BytesThresholdHigh")) {
         ...
         currentResult = new PropertyDescriptor("BytesThresholdHigh", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("BytesThresholdLow")) {
         ...
         currentResult = new PropertyDescriptor("BytesThresholdLow", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DeliveryModeOverride")) {
         ...
         currentResult = new PropertyDescriptor("DeliveryModeOverride", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DestinationKeys")) {
         ...
         currentResult = new PropertyDescriptor("DestinationKeys", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ErrorDestination")) {
         ...
         currentResult = new PropertyDescriptor("ErrorDestination", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ExpirationLoggingPolicy")) {
         ...
         currentResult = new PropertyDescriptor("ExpirationLoggingPolicy", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ExpirationPolicy")) {
         ...
         currentResult = new PropertyDescriptor("ExpirationPolicy", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("JNDIName")) {
         ...
         currentResult = new PropertyDescriptor("JNDIName", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MaximumMessageSize")) {
         ...
         currentResult = new PropertyDescriptor("MaximumMessageSize", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesMaximum")) {
         ...
         currentResult = new PropertyDescriptor("MessagesMaximum", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesThresholdHigh")) {
         ...
         currentResult = new PropertyDescriptor("MessagesThresholdHigh", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesThresholdLow")) {
         ...
         currentResult = new PropertyDescriptor("MessagesThresholdLow", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MulticastAddress")) {
         ...
         currentResult = new PropertyDescriptor("MulticastAddress", JMSTopicMBean.class, getterName, setterName);
         descriptors.put("MulticastAddress", currentResult);
         currentResult.setValue("description", "<p>The multicast address used by this topic.</p> ");
      ...
      if (!descriptors.containsKey("MulticastPort")) {
         ...
         currentResult = new PropertyDescriptor("MulticastPort", JMSTopicMBean.class, getterName, setterName);
         descriptors.put("MulticastPort", currentResult);
         currentResult.setValue("description", "<p>The multicast port for this topic.</p>  <p>This port is used to transmit messages to multicast consumers.</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PriorityOverride")) {
         ...
         currentResult = new PropertyDescriptor("PriorityOverride", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RedeliveryDelayOverride")) {
         ...
         currentResult = new PropertyDescriptor("RedeliveryDelayOverride", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RedeliveryLimit")) {
         ...
         currentResult = new PropertyDescriptor("RedeliveryLimit", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("StoreEnabled")) {
         ...
         currentResult = new PropertyDescriptor("StoreEnabled", JMSTopicMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Template")) {
         ...
         currentResult = new PropertyDescriptor("Template", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("TimeToDeliverOverride")) {
         ...
         currentResult = new PropertyDescriptor("TimeToDeliverOverride", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("TimeToLiveOverride")) {
         ...
         currentResult = new PropertyDescriptor("TimeToLiveOverride", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSTopicMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("JNDINameReplicated")) {
         ...
         currentResult = new PropertyDescriptor("JNDINameReplicated", JMSTopicMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSTopicMBean.class.getMethod("addDestinationKey", JMSDestinationKeyMBean.class);
      ...
      mth = JMSTopicMBean.class.getMethod("removeDestinationKey", JMSDestinationKeyMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSTopicMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSTopicMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSTopicMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSTopicMBean.class.getMethod("restoreDefaultValue", String.class);
