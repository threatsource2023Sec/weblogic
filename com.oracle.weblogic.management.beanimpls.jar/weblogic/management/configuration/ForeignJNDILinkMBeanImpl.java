...
public class ForeignJNDILinkMBeanImpl extends ConfigurationMBeanImpl implements ForeignJNDILinkMBean, Serializable {
   ...
   public ForeignJNDILinkMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ForeignJNDILinkMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(ForeignJNDILinkMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ForeignJNDILinkMBeanImpl otherTyped = (ForeignJNDILinkMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ForeignJNDILinkMBeanImpl original = (ForeignJNDILinkMBeanImpl)event.getSourceBean();
            ForeignJNDILinkMBeanImpl proposed = (ForeignJNDILinkMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ForeignJNDILinkMBeanImpl copy = (ForeignJNDILinkMBeanImpl)initialCopy;
