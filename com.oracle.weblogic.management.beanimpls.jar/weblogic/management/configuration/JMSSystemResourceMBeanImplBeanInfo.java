...
public class JMSSystemResourceMBeanImplBeanInfo extends SystemResourceMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSSystemResourceMBean.class;

   public JMSSystemResourceMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSSystemResourceMBeanImpl");
      ...
      String description = (new String("This bean defines a system-level JMS resource.  It links a separate descriptor that specifies the definition. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer"), BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSSystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DescriptorFileName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DescriptorFileName", JMSSystemResourceMBean.class, getterName, setterName);
         descriptors.put("DescriptorFileName", currentResult);
         currentResult.setValue("description", "<p>The name of the file that contains the module configuration. By default the file resides in the DOMAIN_DIR/config/jms directory.</p> <p>The module file derives its name from the bean name using the following pattern:</p> <p> &lt;beanName&gt;.xml </p> <p>Note that this is a read-only property that can only be set when the bean is created.</p> ");
         currentResult.setValue("restDerivedDefault", Boolean.TRUE);
         currentResult.setValue("owner", "");
      }

      if (!descriptors.containsKey("JMSResource")) {
         getterName = "getJMSResource";
         setterName = null;
         currentResult = new PropertyDescriptor("JMSResource", JMSSystemResourceMBean.class, getterName, setterName);
         descriptors.put("JMSResource", currentResult);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Resource")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Resource", JMSSystemResourceMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSSystemResourceMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSSystemResourceMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSSystemResourceMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSSystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSSystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
