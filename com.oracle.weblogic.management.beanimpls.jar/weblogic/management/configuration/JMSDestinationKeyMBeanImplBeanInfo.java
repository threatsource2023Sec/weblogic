...
public class JMSDestinationKeyMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSDestinationKeyMBean.class;

   public JMSDestinationKeyMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSDestinationKeyMBeanImpl");
      ...
      beanDescriptor.setValue("deprecated", "8.1.0.0 Replaced by {@link weblogic.j2ee.descriptor.wl.DestinationKeyBean} ");
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a key value for a destination, which is used to define the sort order of messages as they arrive on a destination. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSDestinationKeyMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Direction")) {
         ...
         currentResult = new PropertyDescriptor("Direction", JMSDestinationKeyMBean.class, getterName, setterName);
         descriptors.put("Direction", currentResult);
         currentResult.setValue("description", "<p>The direction (Ascending or Descending) in which this key will sort messages. Select <tt>Ascending</tt> for a FIFO (first in, first out) sort order. Select <tt>Descending</tt> for a LIFO (last in, first out) sort order.</p>  <p><i>Note:</i> This attribute is not dynamically configurable.</p> ");
      ...
      if (!descriptors.containsKey("KeyType")) {
         ...
         currentResult = new PropertyDescriptor("KeyType", JMSDestinationKeyMBean.class, getterName, setterName);
         descriptors.put("KeyType", currentResult);
         currentResult.setValue("description", "<p>The expected sort key type for this JMS destination key. (This field is ignored for message header field keys, which have an implied type.)</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSDestinationKeyMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSDestinationKeyMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSDestinationKeyMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSDestinationKeyMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDestinationKeyMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDestinationKeyMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSDestinationKeyMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSDestinationKeyMBean.class.getMethod("restoreDefaultValue", String.class);
