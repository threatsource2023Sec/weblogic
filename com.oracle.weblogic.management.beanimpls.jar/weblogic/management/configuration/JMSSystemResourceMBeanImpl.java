...
public class JMSSystemResourceMBeanImpl extends SystemResourceMBeanImpl implements JMSSystemResourceMBean, Serializable {
   ...
   private transient JMSSystemResource _customizer;
   private List _DelegateSources = new CopyOnWriteArrayList();
   private JMSSystemResourceMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(JMSSystemResourceMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(JMSSystemResourceMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public JMSSystemResourceMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(JMSSystemResourceMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      JMSSystemResourceMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public JMSSystemResourceMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSSystemResourceMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public String getDescriptorFileName() {
      if (!this._isSet(18) && this._getDelegateBean() != null && this._getDelegateBean()._isSet(18)) {
         ...
         if (!this._isSet(18)) {
            try {
               return JMSModuleBeanHelper.constructDefaultJMSSystemFilename(this.getName());
   ...
   public void setDescriptorFileName(String param0) {
      ...
      while(var4.hasNext()) {
         JMSSystemResourceMBeanImpl source = (JMSSystemResourceMBeanImpl)var4.next();
   ...
   public boolean isJMSResourceInherited() {
      return false;
   }
   ...
   public void setJMSResource(JMSBean param0) throws InvalidAttributeValueException {
      if (this._isTransient() && this._isSynthetic() && this._getDelegateBean() != null) {
         this._untransient();
      }

      this._JMSResource = param0;
   }
   ...
   public void _validate() throws IllegalArgumentException {
      super._validate();
      JMSModuleValidator.validateJMSSystemResource(this);
   }
   ...
   public void putValue(String name, Object v) {
      ...
      if (name.equals("DescriptorFileName")) {
      ...
      } else if (name.equals("JMSResource")) {
         JMSBean oldVal = this._JMSResource;
         this._JMSResource = (JMSBean)v;
         this._postSet(20, oldVal, this._JMSResource);
         ...
         JMSSystemResource oldVal = this._customizer;
         this._customizer = (JMSSystemResource)v;
      } else {
   ...
   protected static class Helper extends SystemResourceMBeanImpl.Helper {
      ...
      protected Helper(JMSSystemResourceMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("DescriptorFileName")) {
            return 18;
         } else if (propName.equals("JMSResource")) {
            return 20;
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isJMSResourceSet()) {
               buf.append("JMSResource");
               buf.append(String.valueOf(this.bean.getJMSResource()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSSystemResourceMBeanImpl otherTyped = (JMSSystemResourceMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSSystemResourceMBeanImpl original = (JMSSystemResourceMBeanImpl)event.getSourceBean();
            JMSSystemResourceMBeanImpl proposed = (JMSSystemResourceMBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (!prop.equals("JMSResource")) {
                  if (prop.equals("Name")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSSystemResourceMBeanImpl copy = (JMSSystemResourceMBeanImpl)initialCopy;
