...
public class JDBCSystemResourceMBeanImplBeanInfo extends SystemResourceMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JDBCSystemResourceMBean.class;

   public JDBCSystemResourceMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JDBCSystemResourceMBeanImpl");
      ...
      String description = (new String("<p>This bean defines a system-level JDBC resource.  It links a separate descriptor that specifies the definition.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JDBCSystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DescriptorFileName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DescriptorFileName", JDBCSystemResourceMBean.class, getterName, setterName);
         descriptors.put("DescriptorFileName", currentResult);
         currentResult.setValue("description", "<p>The name of the file containing this configuration.  This is a relative name rooted at <code>DOMAIN_DIR/config</code>.  By default the file resides in the <code>jdbc</code> subdirectory and derives its name from the bean name using the following pattern:</p>  <p><code>&lt;beanName&gt;.xml</code></p>  <p>Note that this is a read-only property that can only be set when the bean is created.</p> ");
         currentResult.setValue("restDerivedDefault", Boolean.TRUE);
         currentResult.setValue("owner", "");
      }

      if (!descriptors.containsKey("JDBCResource")) {
         getterName = "getJDBCResource";
         setterName = null;
         currentResult = new PropertyDescriptor("JDBCResource", JDBCSystemResourceMBean.class, getterName, setterName);
         descriptors.put("JDBCResource", currentResult);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JDBCSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Resource")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Resource", JDBCSystemResourceMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JDBCSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JDBCSystemResourceMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JDBCSystemResourceMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JDBCSystemResourceMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCSystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JDBCSystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
