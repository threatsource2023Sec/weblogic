...
public class JMSDistributedDestinationMemberMBeanImpl extends ConfigurationMBeanImpl implements JMSDistributedDestinationMemberMBean, Serializable {
   ...
   public JMSDistributedDestinationMemberMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public JMSDistributedDestinationMemberMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public Object getValue(String name) {
      return name.equals("Weight") ? new Integer(this._Weight) : super.getValue(name);
   }
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedDestinationMemberMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         return propName.equals("Weight") ? 10 : super.getPropertyIndex(propName);
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSDistributedDestinationMemberMBeanImpl otherTyped = (JMSDistributedDestinationMemberMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSDistributedDestinationMemberMBeanImpl original = (JMSDistributedDestinationMemberMBeanImpl)event.getSourceBean();
            JMSDistributedDestinationMemberMBeanImpl proposed = (JMSDistributedDestinationMemberMBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (prop.equals("Weight")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSDistributedDestinationMemberMBeanImpl copy = (JMSDistributedDestinationMemberMBeanImpl)initialCopy;
