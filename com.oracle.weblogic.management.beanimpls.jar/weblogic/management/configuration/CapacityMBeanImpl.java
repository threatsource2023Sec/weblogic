...
public class CapacityMBeanImpl extends DeploymentMBeanImpl implements CapacityMBean, Serializable {
   ...
   public CapacityMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CapacityMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DeploymentMBeanImpl.Helper {
      ...
      protected Helper(CapacityMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CapacityMBeanImpl otherTyped = (CapacityMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CapacityMBeanImpl original = (CapacityMBeanImpl)event.getSourceBean();
            CapacityMBeanImpl proposed = (CapacityMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CapacityMBeanImpl copy = (CapacityMBeanImpl)initialCopy;
