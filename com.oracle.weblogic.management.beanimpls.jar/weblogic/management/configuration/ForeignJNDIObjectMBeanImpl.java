...
public class ForeignJNDIObjectMBeanImpl extends ConfigurationMBeanImpl implements ForeignJNDIObjectMBean, Serializable {
   ...
   public ForeignJNDIObjectMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ForeignJNDIObjectMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      ...
      protected Helper(ForeignJNDIObjectMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ForeignJNDIObjectMBeanImpl otherTyped = (ForeignJNDIObjectMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ForeignJNDIObjectMBeanImpl original = (ForeignJNDIObjectMBeanImpl)event.getSourceBean();
            ForeignJNDIObjectMBeanImpl proposed = (ForeignJNDIObjectMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ForeignJNDIObjectMBeanImpl copy = (ForeignJNDIObjectMBeanImpl)initialCopy;
