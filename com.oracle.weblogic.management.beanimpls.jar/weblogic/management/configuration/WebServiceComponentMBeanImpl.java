...
public class WebServiceComponentMBeanImpl extends WebAppComponentMBeanImpl implements WebServiceComponentMBean, Serializable {
   ...
   private transient WebServiceComponent _customizer;
   private List _DelegateSources = new CopyOnWriteArrayList();
   private WebServiceComponentMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(WebServiceComponentMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(WebServiceComponentMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public WebServiceComponentMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(WebServiceComponentMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      WebServiceComponentMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public WebServiceComponentMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public WebServiceComponentMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, TargetMBean.class, new ReferenceManager.Resolver(this, 10, param0) {
                  public void resolveReference(Object value) {
                     try {
                        WebServiceComponentMBeanImpl.this.addTarget((TargetMBean)value);
                        WebServiceComponentMBeanImpl.this._getHelper().reorderArrayObjects((Object[])WebServiceComponentMBeanImpl.this._Targets, this.getHandbackObject());
   ...
   public void setName(String param0) throws InvalidAttributeValueException, ManagementException {
      ...
      while(var4.hasNext()) {
         WebServiceComponentMBeanImpl source = (WebServiceComponentMBeanImpl)var4.next();
   ...
   public void putValue(String name, Object v) {
      ...
      if (name.equals("ActivatedTargets")) {
         ...
         WebServiceComponent oldVal = this._customizer;
         this._customizer = (WebServiceComponent)v;
      } else {
   ...
   protected static class Helper extends WebAppComponentMBeanImpl.Helper {
      ...
      protected Helper(WebServiceComponentMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            WebServiceComponentMBeanImpl otherTyped = (WebServiceComponentMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            WebServiceComponentMBeanImpl original = (WebServiceComponentMBeanImpl)event.getSourceBean();
            WebServiceComponentMBeanImpl proposed = (WebServiceComponentMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            WebServiceComponentMBeanImpl copy = (WebServiceComponentMBeanImpl)initialCopy;
