...
public class JMSTopicMBeanImpl extends JMSDestinationMBeanImpl implements JMSTopicMBean, Serializable {
   ...
   private transient JMSTopic _customizer;
   ...
   public JMSTopicMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSTopicMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, JMSDestinationKeyMBean.class, new ReferenceManager.Resolver(this, 10, param0) {
                  public void resolveReference(Object value) {
                     try {
                        JMSTopicMBeanImpl.this.addDestinationKey((JMSDestinationKeyMBean)value);
                        JMSTopicMBeanImpl.this._getHelper().reorderArrayObjects((Object[])JMSTopicMBeanImpl.this._DestinationKeys, this.getHandbackObject());
   ...
   public void setTemplateAsString(String param0) {
      if (param0 != null && param0.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(param0, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 28) {
            public void resolveReference(Object value) {
               try {
                  JMSTopicMBeanImpl.this.setTemplate((JMSTemplateMBean)value);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public void setMulticastTTL(int param0) throws InvalidAttributeValueException {
      LegalChecks.checkInRange("MulticastTTL", (long)param0, 0L, 255L);
      int _oldVal = this.getMulticastTTL();
      this._customizer.setMulticastTTL(param0);
   ...
   public void setMulticastPort(int param0) throws InvalidAttributeValueException {
      ...
      int _oldVal = this.getMulticastPort();
      this._customizer.setMulticastPort(param0);
   ...
   public void useDelegates(DomainMBean param0, JMSBean param1, TopicBean param2) {
   ...
   public void setErrorDestinationAsString(String param0) {
      if (param0 != null && param0.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(param0, JMSDestinationMBean.class, new ReferenceManager.Resolver(this, 20) {
            public void resolveReference(Object value) {
               try {
                  JMSTopicMBeanImpl.this.setErrorDestination((JMSDestinationMBean)value);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
         ...
         if (name.equals("DeliveryModeOverride")) {
            ...
            if (name.equals("DynamicallyCreated")) {
               ...
               if (name.equals("MaximumMessageSize")) {
                  ...
                  JMSTopic oldVal = this._customizer;
                  this._customizer = (JMSTopic)v;
               } else {
   ...
   protected static class Helper extends JMSDestinationMBeanImpl.Helper {
      ...
      protected Helper(JMSTopicMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSTopicMBeanImpl otherTyped = (JMSTopicMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSTopicMBeanImpl original = (JMSTopicMBeanImpl)event.getSourceBean();
            JMSTopicMBeanImpl proposed = (JMSTopicMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSTopicMBeanImpl copy = (JMSTopicMBeanImpl)initialCopy;
            ...
            if (includeObsolete && (excludeProps == null || !excludeProps.contains("MulticastAddress")) && this.bean.isMulticastAddressSet()) {
               copy.setMulticastAddress(this.bean.getMulticastAddress());
            }

            if (includeObsolete && (excludeProps == null || !excludeProps.contains("MulticastPort")) && this.bean.isMulticastPortSet()) {
               copy.setMulticastPort(this.bean.getMulticastPort());
            }

            if (includeObsolete && (excludeProps == null || !excludeProps.contains("MulticastTTL")) && this.bean.isMulticastTTLSet()) {
