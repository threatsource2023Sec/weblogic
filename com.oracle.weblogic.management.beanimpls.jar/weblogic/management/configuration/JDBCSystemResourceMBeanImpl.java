...
public class JDBCSystemResourceMBeanImpl extends SystemResourceMBeanImpl implements JDBCSystemResourceMBean, Serializable {
   ...
   private transient JDBCSystemResource _customizer;
   private List _DelegateSources = new CopyOnWriteArrayList();
   private JDBCSystemResourceMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(JDBCSystemResourceMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(JDBCSystemResourceMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public JDBCSystemResourceMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(JDBCSystemResourceMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      JDBCSystemResourceMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public JDBCSystemResourceMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JDBCSystemResourceMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public String getDescriptorFileName() {
      if (!this._isSet(18) && this._getDelegateBean() != null && this._getDelegateBean()._isSet(18)) {
         ...
         if (!this._isSet(18)) {
            try {
               return JDBCLegalHelper.constructDefaultJDBCSystemFilename(this.getName(), this);
   ...
   public void setDescriptorFileName(String param0) {
      ...
      while(var4.hasNext()) {
         JDBCSystemResourceMBeanImpl source = (JDBCSystemResourceMBeanImpl)var4.next();
   ...
   public boolean isJDBCResourceInherited() {
      return false;
   }
   ...
   public void setJDBCResource(JDBCDataSourceBean param0) throws InvalidAttributeValueException {
      if (this._isTransient() && this._isSynthetic() && this._getDelegateBean() != null) {
         this._untransient();
      }

      this._JDBCResource = param0;
   }
   ...
   public void putValue(String name, Object v) {
      ...
      if (name.equals("DescriptorFileName")) {
      ...
      } else if (name.equals("JDBCResource")) {
         JDBCDataSourceBean oldVal = this._JDBCResource;
         this._JDBCResource = (JDBCDataSourceBean)v;
         this._postSet(20, oldVal, this._JDBCResource);
         ...
         JDBCSystemResource oldVal = this._customizer;
         this._customizer = (JDBCSystemResource)v;
      } else {
   ...
   protected static class Helper extends SystemResourceMBeanImpl.Helper {
      ...
      protected Helper(JDBCSystemResourceMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("DescriptorFileName")) {
            return 18;
         } else if (propName.equals("JDBCResource")) {
            return 20;
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isJDBCResourceSet()) {
               buf.append("JDBCResource");
               buf.append(String.valueOf(this.bean.getJDBCResource()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JDBCSystemResourceMBeanImpl otherTyped = (JDBCSystemResourceMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JDBCSystemResourceMBeanImpl original = (JDBCSystemResourceMBeanImpl)event.getSourceBean();
            JDBCSystemResourceMBeanImpl proposed = (JDBCSystemResourceMBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (!prop.equals("JDBCResource")) {
                  if (prop.equals("Name")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JDBCSystemResourceMBeanImpl copy = (JDBCSystemResourceMBeanImpl)initialCopy;
