...
public class JMSDistributedQueueMemberMBeanImplBeanInfo extends JMSDistributedDestinationMemberMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSDistributedQueueMemberMBean.class;

   public JMSDistributedQueueMemberMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSDistributedQueueMemberMBeanImpl");
      ...
      String description = (new String("This class represents a JMS distributed queue member, which represents a physical JMS queue as a member of a single distributed set of queues that can be served by multiple WebLogic Server instances within a cluster. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSDistributedQueueMemberMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      String getterName;
      String setterName;
      if (!descriptors.containsKey("JMSQueue")) {
         getterName = "getJMSQueue";
         setterName = null;
         if (!this.readOnly) {
            setterName = "setJMSQueue";
         }

         currentResult = new PropertyDescriptor("JMSQueue", JMSDistributedQueueMemberMBean.class, getterName, setterName);
         descriptors.put("JMSQueue", currentResult);
         currentResult.setValue("description", "<p>The physical JMS queue that is associated with this member of the distributed queue set.</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSDistributedQueueMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSDistributedQueueMemberMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSDistributedQueueMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Weight")) {
         ...
         currentResult = new PropertyDescriptor("Weight", JMSDistributedQueueMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSDistributedQueueMemberMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedQueueMemberMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedQueueMemberMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSDistributedQueueMemberMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSDistributedQueueMemberMBean.class.getMethod("restoreDefaultValue", String.class);
