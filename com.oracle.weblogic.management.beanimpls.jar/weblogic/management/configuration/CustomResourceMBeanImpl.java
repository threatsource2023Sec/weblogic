...
public class CustomResourceMBeanImpl extends SystemResourceMBeanImpl implements CustomResourceMBean, Serializable {
   ...
   private transient CustomResource _customizer;
   ...
   public CustomResourceMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public CustomResourceMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public boolean isResourceClassInherited() {
      return false;
   }
   ...
   public void setResourceClass(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String _oldVal = this._ResourceClass;
      this._ResourceClass = param0;
   ...
   public boolean isDescriptorBeanClassInherited() {
      return false;
   }
   ...
   public void setDescriptorBeanClass(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String _oldVal = this._DescriptorBeanClass;
      this._DescriptorBeanClass = param0;
   ...
   public boolean isCustomResourceInherited() {
      return false;
   }
   ...
   public void setCustomResource(DescriptorBean param0) throws InvalidAttributeValueException {
      this._CustomResource = param0;
   }
   ...
   public void putValue(String name, Object v) {
      DescriptorBean oldVal;
      if (name.equals("CustomResource")) {
         oldVal = this._CustomResource;
         this._CustomResource = (DescriptorBean)v;
         this._postSet(22, oldVal, this._CustomResource);
      } else {
         String oldVal;
         if (name.equals("DescriptorBeanClass")) {
            oldVal = this._DescriptorBeanClass;
            this._DescriptorBeanClass = (String)v;
            this._postSet(21, oldVal, this._DescriptorBeanClass);
            ...
            oldVal = this._ResourceClass;
            this._ResourceClass = (String)v;
            this._postSet(20, oldVal, this._ResourceClass);
         } else if (name.equals("Tags")) {
            String[] oldVal = this._Tags;
            this._Tags = (String[])((String[])v);
            this._postSet(9, oldVal, this._Tags);
         } else if (name.equals("customizer")) {
            CustomResource oldVal = this._customizer;
            this._customizer = (CustomResource)v;
         } else {
   ...
   public Object getValue(String name) {
      ...
      } else if (name.equals("DescriptorBeanClass")) {
         return this._DescriptorBeanClass;
      } else if (name.equals("DescriptorFileName")) {
      ...
      public int getPropertyIndex(String s) {
         switch (s.length()) {
            ...
            case 20:
               ...
               break;
            case 21:
               if (s.equals("descriptor-bean-class")) {
                  return 21;
               }
         }
   ...
   protected static class Helper extends SystemResourceMBeanImpl.Helper {
      ...
      protected Helper(CustomResourceMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("CustomResource")) {
            return 22;
         } else if (propName.equals("DescriptorBeanClass")) {
            return 21;
            ...
            return 19;
         } else if (propName.equals("ResourceClass")) {
            return 20;
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isCustomResourceSet()) {
               buf.append("CustomResource");
               buf.append(String.valueOf(this.bean.getCustomResource()));
            }

            if (this.bean.isDescriptorBeanClassSet()) {
               buf.append("DescriptorBeanClass");
               buf.append(String.valueOf(this.bean.getDescriptorBeanClass()));
            }
            ...
            if (this.bean.isResourceClassSet()) {
               buf.append("ResourceClass");
               buf.append(String.valueOf(this.bean.getResourceClass()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomResourceMBeanImpl otherTyped = (CustomResourceMBeanImpl)other;
            this.computeDiff("DescriptorBeanClass", this.bean.getDescriptorBeanClass(), otherTyped.getDescriptorBeanClass(), false);
            this.computeDiff("DescriptorFileName", this.bean.getDescriptorFileName(), otherTyped.getDescriptorFileName(), false);
            this.computeDiff("Name", this.bean.getName(), otherTyped.getName(), false);
            this.computeDiff("ResourceClass", this.bean.getResourceClass(), otherTyped.getResourceClass(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomResourceMBeanImpl original = (CustomResourceMBeanImpl)event.getSourceBean();
            CustomResourceMBeanImpl proposed = (CustomResourceMBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (!prop.equals("CustomResource")) {
                  if (prop.equals("DescriptorBeanClass")) {
                     original.setDescriptorBeanClass(proposed.getDescriptorBeanClass());
                     ...
                     if (prop.equals("ResourceClass")) {
                        original.setResourceClass(proposed.getResourceClass());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomResourceMBeanImpl copy = (CustomResourceMBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("DescriptorBeanClass")) && this.bean.isDescriptorBeanClassSet()) {
               copy.setDescriptorBeanClass(this.bean.getDescriptorBeanClass());
            }
            ...
            if ((excludeProps == null || !excludeProps.contains("ResourceClass")) && this.bean.isResourceClassSet()) {
               copy.setResourceClass(this.bean.getResourceClass());
            }
      ...
      protected void inferSubTree(Class clazz, Object annotation) {
         ...
         this.inferSubTree(this.bean.getCustomResource(), clazz, annotation);
