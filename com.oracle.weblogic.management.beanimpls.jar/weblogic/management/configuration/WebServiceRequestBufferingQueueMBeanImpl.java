...
public class WebServiceRequestBufferingQueueMBeanImpl extends WebServiceBufferingQueueMBeanImpl implements WebServiceRequestBufferingQueueMBean, Serializable {
   ...
   public WebServiceRequestBufferingQueueMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public WebServiceRequestBufferingQueueMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends WebServiceBufferingQueueMBeanImpl.Helper {
      ...
      protected Helper(WebServiceRequestBufferingQueueMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            WebServiceRequestBufferingQueueMBeanImpl otherTyped = (WebServiceRequestBufferingQueueMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            WebServiceRequestBufferingQueueMBeanImpl original = (WebServiceRequestBufferingQueueMBeanImpl)event.getSourceBean();
            WebServiceRequestBufferingQueueMBeanImpl proposed = (WebServiceRequestBufferingQueueMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            WebServiceRequestBufferingQueueMBeanImpl copy = (WebServiceRequestBufferingQueueMBeanImpl)initialCopy;
