...
public class JMSSAFMessageLogFileMBeanImpl extends LogFileMBeanImpl implements JMSSAFMessageLogFileMBean, Serializable {
   ...
   private transient JMSSAFMessageLogFile _customizer;
   private List _DelegateSources = new CopyOnWriteArrayList();
   private JMSSAFMessageLogFileMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(JMSSAFMessageLogFileMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(JMSSAFMessageLogFileMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public JMSSAFMessageLogFileMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(JMSSAFMessageLogFileMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      JMSSAFMessageLogFileMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public JMSSAFMessageLogFileMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSSAFMessageLogFileMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setName(String param0) throws InvalidAttributeValueException, ManagementException {
      ...
      while(var4.hasNext()) {
         JMSSAFMessageLogFileMBeanImpl source = (JMSSAFMessageLogFileMBeanImpl)var4.next();
   ...
   public String getFileName() {
      if (!this._isSet(11) && this._getDelegateBean() != null && this._getDelegateBean()._isSet(11)) {
         ...
         if (!this._isSet(11)) {
            try {
               return "logs/safagents/" + BeanNameUtil.getShortName(this) + "/" + "jms.messages.log";
            } catch (NullPointerException var2) {
            }
         }
   ...
   public void putValue(String name, Object v) {
      if (name.equals("DynamicallyCreated")) {
         ...
         if (name.equals("FileName")) {
            ...
            JMSSAFMessageLogFile oldVal = this._customizer;
            this._customizer = (JMSSAFMessageLogFile)v;
         } else {
   ...
   protected static class Helper extends LogFileMBeanImpl.Helper {
      ...
      protected Helper(JMSSAFMessageLogFileMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSSAFMessageLogFileMBeanImpl otherTyped = (JMSSAFMessageLogFileMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSSAFMessageLogFileMBeanImpl original = (JMSSAFMessageLogFileMBeanImpl)event.getSourceBean();
            JMSSAFMessageLogFileMBeanImpl proposed = (JMSSAFMessageLogFileMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSSAFMessageLogFileMBeanImpl copy = (JMSSAFMessageLogFileMBeanImpl)initialCopy;
