...
public class WebserviceCredentialProviderMBeanImpl extends WebserviceSecurityConfigurationMBeanImpl implements WebserviceCredentialProviderMBean, Serializable {
   ...
   public WebserviceCredentialProviderMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public WebserviceCredentialProviderMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends WebserviceSecurityConfigurationMBeanImpl.Helper {
      ...
      protected Helper(WebserviceCredentialProviderMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            WebserviceCredentialProviderMBeanImpl var2 = (WebserviceCredentialProviderMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            WebserviceCredentialProviderMBeanImpl original = (WebserviceCredentialProviderMBeanImpl)event.getSourceBean();
            WebserviceCredentialProviderMBeanImpl proposed = (WebserviceCredentialProviderMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            WebserviceCredentialProviderMBeanImpl copy = (WebserviceCredentialProviderMBeanImpl)initialCopy;
