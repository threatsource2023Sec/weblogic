...
public class SystemComponentMBeanImplBeanInfo extends ManagedExternalServerMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = SystemComponentMBean.class;

   public SystemComponentMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public SystemComponentMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.SystemComponentMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.SystemComponentMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ComponentType")) {
         ...
         currentResult = new PropertyDescriptor("ComponentType", SystemComponentMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("10.3.4.0", (String)null, this.targetVersion) && !descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", SystemComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("SystemComponentStart")) {
         getterName = "getSystemComponentStart";
         setterName = null;
         currentResult = new PropertyDescriptor("SystemComponentStart", SystemComponentMBean.class, getterName, setterName);
         descriptors.put("SystemComponentStart", currentResult);
         currentResult.setValue("description", "<p> Returns the SystemComponentStartMBean that can be used to start up this system component server remotely. </p> ");
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", SystemComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", SystemComponentMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = SystemComponentMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = SystemComponentMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = SystemComponentMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = SystemComponentMBean.class.getMethod("restoreDefaultValue", String.class);
