...
public class LibraryMBeanImpl extends AppDeploymentMBeanImpl implements LibraryMBean, Serializable {
   ...
   private LibraryMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(LibraryMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(LibraryMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public LibraryMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(LibraryMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      LibraryMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public LibraryMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public LibraryMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setName(String param0) throws InvalidAttributeValueException, ManagementException {
      ...
      while(var4.hasNext()) {
         LibraryMBeanImpl source = (LibraryMBeanImpl)var4.next();
   ...
   public void setStagingMode(String param0) throws ManagementException {
      ...
      while(var5.hasNext()) {
         LibraryMBeanImpl source = (LibraryMBeanImpl)var5.next();
   ...
   protected static class Helper extends AppDeploymentMBeanImpl.Helper {
      ...
      protected Helper(LibraryMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            LibraryMBeanImpl otherTyped = (LibraryMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            LibraryMBeanImpl original = (LibraryMBeanImpl)event.getSourceBean();
            LibraryMBeanImpl proposed = (LibraryMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            LibraryMBeanImpl copy = (LibraryMBeanImpl)initialCopy;
