...
public class JDBCPoolComponentMBeanImplBeanInfo extends ComponentMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JDBCPoolComponentMBean.class;

   public JDBCPoolComponentMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JDBCPoolComponentMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JDBCPoolComponentMBean");
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JDBCPoolComponentMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      mth = JDBCPoolComponentMBean.class.getMethod("removeTarget", TargetMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JDBCPoolComponentMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JDBCPoolComponentMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("7.0.0.0", (String)null, this.targetVersion)) {
         mth = JDBCPoolComponentMBean.class.getMethod("activated", TargetMBean.class);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("target", (String)null)};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      mth = JDBCPoolComponentMBean.class.getMethod("refreshDDsIfNeeded", String[].class);
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
      ...
      mth = JDBCPoolComponentMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JDBCPoolComponentMBean.class.getMethod("restoreDefaultValue", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
