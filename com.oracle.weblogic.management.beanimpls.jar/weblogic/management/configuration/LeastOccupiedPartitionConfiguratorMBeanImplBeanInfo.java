...
public class LeastOccupiedPartitionConfiguratorMBeanImplBeanInfo extends PartitionConfiguratorMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = LeastOccupiedPartitionConfiguratorMBean.class;

   public LeastOccupiedPartitionConfiguratorMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public LeastOccupiedPartitionConfiguratorMBeanImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.LeastOccupiedPartitionConfiguratorMBeanImpl");
      ...
      String description = (new String("The create-cluster-target-provider configuration in a partition template. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.LeastOccupiedPartitionConfiguratorMBean");
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = LeastOccupiedPartitionConfiguratorMBean.class.getMethod("addTargetResourceGroup", ResourceGroupMBean.class);
      ParameterDescriptor[] parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("resourceGroup", "to add. ")};
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      MethodDescriptor currentResult;
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
         descriptors.put(methodKey, currentResult);
         currentResult.setValue("description", "Adds a resource group on which to set the target. ");
         currentResult.setValue("exclude", Boolean.TRUE);
         currentResult.setValue("role", "collection");
         currentResult.setValue("property", "TargetResourceGroups");
      }

      String[] throwsObjectArray;
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = LeastOccupiedPartitionConfiguratorMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = LeastOccupiedPartitionConfiguratorMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = LeastOccupiedPartitionConfiguratorMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = LeastOccupiedPartitionConfiguratorMBean.class.getMethod("restoreDefaultValue", String.class);
