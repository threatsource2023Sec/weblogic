...
public class ConfigurationMBeanImplBeanInfo extends WebLogicMBeanImplBeanInfo {
   ...
   public ConfigurationMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.ConfigurationMBeanImpl");
