...
public class WLDFSystemResourceMBeanImplBeanInfo extends SystemResourceMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = WLDFSystemResourceMBean.class;

   public WLDFSystemResourceMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.WLDFSystemResourceMBeanImpl");
      ...
      String description = (new String("<p>This bean defines a system-level WebLogic Diagnostic Framework (WLDF) resource.  It links a separate descriptor that specifies the definition.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.WLDFSystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Description")) {
         ...
         currentResult = new PropertyDescriptor("Description", WLDFSystemResourceMBean.class, getterName, setterName);
         descriptors.put("Description", currentResult);
         currentResult.setValue("description", "<p>Optional short description of this WLDFSystemResource. If provided, the WebLogic Server Administration Console will display the resource description.</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", WLDFSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Resource")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Resource", WLDFSystemResourceMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", WLDFSystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("WLDFResource")) {
         getterName = "getWLDFResource";
         setterName = null;
         currentResult = new PropertyDescriptor("WLDFResource", WLDFSystemResourceMBean.class, getterName, setterName);
         descriptors.put("WLDFResource", currentResult);
         currentResult.setValue("description", "<p>A WLDF resource defines a system-level or an application-level diagnostic resource.</p>  <p>A system-level WLDF resource is a diagnostic resource whose scope is system-wide; its descriptor file, by default, resides in the <code><i>DOMAIN_NAME</i>/config/diagnostics</code> directory.</p>  <p>An application-level WLDF resource is a diagnostic resource whose scope is application-wide; its descriptor file, <code>weblogic-diagnostics.xml</code> is contained within the application archive.</p> ");
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", WLDFSystemResourceMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = WLDFSystemResourceMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = WLDFSystemResourceMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WLDFSystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = WLDFSystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
