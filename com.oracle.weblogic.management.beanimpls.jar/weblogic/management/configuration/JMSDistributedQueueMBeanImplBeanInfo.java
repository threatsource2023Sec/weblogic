...
public class JMSDistributedQueueMBeanImplBeanInfo extends JMSDistributedDestinationMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSDistributedQueueMBean.class;

   public JMSDistributedQueueMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSDistributedQueueMBeanImpl");
      ...
      String[] seeObjectArray = new String[]{BeanInfoHelper.encodeEntities("weblogic.j2ee.descriptor.wl.UniformDistributedQueueBean")};
      beanDescriptor.setValue("see", seeObjectArray);
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a JMS distributed queue, which is comprised of multiple physical JMS queues as members of a single distributed set of queues that can be served by multiple WebLogic Server instances within a cluster. ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("ForwardDelay")) {
         ...
         currentResult = new PropertyDescriptor("ForwardDelay", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !descriptors.containsKey("JMSDistributedQueueMembers")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("JMSDistributedQueueMembers", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !descriptors.containsKey("JMSTemplate")) {
         ...
         currentResult = new PropertyDescriptor("JMSTemplate", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("JNDIName")) {
         ...
         currentResult = new PropertyDescriptor("JNDIName", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("LoadBalancingPolicy")) {
         ...
         currentResult = new PropertyDescriptor("LoadBalancingPolicy", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion) && !descriptors.containsKey("Members")) {
         ...
         currentResult = new PropertyDescriptor("Members", JMSDistributedQueueMBean.class, getterName, setterName);
         descriptors.put("Members", currentResult);
         currentResult.setValue("description", "<p>All the members for this distributed queue.</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ResetDeliveryCountOnForward")) {
         ...
         currentResult = new PropertyDescriptor("ResetDeliveryCountOnForward", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Targets")) {
         ...
         currentResult = new PropertyDescriptor("Targets", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Template")) {
         ...
         currentResult = new PropertyDescriptor("Template", JMSDistributedQueueMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSDistributedQueueMBean.class, getterName, setterName);
   ...
   private void fillinFactoryMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("createJMSTemplate", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("destroyJMSTemplate", JMSTemplateMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("createJMSDistributedQueueMember", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("createJMSDistributedQueueMember", String.class, JMSDistributedQueueMemberMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("destroyJMSDistributedQueueMember", JMSDistributedQueueMemberMBean.class);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      String methodKey;
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("addMember", JMSDistributedQueueMemberMBean.class);
         ...
         if (!descriptors.containsKey(methodKey)) {
            ...
            currentResult.setValue("obsolete", "9.0.0.0");
            descriptors.put(methodKey, currentResult);
            currentResult.setValue("description", "<p>Add a member to this distributed queue.</p> ");
      ...
      mth = JMSDistributedQueueMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("removeMember", JMSDistributedQueueMemberMBean.class);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("member", "the JMSDistributedQueueMember to remove from the distributed queue ")};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
            throwsObjectArray = new String[]{BeanInfoHelper.encodeEntities("IllegalArgumentException if the specified member is not a member of this distributed queue")};
            currentResult.setValue("throws", throwsObjectArray);
            currentResult.setValue("obsolete", "9.0.0.0");
            descriptors.put(methodKey, currentResult);
            currentResult.setValue("description", "<p>Remove a member from this distributed queue.</p> ");
            currentResult.setValue("role", "collection");
            currentResult.setValue("property", "Members");
            currentResult.setValue("obsolete", "9.0.0.0");
         }
      ...
      mth = JMSDistributedQueueMBean.class.getMethod("removeTarget", TargetMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinFinderMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSDistributedQueueMBean.class.getMethod("lookupJMSDistributedQueueMember", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      String methodKey;
      if (BeanInfoHelper.isVersionCompliant((String)null, "9.0.0.0", this.targetVersion)) {
         mth = JMSDistributedQueueMBean.class.getMethod("destroyJMSDistributedQueueMember", String.class, JMSDistributedQueueMemberMBean.class);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("name", "name "), createParameterDescriptor("member", "JMSDistributedQueueMember ")};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
            currentResult.setValue("obsolete", "9.0.0.0");
      ...
      mth = JMSDistributedQueueMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSDistributedQueueMBean.class.getMethod("restoreDefaultValue", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
