...
public class GenericFileStoreMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   ...
   public GenericFileStoreMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.GenericFileStoreMBeanImpl");
      ...
      String description = (new String("<p>This MBean defines common parameters for file stores. It is the parent of FileStoreMBean and the deprecated JMSFileStoreMBean.</p> ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BlockSize")) {
         ...
         currentResult = new PropertyDescriptor("BlockSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("CacheDirectory")) {
         ...
         currentResult = new PropertyDescriptor("CacheDirectory", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Directory")) {
         ...
         currentResult = new PropertyDescriptor("Directory", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("InitialSize")) {
         ...
         currentResult = new PropertyDescriptor("InitialSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("IoBufferSize")) {
         ...
         currentResult = new PropertyDescriptor("IoBufferSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MaxFileSize")) {
         ...
         currentResult = new PropertyDescriptor("MaxFileSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MaxWindowBufferSize")) {
         ...
         currentResult = new PropertyDescriptor("MaxWindowBufferSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MinWindowBufferSize")) {
         ...
         currentResult = new PropertyDescriptor("MinWindowBufferSize", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("SynchronousWritePolicy")) {
         ...
         currentResult = new PropertyDescriptor("SynchronousWritePolicy", GenericFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("FileLockingEnabled")) {
         ...
         currentResult = new PropertyDescriptor("FileLockingEnabled", GenericFileStoreMBean.class, getterName, setterName);
