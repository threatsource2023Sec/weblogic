...
public class JMSJDBCStoreMBeanImplBeanInfo extends JMSStoreMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSJDBCStoreMBean.class;

   public JMSJDBCStoreMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSJDBCStoreMBeanImpl");
      ...
      beanDescriptor.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.management.configuration.JDBCStoreMBean} ");
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a JMS JDBC store for storing persistent messages and durable subscribers in a JDBC-accessible database. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSJDBCStoreMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("CreateTableDDLFile")) {
         ...
         currentResult = new PropertyDescriptor("CreateTableDDLFile", JMSJDBCStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSJDBCStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PrefixName")) {
         ...
         currentResult = new PropertyDescriptor("PrefixName", JMSJDBCStoreMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSJDBCStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSJDBCStoreMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSJDBCStoreMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSJDBCStoreMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSJDBCStoreMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSJDBCStoreMBean.class.getMethod("restoreDefaultValue", String.class);
