...
public class HeapRetainedMBeanImpl extends RCMResourceMBeanImpl implements HeapRetainedMBean, Serializable {
   private FairShareConstraintMBean _FairShareConstraint;
   private static SchemaHelper2 _schemaHelper;

   public HeapRetainedMBeanImpl() {
      this._initializeProperty(-1);
   }

   public HeapRetainedMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public HeapRetainedMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends RCMResourceMBeanImpl.Helper {
      private HeapRetainedMBeanImpl bean;

      protected Helper(HeapRetainedMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            HeapRetainedMBeanImpl otherTyped = (HeapRetainedMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            HeapRetainedMBeanImpl original = (HeapRetainedMBeanImpl)event.getSourceBean();
            HeapRetainedMBeanImpl proposed = (HeapRetainedMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            HeapRetainedMBeanImpl copy = (HeapRetainedMBeanImpl)initialCopy;
