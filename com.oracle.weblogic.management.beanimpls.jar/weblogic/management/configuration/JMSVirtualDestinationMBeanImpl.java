...
public class JMSVirtualDestinationMBeanImpl extends DeploymentMBeanImpl implements JMSVirtualDestinationMBean, Serializable {
   ...
   public JMSVirtualDestinationMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public JMSVirtualDestinationMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DeploymentMBeanImpl.Helper {
      ...
      protected Helper(JMSVirtualDestinationMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSVirtualDestinationMBeanImpl otherTyped = (JMSVirtualDestinationMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSVirtualDestinationMBeanImpl original = (JMSVirtualDestinationMBeanImpl)event.getSourceBean();
            JMSVirtualDestinationMBeanImpl proposed = (JMSVirtualDestinationMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSVirtualDestinationMBeanImpl copy = (JMSVirtualDestinationMBeanImpl)initialCopy;
