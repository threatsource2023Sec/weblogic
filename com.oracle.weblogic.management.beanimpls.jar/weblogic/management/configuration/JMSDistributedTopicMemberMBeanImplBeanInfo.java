...
public class JMSDistributedTopicMemberMBeanImplBeanInfo extends JMSDistributedDestinationMemberMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSDistributedTopicMemberMBean.class;

   public JMSDistributedTopicMemberMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSDistributedTopicMemberMBeanImpl");
      ...
      String description = (new String("This class represents a JMS distributed topic member, which represents a physical JMS topic as a member of single distributed set of topics that can be served by multiple WebLogic Server instances within a cluster. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSDistributedTopicMemberMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("JMSTopic")) {
         ...
         currentResult = new PropertyDescriptor("JMSTopic", JMSDistributedTopicMemberMBean.class, getterName, setterName);
         descriptors.put("JMSTopic", currentResult);
         currentResult.setValue("description", "<p>The physical JMS topic associated with this member of the distributed topic set.</p> ");
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSDistributedTopicMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSDistributedTopicMemberMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSDistributedTopicMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Weight")) {
         ...
         currentResult = new PropertyDescriptor("Weight", JMSDistributedTopicMemberMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSDistributedTopicMemberMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedTopicMemberMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSDistributedTopicMemberMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSDistributedTopicMemberMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSDistributedTopicMemberMBean.class.getMethod("restoreDefaultValue", String.class);
