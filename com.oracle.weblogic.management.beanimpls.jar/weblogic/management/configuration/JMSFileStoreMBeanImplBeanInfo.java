...
public class JMSFileStoreMBeanImplBeanInfo extends JMSStoreMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSFileStoreMBean.class;

   public JMSFileStoreMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSFileStoreMBeanImpl");
      ...
      beanDescriptor.setValue("deprecated", "9.0.0.0 Replaced by {@link weblogic.management.configuration.FileStoreMBean} ");
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a JMS file store that stores persistent messages and durable subscribers in a file-system directory. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSFileStoreMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BlockSize")) {
         ...
         currentResult = new PropertyDescriptor("BlockSize", JMSFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("IoBufferSize")) {
         ...
         currentResult = new PropertyDescriptor("IoBufferSize", JMSFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MinWindowBufferSize")) {
         getterName = "getMinWindowBufferSize";
         setterName = null;
         if (!this.readOnly) {
            setterName = "setMinWindowBufferSize";
         }

         currentResult = new PropertyDescriptor("MinWindowBufferSize", JMSFileStoreMBean.class, getterName, setterName);
         descriptors.put("MinWindowBufferSize", currentResult);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSFileStoreMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSFileStoreMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("FileLockingEnabled")) {
         getterName = "isFileLockingEnabled";
         setterName = null;
         if (!this.readOnly) {
            setterName = "setFileLockingEnabled";
         }

         currentResult = new PropertyDescriptor("FileLockingEnabled", JMSFileStoreMBean.class, getterName, setterName);
         descriptors.put("FileLockingEnabled", currentResult);
         ...
         String[] seeObjectArray = new String[]{BeanInfoHelper.encodeEntities("#getDirectory"), BeanInfoHelper.encodeEntities("#getCacheDirectory")};
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSFileStoreMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSFileStoreMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSFileStoreMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSFileStoreMBean.class.getMethod("restoreDefaultValue", String.class);
