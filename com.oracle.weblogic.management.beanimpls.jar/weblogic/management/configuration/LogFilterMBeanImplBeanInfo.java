...
public class LogFilterMBeanImplBeanInfo extends ConfigurationMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = LogFilterMBean.class;

   public LogFilterMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.LogFilterMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.LogFilterMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", LogFilterMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", LogFilterMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", LogFilterMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = LogFilterMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = LogFilterMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = LogFilterMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = LogFilterMBean.class.getMethod("restoreDefaultValue", String.class);
