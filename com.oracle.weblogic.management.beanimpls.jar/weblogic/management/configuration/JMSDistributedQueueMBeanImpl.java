...
public class JMSDistributedQueueMBeanImpl extends JMSDistributedDestinationMBeanImpl implements JMSDistributedQueueMBean, Serializable {
   ...
   private transient JMSDistributedQueue _customizer;
   ...
   public JMSDistributedQueueMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public JMSDistributedQueueMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
      ...
      if (param0 != null && param0.length() != 0) {
         ...
         for(int i = 0; i < refs.length; ++i) {
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, JMSDistributedQueueMemberMBean.class, new ReferenceManager.Resolver(this, 16, param0) {
                  public void resolveReference(Object value) {
                     try {
                        JMSDistributedQueueMBeanImpl.this.addMember((JMSDistributedQueueMemberMBean)value);
                        JMSDistributedQueueMBeanImpl.this._getHelper().reorderArrayObjects((Object[])JMSDistributedQueueMBeanImpl.this._Members, this.getHandbackObject());
         ...
         while(true) {
            while(var14.hasNext()) {
               ...
               for(int var8 = 0; var8 < var7; ++var8) {
                  JMSDistributedQueueMemberMBean member = var6[var8];
         ...
         JMSDistributedQueueMemberMBean[] _oldVal = this._Members;
         ...
         for(int i = 0; i < refs.length; ++i) {
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, TargetMBean.class, new ReferenceManager.Resolver(this, 10, param0) {
                  public void resolveReference(Object value) {
                     try {
                        JMSDistributedQueueMBeanImpl.this.addTarget((TargetMBean)value);
                        JMSDistributedQueueMBeanImpl.this._getHelper().reorderArrayObjects((Object[])JMSDistributedQueueMBeanImpl.this._Targets, this.getHandbackObject());
                     } catch (RuntimeException var3) {
                        throw var3;
                     } catch (Exception var4) {
                        throw new AssertionError("Impossible exception: " + var4);
   ...
   public void setMembers(JMSDistributedQueueMemberMBean[] param0) throws InvalidAttributeValueException {
      JMSDistributedQueueMemberMBean[] param0 = param0 == null ? new JMSDistributedQueueMemberMBeanImpl[0] : param0;
      JMSDistributedQueueMemberMBean[] _oldVal = this.getMembers();
      this._customizer.setMembers((JMSDistributedQueueMemberMBean[])param0);
   ...
   public boolean addMember(JMSDistributedQueueMemberMBean param0) throws InvalidAttributeValueException, DistributedManagementException {
   ...
   public boolean removeMember(JMSDistributedQueueMemberMBean param0) throws InvalidAttributeValueException, DistributedManagementException {
   ...
   public void setTemplateAsString(String param0) {
      if (param0 != null && param0.length() != 0) {
         ...
         this._getReferenceManager().registerUnresolvedReference(param0, JMSTemplateMBean.class, new ReferenceManager.Resolver(this, 14) {
            public void resolveReference(Object value) {
               try {
                  JMSDistributedQueueMBeanImpl.this.setTemplate((JMSTemplateMBean)value);
               } catch (RuntimeException var3) {
                  throw var3;
               } catch (Exception var4) {
                  throw new AssertionError("Impossible exception: " + var4);
   ...
   public void useDelegates(DistributedQueueBean param0, SubDeploymentMBean param1) {
   ...
   public void destroyJMSDistributedQueueMember(String param0, JMSDistributedQueueMemberMBean param1) {
      this._customizer.destroyJMSDistributedQueueMember(param0, param1);
   }
   ...
   public void setForwardDelay(int param0) throws InvalidAttributeValueException {
      int _oldVal = this.getForwardDelay();
      this._customizer.setForwardDelay(param0);
   ...
   public void setResetDeliveryCountOnForward(boolean param0) throws InvalidAttributeValueException {
      boolean _oldVal = this.getResetDeliveryCountOnForward();
      this._customizer.setResetDeliveryCountOnForward(param0);
   ...
   public void putValue(String name, Object v) {
      ...
      } else if (name.equals("ForwardDelay")) {
         int oldVal = this._ForwardDelay;
         this._ForwardDelay = (Integer)v;
         this._postSet(18, oldVal, this._ForwardDelay);
      } else {
         JMSDistributedQueueMemberMBean[] oldVal;
         if (name.equals("JMSDistributedQueueMembers")) {
            oldVal = this._JMSDistributedQueueMembers;
            this._JMSDistributedQueueMembers = (JMSDistributedQueueMemberMBean[])((JMSDistributedQueueMemberMBean[])v);
            this._postSet(17, oldVal, this._JMSDistributedQueueMembers);
         } else {
            ...
            if (name.equals("JMSTemplate")) {
               ...
               if (name.equals("JNDIName")) {
                  ...
                  this._Members = (JMSDistributedQueueMemberMBean[])((JMSDistributedQueueMemberMBean[])v);
               ...
               } else if (name.equals("ResetDeliveryCountOnForward")) {
                  oldVal = this._ResetDeliveryCountOnForward;
                  this._ResetDeliveryCountOnForward = (Boolean)v;
                  this._postSet(19, oldVal, this._ResetDeliveryCountOnForward);
                  ...
                  JMSDistributedQueue oldVal = this._customizer;
                  this._customizer = (JMSDistributedQueue)v;
               } else {
   ...
   protected static class Helper extends JMSDistributedDestinationMBeanImpl.Helper {
      ...
      protected Helper(JMSDistributedQueueMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("ForwardDelay")) {
            ...
            return 3;
         } else if (propName.equals("ResetDeliveryCountOnForward")) {
            return 19;
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JMSDistributedQueueMBeanImpl otherTyped = (JMSDistributedQueueMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JMSDistributedQueueMBeanImpl original = (JMSDistributedQueueMBeanImpl)event.getSourceBean();
            JMSDistributedQueueMBeanImpl proposed = (JMSDistributedQueueMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JMSDistributedQueueMBeanImpl copy = (JMSDistributedQueueMBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if (includeObsolete && (excludeProps == null || !excludeProps.contains("ForwardDelay")) && this.bean.isForwardDelaySet()) {
               copy.setForwardDelay(this.bean.getForwardDelay());
            }

            if (includeObsolete && (excludeProps == null || !excludeProps.contains("JMSDistributedQueueMembers")) && this.bean.isJMSDistributedQueueMembersSet() && !copy._isSet(17)) {
               ...
               for(int i = 0; i < newJMSDistributedQueueMembers.length; ++i) {
            ...
            if (includeObsolete && (excludeProps == null || !excludeProps.contains("ResetDeliveryCountOnForward")) && this.bean.isResetDeliveryCountOnForwardSet()) {
