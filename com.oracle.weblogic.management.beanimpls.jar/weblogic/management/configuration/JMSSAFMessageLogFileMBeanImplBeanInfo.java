...
public class JMSSAFMessageLogFileMBeanImplBeanInfo extends LogFileMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSSAFMessageLogFileMBean.class;

   public JMSSAFMessageLogFileMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSSAFMessageLogFileMBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.JMSSAFMessageLogFileMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("FileName")) {
         ...
         currentResult = new PropertyDescriptor("FileName", JMSSAFMessageLogFileMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSSAFMessageLogFileMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSSAFMessageLogFileMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSSAFMessageLogFileMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSSAFMessageLogFileMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSSAFMessageLogFileMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSSAFMessageLogFileMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSSAFMessageLogFileMBean.class.getMethod("restoreDefaultValue", String.class);
      ...
      mth = JMSSAFMessageLogFileMBean.class.getMethod("computeLogFilePath");
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
