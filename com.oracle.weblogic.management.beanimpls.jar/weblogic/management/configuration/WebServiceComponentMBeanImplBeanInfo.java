...
public class WebServiceComponentMBeanImplBeanInfo extends WebAppComponentMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = WebServiceComponentMBean.class;

   public WebServiceComponentMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.WebServiceComponentMBeanImpl");
      ...
      String description = (new String("<p>Provides the interface used to configure a Web service that is deployed on a WebLogic Server instance.</p>  <p>A Web service is a special kind of Java EE Web Application that contains an additional deployment descriptor, web-services.xml, that describes the Web service. Because a Web service is packaged as a Java EE Web application, its component MBean is the same as that of a Web application, and thus simply extends the WebAppComponentMBean interface, adding no new methods.</p>  <p>WebLogic Server instantiates this interface only when you deploy a Web service.</p>  <p>This interface can configure Web services that are deployed as WAR files or exploded directories.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      String[] roleObjectArray = new String[]{BeanInfoHelper.encodeEntities("Deployer")};
      beanDescriptor.setValue("rolesAllowed", roleObjectArray);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.WebServiceComponentMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (BeanInfoHelper.isVersionCompliant("7.0.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("ActivatedTargets")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ActivatedTargets", WebServiceComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Application")) {
         ...
         currentResult = new PropertyDescriptor("Application", WebServiceComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", WebServiceComponentMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", WebServiceComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Targets")) {
         ...
         currentResult = new PropertyDescriptor("Targets", WebServiceComponentMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", WebServiceComponentMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = WebServiceComponentMBean.class.getMethod("addTarget", TargetMBean.class);
      ...
      mth = WebServiceComponentMBean.class.getMethod("removeTarget", TargetMBean.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = WebServiceComponentMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = WebServiceComponentMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("7.0.0.0", (String)null, this.targetVersion)) {
         mth = WebServiceComponentMBean.class.getMethod("activated", TargetMBean.class);
         parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("target", (String)null)};
         methodKey = BeanInfoHelper.buildMethodKey(mth);
         if (!descriptors.containsKey(methodKey)) {
            currentResult = new MethodDescriptor(mth, parameterDescriptors);
      ...
      mth = WebServiceComponentMBean.class.getMethod("refreshDDsIfNeeded", String[].class);
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
      ...
      mth = WebServiceComponentMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = WebServiceComponentMBean.class.getMethod("restoreDefaultValue", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
