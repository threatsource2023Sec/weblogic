...
public class DomainLibraryMBeanImplBeanInfo extends LibraryMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = DomainLibraryMBean.class;

   public DomainLibraryMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.DomainLibraryMBeanImpl");
      ...
      String description = (new String("Configuration bean for Libraries. ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.DomainLibraryMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("AbsoluteAltDescriptorDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsoluteAltDescriptorDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("AbsoluteAltDescriptorPath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsoluteAltDescriptorPath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AbsoluteInstallDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsoluteInstallDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AbsolutePlanDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsolutePlanDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AbsolutePlanPath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsolutePlanPath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AbsoluteSourcePath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AbsoluteSourcePath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AppMBean")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AppMBean", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ApplicationIdentifier")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ApplicationIdentifier", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ApplicationName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ApplicationName", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ConfiguredApplicationIdentifier")) {
         ...
         currentResult = new PropertyDescriptor("ConfiguredApplicationIdentifier", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DeploymentPlan")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentPlan", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DeploymentPlanExternalDescriptors")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeploymentPlanExternalDescriptors", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("LocalAltDescriptorPath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LocalAltDescriptorPath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("LocalInstallDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LocalInstallDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("LocalPlanDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LocalPlanDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("LocalPlanPath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LocalPlanPath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("LocalSourcePath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LocalSourcePath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PlanDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PlanDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PlanPath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PlanPath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PlanStagingMode")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("PlanStagingMode", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RootStagingDir")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RootStagingDir", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("SourcePath")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SourcePath", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("StagingMode")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("StagingMode", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("VersionIdentifier")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("VersionIdentifier", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("AutoDeployedApp")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("AutoDeployedApp", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", DomainLibraryMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MultiVersionApp")) {
         ...
         currentResult = new PropertyDescriptor("MultiVersionApp", DomainLibraryMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = DomainLibraryMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = DomainLibraryMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = DomainLibraryMBean.class.getMethod("createPlan", String.class);
      ...
      mth = DomainLibraryMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = DomainLibraryMBean.class.getMethod("createPlan");
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
      ...
      mth = DomainLibraryMBean.class.getMethod("restoreDefaultValue", String.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("attributeName", (String)null)};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      ...
      mth = DomainLibraryMBean.class.getMethod("getStagingMode", String.class);
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
