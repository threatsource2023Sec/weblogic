...
public class ParameterMBeanImpl extends ConfigurationMBeanImpl implements ParameterMBean, Serializable {
   private String _Description;
   private String _Name;
   private String _Value;
   private static SchemaHelper2 _schemaHelper;

   public ParameterMBeanImpl() {
      this._initializeProperty(-1);
   }

   public ParameterMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ParameterMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void putValue(String name, Object v) {
      ...
      if (name.equals("Description")) {
         ...
         this._postSet(11, oldVal, this._Description);
   ...
   protected static class Helper extends ConfigurationMBeanImpl.Helper {
      private ParameterMBeanImpl bean;

      protected Helper(ParameterMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ParameterMBeanImpl otherTyped = (ParameterMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ParameterMBeanImpl original = (ParameterMBeanImpl)event.getSourceBean();
            ParameterMBeanImpl proposed = (ParameterMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ParameterMBeanImpl copy = (ParameterMBeanImpl)initialCopy;
