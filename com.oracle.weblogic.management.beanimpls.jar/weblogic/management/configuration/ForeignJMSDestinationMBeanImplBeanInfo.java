...
public class ForeignJMSDestinationMBeanImplBeanInfo extends ForeignJNDIObjectMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = ForeignJMSDestinationMBean.class;

   public ForeignJMSDestinationMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.ForeignJMSDestinationMBeanImpl");
      ...
      beanDescriptor.setValue("deprecated", "9.0.0.0 Replaced by the ForeignDestinationBean type in the new JMS module. ");
      beanDescriptor.setValue("package", "weblogic.management.configuration");
      String description = (new String("This class represents a JMS destination that may be found on a remote server. The destination can represent a queue or a topic. When the destination is looked up on the local server, a look-up will be performed automatically on the remote JNDI directory, and the object will be returned from that directory. <p>This MBean will always be a sub-element of the ForeignJMSServer.</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.ForeignJMSDestinationMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("LocalJNDIName")) {
         ...
         currentResult = new PropertyDescriptor("LocalJNDIName", ForeignJMSDestinationMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", ForeignJMSDestinationMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RemoteJNDIName")) {
         ...
         currentResult = new PropertyDescriptor("RemoteJNDIName", ForeignJMSDestinationMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", ForeignJMSDestinationMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", ForeignJMSDestinationMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = ForeignJMSDestinationMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = ForeignJMSDestinationMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = ForeignJMSDestinationMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = ForeignJMSDestinationMBean.class.getMethod("restoreDefaultValue", String.class);
