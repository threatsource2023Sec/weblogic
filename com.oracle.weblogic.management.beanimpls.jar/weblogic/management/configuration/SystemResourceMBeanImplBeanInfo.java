...
public class SystemResourceMBeanImplBeanInfo extends BasicDeploymentMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = SystemResourceMBean.class;

   public SystemResourceMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.SystemResourceMBeanImpl");
      ...
      String description = (new String("<p>A system resource is a resource whose definition is part of the system configuration rather than an application. The descriptor for the resource is linked through config.xml but resides in a separate descriptor file. The beans representing this descriptor are exposed through JMX</p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "weblogic.management.configuration.SystemResourceMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DescriptorFileName")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DescriptorFileName", SystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", SystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Resource")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Resource", SystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("SourcePath")) {
         ...
         currentResult = new PropertyDescriptor("SourcePath", SystemResourceMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", SystemResourceMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", SystemResourceMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = SystemResourceMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = SystemResourceMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = SystemResourceMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = SystemResourceMBean.class.getMethod("restoreDefaultValue", String.class);
