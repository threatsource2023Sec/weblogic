...
public class DataSourceLogFileMBeanImpl extends LogFileMBeanImpl implements DataSourceLogFileMBean, Serializable {
   ...
   private transient DataSourceLogFile _customizer;
   private List _DelegateSources = new CopyOnWriteArrayList();
   private DataSourceLogFileMBeanImpl _DelegateBean;
   private static SchemaHelper2 _schemaHelper;

   public void _addDelegateSource(DataSourceLogFileMBeanImpl source) {
      this._DelegateSources.add(source);
   }

   public void _removeDelegateSource(DataSourceLogFileMBeanImpl source) {
      this._DelegateSources.remove(source);
   }

   public DataSourceLogFileMBeanImpl _getDelegateBean() {
      return this._DelegateBean;
   }

   public void _setDelegateBean(DataSourceLogFileMBeanImpl delegate) {
      super._setDelegateBean(delegate);
      DataSourceLogFileMBeanImpl oldDelegate = this._DelegateBean;
   ...
   public DataSourceLogFileMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
   ...
   public DataSourceLogFileMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setName(String param0) throws InvalidAttributeValueException, ManagementException {
      ...
      while(var4.hasNext()) {
         DataSourceLogFileMBeanImpl source = (DataSourceLogFileMBeanImpl)var4.next();
   ...
   public void putValue(String name, Object v) {
      if (name.equals("DynamicallyCreated")) {
         ...
         if (name.equals("FileName")) {
            ...
            DataSourceLogFile oldVal = this._customizer;
            this._customizer = (DataSourceLogFile)v;
         } else {
   ...
   protected static class Helper extends LogFileMBeanImpl.Helper {
      ...
      protected Helper(DataSourceLogFileMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            DataSourceLogFileMBeanImpl otherTyped = (DataSourceLogFileMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            DataSourceLogFileMBeanImpl original = (DataSourceLogFileMBeanImpl)event.getSourceBean();
            DataSourceLogFileMBeanImpl proposed = (DataSourceLogFileMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            DataSourceLogFileMBeanImpl copy = (DataSourceLogFileMBeanImpl)initialCopy;
