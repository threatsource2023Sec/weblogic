...
public class TransactionLogStoreMBeanImpl extends PersistentStoreMBeanImpl implements TransactionLogStoreMBean, Serializable {
   ...
   public TransactionLogStoreMBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public TransactionLogStoreMBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
            ...
            if (oldRefs.contains(ref)) {
               ...
               this._getReferenceManager().registerUnresolvedReference(ref, TargetMBean.class, new ReferenceManager.Resolver(this, 10, param0) {
                  public void resolveReference(Object value) {
                     try {
                        TransactionLogStoreMBeanImpl.this.addTarget((TargetMBean)value);
                        TransactionLogStoreMBeanImpl.this._getHelper().reorderArrayObjects((Object[])TransactionLogStoreMBeanImpl.this._Targets, this.getHandbackObject());
   ...
   protected static class Helper extends PersistentStoreMBeanImpl.Helper {
      ...
      protected Helper(TransactionLogStoreMBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            TransactionLogStoreMBeanImpl otherTyped = (TransactionLogStoreMBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            TransactionLogStoreMBeanImpl original = (TransactionLogStoreMBeanImpl)event.getSourceBean();
            TransactionLogStoreMBeanImpl proposed = (TransactionLogStoreMBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            TransactionLogStoreMBeanImpl copy = (TransactionLogStoreMBeanImpl)initialCopy;
