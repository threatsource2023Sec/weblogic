...
public class JMSTemplateMBeanImplBeanInfo extends JMSDestCommonMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = JMSTemplateMBean.class;

   public JMSTemplateMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.configuration.JMSTemplateMBeanImpl");
      ...
      String description = (new String("This class represents a JMS template, which provides an efficient means of defining multiple destinations (queues and topics) with similar attribute settings. ")).intern();
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BytesMaximum")) {
         ...
         currentResult = new PropertyDescriptor("BytesMaximum", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("BytesThresholdHigh")) {
         ...
         currentResult = new PropertyDescriptor("BytesThresholdHigh", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("BytesThresholdLow")) {
         ...
         currentResult = new PropertyDescriptor("BytesThresholdLow", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DeliveryModeOverride")) {
         ...
         currentResult = new PropertyDescriptor("DeliveryModeOverride", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Destinations")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Destinations", JMSTemplateMBean.class, getterName, setterName);
         descriptors.put("Destinations", currentResult);
         currentResult.setValue("description", "<p>Returns a read-only array of the destinations for the JMS template.</p> ");
      ...
      if (!descriptors.containsKey("ErrorDestination")) {
         ...
         currentResult = new PropertyDescriptor("ErrorDestination", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ExpirationLoggingPolicy")) {
         ...
         currentResult = new PropertyDescriptor("ExpirationLoggingPolicy", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("ExpirationPolicy")) {
         ...
         currentResult = new PropertyDescriptor("ExpirationPolicy", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MaximumMessageSize")) {
         ...
         currentResult = new PropertyDescriptor("MaximumMessageSize", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesMaximum")) {
         ...
         currentResult = new PropertyDescriptor("MessagesMaximum", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesThresholdHigh")) {
         ...
         currentResult = new PropertyDescriptor("MessagesThresholdHigh", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesThresholdLow")) {
         ...
         currentResult = new PropertyDescriptor("MessagesThresholdLow", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Name")) {
         ...
         currentResult = new PropertyDescriptor("Name", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("Notes")) {
         ...
         currentResult = new PropertyDescriptor("Notes", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("PriorityOverride")) {
         ...
         currentResult = new PropertyDescriptor("PriorityOverride", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RedeliveryDelayOverride")) {
         ...
         currentResult = new PropertyDescriptor("RedeliveryDelayOverride", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("RedeliveryLimit")) {
         ...
         currentResult = new PropertyDescriptor("RedeliveryLimit", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Tags")) {
         ...
         currentResult = new PropertyDescriptor("Tags", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("TimeToDeliverOverride")) {
         ...
         currentResult = new PropertyDescriptor("TimeToDeliverOverride", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("TimeToLiveOverride")) {
         ...
         currentResult = new PropertyDescriptor("TimeToLiveOverride", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("BytesPagingEnabled")) {
         ...
         currentResult = new PropertyDescriptor("BytesPagingEnabled", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("DynamicallyCreated")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DynamicallyCreated", JMSTemplateMBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MessagesPagingEnabled")) {
         ...
         currentResult = new PropertyDescriptor("MessagesPagingEnabled", JMSTemplateMBean.class, getterName, setterName);
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSTemplateMBean.class.getMethod("addDestination", JMSDestinationMBean.class);
      ParameterDescriptor[] parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("destination", "a reference to  JMSDestinationMBean ")};
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      MethodDescriptor currentResult;
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
         descriptors.put(methodKey, currentResult);
         currentResult.setValue("description", "<p>Adds a destination to the JMS template.</p> ");
         currentResult.setValue("role", "collection");
         currentResult.setValue("property", "Destinations");
      }

      mth = JMSTemplateMBean.class.getMethod("removeDestination", JMSDestinationMBean.class);
      parameterDescriptors = new ParameterDescriptor[]{createParameterDescriptor("destination", "a reference to  JMSDestinationMBean ")};
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, parameterDescriptors);
         descriptors.put(methodKey, currentResult);
         currentResult.setValue("description", "<p>Removes a destination from the JMS template.</p> ");
         currentResult.setValue("role", "collection");
         currentResult.setValue("property", "Destinations");
      }
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSTemplateMBean.class.getMethod("addTag", String.class);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion)) {
         mth = JMSTemplateMBean.class.getMethod("removeTag", String.class);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = JMSTemplateMBean.class.getMethod("freezeCurrentValue", String.class);
      ...
      mth = JMSTemplateMBean.class.getMethod("restoreDefaultValue", String.class);
