...
public final class DispatcherImpl_14110_WLStub extends Stub implements StubInfoIntf, DispatcherRemote, DispatcherOneWay {
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md5 = new MethodDescriptor(m[5], class$weblogic$messaging$dispatcher$DispatcherRemote == null ? (class$weblogic$messaging$dispatcher$DispatcherRemote = class$("weblogic.messaging.dispatcher.DispatcherRemote")) : class$weblogic$messaging$dispatcher$DispatcherRemote, true, true, false, false, var0.getTimeOut(m[5]), var0.getRemoteRef().getObjectID(), false, var0.getRemoteExceptionWrapperClassName(m[5]));
