...
public abstract class AbstractResponseShellAction extends AbstractProfileAction {
   @Nonnull
   ...
   protected void doExecute(@Nonnull ProfileRequestContext profileRequestContext) {
      ...
      SAMLObjectBuilder responseBuilder = (SAMLObjectBuilder)bf.getBuilderOrThrow(this.getMessageType());
      ...
      StatusResponseType response = (StatusResponseType)responseBuilder.buildObject();
