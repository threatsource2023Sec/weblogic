...
public interface DownloadedSchemasDocument extends XmlObject {
   ...
   public interface DownloadedSchemas extends XmlObject {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DownloadedSchemas.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLTOOLS").resolveHandle("downloadedschemasb3efelemtype");
