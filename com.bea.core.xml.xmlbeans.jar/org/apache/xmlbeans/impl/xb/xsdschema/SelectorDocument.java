...
public interface SelectorDocument extends XmlObject {
   ...
   public interface Selector extends Annotated {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Selector.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("selector233felemtype");
      ...
      public interface Xpath extends XmlToken {
         SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Xpath.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("xpath6f9aattrtype");
