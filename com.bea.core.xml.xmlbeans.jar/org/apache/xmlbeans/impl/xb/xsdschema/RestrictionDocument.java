...
public interface RestrictionDocument extends XmlObject {
   ...
   public interface Restriction extends Annotated {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Restriction.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("restrictionad11elemtype");
