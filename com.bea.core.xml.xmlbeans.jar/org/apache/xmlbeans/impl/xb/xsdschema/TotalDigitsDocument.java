...
public interface TotalDigitsDocument extends XmlObject {
   ...
   public interface TotalDigits extends NumFacet {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TotalDigits.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("totaldigits2615elemtype");
