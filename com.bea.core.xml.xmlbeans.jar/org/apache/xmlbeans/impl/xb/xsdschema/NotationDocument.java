...
public interface NotationDocument extends XmlObject {
   ...
   public interface Notation extends Annotated {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Notation.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("notation8b1felemtype");
