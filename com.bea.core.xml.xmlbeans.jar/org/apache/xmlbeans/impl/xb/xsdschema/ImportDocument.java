...
public interface ImportDocument extends XmlObject {
   ...
   public interface Import extends Annotated {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Import.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sXMLSCHEMA").resolveHandle("importe2ffelemtype");
