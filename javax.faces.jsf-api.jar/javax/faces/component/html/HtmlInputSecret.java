...
public class HtmlInputSecret extends UIInput {
   ...
   public boolean isRedisplay() {
      if (null != this.redisplay) {
         ...
         ValueExpression _ve = this.getValueExpression("redisplay");
         return _ve != null ? (Boolean)_ve.getValue(this.getFacesContext().getELContext()) : false;
      }
   }
   ...
   public Object saveState(FacesContext _context) {
      ...
      this._values[24] = this.redisplay;
      this._values[25] = this.size;
      this._values[26] = this.style;
      this._values[27] = this.styleClass;
      this._values[28] = this.tabindex;
   ...
   public void restoreState(FacesContext _context, Object _state) {
      ...
      this.redisplay = (Boolean)this._values[24];
      this.size = (Integer)this._values[25];
      this.style = (String)this._values[26];
      this.styleClass = (String)this._values[27];
      this.tabindex = (String)this._values[28];
