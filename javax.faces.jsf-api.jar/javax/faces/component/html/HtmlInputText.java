...
public class HtmlInputText extends UIInput {
   ...
   public String getAutocomplete() {
      if (null != this.autocomplete) {
         ...
         ValueExpression _ve = this.getValueExpression("autocomplete");
         return _ve != null ? (String)_ve.getValue(this.getFacesContext().getELContext()) : null;
      }
   }
   ...
   public int getMaxlength() {
      if (null != this.maxlength) {
         ...
         ValueExpression _ve = this.getValueExpression("maxlength");
   ...
   public int getSize() {
      if (null != this.size) {
         ...
         ValueExpression _ve = this.getValueExpression("size");
         return _ve != null ? (Integer)_ve.getValue(this.getFacesContext().getELContext()) : Integer.MIN_VALUE;
      }
   }
   ...
   public Object saveState(FacesContext _context) {
      ...
      this._values[23] = this.readonly;
      this._values[24] = this.size;
   ...
   public void restoreState(FacesContext _context, Object _state) {
      ...
      this.maxlength = (Integer)this._values[8];
      ...
      this.readonly = (Boolean)this._values[23];
      this.size = (Integer)this._values[24];
