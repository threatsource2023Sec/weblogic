...
public class HtmlDataTable extends UIData {
   ...
   public Object saveState(FacesContext _context) {
      ...
      this._values[8] = this.dir;
      this._values[9] = this.footerClass;
      this._values[10] = this.frame;
      this._values[11] = this.headerClass;
      this._values[12] = this.lang;
      this._values[13] = this.onclick;
      this._values[14] = this.ondblclick;
      this._values[15] = this.onkeydown;
      this._values[16] = this.onkeypress;
      this._values[17] = this.onkeyup;
      this._values[18] = this.onmousedown;
      this._values[19] = this.onmousemove;
      this._values[20] = this.onmouseout;
      this._values[21] = this.onmouseover;
      this._values[22] = this.onmouseup;
      this._values[23] = this.rowClasses;
      this._values[24] = this.rules;
      this._values[25] = this.style;
      this._values[26] = this.styleClass;
      this._values[27] = this.summary;
      this._values[28] = this.title;
      this._values[29] = this.width;
      return this._values;
   }
   ...
   public void restoreState(FacesContext _context, Object _state) {
      ...
      this.dir = (String)this._values[8];
      this.footerClass = (String)this._values[9];
      this.frame = (String)this._values[10];
      this.headerClass = (String)this._values[11];
      this.lang = (String)this._values[12];
      this.onclick = (String)this._values[13];
      this.ondblclick = (String)this._values[14];
      this.onkeydown = (String)this._values[15];
      this.onkeypress = (String)this._values[16];
      this.onkeyup = (String)this._values[17];
      this.onmousedown = (String)this._values[18];
      this.onmousemove = (String)this._values[19];
      this.onmouseout = (String)this._values[20];
      this.onmouseover = (String)this._values[21];
      this.onmouseup = (String)this._values[22];
      this.rowClasses = (String)this._values[23];
      this.rules = (String)this._values[24];
      this.style = (String)this._values[25];
      this.styleClass = (String)this._values[26];
      this.summary = (String)this._values[27];
      this.title = (String)this._values[28];
      this.width = (String)this._values[29];
   }
