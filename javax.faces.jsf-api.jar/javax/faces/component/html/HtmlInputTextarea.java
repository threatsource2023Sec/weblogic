...
public class HtmlInputTextarea extends UIInput {
   ...
   public int getCols() {
      if (null != this.cols) {
         ...
         ValueExpression _ve = this.getValueExpression("cols");
   ...
   public int getRows() {
      if (null != this.rows) {
         ...
         ValueExpression _ve = this.getValueExpression("rows");
         return _ve != null ? (Integer)_ve.getValue(this.getFacesContext().getELContext()) : Integer.MIN_VALUE;
      }
   }
   ...
   public Object saveState(FacesContext _context) {
      ...
      this._values[2] = this.cols;
      this._values[3] = this.dir;
      this._values[4] = this.disabled;
      this._values[5] = this.label;
      this._values[6] = this.lang;
      this._values[7] = this.onblur;
      this._values[8] = this.onchange;
      ...
      this._values[20] = this.onselect;
      this._values[21] = this.readonly;
      this._values[22] = this.rows;
   ...
   public void restoreState(FacesContext _context, Object _state) {
      ...
      this.cols = (Integer)this._values[2];
      this.dir = (String)this._values[3];
      this.disabled = (Boolean)this._values[4];
      this.label = (String)this._values[5];
      this.lang = (String)this._values[6];
      this.onblur = (String)this._values[7];
      this.onchange = (String)this._values[8];
      ...
      this.onselect = (String)this._values[20];
      this.readonly = (Boolean)this._values[21];
      this.rows = (Integer)this._values[22];
