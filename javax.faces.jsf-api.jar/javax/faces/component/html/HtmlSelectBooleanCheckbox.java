...
public class HtmlSelectBooleanCheckbox extends UISelectBoolean {
   ...
   public Object saveState(FacesContext _context) {
      ...
      this._values[4] = this.label;
      this._values[5] = this.lang;
      this._values[6] = this.onblur;
      this._values[7] = this.onchange;
      this._values[8] = this.onclick;
      this._values[9] = this.ondblclick;
      this._values[10] = this.onfocus;
      this._values[11] = this.onkeydown;
      this._values[12] = this.onkeypress;
      this._values[13] = this.onkeyup;
      this._values[14] = this.onmousedown;
      this._values[15] = this.onmousemove;
      this._values[16] = this.onmouseout;
      this._values[17] = this.onmouseover;
      this._values[18] = this.onmouseup;
      this._values[19] = this.onselect;
      this._values[20] = this.readonly;
      this._values[21] = this.style;
      this._values[22] = this.styleClass;
      this._values[23] = this.tabindex;
      this._values[24] = this.title;
      return this._values;
   }
   ...
   public void restoreState(FacesContext _context, Object _state) {
      ...
      this.label = (String)this._values[4];
      this.lang = (String)this._values[5];
      this.onblur = (String)this._values[6];
      this.onchange = (String)this._values[7];
      this.onclick = (String)this._values[8];
      this.ondblclick = (String)this._values[9];
      this.onfocus = (String)this._values[10];
      this.onkeydown = (String)this._values[11];
      this.onkeypress = (String)this._values[12];
      this.onkeyup = (String)this._values[13];
      this.onmousedown = (String)this._values[14];
      this.onmousemove = (String)this._values[15];
      this.onmouseout = (String)this._values[16];
      this.onmouseover = (String)this._values[17];
      this.onmouseup = (String)this._values[18];
      this.onselect = (String)this._values[19];
      this.readonly = (Boolean)this._values[20];
      this.style = (String)this._values[21];
      this.styleClass = (String)this._values[22];
      this.tabindex = (String)this._values[23];
      this.title = (String)this._values[24];
   }
