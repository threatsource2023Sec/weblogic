...
public class InputSecretTag extends UIComponentELTag {
   ...
   protected void setProperties(UIComponent component) {
      ...
      if (this.alt != null) {
         input.setValueExpression("alt", this.alt);
      }

      if (this.autocomplete != null) {
         input.setValueExpression("autocomplete", this.autocomplete);
      }
      ...
      if (this.maxlength != null) {
         input.setValueExpression("maxlength", this.maxlength);
      }
      ...
      if (this.redisplay != null) {
         input.setValueExpression("redisplay", this.redisplay);
      }

      if (this.role != null) {
         input.setValueExpression("role", this.role);
      }

      if (this.size != null) {
         input.setValueExpression("size", this.size);
      }
