...
public class SelectOneRadioTag extends UIComponentELTag {
   ...
   protected void setProperties(UIComponent component) {
      ...
      if (this.border != null) {
         selectone.setValueExpression("border", this.border);
      }
      ...
      if (this.group != null) {
         selectone.setValueExpression("group", this.group);
      }

      if (this.hideNoSelectionOption != null) {
         selectone.setValueExpression("hideNoSelectionOption", this.hideNoSelectionOption);
      }
      ...
      if (this.layout != null) {
         selectone.setValueExpression("layout", this.layout);
      }
      ...
      if (this.role != null) {
         selectone.setValueExpression("role", this.role);
      }
