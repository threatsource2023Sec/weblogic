...
class MessageFactory {
   ...
   static FacesMessage getMessage(Locale locale, String messageId, Object... params) {
      ...
      String bundleName;
      if (null != (bundleName = app.getMessageBundle()) && null != (bundle = ResourceBundle.getBundle(bundleName, locale, getCurrentLoader(appClass)))) {
         try {
      ...
      if (null == summary) {
         bundle = ResourceBundle.getBundle("javax.faces.Messages", locale, getCurrentLoader(appClass));
         if (null == bundle) {
      ...
      if (summary == null) {
         bundle = ResourceBundle.getBundle("com.sun.faces.resources.Messages", locale, getCurrentLoader(appClass));
         if (null == bundle) {
            throw new NullPointerException();
         }
