         ...
         if (value == null) {
            ...
            if (value.length() < 1) {
               ...
               try {
                  ...
                  throw new ConverterException(MessageFactory.getMessage(context, "javax.faces.converter.ShortConverter.SHORT", value, "32456", MessageFactory.getLabel(context, component)), var5);
