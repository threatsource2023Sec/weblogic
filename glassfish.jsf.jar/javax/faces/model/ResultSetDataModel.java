...
public class ResultSetDataModel extends DataModel {
   ...
   private static class ResultSetMap extends TreeMap {
      ...
      public ResultSetMap(ResultSetDataModel model, Comparator comparator) throws SQLException {
         ...
         model.resultSet.absolute(this.index + 1);
      ...
      public Object get(Object key) {
         if (!this.containsKey(key)) {
            ...
            try {
               ...
               return this.model.resultSet.getObject((String)this.realKey(key));
      ...
      public Object put(String key, Object value) {
         if (!this.containsKey(key)) {
            ...
            try {
               this.model.resultSet.absolute(this.index + 1);
               Object previous = this.model.resultSet.getObject((String)this.realKey(key));
               if (previous == null && value == null) {
                  return previous;
               } else if (previous != null && value != null && previous.equals(value)) {
                  return previous;
               } else {
                  this.model.resultSet.updateObject((String)this.realKey(key), value);
                  this.model.updated();
                  return previous;
               }
