...
public class ResourceRefMBeanImpl extends XMLElementMBeanDelegate implements ResourceRefMBean {
   ...
   public void setResSharingScope(String value) {
      ...
      String old = this.resSharingScope;
      this.resSharingScope = value;
      this.isSet_resSharingScope = value != null;
      this.checkChange("resSharingScope", old, this.resSharingScope);
   }
   ...
   public String toXML(int indentLevel) {
      ...
      if ((this.isSet_resSharingScope || !"Shareable".equals(this.getResSharingScope())) && null != this.getResSharingScope()) {
         result.append(ToXML.indent(indentLevel + 2)).append("<res-sharing-scope>").append(this.getResSharingScope()).append("</res-sharing-scope>\n");
      }
