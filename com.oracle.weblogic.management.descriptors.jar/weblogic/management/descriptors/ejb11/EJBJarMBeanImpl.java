...
public class EJBJarMBeanImpl extends XMLElementMBeanDelegate implements EJBJarMBean {
   ...
   public void setEnterpriseBeans(EnterpriseBeansMBean value) {
      EnterpriseBeansMBean old = this.enterpriseBeans;
   ...
   public void setAssemblyDescriptor(AssemblyDescriptorMBean value) {
      AssemblyDescriptorMBean old = this.assemblyDescriptor;
