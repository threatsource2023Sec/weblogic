...
public class AppClientModuleMBeanImplBeanInfo extends J2EEModuleMBeanImplBeanInfo {
   ...
   public AppClientModuleMBeanImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.management.j2ee.internal.AppClientModuleMBeanImpl");
