...
public class RegistryXMLEventFactory extends XMLEventFactory {
   private XMLEventFactory delegate = null;

   public RegistryXMLEventFactory() {
      try {
         RegistryEntityResolver registry = new RegistryEntityResolver();
         this.delegate = registry.getXMLEventFactory();
      } catch (XMLRegistryException var2) {
         XMLLogger.logXMLRegistryException(var2.getMessage());
      }

      if (this.delegate == null) {
         this.delegate = new WebLogicXMLEventFactory();
      }
