...
public class RSASHA1Verify {
   ...
   static {
      log = Logger.getLogger(class$com$trilead$ssh2$signature$RSASHA1Verify == null ? (class$com$trilead$ssh2$signature$RSASHA1Verify = class$("com.trilead.ssh2.signature.RSASHA1Verify")) : class$com$trilead$ssh2$signature$RSASHA1Verify);
   }
}
