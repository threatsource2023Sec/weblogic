...
public class DSASHA1Verify {
   ...
   static {
      log = Logger.getLogger(class$com$trilead$ssh2$signature$DSASHA1Verify == null ? (class$com$trilead$ssh2$signature$DSASHA1Verify = class$("com.trilead.ssh2.signature.DSASHA1Verify")) : class$com$trilead$ssh2$signature$DSASHA1Verify);
   }
}
