...
public class JMSMessageExpireLogRecord extends JMSMessageLogRecord {
   public JMSMessageExpireLogRecord(long eventTimeMillisStamp, long eventTimeNanoStamp, String logMsg, String jmsDest, String jmsMsgId, String jmsCorrelationId, String user, String subscriptionName, Xid xid) {
