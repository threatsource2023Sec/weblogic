...
class UserLockoutCoordinationServiceConfigHelper {
   static String getServiceName(RealmMBean realmMBean) {
      return UserLockoutCoordinationServiceConfigHelper.class.getName() + "_" + realmMBean.getName() + "_" + realmMBean.getUserLockoutManager().getName();
   }
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, ClassLoader cssImplLoader, String wlsLifecycleImplLoaderName, RealmMBean realmMBean) {
      ServiceEngineManagedServiceConfig serviceConfig = serviceEngineConfig.addServiceEngineManagedServiceConfig(getServiceName(realmMBean), UserLockoutCoordinationServiceImpl.class.getName(), true);
   ...
   private static class ConfigImpl implements UserLockoutCoordinationServiceConfig {
