...
class SAMLKeyServiceConfigHelper {
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, ClassLoader cssImplLoader, String lifecycleImplLoaderName, RealmMBean realmMBean, AuthenticatedSubject kernelId) {
      ServiceEngineManagedServiceConfig serviceConfig = serviceEngineConfig.addServiceEngineManagedServiceConfig(getServiceName(cssImplLoader, realmMBean), SAMLKeyServiceImpl.class.getName(), true);
