...
class LDAPSSLSocketFactoryLookupServiceConfigHelper {
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, ClassLoader cssImplLoader, String lifecycleImplLoaderName, RealmMBean realmMBean, AuthenticatedSubject kernelId) {
      ServiceEngineManagedServiceConfig serviceConfig = serviceEngineConfig.addServiceEngineManagedServiceConfig(getServiceName(cssImplLoader, realmMBean), LDAPSSLSocketFactoryLookupServiceImpl.class.getName(), true);
