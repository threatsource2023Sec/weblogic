...
class UserLockoutRuntimeServiceConfigHelper {
   static String getServiceName(RealmMBean realmMBean) {
      return UserLockoutRuntimeServiceConfigHelper.class.getName() + "_" + realmMBean.getName() + "_" + realmMBean.getUserLockoutManager().getName();
   }
   ...
   static void addToConfig(ServiceEngineConfig serviceEngineConfig, ClassLoader cssImplLoader, String wlsLifecycleImplLoaderName, RealmMBean realmMBean) {
      ServiceEngineManagedServiceConfig serviceConfig = serviceEngineConfig.addServiceEngineManagedServiceConfig(getServiceName(realmMBean), UserLockoutRuntimeServiceImpl.class.getName(), true);
   ...
   private static class ConfigImpl implements UserLockoutRuntimeServiceConfig {
