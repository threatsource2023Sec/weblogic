...
/** @deprecated */
public class VeriSignCZAG extends X509V3Extension implements CertExtension {
   private String value;
   ASN1Template asn1TemplateValue;

   /** @deprecated */
   public VeriSignCZAG() {
      this.extensionTypeFlag = 109;
      this.criticality = false;
      this.setSpecialOID(VERISIGN_CZAG_OID);
      this.extensionTypeString = "VeriSignCZAG";
   }

   /** @deprecated */
   public VeriSignCZAG(String var1, boolean var2) {
      this.extensionTypeFlag = 109;
      var2 = false;
      this.setSpecialOID(VERISIGN_CZAG_OID);
   ...
   /** @deprecated */
   public void setCZAG(String var1) {
      if (var1 != null) {
         this.value = var1;
      }
   ...
   public void decodeValue(byte[] var1, int var2) throws CertificateException {
      if (var1 == null) {
         ...
         try {
            ...
            throw new CertificateException("Could not decode VeriSignCZAG extension.");
         }
      }
   }
   ...
   public Object clone() throws CloneNotSupportedException {
      VeriSignCZAG var1 = new VeriSignCZAG();
