...
/** @deprecated */
public class VeriSignFidelityUniqueID extends X509V3Extension implements CertExtension {
   ...
   /** @deprecated */
   public VeriSignFidelityUniqueID(String var1, boolean var2) {
      this.extensionTypeFlag = 110;
      var2 = false;
      this.setSpecialOID(VERISIGN_FIDELITY_ID_OID);
   ...
   /** @deprecated */
   public void setFidelityUniqueID(String var1) {
      if (var1 != null) {
         this.value = var1;
      }
   ...
   public Object clone() throws CloneNotSupportedException {
      VeriSignFidelityUniqueID var1 = new VeriSignFidelityUniqueID();
