...
/** @deprecated */
public class VeriSignNetscapeInBoxV1 extends X509V3Extension implements CertExtension {
   private String value;
   ASN1Template asn1TemplateValue;

   /** @deprecated */
   public VeriSignNetscapeInBoxV1() {
      this.extensionTypeFlag = 111;
      this.criticality = false;
      this.setSpecialOID(VERISIGN_NETSCAPE_INBOX_V1_OID);
      this.extensionTypeString = "VeriSignNetscapeInBoxV1";
   }

   /** @deprecated */
   public VeriSignNetscapeInBoxV1(String var1, boolean var2) {
      this.extensionTypeFlag = 111;
      var2 = false;
      this.setSpecialOID(VERISIGN_NETSCAPE_INBOX_V1_OID);
   ...
   /** @deprecated */
   public void setNetscapeInBox(String var1) {
      if (var1 != null) {
         this.value = var1;
      }
   ...
   public void decodeValue(byte[] var1, int var2) throws CertificateException {
      if (var1 == null) {
         ...
         try {
            ...
            throw new CertificateException("Could not decode VeriSignNetscapeInBoxV1 extension.");
         }
      }
   }
   ...
   public Object clone() throws CloneNotSupportedException {
      VeriSignNetscapeInBoxV1 var1 = new VeriSignNetscapeInBoxV1();
