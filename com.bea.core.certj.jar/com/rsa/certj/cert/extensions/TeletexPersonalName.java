...
/** @deprecated */
public class TeletexPersonalName implements Serializable, Cloneable {
   ...
   /** @deprecated */
   public TeletexPersonalName(byte[] var1, int var2, int var3) throws NameException {
      this.special = var3;
      if (var1 == null) {
         ...
         try {
            ...
            TeletexStringContainer var5 = new TeletexStringContainer(8388608, 1, 40);
            TeletexStringContainer var6 = new TeletexStringContainer(8454145, 1, 16);
            TeletexStringContainer var7 = new TeletexStringContainer(8454146, 1, 5);
            TeletexStringContainer var8 = new TeletexStringContainer(8454147, 1, 3);
   ...
   private int derEncodeInit() {
      if (this.asn1Template != null) {
         ...
         try {
            ...
            TeletexStringContainer var4 = new TeletexStringContainer(8388608, true, 0, this.surname, 1, 40);
            TeletexStringContainer var5 = null;
            TeletexStringContainer var6 = null;
            TeletexStringContainer var7 = null;
            if (this.givenName != null) {
               var7 = new TeletexStringContainer(8454145, true, 0, this.givenName, 1, 16);
               var1 = 1;
            }

            if (this.initials != null) {
               var6 = new TeletexStringContainer(8454146, true, 0, this.initials, 1, 5);
               if (var1 == 0) {
                  var1 = 2;
               } else {
                  var1 = 3;
            ...
            if (this.generation != null) {
               var5 = new TeletexStringContainer(8454147, true, 0, this.generation, 1, 3);
               if (var1 == 0) {
                  var1 = 4;
               } else if (var1 == 1) {
                  var1 = 5;
   ...
   public boolean equals(Object var1) {
      if (var1 != null && var1 instanceof TeletexPersonalName) {
         TeletexPersonalName var2 = (TeletexPersonalName)var1;
         if (this.surname != null) {
   ...
   public Object clone() throws CloneNotSupportedException {
      TeletexPersonalName var1 = new TeletexPersonalName();
      if (this.surname != null) {
