...
public class VeriSignCRSRecipientNonce extends X501Attribute {
   ...
   /** @deprecated */
   public VeriSignCRSRecipientNonce(byte[] var1, int var2, int var3) {
      this();
      this.setRecipientNonce(var1, var2, var3);
   }
   ...
   /** @deprecated */
   public void setRecipientNonce(byte[] var1, int var2, int var3) {
      this.reset();
      if (var1 != null && var3 != 0) {
   ...
   public Object clone() throws CloneNotSupportedException {
      VeriSignCRSRecipientNonce var1 = new VeriSignCRSRecipientNonce();
      if (this.nonce != null) {
   ...
   public boolean equals(Object var1) {
      if (var1 != null && var1 instanceof VeriSignCRSRecipientNonce) {
         VeriSignCRSRecipientNonce var2 = (VeriSignCRSRecipientNonce)var1;
