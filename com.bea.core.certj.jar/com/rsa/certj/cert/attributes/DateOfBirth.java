...
/** @deprecated */
public class DateOfBirth extends X501Attribute {
   ...
   /** @deprecated */
   public DateOfBirth(Date var1) {
      this();
      this.setDateOfBirth(var1);
   }
   ...
   protected void decodeValue(byte[] var1, int var2) throws AttributeException {
      if (var1 == null) {
         ...
         GenTimeContainer var5 = new GenTimeContainer(0);
         ASN1Container[] var6 = new ASN1Container[]{var3, var5, var4};

         try {
            ASN1.berDecode(var1, var2, var6);
         } catch (ASN_Exception var8) {
            throw new AttributeException("Could not BER decode DateOfBirth.", var8);
         }

         this.theDate = new Date(var5.theTime.getTime());
      }
   }

   /** @deprecated */
   public void setDateOfBirth(Date var1) {
      if (var1 != null) {
         this.reset();
         this.theDate = new Date(var1.getTime());
      }
   ...
   public Date getDateOfBirth() {
      return this.theDate == null ? null : new Date(this.theDate.getTime());
   }
   ...
   protected int derEncodeValueInit() {
      ...
      if (this.theDate == null) {
         ...
         GenTimeContainer var2 = new GenTimeContainer(0, true, 0, this.theDate);
   ...
   public Object clone() throws CloneNotSupportedException {
      DateOfBirth var1 = new DateOfBirth();
      if (this.theDate != null) {
         var1.theDate = new Date(this.theDate.getTime());
      }
   ...
   public boolean equals(Object var1) {
      if (var1 != null && var1 instanceof DateOfBirth) {
         DateOfBirth var2 = (DateOfBirth)var1;
         if (this.theDate == null) {
            return var2.theDate == null;
         } else {
            return var2.theDate == null ? false : this.theDate.equals(var2.theDate);
         }
      } else {
         return false;
      }
   ...
   public int hashCode() {
      ...
      var2 = var1 * var2 + CertJInternalHelper.hashCodeValue(this.theDate);
      return var2;
   }
