...
public class RegexpURLValidator implements ConstraintValidator {
   ...
   public boolean isValid(CharSequence value, ConstraintValidatorContext constraintValidatorContext) {
      if (value != null && value.length() != 0) {
         ...
         if (values == null) {
            return false;
         } else if (!DomainNameUtil.isValidDomainAddress(values.getHost())) {
            return false;
         } else if (this.protocol != null && this.protocol.length() > 0 && !this.protocol.equals(values.getProtocol())) {
            return false;
         } else if (this.host != null && this.host.length() > 0 && !this.host.equals(values.getHost())) {
            return false;
         } else {
