...
CREATE TABLE LIFECYCLE_RUNTIME_PROPERTY(
  ...
  CONSTRAINT runtimepp_fkey FOREIGN KEY (NAME) REFERENCES LIFECYCLE_RUNTIME(NAME)) ;
...
CREATE TABLE LIFECYCLE_PARTITION(
  ...
  CREATED_ON TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  UPDATED_ON TIMESTAMP NULL,
  CONSTRAINT partitions_fkey FOREIGN KEY (RUNTIME_NAME) REFERENCES LIFECYCLE_RUNTIME(NAME)) ;
...
CREATE TABLE LIFECYCLE_PARTITION_PROPERTY(
  ...
  CONSTRAINT partitionpp_fkey FOREIGN KEY (ID) REFERENCES LIFECYCLE_PARTITION(ID)) ;
...
CREATE TABLE LIFECYCLE_PARTITION_REF(
  ...
  CONSTRAINT LIFECYCLE_PR_pk PRIMARY KEY (ENVIRONMENT_NAME, ID)) ;
...
CREATE TABLE LIFECYCLE_SERVICE(
  ...
  NAME VARCHAR(100),
  ENVIRONMENT_REF VARCHAR(100),
  TENANT_ID VARCHAR(100) NOT NULL,
  CREATED_ON TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  UPDATED_ON TIMESTAMP NULL,
  CONSTRAINT SERVICE_ENVIRONMENT_FKEY FOREIGN KEY (ENVIRONMENT_REF) REFERENCES LIFECYCLE_ENVIRONMENT(NAME),
  CONSTRAINT SERVICE_TENANT_FKEY FOREIGN KEY (TENANT_ID) REFERENCES LIFECYCLE_TENANT(ID)) ;
...
CREATE TABLE LIFECYCLE_PDB(
  ...
  CREATED_ON TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL,
  UPDATED_ON TIMESTAMP NULL,
  CONSTRAINT PDB_SERVICE_FKEY FOREIGN KEY (SERVICE_ID) REFERENCES LIFECYCLE_SERVICE(ID)) ;
...
CREATE TABLE LIFECYCLE_ASSOCIATION(
  ...
  CONSTRAINT ASSOC2_FKEY FOREIGN KEY (PARTITION2) REFERENCES LIFECYCLE_PARTITION(ID)) ;
...
CREATE TABLE LIFECYCLE_SERVICE_RESOURCE(
  ...
  CONSTRAINT RES_SERV_FKEY2 FOREIGN KEY (TENANT_ID) REFERENCES LIFECYCLE_TENANT(ID),
  CONSTRAINT LIFECYCLE_SR_pk PRIMARY KEY(NAME, SERVICE_ID, TENANT_ID)) ;
...
CREATE TABLE LIFECYCLE_SRESOURCE_PROPERTY(
  ...
  CONSTRAINT LIFECYCLE_SRPP_pk PRIMARY KEY (SERVICE_ID, RESOURCE_NAME, TENANT_ID, PROPERTYNAME)) ;
...
CREATE TABLE LIFECYCLE_TRESOURCE_PROPERTY(
  ...
  CONSTRAINT LIFECYCLE_TRPP_fk FOREIGN KEY (NAME) REFERENCES LIFECYCLE_TENANT_RESOURCE(NAME)) ;
