...
public class SuccessfulImageSourceBeanImpl extends AbstractDescriptorBean implements SuccessfulImageSourceBean, Serializable {
   ...
   public SuccessfulImageSourceBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SuccessfulImageSourceBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setImageCaptureElapsedTime(long param0) {
      long _oldVal = this._ImageCaptureElapsedTime;
      this._ImageCaptureElapsedTime = param0;
   ...
   public boolean isImageCaptureElapsedTimeInherited() {
      return false;
   }
      ...
      public int getPropertyIndex(String s) {
         switch (s.length()) {
            case 12:
               ...
               break;
            case 26:
               if (s.equals("image-capture-elapsed-time")) {
                  return 1;
               }
         }
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      ...
      protected Helper(SuccessfulImageSourceBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("ImageCaptureElapsedTime")) {
            return 1;
         } else {
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isImageCaptureElapsedTimeSet()) {
               buf.append("ImageCaptureElapsedTime");
               buf.append(String.valueOf(this.bean.getImageCaptureElapsedTime()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SuccessfulImageSourceBeanImpl otherTyped = (SuccessfulImageSourceBeanImpl)other;
            this.computeDiff("ImageCaptureElapsedTime", this.bean.getImageCaptureElapsedTime(), otherTyped.getImageCaptureElapsedTime(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SuccessfulImageSourceBeanImpl original = (SuccessfulImageSourceBeanImpl)event.getSourceBean();
            SuccessfulImageSourceBeanImpl proposed = (SuccessfulImageSourceBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (prop.equals("ImageCaptureElapsedTime")) {
                  original.setImageCaptureElapsedTime(proposed.getImageCaptureElapsedTime());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SuccessfulImageSourceBeanImpl copy = (SuccessfulImageSourceBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("ImageCaptureElapsedTime")) && this.bean.isImageCaptureElapsedTimeSet()) {
               copy.setImageCaptureElapsedTime(this.bean.getImageCaptureElapsedTime());
            }
