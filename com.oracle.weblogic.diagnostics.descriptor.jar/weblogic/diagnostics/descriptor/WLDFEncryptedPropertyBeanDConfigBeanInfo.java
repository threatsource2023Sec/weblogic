...
public class WLDFEncryptedPropertyBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WLDFEncryptedPropertyBean beanTreeNode;

   public WLDFEncryptedPropertyBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WLDFEncryptedPropertyBean)btn;
      this.beanTree = btn;
