...
public class WLDFPropertyBeanImpl extends WLDFConfigurationPropertyBeanImpl implements WLDFPropertyBean, Serializable {
   private String _Value;
   private static SchemaHelper2 _schemaHelper;

   public WLDFPropertyBeanImpl() {
      this._initializeProperty(-1);
   }

   public WLDFPropertyBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public WLDFPropertyBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends WLDFConfigurationPropertyBeanImpl.Helper {
      private WLDFPropertyBeanImpl bean;

      protected Helper(WLDFPropertyBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            WLDFPropertyBeanImpl otherTyped = (WLDFPropertyBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            WLDFPropertyBeanImpl original = (WLDFPropertyBeanImpl)event.getSourceBean();
            WLDFPropertyBeanImpl proposed = (WLDFPropertyBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            WLDFPropertyBeanImpl copy = (WLDFPropertyBeanImpl)initialCopy;
