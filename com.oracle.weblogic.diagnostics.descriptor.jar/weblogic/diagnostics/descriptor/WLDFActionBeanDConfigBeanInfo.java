...
public class WLDFActionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WLDFActionBean beanTreeNode;

   public WLDFActionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WLDFActionBean)btn;
      this.beanTree = btn;
   ...
   public WLDFEncryptedPropertyBean[] getEncryptedProperties() {
      return this.beanTreeNode.getEncryptedProperties();
   }

   public WLDFConfigurationPropertiesBean[] getMapProperties() {
      return this.beanTreeNode.getMapProperties();
   }

   public WLDFArrayPropertyBean[] getArrayProperties() {
      return this.beanTreeNode.getArrayProperties();
   }

   public WLDFConfigurationPropertyBean[] getConfigurationProperties() {
      return this.beanTreeNode.getConfigurationProperties();
   }
}
