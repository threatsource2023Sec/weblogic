...
public class SAMLAuthorizationDecisionQuery extends SAMLSubjectQuery implements Cloneable {
   ...
   public SAMLAuthorizationDecisionQuery(SAMLSubject var1, String var2, Collection var3, Collection var4) throws SAMLException {
      super(var1);
      this.resource = var2;
      this.actions.addAll(var3);
      if (var4 != null) {
         this.evidence.addAll(var4);
      }

   }

   public SAMLAuthorizationDecisionQuery(Element var1) throws SAMLException {
      this.fromDOM(var1);
   }

   public SAMLAuthorizationDecisionQuery(InputStream var1) throws SAMLException {
      this.fromDOM(fromStream(var1));
   }

   public void fromDOM(Element var1) throws SAMLException {
      super.fromDOM(var1);
      if (this.config.getBooleanProperty("org.opensaml.strict-dom-checking") && !XML.isElementNamed(var1, "urn:oasis:names:tc:SAML:1.0:protocol", "AuthorizationDecisionQuery")) {
         QName var2 = QName.getQNameAttribute(var1, "http://www.w3.org/2001/XMLSchema-instance", "type");
         if (!XML.isElementNamed(var1, "urn:oasis:names:tc:SAML:1.0:protocol", "Query") || !XML.isElementNamed(var1, "urn:oasis:names:tc:SAML:1.0:protocol", "SubjectQuery") || var2 == null || !"urn:oasis:names:tc:SAML:1.0:protocol".equals(var2.getNamespaceURI()) || !"AuthorizationDecisionQueryType".equals(var2.getLocalName())) {
   ...
   public Node toDOM(Document var1, boolean var2) throws SAMLException {
      if ((this.root = super.toDOM(var1, var2)) != null) {
         if (var2) {
            ((Element)this.root).setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns", "XML.SAMLP_NS");
         }

         return this.root;
      } else {
         Element var3 = var1.createElementNS("urn:oasis:names:tc:SAML:1.0:protocol", "AuthorizationDecisionQuery");
         if (var2) {
            var3.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns", "XML.SAMLP_NS");
         }
         ...
         while(var4.hasNext()) {
            var3.appendChild(((SAMLAction)var4.next()).toDOM(var1));
         }

         if (this.evidence.size() > 0) {
            Element var5 = var1.createElementNS("urn:oasis:names:tc:SAML:1.0:assertion", "Evidence");
            var5.setAttributeNS("http://www.w3.org/2000/xmlns/", "xmlns", "urn:oasis:names:tc:SAML:1.0:assertion");
   ...
   public Object clone() throws CloneNotSupportedException {
      SAMLAuthorizationDecisionQuery var1 = (SAMLAuthorizationDecisionQuery)super.clone();
