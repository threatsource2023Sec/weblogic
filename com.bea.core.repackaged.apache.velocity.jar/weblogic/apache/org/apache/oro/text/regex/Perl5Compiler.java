...
public final class Perl5Compiler implements PatternCompiler {
         ...
         while(!this.__input._isAtEnd() && (var3 = this.__input._getValue()) != ']' || var2) {
            ...
            if (var3 == '\\') {
               ...
               switch (var3) {
                  ...
                  case '8':
                  case '9':
                     var3 = (char)__parseOctal(this.__input._array, this.__input._getOffset() - 1, 3, var8);
                     this.__input._increment(var8[0] - 1);
                  case ':':
                  case ';':
                  case '<':
                  case '=':
                  ...
                  case 'D':
                     for(var3 = 0; var3 < '0'; ++var3) {
                        this.__setCharacterClassBits(this.__program, var7, var4, var3);
                     }

                     for(var3 = ':'; var3 < 256; ++var3) {
                        this.__setCharacterClassBits(this.__program, var7, var4, var3);
                     }
                  ...
                  case 'W':
                     for(var3 = 0; var3 < 256; ++var3) {
                        if (!OpCode._isWordCharacter(var3)) {
                           this.__setCharacterClassBits(this.__program, var7, var4, var3);
                        }
                     }
                  ...
                  case 'w':
                     ...
                     continue;
                  case 'x':
                     var3 = (char)__parseHex(this.__input._array, this.__input._getOffset(), 2, var8);
                     this.__input._increment(var8[0]);
               }
            }
            ...
            for(; var5 <= var3; ++var5) {
               this.__setCharacterClassBits(this.__program, var7, var4, var5);
               if ((this.__modifierFlags[0] & 1) != 0 && Character.isUpperCase(var5)) {
                  this.__setCharacterClassBits(this.__program, var7, var4, Character.toLowerCase(var5));
               }
            }
   ...
   private int __parseExpression(boolean var1, int[] var2) throws MalformedPatternException {
         ...
         if (this.__input._getValue() == '?') {
            ...
            switch (var3) {
               ...
               default:
                  ...
                  for(var3 = this.__input._getValue(); var3 != '\uffff' && var10.indexOf(var3) != -1; var3 = this.__input._increment()) {
                     __setModifierFlag(this.__modifierFlags, var3);
                  }
      ...
      int var7 = this.__parseAlternation(var9);
      if (var7 == -1) {
         return -1;
      } else {
         if (var5 != -1) {
            this.__programAddTail(var5, var7);
         } else {
            var5 = var7;
         }
         ...
         for(var2[0] |= var9[0] & 4; this.__input._getValue() == '|'; var2[0] |= var9[0] & 4) {
            this.__getNextChar();
            var7 = this.__parseAlternation(var9);
            if (var7 == -1) {
               return -1;
            }
         ...
         switch (var4) {
            case '\u0000':
            default:
               var8 = this.__emitNode('\u0000');
               break;
            case '\u0001':
               var8 = this.__emitArgNode('\u001c', (char)var6);
               break;
            case '!':
            case '=':
               var8 = this.__emitNode('!');
         ...
         this.__programAddTail(var5, var8);

         for(var7 = var5; var7 != -1; var7 = OpCode._getNext(this.__program, var7)) {
            this.__programAddOperatorTail(var7, var8);
         }
   ...
   private void __setCharacterClassBits(char[] var1, int var2, char var3, char var4) {
      if (this.__program != null && var4 < 256) {
         var4 &= '\uffff';
         if (var3 == 0) {
            var1[var2 + (var4 >> 4)] = (char)(var1[var2 + (var4 >> 4)] | 1 << (var4 & 15));
         } else {
            var1[var2 + (var4 >> 4)] = (char)(var1[var2 + (var4 >> 4)] & ~(1 << (var4 & 15)));
         }
