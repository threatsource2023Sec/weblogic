...
public final class AwkCompiler implements PatternCompiler {
   ...
   private SyntaxNode __repetition(SyntaxNode var1) throws MalformedPatternException {
      ...
      if (this.__lookahead == '}') {
         ...
         var7 = var8 = new CatNode();
         var8._left = var1;

         while(true) {
            --var2;
            if (var2 <= 1) {
               var8._right = var1._clone(var4);
               break;
            }

            var1 = var1._clone(var4);
            var8._right = new CatNode();
            var8 = (CatNode)var8._right;
            var8._left = var1;
         }
      } else {
         if (this.__lookahead != ',') {
         ...
         if (this.__lookahead == '}') {
            ...
            while(true) {
               --var2;
               if (var2 <= 0) {
                  var8._right = new StarNode(var1._clone(var4));
                  break;
               }
            ...
            if (var2 == 0) {
               ...
               var7 = var8 = new CatNode();
               var10 = new QuestionNode(var1);
               var8._left = (SyntaxNode)var10;

               while(true) {
                  --var3;
                  if (var3 <= 1) {
                     var8._right = ((SyntaxNode)var10)._clone(var4);
                     break;
                  }

                  var10 = ((SyntaxNode)var10)._clone(var4);
                  var8._right = new CatNode();
                  var8 = (CatNode)var8._right;
                  var8._left = (SyntaxNode)var10;
               }
               ...
               var10 = new QuestionNode(var1._clone(var4));
               var9 = var3 - var2;
               if (var9 == 1) {
                  var8._right = (SyntaxNode)var10;
               } else {
                  var8._right = new CatNode();
                  var8 = (CatNode)var8._right;
                  var8._left = (SyntaxNode)var10;
