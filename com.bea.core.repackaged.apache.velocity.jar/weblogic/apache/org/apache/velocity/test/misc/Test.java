package weblogic.apache.org.apache.velocity.test.misc;
...
import weblogic.apache.org.apache.velocity.app.event.MethodExceptionEventHandler;
import weblogic.apache.org.apache.velocity.app.event.NullSetEventHandler;
import weblogic.apache.org.apache.velocity.app.event.ReferenceInsertionEventHandler;
...
public class Test implements ReferenceInsertionEventHandler, NullSetEventHandler, MethodExceptionEventHandler {
   ...
   public Test(String templateFile, String encoding) {
      ...
      try {
         ...
         context.put("runtime", new FieldMethodizer("weblogic.apache.org.apache.velocity.runtime.RuntimeSingleton"));
