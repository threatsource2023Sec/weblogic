...
public class IntrospectorTestCase extends BaseTestCase {
   ...
   // $FF: synthetic field
   static Class class$weblogic$apache$org$apache$velocity$test$IntrospectorTestCase$MethodProvider;
   ...
   public void runTest() {
      ...
      try {
         ...
         this.type = "boolean";
         this.method = RuntimeSingleton.getIntrospector().getMethod(class$weblogic$apache$org$apache$velocity$test$IntrospectorTestCase$MethodProvider == null ? (class$weblogic$apache$org$apache$velocity$test$IntrospectorTestCase$MethodProvider = class$("weblogic.apache.org.apache.velocity.test.IntrospectorTestCase$MethodProvider")) : class$weblogic$apache$org$apache$velocity$test$IntrospectorTestCase$MethodProvider, this.type + "Method", booleanParams);
