...
public class MultiLoaderTestCase extends BaseTestCase {
   ...
   public MultiLoaderTestCase() {
      ...
      try {
         ...
         Velocity.setProperty("classpath.resource.loader.class", "weblogic.apache.org.apache.velocity.runtime.resource.loader.ClasspathResourceLoader");
         ...
         Velocity.setProperty("jar.resource.loader.class", "weblogic.apache.org.apache.velocity.runtime.resource.loader.JarResourceLoader");
