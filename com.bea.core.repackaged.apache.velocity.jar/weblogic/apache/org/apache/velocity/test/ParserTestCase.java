...
public class ParserTestCase extends TestCase {
   // $FF: synthetic field
   static Class class$weblogic$apache$org$apache$velocity$test$ParserTestCase;
   ...
   public static Test suite() {
      return new TestSuite(class$weblogic$apache$org$apache$velocity$test$ParserTestCase == null ? (class$weblogic$apache$org$apache$velocity$test$ParserTestCase = class$("weblogic.apache.org.apache.velocity.test.ParserTestCase")) : class$weblogic$apache$org$apache$velocity$test$ParserTestCase);
   }
