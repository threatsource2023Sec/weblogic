...
public final class T3RemoteOutputStreamProxy_14110_WLStub extends Stub implements StubInfoIntf, OneWayOutputServer {
   // $FF: synthetic field
   ...
   public T3RemoteOutputStreamProxy_14110_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
   ...
   private static synchronized void ensureInitialized(StubInfo var0) {
      if (!initialized) {
         ...
         md2 = new MethodDescriptor(m[2], class$weblogic$io$common$internal$OneWayOutputServer == null ? (class$weblogic$io$common$internal$OneWayOutputServer = class$("weblogic.io.common.internal.OneWayOutputServer")) : class$weblogic$io$common$internal$OneWayOutputServer, true, false, false, false, var0.getTimeOut(m[2]), var0.getRemoteRef().getObjectID(), false, var0.getRemoteExceptionWrapperClassName(m[2]));
         initialized = true;
      }
   }
