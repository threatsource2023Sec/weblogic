...
public interface GenericBooleanType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(GenericBooleanType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("genericbooleantypee5edtype");
