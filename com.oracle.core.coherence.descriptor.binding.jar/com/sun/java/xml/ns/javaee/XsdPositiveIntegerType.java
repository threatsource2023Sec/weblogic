...
public interface XsdPositiveIntegerType extends XmlPositiveInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdPositiveIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("xsdpositiveintegertypea369type");
