...
public interface PersistenceContextTypeType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(PersistenceContextTypeType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("persistencecontexttypetype4533type");
