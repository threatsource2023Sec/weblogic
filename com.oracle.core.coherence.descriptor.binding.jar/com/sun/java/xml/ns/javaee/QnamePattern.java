...
public interface QnamePattern extends XmlToken {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(QnamePattern.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("qnamepattern2f20type");
