...
public interface XsdNonNegativeIntegerType extends XmlNonNegativeInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdNonNegativeIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("xsdnonnegativeintegertypeeda0type");
