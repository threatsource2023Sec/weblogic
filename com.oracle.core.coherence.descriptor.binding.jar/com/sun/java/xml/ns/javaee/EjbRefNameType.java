...
public interface EjbRefNameType extends JndiNameType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(EjbRefNameType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("ejbrefnametype9d62type");
