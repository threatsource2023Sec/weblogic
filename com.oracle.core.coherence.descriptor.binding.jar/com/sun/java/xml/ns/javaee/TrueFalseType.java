...
public interface TrueFalseType extends XsdBooleanType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TrueFalseType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("truefalsetype1d91type");
   ...
   public static final class Factory {
      ...
      public static TrueFalseType parse(java.lang.String xmlAsString) throws XmlException {
         return (TrueFalseType)XmlBeans.getContextTypeLoader().parse(xmlAsString, TrueFalseType.type, (XmlOptions)null);
      }

      public static TrueFalseType parse(java.lang.String xmlAsString, XmlOptions options) throws XmlException {
