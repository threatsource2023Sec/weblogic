...
public class EjbLocalRefTypeImpl extends XmlComplexContentImpl implements EjbLocalRefType {
   ...
   private static final QName EJBREFNAME$2 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-ref-name");
   private static final QName EJBREFTYPE$4 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-ref-type");
   private static final QName LOCALHOME$6 = new QName("http://java.sun.com/xml/ns/javaee", "local-home");
   private static final QName LOCAL$8 = new QName("http://java.sun.com/xml/ns/javaee", "local");
   private static final QName EJBLINK$10 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-link");
   private static final QName MAPPEDNAME$12 = new QName("http://java.sun.com/xml/ns/javaee", "mapped-name");
   private static final QName INJECTIONTARGET$14 = new QName("http://java.sun.com/xml/ns/javaee", "injection-target");
   private static final QName LOOKUPNAME$16 = new QName("http://java.sun.com/xml/ns/javaee", "lookup-name");
   private static final QName ID$18 = new QName("", "id");

   public EjbLocalRefTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public LocalHomeType getLocalHome() {
      synchronized(this.monitor()) {
         ...
         target = (LocalHomeType)this.get_store().find_element_user(LOCALHOME$6, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetLocalHome() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(LOCALHOME$6) != 0;
      }
   }

   public void setLocalHome(LocalHomeType localHome) {
      this.generatedSetterHelperImpl(localHome, LOCALHOME$6, 0, (short)1);
   }
   ...
   public LocalHomeType addNewLocalHome() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LocalHomeType target = null;
         target = (LocalHomeType)this.get_store().add_element_user(LOCALHOME$6);
         return target;
      }
   }
   ...
   public void unsetLocalHome() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(LOCALHOME$6, 0);
      }
   }
   ...
   public LocalType getLocal() {
      synchronized(this.monitor()) {
         ...
         target = (LocalType)this.get_store().find_element_user(LOCAL$8, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetLocal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(LOCAL$8) != 0;
      }
   }

   public void setLocal(LocalType local) {
      this.generatedSetterHelperImpl(local, LOCAL$8, 0, (short)1);
   }
   ...
   public LocalType addNewLocal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LocalType target = null;
         target = (LocalType)this.get_store().add_element_user(LOCAL$8);
         return target;
      }
   }
   ...
   public void unsetLocal() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(LOCAL$8, 0);
      }
   }
