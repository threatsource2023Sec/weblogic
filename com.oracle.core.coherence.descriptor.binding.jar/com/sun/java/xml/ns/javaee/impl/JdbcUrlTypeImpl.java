...
public class JdbcUrlTypeImpl extends JavaStringHolderEx implements JdbcUrlType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JdbcUrlTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JdbcUrlTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
