...
public class EjbLinkTypeImpl extends JavaStringHolderEx implements EjbLinkType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EjbLinkTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EjbLinkTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
