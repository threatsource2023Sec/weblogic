...
public class HandlerTypeImpl extends XmlComplexContentImpl implements HandlerType {
   ...
   private static final QName HANDLERNAME$6 = new QName("http://java.sun.com/xml/ns/javaee", "handler-name");
   private static final QName HANDLERCLASS$8 = new QName("http://java.sun.com/xml/ns/javaee", "handler-class");
   private static final QName INITPARAM$10 = new QName("http://java.sun.com/xml/ns/javaee", "init-param");
   private static final QName SOAPHEADER$12 = new QName("http://java.sun.com/xml/ns/javaee", "soap-header");
   private static final QName SOAPROLE$14 = new QName("http://java.sun.com/xml/ns/javaee", "soap-role");
   private static final QName PORTNAME$16 = new QName("http://java.sun.com/xml/ns/javaee", "port-name");
