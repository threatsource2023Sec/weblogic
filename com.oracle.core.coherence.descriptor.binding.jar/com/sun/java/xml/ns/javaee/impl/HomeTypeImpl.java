...
public class HomeTypeImpl extends JavaStringHolderEx implements HomeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public HomeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected HomeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
