...
public class ResSharingScopeTypeImpl extends JavaStringEnumerationHolderEx implements ResSharingScopeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResSharingScopeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResSharingScopeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
