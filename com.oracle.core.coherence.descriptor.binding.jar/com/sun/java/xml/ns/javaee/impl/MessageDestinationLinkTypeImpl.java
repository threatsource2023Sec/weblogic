...
public class MessageDestinationLinkTypeImpl extends JavaStringHolderEx implements MessageDestinationLinkType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MessageDestinationLinkTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MessageDestinationLinkTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
