...
import com.sun.java.xml.ns.javaee.PersistenceContextTypeType;
...
public class PersistenceContextRefTypeImpl extends XmlComplexContentImpl implements PersistenceContextRefType {
   ...
   private static final QName PERSISTENCECONTEXTREFNAME$2 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-context-ref-name");
   private static final QName PERSISTENCEUNITNAME$4 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-unit-name");
   private static final QName PERSISTENCECONTEXTTYPE$6 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-context-type");
   private static final QName PERSISTENCEPROPERTY$8 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-property");
   private static final QName MAPPEDNAME$10 = new QName("http://java.sun.com/xml/ns/javaee", "mapped-name");
   private static final QName INJECTIONTARGET$12 = new QName("http://java.sun.com/xml/ns/javaee", "injection-target");
   ...
   public PropertyType[] getPersistencePropertyArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(PERSISTENCEPROPERTY$8, targetList);
   ...
   public PropertyType getPersistencePropertyArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (PropertyType)this.get_store().find_element_user(PERSISTENCEPROPERTY$8, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfPersistencePropertyArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(PERSISTENCEPROPERTY$8);
      }
   }

   public void setPersistencePropertyArray(PropertyType[] persistencePropertyArray) {
      this.check_orphaned();
      this.arraySetterHelper(persistencePropertyArray, PERSISTENCEPROPERTY$8);
   }

   public void setPersistencePropertyArray(int i, PropertyType persistenceProperty) {
      this.generatedSetterHelperImpl(persistenceProperty, PERSISTENCEPROPERTY$8, i, (short)2);
   }
   ...
   public PropertyType insertNewPersistenceProperty(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         PropertyType target = null;
         target = (PropertyType)this.get_store().insert_element_user(PERSISTENCEPROPERTY$8, i);
         return target;
      }
   }
   ...
   public PropertyType addNewPersistenceProperty() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         PropertyType target = null;
         target = (PropertyType)this.get_store().add_element_user(PERSISTENCEPROPERTY$8);
         return target;
      }
   }
   ...
   public void removePersistenceProperty(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(PERSISTENCEPROPERTY$8, i);
      }
   }
