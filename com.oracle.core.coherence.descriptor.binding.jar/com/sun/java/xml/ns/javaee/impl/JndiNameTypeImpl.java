...
public class JndiNameTypeImpl extends JavaStringHolderEx implements JndiNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JndiNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JndiNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
