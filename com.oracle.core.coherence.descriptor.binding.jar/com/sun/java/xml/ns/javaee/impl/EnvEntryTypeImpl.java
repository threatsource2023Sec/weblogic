...
import com.sun.java.xml.ns.javaee.EnvEntryTypeValuesType;
...
public class EnvEntryTypeImpl extends XmlComplexContentImpl implements EnvEntryType {
   ...
   private static final QName ENVENTRYNAME$2 = new QName("http://java.sun.com/xml/ns/javaee", "env-entry-name");
   private static final QName ENVENTRYTYPE$4 = new QName("http://java.sun.com/xml/ns/javaee", "env-entry-type");
   private static final QName ENVENTRYVALUE$6 = new QName("http://java.sun.com/xml/ns/javaee", "env-entry-value");
   private static final QName MAPPEDNAME$8 = new QName("http://java.sun.com/xml/ns/javaee", "mapped-name");
   private static final QName INJECTIONTARGET$10 = new QName("http://java.sun.com/xml/ns/javaee", "injection-target");
   private static final QName LOOKUPNAME$12 = new QName("http://java.sun.com/xml/ns/javaee", "lookup-name");
