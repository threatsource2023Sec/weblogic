...
public class MessageDestinationUsageTypeImpl extends JavaStringEnumerationHolderEx implements MessageDestinationUsageType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MessageDestinationUsageTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MessageDestinationUsageTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
