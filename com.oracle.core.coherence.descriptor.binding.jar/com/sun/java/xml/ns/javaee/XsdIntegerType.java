...
public interface XsdIntegerType extends XmlInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("xsdintegertype4ce2type");
