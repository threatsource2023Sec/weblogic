...
public interface DescriptionType extends XsdStringType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DescriptionType.class.getClassLoader(), "schemacom_bea_xml.system.com_oracle_core_coherence_descriptor_binding_3_0_0_0").resolveHandle("descriptiontype63b7type");
