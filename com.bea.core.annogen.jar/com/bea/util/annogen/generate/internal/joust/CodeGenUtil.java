...
public class CodeGenUtil {
   ...
   public static boolean externalCompile(List srcFiles, File outdir, File[] cp, boolean debug) {
      return externalCompile(srcFiles, outdir, cp, debug, "javac", "8m", "256m", false, false, (String)null, (String)null);
   }
   ...
   public static boolean externalCompile(List srcFiles, File outdir, File[] cp, boolean debug, String javacPath, String memStart, String memMax, boolean quiet, boolean verbose) {
      return externalCompile(srcFiles, outdir, cp, debug, javacPath, memStart, memMax, quiet, verbose, (String)null, (String)null);
   }

   public static boolean externalCompile(List srcFiles, File outdir, File[] cp, boolean debug, String javacPath, String memStart, String memMax, boolean quiet, boolean verbose, String javacS, String javacT) {
      List args = new ArrayList();
      File javac = findJavaTool(javacPath == null ? "javac" : javacPath);
      ...
      try {
         ...
         System.err.println(var18.getCause());
   ...
   public static boolean externalJar(File srcdir, File outfile) {
      return externalJar(srcdir, outfile, "jar", false, false);
   }
   ...
   public static boolean externalJar(File srcdir, File outfile, String jarPath, boolean quiet, boolean verbose) {
      List args = new ArrayList();
      File jar = findJavaTool(jarPath == null ? "jar" : jarPath);
