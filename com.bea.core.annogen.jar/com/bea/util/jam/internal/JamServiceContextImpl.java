...
import com.bea.util.jam.annotation.WhitespaceDelimitedTagParser;
import com.bea.util.jam.internal.elements.ElementContext;
import com.bea.util.jam.provider.CompositeJamClassBuilder;
...
import com.bea.util.jam.provider.ResourcePath;
import com.bea.util.jam.visitor.CompositeMVisitor;
import com.bea.util.jam.visitor.MVisitor;
import com.bea.util.jam.visitor.PropertyInitializer;
import java.io.File;
...
public class JamServiceContextImpl implements JamServiceContext, JamServiceParams, ElementContext {
   ...
   public void setLoggerWriter(PrintWriter out) {
      if (this.mLogger instanceof JamLoggerImpl) {
         ((JamLoggerImpl)this.mLogger).setOut(out);
      } else {
   ...
   public void setShowWarnings(boolean b) {
      this.mLogger.setShowWarnings(b);
   }

   public void setVerbose(boolean v) {
      if (v) {
         this.mLogger.setVerbose(Object.class);
      }
   ...
   private File getPathRootForFile(File[] sourcepath, File sourceFile) {
      if (sourcepath == null) {
         ...
         if (this.mLogger.isVerbose((Object)this)) {
            this.mLogger.verbose("[JamServiceContextImpl] Getting root for " + sourceFile + "...");
         }

         for(int i = 0; i < sourcepath.length; ++i) {
            if (this.mLogger.isVerbose((Object)this)) {
               this.mLogger.verbose("[JamServiceContextImpl] ...looking in " + sourcepath[i]);
            }
   ...
   private DirectoryScanner getSourceScanner(File srcRoot) {
      ...
      if (out == null) {
         this.mSourceRoot2Scanner.put(srcRoot, out = new DirectoryScanner(srcRoot, this.mLogger));
      }
   ...
   private DirectoryScanner getClassScanner(File clsRoot) {
      ...
      if (out == null) {
         this.mClassRoot2Scanner.put(clsRoot, out = new DirectoryScanner(clsRoot, this.mLogger));
      }
