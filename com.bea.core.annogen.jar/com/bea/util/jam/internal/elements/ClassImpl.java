...
public class ClassImpl extends MemberImpl implements MClass, JClassRef, JClassRefContext {
   ...
   private JImport[] mImportItems = null;
   ...
   public void setImports(JImport[] items) {
      this.mImportItems = items;
   }
   ...
   public boolean isAssignableFrom(JClass arg) {
      ...
      if (!this.isPrimitiveType() && !arg.isPrimitiveType()) {
         try {
            ...
            if ("java.util.Locale".equals(arg.getQualifiedName()) && "com.sun.tools.javac.code.Symbol$CompletionFailure".equals(var3.getClass().getName())) {
               return false;
            } else {
               throw var3;
            }
   ...
   public JImport[] getImports() {
      return this.mImportItems == null ? NO_IMPORT : this.mImportItems;
   }
   ...
   public boolean isSourceAvailable() {
      return this.mIsSourceAvailable;
   }
