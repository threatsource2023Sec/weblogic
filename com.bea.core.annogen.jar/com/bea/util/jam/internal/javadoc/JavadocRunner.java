...
public class JavadocRunner extends Doclet {
   private static final String JAVADOC_RUNNER_150 = "com.bea.util.jam.internal.javadoc.JavadocRunner_150";
   ...
   public static JavadocRunner newInstance() {
      ...
      try {
         Class onefive = Class.forName("com.bea.util.jam.internal.javadoc.JavadocRunner_150");
   ...
   synchronized RootDoc run(File[] files, PrintWriter out, String sourcePath, String classPath, String encoding, String[] javadocArgs, JamLogger logger) throws IOException, FileNotFoundException {
      if (files != null && files.length != 0) {
         ...
         argList.add("-private");
         argList.add("-XDfileManager.deferClose");
         if (sourcePath != null) {
