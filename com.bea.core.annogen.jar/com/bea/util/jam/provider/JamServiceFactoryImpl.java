...
import com.bea.util.jam.internal.JamClassLoaderImpl;
...
import com.bea.util.jam.internal.javadoc.JavadocClassBuilder;
import com.bea.util.jam.internal.parser.ParserClassBuilder;
import com.bea.util.jam.internal.reflect.ReflectClassBuilder;
...
public class JamServiceFactoryImpl extends JamServiceFactory {
   ...
   protected JamClassBuilder createBuilder(JamServiceContext ctx) throws IOException {
      ...
      if (log.isVerbose((Object)this)) {
         ...
         JClass c = out.build((Javac)null, "java.lang", "Object");
         c = out.build((Javac)null, "javax.ejb", "SessionBean");
      }
   ...
   protected JamClassBuilder createSourceBuilder(JamServiceContext ctx) throws IOException {
      ...
      if (sources != null && sources.length != 0) {
         ...
         if (ctx.getLogger().isVerbose((Object)this)) {
            ctx.getLogger().verbose("[JamServiceFactoryImpl]no source files present, skipping source ClassBuilder");
         }
