...
import com.bea.xml_.impl.jam.internal.elements.ArrayClassImpl;
import com.bea.xml_.impl.jam.internal.elements.ClassImpl;
import com.bea.xml_.impl.jam.internal.elements.ElementContext;
import com.bea.xml_.impl.jam.internal.elements.PackageImpl;
import com.bea.xml_.impl.jam.internal.elements.PrimitiveClassImpl;
import com.bea.xml_.impl.jam.internal.elements.UnresolvedClassImpl;
import com.bea.xml_.impl.jam.internal.elements.VoidClassImpl;
...
import com.bea.xml_.impl.jam.visitor.TraversingMVisitor;
   ...
   public final JClass loadClass(String fd) {
      ...
      if (out != null) {
         ...
         if (dot != -1) {
            ...
            JClass out = this.mBuilder.build(pkg, name);
            if (out == null) {
