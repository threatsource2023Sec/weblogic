...
final class DomImpl {
   ...
   public static boolean _soapText_isComment(Dom n) {
      Locale l = n.locale();
      com.bea.xbean.soap.Text text = (com.bea.xbean.soap.Text)n;
      if (l.noSync()) {
         l.enter();
   ...
   public static void _soapNode_detachNode(Dom n) {
      Locale l = n.locale();
      com.bea.xbean.soap.Node node = (com.bea.xbean.soap.Node)n;
      if (l.noSync()) {
         l.enter();
   ...
   static class SaajCdataNode extends CdataNode implements com.bea.xbean.soap.Text {
   ...
   static class SaajTextNode extends TextNode implements com.bea.xbean.soap.Text {
