...
import com.bea.xbean.xb.xsdschema.SimpleExtensionType;
...
public class TypeSystemHolder {
   ...
   private void fillUpTypeOnElement(Type elemType, com.bea.xbean.xb.xsdschema.Element parentSElement, String tns) {
   ...
   private void fillUpEnumeration(Type type, com.bea.xbean.xb.xsdschema.Element parentSElement) {
   ...
   private void fillUpAttributesInComplexTypesSimpleContent(Type elemType, SimpleExtensionType sExtension, String tns) {
      for(int i = 0; i < elemType.getAttributes().size(); ++i) {
         ...
         com.bea.xbean.xb.xsdschema.Attribute sAttribute = sExtension.addNewAttribute();
   ...
   private void fillUpAttributesInComplexTypesComplexContent(Type elemType, ComplexType localSComplexType, String tns) {
      for(int i = 0; i < elemType.getAttributes().size(); ++i) {
         Attribute att = (Attribute)elemType.getAttributes().get(i);
         com.bea.xbean.xb.xsdschema.Attribute sAttribute = localSComplexType.addNewAttribute();
         this.fillUpLocalAttribute(att, sAttribute, tns);
      }

   }

   protected void fillUpLocalAttribute(Attribute att, com.bea.xbean.xb.xsdschema.Attribute sAttribute, String tns) {
      if (att.isRef()) {
         ...
         if (att.isOptional()) {
            sAttribute.setUse(com.bea.xbean.xb.xsdschema.Attribute.Use.OPTIONAL);
         }
      }
   ...
   private static void fillUpElementDocumentation(com.bea.xbean.xb.xsdschema.Element element, String comment) {
