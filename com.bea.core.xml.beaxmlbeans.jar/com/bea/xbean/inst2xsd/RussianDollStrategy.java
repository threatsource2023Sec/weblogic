...
import com.bea.xbean.inst2xsd.util.Attribute;
   ...
   protected QName combineToMoreGeneralSimpleType(QName t1, QName t2) {
      if (t1.equals(t2)) {
         ...
         if (t2.equals(XmlLong.type.getName()) && (t1.equals(XmlInt.type.getName()) || t1.equals(XmlShort.type.getName()) || t1.equals(XmlByte.type.getName()))) {
            return t2;
         } else if (!t1.equals(XmlLong.type.getName()) || !t2.equals(XmlInt.type.getName()) && !t2.equals(XmlShort.type.getName()) && !t2.equals(XmlByte.type.getName())) {
