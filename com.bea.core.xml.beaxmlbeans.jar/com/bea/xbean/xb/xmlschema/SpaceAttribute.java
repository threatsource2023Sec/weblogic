...
public interface SpaceAttribute extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SpaceAttribute.class.getClassLoader(), "schemacom_bea_xml.system.sXMLLANG").resolveHandle("space9344attrtypetype");
   ...
   public interface Space extends XmlNCName {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Space.class.getClassLoader(), "schemacom_bea_xml.system.sXMLLANG").resolveHandle("spaceb986attrtype");
