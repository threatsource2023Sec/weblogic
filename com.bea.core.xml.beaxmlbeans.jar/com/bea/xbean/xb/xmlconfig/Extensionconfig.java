...
public interface Extensionconfig extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Extensionconfig.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("extensionconfig2ac2type");
   ...
   public interface PrePostSet extends XmlObject {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(PrePostSet.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("prepostset5c9delemtype");
   ...
   public interface Interface extends XmlObject {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Interface.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("interface02a7elemtype");
