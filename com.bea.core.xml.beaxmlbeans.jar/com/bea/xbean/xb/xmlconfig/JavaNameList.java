...
public interface JavaNameList extends XmlAnySimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(JavaNameList.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("javanamelistbcfetype");
   ...
   public interface Member2 extends XmlAnySimpleType {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member2.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("anon3a98type");
   ...
   public interface Member extends XmlToken {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("anon3e39type");
