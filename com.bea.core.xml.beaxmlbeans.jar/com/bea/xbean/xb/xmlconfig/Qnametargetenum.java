...
public interface Qnametargetenum extends XmlToken {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Qnametargetenum.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("qnametargetenum9f8ftype");
