...
public interface Qnameconfig extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Qnameconfig.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("qnameconfig463ftype");
