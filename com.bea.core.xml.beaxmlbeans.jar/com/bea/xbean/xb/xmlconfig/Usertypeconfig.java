...
public interface Usertypeconfig extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Usertypeconfig.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("usertypeconfig7bbatype");
