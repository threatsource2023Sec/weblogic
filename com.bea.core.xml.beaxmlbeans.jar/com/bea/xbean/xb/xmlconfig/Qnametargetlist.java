...
public interface Qnametargetlist extends XmlAnySimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Qnametargetlist.class.getClassLoader(), "schemacom_bea_xml.system.sXMLCONFIG").resolveHandle("qnametargetlist16actype");
