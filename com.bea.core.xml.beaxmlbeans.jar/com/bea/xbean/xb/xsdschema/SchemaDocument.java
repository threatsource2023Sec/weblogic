...
public interface SchemaDocument extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SchemaDocument.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("schema0782doctype");
   ...
   public interface Schema extends OpenAttrs {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Schema.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("schemad77felemtype");
