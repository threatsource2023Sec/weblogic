...
public interface RestrictionType extends Annotated {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RestrictionType.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("restrictiontype939ftype");
