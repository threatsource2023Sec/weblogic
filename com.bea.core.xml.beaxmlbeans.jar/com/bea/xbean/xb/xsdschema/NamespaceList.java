...
public interface NamespaceList extends XmlAnySimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(NamespaceList.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("namespacelist10cctype");
   ...
   public interface Member2 extends XmlAnySimpleType {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member2.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anona0e6type");
      ...
      public interface Item extends XmlAnySimpleType {
         SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Item.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anon16cetype");
         ...
         public interface Member extends XmlToken {
            SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anon0c73type");
   ...
   public interface Member extends XmlToken {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anonfac7type");
