...
public interface AttributeGroup extends Annotated {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(AttributeGroup.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("attributegroupe530type");
