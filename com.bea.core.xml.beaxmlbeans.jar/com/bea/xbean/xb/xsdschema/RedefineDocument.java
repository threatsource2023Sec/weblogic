...
public interface RedefineDocument extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(RedefineDocument.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("redefine3f55doctype");
   ...
   public interface Redefine extends OpenAttrs {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Redefine.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("redefine9e9felemtype");
