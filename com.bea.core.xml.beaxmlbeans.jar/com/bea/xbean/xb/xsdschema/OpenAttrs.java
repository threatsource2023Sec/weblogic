...
public interface OpenAttrs extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(OpenAttrs.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("openattrs2d4dtype");
