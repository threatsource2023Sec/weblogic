...
public interface SimpleRestrictionType extends RestrictionType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SimpleRestrictionType.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("simplerestrictiontypeeab1type");
