...
public interface ExtensionType extends Annotated {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ExtensionType.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("extensiontypeed4ctype");
