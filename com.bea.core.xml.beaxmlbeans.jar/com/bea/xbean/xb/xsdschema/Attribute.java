...
public interface Attribute extends Annotated {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Attribute.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("attribute83a9type");
   ...
   public interface Use extends XmlNMTOKEN {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Use.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("usea41aattrtype");
