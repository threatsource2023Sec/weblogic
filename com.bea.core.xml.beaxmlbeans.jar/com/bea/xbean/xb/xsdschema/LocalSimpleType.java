...
public interface LocalSimpleType extends SimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(LocalSimpleType.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("localsimpletype410etype");
