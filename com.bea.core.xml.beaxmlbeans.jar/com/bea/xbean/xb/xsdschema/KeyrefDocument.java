...
public interface KeyrefDocument extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(KeyrefDocument.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("keyref45afdoctype");
   ...
   public interface Keyref extends Keybase {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Keyref.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("keyref7a1felemtype");
