...
public interface BlockSet extends XmlAnySimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(BlockSet.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("blockset815etype");
   ...
   public interface Member2 extends XmlAnySimpleType {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member2.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anonc904type");
      ...
      public interface Item extends DerivationControl {
         SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Item.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anon421ctype");
   ...
   public interface Member extends XmlToken {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Member.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("anon0683type");
