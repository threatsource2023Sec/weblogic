...
public interface TopLevelElement extends Element {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TopLevelElement.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("toplevelelement98d8type");
