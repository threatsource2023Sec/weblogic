...
public interface TopLevelSimpleType extends SimpleType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TopLevelSimpleType.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("toplevelsimpletypec958type");
