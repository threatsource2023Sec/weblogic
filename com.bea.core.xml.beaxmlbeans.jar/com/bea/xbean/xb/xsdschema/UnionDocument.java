...
public interface UnionDocument extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(UnionDocument.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("union5866doctype");
   ...
   public interface Union extends Annotated {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Union.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("union498belemtype");
      ...
      public interface MemberTypes extends XmlAnySimpleType {
         SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(MemberTypes.class.getClassLoader(), "schemacom_bea_xml.system.sXMLSCHEMA").resolveHandle("membertypes2404attrtype");
