...
public interface TestCase extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TestCase.class.getClassLoader(), "schemacom_bea_xml.system.sXMLTOOLS").resolveHandle("testcase939btype");
   ...
   public interface Files extends XmlObject {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Files.class.getClassLoader(), "schemacom_bea_xml.system.sXMLTOOLS").resolveHandle("files7c3eelemtype");
