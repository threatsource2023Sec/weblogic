...
public interface FileDesc extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(FileDesc.class.getClassLoader(), "schemacom_bea_xml.system.sXMLTOOLS").resolveHandle("filedesc9392type");
   ...
   public interface Role extends XmlToken {
      SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(Role.class.getClassLoader(), "schemacom_bea_xml.system.sXMLTOOLS").resolveHandle("role21a8attrtype");
