...
class RegexParser {
   ...
   public void setLocale(Locale var1) {
      try {
         if (var1 != null) {
            this.resources = ResourceBundle.getBundle("weblogic.apache.xerces.impl.xpath.regex.message", var1);
         } else {
            this.resources = ResourceBundle.getBundle("weblogic.apache.xerces.impl.xpath.regex.message");
         }
