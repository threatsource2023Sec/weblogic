...
public class DatatypeException extends Exception {
   ...
   public String getMessage() {
      ...
      var1 = ResourceBundle.getBundle("weblogic.apache.xerces.impl.msg.XMLSchemaMessages");
      if (var1 == null) {
         throw new MissingResourceException("Property file not found!", "weblogic.apache.xerces.impl.msg.XMLSchemaMessages", this.key);
      } else {
         String var2 = var1.getString(this.key);
         if (var2 == null) {
            var2 = var1.getString("BadMessageKey");
            throw new MissingResourceException(var2, "weblogic.apache.xerces.impl.msg.XMLSchemaMessages", this.key);
         } else {
            if (this.args != null) {
               try {
