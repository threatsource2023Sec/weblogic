...
public abstract class DTDDVFactory {
   private static final String DEFAULT_FACTORY_CLASS = "weblogic.apache.xerces.impl.dv.dtd.DTDDVFactoryImpl";

   public static final DTDDVFactory getInstance() throws DVFactoryException {
      return getInstance("weblogic.apache.xerces.impl.dv.dtd.DTDDVFactoryImpl");
   }
