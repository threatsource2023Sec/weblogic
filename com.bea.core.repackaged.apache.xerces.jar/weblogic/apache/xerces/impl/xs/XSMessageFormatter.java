...
public class XSMessageFormatter implements MessageFormatter {
   ...
   public String formatMessage(Locale var1, String var2, Object[] var3) throws MissingResourceException {
      ...
      if (var1 != this.fLocale) {
         this.fResourceBundle = ResourceBundle.getBundle("weblogic.apache.xerces.impl.msg.XMLSchemaMessages", var1);
         this.fLocale = var1;
      }
      ...
      if (var4 == null) {
         ...
         throw new MissingResourceException(var4, "weblogic.apache.xerces.impl.msg.SchemaMessages", var2);
      } else {
         return var4;
      }
   }
