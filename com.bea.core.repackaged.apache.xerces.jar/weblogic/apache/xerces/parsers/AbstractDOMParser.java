...
import weblogic.apache.xerces.dom.AttrImpl;
...
import weblogic.apache.xerces.dom.DeferredDocumentImpl;
import weblogic.apache.xerces.dom.DocumentImpl;
import weblogic.apache.xerces.dom.DocumentTypeImpl;
import weblogic.apache.xerces.dom.ElementDefinitionImpl;
import weblogic.apache.xerces.dom.ElementImpl;
import weblogic.apache.xerces.dom.ElementNSImpl;
import weblogic.apache.xerces.dom.EntityImpl;
import weblogic.apache.xerces.dom.EntityReferenceImpl;
import weblogic.apache.xerces.dom.NodeImpl;
import weblogic.apache.xerces.dom.NotationImpl;
import weblogic.apache.xerces.dom.PSVIAttrNSImpl;
import weblogic.apache.xerces.dom.PSVIDocumentImpl;
import weblogic.apache.xerces.dom.PSVIElementNSImpl;
...
public class AbstractDOMParser extends AbstractXMLDocumentParser {
   ...
   protected static final String DEFAULT_DOCUMENT_CLASS_NAME = "weblogic.apache.xerces.dom.DocumentImpl";
   protected static final String CORE_DOCUMENT_CLASS_NAME = "weblogic.apache.xerces.dom.CoreDocumentImpl";
   protected static final String PSVI_DOCUMENT_CLASS_NAME = "weblogic.apache.xerces.dom.PSVIDocumentImpl";
   ...
   protected AbstractDOMParser(XMLParserConfiguration var1) {
      ...
      this.fConfiguration.setProperty("http://apache.org/xml/properties/dom/document-class-name", "weblogic.apache.xerces.dom.DocumentImpl");
   }
   ...
   protected void setDocumentClassName(String var1) {
      if (var1 == null) {
         var1 = "weblogic.apache.xerces.dom.DocumentImpl";
      }

      if (!var1.equals("weblogic.apache.xerces.dom.DocumentImpl") && !var1.equals("weblogic.apache.xerces.dom.PSVIDocumentImpl")) {
         try {
      ...
      if (!var1.equals("weblogic.apache.xerces.dom.DocumentImpl")) {
   ...
   public void startDocument(XMLLocator var1, String var2, NamespaceContext var3, Augmentations var4) throws XNIException {
      this.fLocator = var1;
      if (!this.fDeferNodeExpansion) {
         if (this.fDocumentClassName.equals("weblogic.apache.xerces.dom.DocumentImpl")) {
         ...
         } else if (this.fDocumentClassName.equals("weblogic.apache.xerces.dom.PSVIDocumentImpl")) {
            ...
            try {
               ...
               Class var7 = ObjectFactory.findProviderClass("weblogic.apache.xerces.dom.CoreDocumentImpl", var5, true);
               if (var7.isAssignableFrom(var6)) {
                  this.fDocumentImpl = (CoreDocumentImpl)this.fDocument;
                  Class var8 = ObjectFactory.findProviderClass("weblogic.apache.xerces.dom.PSVIDocumentImpl", var5, true);
