...
import weblogic.apache.xerces.util.HTTPInputSource;
...
import weblogic.apache.xerces.util.XMLLocatorWrapper;
...
import weblogic.apache.xerces.xpointer.XPointerHandler;
import weblogic.apache.xerces.xpointer.XPointerProcessor;

public class XIncludeHandler implements XMLComponent, XMLDocumentFilter, XMLDTDFilter {
   public static final String XINCLUDE_DEFAULT_CONFIGURATION = "weblogic.apache.xerces.parsers.XIncludeParserConfiguration";
      ...
      if (this.getState() == 2) {
         ...
         if (var3.equals(XINCLUDE_PARSE_XML)) {
            if (var4 != null && this.fXPointerChildConfig == null || var4 == null && this.fXIncludeChildConfig == null) {
               var9 = "weblogic.apache.xerces.parsers.XIncludeParserConfiguration";
               if (var4 != null) {
                  var9 = "weblogic.apache.xerces.parsers.XPointerParserConfiguration";
               }
