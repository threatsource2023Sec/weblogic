...
import weblogic.apache.xerces.dom.DOMInputImpl;
...
import weblogic.apache.xml.resolver.Catalog;
import weblogic.apache.xml.resolver.CatalogManager;
import weblogic.apache.xml.resolver.readers.SAXCatalogReader;
...
public class XMLCatalogResolver implements XMLEntityResolver, EntityResolver2, LSResourceResolver {
   ...
   private void init(String[] var1, boolean var2) {
      ...
      this.fResolverCatalogManager.setCatalogClassName("weblogic.apache.xml.resolver.Catalog");
   ...
   private void attachReaderToCatalog(Catalog var1) {
      ...
      var3.setCatalogParser("urn:oasis:names:tc:entity:xmlns:xml:catalog", "catalog", "weblogic.apache.xml.resolver.readers.OASISXMLCatalogReader");
