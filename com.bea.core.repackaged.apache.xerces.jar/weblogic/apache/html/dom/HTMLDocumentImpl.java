...
public class HTMLDocumentImpl extends DocumentImpl implements HTMLDocument {
   ...
   // $FF: synthetic field
   static Class class$weblogic$apache$html$dom$HTMLDocumentImpl;
   // $FF: synthetic field
   ...
   private static void populateElementType(String var0, String var1) {
      try {
         _elementTypesHTML.put(var0, ObjectFactory.findProviderClass("weblogic.apache.html.dom." + var1, (class$weblogic$apache$html$dom$HTMLDocumentImpl == null ? (class$weblogic$apache$html$dom$HTMLDocumentImpl = class$("weblogic.apache.html.dom.HTMLDocumentImpl")) : class$weblogic$apache$html$dom$HTMLDocumentImpl).getClassLoader(), true));
   ...
   static {
      _elemClassSigHTML = new Class[]{class$weblogic$apache$html$dom$HTMLDocumentImpl == null ? (class$weblogic$apache$html$dom$HTMLDocumentImpl = class$("weblogic.apache.html.dom.HTMLDocumentImpl")) : class$weblogic$apache$html$dom$HTMLDocumentImpl, class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String};
   }
}
