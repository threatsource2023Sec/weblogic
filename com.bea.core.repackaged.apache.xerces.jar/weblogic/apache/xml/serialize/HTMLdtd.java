...
public final class HTMLdtd {
   ...
   // $FF: synthetic field
   static Class class$weblogic$apache$xml$serialize$HTMLdtd;
   ...
   private static void initialize() {
      ...
      if (_byName == null) {
         try {
            ...
            var0 = (class$weblogic$apache$xml$serialize$HTMLdtd == null ? (class$weblogic$apache$xml$serialize$HTMLdtd = class$("weblogic.apache.xml.serialize.HTMLdtd")) : class$weblogic$apache$xml$serialize$HTMLdtd).getResourceAsStream("HTMLEntities.res");
            if (var0 == null) {
