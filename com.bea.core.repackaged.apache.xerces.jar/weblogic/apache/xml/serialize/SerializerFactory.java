...
public abstract class SerializerFactory {
   ...
   // $FF: synthetic field
   static Class class$weblogic$apache$xml$serialize$SerializerFactory;
   ...
   static {
      ...
      registerSerializerFactory(var0);
      String var1 = SecuritySupport.getSystemProperty("weblogic.apache.xml.serialize.factories");
      if (var1 != null) {
         ...
         while(var2.hasMoreTokens()) {
            ...
            try {
               SerializerFactory var6 = (SerializerFactory)ObjectFactory.newInstance(var3, (class$weblogic$apache$xml$serialize$SerializerFactory == null ? (class$weblogic$apache$xml$serialize$SerializerFactory = class$("weblogic.apache.xml.serialize.SerializerFactory")) : class$weblogic$apache$xml$serialize$SerializerFactory).getClassLoader(), true);
