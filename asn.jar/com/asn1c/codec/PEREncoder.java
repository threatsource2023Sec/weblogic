...
public abstract class PEREncoder extends FilterEncoder {
   ...
   public PEREncoder(Encoder var1, String var2, byte[] var3) {
      super(var1);
      if (done == -1) {
         examine(var3);
      }
   ...
   protected PEREncoder(Encoder var1, PEREncoder var2) {
      super(var1);
      if (done == -1) {
   ...
   public void joinEncoder(PEREncoder var1) {
   ...
   protected PEREncoder getEncoder(String var1) {
      return (PEREncoder)this.encoderCache.get(var1);
   }
   ...
   public void writeConstrainedByteO(byte var1, int var2, byte var3) throws IOException, EOFException, ValueTooLargeException {
      this.skipToAlignment();
      this.writeUInteger(var1 - var3, var2);
   }

   public void writeConstrainedShortO(short var1, int var2, short var3) throws IOException, EOFException, ValueTooLargeException {
      this.skipToAlignment();
      this.writeUInteger(var1 - var3, var2);
   }

   public void writeConstrainedIntegerO(int var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      this.skipToAlignment();
      this.writeUInteger(var1 - var3, var2);
   }

   public void writeConstrainedLongO(long var1, int var3, long var4) throws IOException, EOFException, ValueTooLargeException {
      this.skipToAlignment();
      this.writeULong(var1 - var4, var3);
   }

   public void writeConstrainedBigIntegerO(BigInteger var1, int var2, BigInteger var3) throws IOException, EOFException {
      BigInteger var4 = var1.subtract(var3);
      this.skipToAlignment();
      this.writeUBigInteger(var4, var2);
   }

   public void writeConstrainedIntegerBO(int var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeConstrainedLongBO(long var1, int var3, long var4) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeConstrainedBigIntegerBO(BigInteger var1, int var2, BigInteger var3) throws IOException, EOFException, ValueTooLargeException {
      BigInteger var4 = var1.subtract(var3);
   ...
   public void writeConstrainedIntegerOO(int var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      int var4 = octetLengthU(var1 - var3);
      this.skipToAlignment();
      this.writeUInteger(var4 - 1, var2);
      this.writeUInteger(var1 - var3, var4 * 8);
   ...
   public void writeConstrainedBigIntegerOO(BigInteger var1, int var2, BigInteger var3) throws IOException, EOFException, ValueTooLargeException {
      BigInteger var4 = var1.subtract(var3);
      int var5 = octetLengthU(var4);
      this.skipToAlignment();
      this.writeUInteger(var5 - 1, var2);
   ...
   public void writeConstrainedBigIntegerFOO(BigInteger var1, BigInteger var2) throws IOException, EOFException {
   ...
   public void writeSemiconstrainedByteFOO(byte var1, byte var2) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeSemiconstrainedShortFOO(short var1, short var2) throws IOException, EOFException, ValueTooLargeException {
      int var3 = octetLengthU(var1 - var2);
      BitString var4 = new BitString();
      var4.appendUInteger(var1 - var2, var3 * 8);
      this.writeFragmented(var4, 8);
   ...
   public void writeSemiconstrainedIntegerFOO(int var1, int var2) throws IOException, EOFException, ValueTooLargeException {
      int var3 = octetLengthU(var1 - var2);
      BitString var4 = new BitString();
      var4.appendUInteger(var1 - var2, var3 * 8);
      this.writeFragmented(var4, 8);
   ...
   public void writeSemiconstrainedLongFOO(long var1, long var3) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeSemiconstrainedBigIntegerFOO(BigInteger var1, BigInteger var2) throws IOException, EOFException {
      BigInteger var3 = var1.subtract(var2);
      int var4 = octetLengthU(var3);
      BitString var5 = new BitString();
      var5.appendUBigInteger(var3, var4 * 8);
   ...
   public void writeSemiconstrainedByteSB(byte var1, byte var2) throws IOException, EOFException, ValueTooLargeException {
      if (var1 - var2 < 64) {
         ...
         this.writeBit(true);
         this.writeSemiconstrainedByteFOO(var1, var2);
      }
   ...
   public void writeSemiconstrainedShortSB(short var1, short var2) throws IOException, EOFException, ValueTooLargeException {
      if (var1 - var2 < 64) {
         ...
         this.writeBit(true);
         this.writeSemiconstrainedShortFOO(var1, var2);
      }
   ...
   public void writeSemiconstrainedIntegerSB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException {
      if (var1 - var2 < 64) {
         ...
         this.writeBit(true);
         this.writeSemiconstrainedIntegerFOO(var1, var2);
      }
   ...
   public void writeSemiconstrainedLongSB(long var1, long var3) throws IOException, EOFException, ValueTooLargeException {
      if (var1 - var3 < 64L) {
         ...
         this.writeBit(true);
         this.writeSemiconstrainedLongFOO(var1, var3);
      }
   ...
   public void writeSemiconstrainedBigIntegerSB(BigInteger var1, BigInteger var2) throws IOException, EOFException {
      ...
      if (var3.compareTo(var4) < 0) {
         ...
         this.writeBit(true);
         this.writeSemiconstrainedBigIntegerFOO(var1, var2);
      }

   }

   public void writeUnconstrainedByteFOO(byte var1) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeUnconstrainedShortFOO(short var1) throws IOException, EOFException, ValueTooLargeException {
      int var2 = octetLength(var1);
      BitString var3 = new BitString();
      var3.appendSInteger(var1, var2 * 8);
      this.writeFragmented(var3, 8);
   ...
   public void writeUnconstrainedIntegerFOO(int var1) throws IOException, EOFException, ValueTooLargeException {
      int var2 = octetLength(var1);
      BitString var3 = new BitString();
      var3.appendSInteger(var1, var2 * 8);
      this.writeFragmented(var3, 8);
   ...
   public void writeUnconstrainedLongFOO(long var1) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeUnconstrainedBigIntegerFOO(BigInteger var1) throws IOException, EOFException {
      int var2 = octetLength(var1);
      BitString var3 = new BitString();
   ...
   public void writeConstrainedBitStringO(BitString var1, int var2) throws IOException, EOFException {
      this.skipToAlignment();
      this.write(var1, 0, var2);
   }

   public void writeConstrainedTrimmedBitStringO(TrimmedBitString var1, int var2) throws IOException, EOFException {
      this.skipToAlignment();
      this.write(var1, 0, var2);
   }

   public void writeConstrainedBitStringBO(BitString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeConstrainedTrimmedBitStringBO(TrimmedBitString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      int var4 = var1.bitLength();
      if (var4 < var3) {
         var4 = var3;
      }
   ...
   public void writeConstrainedBitStringOO(BitString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      int var4 = var1.bitLength();
      this.skipToAlignment();
      this.writeUInteger(var4 - var3, var2);
      this.write(var1, 0, var4);
   ...
   public void writeConstrainedTrimmedBitStringOO(TrimmedBitString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      int var4 = var1.bitLength();
      if (var4 < var3) {
         var4 = var3;
      }
   ...
   public void writeConstrainedBitStringFOO(BitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeConstrainedTrimmedBitStringFOO(TrimmedBitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeSemiconstrainedBitStringFOO(BitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeSemiconstrainedTrimmedBitStringFOO(TrimmedBitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeUnconstrainedBitStringFOO(BitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeUnconstrainedTrimmedBitStringFOO(TrimmedBitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }
   ...
   public void writeConstrainedOctetStringO(OctetString var1, int var2) throws IOException, EOFException {
      this.skipToAlignment();
      this.write(new BitString(var1), 0, var2 * 8);
   }

   public void writeConstrainedOctetStringBO(OctetString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
   ...
   public void writeConstrainedOctetStringOO(OctetString var1, int var2, int var3) throws IOException, EOFException, ValueTooLargeException {
      int var4 = var1.octetLength();
      this.skipToAlignment();
      this.writeUInteger(var4 - var3, var2);
      this.write(new BitString(var1), 0, var4 * 8);
   ...
   public void writeConstrainedOctetStringFOO(OctetString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(new BitString(var1), 8);
   }

   public void writeSemiconstrainedOctetStringFOO(OctetString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(new BitString(var1), 8);
   }

   public void writeUnconstrainedOctetStringFOO(OctetString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(new BitString(var1), 8);
   }
   ...
   public void writeConstrainedStringO(String var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.skipToAlignment();
      BitString var5 = new BitString();
      var5.appendString16(new String16(this.applyTable(var1, var4)), var2, var3);
      this.write(var5, 0, var2 * var3);
   ...
   public void writeConstrainedString32O(String32 var1, int var2, int var3, String32Table var4) throws IOException, EOFException, BadValueException {
      this.skipToAlignment();
      BitString var5 = new BitString();
      var5.appendString32(this.applyTable(var1, var4), var2, var3);
      this.write(var5, 0, var2 * var3);
   ...
   public void writeConstrainedStringBO(String var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      int var6 = var1.length();
      this.writeUInteger(var6 - var3, var2);
      this.skipToAlignment();
      BitString var7 = new BitString();
   ...
   public void writeConstrainedString32BO(String32 var1, int var2, int var3, int var4, String32Table var5) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      int var6 = var1.length();
      this.writeUInteger(var6 - var3, var2);
      this.skipToAlignment();
      BitString var7 = new BitString();
   ...
   public void writeConstrainedStringOO(String var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      int var6 = var1.length();
      this.skipToAlignment();
      this.writeUInteger(var6 - var3, var2);
      BitString var7 = new BitString();
   ...
   public void writeConstrainedString32OO(String32 var1, int var2, int var3, int var4, String32Table var5) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      int var6 = var1.length();
      this.skipToAlignment();
      this.writeUInteger(var6 - var3, var2);
      BitString var7 = new BitString();
   ...
   public void writeConstrainedStringFOO(String var1, int var2, String16Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString16(new String16(this.applyTable(var1, var3)), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }

   public void writeConstrainedString32FOO(String32 var1, int var2, String32Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString32(this.applyTable(var1, var3), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }

   public void writeSemiconstrainedStringFOO(String var1, int var2, String16Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString16(new String16(this.applyTable(var1, var3)), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }

   public void writeSemiconstrainedString32FOO(String32 var1, int var2, String32Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString32(this.applyTable(var1, var3), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }

   public void writeUnconstrainedStringFOO(String var1, int var2, String16Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString16(new String16(this.applyTable(var1, var3)), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }

   public void writeUnconstrainedString32FOO(String32 var1, int var2, String32Table var3) throws IOException, EOFException, BadValueException {
      BitString var4 = new BitString();
      var4.appendString32(this.applyTable(var1, var3), var1.length(), var2);
      this.writeFragmented(var4, var2);
   }
   ...
   public void writeConstrainedGeneralizedTimeO(GeneralizedTime var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, BadValueException {
      this.writeConstrainedStringO(generalizedTimeToString(var1, var4), var2, var3, var5);
   }

   public void writeConstrainedGeneralizedTimeBO(GeneralizedTime var1, int var2, int var3, int var4, int var5, String16Table var6) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      this.writeConstrainedStringBO(generalizedTimeToString(var1, var5), var2, var3, var4, var6);
   }

   public void writeConstrainedGeneralizedTimeOO(GeneralizedTime var1, int var2, int var3, int var4, int var5, String16Table var6) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      this.writeConstrainedStringOO(generalizedTimeToString(var1, var5), var2, var3, var4, var6);
   }

   public void writeConstrainedGeneralizedTimeFOO(GeneralizedTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeConstrainedStringFOO(generalizedTimeToString(var1, var3), var2, var4);
   }

   public void writeSemiconstrainedGeneralizedTimeFOO(GeneralizedTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeSemiconstrainedStringFOO(generalizedTimeToString(var1, var3), var2, var4);
   }

   public void writeUnconstrainedGeneralizedTimeFOO(GeneralizedTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeUnconstrainedStringFOO(generalizedTimeToString(var1, var3), var2, var4);
   }
   ...
   public void writeConstrainedUTCTimeO(UTCTime var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, BadValueException {
      this.writeConstrainedStringO(utcTimeToString(var1, var4), var2, var3, var5);
   }

   public void writeConstrainedUTCTimeBO(UTCTime var1, int var2, int var3, int var4, int var5, String16Table var6) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      this.writeConstrainedStringBO(utcTimeToString(var1, var5), var2, var3, var4, var6);
   }

   public void writeConstrainedUTCTimeOO(UTCTime var1, int var2, int var3, int var4, int var5, String16Table var6) throws IOException, EOFException, ValueTooLargeException, BadValueException {
      this.writeConstrainedStringOO(utcTimeToString(var1, var5), var2, var3, var4, var6);
   }

   public void writeConstrainedUTCTimeFOO(UTCTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeConstrainedStringFOO(utcTimeToString(var1, var3), var2, var4);
   }

   public void writeSemiconstrainedUTCTimeFOO(UTCTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeSemiconstrainedStringFOO(utcTimeToString(var1, var3), var2, var4);
   }

   public void writeUnconstrainedUTCTimeFOO(UTCTime var1, int var2, int var3, String16Table var4) throws IOException, EOFException, BadValueException {
      this.writeUnconstrainedStringFOO(utcTimeToString(var1, var3), var2, var4);
   }
   ...
   public void writeExternal(External var1) throws IOException, EOFException, BadValueException, ValueTooLargeException {
      ...
      switch (var2.getSelector()) {
         ...
         case 2:
            ...
            this.writeBit(true);
            this.writeBit(var3 != null);
            this.writeUnconstrainedIntegerFOO(var2.getPresentationContextId());
            break;
         case 3:
            this.writeBit(true);
            this.writeBit(true);
            ...
            this.writeUnconstrainedIntegerFOO(var2.getContextNegotiationPresentationContextId());
            break;
         default:
            throw new BadValueException();
      }
      ...
      switch (var4.getSelector()) {
         ...
         case 1:
            if ((var4.getEncodedBitString().bitLength() & 7) != 0) {
               this.writeBit(true);
               this.writeBit(false);
               this.writeUnconstrainedBitStringFOO(var4.getEncodedBitString());
            } else {
               this.writeBit(false);
               this.writeBit(true);
               this.writeUnconstrainedOctetStringFOO(new OctetString(var4.getEncodedBitString()));
            }
            break;
         case 2:
            this.writeBit(false);
            this.writeBit(true);
            this.writeUnconstrainedOctetStringFOO(var4.getEncodedOctetString());
            break;
         default:
            throw new BadValueException();
      }
   ...
   public void writeCharacterString(CharacterString var1) throws IOException, EOFException, BadValueException, ValueTooLargeException {
      ...
      this.writeUnconstrainedOctetStringFOO(var6);
   }
   ...
   public void writeCharacterStringOpt(CharacterString var1, Identification var2) throws IOException, EOFException, BadValueException, ValueTooLargeException {
      ...
      this.writeUnconstrainedOctetStringFOO(var3);
   }

   public void writeOpen(UnitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeUnconstrainedOctetStringFOO(new OctetString(var1));
   }
   ...
   public void writeBitFieldFOO(TrimmedBitString var1) throws IOException, EOFException, ValueTooLargeException {
      this.writeFragmented(var1, 1);
   }

   public void writeBitFieldSO(TrimmedBitString var1) throws IOException, EOFException, ValueTooLargeException, BadValueException {
   ...
   public PEREncoder createExtensionEncoder() throws IOException, EOFException {
      DataEncoder var4 = new DataEncoder();
      PEREncoder var3 = this.createExtensionClone(var4);
      Iterator var5 = this.encoderCache.values().iterator();

      while(var5.hasNext()) {
         PEREncoder var2 = (PEREncoder)var5.next();
         if (var2 != this) {
   ...
   public void closeExtensionEncoder(PEREncoder var1) throws IOException, EOFException {
      var1.flushOut();
      DataEncoder var2 = (DataEncoder)var1.getOutputEncoder();
      this.writeFragmented(var2.getEncodedData(), 8);
   }

   public abstract PEREncoder createExtensionClone(Encoder var1);
