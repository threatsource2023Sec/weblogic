...
public abstract class CERDecoder extends FilterDecoder {
   ...
   public CERDecoder(Decoder var1, String var2, FactoryMap var3, byte[] var4) {
      super(var1);
      if (done == -1) {
         examine(var4);
      }
   ...
   protected CERDecoder(Decoder var1, CERDecoder var2, boolean var3) {
      super(var1);
      if (done == -1) {
   ...
   protected CERDecoder getDecoder(String var1) {
      return (CERDecoder)this.decoderMap.get(var1);
   }
   ...
   public CERDecoder createExplicitTagDecoder(int var1) throws BadDataException, IOException {
   ...
   public void readEndOfContents(CERDecoder var1) throws BadDataException, IOException {
   ...
   public abstract CERDecoder createExtensionClone(Decoder var1, boolean var2);
   ...
   public boolean readBoolean(int var1) throws BadDataException, IOException {
      ...
      if (this.currentLength != 1) {
         ...
         byte var2 = (byte)this.readUInteger(8);
         this.tagLengthCached = false;
         return var2 != 0;
      }
   }
   ...
   public BitString readBitString(int var1) throws BadDataException, IOException {
      ...
      if ((this.currentTag & 536870912) == 0) {
         ...
         CERDecoder var2 = this.createExplicitTagDecoder(var1);
         this.tagLengthCached = false;
         var3 = new BitString();
   ...
   public External readExternal(int var1) throws BadDataException, IOException, ValueTooLargeException {
      CERDecoder var7 = this.createExplicitTagDecoder(var1);
      var7.readTagLength();
      int var3;
      Identification var4;
      ...
      switch (var7.currentTag & -536870913) {
         case Integer.MIN_VALUE:
            CERDecoder var8 = var7.createExplicitTagDecoder(Integer.MIN_VALUE);
   ...
   public EmbeddedPDV readEmbeddedPDV(int var1) throws BadDataException, IOException {
      throw new InternalError("Decoding of EMBEDDED PDV for CER not implemented yet.");
   }

   public CharacterString readCharacterString(int var1) throws BadDataException, IOException {
      throw new InternalError("Decoding of CHARACTER STRING for CER not implemented yet.");
   }
   ...
   public OctetString readOpen() throws BadDataException, IOException {
      ...
      if ((this.currentTag & 536870912) == 0) {
         ...
         CERDecoder var2 = this.createExplicitTagDecoder(this.currentTag);
         this.tagLengthCached = false;
