...
public abstract class BEREncoder extends FilterEncoder {
   ...
   public BEREncoder(Encoder var1, String var2, byte[] var3) {
      super(var1);
      if (done == -1) {
         examine(var3);
      }
   ...
   protected BEREncoder(Encoder var1, BEREncoder var2, boolean var3) {
      super(var1);
      if (done == -1) {
   ...
   public void joinEncoder(BEREncoder var1) {
   ...
   protected BEREncoder getEncoder(String var1) {
      return (BEREncoder)this.encoderCache.get(var1);
   }
   ...
   public BEREncoder createExplicitTagEncoder(int var1, boolean var2) throws IOException {
      if (var2) {
   ...
   public void writeEndOfContents(BEREncoder var1) throws IOException {
   ...
   public abstract BEREncoder createExtensionClone(Encoder var1, boolean var2);
   ...
   public void writeExternal(External var1, int var2) throws IOException, BadValueException {
      BEREncoder var3 = this.createExplicitTagEncoder(var2, true);
      ...
      switch (var6.getSelector()) {
         case 0:
            BEREncoder var7 = var3.createExplicitTagEncoder(Integer.MIN_VALUE, true);
   ...
   public void writeExternalDefiniteLength(External var1, int var2) throws IOException, BadValueException {
      BEREncoder var3 = this.createExplicitTagEncoder(var2, false);
      Identification var4 = var1.getIdentification();
      ObjectDescriptor var5 = var1.getDataValueDescriptor();
      DataValue var6 = var1.getDataValue();
      switch (var4.getSelector()) {
      ...
      switch (var6.getSelector()) {
         case 0:
            BEREncoder var7 = var3.createExplicitTagEncoder(Integer.MIN_VALUE, false);
            var7.writeOpen(var6.getNotation().getEncoded());
            var3.writeEndOfContents(var7);
            break;
         case 1:
            var3.writeBitString(var6.getEncodedBitString(), -2147483647);
            break;
         case 2:
            var3.writeOctetString(var6.getEncodedOctetString(), -2147483646);
            break;
         default:
            throw new BadValueException();
      }
   ...
   public void writeEmbeddedPDV(EmbeddedPDV var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of EMBEDDED PDV for BER not implemented yet.");
   }

   public void writeEmbeddedPDVDefiniteLength(EmbeddedPDV var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of EMBEDDED PDV for BER not implemented yet.");
   }

   public void writeCharacterString(CharacterString var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of CHARACTER STRING for BER not implemented yet.");
   }

   public void writeCharacterStringDefiniteLength(CharacterString var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of CHARACTER STRING for BER not implemented yet.");
   }
