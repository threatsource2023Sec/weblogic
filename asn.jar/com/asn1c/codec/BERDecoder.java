...
public abstract class BERDecoder extends FilterDecoder {
   ...
   public BERDecoder(Decoder var1, String var2, FactoryMap var3, byte[] var4) {
      super(var1);
      if (done == -1) {
         examine(var4);
      }
   ...
   protected BERDecoder(Decoder var1, BERDecoder var2, boolean var3) {
      super(var1);
      if (done == -1) {
   ...
   protected BERDecoder getDecoder(String var1) {
      return (BERDecoder)this.decoderMap.get(var1);
   }
   ...
   public BERDecoder createExplicitTagDecoder(int var1) throws BadDataException, IOException {
   ...
   public void readEndOfContents(BERDecoder var1) throws BadDataException, IOException {
   ...
   public abstract BERDecoder createExtensionClone(Decoder var1, boolean var2);
   ...
   public BitString readBitString(int var1) throws BadDataException, IOException {
      ...
      if ((this.currentTag & 536870912) == 0) {
         ...
         BERDecoder var2 = this.createExplicitTagDecoder(var1);
         this.tagLengthCached = false;
         var3 = new BitString();
   ...
   public External readExternal(int var1) throws BadDataException, IOException, ValueTooLargeException {
      BERDecoder var7 = this.createExplicitTagDecoder(var1);
      var7.readTagLength();
      int var3;
      Identification var4;
      ...
      switch (var7.currentTag & -536870913) {
         case Integer.MIN_VALUE:
            BERDecoder var8 = var7.createExplicitTagDecoder(Integer.MIN_VALUE);
   ...
   public OctetString readOpen() throws BadDataException, IOException {
      ...
      if ((this.currentTag & 536870912) == 0) {
         ...
         BERDecoder var2 = this.createExplicitTagDecoder(this.currentTag);
         this.tagLengthCached = false;
