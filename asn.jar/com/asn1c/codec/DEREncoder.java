...
public abstract class DEREncoder extends FilterEncoder {
   ...
   public DEREncoder(Encoder var1, String var2, byte[] var3) {
      super(var1);
      if (done == -1) {
         examine(var3);
      }
   ...
   protected DEREncoder(Encoder var1, DEREncoder var2, boolean var3) {
      super(var1);
      if (done == -1) {
   ...
   public void joinEncoder(DEREncoder var1) {
   ...
   protected DEREncoder getEncoder(String var1) {
      return (DEREncoder)this.encoderCache.get(var1);
   }
   ...
   public DEREncoder createExplicitTagEncoder(int var1, boolean var2) throws IOException {
      if (var2) {
   ...
   public void writeEndOfContents(DEREncoder var1) throws IOException {
   ...
   public abstract DEREncoder createExtensionClone(Encoder var1, boolean var2);
   ...
   public void writeExternal(External var1, int var2) throws IOException, BadValueException {
      DEREncoder var3 = this.createExplicitTagEncoder(var2, false);
      ...
      switch (var6.getSelector()) {
         case 0:
            DEREncoder var7 = var3.createExplicitTagEncoder(Integer.MIN_VALUE, false);
   ...
   public void writeEmbeddedPDV(EmbeddedPDV var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of EMBEDDED PDV for DER not implemented yet.");
   }

   public void writeCharacterString(CharacterString var1, int var2) throws IOException, BadValueException {
      throw new InternalError("Encoding of CHARACTER STRING for DER not implemented yet.");
   }
