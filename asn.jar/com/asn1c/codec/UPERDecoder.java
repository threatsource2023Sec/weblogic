...
public abstract class UPERDecoder extends FilterDecoder {
   ...
   public UPERDecoder(Decoder var1, String var2, FactoryMap var3, byte[] var4) {
      super(var1);
      if (done == -1) {
         examine(var4);
      }
   ...
   protected UPERDecoder(Decoder var1, UPERDecoder var2) {
      super(var1);
      if (done == -1) {
   ...
   protected UPERDecoder getDecoder(String var1) {
      return (UPERDecoder)this.decoderMap.get(var1);
   }
   ...
   public int readConstrainedIntegerBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
   ...
   public long readConstrainedLongBB(int var1, long var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
   ...
   public BigInteger readConstrainedBigIntegerBB(int var1, BigInteger var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1);
      if (var3 > 268435454) {
         throw new ValueTooLargeException();
      } else {
   ...
   public void skipConstrainedIntegerBB(int var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
   ...
   public BigInteger readConstrainedBigIntegerFBB(BigInteger var1) throws IOException, EOFException, BadDataException {
   ...
   public byte readSemiconstrainedByteFBB(byte var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var2 = this.readFragmented(8);
      return (byte)(var2.getUInteger(0, var2.bitLength()) + var1);
   }

   public short readSemiconstrainedShortFBB(short var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var2 = this.readFragmented(8);
      return (short)(var2.getUInteger(0, var2.bitLength()) + var1);
   }

   public int readSemiconstrainedIntegerFBB(int var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var2 = this.readFragmented(8);
      return var2.getUInteger(0, var2.bitLength()) + var1;
   }

   public long readSemiconstrainedLongFBB(long var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(8);
      return var3.getULong(0, var3.bitLength()) + var1;
   }

   public BigInteger readSemiconstrainedBigIntegerFBB(BigInteger var1) throws IOException, EOFException, BadDataException {
      BitString var2 = this.readFragmented(8);
      return var2.getUBigInteger(0, var2.bitLength()).add(var1);
   }
   ...
   public byte readSemiconstrainedByteSB(byte var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      return this.readBit() ? this.readSemiconstrainedByteFBB(var1) : (byte)(this.readUInteger(6) + var1);
   }
   ...
   public BitString readConstrainedBitStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
      return this.readBits(var3);
   }

   public TrimmedBitString readConstrainedTrimmedBitStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
      return new TrimmedBitString(this.readBits(var3));
   }

   public void skipConstrainedBitStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
      this.skip((long)var3);
   }

   public void skipConstrainedTrimmedBitStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
      this.skip((long)var3);
   }
   ...
   public OctetString readConstrainedOctetStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
      return this.readBits(var3 * 8).getOctets(0, var3);
   }

   public void skipConstrainedOctetStringBB(int var1, int var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      int var3 = this.readUInteger(var1) + var2;
   ...
   public String readConstrainedStringFBB(int var1, String16Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString(0, var3.bitLength() / var1, var1), var2);
   }

   public String32 readConstrainedString32FBB(int var1, String32Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString32(0, var3.bitLength() / var1, var1), var2);
   }

   public void skipConstrainedStringFBB(int var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      this.skipFragmented(var1);
   }

   public String readSemiconstrainedStringFBB(int var1, String16Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString(0, var3.bitLength() / var1, var1), var2);
   }

   public String32 readSemiconstrainedString32FBB(int var1, String32Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString32(0, var3.bitLength() / var1, var1), var2);
   }

   public void skipSemiconstrainedStringFBB(int var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      this.skipFragmented(var1);
   }

   public String readUnconstrainedStringFBB(int var1, String16Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString(0, var3.bitLength() / var1, var1), var2);
   }

   public String32 readUnconstrainedString32FBB(int var1, String32Table var2) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      BitString var3 = this.readFragmented(var1);
      return this.applyTable(var3.getString32(0, var3.bitLength() / var1, var1), var2);
   }

   public void skipUnconstrainedStringFBB(int var1) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      this.skipFragmented(var1);
   }
   ...
   public GeneralizedTime readConstrainedGeneralizedTimeBB(int var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var6 = this.readConstrainedStringBB(var1, var2, var3, var5);
      return this.stringToGeneralizedTime(var6, var4);
   }

   public GeneralizedTime readConstrainedGeneralizedTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToGeneralizedTime(var4, var2);
   }

   public GeneralizedTime readSemiconstrainedGeneralizedTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToGeneralizedTime(var4, var2);
   }

   public GeneralizedTime readUnconstrainedGeneralizedTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToGeneralizedTime(var4, var2);
   }
   ...
   public UTCTime readConstrainedUTCTimeBB(int var1, int var2, int var3, int var4, String16Table var5) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var6 = this.readConstrainedStringBB(var1, var2, var3, var5);
      return this.stringToUTCTime(var6, var4);
   }

   public UTCTime readConstrainedUTCTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToUTCTime(var4, var2);
   }

   public UTCTime readSemiconstrainedUTCTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToUTCTime(var4, var2);
   }

   public UTCTime readUnconstrainedUTCTimeFBB(int var1, int var2, String16Table var3) throws IOException, EOFException, ValueTooLargeException, BadDataException {
      String var4 = this.readConstrainedStringFBB(var1, var3);
      return this.stringToUTCTime(var4, var2);
   }
   ...
   public External readExternal() throws IOException, EOFException, BadDataException, ValueTooLargeException {
      ...
      if (!var4.getBit(0)) {
         ...
         int var5 = this.readUnconstrainedIntegerFBB();
         ...
         if (!var4.getBit(1)) {
            ...
            var8 = this.readObjectIdentifier();
            int var6 = this.readUnconstrainedIntegerFBB();
      ...
      if (var3) {
         ...
         if (!var5.getBit(2)) {
            if (!var5.getBit(1)) {
               ...
               int var8 = this.readUnconstrainedIntegerFBB();
               var1 = new Identification(2, var8);
            } else {
               var6 = this.readObjectIdentifier();
               int var9 = this.readUnconstrainedIntegerFBB();
   ...
   public void closeExtensionDecoder(UPERDecoder var1) throws IOException, EOFException, BadDataException {
      var1.flushIn();
   }
