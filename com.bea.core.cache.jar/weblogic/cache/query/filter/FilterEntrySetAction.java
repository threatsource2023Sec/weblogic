...
public class FilterEntrySetAction extends FilterAction {
   public FilterEntrySetAction(Comparator comparator, String name, Object... parameters) {
   ...
   public Object run() {
      if (!(this.cache instanceof CacheMap)) {
         ...
         if (filter == null) {
            ...
            return FilterQueryHelper.entrySet(filter, this.cache, this.comparator, this.parameters);
         }
      }
   }
}
