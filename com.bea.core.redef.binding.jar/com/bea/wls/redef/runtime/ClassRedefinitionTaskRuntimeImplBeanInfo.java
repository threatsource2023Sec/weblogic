...
public class ClassRedefinitionTaskRuntimeImplBeanInfo extends TaskRuntimeMBeanImplBeanInfo {
   public static final Class INTERFACE_CLASS = ClassRedefinitionTaskRuntimeMBean.class;

   public ClassRedefinitionTaskRuntimeImplBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
      super(readOnly, targetVersion);
   }

   public ClassRedefinitionTaskRuntimeImplBeanInfo() throws IntrospectionException {
   }
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("com.bea.wls.redef.runtime.ClassRedefinitionTaskRuntimeImpl");
      ...
      String description = (new String("<p> This interface provides functionality to monitor and control a class redefinition request. </p> ")).intern();
      beanDescriptor.setShortDescription(description);
      beanDescriptor.setValue("description", description);
      beanDescriptor.setValue("interfaceclassname", "com.bea.wls.redef.runtime.ClassRedefinitionTaskRuntimeMBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("BeginTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("BeginTime", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("CandidateClassesCount")) {
         getterName = "getCandidateClassesCount";
         setterName = null;
         currentResult = new PropertyDescriptor("CandidateClassesCount", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("CandidateClassesCount", currentResult);
         currentResult.setValue("description", "<p>Estimated number of candidate classes to be redefined in the current change-list. Returns -1 if the number is not yet estimated. </p> ");
      ...
      if (!descriptors.containsKey("Description")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Description", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("EndTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("EndTime", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Error")) {
         getterName = "getError";
         setterName = null;
         currentResult = new PropertyDescriptor("Error", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ParentTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ParentTask", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("ProcessedClassesCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("ProcessedClassesCount", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("ProcessedClassesCount", currentResult);
         currentResult.setValue("description", "<p>Number of classes processed so far.</p> ");
         currentResult.setValue("owner", "");
      }
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("Progress")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Progress", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Status")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Status", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SubTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SubTasks", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("Running")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("Running", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("SystemTask")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("SystemTask", ClassRedefinitionTaskRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = ClassRedefinitionTaskRuntimeMBean.class.getMethod("cancel");
      ...
      mth = ClassRedefinitionTaskRuntimeMBean.class.getMethod("printLog", PrintWriter.class);
