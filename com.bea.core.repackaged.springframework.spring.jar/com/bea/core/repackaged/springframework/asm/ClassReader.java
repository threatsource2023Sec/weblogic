...
public class ClassReader {
   ...
   private int readMethod(ClassVisitor classVisitor, Context context, int methodInfoOffset) {
      ...
      if (methodVisitor == null) {
         ...
         if (methodVisitor instanceof MethodWriter) {
            ...
            if (methodWriter.canCopyMethodAttributes(this, methodInfoOffset, currentOffset - methodInfoOffset, synthetic, (context.currentMethodAccessFlags & 131072) != 0, this.readUnsignedShort(methodInfoOffset + 4), signatureIndex, exceptionsOffset)) {
               return currentOffset;
            }
         }
      ...
      if (stackMapFrameOffset != 0) {
         ...
         for(currentVisibleTypeAnnotationIndex = stackMapFrameOffset; currentVisibleTypeAnnotationIndex < stackMapTableEndOffset - 2; ++currentVisibleTypeAnnotationIndex) {
            if (classFileBuffer[currentVisibleTypeAnnotationIndex] == 8) {
               ...
               if (currentVisibleTypeAnnotationBytecodeOffset >= 0 && currentVisibleTypeAnnotationBytecodeOffset < codeLength && (classFileBuffer[bytecodeStartOffset + currentVisibleTypeAnnotationBytecodeOffset] & 255) == 187) {
         ...
         switch (startPc) {
            ...
            case 185:
               ...
               if (startPc < 182) {
                  ...
                  boolean isInterface = classFileBuffer[typeAnnotationOffset - 1] == 11;
   ...
   private int readTypeAnnotationTarget(Context context, int typeAnnotationOffset) {
      ...
      context.currentTypeAnnotationTargetPath = tableLength == 0 ? null : new TypePath(this.b, currentOffset);
