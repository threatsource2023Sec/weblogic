...
public final class Type {
   ...
   public String getDescriptor() {
      if (this.sort == 10) {
         ...
         return this.sort == 12 ? (new StringBuilder()).append('L').append(this.valueBuffer, this.valueBegin, this.valueEnd).append(';').toString() : this.valueBuffer.substring(this.valueBegin, this.valueEnd);
      }
   }
