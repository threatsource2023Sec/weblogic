...
class BulkBeanEmitter extends ClassEmitter {
   ...
   private static final Type BULK_BEAN = TypeUtils.parseType("com.bea.core.repackaged.springframework.cglib.beans.BulkBean");
   private static final Type BULK_BEAN_EXCEPTION = TypeUtils.parseType("com.bea.core.repackaged.springframework.cglib.beans.BulkBeanException");
