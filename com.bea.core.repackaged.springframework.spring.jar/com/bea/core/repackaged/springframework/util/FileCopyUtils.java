...
public abstract class FileCopyUtils {
   ...
   public static int copy(File in, File out) throws IOException {
      Assert.notNull(in, (String)"No input File specified");
      Assert.notNull(out, (String)"No output File specified");
   ...
   public static int copy(Reader in, Writer out) throws IOException {
      Assert.notNull(in, (String)"No Reader specified");
      Assert.notNull(out, (String)"No Writer specified");
