...
public class ResolvableType implements Serializable {
   ...
   private boolean isAssignableFrom(ResolvableType other, @Nullable Map matchedBefore) {
      Assert.notNull(other, (String)"ResolvableType must not be null");
      if (this != NONE && other != NONE) {
         if (this.isArray()) {
            ...
            WildcardBounds ourBounds = ResolvableType.WildcardBounds.get(this);
            WildcardBounds typeBounds = ResolvableType.WildcardBounds.get(other);
            if (typeBounds != null) {
   ...
   public ResolvableType getComponentType() {
      if (this == NONE) {
         ...
         return forType(componentType, (VariableResolver)this.variableResolver);
      } else {
   ...
   public ResolvableType getNested(int nestingLevel, @Nullable Map typeIndexesPerLevel) {
   ...
   private int calculateHashCode() {
      int hashCode = ObjectUtils.nullSafeHashCode((Object)this.type);
      if (this.typeProvider != null) {
         hashCode = 31 * hashCode + ObjectUtils.nullSafeHashCode((Object)this.typeProvider.getType());
      }
      ...
      if (this.componentType != null) {
         hashCode = 31 * hashCode + ObjectUtils.nullSafeHashCode((Object)this.componentType);
      }
   ...
   VariableResolver asVariableResolver() {
      return this == NONE ? null : new DefaultVariableResolver();
   }
   ...
   public static ResolvableType forClass(Class baseType, Class implementationClass) {
      Assert.notNull(baseType, (String)"Base type must not be null");
   ...
   public static ResolvableType forClassWithGenerics(Class clazz, Class... generics) {
      ...
      Assert.notNull(generics, (String)"Generics array must not be null");
   ...
   public static ResolvableType forClassWithGenerics(Class clazz, ResolvableType... generics) {
      ...
      return forType(syntheticType, (VariableResolver)(new TypeVariablesVariableResolver(variables, generics)));
   }
   ...
   public static ResolvableType forField(Field field) {
      ...
      return forType((Type)null, new SerializableTypeWrapper.FieldTypeProvider(field), (VariableResolver)null);
   }
   ...
   public static ResolvableType forField(Field field, int nestingLevel) {
      Assert.notNull(field, (String)"Field must not be null");
      return forType((Type)null, new SerializableTypeWrapper.FieldTypeProvider(field), (VariableResolver)null).getNested(nestingLevel);
   }
   ...
   public static ResolvableType forType(@Nullable Type type) {
      return forType(type, (SerializableTypeWrapper.TypeProvider)null, (VariableResolver)null);
   }
   ...
   public static ResolvableType forType(ParameterizedTypeReference typeReference) {
      return forType(typeReference.getType(), (SerializableTypeWrapper.TypeProvider)null, (VariableResolver)null);
   }
   ...
   // $FF: synthetic method
   ResolvableType(Class x0, Object x1) {
      this(x0);
   }

   static {
      NONE = new ResolvableType(ResolvableType.EmptyType.INSTANCE, (SerializableTypeWrapper.TypeProvider)null, (VariableResolver)null, 0);
   ...
   private static class WildcardBounds {
      ...
      public static WildcardBounds get(ResolvableType type) {
         ...
         Kind boundsType = wildcardType.getLowerBounds().length > 0 ? ResolvableType.WildcardBounds.Kind.LOWER : ResolvableType.WildcardBounds.Kind.UPPER;
   ...
   private class DefaultVariableResolver implements VariableResolver {
      ...
      // $FF: synthetic method
      DefaultVariableResolver(Object x1) {
         this();
      }
   }
