...
@Label("Webservices JAXWS Resource")
@Name("com.oracle.weblogic.webservices.WebservicesJAXWSResourceEvent")
@Description("Webservices JAX-WS resource information")
@Category({"WebLogic Server", "Webservices", "JAXWS"})
public class WebservicesJAXWSResourceEvent extends BaseEvent implements WebservicesJAXWSEventInfo {
   @Label("Subsystem")
