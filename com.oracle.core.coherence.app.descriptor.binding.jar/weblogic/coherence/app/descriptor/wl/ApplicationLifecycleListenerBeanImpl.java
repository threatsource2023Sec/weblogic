...
public class ApplicationLifecycleListenerBeanImpl extends SettableBeanImpl implements ApplicationLifecycleListenerBean, Serializable {
   private String _ClassName;
   private InitParamsBean _InitParams;
   private static SchemaHelper2 _schemaHelper;

   public ApplicationLifecycleListenerBeanImpl() {
      this._initializeProperty(-1);
   }

   public ApplicationLifecycleListenerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ApplicationLifecycleListenerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SettableBeanImpl.Helper {
      private ApplicationLifecycleListenerBeanImpl bean;

      protected Helper(ApplicationLifecycleListenerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ApplicationLifecycleListenerBeanImpl otherTyped = (ApplicationLifecycleListenerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ApplicationLifecycleListenerBeanImpl original = (ApplicationLifecycleListenerBeanImpl)event.getSourceBean();
            ApplicationLifecycleListenerBeanImpl proposed = (ApplicationLifecycleListenerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ApplicationLifecycleListenerBeanImpl copy = (ApplicationLifecycleListenerBeanImpl)initialCopy;
