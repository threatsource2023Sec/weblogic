...
public final class _DomainMigrationHistory_Stub extends Stub implements DomainMigrationHistory {
   private static String[] _type_ids = new String[]{"RMI:weblogic.management.provider.DomainMigrationHistory:0000000000000000"};
   // $FF: synthetic field
   ...
   public final void update(MigrationData var1) throws RemoteException {
      try {
         ...
         try {
            org.omg.CORBA_2_3.portable.OutputStream var3 = (org.omg.CORBA_2_3.portable.OutputStream)this._request("update", true);
