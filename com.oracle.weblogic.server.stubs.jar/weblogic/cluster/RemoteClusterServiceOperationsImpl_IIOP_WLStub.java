...
public final class RemoteClusterServiceOperationsImpl_IIOP_WLStub extends Stub implements StubInfoIntf, RemoteClusterServicesOperations {
   // $FF: synthetic field
   ...
   public RemoteClusterServiceOperationsImpl_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
