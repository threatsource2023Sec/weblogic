...
public final class SingletonServicesManagerService_IIOP_WLStub extends Stub implements StubInfoIntf, RemoteSingletonServicesControl {
   // $FF: synthetic field
   ...
   public SingletonServicesManagerService_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
