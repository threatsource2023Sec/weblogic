...
public final class ResourceGroupMigrationManagerImpl_IIOP_WLStub extends Stub implements StubInfoIntf, ResourceGroupMigrationManager {
   // $FF: synthetic field
   ...
   public ResourceGroupMigrationManagerImpl_IIOP_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
