...
public class EncryptionConfigurationCriterion implements Criterion {
   ...
   public EncryptionConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty List configurations) {
   ...
   public EncryptionConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty EncryptionConfiguration... configurations) {
      Constraint.isNotNull(configurations, "List of configurations cannot be null");
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof EncryptionConfigurationCriterion ? this.configs.equals(((EncryptionConfigurationCriterion)obj).getConfigurations()) : false;
      }
   }
}
