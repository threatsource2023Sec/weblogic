...
public class SignatureValidationConfigurationCriterion implements Criterion {
   ...
   public SignatureValidationConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty List configurations) {
   ...
   public SignatureValidationConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty SignatureValidationConfiguration... configurations) {
      Constraint.isNotNull(configurations, "List of configurations cannot be null");
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof SignatureValidationConfigurationCriterion ? this.configs.equals(((SignatureValidationConfigurationCriterion)obj).getConfigurations()) : false;
      }
   }
}
