...
public class DecryptionConfigurationCriterion implements Criterion {
   ...
   public DecryptionConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty List configurations) {
   ...
   public DecryptionConfigurationCriterion(@Nonnull @NonnullElements @NotEmpty DecryptionConfiguration... configurations) {
      Constraint.isNotNull(configurations, "List of configurations cannot be null");
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         return obj instanceof DecryptionConfigurationCriterion ? this.configs.equals(((DecryptionConfigurationCriterion)obj).getConfigurations()) : false;
      }
   }
}
