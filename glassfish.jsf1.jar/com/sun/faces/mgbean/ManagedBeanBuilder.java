...
public class ManagedBeanBuilder extends BeanBuilder {
   ...
   void bake() {
      if (!this.isBaked()) {
         ...
         if (this.beanInfo.hasManagedProperties()) {
            ...
            try {
               Iterator i$ = this.beanInfo.getManagedProperties().iterator();

               while(i$.hasNext()) {
                  ManagedBeanInfo.ManagedProperty property = (ManagedBeanInfo.ManagedProperty)i$.next();
   ...
   protected void buildBean(Object bean, FacesContext context) {
      if (this.properties != null) {
         ...
         while(i$.hasNext()) {
            BakedProperty property = (BakedProperty)i$.next();
