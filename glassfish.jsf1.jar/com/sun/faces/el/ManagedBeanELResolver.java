   ...
   public Iterator getFeatureDescriptors(ELContext context, Object base) {
      if (base != null) {
         ...
         if (beanManager != null && !beanManager.getRegisteredBeans().isEmpty()) {
            ...
            BeanBuilder builder;
            String description;
            for(Iterator i$ = beans.entrySet().iterator(); i$.hasNext(); list.add(Util.getFeatureDescriptor(beanName, beanName, description == null ? "" : description, false, false, true, builder.getBeanClass(), Boolean.TRUE))) {
               Map.Entry bean = (Map.Entry)i$.next();
