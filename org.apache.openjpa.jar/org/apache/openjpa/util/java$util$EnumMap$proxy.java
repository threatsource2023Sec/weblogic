...
public class java$util$EnumMap$proxy extends EnumMap implements ProxyMap {
   ...
   public java$util$EnumMap$proxy(Class var1) {
      super(var1);
   }

   public java$util$EnumMap$proxy(EnumMap var1) {
      super(var1);
   }

   public java$util$EnumMap$proxy(Map var1) {
      super(var1);
   }
   ...
   public Object copy(Object var1) {
      return new EnumMap((EnumMap)var1);
   }
