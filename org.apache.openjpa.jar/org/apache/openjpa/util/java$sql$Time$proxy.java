...
public class java$sql$Time$proxy extends Time implements ProxyDate {
   ...
   public java$sql$Time$proxy(int var1, int var2, int var3) {
      super(var1, var2, var3);
   }

   public java$sql$Time$proxy(long var1) {
      super(var1);
   }
   ...
   public Object copy(Object var1) {
      return new Time(((Date)var1).getTime());
   }

   public ProxyDate newInstance() {
      return new java$sql$Time$proxy();
   }
