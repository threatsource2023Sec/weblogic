...
public class java$util$LinkedHashMap$proxy extends LinkedHashMap implements ProxyMap {
   ...
   public java$util$LinkedHashMap$proxy(int var1, float var2) {
      super(var1, var2);
   }

   public java$util$LinkedHashMap$proxy(int var1) {
      super(var1);
   }

   public java$util$LinkedHashMap$proxy() {
   }

   public java$util$LinkedHashMap$proxy(Map var1) {
      super(var1);
   }

   public java$util$LinkedHashMap$proxy(int var1, float var2, boolean var3) {
   ...
   public Object copy(Object var1) {
      return new LinkedHashMap((Map)var1);
   }
   ...
   public ProxyMap newInstance(Class var1, Class var2, Comparator var3, boolean var4, boolean var5) {
      java$util$LinkedHashMap$proxy var6 = new java$util$LinkedHashMap$proxy();
      var6.keyType = var1;
      var6.valueType = var2;
      if (var4) {
