...
public class java$util$Properties$proxy extends Properties implements ProxyMap {
   ...
   public java$util$Properties$proxy(Properties var1) {
      super(var1);
   }
   ...
   public Object copy(Object var1) {
      return new Properties((Properties)var1);
   }
   ...
   public ProxyMap newInstance(Class var1, Class var2, Comparator var3, boolean var4, boolean var5) {
      java$util$Properties$proxy var6 = new java$util$Properties$proxy();
      var6.keyType = var1;
      var6.valueType = var2;
      if (var4) {
   ...
   public Object setProperty(String var1, String var2) {
      boolean var3 = ProxyMaps.beforeSetProperty(this, var1, var2);
      Object var4 = super.setProperty(var1, var2);
      return ProxyMaps.afterSetProperty(this, var1, var2, var4, var3);
   }

   public void load(InputStream var1) {
      ProxyMaps.beforeLoad(this, var1);
      super.load(var1);
   }

   public void loadFromXML(InputStream var1) {
      ProxyMaps.beforeLoadFromXML(this, var1);
