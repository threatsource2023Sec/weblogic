...
public class java$util$HashSet$proxy extends HashSet implements ProxyCollection {
   ...
   public java$util$HashSet$proxy(Collection var1) {
      super(var1);
   }

   public java$util$HashSet$proxy(int var1, float var2) {
      super(var1, var2);
   }

   public java$util$HashSet$proxy(int var1) {
      super(var1);
   }
   ...
   public Object copy(Object var1) {
      return new HashSet((Collection)var1);
   }
   ...
   public ProxyCollection newInstance(Class var1, Comparator var2, boolean var3, boolean var4) {
      java$util$HashSet$proxy var5 = new java$util$HashSet$proxy();
