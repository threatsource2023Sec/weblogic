...
public class java$util$HashMap$proxy extends HashMap implements ProxyMap {
   ...
   public java$util$HashMap$proxy(int var1, float var2) {
      super(var1, var2);
   }

   public java$util$HashMap$proxy(int var1) {
      super(var1);
   }
   ...
   public java$util$HashMap$proxy(Map var1) {
      super(var1);
   }
   ...
   public ProxyMap newInstance(Class var1, Class var2, Comparator var3, boolean var4, boolean var5) {
      java$util$HashMap$proxy var6 = new java$util$HashMap$proxy();
      var6.keyType = var1;
      var6.valueType = var2;
      if (var4) {
