...
public class java$util$ArrayList$proxy extends ArrayList implements ProxyCollection {
   private transient OpenJPAStateManager sm;
   private transient int field;
   private transient CollectionChangeTracker changeTracker;
   private transient Class elementType;

   public java$util$ArrayList$proxy(int var1) {
      super(var1);
   }
   ...
   public java$util$ArrayList$proxy(Collection var1) {
      super(var1);
   }
   ...
   public Object copy(Object var1) {
      return new ArrayList((Collection)var1);
   }
   ...
   public ProxyCollection newInstance(Class var1, Comparator var2, boolean var3, boolean var4) {
      java$util$ArrayList$proxy var5 = new java$util$ArrayList$proxy();
