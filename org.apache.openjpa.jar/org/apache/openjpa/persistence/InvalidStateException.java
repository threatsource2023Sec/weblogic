...
public class InvalidStateException extends IllegalStateException implements Serializable, ExceptionInfo {
   ...
   public InvalidStateException(String msg, Throwable[] nested, Object failed, boolean fatal) {
      super(msg);
      this._fatal = false;
      this._failed = null;
      this._nested = null;
