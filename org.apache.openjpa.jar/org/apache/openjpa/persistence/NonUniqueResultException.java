...
public class NonUniqueResultException extends javax.persistence.NonUniqueResultException implements Serializable, ExceptionInfo {
   private transient boolean _fatal = false;
   private transient Object _failed = null;
   private transient Throwable[] _nested = null;

   public NonUniqueResultException(String msg, Throwable[] nested, Object failed, boolean fatal) {
      super(msg);
      this._nested = nested;
      this._failed = failed;
      this._fatal = fatal;
