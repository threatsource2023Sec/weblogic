...
public class TransactionRequiredException extends javax.persistence.TransactionRequiredException implements Serializable, ExceptionInfo {
   ...
   public TransactionRequiredException(Localizer.Message msg, Throwable[] nested, Object failed, boolean fatal) {
      this(msg.getMessage(), nested, failed, fatal);
   }

   public TransactionRequiredException(String msg, Throwable[] nested, Object failed, boolean fatal) {
      super(msg);
      this._fatal = false;
      this._failed = null;
      this._nested = null;
