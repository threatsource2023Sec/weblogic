...
public class TTLLRUCache extends LRUCache {
   ...
   public Object put(Object key, Object value, long timeToLive) {
      TTLEntry entry = (TTLEntry)super.put(key, new TTLEntry(value, timeToLive));
      return entry == null ? null : entry.value;
   }
   ...
   private Iterator getSuperIterator() {
   ...
   private class TTLIterator implements Iterator {
      Iterator iterator = TTLLRUCache.this.getSuperIterator();
   ...
   private class TTLEntry {
      ...
      public TTLEntry(Object value) {
         this(value, TTLLRUCache.this.timeToLive);
      }

      public TTLEntry(Object value, long timeToLive) {
         this.value = value;
      ...
      public boolean isValid() {
         return this.TTL == 0L || System.currentTimeMillis() - this.timeStamp < this.TTL;
      }
