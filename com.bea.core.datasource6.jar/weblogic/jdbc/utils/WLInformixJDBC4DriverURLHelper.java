...
public class WLInformixJDBC4DriverURLHelper extends JDBCURLHelper {
   public String getURL() throws JDBCDriverInfoException {
      ...
      if (!this.isValid(info.getDbmsHost())) {
         ...
         return "jdbc:weblogic:informix://" + info.getDbmsHost() + ":" + info.getDbmsPort() + ";informixServer=" + this.getOtherAttribute("informixserver", info) + ";databaseName=" + info.getDbmsName();
      }
   }
