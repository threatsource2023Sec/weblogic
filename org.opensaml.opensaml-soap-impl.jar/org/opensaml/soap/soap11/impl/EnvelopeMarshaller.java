...
public class EnvelopeMarshaller extends AbstractXMLObjectMarshaller {
   protected void marshallAttributes(XMLObject xmlObject, Element domElement) throws MarshallingException {
      ...
      Iterator var5 = envelope.getUnknownAttributes().entrySet().iterator();
      ...
      while(true) {
         ...
         } while(!XMLObjectProviderRegistrySupport.isIDAttribute((QName)entry.getKey()) && !envelope.getUnknownAttributes().isIDAttribute((QName)entry.getKey()));
