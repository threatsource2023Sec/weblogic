...
public class BodyMarshaller extends AbstractXMLObjectMarshaller {
   protected void marshallAttributes(XMLObject xmlObject, Element domElement) throws MarshallingException {
      ...
      Iterator var5 = body.getUnknownAttributes().entrySet().iterator();
      ...
      while(true) {
         ...
         } while(!XMLObjectProviderRegistrySupport.isIDAttribute((QName)entry.getKey()) && !body.getUnknownAttributes().isIDAttribute((QName)entry.getKey()));
