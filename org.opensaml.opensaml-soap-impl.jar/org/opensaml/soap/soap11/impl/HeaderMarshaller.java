...
public class HeaderMarshaller extends AbstractXMLObjectMarshaller {
   protected void marshallAttributes(XMLObject xmlObject, Element domElement) throws MarshallingException {
      ...
      Iterator var5 = header.getUnknownAttributes().entrySet().iterator();
      ...
      while(true) {
         ...
         } while(!XMLObjectProviderRegistrySupport.isIDAttribute((QName)entry.getKey()) && !header.getUnknownAttributes().isIDAttribute((QName)entry.getKey()));
