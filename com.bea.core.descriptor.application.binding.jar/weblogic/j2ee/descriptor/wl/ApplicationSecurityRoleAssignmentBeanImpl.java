...
public class ApplicationSecurityRoleAssignmentBeanImpl extends AbstractDescriptorBean implements ApplicationSecurityRoleAssignmentBean, Serializable {
   private EmptyBean _ExternallyDefined;
   private String[] _PrincipalNames;
   private String _RoleName;
   private static SchemaHelper2 _schemaHelper;

   public ApplicationSecurityRoleAssignmentBeanImpl() {
      this._initializeProperty(-1);
   }

   public ApplicationSecurityRoleAssignmentBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ApplicationSecurityRoleAssignmentBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private ApplicationSecurityRoleAssignmentBeanImpl bean;

      protected Helper(ApplicationSecurityRoleAssignmentBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ApplicationSecurityRoleAssignmentBeanImpl otherTyped = (ApplicationSecurityRoleAssignmentBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ApplicationSecurityRoleAssignmentBeanImpl original = (ApplicationSecurityRoleAssignmentBeanImpl)event.getSourceBean();
            ApplicationSecurityRoleAssignmentBeanImpl proposed = (ApplicationSecurityRoleAssignmentBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ApplicationSecurityRoleAssignmentBeanImpl copy = (ApplicationSecurityRoleAssignmentBeanImpl)initialCopy;
