...
public class StatementBeanImpl extends AbstractDescriptorBean implements StatementBean, Serializable {
   private boolean _ProfilingEnabled;
   private static SchemaHelper2 _schemaHelper;

   public StatementBeanImpl() {
      this._initializeProperty(-1);
   }

   public StatementBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public StatementBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private StatementBeanImpl bean;

      protected Helper(StatementBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            StatementBeanImpl otherTyped = (StatementBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            StatementBeanImpl original = (StatementBeanImpl)event.getSourceBean();
            StatementBeanImpl proposed = (StatementBeanImpl)event.getProposedBean();
            String prop = update.getPropertyName();
            int type = update.getUpdateType();
            if (!update.isDerivedUpdate()) {
               if (prop.equals("ProfilingEnabled")) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            StatementBeanImpl copy = (StatementBeanImpl)initialCopy;
