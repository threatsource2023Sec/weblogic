...
public class ApplicationParamBeanImpl extends AbstractDescriptorBean implements ApplicationParamBean, Serializable {
   private String _Description;
   private String _ParamName;
   private String _ParamValue;
   private static SchemaHelper2 _schemaHelper;

   public ApplicationParamBeanImpl() {
      this._initializeProperty(-1);
   }

   public ApplicationParamBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ApplicationParamBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
      ...
      switch (s.length()) {
         case 10:
            if (s.equals("param-name")) {
               return info.compareXpaths(this._getPropertyXpath("param-name"));
            }
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private ApplicationParamBeanImpl bean;

      protected Helper(ApplicationParamBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ApplicationParamBeanImpl otherTyped = (ApplicationParamBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ApplicationParamBeanImpl original = (ApplicationParamBeanImpl)event.getSourceBean();
            ApplicationParamBeanImpl proposed = (ApplicationParamBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ApplicationParamBeanImpl copy = (ApplicationParamBeanImpl)initialCopy;
