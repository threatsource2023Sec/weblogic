...
import org.jcp.xmlns.xml.ns.javaee.XsdNMTOKENType;

public class XsdNMTOKENTypeImpl extends JavaStringHolderEx implements XsdNMTOKENType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public XsdNMTOKENTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected XsdNMTOKENTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
