...
import org.jcp.xmlns.xml.ns.javaee.XsdPositiveIntegerType;

public class XsdPositiveIntegerTypeImpl extends JavaIntegerHolderEx implements XsdPositiveIntegerType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public XsdPositiveIntegerTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected XsdPositiveIntegerTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
