...
public class GenericBooleanTypeImpl extends JavaStringEnumerationHolderEx implements GenericBooleanType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public GenericBooleanTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected GenericBooleanTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
