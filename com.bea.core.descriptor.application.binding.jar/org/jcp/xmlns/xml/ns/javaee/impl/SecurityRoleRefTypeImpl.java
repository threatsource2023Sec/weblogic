...
import org.jcp.xmlns.xml.ns.javaee.RoleNameType;
...
public class SecurityRoleRefTypeImpl extends XmlComplexContentImpl implements SecurityRoleRefType {
   ...
   private static final QName ROLENAME$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "role-name");
   private static final QName ROLELINK$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "role-link");
   private static final QName ID$6 = new QName("", "id");

   public SecurityRoleRefTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public RoleNameType getRoleName() {
      synchronized(this.monitor()) {
         ...
         target = (RoleNameType)this.get_store().find_element_user(ROLENAME$2, 0);
         return target == null ? null : target;
      }
   }

   public void setRoleName(RoleNameType roleName) {
      this.generatedSetterHelperImpl(roleName, ROLENAME$2, 0, (short)1);
   }
   ...
   public RoleNameType getRoleLink() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         RoleNameType target = null;
         target = (RoleNameType)this.get_store().find_element_user(ROLELINK$4, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetRoleLink() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(ROLELINK$4) != 0;
      }
   }

   public void setRoleLink(RoleNameType roleLink) {
      this.generatedSetterHelperImpl(roleLink, ROLELINK$4, 0, (short)1);
   }
   ...
   public RoleNameType addNewRoleLink() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         RoleNameType target = null;
         target = (RoleNameType)this.get_store().add_element_user(ROLELINK$4);
         return target;
      }
   }
   ...
   public void unsetRoleLink() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ROLELINK$4, 0);
      }
   }
