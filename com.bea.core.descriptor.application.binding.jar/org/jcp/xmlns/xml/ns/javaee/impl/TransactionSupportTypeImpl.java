...
public class TransactionSupportTypeImpl extends JavaStringEnumerationHolderEx implements TransactionSupportType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TransactionSupportTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TransactionSupportTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
