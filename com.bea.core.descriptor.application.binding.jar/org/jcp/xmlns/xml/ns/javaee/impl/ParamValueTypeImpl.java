...
public class ParamValueTypeImpl extends XmlComplexContentImpl implements ParamValueType {
   private static final long serialVersionUID = 1L;
   private static final QName DESCRIPTION$0 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "description");
   private static final QName PARAMNAME$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "param-name");
   private static final QName PARAMVALUE$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "param-value");
   private static final QName ID$6 = new QName("", "id");

   public ParamValueTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public String getParamName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().find_element_user(PARAMNAME$2, 0);
         return target == null ? null : target;
      }
   }

   public void setParamName(String paramName) {
      this.generatedSetterHelperImpl(paramName, PARAMNAME$2, 0, (short)1);
   }

   public String addNewParamName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().add_element_user(PARAMNAME$2);
         return target;
      }
   }
   ...
   public XsdStringType getParamValue() {
      synchronized(this.monitor()) {
         ...
         target = (XsdStringType)this.get_store().find_element_user(PARAMVALUE$4, 0);
         return target == null ? null : target;
      }
   }

   public void setParamValue(XsdStringType paramValue) {
      this.generatedSetterHelperImpl(paramValue, PARAMVALUE$4, 0, (short)1);
   }

   public XsdStringType addNewParamValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdStringType target = null;
         target = (XsdStringType)this.get_store().add_element_user(PARAMVALUE$4);
         return target;
      }
   }
