...
public class ResAuthTypeImpl extends JavaStringEnumerationHolderEx implements ResAuthType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResAuthTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResAuthTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
