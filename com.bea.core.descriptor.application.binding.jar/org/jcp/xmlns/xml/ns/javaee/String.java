...
public interface String extends XmlToken {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(String.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_application_binding_2_0_0_0").resolveHandle("string46b4type");
