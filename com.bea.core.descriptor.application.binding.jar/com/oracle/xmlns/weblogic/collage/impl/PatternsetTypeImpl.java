...
public class PatternsetTypeImpl extends XmlComplexContentImpl implements PatternsetType {
   private static final long serialVersionUID = 1L;
   private static final QName INCLUDE$0 = new QName("http://xmlns.oracle.com/weblogic/collage", "include");
   private static final QName EXCLUDE$2 = new QName("http://xmlns.oracle.com/weblogic/collage", "exclude");
   private static final QName ID$4 = new QName("", "id");

   public PatternsetTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public XmlString xgetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_attribute_user(ID$4);
         return target;
      }
   }
   ...
   public void xsetId(XmlString id) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_attribute_user(ID$4);
         if (target == null) {
            target = (XmlString)this.get_store().add_attribute_user(ID$4);
         }
