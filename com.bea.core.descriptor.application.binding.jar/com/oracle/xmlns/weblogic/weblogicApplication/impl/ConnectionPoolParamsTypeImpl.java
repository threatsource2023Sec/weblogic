...
import com.oracle.xmlns.weblogic.weblogicApplication.ConnectionPoolParamsType;
...
public class ConnectionPoolParamsTypeImpl extends XmlComplexContentImpl implements ConnectionPoolParamsType {
   ...
   private static final QName SHRINKFREQUENCYSECONDS$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "shrink-frequency-seconds");
   private static final QName HIGHESTNUMWAITERS$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "highest-num-waiters");
   private static final QName HIGHESTNUMUNAVAILABLE$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "highest-num-unavailable");
   private static final QName CONNECTIONCREATIONRETRYFREQUENCYSECONDS$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "connection-creation-retry-frequency-seconds");
   private static final QName CONNECTIONRESERVETIMEOUTSECONDS$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "connection-reserve-timeout-seconds");
   private static final QName TESTFREQUENCYSECONDS$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "test-frequency-seconds");
   private static final QName TESTCONNECTIONSONCREATE$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "test-connections-on-create");
   private static final QName TESTCONNECTIONSONRELEASE$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "test-connections-on-release");
   private static final QName TESTCONNECTIONSONRESERVE$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "test-connections-on-reserve");
   private static final QName PROFILEHARVESTFREQUENCYSECONDS$26 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "profile-harvest-frequency-seconds");
   private static final QName IGNOREINUSECONNECTIONSENABLED$28 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "ignore-in-use-connections-enabled");
