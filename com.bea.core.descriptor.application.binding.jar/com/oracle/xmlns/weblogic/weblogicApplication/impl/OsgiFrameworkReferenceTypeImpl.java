...
public class OsgiFrameworkReferenceTypeImpl extends XmlComplexContentImpl implements OsgiFrameworkReferenceType {
   ...
   private static final QName BUNDLESDIRECTORY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "bundles-directory");
   private static final QName APPLICATIONBUNDLESYMBOLICNAME$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "application-bundle-symbolic-name");
   private static final QName APPLICATIONBUNDLEVERSION$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "application-bundle-version");
