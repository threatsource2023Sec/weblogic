...
public class ManagedExecutorServiceTypeImpl extends XmlComplexContentImpl implements ManagedExecutorServiceType {
   ...
   private static final QName DISPATCHPOLICY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "dispatch-policy");
   private static final QName MAXCONCURRENTLONGRUNNINGREQUESTS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "max-concurrent-long-running-requests");
   private static final QName LONGRUNNINGPRIORITY$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "long-running-priority");
