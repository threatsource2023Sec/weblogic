...
public final class ECDSAUtils {
   private static final List ecCurveDefinitions = new ArrayList();
   ...
   public static byte[] convertASN1toXMLDSIG(byte[] asn1Bytes) throws IOException {
      if (asn1Bytes.length >= 8 && asn1Bytes[0] == 48) {
         ...
         if ((asn1Bytes[offset - 1] & 255) == asn1Bytes.length - offset && (asn1Bytes[offset - 1] & 255) == 2 + rLength + 2 + sLength && asn1Bytes[offset] == 2 && asn1Bytes[offset + 2 + rLength] == 2) {
   ...
   public static String getOIDFromPublicKey(ECPublicKey ecPublicKey) {
      ...
      String oid;
      do {
         if (!ecCurveDefinitionIterator.hasNext()) {
            return null;
         }

         ECCurveDefinition ecCurveDefinition = (ECCurveDefinition)ecCurveDefinitionIterator.next();
         oid = ecCurveDefinition.equals(field, a, b, affineX, affineY, order, h);
      } while(oid == null);
   ...
   public static ECCurveDefinition getECCurveDefinition(String oid) {
      ...
      ECCurveDefinition ecCurveDefinition;
      do {
         if (!ecCurveDefinitionIterator.hasNext()) {
            return null;
         }
      ...
      } while(!ecCurveDefinition.getOid().equals(oid));
   ...
   public static class ECCurveDefinition {
      ...
      public String equals(BigInteger field, BigInteger a, BigInteger b, BigInteger x, BigInteger y, BigInteger n, int h) {
         return this.field.equals(field.toString(16)) && this.a.equals(a.toString(16)) && this.b.equals(b.toString(16)) && this.x.equals(x.toString(16)) && this.y.equals(y.toString(16)) && this.n.equals(n.toString(16)) && this.h == h ? this.oid : null;
      }
