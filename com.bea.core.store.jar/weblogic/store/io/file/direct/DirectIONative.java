...
class DirectIONative {
   ...
   static native long openConsiderLock(String var0, String var1, boolean var2) throws IOException;

   static native long open(String var0, String var1) throws IOException;
