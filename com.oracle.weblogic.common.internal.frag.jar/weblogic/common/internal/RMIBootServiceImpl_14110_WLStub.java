...
public final class RMIBootServiceImpl_14110_WLStub extends Stub implements StubInfoIntf, SecurityService {
   // $FF: synthetic field
   ...
   public RMIBootServiceImpl_14110_WLStub(StubInfo var1) {
      super(var1);
      this.stubinfo = var1;
