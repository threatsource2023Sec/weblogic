...
public class WLSCredMapCollectionInfo extends DomainRealmScope implements PersistenceCapable {
   ...
   // $FF: synthetic field
   static Class class$Lcom$bea$common$security$store$data$WLSCredMapCollectionInfo;

   public WLSCredMapCollectionInfo() {
   }

   public WLSCredMapCollectionInfo(String domainName, String realmName, String wlsCollectionName) {
   ...
   public boolean equals(Object other) {
      if (this == other) {
         ...
         return false;
      } else if (!(other instanceof WLSCredMapCollectionInfo)) {
         return false;
      } else {
         WLSCredMapCollectionInfo o = (WLSCredMapCollectionInfo)other;
   ...
   static {
      ...
      PCRegistry.register(class$Lcom$bea$common$security$store$data$WLSCredMapCollectionInfo != null ? class$Lcom$bea$common$security$store$data$WLSCredMapCollectionInfo : (class$Lcom$bea$common$security$store$data$WLSCredMapCollectionInfo = class$("com.bea.common.security.store.data.WLSCredMapCollectionInfo")), pcFieldNames, pcFieldTypes, pcFieldFlags, pcPCSuperclass, "WLSCredMapCollectionInfo", new WLSCredMapCollectionInfo());
   }
   ...
   public PersistenceCapable pcNewInstance(StateManager var1, Object var2, boolean var3) {
      WLSCredMapCollectionInfo var4 = new WLSCredMapCollectionInfo();
      if (var3) {
         var4.pcClearFields();
      }
   ...
   public PersistenceCapable pcNewInstance(StateManager var1, boolean var2) {
      WLSCredMapCollectionInfo var3 = new WLSCredMapCollectionInfo();
      if (var2) {
         var3.pcClearFields();
      }
   ...
   protected void pcCopyField(WLSCredMapCollectionInfo var1, int var2) {
   ...
   public void pcCopyFields(Object var1, int[] var2) {
      WLSCredMapCollectionInfo var3 = (WLSCredMapCollectionInfo)var1;
   ...
   public void pcCopyKeyFieldsToObjectId(FieldSupplier var1, Object var2) {
      ...
      WLSCredMapCollectionInfoId var3 = (WLSCredMapCollectionInfoId)var2;
   ...
   public void pcCopyKeyFieldsToObjectId(Object var1) {
      ...
      WLSCredMapCollectionInfoId var2 = (WLSCredMapCollectionInfoId)var1;
   ...
   public Object pcNewObjectIdInstance(Object var1) {
      return new WLSCredMapCollectionInfoId((String)var1);
   }

   public Object pcNewObjectIdInstance() {
      return new WLSCredMapCollectionInfoId();
   }

   private static final String pcGetwlsCollectionName(WLSCredMapCollectionInfo var0) {
   ...
   private static final void pcSetwlsCollectionName(WLSCredMapCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final String pcGetwlsCollectionTimestamp(WLSCredMapCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsCollectionTimestamp(WLSCredMapCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final String pcGetwlsCollectionVersion(WLSCredMapCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsCollectionVersion(WLSCredMapCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final byte[] pcGetwlsXmlFragment(WLSCredMapCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsXmlFragment(WLSCredMapCollectionInfo var0, byte[] var1) {
      if (var0.pcStateManager == null) {
