...
public class WLSRoleCollectionInfoId extends DomainRealmScopeId {
   public static final String WLSCOLLECTIONNAME = "wlsCollectionName";
   public String wlsCollectionName;

   public WLSRoleCollectionInfoId() {
   }

   public WLSRoleCollectionInfoId(String binding) {
      super(binding);
      Map p = ApplicationIdUtil.parse(binding);
      this.wlsCollectionName = (String)p.get("wlsCollectionName");
   }

   public WLSRoleCollectionInfoId(String domainName, String realmName, String wlsCollectionName) {
      super(domainName, realmName);
      this.wlsCollectionName = wlsCollectionName;
   }

   public WLSRoleCollectionInfoId(WLSRoleCollectionInfo obj) {
   ...
   public boolean equals(Object other) {
      if (this == other) {
         ...
         return false;
      } else if (!(other instanceof WLSRoleCollectionInfoId)) {
         return false;
      } else {
         WLSRoleCollectionInfoId o = (WLSRoleCollectionInfoId)other;
