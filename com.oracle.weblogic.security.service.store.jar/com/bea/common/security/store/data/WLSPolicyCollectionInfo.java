...
public class WLSPolicyCollectionInfo extends DomainRealmScope implements PersistenceCapable {
   ...
   // $FF: synthetic field
   static Class class$Lcom$bea$common$security$store$data$WLSPolicyCollectionInfo;

   public WLSPolicyCollectionInfo() {
   }

   public WLSPolicyCollectionInfo(String domainName, String realmName, String wlsCollectionName) {
   ...
   public boolean equals(Object other) {
      if (this == other) {
         ...
         return false;
      } else if (!(other instanceof WLSPolicyCollectionInfo)) {
         return false;
      } else {
         WLSPolicyCollectionInfo o = (WLSPolicyCollectionInfo)other;
   ...
   static {
      ...
      PCRegistry.register(class$Lcom$bea$common$security$store$data$WLSPolicyCollectionInfo != null ? class$Lcom$bea$common$security$store$data$WLSPolicyCollectionInfo : (class$Lcom$bea$common$security$store$data$WLSPolicyCollectionInfo = class$("com.bea.common.security.store.data.WLSPolicyCollectionInfo")), pcFieldNames, pcFieldTypes, pcFieldFlags, pcPCSuperclass, "WLSPolicyCollectionInfo", new WLSPolicyCollectionInfo());
   }
   ...
   public PersistenceCapable pcNewInstance(StateManager var1, Object var2, boolean var3) {
      WLSPolicyCollectionInfo var4 = new WLSPolicyCollectionInfo();
      if (var3) {
         var4.pcClearFields();
      }
   ...
   public PersistenceCapable pcNewInstance(StateManager var1, boolean var2) {
      WLSPolicyCollectionInfo var3 = new WLSPolicyCollectionInfo();
      if (var2) {
         var3.pcClearFields();
      }
   ...
   protected void pcCopyField(WLSPolicyCollectionInfo var1, int var2) {
   ...
   public void pcCopyFields(Object var1, int[] var2) {
      WLSPolicyCollectionInfo var3 = (WLSPolicyCollectionInfo)var1;
   ...
   public void pcCopyKeyFieldsToObjectId(FieldSupplier var1, Object var2) {
      ...
      WLSPolicyCollectionInfoId var3 = (WLSPolicyCollectionInfoId)var2;
   ...
   public void pcCopyKeyFieldsToObjectId(Object var1) {
      ...
      WLSPolicyCollectionInfoId var2 = (WLSPolicyCollectionInfoId)var1;
   ...
   public Object pcNewObjectIdInstance(Object var1) {
      return new WLSPolicyCollectionInfoId((String)var1);
   }

   public Object pcNewObjectIdInstance() {
      return new WLSPolicyCollectionInfoId();
   }

   private static final String pcGetwlsCollectionName(WLSPolicyCollectionInfo var0) {
   ...
   private static final void pcSetwlsCollectionName(WLSPolicyCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final String pcGetwlsCollectionTimestamp(WLSPolicyCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsCollectionTimestamp(WLSPolicyCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final String pcGetwlsCollectionVersion(WLSPolicyCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsCollectionVersion(WLSPolicyCollectionInfo var0, String var1) {
      if (var0.pcStateManager == null) {
   ...
   private static final byte[] pcGetwlsXmlFragment(WLSPolicyCollectionInfo var0) {
      if (var0.pcStateManager == null) {
   ...
   private static final void pcSetwlsXmlFragment(WLSPolicyCollectionInfo var0, byte[] var1) {
      if (var0.pcStateManager == null) {
