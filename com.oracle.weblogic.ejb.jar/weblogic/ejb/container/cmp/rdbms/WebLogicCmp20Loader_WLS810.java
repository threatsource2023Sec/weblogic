...
public final class WebLogicCmp20Loader_WLS810 extends CMPDDParser implements XMLProcessor, InProcessor {
   ...
   private void __post_197(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1982791261](.weblogic-rdbms-jar.order-database-operations.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[1982791261](.weblogic-rdbms-jar.order-database-operations.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_201(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1562557367](.weblogic-rdbms-jar.validate-db-schema-with.) must be a non-empty string");
      } else if (!"TableQuery".equals(var2) && !"MetaData".equals(var2)) {
         throw new SAXValidationException("PAction[1562557367](.weblogic-rdbms-jar.validate-db-schema-with.) must be one of the values: TableQuery,MetaData");
      } else {
   ...
   private void __post_169(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1101288798](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.group-name.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_171(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[125993742](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.max-elements.) must be a non-empty string");
      } else {
         try {
            this.validatePositiveInteger(var2);
   ...
   private void __post_148(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1068824137](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_182(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[864237698](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.key-cache-size.) must be a non-empty string");
      } else {
         int var7 = Integer.parseInt(var2);
   ...
   private void __post_140(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[537548559](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.optimistic-column.) must be a non-empty string");
      } else {
   ...
   private void __post_173(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[380894366](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[380894366](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.sql-select-distinct.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_206(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[237852351](.weblogic-rdbms-jar.compatibility.load-related-beans-from-db-in-post-create.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[237852351](.weblogic-rdbms-jar.compatibility.load-related-beans-from-db-in-post-create.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_183(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[608188624](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.select-first-sequence-key-before-update.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[608188624](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.select-first-sequence-key-before-update.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_177(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[992136656](.weblogic-rdbms-jar.weblogic-rdbms-bean.instance-lock-order.) must be a non-empty string");
      } else if (!"AccessOrder".equalsIgnoreCase(var2) && !"ValueOrder".equalsIgnoreCase(var2)) {
         throw new SAXValidationException(EJBComplianceTextFormatter.getInstance().INVALID_INSTANCE_LOCK_ORDER(this.getFileName(), var4.getEjbName(), var2));
      } else {
   ...
   private void __post_192(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[511833308](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.foreign-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_200(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1297685781](.weblogic-rdbms-jar.default-dbms-tables-ddl.) must be a non-empty string");
      } else {
   ...
   private void __post_172(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1705929636](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[1705929636](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.include-updates.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_178(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1221555852](.weblogic-rdbms-jar.weblogic-rdbms-bean.check-exists-on-method.) must be a non-empty string");
      } else {
   ...
   private void __post_168(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1509514333](.weblogic-rdbms-jar.weblogic-rdbms-bean.weblogic-query.weblogic-ql.) must be a non-empty string");
      } else {
         EjbQlQueryBean var7 = var3.getEjbQlQuery();
   ...
   private void __post_205(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1556956098](.weblogic-rdbms-jar.compatibility.allow-readonly-create-and-remove.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[1556956098](.weblogic-rdbms-jar.compatibility.allow-readonly-create-and-remove.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_204(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1252585652](.weblogic-rdbms-jar.compatibility.serialize-byte-array-to-oracle-blob.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[1252585652](.weblogic-rdbms-jar.compatibility.serialize-byte-array-to-oracle-blob.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_143(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[2036368507](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmp-field.) must be a non-empty string");
      } else {
   ...
   private void __post_131(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1785210046](.weblogic-rdbms-jar.weblogic-rdbms-bean.data-source-name.) must be a non-empty string");
      } else {
   ...
   private void __post_180(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1552787810](.weblogic-rdbms-jar.weblogic-rdbms-bean.automatic-key-generation.generator-type.) must be a non-empty string");
      } else {
         String var7;
         if ("Oracle".equalsIgnoreCase(var2)) {
            var7 = "Sequence";
            var6.setDatabaseType("Oracle");
         } else if ("TIMESTEN".equalsIgnoreCase(var2)) {
            var7 = "Sequence";
            var6.setDatabaseType("TIMESTEN");
   ...
   private void __post_185(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1361960727](.weblogic-rdbms-jar.weblogic-rdbms-relation.relation-name.) must be a non-empty string");
      } else {
   ...
   private void __post_186(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var4 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[739498517](.weblogic-rdbms-jar.weblogic-rdbms-relation.table-name.) must be a non-empty string");
      } else {
         var3.setTableName(var2);
      }
   }
   ...
   private void __post_174(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[125130493](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[125130493](.weblogic-rdbms-jar.weblogic-rdbms-bean.delay-database-insert-until.) must be one of the values: ejbCreate,ejbPostCreate,EjbCreate,EjbPostCreate,ejbcreate,ejbpostcreate,commit");
      } else {
         String var6 = null;
         if ("ejbcreate".equalsIgnoreCase(var2)) {
            var6 = "ejbCreate";
         } else if ("commit".equalsIgnoreCase(var2)) {
            Log.getInstance().logWarning(EJBComplianceTextFormatter.getInstance().COMMIT_OPTION_FOR_delayDatabaseInsertUntil_IGNORED());
            var6 = "ejbPostCreate";
         } else {
            var6 = "ejbPostCreate";
         }
   ...
   private void __post_193(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[914504136](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.primary-key-table.) must be a non-empty string");
      } else {
   ...
   private void __post_160(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[166239592](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_157(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var10 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[991505714](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_130(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[385242642](.weblogic-rdbms-jar.weblogic-rdbms-bean.ejb-name.) must be a non-empty string");
      } else {
   ...
   private void __post_195(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[824009085](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.foreign-key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_154(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var9 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[2085857771](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_189(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var5 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[248609774](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
   ...
   private void __post_144(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[708049632](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.cmr-field.) must be a non-empty string");
      } else {
   ...
   private void __post_196(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[1887400018](.weblogic-rdbms-jar.weblogic-rdbms-relation.weblogic-relationship-role.relationship-role-map.column-map.key-column.) must be a non-empty string");
      } else {
   ...
   private void __post_198(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[285377351](.weblogic-rdbms-jar.enable-batch-operations.) must be a non-empty string");
      } else if (!"True".equals(var2) && !"False".equals(var2) && !"true".equals(var2) && !"false".equals(var2)) {
         throw new SAXValidationException("PAction[285377351](.weblogic-rdbms-jar.enable-batch-operations.) must be one of the values: True,False,true,false");
      } else {
   ...
   private void __post_151(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var8 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[344560770](.weblogic-rdbms-jar.weblogic-rdbms-bean.relationship-caching.caching-element.caching-element.cmr-field.) must be a non-empty string");
      } else {
         var3.setCmrField(var2);
      }
   }
   ...
   private void __post_199(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var3 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[559450121](.weblogic-rdbms-jar.create-default-dbms-tables.) must be a non-empty string");
      } else {
   ...
   private void __post_137(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var7 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[716083600](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be a non-empty string");
         ...
         throw new SAXValidationException("PAction[716083600](.weblogic-rdbms-jar.weblogic-rdbms-bean.table-map.field-map.dbms-column-type.) must be one of the values: OracleClob,OracleBlob,NClob,NChar,NVarchar2,LongString,SybaseBinary,SQLXML");
      } else {
         String var8 = var2;
   ...
   private void __post_142(ProcessingContext var1) throws SAXProcessorException, SAXValidationException {
      ...
      WeblogicRdbmsJarBean var6 = (WeblogicRdbmsJarBean)var1.getBoundObject("cmpJar");
      if (var2.length() == 0) {
         throw new SAXValidationException("PAction[791885625](.weblogic-rdbms-jar.weblogic-rdbms-bean.field-group.group-name.) must be a non-empty string");
      } else {
         var3.setGroupName(var2);
      }
   }
