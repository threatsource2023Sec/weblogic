...
public class ExprBETWEEN extends BaseExpr implements Expr, ExpressionTypes {
   ...
   protected ExprBETWEEN(int type, Expr lhs, Expr left, Expr right) {
   ...
   protected Expr invertForNOT() throws ErrorCollectionException {
      BaseExpr newExprNOT_BETWEEN = new ExprNOT_BETWEEN(77, this.term1, this.term2, this.term3);
      newExprNOT_BETWEEN.setPreEJBQLFrom(this);
      newExprNOT_BETWEEN.setMainEJBQL("NOT BETWEEN ");
      newExprNOT_BETWEEN.setPostEJBQLFrom(this);
      return newExprNOT_BETWEEN;
   }
