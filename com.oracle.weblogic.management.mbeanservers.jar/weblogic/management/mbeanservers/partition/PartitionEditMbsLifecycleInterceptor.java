...
import weblogic.management.mbeanservers.edit.internal.EditServerService;
...
@Service
@Interceptor
@ContractsProvided({PartitionEditMbsLifecycleInterceptor.class, MethodInterceptor.class})
@ServerServiceInterceptor(EditServerService.class)
public class PartitionEditMbsLifecycleInterceptor extends PartitionManagerInterceptorAdapter {
   @Inject
   ...
   private void startPartition(MethodInvocation methodInvocation) throws Throwable {
      ...
      this.pmm.registerInJndi(pr.getName(), this.pmm.getJndiName(), ManagementService.getEditMBeanServer(kernelId));
