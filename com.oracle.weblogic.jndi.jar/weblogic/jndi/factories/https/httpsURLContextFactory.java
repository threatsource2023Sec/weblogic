...
public class httpsURLContextFactory implements ObjectFactory {
   public httpsURLContextFactory() {
      if (NamingDebugLogger.isDebugEnabled()) {
         p("httpsURLContextFactory()");
      }
   ...
   public Object getObjectInstance(Object obj, Name name, Context ctx, Hashtable env) throws NamingException {
      ...
      return new HTTPSContext(env, url);
   }

   private static final void p(String msg) {
      NamingDebugLogger.debug("<httpURLContextFactory>: " + msg);
   }
   ...
   private static class HTTPSContext extends AbstractURLContext {
      ...
      public HTTPSContext(Hashtable env, String url) throws InvalidNameException {
         this.env = env;
         if (url != null) {
            try {
