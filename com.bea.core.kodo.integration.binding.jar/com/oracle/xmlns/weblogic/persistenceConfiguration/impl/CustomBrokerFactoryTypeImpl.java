...
public class CustomBrokerFactoryTypeImpl extends BrokerFactoryTypeImpl implements CustomBrokerFactoryType {
   ...
   public CustomBrokerFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
