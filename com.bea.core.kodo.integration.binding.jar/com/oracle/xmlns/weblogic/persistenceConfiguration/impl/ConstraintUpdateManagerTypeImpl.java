...
public class ConstraintUpdateManagerTypeImpl extends UpdateManagerTypeImpl implements ConstraintUpdateManagerType {
   ...
   public ConstraintUpdateManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
