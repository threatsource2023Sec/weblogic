...
public class CustomMetaDataRepositoryTypeImpl extends MetaDataRepositoryTypeImpl implements CustomMetaDataRepositoryType {
   ...
   public CustomMetaDataRepositoryTypeImpl(SchemaType sType) {
      super(sType);
   }
