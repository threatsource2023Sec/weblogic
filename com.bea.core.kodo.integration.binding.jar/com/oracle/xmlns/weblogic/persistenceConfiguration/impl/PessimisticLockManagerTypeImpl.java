...
public class PessimisticLockManagerTypeImpl extends LockManagerTypeImpl implements PessimisticLockManagerType {
   ...
   public PessimisticLockManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
