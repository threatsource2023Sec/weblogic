...
public class CustomAggregateListenerTypeImpl extends AggregateListenerTypeImpl implements CustomAggregateListenerType {
   ...
   public CustomAggregateListenerTypeImpl(SchemaType sType) {
      super(sType);
   }
