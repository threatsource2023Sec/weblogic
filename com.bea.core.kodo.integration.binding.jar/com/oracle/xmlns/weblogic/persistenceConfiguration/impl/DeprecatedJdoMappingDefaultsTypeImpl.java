...
public class DeprecatedJdoMappingDefaultsTypeImpl extends MappingDefaultsTypeImpl implements DeprecatedJdoMappingDefaultsType {
   ...
   public DeprecatedJdoMappingDefaultsTypeImpl(SchemaType sType) {
      super(sType);
   }
