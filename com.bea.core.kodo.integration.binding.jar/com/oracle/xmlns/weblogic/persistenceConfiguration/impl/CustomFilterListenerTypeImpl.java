...
public class CustomFilterListenerTypeImpl extends FilterListenerTypeImpl implements CustomFilterListenerType {
   ...
   public CustomFilterListenerTypeImpl(SchemaType sType) {
      super(sType);
   }
