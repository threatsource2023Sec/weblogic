...
public class CustomJdbcListenerTypeImpl extends JdbcListenerTypeImpl implements CustomJdbcListenerType {
   ...
   public CustomJdbcListenerTypeImpl(SchemaType sType) {
      super(sType);
   }
