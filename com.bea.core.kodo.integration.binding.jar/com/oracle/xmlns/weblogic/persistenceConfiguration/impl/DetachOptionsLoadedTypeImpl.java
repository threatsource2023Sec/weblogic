...
public class DetachOptionsLoadedTypeImpl extends DetachStateTypeImpl implements DetachOptionsLoadedType {
   ...
   public DetachOptionsLoadedTypeImpl(SchemaType sType) {
      super(sType);
   }
