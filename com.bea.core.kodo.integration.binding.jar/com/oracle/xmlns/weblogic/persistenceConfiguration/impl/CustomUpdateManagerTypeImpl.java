...
public class CustomUpdateManagerTypeImpl extends UpdateManagerTypeImpl implements CustomUpdateManagerType {
   ...
   public CustomUpdateManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
