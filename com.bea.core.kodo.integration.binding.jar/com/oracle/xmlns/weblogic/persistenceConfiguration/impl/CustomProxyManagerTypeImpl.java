...
public class CustomProxyManagerTypeImpl extends ProxyManagerTypeImpl implements CustomProxyManagerType {
   ...
   public CustomProxyManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
