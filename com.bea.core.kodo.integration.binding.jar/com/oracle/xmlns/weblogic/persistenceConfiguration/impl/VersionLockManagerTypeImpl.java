...
public class VersionLockManagerTypeImpl extends LockManagerTypeImpl implements VersionLockManagerType {
   ...
   public VersionLockManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
