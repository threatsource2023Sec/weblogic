...
public class CustomMetaDataFactoryTypeImpl extends MetaDataFactoryTypeImpl implements CustomMetaDataFactoryType {
   ...
   public CustomMetaDataFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
