...
public class ProfilingProxyManagerTypeImpl extends ProxyManagerTypeImpl implements ProfilingProxyManagerType {
   ...
   public ProfilingProxyManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
