...
public class CustomMappingDefaultsTypeImpl extends MappingDefaultsTypeImpl implements CustomMappingDefaultsType {
   ...
   public CustomMappingDefaultsTypeImpl(SchemaType sType) {
      super(sType);
   }
