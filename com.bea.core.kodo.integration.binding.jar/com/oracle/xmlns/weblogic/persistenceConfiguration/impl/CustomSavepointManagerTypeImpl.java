...
public class CustomSavepointManagerTypeImpl extends SavepointManagerTypeImpl implements CustomSavepointManagerType {
   ...
   public CustomSavepointManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
