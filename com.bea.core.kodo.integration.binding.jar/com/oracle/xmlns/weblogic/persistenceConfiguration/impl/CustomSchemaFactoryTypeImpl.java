...
public class CustomSchemaFactoryTypeImpl extends SchemaFactoryTypeImpl implements CustomSchemaFactoryType {
   ...
   public CustomSchemaFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
