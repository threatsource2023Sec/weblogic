...
public class CustomConnectionDecoratorTypeImpl extends ConnectionDecoratorTypeImpl implements CustomConnectionDecoratorType {
   ...
   public CustomConnectionDecoratorTypeImpl(SchemaType sType) {
      super(sType);
   }
