...
public class KodoPersistenceMappingFactoryTypeImpl extends MappingFactoryTypeImpl implements KodoPersistenceMappingFactoryType {
   ...
   public KodoPersistenceMappingFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
