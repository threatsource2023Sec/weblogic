...
public class JdoMetaDataFactoryTypeImpl extends MetaDataFactoryTypeImpl implements JdoMetaDataFactoryType {
   ...
   public JdoMetaDataFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
