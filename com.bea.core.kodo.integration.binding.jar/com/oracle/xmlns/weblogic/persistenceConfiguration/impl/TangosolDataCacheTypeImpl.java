...
public class TangosolDataCacheTypeImpl extends DataCacheTypeImpl implements TangosolDataCacheType {
   ...
   private static final QName EVICTIONSCHEDULE$6 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "eviction-schedule");

   public TangosolDataCacheTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public String getEvictionSchedule() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(EVICTIONSCHEDULE$6, 0);
         return target == null ? null : target.getStringValue();
      }
   }
   ...
   public XmlString xgetEvictionSchedule() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(EVICTIONSCHEDULE$6, 0);
         return target;
      }
   }
   ...
   public boolean isSetEvictionSchedule() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(EVICTIONSCHEDULE$6) != 0;
      }
   }
   ...
   public void setEvictionSchedule(String evictionSchedule) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(EVICTIONSCHEDULE$6, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(EVICTIONSCHEDULE$6);
         }
   ...
   public void xsetEvictionSchedule(XmlString evictionSchedule) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(EVICTIONSCHEDULE$6, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(EVICTIONSCHEDULE$6);
         }
   ...
   public void unsetEvictionSchedule() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(EVICTIONSCHEDULE$6, 0);
      }
   }
}
