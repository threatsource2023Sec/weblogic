...
public class TableLockUpdateManagerTypeImpl extends UpdateManagerTypeImpl implements TableLockUpdateManagerType {
   ...
   public TableLockUpdateManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
