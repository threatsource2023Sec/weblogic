...
public class KodoConcurrentQueryCacheTypeImpl extends QueryCacheTypeImpl implements KodoConcurrentQueryCacheType {
   ...
   public KodoConcurrentQueryCacheTypeImpl(SchemaType sType) {
      super(sType);
   }
