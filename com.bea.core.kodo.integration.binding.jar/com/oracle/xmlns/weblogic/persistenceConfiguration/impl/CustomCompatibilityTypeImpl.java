...
public class CustomCompatibilityTypeImpl extends PersistenceCompatibilityTypeImpl implements CustomCompatibilityType {
   ...
   public CustomCompatibilityTypeImpl(SchemaType sType) {
      super(sType);
   }
