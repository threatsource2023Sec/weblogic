...
public class MappingFileDeprecatedJdoMappingFactoryTypeImpl extends MappingFactoryTypeImpl implements MappingFileDeprecatedJdoMappingFactoryType {
   ...
   private static final QName SINGLEFILE$8 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "single-file");
   private static final QName TYPES$10 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "types");
   private static final QName FILENAME$12 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "file-name");
   ...
   public MappingFileDeprecatedJdoMappingFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public boolean getSingleFile() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(SINGLEFILE$8, 0);
         return target == null ? false : target.getBooleanValue();
      }
   }

   public XmlBoolean xgetSingleFile() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean target = null;
         target = (XmlBoolean)this.get_store().find_element_user(SINGLEFILE$8, 0);
         return target;
      }
   }

   public boolean isSetSingleFile() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SINGLEFILE$8) != 0;
      }
   }
   ...
   public void setSingleFile(boolean singleFile) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(SINGLEFILE$8, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(SINGLEFILE$8);
         }

         target.setBooleanValue(singleFile);
      }
   }

   public void xsetSingleFile(XmlBoolean singleFile) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean target = null;
         target = (XmlBoolean)this.get_store().find_element_user(SINGLEFILE$8, 0);
         if (target == null) {
            target = (XmlBoolean)this.get_store().add_element_user(SINGLEFILE$8);
         }

         target.set(singleFile);
      }
   }
   ...
   public void unsetSingleFile() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SINGLEFILE$8, 0);
      }
   }
   ...
   public String getFileName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(FILENAME$12, 0);
         return target == null ? null : target.getStringValue();
      }
   }
   ...
   public XmlString xgetFileName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(FILENAME$12, 0);
         return target;
      }
   }
   ...
   public boolean isSetFileName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(FILENAME$12) != 0;
      }
   }
   ...
   public void setFileName(String fileName) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(FILENAME$12, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(FILENAME$12);
         }
   ...
   public void xsetFileName(XmlString fileName) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(FILENAME$12, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(FILENAME$12);
         }
   ...
   public void unsetFileName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(FILENAME$12, 0);
      }
   }
