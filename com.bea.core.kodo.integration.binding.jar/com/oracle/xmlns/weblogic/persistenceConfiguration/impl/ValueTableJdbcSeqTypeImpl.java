...
public class ValueTableJdbcSeqTypeImpl extends SequenceTypeImpl implements ValueTableJdbcSeqType {
   ...
   private static final QName PRIMARYKEYVALUE$6 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "primary-key-value");
   private static final QName TABLE$8 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "table");
   private static final QName PRIMARYKEYCOLUMN$10 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "primary-key-column");
   private static final QName SEQUENCECOLUMN$12 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "sequence-column");
   private static final QName INCREMENT$14 = new QName("http://xmlns.oracle.com/weblogic/persistence-configuration", "increment");

   public ValueTableJdbcSeqTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public String getPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
         return target == null ? null : target.getStringValue();
      }
   }

   public XmlString xgetPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
         return target;
      }
   }

   public boolean isNilPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
   ...
   public boolean isSetPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(PRIMARYKEYVALUE$6) != 0;
      }
   }
   ...
   public void setPrimaryKeyValue(String primaryKeyValue) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(PRIMARYKEYVALUE$6);
         }

         target.setStringValue(primaryKeyValue);
      }
   }

   public void xsetPrimaryKeyValue(XmlString primaryKeyValue) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(PRIMARYKEYVALUE$6);
         }

         target.set(primaryKeyValue);
      }
   }

   public void setNilPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYVALUE$6, 0);
   ...
   public void unsetPrimaryKeyValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(PRIMARYKEYVALUE$6, 0);
      }
   }
   ...
   public String getTable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(TABLE$8, 0);
         return target == null ? null : target.getStringValue();
      }
   }
   ...
   public XmlString xgetTable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(TABLE$8, 0);
         return target;
      }
   }
   ...
   public boolean isSetTable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(TABLE$8) != 0;
      }
   }
   ...
   public void setTable(String table) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(TABLE$8, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(TABLE$8);
         }
   ...
   public void xsetTable(XmlString table) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(TABLE$8, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(TABLE$8);
         }
   ...
   public void unsetTable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(TABLE$8, 0);
      }
   }
   ...
   public String getPrimaryKeyColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(PRIMARYKEYCOLUMN$10, 0);
         return target == null ? null : target.getStringValue();
      }
   }
   ...
   public XmlString xgetPrimaryKeyColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYCOLUMN$10, 0);
         return target;
      }
   }
   ...
   public boolean isSetPrimaryKeyColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(PRIMARYKEYCOLUMN$10) != 0;
      }
   }
   ...
   public void setPrimaryKeyColumn(String primaryKeyColumn) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(PRIMARYKEYCOLUMN$10, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(PRIMARYKEYCOLUMN$10);
         }
   ...
   public void xsetPrimaryKeyColumn(XmlString primaryKeyColumn) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(PRIMARYKEYCOLUMN$10, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(PRIMARYKEYCOLUMN$10);
         }
   ...
   public void unsetPrimaryKeyColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(PRIMARYKEYCOLUMN$10, 0);
      }
   }
   ...
   public String getSequenceColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_element_user(SEQUENCECOLUMN$12, 0);
         return target == null ? null : target.getStringValue();
      }
   }
   ...
   public XmlString xgetSequenceColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlString target = null;
         target = (XmlString)this.get_store().find_element_user(SEQUENCECOLUMN$12, 0);
         return target;
      }
   }
   ...
   public boolean isSetSequenceColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SEQUENCECOLUMN$12) != 0;
      }
   }
   ...
   public void setSequenceColumn(String sequenceColumn) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(SEQUENCECOLUMN$12, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(SEQUENCECOLUMN$12);
         }
   ...
   public void xsetSequenceColumn(XmlString sequenceColumn) {
      synchronized(this.monitor()) {
         ...
         target = (XmlString)this.get_store().find_element_user(SEQUENCECOLUMN$12, 0);
         if (target == null) {
            target = (XmlString)this.get_store().add_element_user(SEQUENCECOLUMN$12);
         }
   ...
   public void unsetSequenceColumn() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SEQUENCECOLUMN$12, 0);
      }
   }
