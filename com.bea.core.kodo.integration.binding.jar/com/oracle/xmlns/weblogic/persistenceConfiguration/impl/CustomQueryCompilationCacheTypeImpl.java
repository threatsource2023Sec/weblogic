...
public class CustomQueryCompilationCacheTypeImpl extends QueryCompilationCacheTypeImpl implements CustomQueryCompilationCacheType {
   ...
   public CustomQueryCompilationCacheTypeImpl(SchemaType sType) {
      super(sType);
   }
