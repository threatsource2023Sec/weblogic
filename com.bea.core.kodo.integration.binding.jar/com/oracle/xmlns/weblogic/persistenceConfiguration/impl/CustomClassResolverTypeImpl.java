...
public class CustomClassResolverTypeImpl extends ClassResolverTypeImpl implements CustomClassResolverType {
   ...
   public CustomClassResolverTypeImpl(SchemaType sType) {
      super(sType);
   }
