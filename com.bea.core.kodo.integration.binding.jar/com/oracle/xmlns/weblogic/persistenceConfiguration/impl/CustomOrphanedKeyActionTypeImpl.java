...
public class CustomOrphanedKeyActionTypeImpl extends LogOrphanedKeyActionTypeImpl implements CustomOrphanedKeyActionType {
   ...
   public CustomOrphanedKeyActionTypeImpl(SchemaType sType) {
      super(sType);
   }
