...
public class CustomPersistenceServerTypeImpl extends PersistenceServerTypeImpl implements CustomPersistenceServerType {
   ...
   public CustomPersistenceServerTypeImpl(SchemaType sType) {
      super(sType);
   }
