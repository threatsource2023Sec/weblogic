...
public class DeprecatedJdoMetaDataFactoryTypeImpl extends MetaDataFactoryTypeImpl implements DeprecatedJdoMetaDataFactoryType {
   ...
   public DeprecatedJdoMetaDataFactoryTypeImpl(SchemaType sType) {
      super(sType);
   }
