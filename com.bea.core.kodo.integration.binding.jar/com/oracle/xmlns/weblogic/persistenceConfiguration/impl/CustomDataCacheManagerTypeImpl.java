...
public class CustomDataCacheManagerTypeImpl extends DataCacheManagerTypeImpl implements CustomDataCacheManagerType {
   ...
   public CustomDataCacheManagerTypeImpl(SchemaType sType) {
      super(sType);
   }
