...
public class CustomRemoteCommitProviderTypeImpl extends RemoteCommitProviderTypeImpl implements CustomRemoteCommitProviderType {
   ...
   public CustomRemoteCommitProviderTypeImpl(SchemaType sType) {
      super(sType);
   }
