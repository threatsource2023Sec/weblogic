...
public class CustomDriverDataSourceTypeImpl extends DriverDataSourceTypeImpl implements CustomDriverDataSourceType {
   ...
   public CustomDriverDataSourceTypeImpl(SchemaType sType) {
      super(sType);
   }
