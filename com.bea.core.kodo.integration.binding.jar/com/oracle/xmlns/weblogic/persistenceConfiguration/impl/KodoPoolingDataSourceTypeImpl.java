...
public class KodoPoolingDataSourceTypeImpl extends DriverDataSourceTypeImpl implements KodoPoolingDataSourceType {
   ...
   public KodoPoolingDataSourceTypeImpl(SchemaType sType) {
      super(sType);
   }
