...
public interface PersistenceMappingDefaultsType extends MappingDefaultsType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(PersistenceMappingDefaultsType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_kodo_integration_binding_3_0_0_0").resolveHandle("persistencemappingdefaultstype5ffbtype");
   ...
   public static final class Factory {
      public static PersistenceMappingDefaultsType newInstance() {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().newInstance(PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType newInstance(XmlOptions options) {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().newInstance(PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(String xmlAsString) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(xmlAsString, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(String xmlAsString, XmlOptions options) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(xmlAsString, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(File file) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(file, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(File file, XmlOptions options) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(file, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(URL u) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(u, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(URL u, XmlOptions options) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(u, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(InputStream is) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(is, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(InputStream is, XmlOptions options) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(is, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(Reader r) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(r, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(Reader r, XmlOptions options) throws XmlException, IOException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(r, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(XMLStreamReader sr) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(sr, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(XMLStreamReader sr, XmlOptions options) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(sr, PersistenceMappingDefaultsType.type, options);
      }

      public static PersistenceMappingDefaultsType parse(Node node) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(node, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      public static PersistenceMappingDefaultsType parse(Node node, XmlOptions options) throws XmlException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(node, PersistenceMappingDefaultsType.type, options);
      }

      /** @deprecated */
      public static PersistenceMappingDefaultsType parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(xis, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      /** @deprecated */
      public static PersistenceMappingDefaultsType parse(XMLInputStream xis, XmlOptions options) throws XmlException, XMLStreamException {
         return (PersistenceMappingDefaultsType)XmlBeans.getContextTypeLoader().parse(xis, PersistenceMappingDefaultsType.type, options);
      }

      /** @deprecated */
      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xis) throws XmlException, XMLStreamException {
         return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xis, PersistenceMappingDefaultsType.type, (XmlOptions)null);
      }

      /** @deprecated */
      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xis, XmlOptions options) throws XmlException, XMLStreamException {
         return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xis, PersistenceMappingDefaultsType.type, options);
      }
