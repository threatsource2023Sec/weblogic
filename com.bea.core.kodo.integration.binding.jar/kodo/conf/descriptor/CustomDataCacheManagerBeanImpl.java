...
public class CustomDataCacheManagerBeanImpl extends DataCacheManagerBeanImpl implements CustomDataCacheManagerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomDataCacheManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomDataCacheManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomDataCacheManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DataCacheManagerBeanImpl.Helper {
      private CustomDataCacheManagerBeanImpl bean;

      protected Helper(CustomDataCacheManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomDataCacheManagerBeanImpl otherTyped = (CustomDataCacheManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomDataCacheManagerBeanImpl original = (CustomDataCacheManagerBeanImpl)event.getSourceBean();
            CustomDataCacheManagerBeanImpl proposed = (CustomDataCacheManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomDataCacheManagerBeanImpl copy = (CustomDataCacheManagerBeanImpl)initialCopy;
