...
public class KodoConcurrentQueryCacheBeanImpl extends QueryCacheBeanImpl implements KodoConcurrentQueryCacheBean, Serializable {
   private int _CacheSize;
   private int _SoftReferenceSize;
   private static SchemaHelper2 _schemaHelper;

   public KodoConcurrentQueryCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public KodoConcurrentQueryCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public KodoConcurrentQueryCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends QueryCacheBeanImpl.Helper {
      private KodoConcurrentQueryCacheBeanImpl bean;

      protected Helper(KodoConcurrentQueryCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            KodoConcurrentQueryCacheBeanImpl otherTyped = (KodoConcurrentQueryCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            KodoConcurrentQueryCacheBeanImpl original = (KodoConcurrentQueryCacheBeanImpl)event.getSourceBean();
            KodoConcurrentQueryCacheBeanImpl proposed = (KodoConcurrentQueryCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            KodoConcurrentQueryCacheBeanImpl copy = (KodoConcurrentQueryCacheBeanImpl)initialCopy;
