...
public class CustomQueryCacheBeanImpl extends QueryCacheBeanImpl implements CustomQueryCacheBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomQueryCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomQueryCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomQueryCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends QueryCacheBeanImpl.Helper {
      private CustomQueryCacheBeanImpl bean;

      protected Helper(CustomQueryCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomQueryCacheBeanImpl otherTyped = (CustomQueryCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomQueryCacheBeanImpl original = (CustomQueryCacheBeanImpl)event.getSourceBean();
            CustomQueryCacheBeanImpl proposed = (CustomQueryCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomQueryCacheBeanImpl copy = (CustomQueryCacheBeanImpl)initialCopy;
