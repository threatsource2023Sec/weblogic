...
public class CustomBrokerImplBeanImpl extends BrokerImplBeanImpl implements CustomBrokerImplBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomBrokerImplBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomBrokerImplBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomBrokerImplBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends BrokerImplBeanImpl.Helper {
      private CustomBrokerImplBeanImpl bean;

      protected Helper(CustomBrokerImplBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomBrokerImplBeanImpl otherTyped = (CustomBrokerImplBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomBrokerImplBeanImpl original = (CustomBrokerImplBeanImpl)event.getSourceBean();
            CustomBrokerImplBeanImpl proposed = (CustomBrokerImplBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomBrokerImplBeanImpl copy = (CustomBrokerImplBeanImpl)initialCopy;
