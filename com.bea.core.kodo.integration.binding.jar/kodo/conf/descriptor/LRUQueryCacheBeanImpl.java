...
public class LRUQueryCacheBeanImpl extends QueryCacheBeanImpl implements LRUQueryCacheBean, Serializable {
   private int _CacheSize;
   private int _SoftReferenceSize;
   private static SchemaHelper2 _schemaHelper;

   public LRUQueryCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public LRUQueryCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public LRUQueryCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends QueryCacheBeanImpl.Helper {
      private LRUQueryCacheBeanImpl bean;

      protected Helper(LRUQueryCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            LRUQueryCacheBeanImpl otherTyped = (LRUQueryCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            LRUQueryCacheBeanImpl original = (LRUQueryCacheBeanImpl)event.getSourceBean();
            LRUQueryCacheBeanImpl proposed = (LRUQueryCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            LRUQueryCacheBeanImpl copy = (LRUQueryCacheBeanImpl)initialCopy;
