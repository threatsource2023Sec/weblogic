...
public class DetachOptionsAllBeanImpl extends DetachStateBeanImpl implements DetachOptionsAllBean, Serializable {
   ...
   public DetachOptionsAllBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public DetachOptionsAllBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DetachStateBeanImpl.Helper {
      ...
      protected Helper(DetachOptionsAllBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            DetachOptionsAllBeanImpl otherTyped = (DetachOptionsAllBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            DetachOptionsAllBeanImpl original = (DetachOptionsAllBeanImpl)event.getSourceBean();
            DetachOptionsAllBeanImpl proposed = (DetachOptionsAllBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            DetachOptionsAllBeanImpl copy = (DetachOptionsAllBeanImpl)initialCopy;
