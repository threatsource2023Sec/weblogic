...
public class CustomPlugInBeanImpl extends AbstractDescriptorBean implements CustomPlugInBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomPlugInBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomPlugInBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomPlugInBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private CustomPlugInBeanImpl bean;

      protected Helper(CustomPlugInBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomPlugInBeanImpl otherTyped = (CustomPlugInBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomPlugInBeanImpl original = (CustomPlugInBeanImpl)event.getSourceBean();
            CustomPlugInBeanImpl proposed = (CustomPlugInBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomPlugInBeanImpl copy = (CustomPlugInBeanImpl)initialCopy;
