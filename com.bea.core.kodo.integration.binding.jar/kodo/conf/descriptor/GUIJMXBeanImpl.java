...
public class GUIJMXBeanImpl extends LocalJMXBeanImpl implements GUIJMXBean, Serializable {
   ...
   public GUIJMXBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public GUIJMXBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends LocalJMXBeanImpl.Helper {
      ...
      protected Helper(GUIJMXBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            GUIJMXBeanImpl var2 = (GUIJMXBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            GUIJMXBeanImpl original = (GUIJMXBeanImpl)event.getSourceBean();
            GUIJMXBeanImpl proposed = (GUIJMXBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            GUIJMXBeanImpl copy = (GUIJMXBeanImpl)initialCopy;
