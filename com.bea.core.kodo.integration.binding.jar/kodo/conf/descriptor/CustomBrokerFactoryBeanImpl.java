...
public class CustomBrokerFactoryBeanImpl extends BrokerFactoryBeanImpl implements CustomBrokerFactoryBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomBrokerFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomBrokerFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomBrokerFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends BrokerFactoryBeanImpl.Helper {
      private CustomBrokerFactoryBeanImpl bean;

      protected Helper(CustomBrokerFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomBrokerFactoryBeanImpl otherTyped = (CustomBrokerFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomBrokerFactoryBeanImpl original = (CustomBrokerFactoryBeanImpl)event.getSourceBean();
            CustomBrokerFactoryBeanImpl proposed = (CustomBrokerFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomBrokerFactoryBeanImpl copy = (CustomBrokerFactoryBeanImpl)initialCopy;
