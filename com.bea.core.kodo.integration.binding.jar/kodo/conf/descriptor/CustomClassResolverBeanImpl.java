...
public class CustomClassResolverBeanImpl extends ClassResolverBeanImpl implements CustomClassResolverBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomClassResolverBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomClassResolverBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomClassResolverBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ClassResolverBeanImpl.Helper {
      private CustomClassResolverBeanImpl bean;

      protected Helper(CustomClassResolverBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomClassResolverBeanImpl otherTyped = (CustomClassResolverBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomClassResolverBeanImpl original = (CustomClassResolverBeanImpl)event.getSourceBean();
            CustomClassResolverBeanImpl proposed = (CustomClassResolverBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomClassResolverBeanImpl copy = (CustomClassResolverBeanImpl)initialCopy;
