...
public class CustomLockManagerBeanImpl extends LockManagerBeanImpl implements CustomLockManagerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomLockManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomLockManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomLockManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends LockManagerBeanImpl.Helper {
      private CustomLockManagerBeanImpl bean;

      protected Helper(CustomLockManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomLockManagerBeanImpl otherTyped = (CustomLockManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomLockManagerBeanImpl original = (CustomLockManagerBeanImpl)event.getSourceBean();
            CustomLockManagerBeanImpl proposed = (CustomLockManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomLockManagerBeanImpl copy = (CustomLockManagerBeanImpl)initialCopy;
