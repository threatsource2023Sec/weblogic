...
public class JDOMetaDataFactoryBeanImpl extends MetaDataFactoryBeanImpl implements JDOMetaDataFactoryBean, Serializable {
   ...
   public JDOMetaDataFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public JDOMetaDataFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public JDOMetaDataFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MetaDataFactoryBeanImpl.Helper {
      private JDOMetaDataFactoryBeanImpl bean;

      protected Helper(JDOMetaDataFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JDOMetaDataFactoryBeanImpl otherTyped = (JDOMetaDataFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JDOMetaDataFactoryBeanImpl original = (JDOMetaDataFactoryBeanImpl)event.getSourceBean();
            JDOMetaDataFactoryBeanImpl proposed = (JDOMetaDataFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JDOMetaDataFactoryBeanImpl copy = (JDOMetaDataFactoryBeanImpl)initialCopy;
