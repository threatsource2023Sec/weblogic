...
public class CustomDetachStateBeanImpl extends DetachStateBeanImpl implements CustomDetachStateBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomDetachStateBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomDetachStateBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomDetachStateBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DetachStateBeanImpl.Helper {
      private CustomDetachStateBeanImpl bean;

      protected Helper(CustomDetachStateBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomDetachStateBeanImpl otherTyped = (CustomDetachStateBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomDetachStateBeanImpl original = (CustomDetachStateBeanImpl)event.getSourceBean();
            CustomDetachStateBeanImpl proposed = (CustomDetachStateBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomDetachStateBeanImpl copy = (CustomDetachStateBeanImpl)initialCopy;
