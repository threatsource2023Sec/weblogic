...
public class NoneJMXBeanImpl extends JMXBeanImpl implements NoneJMXBean, Serializable {
   private static SchemaHelper2 _schemaHelper;

   public NoneJMXBeanImpl() {
      this._initializeProperty(-1);
   }

   public NoneJMXBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public NoneJMXBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends JMXBeanImpl.Helper {
      private NoneJMXBeanImpl bean;

      protected Helper(NoneJMXBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            NoneJMXBeanImpl var2 = (NoneJMXBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            NoneJMXBeanImpl original = (NoneJMXBeanImpl)event.getSourceBean();
            NoneJMXBeanImpl proposed = (NoneJMXBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            NoneJMXBeanImpl copy = (NoneJMXBeanImpl)initialCopy;
