...
public class KodoPersistenceMetaDataFactoryBeanImpl extends MetaDataFactoryBeanImpl implements KodoPersistenceMetaDataFactoryBean, Serializable {
   ...
   public KodoPersistenceMetaDataFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public KodoPersistenceMetaDataFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public KodoPersistenceMetaDataFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MetaDataFactoryBeanImpl.Helper {
      private KodoPersistenceMetaDataFactoryBeanImpl bean;

      protected Helper(KodoPersistenceMetaDataFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            KodoPersistenceMetaDataFactoryBeanImpl otherTyped = (KodoPersistenceMetaDataFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            KodoPersistenceMetaDataFactoryBeanImpl original = (KodoPersistenceMetaDataFactoryBeanImpl)event.getSourceBean();
            KodoPersistenceMetaDataFactoryBeanImpl proposed = (KodoPersistenceMetaDataFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            KodoPersistenceMetaDataFactoryBeanImpl copy = (KodoPersistenceMetaDataFactoryBeanImpl)initialCopy;
