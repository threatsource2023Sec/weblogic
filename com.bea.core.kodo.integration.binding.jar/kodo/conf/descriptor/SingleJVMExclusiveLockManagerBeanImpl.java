...
public class SingleJVMExclusiveLockManagerBeanImpl extends LockManagerBeanImpl implements SingleJVMExclusiveLockManagerBean, Serializable {
   private boolean _VersionCheckOnReadLock;
   private boolean _VersionUpdateOnWriteLock;
   private static SchemaHelper2 _schemaHelper;

   public SingleJVMExclusiveLockManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public SingleJVMExclusiveLockManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SingleJVMExclusiveLockManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            case 0:
               this._VersionCheckOnReadLock = false;
               if (initOne) {
                  break;
               }
            case 1:
               this._VersionUpdateOnWriteLock = false;
               if (initOne) {
                  break;
               }
            default:
   ...
   protected static class Helper extends LockManagerBeanImpl.Helper {
      private SingleJVMExclusiveLockManagerBeanImpl bean;

      protected Helper(SingleJVMExclusiveLockManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SingleJVMExclusiveLockManagerBeanImpl otherTyped = (SingleJVMExclusiveLockManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SingleJVMExclusiveLockManagerBeanImpl original = (SingleJVMExclusiveLockManagerBeanImpl)event.getSourceBean();
            SingleJVMExclusiveLockManagerBeanImpl proposed = (SingleJVMExclusiveLockManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SingleJVMExclusiveLockManagerBeanImpl copy = (SingleJVMExclusiveLockManagerBeanImpl)initialCopy;
