...
public class CustomFilterListenerBeanImpl extends FilterListenerBeanImpl implements CustomFilterListenerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomFilterListenerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomFilterListenerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomFilterListenerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public static class SchemaHelper2 extends FilterListenerBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends FilterListenerBeanImpl.Helper {
      private CustomFilterListenerBeanImpl bean;

      protected Helper(CustomFilterListenerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomFilterListenerBeanImpl otherTyped = (CustomFilterListenerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomFilterListenerBeanImpl original = (CustomFilterListenerBeanImpl)event.getSourceBean();
            CustomFilterListenerBeanImpl proposed = (CustomFilterListenerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomFilterListenerBeanImpl copy = (CustomFilterListenerBeanImpl)initialCopy;
