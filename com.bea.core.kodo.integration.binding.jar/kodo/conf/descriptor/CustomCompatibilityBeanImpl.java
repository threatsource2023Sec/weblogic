...
public class CustomCompatibilityBeanImpl extends PersistenceCompatibilityBeanImpl implements CustomCompatibilityBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomCompatibilityBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomCompatibilityBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomCompatibilityBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends PersistenceCompatibilityBeanImpl.Helper {
      private CustomCompatibilityBeanImpl bean;

      protected Helper(CustomCompatibilityBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomCompatibilityBeanImpl otherTyped = (CustomCompatibilityBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomCompatibilityBeanImpl original = (CustomCompatibilityBeanImpl)event.getSourceBean();
            CustomCompatibilityBeanImpl proposed = (CustomCompatibilityBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomCompatibilityBeanImpl copy = (CustomCompatibilityBeanImpl)initialCopy;
