...
public class CustomPersistenceServerBeanImpl extends PersistenceServerBeanImpl implements CustomPersistenceServerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomPersistenceServerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomPersistenceServerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomPersistenceServerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends PersistenceServerBeanImpl.Helper {
      private CustomPersistenceServerBeanImpl bean;

      protected Helper(CustomPersistenceServerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomPersistenceServerBeanImpl otherTyped = (CustomPersistenceServerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomPersistenceServerBeanImpl original = (CustomPersistenceServerBeanImpl)event.getSourceBean();
            CustomPersistenceServerBeanImpl proposed = (CustomPersistenceServerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomPersistenceServerBeanImpl copy = (CustomPersistenceServerBeanImpl)initialCopy;
