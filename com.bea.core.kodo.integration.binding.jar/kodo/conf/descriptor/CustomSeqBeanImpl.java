...
public class CustomSeqBeanImpl extends SequenceBeanImpl implements CustomSeqBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomSeqBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomSeqBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomSeqBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SequenceBeanImpl.Helper {
      private CustomSeqBeanImpl bean;

      protected Helper(CustomSeqBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomSeqBeanImpl otherTyped = (CustomSeqBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomSeqBeanImpl original = (CustomSeqBeanImpl)event.getSourceBean();
            CustomSeqBeanImpl proposed = (CustomSeqBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomSeqBeanImpl copy = (CustomSeqBeanImpl)initialCopy;
