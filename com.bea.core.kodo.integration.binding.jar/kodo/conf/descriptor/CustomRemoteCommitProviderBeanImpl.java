...
public class CustomRemoteCommitProviderBeanImpl extends RemoteCommitProviderBeanImpl implements CustomRemoteCommitProviderBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomRemoteCommitProviderBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomRemoteCommitProviderBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomRemoteCommitProviderBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            ...
            case 2:
               this._Properties = new PropertiesBeanImpl(this, 2);
   ...
   protected static class Helper extends RemoteCommitProviderBeanImpl.Helper {
      private CustomRemoteCommitProviderBeanImpl bean;

      protected Helper(CustomRemoteCommitProviderBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomRemoteCommitProviderBeanImpl otherTyped = (CustomRemoteCommitProviderBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomRemoteCommitProviderBeanImpl original = (CustomRemoteCommitProviderBeanImpl)event.getSourceBean();
            CustomRemoteCommitProviderBeanImpl proposed = (CustomRemoteCommitProviderBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomRemoteCommitProviderBeanImpl copy = (CustomRemoteCommitProviderBeanImpl)initialCopy;
