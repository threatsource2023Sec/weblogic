...
public class NoneProfilingBeanImpl extends ProfilingBeanImpl implements NoneProfilingBean, Serializable {
   private static SchemaHelper2 _schemaHelper;

   public NoneProfilingBeanImpl() {
      this._initializeProperty(-1);
   }

   public NoneProfilingBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public NoneProfilingBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ProfilingBeanImpl.Helper {
      private NoneProfilingBeanImpl bean;

      protected Helper(NoneProfilingBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            NoneProfilingBeanImpl var2 = (NoneProfilingBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            NoneProfilingBeanImpl original = (NoneProfilingBeanImpl)event.getSourceBean();
            NoneProfilingBeanImpl proposed = (NoneProfilingBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            NoneProfilingBeanImpl copy = (NoneProfilingBeanImpl)initialCopy;
