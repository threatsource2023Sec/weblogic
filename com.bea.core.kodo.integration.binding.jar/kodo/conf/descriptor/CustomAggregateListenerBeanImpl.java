...
public class CustomAggregateListenerBeanImpl extends AggregateListenerBeanImpl implements CustomAggregateListenerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomAggregateListenerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomAggregateListenerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomAggregateListenerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public static class SchemaHelper2 extends AggregateListenerBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends AggregateListenerBeanImpl.Helper {
      private CustomAggregateListenerBeanImpl bean;

      protected Helper(CustomAggregateListenerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomAggregateListenerBeanImpl otherTyped = (CustomAggregateListenerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomAggregateListenerBeanImpl original = (CustomAggregateListenerBeanImpl)event.getSourceBean();
            CustomAggregateListenerBeanImpl proposed = (CustomAggregateListenerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomAggregateListenerBeanImpl copy = (CustomAggregateListenerBeanImpl)initialCopy;
