...
public class DeprecatedJDOMetaDataFactoryBeanImpl extends MetaDataFactoryBeanImpl implements DeprecatedJDOMetaDataFactoryBean, Serializable {
   ...
   public DeprecatedJDOMetaDataFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public DeprecatedJDOMetaDataFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public DeprecatedJDOMetaDataFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MetaDataFactoryBeanImpl.Helper {
      private DeprecatedJDOMetaDataFactoryBeanImpl bean;

      protected Helper(DeprecatedJDOMetaDataFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            DeprecatedJDOMetaDataFactoryBeanImpl otherTyped = (DeprecatedJDOMetaDataFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            DeprecatedJDOMetaDataFactoryBeanImpl original = (DeprecatedJDOMetaDataFactoryBeanImpl)event.getSourceBean();
            DeprecatedJDOMetaDataFactoryBeanImpl proposed = (DeprecatedJDOMetaDataFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            DeprecatedJDOMetaDataFactoryBeanImpl copy = (DeprecatedJDOMetaDataFactoryBeanImpl)initialCopy;
