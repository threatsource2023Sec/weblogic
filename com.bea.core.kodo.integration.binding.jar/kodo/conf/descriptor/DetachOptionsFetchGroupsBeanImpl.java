...
public class DetachOptionsFetchGroupsBeanImpl extends DetachStateBeanImpl implements DetachOptionsFetchGroupsBean, Serializable {
   ...
   public DetachOptionsFetchGroupsBeanImpl() {
      this._initializeProperty(-1);
   }

   public DetachOptionsFetchGroupsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public DetachOptionsFetchGroupsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DetachStateBeanImpl.Helper {
      private DetachOptionsFetchGroupsBeanImpl bean;

      protected Helper(DetachOptionsFetchGroupsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            DetachOptionsFetchGroupsBeanImpl otherTyped = (DetachOptionsFetchGroupsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            DetachOptionsFetchGroupsBeanImpl original = (DetachOptionsFetchGroupsBeanImpl)event.getSourceBean();
            DetachOptionsFetchGroupsBeanImpl proposed = (DetachOptionsFetchGroupsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            DetachOptionsFetchGroupsBeanImpl copy = (DetachOptionsFetchGroupsBeanImpl)initialCopy;
