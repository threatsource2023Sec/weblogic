...
public class CustomDataCacheBeanImpl extends DataCacheBeanImpl implements CustomDataCacheBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomDataCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomDataCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomDataCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DataCacheBeanImpl.Helper {
      private CustomDataCacheBeanImpl bean;

      protected Helper(CustomDataCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomDataCacheBeanImpl otherTyped = (CustomDataCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomDataCacheBeanImpl original = (CustomDataCacheBeanImpl)event.getSourceBean();
            CustomDataCacheBeanImpl proposed = (CustomDataCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomDataCacheBeanImpl copy = (CustomDataCacheBeanImpl)initialCopy;
