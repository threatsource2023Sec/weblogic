...
public class GUIProfilingBeanImpl extends ProfilingBeanImpl implements GUIProfilingBean, Serializable {
   private static SchemaHelper2 _schemaHelper;

   public GUIProfilingBeanImpl() {
      this._initializeProperty(-1);
   }

   public GUIProfilingBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public GUIProfilingBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ProfilingBeanImpl.Helper {
      private GUIProfilingBeanImpl bean;

      protected Helper(GUIProfilingBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            GUIProfilingBeanImpl var2 = (GUIProfilingBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            GUIProfilingBeanImpl original = (GUIProfilingBeanImpl)event.getSourceBean();
            GUIProfilingBeanImpl proposed = (GUIProfilingBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            GUIProfilingBeanImpl copy = (GUIProfilingBeanImpl)initialCopy;
