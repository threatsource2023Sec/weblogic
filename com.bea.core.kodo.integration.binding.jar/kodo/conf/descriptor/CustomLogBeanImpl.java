...
public class CustomLogBeanImpl extends LogBeanImpl implements CustomLogBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomLogBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomLogBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomLogBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends LogBeanImpl.Helper {
      private CustomLogBeanImpl bean;

      protected Helper(CustomLogBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomLogBeanImpl otherTyped = (CustomLogBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomLogBeanImpl original = (CustomLogBeanImpl)event.getSourceBean();
            CustomLogBeanImpl proposed = (CustomLogBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomLogBeanImpl copy = (CustomLogBeanImpl)initialCopy;
