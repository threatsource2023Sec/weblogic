...
public class CustomMetaDataRepositoryBeanImpl extends MetaDataRepositoryBeanImpl implements CustomMetaDataRepositoryBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomMetaDataRepositoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomMetaDataRepositoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomMetaDataRepositoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MetaDataRepositoryBeanImpl.Helper {
      private CustomMetaDataRepositoryBeanImpl bean;

      protected Helper(CustomMetaDataRepositoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomMetaDataRepositoryBeanImpl otherTyped = (CustomMetaDataRepositoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomMetaDataRepositoryBeanImpl original = (CustomMetaDataRepositoryBeanImpl)event.getSourceBean();
            CustomMetaDataRepositoryBeanImpl proposed = (CustomMetaDataRepositoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomMetaDataRepositoryBeanImpl copy = (CustomMetaDataRepositoryBeanImpl)initialCopy;
