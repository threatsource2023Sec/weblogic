...
public class KodoConcurrentDataCacheBeanImpl extends DataCacheBeanImpl implements KodoConcurrentDataCacheBean, Serializable {
   private int _CacheSize;
   private String _EvictionSchedule;
   private int _SoftReferenceSize;
   private static SchemaHelper2 _schemaHelper;

   public KodoConcurrentDataCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public KodoConcurrentDataCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public KodoConcurrentDataCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DataCacheBeanImpl.Helper {
      private KodoConcurrentDataCacheBeanImpl bean;

      protected Helper(KodoConcurrentDataCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            KodoConcurrentDataCacheBeanImpl otherTyped = (KodoConcurrentDataCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            KodoConcurrentDataCacheBeanImpl original = (KodoConcurrentDataCacheBeanImpl)event.getSourceBean();
            KodoConcurrentDataCacheBeanImpl proposed = (KodoConcurrentDataCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            KodoConcurrentDataCacheBeanImpl copy = (KodoConcurrentDataCacheBeanImpl)initialCopy;
