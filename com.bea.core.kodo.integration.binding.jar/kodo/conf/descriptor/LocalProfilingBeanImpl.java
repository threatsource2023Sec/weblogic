...
public class LocalProfilingBeanImpl extends ProfilingBeanImpl implements LocalProfilingBean, Serializable {
   private static SchemaHelper2 _schemaHelper;

   public LocalProfilingBeanImpl() {
      this._initializeProperty(-1);
   }

   public LocalProfilingBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public LocalProfilingBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ProfilingBeanImpl.Helper {
      private LocalProfilingBeanImpl bean;

      protected Helper(LocalProfilingBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            LocalProfilingBeanImpl var2 = (LocalProfilingBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            LocalProfilingBeanImpl original = (LocalProfilingBeanImpl)event.getSourceBean();
            LocalProfilingBeanImpl proposed = (LocalProfilingBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            LocalProfilingBeanImpl copy = (LocalProfilingBeanImpl)initialCopy;
