...
public class CustomQueryCompilationCacheBeanImpl extends QueryCompilationCacheBeanImpl implements CustomQueryCompilationCacheBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomQueryCompilationCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomQueryCompilationCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomQueryCompilationCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends QueryCompilationCacheBeanImpl.Helper {
      private CustomQueryCompilationCacheBeanImpl bean;

      protected Helper(CustomQueryCompilationCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomQueryCompilationCacheBeanImpl otherTyped = (CustomQueryCompilationCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomQueryCompilationCacheBeanImpl original = (CustomQueryCompilationCacheBeanImpl)event.getSourceBean();
            CustomQueryCompilationCacheBeanImpl proposed = (CustomQueryCompilationCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomQueryCompilationCacheBeanImpl copy = (CustomQueryCompilationCacheBeanImpl)initialCopy;
