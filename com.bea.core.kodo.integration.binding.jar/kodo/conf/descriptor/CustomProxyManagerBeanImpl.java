...
public class CustomProxyManagerBeanImpl extends ProxyManagerBeanImpl implements CustomProxyManagerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomProxyManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomProxyManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomProxyManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends ProxyManagerBeanImpl.Helper {
      private CustomProxyManagerBeanImpl bean;

      protected Helper(CustomProxyManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomProxyManagerBeanImpl otherTyped = (CustomProxyManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomProxyManagerBeanImpl original = (CustomProxyManagerBeanImpl)event.getSourceBean();
            CustomProxyManagerBeanImpl proposed = (CustomProxyManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomProxyManagerBeanImpl copy = (CustomProxyManagerBeanImpl)initialCopy;
