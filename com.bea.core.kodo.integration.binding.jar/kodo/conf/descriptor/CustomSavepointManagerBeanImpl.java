...
public class CustomSavepointManagerBeanImpl extends SavepointManagerBeanImpl implements CustomSavepointManagerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomSavepointManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomSavepointManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomSavepointManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SavepointManagerBeanImpl.Helper {
      private CustomSavepointManagerBeanImpl bean;

      protected Helper(CustomSavepointManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomSavepointManagerBeanImpl otherTyped = (CustomSavepointManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomSavepointManagerBeanImpl original = (CustomSavepointManagerBeanImpl)event.getSourceBean();
            CustomSavepointManagerBeanImpl proposed = (CustomSavepointManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomSavepointManagerBeanImpl copy = (CustomSavepointManagerBeanImpl)initialCopy;
