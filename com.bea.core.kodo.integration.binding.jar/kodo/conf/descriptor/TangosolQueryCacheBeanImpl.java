...
public class TangosolQueryCacheBeanImpl extends QueryCacheBeanImpl implements TangosolQueryCacheBean, Serializable {
   private boolean _ClearOnClose;
   private String _TangosolCacheName;
   private String _TangosolCacheType;
   private static SchemaHelper2 _schemaHelper;

   public TangosolQueryCacheBeanImpl() {
      this._initializeProperty(-1);
   }

   public TangosolQueryCacheBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public TangosolQueryCacheBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            ...
            case 3:
               this._TangosolCacheName = "kodo-query";
               if (initOne) {
                  break;
               }
            case 2:
   ...
   protected static class Helper extends QueryCacheBeanImpl.Helper {
      private TangosolQueryCacheBeanImpl bean;

      protected Helper(TangosolQueryCacheBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            TangosolQueryCacheBeanImpl otherTyped = (TangosolQueryCacheBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            TangosolQueryCacheBeanImpl original = (TangosolQueryCacheBeanImpl)event.getSourceBean();
            TangosolQueryCacheBeanImpl proposed = (TangosolQueryCacheBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            TangosolQueryCacheBeanImpl copy = (TangosolQueryCacheBeanImpl)initialCopy;
