...
public class ORMFileJDORMappingFactoryBeanImpl extends MappingFactoryBeanImpl implements ORMFileJDORMappingFactoryBean, Serializable {
   ...
   public ORMFileJDORMappingFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ORMFileJDORMappingFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MappingFactoryBeanImpl.Helper {
      ...
      protected Helper(ORMFileJDORMappingFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ORMFileJDORMappingFactoryBeanImpl otherTyped = (ORMFileJDORMappingFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ORMFileJDORMappingFactoryBeanImpl original = (ORMFileJDORMappingFactoryBeanImpl)event.getSourceBean();
            ORMFileJDORMappingFactoryBeanImpl proposed = (ORMFileJDORMappingFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ORMFileJDORMappingFactoryBeanImpl copy = (ORMFileJDORMappingFactoryBeanImpl)initialCopy;
