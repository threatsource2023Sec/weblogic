...
public class DeprecatedJDOMappingDefaultsBeanImpl extends MappingDefaultsBeanImpl implements DeprecatedJDOMappingDefaultsBean, Serializable {
   ...
   public DeprecatedJDOMappingDefaultsBeanImpl() {
      this._initializeProperty(-1);
   }

   public DeprecatedJDOMappingDefaultsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public DeprecatedJDOMappingDefaultsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            ...
            case 15:
               this._DataStoreIdColumnName = "jdoId";
               if (initOne) {
                  break;
               }
            case 6:
            ...
            case 3:
               this._DiscriminatorColumnName = "jdoClass";
               if (initOne) {
                  break;
               }
            case 11:
            ...
            case 18:
               this._OrderLists = true;
               if (initOne) {
                  break;
               }
            case 17:
               this._StoreEnumOrdinal = false;
               if (initOne) {
                  break;
               }
            case 21:
   ...
   protected static class Helper extends MappingDefaultsBeanImpl.Helper {
      private DeprecatedJDOMappingDefaultsBeanImpl bean;

      protected Helper(DeprecatedJDOMappingDefaultsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            DeprecatedJDOMappingDefaultsBeanImpl otherTyped = (DeprecatedJDOMappingDefaultsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            DeprecatedJDOMappingDefaultsBeanImpl original = (DeprecatedJDOMappingDefaultsBeanImpl)event.getSourceBean();
            DeprecatedJDOMappingDefaultsBeanImpl proposed = (DeprecatedJDOMappingDefaultsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            DeprecatedJDOMappingDefaultsBeanImpl copy = (DeprecatedJDOMappingDefaultsBeanImpl)initialCopy;
