...
public class MappingDefaultsImplBeanImpl extends MappingDefaultsBeanImpl implements MappingDefaultsImplBean, Serializable {
   ...
   public MappingDefaultsImplBeanImpl() {
      this._initializeProperty(-1);
   }

   public MappingDefaultsImplBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public MappingDefaultsImplBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            ...
            case 3:
               this._DiscriminatorColumnName = null;
               if (initOne) {
                  break;
               }
            case 11:
   ...
   protected static class Helper extends MappingDefaultsBeanImpl.Helper {
      private MappingDefaultsImplBeanImpl bean;

      protected Helper(MappingDefaultsImplBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            MappingDefaultsImplBeanImpl otherTyped = (MappingDefaultsImplBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            MappingDefaultsImplBeanImpl original = (MappingDefaultsImplBeanImpl)event.getSourceBean();
            MappingDefaultsImplBeanImpl proposed = (MappingDefaultsImplBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            MappingDefaultsImplBeanImpl copy = (MappingDefaultsImplBeanImpl)initialCopy;
