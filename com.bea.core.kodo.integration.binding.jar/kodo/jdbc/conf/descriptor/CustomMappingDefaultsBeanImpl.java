...
public class CustomMappingDefaultsBeanImpl extends MappingDefaultsBeanImpl implements CustomMappingDefaultsBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomMappingDefaultsBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomMappingDefaultsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomMappingDefaultsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MappingDefaultsBeanImpl.Helper {
      private CustomMappingDefaultsBeanImpl bean;

      protected Helper(CustomMappingDefaultsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomMappingDefaultsBeanImpl otherTyped = (CustomMappingDefaultsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomMappingDefaultsBeanImpl original = (CustomMappingDefaultsBeanImpl)event.getSourceBean();
            CustomMappingDefaultsBeanImpl proposed = (CustomMappingDefaultsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomMappingDefaultsBeanImpl copy = (CustomMappingDefaultsBeanImpl)initialCopy;
