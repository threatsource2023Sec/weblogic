...
public class ValueTableJDBCSeqBeanImpl extends SequenceBeanImpl implements ValueTableJDBCSeqBean, Serializable {
   ...
   public ValueTableJDBCSeqBeanImpl() {
      this._initializeProperty(-1);
   }

   public ValueTableJDBCSeqBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ValueTableJDBCSeqBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public boolean isPrimaryKeyValueInherited() {
      return false;
   }

   public boolean isPrimaryKeyValueSet() {
      return this._isSet(3);
   }

   public void setPrimaryKeyValue(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String _oldVal = this._PrimaryKeyValue;
      this._PrimaryKeyValue = param0;
   ...
   protected static class Helper extends SequenceBeanImpl.Helper {
      private ValueTableJDBCSeqBeanImpl bean;

      protected Helper(ValueTableJDBCSeqBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Allocate")) {
            ...
            return 5;
         } else if (propName.equals("PrimaryKeyValue")) {
            return 3;
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isPrimaryKeyValueSet()) {
               buf.append("PrimaryKeyValue");
               buf.append(String.valueOf(this.bean.getPrimaryKeyValue()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ValueTableJDBCSeqBeanImpl otherTyped = (ValueTableJDBCSeqBeanImpl)other;
            ...
            this.computeDiff("PrimaryKeyValue", this.bean.getPrimaryKeyValue(), otherTyped.getPrimaryKeyValue(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ValueTableJDBCSeqBeanImpl original = (ValueTableJDBCSeqBeanImpl)event.getSourceBean();
            ValueTableJDBCSeqBeanImpl proposed = (ValueTableJDBCSeqBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("PrimaryKeyValue")) {
                  original.setPrimaryKeyValue(proposed.getPrimaryKeyValue());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ValueTableJDBCSeqBeanImpl copy = (ValueTableJDBCSeqBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("PrimaryKeyValue")) && this.bean.isPrimaryKeyValueSet()) {
               copy.setPrimaryKeyValue(this.bean.getPrimaryKeyValue());
            }
