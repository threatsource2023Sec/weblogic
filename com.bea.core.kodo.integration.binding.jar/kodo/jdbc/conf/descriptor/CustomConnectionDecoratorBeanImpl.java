...
public class CustomConnectionDecoratorBeanImpl extends ConnectionDecoratorBeanImpl implements CustomConnectionDecoratorBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomConnectionDecoratorBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomConnectionDecoratorBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomConnectionDecoratorBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public static class SchemaHelper2 extends ConnectionDecoratorBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends ConnectionDecoratorBeanImpl.Helper {
      private CustomConnectionDecoratorBeanImpl bean;

      protected Helper(CustomConnectionDecoratorBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomConnectionDecoratorBeanImpl otherTyped = (CustomConnectionDecoratorBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomConnectionDecoratorBeanImpl original = (CustomConnectionDecoratorBeanImpl)event.getSourceBean();
            CustomConnectionDecoratorBeanImpl proposed = (CustomConnectionDecoratorBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomConnectionDecoratorBeanImpl copy = (CustomConnectionDecoratorBeanImpl)initialCopy;
