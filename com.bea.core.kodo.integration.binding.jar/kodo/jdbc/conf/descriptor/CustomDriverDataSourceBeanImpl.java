...
public class CustomDriverDataSourceBeanImpl extends DriverDataSourceBeanImpl implements CustomDriverDataSourceBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomDriverDataSourceBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomDriverDataSourceBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomDriverDataSourceBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DriverDataSourceBeanImpl.Helper {
      private CustomDriverDataSourceBeanImpl bean;

      protected Helper(CustomDriverDataSourceBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomDriverDataSourceBeanImpl otherTyped = (CustomDriverDataSourceBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomDriverDataSourceBeanImpl original = (CustomDriverDataSourceBeanImpl)event.getSourceBean();
            CustomDriverDataSourceBeanImpl proposed = (CustomDriverDataSourceBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomDriverDataSourceBeanImpl copy = (CustomDriverDataSourceBeanImpl)initialCopy;
