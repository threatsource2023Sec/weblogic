...
public class CustomDictionaryBeanImpl extends DBDictionaryBeanImpl implements CustomDictionaryBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomDictionaryBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomDictionaryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomDictionaryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DBDictionaryBeanImpl.Helper {
      private CustomDictionaryBeanImpl bean;

      protected Helper(CustomDictionaryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomDictionaryBeanImpl otherTyped = (CustomDictionaryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomDictionaryBeanImpl original = (CustomDictionaryBeanImpl)event.getSourceBean();
            CustomDictionaryBeanImpl proposed = (CustomDictionaryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomDictionaryBeanImpl copy = (CustomDictionaryBeanImpl)initialCopy;
