...
public class CustomJDBCListenerBeanImpl extends JDBCListenerBeanImpl implements CustomJDBCListenerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomJDBCListenerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomJDBCListenerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomJDBCListenerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public static class SchemaHelper2 extends JDBCListenerBeanImpl.SchemaHelper2 implements SchemaHelper {
   ...
   protected static class Helper extends JDBCListenerBeanImpl.Helper {
      private CustomJDBCListenerBeanImpl bean;

      protected Helper(CustomJDBCListenerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomJDBCListenerBeanImpl otherTyped = (CustomJDBCListenerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomJDBCListenerBeanImpl original = (CustomJDBCListenerBeanImpl)event.getSourceBean();
            CustomJDBCListenerBeanImpl proposed = (CustomJDBCListenerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomJDBCListenerBeanImpl copy = (CustomJDBCListenerBeanImpl)initialCopy;
