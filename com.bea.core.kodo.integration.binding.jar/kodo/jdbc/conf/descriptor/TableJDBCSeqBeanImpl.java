...
public class TableJDBCSeqBeanImpl extends SequenceBeanImpl implements TableJDBCSeqBean, Serializable {
   ...
   public TableJDBCSeqBeanImpl() {
      this._initializeProperty(-1);
   }

   public TableJDBCSeqBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public TableJDBCSeqBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   private boolean _initializeProperty(int idx) {
      ...
      try {
         switch (idx) {
            ...
            case 3:
               this._Table = "OPENJPA_SEQUENCE_TABLE";
               if (initOne) {
                  break;
               }
            case 2:
   ...
   protected static class Helper extends SequenceBeanImpl.Helper {
      private TableJDBCSeqBeanImpl bean;

      protected Helper(TableJDBCSeqBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            TableJDBCSeqBeanImpl otherTyped = (TableJDBCSeqBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            TableJDBCSeqBeanImpl original = (TableJDBCSeqBeanImpl)event.getSourceBean();
            TableJDBCSeqBeanImpl proposed = (TableJDBCSeqBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            TableJDBCSeqBeanImpl copy = (TableJDBCSeqBeanImpl)initialCopy;
