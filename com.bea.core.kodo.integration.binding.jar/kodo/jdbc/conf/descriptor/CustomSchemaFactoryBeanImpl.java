...
public class CustomSchemaFactoryBeanImpl extends SchemaFactoryBeanImpl implements CustomSchemaFactoryBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomSchemaFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomSchemaFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomSchemaFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SchemaFactoryBeanImpl.Helper {
      private CustomSchemaFactoryBeanImpl bean;

      protected Helper(CustomSchemaFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomSchemaFactoryBeanImpl otherTyped = (CustomSchemaFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomSchemaFactoryBeanImpl original = (CustomSchemaFactoryBeanImpl)event.getSourceBean();
            CustomSchemaFactoryBeanImpl proposed = (CustomSchemaFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomSchemaFactoryBeanImpl copy = (CustomSchemaFactoryBeanImpl)initialCopy;
