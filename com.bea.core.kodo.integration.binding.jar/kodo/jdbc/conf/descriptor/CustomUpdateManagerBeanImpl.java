...
public class CustomUpdateManagerBeanImpl extends UpdateManagerBeanImpl implements CustomUpdateManagerBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomUpdateManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomUpdateManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomUpdateManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends UpdateManagerBeanImpl.Helper {
      private CustomUpdateManagerBeanImpl bean;

      protected Helper(CustomUpdateManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomUpdateManagerBeanImpl otherTyped = (CustomUpdateManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomUpdateManagerBeanImpl original = (CustomUpdateManagerBeanImpl)event.getSourceBean();
            CustomUpdateManagerBeanImpl proposed = (CustomUpdateManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomUpdateManagerBeanImpl copy = (CustomUpdateManagerBeanImpl)initialCopy;
