...
public class ExtensionDeprecatedJDOMappingFactoryBeanImpl extends MappingFactoryBeanImpl implements ExtensionDeprecatedJDOMappingFactoryBean, Serializable {
   ...
   public ExtensionDeprecatedJDOMappingFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public ExtensionDeprecatedJDOMappingFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ExtensionDeprecatedJDOMappingFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends MappingFactoryBeanImpl.Helper {
      private ExtensionDeprecatedJDOMappingFactoryBeanImpl bean;

      protected Helper(ExtensionDeprecatedJDOMappingFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ExtensionDeprecatedJDOMappingFactoryBeanImpl otherTyped = (ExtensionDeprecatedJDOMappingFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ExtensionDeprecatedJDOMappingFactoryBeanImpl original = (ExtensionDeprecatedJDOMappingFactoryBeanImpl)event.getSourceBean();
            ExtensionDeprecatedJDOMappingFactoryBeanImpl proposed = (ExtensionDeprecatedJDOMappingFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ExtensionDeprecatedJDOMappingFactoryBeanImpl copy = (ExtensionDeprecatedJDOMappingFactoryBeanImpl)initialCopy;
