...
public class TableLockUpdateManagerBeanImpl extends UpdateManagerBeanImpl implements TableLockUpdateManagerBean, Serializable {
   private boolean _MaximizeBatchSize;
   private static SchemaHelper2 _schemaHelper;

   public TableLockUpdateManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public TableLockUpdateManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public TableLockUpdateManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends UpdateManagerBeanImpl.Helper {
      private TableLockUpdateManagerBeanImpl bean;

      protected Helper(TableLockUpdateManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            TableLockUpdateManagerBeanImpl otherTyped = (TableLockUpdateManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            TableLockUpdateManagerBeanImpl original = (TableLockUpdateManagerBeanImpl)event.getSourceBean();
            TableLockUpdateManagerBeanImpl proposed = (TableLockUpdateManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            TableLockUpdateManagerBeanImpl copy = (TableLockUpdateManagerBeanImpl)initialCopy;
