...
public class SimpleDriverDataSourceBeanImpl extends DriverDataSourceBeanImpl implements SimpleDriverDataSourceBean, Serializable {
   ...
   public SimpleDriverDataSourceBeanImpl() {
      this._initializeProperty(-1);
   }

   public SimpleDriverDataSourceBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SimpleDriverDataSourceBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setConnectionPasswordEncrypted(byte[] param0) {
      ...
      if (this._isProductionModeEnabled() && param0 != null && !this._isEncrypted(param0)) {
         throw new IllegalArgumentException("In production mode, it's not allowed to set a clear text value to the property: ConnectionPasswordEncrypted of SimpleDriverDataSourceBean");
      } else {
   ...
   protected static class Helper extends DriverDataSourceBeanImpl.Helper {
      private SimpleDriverDataSourceBeanImpl bean;

      protected Helper(SimpleDriverDataSourceBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SimpleDriverDataSourceBeanImpl otherTyped = (SimpleDriverDataSourceBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SimpleDriverDataSourceBeanImpl original = (SimpleDriverDataSourceBeanImpl)event.getSourceBean();
            SimpleDriverDataSourceBeanImpl proposed = (SimpleDriverDataSourceBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SimpleDriverDataSourceBeanImpl copy = (SimpleDriverDataSourceBeanImpl)initialCopy;
