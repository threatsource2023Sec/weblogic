...
public class BatchingOperationOrderUpdateManagerBeanImpl extends UpdateManagerBeanImpl implements BatchingOperationOrderUpdateManagerBean, Serializable {
   private boolean _MaximizeBatchSize;
   private static SchemaHelper2 _schemaHelper;

   public BatchingOperationOrderUpdateManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public BatchingOperationOrderUpdateManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public BatchingOperationOrderUpdateManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends UpdateManagerBeanImpl.Helper {
      private BatchingOperationOrderUpdateManagerBeanImpl bean;

      protected Helper(BatchingOperationOrderUpdateManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            BatchingOperationOrderUpdateManagerBeanImpl otherTyped = (BatchingOperationOrderUpdateManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            BatchingOperationOrderUpdateManagerBeanImpl original = (BatchingOperationOrderUpdateManagerBeanImpl)event.getSourceBean();
            BatchingOperationOrderUpdateManagerBeanImpl proposed = (BatchingOperationOrderUpdateManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            BatchingOperationOrderUpdateManagerBeanImpl copy = (BatchingOperationOrderUpdateManagerBeanImpl)initialCopy;
