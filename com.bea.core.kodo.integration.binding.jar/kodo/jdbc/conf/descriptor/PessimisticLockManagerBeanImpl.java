...
import kodo.conf.descriptor.LockManagerBeanImpl;
...
public class PessimisticLockManagerBeanImpl extends LockManagerBeanImpl implements PessimisticLockManagerBean, Serializable {
   private boolean _VersionCheckOnReadLock;
   private boolean _VersionUpdateOnWriteLock;
   private static SchemaHelper2 _schemaHelper;

   public PessimisticLockManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public PessimisticLockManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public PessimisticLockManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends LockManagerBeanImpl.Helper {
      private PessimisticLockManagerBeanImpl bean;

      protected Helper(PessimisticLockManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            PessimisticLockManagerBeanImpl otherTyped = (PessimisticLockManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            PessimisticLockManagerBeanImpl original = (PessimisticLockManagerBeanImpl)event.getSourceBean();
            PessimisticLockManagerBeanImpl proposed = (PessimisticLockManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            PessimisticLockManagerBeanImpl copy = (PessimisticLockManagerBeanImpl)initialCopy;
