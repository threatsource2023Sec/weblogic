...
public class CustomSQLFactoryBeanImpl extends SQLFactoryBeanImpl implements CustomSQLFactoryBean, Serializable {
   private String _Classname;
   private PropertiesBean _Properties;
   private static SchemaHelper2 _schemaHelper;

   public CustomSQLFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public CustomSQLFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CustomSQLFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SQLFactoryBeanImpl.Helper {
      private CustomSQLFactoryBeanImpl bean;

      protected Helper(CustomSQLFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CustomSQLFactoryBeanImpl otherTyped = (CustomSQLFactoryBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CustomSQLFactoryBeanImpl original = (CustomSQLFactoryBeanImpl)event.getSourceBean();
            CustomSQLFactoryBeanImpl proposed = (CustomSQLFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CustomSQLFactoryBeanImpl copy = (CustomSQLFactoryBeanImpl)initialCopy;
