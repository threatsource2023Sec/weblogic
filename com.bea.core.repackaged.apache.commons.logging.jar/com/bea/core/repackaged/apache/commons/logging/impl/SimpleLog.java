...
public class SimpleLog implements Log, Serializable {
   ...
   // $FF: synthetic field
   static Class class$com$bea$core$repackaged$apache$commons$logging$impl$SimpleLog;
   ...
   public SimpleLog(String name) {
      this.logName = name;
      this.setLevel(3);
      String lvl = getStringProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.log." + this.logName);

      for(int i = String.valueOf(name).lastIndexOf("."); null == lvl && i > -1; i = String.valueOf(name).lastIndexOf(".")) {
         name = name.substring(0, i);
         lvl = getStringProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.log." + name);
      }

      if (null == lvl) {
         lvl = getStringProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.defaultlog");
      }
   ...
   private static ClassLoader getContextClassLoader() {
      ...
      if (classLoader == null) {
         classLoader = (class$com$bea$core$repackaged$apache$commons$logging$impl$SimpleLog == null ? (class$com$bea$core$repackaged$apache$commons$logging$impl$SimpleLog = class$("com.bea.core.repackaged.apache.commons.logging.impl.SimpleLog")) : class$com$bea$core$repackaged$apache$commons$logging$impl$SimpleLog).getClassLoader();
      }
   ...
   static {
      ...
      showLogName = getBooleanProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.showlogname", showLogName);
      showShortName = getBooleanProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.showShortLogname", showShortName);
      showDateTime = getBooleanProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.showdatetime", showDateTime);
      if (showDateTime) {
         dateTimeFormat = getStringProperty("com.bea.core.repackaged.apache.commons.logging.simplelog.dateTimeFormat", dateTimeFormat);
