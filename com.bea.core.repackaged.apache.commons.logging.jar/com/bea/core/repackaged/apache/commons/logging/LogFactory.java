...
public abstract class LogFactory {
   ...
   public static final String FACTORY_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.LogFactory";
   public static final String FACTORY_DEFAULT = "com.bea.core.repackaged.apache.commons.logging.impl.LogFactoryImpl";
   public static final String FACTORY_PROPERTIES = "commons-logging.properties";
   protected static final String SERVICE_ID = "META-INF/services/org.apache.commons.logging.LogFactory";
   public static final String DIAGNOSTICS_DEST_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.diagnostics.dest";
   private static PrintStream diagnosticsStream = null;
   private static final String diagnosticPrefix;
   public static final String HASHTABLE_IMPLEMENTATION_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.LogFactory.HashtableImpl";
   private static final String WEAK_HASHTABLE_CLASSNAME = "com.bea.core.repackaged.apache.commons.logging.impl.WeakHashtable";
   ...
   private static final Hashtable createFactoryStore() {
      ...
      try {
         storeImplementationClass = getSystemProperty("com.bea.core.repackaged.apache.commons.logging.LogFactory.HashtableImpl", (String)null);
      } catch (SecurityException var3) {
         storeImplementationClass = null;
      }

      if (storeImplementationClass == null) {
         storeImplementationClass = "com.bea.core.repackaged.apache.commons.logging.impl.WeakHashtable";
      }
      ...
      try {
         ...
         if (!"com.bea.core.repackaged.apache.commons.logging.impl.WeakHashtable".equals(storeImplementationClass)) {
   ...
   public static LogFactory getFactory() throws LogConfigurationException {
      ...
      if (factory != null) {
         ...
         try {
            factoryClass = getSystemProperty("com.bea.core.repackaged.apache.commons.logging.LogFactory", (String)null);
            if (factoryClass != null) {
               if (isDiagnosticsEnabled()) {
                  logDiagnostic("[LOOKUP] Creating an instance of LogFactory class '" + factoryClass + "' as specified by system property " + "com.bea.core.repackaged.apache.commons.logging.LogFactory");
               }
         ...
         if (factory == null) {
            if (props != null) {
               ...
               factoryClass = props.getProperty("com.bea.core.repackaged.apache.commons.logging.LogFactory");
               if (factoryClass != null) {
                  if (isDiagnosticsEnabled()) {
         ...
         if (factory == null) {
            ...
            factory = newFactory("com.bea.core.repackaged.apache.commons.logging.impl.LogFactoryImpl", thisClassLoader, contextClassLoader);
         }
      ...
      try {
         if (classLoader != null) {
            try {
               ...
               if ((class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory).isAssignableFrom(logFactoryClass)) {
                  if (isDiagnosticsEnabled()) {
                     logDiagnostic("Loaded class " + logFactoryClass.getName() + " from classloader " + objectId(classLoader));
                  }
               } else if (isDiagnosticsEnabled()) {
                  logDiagnostic("Factory class " + logFactoryClass.getName() + " loaded from classloader " + objectId(logFactoryClass.getClassLoader()) + " does not extend '" + (class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory).getName() + "' as loaded by this classloader.");
               ...
               if (classLoader == thisClassLoader) {
                  ...
                  msg.append((class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory).getName());
                  msg.append("'. ");
         ...
         return logFactoryClass != null && !(class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory).isAssignableFrom(logFactoryClass) ? new LogConfigurationException("The chosen LogFactory implementation does not extend LogFactory. Please check your configuration.", var9) : new LogConfigurationException(var9);
      }
   }
      ...
      if (logFactoryClass != null) {
         try {
            ...
            if (logFactoryClassLoader == null) {
               ...
               Class factoryFromCustomLoader = Class.forName("com.bea.core.repackaged.apache.commons.logging.LogFactory", false, logFactoryClassLoader);
   ...
   private static PrintStream initDiagnostics() {
      String dest;
      try {
         dest = getSystemProperty("com.bea.core.repackaged.apache.commons.logging.diagnostics.dest", (String)null);
         if (dest == null) {
            return null;
         }
      } catch (SecurityException var3) {
   ...
   static {
      thisClassLoader = getClassLoader(class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory);
      ...
      logClassLoaderEnvironment(class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory);
