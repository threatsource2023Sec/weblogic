...
public class Log4JLogger implements Log, Serializable {
   ...
   // $FF: synthetic field
   static Class class$com$bea$core$repackaged$apache$commons$logging$impl$Log4JLogger;
   // $FF: synthetic field
   ...
   static {
      FQCN = (class$com$bea$core$repackaged$apache$commons$logging$impl$Log4JLogger == null ? (class$com$bea$core$repackaged$apache$commons$logging$impl$Log4JLogger = class$("com.bea.core.repackaged.apache.commons.logging.impl.Log4JLogger")) : class$com$bea$core$repackaged$apache$commons$logging$impl$Log4JLogger).getName();
