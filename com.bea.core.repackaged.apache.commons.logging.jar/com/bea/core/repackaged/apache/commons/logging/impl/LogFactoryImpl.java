...
public class LogFactoryImpl extends LogFactory {
   private static final String LOGGING_IMPL_LOG4J_LOGGER = "com.bea.core.repackaged.apache.commons.logging.impl.Log4JLogger";
   private static final String LOGGING_IMPL_JDK14_LOGGER = "com.bea.core.repackaged.apache.commons.logging.impl.Jdk14Logger";
   private static final String LOGGING_IMPL_LUMBERJACK_LOGGER = "com.bea.core.repackaged.apache.commons.logging.impl.Jdk13LumberjackLogger";
   private static final String LOGGING_IMPL_SIMPLE_LOGGER = "com.bea.core.repackaged.apache.commons.logging.impl.SimpleLog";
   private static final String PKG_IMPL = "com.bea.core.repackaged.apache.commons.logging.impl.";
   private static final int PKG_LEN = "com.bea.core.repackaged.apache.commons.logging.impl.".length();
   public static final String LOG_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.Log";
   protected static final String LOG_PROPERTY_OLD = "com.bea.core.repackaged.apache.commons.logging.log";
   public static final String ALLOW_FLAWED_CONTEXT_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedContext";
   public static final String ALLOW_FLAWED_DISCOVERY_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedDiscovery";
   public static final String ALLOW_FLAWED_HIERARCHY_PROPERTY = "com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedHierarchy";
   private static final String[] classesToDiscover = new String[]{"com.bea.core.repackaged.apache.commons.logging.impl.Log4JLogger", "com.bea.core.repackaged.apache.commons.logging.impl.Jdk14Logger", "com.bea.core.repackaged.apache.commons.logging.impl.Jdk13LumberjackLogger", "com.bea.core.repackaged.apache.commons.logging.impl.SimpleLog"};
   ...
   // $FF: synthetic field
   static Class class$com$bea$core$repackaged$apache$commons$logging$LogFactory;
   // $FF: synthetic field
   static Class class$com$bea$core$repackaged$apache$commons$logging$impl$LogFactoryImpl;
   // $FF: synthetic field
   static Class class$com$bea$core$repackaged$apache$commons$logging$Log;
   ...
   public LogFactoryImpl() {
      ...
      this.logMethod = null;
      this.logMethodSignature = new Class[]{class$com$bea$core$repackaged$apache$commons$logging$LogFactory == null ? (class$com$bea$core$repackaged$apache$commons$logging$LogFactory = class$("com.bea.core.repackaged.apache.commons.logging.LogFactory")) : class$com$bea$core$repackaged$apache$commons$logging$LogFactory};
   ...
   protected boolean isJdk13LumberjackAvailable() {
      return this.isLogLibraryAvailable("Jdk13Lumberjack", "com.bea.core.repackaged.apache.commons.logging.impl.Jdk13LumberjackLogger");
   }

   /** @deprecated */
   protected boolean isJdk14Available() {
      return this.isLogLibraryAvailable("Jdk14", "com.bea.core.repackaged.apache.commons.logging.impl.Jdk14Logger");
   }

   /** @deprecated */
   protected boolean isLog4JAvailable() {
      return this.isLogLibraryAvailable("Log4J", "com.bea.core.repackaged.apache.commons.logging.impl.Log4JLogger");
   }
   ...
   private void initConfiguration() {
      this.allowFlawedContext = this.getBooleanConfiguration("com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedContext", true);
      this.allowFlawedDiscovery = this.getBooleanConfiguration("com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedDiscovery", true);
      this.allowFlawedHierarchy = this.getBooleanConfiguration("com.bea.core.repackaged.apache.commons.logging.Log.allowFlawedHierarchy", true);
   }
   ...
   private Log discoverLogImplementation(String logCategory) throws LogConfigurationException {
      ...
      if (specifiedLogClassName != null) {
         ...
         if (result == null) {
            ...
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.bea.core.repackaged.apache.commons.logging.impl.Log4JLogger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.bea.core.repackaged.apache.commons.logging.impl.Jdk14Logger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.bea.core.repackaged.apache.commons.logging.impl.Jdk13LumberjackLogger");
            this.informUponSimilarName(messageBuffer, specifiedLogClassName, "com.bea.core.repackaged.apache.commons.logging.impl.SimpleLog");
   ...
   private String findUserSpecifiedLogClassName() {
      ...
      String specifiedClass = (String)this.getAttribute("com.bea.core.repackaged.apache.commons.logging.Log");
      if (specifiedClass == null) {
         if (isDiagnosticsEnabled()) {
            this.logDiagnostic("Trying to get log class from attribute 'org.apache.commons.logging.log'");
         }

         specifiedClass = (String)this.getAttribute("com.bea.core.repackaged.apache.commons.logging.log");
      }
      ...
      if (specifiedClass == null) {
         ...
         try {
            specifiedClass = getSystemProperty("com.bea.core.repackaged.apache.commons.logging.Log", (String)null);
         } catch (SecurityException var4) {
            if (isDiagnosticsEnabled()) {
   ...
   private ClassLoader getBaseClassLoader() throws LogConfigurationException {
      ClassLoader thisClassLoader = getClassLoader(class$com$bea$core$repackaged$apache$commons$logging$impl$LogFactoryImpl == null ? (class$com$bea$core$repackaged$apache$commons$logging$impl$LogFactoryImpl = class$("com.bea.core.repackaged.apache.commons.logging.impl.LogFactoryImpl")) : class$com$bea$core$repackaged$apache$commons$logging$impl$LogFactoryImpl);
      if (!this.useTCCL) {
   ...
   private void handleFlawedHierarchy(ClassLoader badClassLoader, Class badClass) throws LogConfigurationException {
      ...
      String logInterfaceName = (class$com$bea$core$repackaged$apache$commons$logging$Log == null ? (class$com$bea$core$repackaged$apache$commons$logging$Log = class$("com.bea.core.repackaged.apache.commons.logging.Log")) : class$com$bea$core$repackaged$apache$commons$logging$Log).getName();
      ...
      if (implementsLog) {
         if (isDiagnosticsEnabled()) {
            try {
               ClassLoader logInterfaceClassLoader = getClassLoader(class$com$bea$core$repackaged$apache$commons$logging$Log == null ? (class$com$bea$core$repackaged$apache$commons$logging$Log = class$("com.bea.core.repackaged.apache.commons.logging.Log")) : class$com$bea$core$repackaged$apache$commons$logging$Log);
         ...
         if (!this.allowFlawedHierarchy) {
            ...
            msg.append((class$com$bea$core$repackaged$apache$commons$logging$Log == null ? (class$com$bea$core$repackaged$apache$commons$logging$Log = class$("com.bea.core.repackaged.apache.commons.logging.Log")) : class$com$bea$core$repackaged$apache$commons$logging$Log).getName());
            msg.append("' visible.");
            if (isDiagnosticsEnabled()) {
