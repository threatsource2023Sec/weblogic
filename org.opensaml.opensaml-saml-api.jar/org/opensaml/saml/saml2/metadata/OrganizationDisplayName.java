...
public interface OrganizationDisplayName extends LocalizedName {
   String DEFAULT_ELEMENT_LOCAL_NAME = "OrganizationDisplayName";
   QName DEFAULT_ELEMENT_NAME = new QName("urn:oasis:names:tc:SAML:2.0:metadata", "OrganizationDisplayName", "md");
