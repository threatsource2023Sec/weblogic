...
public class DiagnosticDbstoreArchiveRuntimeBeanInfo extends DiagnosticEditableArchiveRuntimeBeanInfo {
   ...
   public DiagnosticDbstoreArchiveRuntimeBeanInfo(boolean readOnly, String targetVersion) throws IntrospectionException {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.diagnostics.archive.DiagnosticDbstoreArchiveRuntime");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("DataRetirementCycles")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DataRetirementCycles", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (BeanInfoHelper.isVersionCompliant("12.2.1.0.0", (String)null, this.targetVersion) && !descriptors.containsKey("DataRetirementTasks")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DataRetirementTasks", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DataRetirementTotalTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DataRetirementTotalTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("DeletionCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeletionCount", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("DeletionCount", currentResult);
         currentResult.setValue("description", "<p>The number of records deleted from the archive since this server was started.</p> ");
      ...
      if (!descriptors.containsKey("DeletionTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("DeletionTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("DeletionTime", currentResult);
         currentResult.setValue("description", "<p>The time, in milliseconds, spent deleting records from the archive since this server was started.</p> ");
         currentResult.setValue("owner", "");
      }
      ...
      if (!descriptors.containsKey("InsertionCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("InsertionCount", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("InsertionCount", currentResult);
         currentResult.setValue("description", "<p>The number of new records inserted in the archive since this server was started.</p> ");
         currentResult.setValue("owner", "");
      }
      ...
      if (!descriptors.containsKey("InsertionTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("InsertionTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
         descriptors.put("InsertionTime", currentResult);
         currentResult.setValue("description", "<p>The time, in milliseconds, spent inserting records into the archive since this server was started.</p> ");
         currentResult.setValue("owner", "");
      }
      ...
      if (!descriptors.containsKey("LastDataRetirementStartTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastDataRetirementStartTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("LastDataRetirementTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("LastDataRetirementTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RecordRetrievalTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RecordRetrievalTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RecordSeekCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RecordSeekCount", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RecordSeekTime")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RecordSeekTime", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RetiredRecordCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RetiredRecordCount", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
      ...
      if (!descriptors.containsKey("RetrievedRecordCount")) {
         ...
         setterName = null;
         currentResult = new PropertyDescriptor("RetrievedRecordCount", DbstoreArchiveRuntimeMBean.class, getterName, (String)setterName);
   ...
   private void fillinOperationMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = DbstoreArchiveRuntimeMBean.class.getMethod("performRetirement");
      ...
      mth = DbstoreArchiveRuntimeMBean.class.getMethod("purgeDataRetirementTasks", Long.TYPE);
