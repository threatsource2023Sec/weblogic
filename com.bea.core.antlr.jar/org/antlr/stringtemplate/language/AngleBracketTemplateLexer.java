   ...
   public final void mACTION(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (this.LA(1) == '<' && this.LA(2) == '\\' && this.LA(3) == '\\' && this.LA(4) == '>' && _tokenSet_2.member(this.LA(5))) {
         ...
         if (this.LA(1) == '<' && this.LA(2) == '\\' && _tokenSet_3.member(this.LA(3)) && _tokenSet_4.member(this.LA(4))) {
            ...
            if (this.LA(1) != '<' || !_tokenSet_5.member(this.LA(2)) || this.LA(3) < 1 || this.LA(3) > '\ufffe') {
               throw new NoViableAltForCharException(this.LA(1), this.getFilename(), this.getLine(), this.getColumn());
            }

            if (this.LA(1) == '<' && this.LA(2) == 'i' && this.LA(3) == 'f' && (this.LA(4) == ' ' || this.LA(4) == '(') && _tokenSet_6.member(this.LA(5)) && this.LA(6) >= 1 && this.LA(6) <= '\ufffe' && this.LA(7) >= 1 && this.LA(7) <= '\ufffe') {
               _saveIndex = this.text.length();
               this.match('<');
               this.text.setLength(_saveIndex);
               this.match("if");
            ...
            } else if (this.LA(1) == '<' && this.LA(2) == '@' && _tokenSet_7.member(this.LA(3)) && this.LA(4) >= 1 && this.LA(4) <= '\ufffe' && this.LA(5) >= 1 && this.LA(5) <= '\ufffe' && this.LA(6) >= 1 && this.LA(6) <= '\ufffe') {
               _saveIndex = this.text.length();
               this.match('<');
               this.text.setLength(_saveIndex);
               _saveIndex = this.text.length();
               ...
               int _cnt29;
               for(_cnt29 = 0; _tokenSet_7.member(this.LA(1)); ++_cnt29) {
               ...
               switch (this.LA(1)) {
                  ...
                  case '>':
                     ...
                     for(_cnt36 = 0; this.LA(1) >= 1 && this.LA(1) <= '\ufffe' && this.LA(2) >= 1 && this.LA(2) <= '\ufffe' && !this.upcomingAtEND(1) && (!this.upcomingNewline(1) || !this.upcomingAtEND(2)); ++_cnt36) {
   ...
   protected final void mEXPR(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      while(true) {
         label97: {
            ...
            if ((this.LA(1) == '+' || this.LA(1) == '=') && (this.LA(2) == '"' || this.LA(2) == '<')) {
            ...
            } else if ((this.LA(1) == '+' || this.LA(1) == '=') && this.LA(2) == '{') {
               switch (this.LA(1)) {
                  case '+':
                     this.match('+');
                     break;
               ...
               this.mSUBTEMPLATE(false);
            } else if ((this.LA(1) == '+' || this.LA(1) == '=') && _tokenSet_9.member(this.LA(2))) {
               switch (this.LA(1)) {
                  case '+':
                     this.match('+');
                     break;
