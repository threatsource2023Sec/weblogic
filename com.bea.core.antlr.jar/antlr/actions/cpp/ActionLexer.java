   ...
   protected final void mAST_ITEM(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      if (this.LA(1) == '#' && this.LA(2) == '(') {
         ...
         if (this.LA(1) == '#' && _tokenSet_3.member(this.LA(2))) {
            ...
            } else if (var9.equals("if") || var9.equals("define") || var9.equals("ifdef") || var9.equals("ifndef") || var9.equals("else") || var9.equals("elif") || var9.equals("endif") || var9.equals("warning") || var9.equals("error") || var9.equals("ident") || var9.equals("pragma") || var9.equals("include")) {
               this.text.setLength(var4);
         ...
         if (this.LA(1) == 'T' && this.LA(2) == 'e') {
            ...
            switch (this.LA(1)) {
               ...
               case '(':
                  ...
                  var7 = this._returnToken;
                  this.match(')');
                  var12 = "{ text.erase(_begin); text += " + var7.getText() + "; }";
                  this.text.setLength(var4);
                  this.text.append(var12);
                  break;
               default:
   ...
   protected final void mTREE(boolean var1) throws RecognitionException, CharStreamException, TokenStreamException {
      ...
      switch (this.LA(1)) {
         ...
         case 'z':
            ...
            this.text.setLength(var5);
            var6 = this._returnToken;
            var10.appendElement(this.generator.processStringForASTConstructor(var6.getText()));
            switch (this.LA(1)) {
               case '\t':
               case '\n':
               case '\r':
               ...
               case ',':
                  while(this.LA(1) == ',') {
                     ...
                     this.text.setLength(var5);
                     var7 = this._returnToken;
                     var10.appendElement(this.generator.processStringForASTConstructor(var7.getText()));
                     switch (this.LA(1)) {
                        case '\t':
                        case '\n':
                        case '\r':
               ...
               case ']':
                  switch (this.LA(1)) {
                     ...
                     case ']':
                        ...
                        this.match(']');
                        this.text.setLength(var5);
                        String var8 = this.generator.processStringForASTConstructor(var6.getText());
                        if (var7 != null) {
