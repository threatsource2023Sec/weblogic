...
public class ConnectionPropertiesBeanDConfig extends BasicDConfigBean {
   ...
   public ConnectionPropertiesBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ConnectionPropertiesBean)btn;
      this.beanTree = btn;
   ...
   public void setDriverClassName(String value) {
      this.beanTreeNode.setDriverClassName(value);
