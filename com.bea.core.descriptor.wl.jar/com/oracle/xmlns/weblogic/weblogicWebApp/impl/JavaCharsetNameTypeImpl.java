...
public class JavaCharsetNameTypeImpl extends JavaStringHolderEx implements JavaCharsetNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JavaCharsetNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JavaCharsetNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
