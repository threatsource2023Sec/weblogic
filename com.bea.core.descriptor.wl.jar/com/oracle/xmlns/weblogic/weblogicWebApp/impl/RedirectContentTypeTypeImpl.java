...
public class RedirectContentTypeTypeImpl extends JavaStringHolderEx implements RedirectContentTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RedirectContentTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RedirectContentTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
