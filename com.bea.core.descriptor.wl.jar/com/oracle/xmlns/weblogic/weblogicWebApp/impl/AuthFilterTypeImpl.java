...
public class AuthFilterTypeImpl extends JavaStringHolderEx implements AuthFilterType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public AuthFilterTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected AuthFilterTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
