...
public class WlDispatchPolicyTypeImpl extends JavaStringHolderEx implements WlDispatchPolicyType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WlDispatchPolicyTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WlDispatchPolicyTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
