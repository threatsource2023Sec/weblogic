...
public class IanaCharsetNameTypeImpl extends JavaStringHolderEx implements IanaCharsetNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public IanaCharsetNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected IanaCharsetNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
