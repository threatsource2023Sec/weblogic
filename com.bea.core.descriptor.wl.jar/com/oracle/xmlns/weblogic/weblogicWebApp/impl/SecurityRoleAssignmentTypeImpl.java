...
public class SecurityRoleAssignmentTypeImpl extends XmlComplexContentImpl implements SecurityRoleAssignmentType {
   ...
   private static final QName ROLENAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "role-name");
   private static final QName PRINCIPALNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "principal-name");
   private static final QName EXTERNALLYDEFINED$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "externally-defined");
