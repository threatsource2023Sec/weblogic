...
public class DefaultMimeTypeTypeImpl extends JavaStringHolderEx implements DefaultMimeTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DefaultMimeTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DefaultMimeTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
