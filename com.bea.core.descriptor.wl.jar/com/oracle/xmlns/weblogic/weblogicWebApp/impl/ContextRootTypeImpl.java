...
public class ContextRootTypeImpl extends JavaStringHolderEx implements ContextRootType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ContextRootTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ContextRootTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
