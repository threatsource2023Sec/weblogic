...
import com.oracle.xmlns.weblogic.weblogicWebApp.ParamNameType;
import javax.xml.namespace.QName;

public class ParamNameTypeImpl extends JavaStringHolderEx implements ParamNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ParamNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ParamNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
