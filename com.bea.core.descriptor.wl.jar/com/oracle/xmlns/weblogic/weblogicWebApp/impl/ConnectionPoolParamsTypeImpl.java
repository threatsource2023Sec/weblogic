...
import com.oracle.xmlns.weblogic.weblogicWebApp.ConnectionPoolParamsType;
...
public class ConnectionPoolParamsTypeImpl extends XmlComplexContentImpl implements ConnectionPoolParamsType {
   ...
   private static final QName INITIALCAPACITY$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "initial-capacity");
   private static final QName MAXCAPACITY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "max-capacity");
   private static final QName CAPACITYINCREMENT$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "capacity-increment");
   private static final QName SHRINKINGENABLED$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "shrinking-enabled");
   private static final QName SHRINKFREQUENCYSECONDS$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "shrink-frequency-seconds");
   private static final QName HIGHESTNUMWAITERS$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "highest-num-waiters");
   private static final QName HIGHESTNUMUNAVAILABLE$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "highest-num-unavailable");
   private static final QName CONNECTIONCREATIONRETRYFREQUENCYSECONDS$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "connection-creation-retry-frequency-seconds");
   private static final QName CONNECTIONRESERVETIMEOUTSECONDS$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "connection-reserve-timeout-seconds");
   private static final QName TESTFREQUENCYSECONDS$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "test-frequency-seconds");
   private static final QName TESTCONNECTIONSONCREATE$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "test-connections-on-create");
   private static final QName TESTCONNECTIONSONRELEASE$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "test-connections-on-release");
   private static final QName TESTCONNECTIONSONRESERVE$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "test-connections-on-reserve");
   private static final QName PROFILEHARVESTFREQUENCYSECONDS$26 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "profile-harvest-frequency-seconds");
   private static final QName IGNOREINUSECONNECTIONSENABLED$28 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "ignore-in-use-connections-enabled");
