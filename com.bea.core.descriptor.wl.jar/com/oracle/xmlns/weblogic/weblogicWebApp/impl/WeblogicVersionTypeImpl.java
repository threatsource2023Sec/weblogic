...
public class WeblogicVersionTypeImpl extends JavaStringHolderEx implements WeblogicVersionType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WeblogicVersionTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WeblogicVersionTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
