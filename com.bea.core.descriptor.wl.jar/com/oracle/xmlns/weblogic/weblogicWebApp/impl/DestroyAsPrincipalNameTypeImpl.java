...
public class DestroyAsPrincipalNameTypeImpl extends JavaStringHolderEx implements DestroyAsPrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DestroyAsPrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DestroyAsPrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
