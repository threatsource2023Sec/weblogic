...
public class LibraryRefTypeImpl extends XmlComplexContentImpl implements LibraryRefType {
   ...
   private static final QName LIBRARYNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "library-name");
   private static final QName SPECIFICATIONVERSION$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "specification-version");
   private static final QName IMPLEMENTATIONVERSION$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "implementation-version");
   private static final QName EXACTMATCH$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "exact-match");
   private static final QName CONTEXTROOT$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "context-root");
