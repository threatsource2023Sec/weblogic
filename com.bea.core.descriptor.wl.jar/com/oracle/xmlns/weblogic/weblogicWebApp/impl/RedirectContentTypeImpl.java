...
public class RedirectContentTypeImpl extends JavaStringHolderEx implements RedirectContentType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RedirectContentTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RedirectContentTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
