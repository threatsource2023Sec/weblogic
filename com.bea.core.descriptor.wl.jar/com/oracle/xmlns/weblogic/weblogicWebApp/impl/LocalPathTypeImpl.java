...
public class LocalPathTypeImpl extends JavaStringHolderEx implements LocalPathType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public LocalPathTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected LocalPathTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
