...
public class ResourcePathTypeImpl extends JavaStringHolderEx implements ResourcePathType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResourcePathTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResourcePathTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
