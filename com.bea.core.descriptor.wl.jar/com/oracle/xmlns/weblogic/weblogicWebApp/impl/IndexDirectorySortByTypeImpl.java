...
public class IndexDirectorySortByTypeImpl extends JavaStringHolderEx implements IndexDirectorySortByType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public IndexDirectorySortByTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected IndexDirectorySortByTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
