...
public interface SecurityPermissionType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SecurityPermissionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("securitypermissiontype6d3dtype");

   com.sun.java.xml.ns.javaee.DescriptionType getDescription();

   boolean isSetDescription();

   void setDescription(com.sun.java.xml.ns.javaee.DescriptionType var1);
