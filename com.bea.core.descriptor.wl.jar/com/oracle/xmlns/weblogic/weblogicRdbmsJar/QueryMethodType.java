...
public interface QueryMethodType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(QueryMethodType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("querymethodtype76b5type");
   ...
   public static final class Factory {
      ...
      public static QueryMethodType parse(String xmlAsString) throws XmlException {
         return (QueryMethodType)XmlBeans.getContextTypeLoader().parse(xmlAsString, QueryMethodType.type, (XmlOptions)null);
      }

      public static QueryMethodType parse(String xmlAsString, XmlOptions options) throws XmlException {
