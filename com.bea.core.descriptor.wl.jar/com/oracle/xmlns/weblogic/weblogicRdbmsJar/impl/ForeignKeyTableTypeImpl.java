...
public class ForeignKeyTableTypeImpl extends JavaStringHolderEx implements ForeignKeyTableType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ForeignKeyTableTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ForeignKeyTableTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
