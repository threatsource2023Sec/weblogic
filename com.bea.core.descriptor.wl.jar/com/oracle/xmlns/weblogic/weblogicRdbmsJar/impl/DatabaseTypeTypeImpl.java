...
public class DatabaseTypeTypeImpl extends JavaStringHolderEx implements DatabaseTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DatabaseTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DatabaseTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
