...
public class InstanceLockOrderTypeImpl extends JavaStringHolderEx implements InstanceLockOrderType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public InstanceLockOrderTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected InstanceLockOrderTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
