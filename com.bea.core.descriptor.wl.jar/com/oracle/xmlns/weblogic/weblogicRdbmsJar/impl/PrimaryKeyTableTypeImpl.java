...
public class PrimaryKeyTableTypeImpl extends JavaStringHolderEx implements PrimaryKeyTableType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PrimaryKeyTableTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PrimaryKeyTableTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
