...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.DefaultResourcePrincipalType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.ResourceDescriptionType;
...
public class ResourceDescriptionTypeImpl extends XmlComplexContentImpl implements ResourceDescriptionType {
   ...
   private static final QName RESREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "res-ref-name");
   private static final QName JNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "jndi-name");
   private static final QName RESOURCELINK$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "resource-link");
   private static final QName DEFAULTRESOURCEPRINCIPAL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "default-resource-principal");
