...
public class OptimisticColumnTypeImpl extends JavaStringHolderEx implements OptimisticColumnType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public OptimisticColumnTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected OptimisticColumnTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
