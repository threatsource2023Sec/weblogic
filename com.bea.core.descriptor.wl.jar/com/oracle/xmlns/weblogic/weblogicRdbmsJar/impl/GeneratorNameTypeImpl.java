...
public class GeneratorNameTypeImpl extends JavaStringHolderEx implements GeneratorNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public GeneratorNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected GeneratorNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
