...
public class CdiDescriptorTypeImpl extends XmlComplexContentImpl implements CdiDescriptorType {
   ...
   private static final QName POJOANNOTATIONENABLED$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "pojo-annotation-enabled");
   private static final QName IMPLICITBEANDISCOVERYENABLED$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "implicit-bean-discovery-enabled");
   private static final QName POLICY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "policy");
