...
public class GeneratorTypeTypeImpl extends JavaStringHolderEx implements GeneratorTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public GeneratorTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected GeneratorTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
