...
public class DelayDatabaseInsertUntilTypeImpl extends JavaStringHolderEx implements DelayDatabaseInsertUntilType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DelayDatabaseInsertUntilTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DelayDatabaseInsertUntilTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
