...
public class VerifyColumnsTypeImpl extends JavaStringHolderEx implements VerifyColumnsType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public VerifyColumnsTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected VerifyColumnsTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
