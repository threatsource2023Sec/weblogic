...
public class DefaultDbmsTablesDdlTypeImpl extends JavaStringHolderEx implements DefaultDbmsTablesDdlType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DefaultDbmsTablesDdlTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DefaultDbmsTablesDdlTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
