...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.OwsmPolicyType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.PortInfoType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.PropertyNamevalueType;
...
public class PortInfoTypeImpl extends XmlComplexContentImpl implements PortInfoType {
   ...
   private static final QName PORTNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "port-name");
   private static final QName STUBPROPERTY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "stub-property");
   private static final QName CALLPROPERTY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "call-property");
   private static final QName WSATCONFIG$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "wsat-config");
   private static final QName OWSMPOLICY$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "owsm-policy");
   private static final QName OPERATION$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "operation");
