...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.SecurityPermissionType;
...
public class SecurityPermissionTypeImpl extends XmlComplexContentImpl implements SecurityPermissionType {
   ...
   private static final QName SECURITYPERMISSIONSPEC$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "security-permission-spec");
