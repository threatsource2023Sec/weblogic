...
public class RelationNameTypeImpl extends JavaStringHolderEx implements RelationNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RelationNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RelationNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
