...
public class VerifyRowsTypeImpl extends JavaStringHolderEx implements VerifyRowsType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public VerifyRowsTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected VerifyRowsTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
