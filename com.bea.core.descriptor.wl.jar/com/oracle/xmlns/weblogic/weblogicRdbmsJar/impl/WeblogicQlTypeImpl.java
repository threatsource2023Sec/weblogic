...
public class WeblogicQlTypeImpl extends JavaStringHolderEx implements WeblogicQlType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WeblogicQlTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WeblogicQlTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
