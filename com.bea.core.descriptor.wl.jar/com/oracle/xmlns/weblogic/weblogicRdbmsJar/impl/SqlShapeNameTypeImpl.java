...
public class SqlShapeNameTypeImpl extends JavaStringHolderEx implements SqlShapeNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public SqlShapeNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected SqlShapeNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
