...
public class UnknownPrimaryKeyFieldTypeImpl extends XmlComplexContentImpl implements UnknownPrimaryKeyFieldType {
   ...
   public UnknownPrimaryKeyFieldTypeImpl(SchemaType sType) {
      super(sType);
   }
