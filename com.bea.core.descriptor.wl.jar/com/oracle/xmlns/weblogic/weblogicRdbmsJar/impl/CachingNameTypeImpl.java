...
public class CachingNameTypeImpl extends JavaStringHolderEx implements CachingNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CachingNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CachingNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
