...
public class DbmsColumnTypeTypeImpl extends JavaStringHolderEx implements DbmsColumnTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DbmsColumnTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DbmsColumnTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
