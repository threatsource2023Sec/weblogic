...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "destination-resource-link");
