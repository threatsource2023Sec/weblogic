...
public class ForeignKeyColumnTypeImpl extends JavaStringHolderEx implements ForeignKeyColumnType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ForeignKeyColumnTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ForeignKeyColumnTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
