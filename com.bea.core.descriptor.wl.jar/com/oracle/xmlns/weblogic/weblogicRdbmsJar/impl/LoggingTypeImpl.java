...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.LoggingType;
...
public class LoggingTypeImpl extends XmlComplexContentImpl implements LoggingType {
   ...
   private static final QName LOGFILENAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "log-filename");
   private static final QName LOGGINGENABLED$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "logging-enabled");
   private static final QName ROTATIONTYPE$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "rotation-type");
   private static final QName NUMBEROFFILESLIMITED$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "number-of-files-limited");
   private static final QName FILECOUNT$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "file-count");
   private static final QName FILESIZELIMIT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "file-size-limit");
   private static final QName ROTATELOGONSTARTUP$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "rotate-log-on-startup");
   private static final QName LOGFILEROTATIONDIR$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "log-file-rotation-dir");
   private static final QName ROTATIONTIME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "rotation-time");
   private static final QName FILETIMESPAN$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "file-time-span");
   private static final QName DATEFORMATPATTERN$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "date-format-pattern");
