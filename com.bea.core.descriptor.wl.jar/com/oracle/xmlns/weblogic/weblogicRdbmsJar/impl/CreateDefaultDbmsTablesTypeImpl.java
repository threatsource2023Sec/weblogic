...
public class CreateDefaultDbmsTablesTypeImpl extends JavaStringHolderEx implements CreateDefaultDbmsTablesType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CreateDefaultDbmsTablesTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CreateDefaultDbmsTablesTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
