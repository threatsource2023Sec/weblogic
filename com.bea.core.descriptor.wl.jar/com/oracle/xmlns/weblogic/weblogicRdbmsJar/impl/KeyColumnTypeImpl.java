...
public class KeyColumnTypeImpl extends JavaStringHolderEx implements KeyColumnType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public KeyColumnTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected KeyColumnTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
