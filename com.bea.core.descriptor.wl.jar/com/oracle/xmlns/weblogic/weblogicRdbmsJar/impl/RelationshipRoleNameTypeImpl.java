...
public class RelationshipRoleNameTypeImpl extends JavaStringHolderEx implements RelationshipRoleNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RelationshipRoleNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RelationshipRoleNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
