...
public interface CmrFieldType extends XmlString {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CmrFieldType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("cmrfieldtypeb132type");
   ...
   public static final class Factory {
      ...
      public static CmrFieldType parse(String xmlAsString) throws XmlException {
         return (CmrFieldType)XmlBeans.getContextTypeLoader().parse(xmlAsString, CmrFieldType.type, (XmlOptions)null);
      }

      public static CmrFieldType parse(String xmlAsString, XmlOptions options) throws XmlException {
