...
public interface ValidateDbSchemaWithType extends XmlString {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ValidateDbSchemaWithType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("validatedbschemawithtype01f7type");
