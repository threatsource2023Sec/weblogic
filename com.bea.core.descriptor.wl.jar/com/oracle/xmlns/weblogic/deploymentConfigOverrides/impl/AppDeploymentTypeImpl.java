...
public class AppDeploymentTypeImpl extends XmlComplexContentImpl implements AppDeploymentType {
   ...
   private static final QName NAME$0 = new QName("http://xmlns.oracle.com/weblogic/deployment-config-overrides", "name");
   private static final QName SOURCEPATH$2 = new QName("http://xmlns.oracle.com/weblogic/deployment-config-overrides", "source-path");
   private static final QName RETIRETIMEOUT$4 = new QName("http://xmlns.oracle.com/weblogic/deployment-config-overrides", "retire-timeout");
   private static final QName GENERATEDVERSION$6 = new QName("http://xmlns.oracle.com/weblogic/deployment-config-overrides", "generated-version");
