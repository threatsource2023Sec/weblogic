...
public class VariableAssignmentTypeImpl extends XmlComplexContentImpl implements VariableAssignmentType {
   ...
   private static final QName NAME$2 = new QName("http://xmlns.oracle.com/weblogic/deployment-plan", "name");
   private static final QName XPATH$4 = new QName("http://xmlns.oracle.com/weblogic/deployment-plan", "xpath");
   private static final QName ORIGIN$6 = new QName("http://xmlns.oracle.com/weblogic/deployment-plan", "origin");
   private static final QName OPERATION$8 = new QName("http://xmlns.oracle.com/weblogic/deployment-plan", "operation");
