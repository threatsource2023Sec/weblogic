...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "destination-resource-link");
