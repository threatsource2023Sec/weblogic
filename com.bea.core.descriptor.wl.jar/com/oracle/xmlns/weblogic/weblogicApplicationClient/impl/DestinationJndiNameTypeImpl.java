...
public class DestinationJndiNameTypeImpl extends JavaStringHolderEx implements DestinationJndiNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DestinationJndiNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DestinationJndiNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
