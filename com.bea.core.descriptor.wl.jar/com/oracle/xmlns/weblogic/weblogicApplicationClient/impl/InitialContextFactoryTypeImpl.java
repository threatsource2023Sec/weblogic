...
public class InitialContextFactoryTypeImpl extends JavaStringHolderEx implements InitialContextFactoryType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public InitialContextFactoryTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected InitialContextFactoryTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
