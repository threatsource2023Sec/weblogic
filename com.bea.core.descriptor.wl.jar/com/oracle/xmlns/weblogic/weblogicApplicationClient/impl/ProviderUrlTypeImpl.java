...
public class ProviderUrlTypeImpl extends JavaStringHolderEx implements ProviderUrlType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ProviderUrlTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ProviderUrlTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
