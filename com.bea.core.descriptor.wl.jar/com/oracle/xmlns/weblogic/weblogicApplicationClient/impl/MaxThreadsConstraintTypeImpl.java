...
public class MaxThreadsConstraintTypeImpl extends XmlComplexContentImpl implements MaxThreadsConstraintType {
   ...
   private static final QName POOLNAME$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "pool-name");
   private static final QName QUEUESIZE$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "queue-size");
