...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.DefaultResourcePrincipalType;
...
public class ResourceDescriptionTypeImpl extends XmlComplexContentImpl implements ResourceDescriptionType {
   ...
   private static final QName RESREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "res-ref-name");
   private static final QName JNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "jndi-name");
   private static final QName RESOURCELINK$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "resource-link");
   private static final QName DEFAULTRESOURCEPRINCIPAL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "default-resource-principal");
