...
public class MessageDestinationNameTypeImpl extends JavaStringHolderEx implements MessageDestinationNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MessageDestinationNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MessageDestinationNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
