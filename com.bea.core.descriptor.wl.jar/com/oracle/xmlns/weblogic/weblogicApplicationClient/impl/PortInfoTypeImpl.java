...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.OperationInfoType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.OwsmPolicyType;
...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.WsatConfigType;
...
public class PortInfoTypeImpl extends XmlComplexContentImpl implements PortInfoType {
   ...
   private static final QName PORTNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "port-name");
   private static final QName STUBPROPERTY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "stub-property");
   private static final QName CALLPROPERTY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "call-property");
   private static final QName WSATCONFIG$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "wsat-config");
   private static final QName OWSMPOLICY$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "owsm-policy");
   private static final QName OPERATION$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "operation");
