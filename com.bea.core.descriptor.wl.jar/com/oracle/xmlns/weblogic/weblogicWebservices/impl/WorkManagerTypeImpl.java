...
import com.oracle.xmlns.weblogic.weblogicWebservices.CapacityType;
import com.oracle.xmlns.weblogic.weblogicWebservices.ContextRequestClassType;
import com.oracle.xmlns.weblogic.weblogicWebservices.DispatchPolicyType;
import com.oracle.xmlns.weblogic.weblogicWebservices.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicWebservices.MaxThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicWebservices.MinThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicWebservices.ResponseTimeRequestClassType;
import com.oracle.xmlns.weblogic.weblogicWebservices.WorkManagerShutdownTriggerType;
import com.oracle.xmlns.weblogic.weblogicWebservices.WorkManagerType;
...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "context-request-class");
   private static final QName REQUESTCLASSNAME$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "request-class-name");
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "ignore-stuck-threads");
