...
import com.oracle.xmlns.weblogic.weblogicWebservices.ManagedExecutorServiceType;
...
public class ManagedExecutorServiceTypeImpl extends XmlComplexContentImpl implements ManagedExecutorServiceType {
   ...
   private static final QName DISPATCHPOLICY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "dispatch-policy");
   private static final QName MAXCONCURRENTLONGRUNNINGREQUESTS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "max-concurrent-long-running-requests");
   private static final QName LONGRUNNINGPRIORITY$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "long-running-priority");
