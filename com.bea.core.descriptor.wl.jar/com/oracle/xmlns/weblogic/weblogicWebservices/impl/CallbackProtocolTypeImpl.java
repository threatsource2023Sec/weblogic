...
public class CallbackProtocolTypeImpl extends JavaStringEnumerationHolderEx implements CallbackProtocolType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CallbackProtocolTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CallbackProtocolTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
