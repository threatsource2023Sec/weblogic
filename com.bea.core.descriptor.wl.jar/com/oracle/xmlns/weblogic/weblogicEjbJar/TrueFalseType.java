...
public interface TrueFalseType extends XsdBooleanType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TrueFalseType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("truefalsetypebc1atype");
