...
public interface MethodType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(MethodType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("methodtype5997type");
   ...
   public static final class Factory {
      ...
      public static MethodType parse(String xmlAsString) throws XmlException {
         return (MethodType)XmlBeans.getContextTypeLoader().parse(xmlAsString, MethodType.type, (XmlOptions)null);
      }

      public static MethodType parse(String xmlAsString, XmlOptions options) throws XmlException {
