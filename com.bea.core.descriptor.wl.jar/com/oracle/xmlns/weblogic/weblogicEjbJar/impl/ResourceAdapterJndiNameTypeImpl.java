...
public class ResourceAdapterJndiNameTypeImpl extends JavaStringHolderEx implements ResourceAdapterJndiNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResourceAdapterJndiNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResourceAdapterJndiNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
