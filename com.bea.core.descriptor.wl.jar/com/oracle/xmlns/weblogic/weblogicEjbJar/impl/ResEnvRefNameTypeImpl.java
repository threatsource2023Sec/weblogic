...
import com.oracle.xmlns.weblogic.weblogicEjbJar.ResEnvRefNameType;
import javax.xml.namespace.QName;

public class ResEnvRefNameTypeImpl extends JavaStringHolderEx implements ResEnvRefNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResEnvRefNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResEnvRefNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
