...
public class IntegrityTypeImpl extends JavaStringHolderEx implements IntegrityType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public IntegrityTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected IntegrityTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
