...
public class IsModifiedMethodNameTypeImpl extends JavaStringHolderEx implements IsModifiedMethodNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public IsModifiedMethodNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected IsModifiedMethodNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
