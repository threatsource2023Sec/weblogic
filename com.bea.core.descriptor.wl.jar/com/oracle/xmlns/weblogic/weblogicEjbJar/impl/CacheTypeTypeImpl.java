...
public class CacheTypeTypeImpl extends JavaStringHolderEx implements CacheTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CacheTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CacheTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
