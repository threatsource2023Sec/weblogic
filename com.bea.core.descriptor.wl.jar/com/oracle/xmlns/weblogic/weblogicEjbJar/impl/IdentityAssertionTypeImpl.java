...
public class IdentityAssertionTypeImpl extends JavaStringHolderEx implements IdentityAssertionType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public IdentityAssertionTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected IdentityAssertionTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
