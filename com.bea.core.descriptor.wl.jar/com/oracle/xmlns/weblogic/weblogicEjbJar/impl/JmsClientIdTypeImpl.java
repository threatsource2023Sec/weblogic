...
public class JmsClientIdTypeImpl extends JavaStringHolderEx implements JmsClientIdType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JmsClientIdTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JmsClientIdTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
