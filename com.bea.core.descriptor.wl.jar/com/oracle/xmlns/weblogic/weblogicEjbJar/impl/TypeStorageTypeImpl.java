...
public class TypeStorageTypeImpl extends JavaStringHolderEx implements TypeStorageType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TypeStorageTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TypeStorageTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
