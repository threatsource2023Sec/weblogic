...
public class EntityCacheNameTypeImpl extends JavaStringHolderEx implements EntityCacheNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EntityCacheNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EntityCacheNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
