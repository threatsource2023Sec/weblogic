...
public class LoadAlgorithmTypeImpl extends JavaStringHolderEx implements LoadAlgorithmType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public LoadAlgorithmTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected LoadAlgorithmTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
