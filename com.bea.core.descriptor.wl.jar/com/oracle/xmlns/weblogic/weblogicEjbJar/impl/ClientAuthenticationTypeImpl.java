...
public class ClientAuthenticationTypeImpl extends JavaStringHolderEx implements ClientAuthenticationType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ClientAuthenticationTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ClientAuthenticationTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
