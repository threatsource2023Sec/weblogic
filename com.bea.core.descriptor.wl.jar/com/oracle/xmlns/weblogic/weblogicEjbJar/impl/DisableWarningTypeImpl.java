...
public class DisableWarningTypeImpl extends JavaStringHolderEx implements DisableWarningType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DisableWarningTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DisableWarningTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
