...
public class ClientCertAuthenticationTypeImpl extends JavaStringHolderEx implements ClientCertAuthenticationType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ClientCertAuthenticationTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ClientCertAuthenticationTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
