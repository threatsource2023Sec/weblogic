...
public class ConcurrencyStrategyTypeImpl extends JavaStringHolderEx implements ConcurrencyStrategyType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConcurrencyStrategyTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConcurrencyStrategyTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
