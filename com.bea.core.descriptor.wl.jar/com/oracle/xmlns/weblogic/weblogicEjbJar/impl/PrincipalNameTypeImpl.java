...
import com.oracle.xmlns.weblogic.weblogicEjbJar.PrincipalNameType;
import javax.xml.namespace.QName;

public class PrincipalNameTypeImpl extends JavaStringHolderEx implements PrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
