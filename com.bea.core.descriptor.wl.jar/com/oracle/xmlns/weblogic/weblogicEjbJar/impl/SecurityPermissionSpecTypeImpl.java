...
import com.oracle.xmlns.weblogic.weblogicEjbJar.SecurityPermissionSpecType;
import javax.xml.namespace.QName;

public class SecurityPermissionSpecTypeImpl extends JavaStringHolderEx implements SecurityPermissionSpecType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public SecurityPermissionSpecTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected SecurityPermissionSpecTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
