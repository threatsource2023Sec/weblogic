...
public class ReplicationTypeTypeImpl extends JavaStringHolderEx implements ReplicationTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ReplicationTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ReplicationTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
