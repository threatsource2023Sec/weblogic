...
public class InvalidationTargetTypeImpl extends XmlComplexContentImpl implements InvalidationTargetType {
   private static final long serialVersionUID = 1L;
   private static final QName EJBNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "ejb-name");
   private static final QName ID$2 = new QName("", "id");

   public InvalidationTargetTypeImpl(SchemaType sType) {
      super(sType);
   }
