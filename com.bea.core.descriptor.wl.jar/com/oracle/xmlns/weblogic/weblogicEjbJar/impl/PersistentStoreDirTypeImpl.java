...
public class PersistentStoreDirTypeImpl extends JavaStringHolderEx implements PersistentStoreDirType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PersistentStoreDirTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PersistentStoreDirTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
