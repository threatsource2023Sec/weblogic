...
public class CallRouterClassNameTypeImpl extends JavaStringHolderEx implements CallRouterClassNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CallRouterClassNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CallRouterClassNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
