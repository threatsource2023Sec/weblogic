...
public class CreateAsPrincipalNameTypeImpl extends JavaStringHolderEx implements CreateAsPrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CreateAsPrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CreateAsPrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
