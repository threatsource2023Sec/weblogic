...
public class TimerImplementationTypeImpl extends JavaStringHolderEx implements TimerImplementationType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TimerImplementationTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TimerImplementationTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
