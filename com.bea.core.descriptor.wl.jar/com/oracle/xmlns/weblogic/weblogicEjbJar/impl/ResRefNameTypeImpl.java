...
import com.oracle.xmlns.weblogic.weblogicEjbJar.ResRefNameType;
import javax.xml.namespace.QName;

public class ResRefNameTypeImpl extends JavaStringHolderEx implements ResRefNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResRefNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResRefNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
