...
public class DistributedDestinationConnectionTypeImpl extends JavaStringHolderEx implements DistributedDestinationConnectionType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DistributedDestinationConnectionTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DistributedDestinationConnectionTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
