...
public class IdempotentMethodsTypeImpl extends XmlComplexContentImpl implements IdempotentMethodsType {
   private static final long serialVersionUID = 1L;
   private static final QName METHOD$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "method");
   private static final QName ID$2 = new QName("", "id");

   public IdempotentMethodsTypeImpl(SchemaType sType) {
      super(sType);
   }
