...
public class PassivateAsPrincipalNameTypeImpl extends JavaStringHolderEx implements PassivateAsPrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PassivateAsPrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PassivateAsPrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
