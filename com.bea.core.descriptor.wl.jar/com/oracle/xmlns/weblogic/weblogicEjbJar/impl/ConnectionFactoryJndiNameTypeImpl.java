...
public class ConnectionFactoryJndiNameTypeImpl extends JavaStringHolderEx implements ConnectionFactoryJndiNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConnectionFactoryJndiNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConnectionFactoryJndiNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
