...
public class ConfidentialityTypeImpl extends JavaStringHolderEx implements ConfidentialityType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConfidentialityTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConfidentialityTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
