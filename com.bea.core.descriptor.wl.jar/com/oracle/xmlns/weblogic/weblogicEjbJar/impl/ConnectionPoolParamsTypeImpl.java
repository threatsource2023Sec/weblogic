...
import com.oracle.xmlns.weblogic.weblogicEjbJar.ConnectionPoolParamsType;
...
public class ConnectionPoolParamsTypeImpl extends XmlComplexContentImpl implements ConnectionPoolParamsType {
   ...
   private static final QName INITIALCAPACITY$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "initial-capacity");
   private static final QName MAXCAPACITY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "max-capacity");
   private static final QName CAPACITYINCREMENT$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "capacity-increment");
   private static final QName SHRINKINGENABLED$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "shrinking-enabled");
   private static final QName SHRINKFREQUENCYSECONDS$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "shrink-frequency-seconds");
   private static final QName HIGHESTNUMWAITERS$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "highest-num-waiters");
   private static final QName HIGHESTNUMUNAVAILABLE$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "highest-num-unavailable");
   private static final QName CONNECTIONCREATIONRETRYFREQUENCYSECONDS$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "connection-creation-retry-frequency-seconds");
   private static final QName CONNECTIONRESERVETIMEOUTSECONDS$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "connection-reserve-timeout-seconds");
   private static final QName TESTFREQUENCYSECONDS$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "test-frequency-seconds");
   private static final QName TESTCONNECTIONSONCREATE$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "test-connections-on-create");
   private static final QName TESTCONNECTIONSONRELEASE$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "test-connections-on-release");
   private static final QName TESTCONNECTIONSONRESERVE$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "test-connections-on-reserve");
   private static final QName PROFILEHARVESTFREQUENCYSECONDS$26 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "profile-harvest-frequency-seconds");
   private static final QName IGNOREINUSECONNECTIONSENABLED$28 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "ignore-in-use-connections-enabled");
