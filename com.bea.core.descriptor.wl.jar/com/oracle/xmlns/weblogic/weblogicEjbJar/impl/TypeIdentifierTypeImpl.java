...
public class TypeIdentifierTypeImpl extends JavaStringHolderEx implements TypeIdentifierType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TypeIdentifierTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TypeIdentifierTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
