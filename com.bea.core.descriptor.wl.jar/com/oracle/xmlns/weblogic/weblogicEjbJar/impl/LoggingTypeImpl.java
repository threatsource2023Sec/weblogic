...
import com.oracle.xmlns.weblogic.weblogicEjbJar.LoggingType;
...
public class LoggingTypeImpl extends XmlComplexContentImpl implements LoggingType {
   ...
   private static final QName LOGFILENAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "log-filename");
   private static final QName LOGGINGENABLED$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "logging-enabled");
   private static final QName ROTATIONTYPE$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "rotation-type");
   private static final QName NUMBEROFFILESLIMITED$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "number-of-files-limited");
   private static final QName FILECOUNT$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "file-count");
   private static final QName FILESIZELIMIT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "file-size-limit");
   private static final QName ROTATELOGONSTARTUP$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "rotate-log-on-startup");
   private static final QName LOGFILEROTATIONDIR$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "log-file-rotation-dir");
   private static final QName ROTATIONTIME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "rotation-time");
   private static final QName FILETIMESPAN$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "file-time-span");
   private static final QName DATEFORMATPATTERN$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "date-format-pattern");
