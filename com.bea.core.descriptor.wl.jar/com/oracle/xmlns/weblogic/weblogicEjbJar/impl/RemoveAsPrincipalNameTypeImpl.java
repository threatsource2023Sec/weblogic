...
public class RemoveAsPrincipalNameTypeImpl extends JavaStringHolderEx implements RemoveAsPrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RemoveAsPrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RemoveAsPrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
