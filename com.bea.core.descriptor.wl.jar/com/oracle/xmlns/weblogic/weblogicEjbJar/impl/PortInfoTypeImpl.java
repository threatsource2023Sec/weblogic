...
import com.oracle.xmlns.weblogic.weblogicEjbJar.OperationInfoType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.OwsmPolicyType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.PortInfoType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.PropertyNamevalueType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.WsatConfigType;
...
public class PortInfoTypeImpl extends XmlComplexContentImpl implements PortInfoType {
   ...
   private static final QName PORTNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "port-name");
   private static final QName STUBPROPERTY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "stub-property");
   private static final QName CALLPROPERTY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "call-property");
   private static final QName WSATCONFIG$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "wsat-config");
   private static final QName OWSMPOLICY$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "owsm-policy");
   private static final QName OPERATION$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "operation");
