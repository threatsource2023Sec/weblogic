...
import com.oracle.xmlns.weblogic.weblogicConnector.ContextCaseType;
import com.oracle.xmlns.weblogic.weblogicConnector.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicConnector.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName USERNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "user-name");
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "fair-share-request-class");
