...
import com.oracle.xmlns.weblogic.weblogicConnector.CapacityType;
import com.oracle.xmlns.weblogic.weblogicConnector.ContextRequestClassType;
import com.oracle.xmlns.weblogic.weblogicConnector.DispatchPolicyType;
import com.oracle.xmlns.weblogic.weblogicConnector.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicConnector.MaxThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicConnector.MinThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicConnector.ResponseTimeRequestClassType;
import com.oracle.xmlns.weblogic.weblogicConnector.WorkManagerShutdownTriggerType;
...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "context-request-class");
   private static final QName REQUESTCLASSNAME$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "request-class-name");
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "ignore-stuck-threads");
