...
public interface EjbNameType extends XmlString {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(EjbNameType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_wl_4_0_0_0").resolveHandle("ejbnametype259atype");
   ...
   public static final class Factory {
      ...
      public static EjbNameType parse(String xmlAsString) throws XmlException {
         return (EjbNameType)XmlBeans.getContextTypeLoader().parse(xmlAsString, EjbNameType.type, (XmlOptions)null);
      }

      public static EjbNameType parse(String xmlAsString, XmlOptions options) throws XmlException {
