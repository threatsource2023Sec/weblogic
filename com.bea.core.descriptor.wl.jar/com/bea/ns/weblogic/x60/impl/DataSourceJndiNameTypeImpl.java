...
public class DataSourceJndiNameTypeImpl extends JavaStringHolderEx implements DataSourceJndiNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DataSourceJndiNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DataSourceJndiNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
