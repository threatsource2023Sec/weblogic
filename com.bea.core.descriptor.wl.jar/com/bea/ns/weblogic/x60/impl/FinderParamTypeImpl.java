...
public class FinderParamTypeImpl extends JavaStringHolderEx implements FinderParamType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FinderParamTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FinderParamTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
