...
public class TableNameTypeImpl extends JavaStringHolderEx implements TableNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TableNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TableNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
