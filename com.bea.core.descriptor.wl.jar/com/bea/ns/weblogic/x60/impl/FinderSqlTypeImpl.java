...
public class FinderSqlTypeImpl extends JavaStringHolderEx implements FinderSqlType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FinderSqlTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FinderSqlTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
