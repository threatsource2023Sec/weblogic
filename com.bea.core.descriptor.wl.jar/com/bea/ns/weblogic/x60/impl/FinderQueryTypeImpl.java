...
public class FinderQueryTypeImpl extends JavaStringHolderEx implements FinderQueryType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FinderQueryTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FinderQueryTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
