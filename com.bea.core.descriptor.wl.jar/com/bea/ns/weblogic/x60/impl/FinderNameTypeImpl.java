...
public class FinderNameTypeImpl extends JavaStringHolderEx implements FinderNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FinderNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FinderNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
