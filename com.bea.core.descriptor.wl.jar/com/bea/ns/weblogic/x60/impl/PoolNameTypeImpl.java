...
public class PoolNameTypeImpl extends JavaStringHolderEx implements PoolNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PoolNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PoolNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
