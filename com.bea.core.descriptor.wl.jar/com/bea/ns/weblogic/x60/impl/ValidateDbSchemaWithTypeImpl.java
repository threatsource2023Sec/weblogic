...
public class ValidateDbSchemaWithTypeImpl extends JavaStringHolderEx implements ValidateDbSchemaWithType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ValidateDbSchemaWithTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ValidateDbSchemaWithTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
