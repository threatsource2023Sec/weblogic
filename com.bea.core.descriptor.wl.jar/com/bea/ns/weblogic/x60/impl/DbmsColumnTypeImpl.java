...
public class DbmsColumnTypeImpl extends JavaStringHolderEx implements DbmsColumnType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DbmsColumnTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DbmsColumnTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
