...
public class TopicBeanImpl extends DestinationBeanImpl implements TopicBean, Serializable {
   ...
   public TopicBeanImpl() {
      this._initializeProperty(-1);
   }

   public TopicBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public TopicBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DestinationBeanImpl.Helper {
      private TopicBeanImpl bean;

      protected Helper(TopicBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            TopicBeanImpl otherTyped = (TopicBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            TopicBeanImpl original = (TopicBeanImpl)event.getSourceBean();
            TopicBeanImpl proposed = (TopicBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            TopicBeanImpl copy = (TopicBeanImpl)initialCopy;
