...
public class SkipStateReplicationMethodsBeanImpl extends AbstractDescriptorBean implements SkipStateReplicationMethodsBean, Serializable {
   private String _Id;
   private MethodBean[] _Methods;
   private static SchemaHelper2 _schemaHelper;

   public SkipStateReplicationMethodsBeanImpl() {
      this._initializeProperty(-1);
   }

   public SkipStateReplicationMethodsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SkipStateReplicationMethodsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private SkipStateReplicationMethodsBeanImpl bean;

      protected Helper(SkipStateReplicationMethodsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Id")) {
            ...
            return propName.equals("Methods") ? 0 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SkipStateReplicationMethodsBeanImpl otherTyped = (SkipStateReplicationMethodsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SkipStateReplicationMethodsBeanImpl original = (SkipStateReplicationMethodsBeanImpl)event.getSourceBean();
            SkipStateReplicationMethodsBeanImpl proposed = (SkipStateReplicationMethodsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SkipStateReplicationMethodsBeanImpl copy = (SkipStateReplicationMethodsBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("Id")) && this.bean.isIdSet()) {
               copy.setId(this.bean.getId());
            }

            if ((excludeProps == null || !excludeProps.contains("Methods")) && this.bean.isMethodsSet() && !copy._isSet(0)) {
