...
public class AnnotationManifestBeanDConfig extends BasicDConfigBeanRoot {
   ...
   public AnnotationManifestBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (AnnotationManifestBean)btn;
      this.beanTree = btn;
   ...
   public AnnotationManifestBeanDConfig(DDBeanRoot root, WebLogicDeploymentConfiguration dc, DescriptorBean beanTree, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
      super(root, dc, name, ds);
      this.beanTree = beanTree;
      this.beanTreeNode = (AnnotationManifestBean)beanTree;
   ...
   public AnnotationManifestBeanDConfig(DDBeanRoot root, WebLogicDeploymentConfiguration dc, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
      super(root, dc, name, ds);
