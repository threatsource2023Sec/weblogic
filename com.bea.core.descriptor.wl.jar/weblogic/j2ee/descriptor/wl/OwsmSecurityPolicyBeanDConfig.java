...
public class OwsmSecurityPolicyBeanDConfig extends BasicDConfigBean {
   ...
   public OwsmSecurityPolicyBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (OwsmSecurityPolicyBean)btn;
      this.beanTree = btn;
