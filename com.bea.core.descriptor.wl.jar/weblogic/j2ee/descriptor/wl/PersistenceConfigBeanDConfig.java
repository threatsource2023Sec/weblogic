...
public class PersistenceConfigBeanDConfig extends BasicDConfigBean {
   ...
   public PersistenceConfigBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (PersistenceConfigBean)btn;
      this.beanTree = btn;
   ...
   public void setDefaultLogicalStoreName(String value) {
      this.beanTreeNode.setDefaultLogicalStoreName(value);
