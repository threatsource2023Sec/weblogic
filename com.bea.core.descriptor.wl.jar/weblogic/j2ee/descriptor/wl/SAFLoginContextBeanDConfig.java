...
public class SAFLoginContextBeanDConfig extends BasicDConfigBean {
   ...
   public SAFLoginContextBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (SAFLoginContextBean)btn;
      this.beanTree = btn;
   ...
   public void setLoginURL(String value) {
      this.beanTreeNode.setLoginURL(value);
