...
public class RetryMethodsOnRollbackBeanDConfig extends BasicDConfigBean {
   ...
   public RetryMethodsOnRollbackBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (RetryMethodsOnRollbackBean)btn;
      this.beanTree = btn;
