...
public class CoherenceClusterRefBeanDConfigBeanInfo extends SimpleBeanInfo {
   ...
   public PropertyDescriptor[] getPropertyDescriptors() {
      if (pds != null) {
         ...
         try {
            PropertyDescriptor pd = new PropertyDescriptor("CoherenceClusterName", Class.forName("weblogic.j2ee.descriptor.wl.CoherenceClusterRefBeanDConfig"), "getCoherenceClusterName", "setCoherenceClusterName");
