...
public class ColumnMapBeanDConfig extends BasicDConfigBean {
   ...
   public ColumnMapBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ColumnMapBean)btn;
      this.beanTree = btn;
   ...
   public void setForeignKeyColumn(String value) {
      this.beanTreeNode.setForeignKeyColumn(value);
   ...
   public void setKeyColumn(String value) {
      this.beanTreeNode.setKeyColumn(value);
