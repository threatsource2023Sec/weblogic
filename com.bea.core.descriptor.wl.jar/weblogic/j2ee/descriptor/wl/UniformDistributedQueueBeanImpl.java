...
public class UniformDistributedQueueBeanImpl extends UniformDistributedDestinationBeanImpl implements UniformDistributedQueueBean, Serializable {
   private int _ForwardDelay;
   private boolean _ResetDeliveryCountOnForward;
   private static SchemaHelper2 _schemaHelper;

   public UniformDistributedQueueBeanImpl() {
      this._initializeProperty(-1);
   }

   public UniformDistributedQueueBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public UniformDistributedQueueBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends UniformDistributedDestinationBeanImpl.Helper {
      private UniformDistributedQueueBeanImpl bean;

      protected Helper(UniformDistributedQueueBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            UniformDistributedQueueBeanImpl otherTyped = (UniformDistributedQueueBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            UniformDistributedQueueBeanImpl original = (UniformDistributedQueueBeanImpl)event.getSourceBean();
            UniformDistributedQueueBeanImpl proposed = (UniformDistributedQueueBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            UniformDistributedQueueBeanImpl copy = (UniformDistributedQueueBeanImpl)initialCopy;
