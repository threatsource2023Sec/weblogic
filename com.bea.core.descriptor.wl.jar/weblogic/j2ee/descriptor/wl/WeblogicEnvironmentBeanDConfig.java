...
public class WeblogicEnvironmentBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WeblogicEnvironmentBean beanTreeNode;

   public WeblogicEnvironmentBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WeblogicEnvironmentBean)btn;
      this.beanTree = btn;
