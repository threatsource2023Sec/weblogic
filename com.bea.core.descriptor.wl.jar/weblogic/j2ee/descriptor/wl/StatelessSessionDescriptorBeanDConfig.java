...
public class StatelessSessionDescriptorBeanDConfig extends BasicDConfigBean {
   ...
   public StatelessSessionDescriptorBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (StatelessSessionDescriptorBean)btn;
      this.beanTree = btn;
   ...
   public boolean isStatelessClusteringSet() {
      return this.beanTreeNode.isStatelessClusteringSet();
   }
