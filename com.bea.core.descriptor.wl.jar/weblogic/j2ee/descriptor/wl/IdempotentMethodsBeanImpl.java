...
public class IdempotentMethodsBeanImpl extends AbstractDescriptorBean implements IdempotentMethodsBean, Serializable {
   private String _Id;
   private MethodBean[] _Methods;
   private static SchemaHelper2 _schemaHelper;

   public IdempotentMethodsBeanImpl() {
      this._initializeProperty(-1);
   }

   public IdempotentMethodsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public IdempotentMethodsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private IdempotentMethodsBeanImpl bean;

      protected Helper(IdempotentMethodsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            IdempotentMethodsBeanImpl otherTyped = (IdempotentMethodsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            IdempotentMethodsBeanImpl original = (IdempotentMethodsBeanImpl)event.getSourceBean();
            IdempotentMethodsBeanImpl proposed = (IdempotentMethodsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            IdempotentMethodsBeanImpl copy = (IdempotentMethodsBeanImpl)initialCopy;
