...
public class ConfigResourceOverrideBeanDConfig extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ConfigResourceOverrideBean beanTreeNode;

   public ConfigResourceOverrideBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ConfigResourceOverrideBean)btn;
      this.beanTree = btn;
