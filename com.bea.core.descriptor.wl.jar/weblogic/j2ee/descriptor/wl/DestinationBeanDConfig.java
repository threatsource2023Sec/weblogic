...
public class DestinationBeanDConfig extends BasicDConfigBean {
   ...
   public DestinationBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DestinationBean)btn;
      this.beanTree = btn;
   ...
   public String getDCBProperties() {
      ...
      sb.append("JMSCreateDestinationIdentifier: ");
      sb.append(this.beanTreeNode.getJMSCreateDestinationIdentifier());
      sb.append("\n");
   ...
   public void setTemplate(TemplateBean value) {
      this.beanTreeNode.setTemplate(value);
   ...
   public void setJMSCreateDestinationIdentifier(String value) {
      this.beanTreeNode.setJMSCreateDestinationIdentifier(value);
