...
public class WebserviceAddressBeanDConfig extends BasicDConfigBean {
   ...
   public WebserviceAddressBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WebserviceAddressBean)btn;
      this.beanTree = btn;
   ...
   public void setWebserviceContextpath(String value) {
      this.beanTreeNode.setWebserviceContextpath(value);
   ...
   public void setWebserviceServiceuri(String value) {
      this.beanTreeNode.setWebserviceServiceuri(value);
