...
public class WeblogicWebservicesBeanDConfig extends BasicDConfigBeanRoot {
   ...
   public WeblogicWebservicesBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WeblogicWebservicesBean)btn;
      this.beanTree = btn;
   ...
   public WeblogicWebservicesBeanDConfig(DDBeanRoot root, WebLogicDeploymentConfiguration dc, DescriptorBean beanTree, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
      super(root, dc, name, ds);
      this.beanTree = beanTree;
      this.beanTreeNode = (WeblogicWebservicesBean)beanTree;
   ...
   public WeblogicWebservicesBeanDConfig(DDBeanRoot root, WebLogicDeploymentConfiguration dc, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
      super(root, dc, name, ds);
