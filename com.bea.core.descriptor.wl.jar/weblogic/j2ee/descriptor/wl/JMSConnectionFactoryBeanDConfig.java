...
public class JMSConnectionFactoryBeanDConfig extends BasicDConfigBean {
   ...
   public JMSConnectionFactoryBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (JMSConnectionFactoryBean)btn;
      this.beanTree = btn;
