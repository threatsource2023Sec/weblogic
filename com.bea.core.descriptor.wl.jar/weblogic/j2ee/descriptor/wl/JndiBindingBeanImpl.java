...
public class JndiBindingBeanImpl extends AbstractDescriptorBean implements JndiBindingBean, Serializable {
   private String _ClassName;
   private String _Id;
   private String _JndiName;
   private static SchemaHelper2 _schemaHelper;

   public JndiBindingBeanImpl() {
      this._initializeProperty(-1);
   }

   public JndiBindingBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public JndiBindingBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
      ...
      switch (s.length()) {
         case 10:
            if (s.equals("class-name")) {
               return info.compareXpaths(this._getPropertyXpath("class-name"));
            }
   ...
   public static class SchemaHelper2 extends AbstractSchemaHelper2 implements SchemaHelper {
      ...
      public String[] getKeyElementNames() {
         ...
         indices.add("class-name");
         return (String[])((String[])indices.toArray(new String[0]));
      }
   }

   protected static class Helper extends AbstractDescriptorBeanHelper {
      private JndiBindingBeanImpl bean;

      protected Helper(JndiBindingBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JndiBindingBeanImpl otherTyped = (JndiBindingBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JndiBindingBeanImpl original = (JndiBindingBeanImpl)event.getSourceBean();
            JndiBindingBeanImpl proposed = (JndiBindingBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JndiBindingBeanImpl copy = (JndiBindingBeanImpl)initialCopy;
