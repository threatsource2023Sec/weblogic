...
public class ConnectorWorkManagerBeanImpl extends AbstractDescriptorBean implements ConnectorWorkManagerBean, Serializable {
   private String _Id;
   private int _MaxConcurrentLongRunningRequests;
   private static SchemaHelper2 _schemaHelper;

   public ConnectorWorkManagerBeanImpl() {
      this._initializeProperty(-1);
   }

   public ConnectorWorkManagerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ConnectorWorkManagerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setMaxConcurrentLongRunningRequests(int param0) {
      LegalChecks.checkMin("MaxConcurrentLongRunningRequests", param0, 1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private ConnectorWorkManagerBeanImpl bean;

      protected Helper(ConnectorWorkManagerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Id")) {
            ...
            return propName.equals("MaxConcurrentLongRunningRequests") ? 0 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ConnectorWorkManagerBeanImpl otherTyped = (ConnectorWorkManagerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ConnectorWorkManagerBeanImpl original = (ConnectorWorkManagerBeanImpl)event.getSourceBean();
            ConnectorWorkManagerBeanImpl proposed = (ConnectorWorkManagerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ConnectorWorkManagerBeanImpl copy = (ConnectorWorkManagerBeanImpl)initialCopy;
