...
public class AnnotationManifestBeanImpl extends AbstractDescriptorBean implements AnnotationManifestBean, Serializable {
   ...
   public AnnotationManifestBeanImpl() {
      this._initializeRootBean(this.getDescriptor());
      this._initializeProperty(-1);
   }

   public AnnotationManifestBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeRootBean(this.getDescriptor());
      this._initializeProperty(-1);
   }

   public AnnotationManifestBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AnnotationManifestBeanImpl bean;

      protected Helper(AnnotationManifestBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AnnotationManifestBeanImpl otherTyped = (AnnotationManifestBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AnnotationManifestBeanImpl original = (AnnotationManifestBeanImpl)event.getSourceBean();
            AnnotationManifestBeanImpl proposed = (AnnotationManifestBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AnnotationManifestBeanImpl copy = (AnnotationManifestBeanImpl)initialCopy;
