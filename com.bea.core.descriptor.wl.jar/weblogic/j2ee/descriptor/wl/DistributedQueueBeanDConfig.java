...
public class DistributedQueueBeanDConfig extends BasicDConfigBean {
   ...
   public DistributedQueueBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (DistributedQueueBean)btn;
      this.beanTree = btn;
