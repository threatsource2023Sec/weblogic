...
public class WeblogicRdbmsRelationBeanDConfig extends BasicDConfigBean {
   ...
   public WeblogicRdbmsRelationBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WeblogicRdbmsRelationBean)btn;
      this.beanTree = btn;
   ...
   public void initKeyPropertyValue(String value) {
      this.setRelationName(value);
   }

   public String getDCBProperties() {
      StringBuffer sb = new StringBuffer();
      sb.append("RelationName: ");
      sb.append(this.beanTreeNode.getRelationName());
      sb.append("\n");
      return sb.toString();
   }
   ...
   public void setRelationName(String value) {
      this.beanTreeNode.setRelationName(value);
