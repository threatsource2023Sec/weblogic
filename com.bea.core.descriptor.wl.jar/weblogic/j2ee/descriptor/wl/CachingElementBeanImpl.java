...
public class CachingElementBeanImpl extends AbstractDescriptorBean implements CachingElementBean, Serializable {
   private CachingElementBean[] _CachingElements;
   private String _CmrField;
   private String _GroupName;
   private String _Id;
   private static SchemaHelper2 _schemaHelper;

   public CachingElementBeanImpl() {
      this._initializeProperty(-1);
   }

   public CachingElementBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public CachingElementBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setCmrField(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String _oldVal = this._CmrField;
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private CachingElementBeanImpl bean;

      protected Helper(CachingElementBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isCmrFieldSet()) {
               buf.append("CmrField");
               buf.append(String.valueOf(this.bean.getCmrField()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            CachingElementBeanImpl otherTyped = (CachingElementBeanImpl)other;
            this.computeChildDiff("CachingElements", this.bean.getCachingElements(), otherTyped.getCachingElements(), false);
            this.computeDiff("CmrField", this.bean.getCmrField(), otherTyped.getCmrField(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            CachingElementBeanImpl original = (CachingElementBeanImpl)event.getSourceBean();
            CachingElementBeanImpl proposed = (CachingElementBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               if (prop.equals("CachingElements")) {
                  ...
                  original.setCmrField(proposed.getCmrField());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            CachingElementBeanImpl copy = (CachingElementBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("CachingElements")) && this.bean.isCachingElementsSet() && !copy._isSet(2)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("CmrField")) && this.bean.isCmrFieldSet()) {
               copy.setCmrField(this.bean.getCmrField());
            }
