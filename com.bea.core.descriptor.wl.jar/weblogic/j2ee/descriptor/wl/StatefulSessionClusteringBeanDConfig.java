...
public class StatefulSessionClusteringBeanDConfig extends BasicDConfigBean {
   ...
   public StatefulSessionClusteringBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (StatefulSessionClusteringBean)btn;
      this.beanTree = btn;
   ...
   public void setReplicationType(String value) {
      this.beanTreeNode.setReplicationType(value);
   ...
   public void setPassivateDuringReplication(boolean value) {
      this.beanTreeNode.setPassivateDuringReplication(value);
   ...
   public void setCalculateDeltaUsingReflection(boolean value) {
      this.beanTreeNode.setCalculateDeltaUsingReflection(value);
