...
public class MethodBeanDConfig extends BasicDConfigBean {
   ...
   public MethodBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (MethodBean)btn;
      this.beanTree = btn;
   ...
   public void setMethodIntf(String value) {
      this.beanTreeNode.setMethodIntf(value);
