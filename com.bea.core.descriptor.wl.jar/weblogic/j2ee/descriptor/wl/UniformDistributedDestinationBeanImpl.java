...
public class UniformDistributedDestinationBeanImpl extends DestinationBeanImpl implements UniformDistributedDestinationBean, Serializable {
   private static SchemaHelper2 _schemaHelper;

   public UniformDistributedDestinationBeanImpl() {
      this._initializeProperty(-1);
   }

   public UniformDistributedDestinationBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public UniformDistributedDestinationBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends DestinationBeanImpl.Helper {
      private UniformDistributedDestinationBeanImpl bean;

      protected Helper(UniformDistributedDestinationBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            UniformDistributedDestinationBeanImpl var2 = (UniformDistributedDestinationBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            UniformDistributedDestinationBeanImpl original = (UniformDistributedDestinationBeanImpl)event.getSourceBean();
            UniformDistributedDestinationBeanImpl proposed = (UniformDistributedDestinationBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            UniformDistributedDestinationBeanImpl copy = (UniformDistributedDestinationBeanImpl)initialCopy;
