...
public class OperationComponentBeanImpl extends AbstractDescriptorBean implements OperationComponentBean, Serializable {
   private String _Name;
   private WSATConfigBean _WSATConfig;
   private static SchemaHelper2 _schemaHelper;

   public OperationComponentBeanImpl() {
      this._initializeProperty(-1);
   }

   public OperationComponentBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public OperationComponentBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private OperationComponentBeanImpl bean;

      protected Helper(OperationComponentBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Name")) {
            ...
            return propName.equals("WSATConfig") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            OperationComponentBeanImpl otherTyped = (OperationComponentBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            OperationComponentBeanImpl original = (OperationComponentBeanImpl)event.getSourceBean();
            OperationComponentBeanImpl proposed = (OperationComponentBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            OperationComponentBeanImpl copy = (OperationComponentBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            if ((excludeProps == null || !excludeProps.contains("Name")) && this.bean.isNameSet()) {
               copy.setName(this.bean.getName());
            }

            if ((excludeProps == null || !excludeProps.contains("WSATConfig")) && this.bean.isWSATConfigSet() && !copy._isSet(1)) {
