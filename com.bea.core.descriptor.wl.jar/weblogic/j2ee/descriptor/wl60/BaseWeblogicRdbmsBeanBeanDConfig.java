...
public class BaseWeblogicRdbmsBeanBeanDConfig extends BasicDConfigBean {
   ...
   public BaseWeblogicRdbmsBeanBeanDConfig(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (BaseWeblogicRdbmsBeanBean)btn;
      this.beanTree = btn;
