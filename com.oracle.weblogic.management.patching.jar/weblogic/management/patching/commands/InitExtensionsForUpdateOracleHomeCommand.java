...
public class InitExtensionsForUpdateOracleHomeCommand extends AbstractCommand implements CommandRevertInterface {
   ...
   private static final long serialVersionUID = 1597573897868209811L;
   @SharedState
   ...
   public boolean execute() throws Exception {
      ...
      if (PatchingDebugLogger.isDebugEnabled()) {
         PatchingDebugLogger.debug("initExtensionsForUpdateOracleHomeCommand set variables, ACTION: extract, WORKFLOW_ID: " + scriptEnv.get("WORKFLOW_ID") + ", " + "EXTENSION_JARS" + ": " + scriptEnv.get("EXTENSION_JARS"));
      }
   ...
   public boolean revert() throws Exception {
      ...
      scriptEnv.put("EXTENSION_JARS", this.extensionJars);
      if (PatchingDebugLogger.isDebugEnabled()) {
         PatchingDebugLogger.debug("initExtensionsForUpdateOracleHomeCommand set variables, ACTION: cleanup, WORKFLOW_ID: " + scriptEnv.get("WORKFLOW_ID") + ", " + "EXTENSION_JARS" + ": " + scriptEnv.get("EXTENSION_JARS"));
      }
