...
public class Attribute implements ASN1Object {
   protected OctetString type;
   protected Attribute_vals vals;

   public Attribute() {
   }

   public Attribute(OctetString type, Attribute_vals vals) {
      if (type == null) {
   ...
   public Attribute_vals getVals() {
      return this.vals;
   }

   public void setVals(Attribute_vals val) {
      if (val == null) {
         throw new IllegalArgumentException();
      } else {
         this.vals = val;
