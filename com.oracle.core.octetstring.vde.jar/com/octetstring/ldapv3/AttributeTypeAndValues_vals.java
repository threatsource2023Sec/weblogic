...
public class AttributeTypeAndValues_vals extends ArrayList implements ASN1Object {
   public AttributeTypeAndValues_vals() {
   }

   public AttributeTypeAndValues_vals(Collection value) {
      super(value);
   }

   public AttributeTypeAndValues_vals(AttributeValue[] value) {
