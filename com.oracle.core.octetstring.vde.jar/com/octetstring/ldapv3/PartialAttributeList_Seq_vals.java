...
public class PartialAttributeList_Seq_vals extends ArrayList implements ASN1Object {
   public PartialAttributeList_Seq_vals() {
   }

   public PartialAttributeList_Seq_vals(Collection value) {
      super(value);
   }

   public PartialAttributeList_Seq_vals(AttributeValue[] value) {
