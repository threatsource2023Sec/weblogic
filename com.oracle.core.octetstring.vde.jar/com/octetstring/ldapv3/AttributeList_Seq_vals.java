...
public class AttributeList_Seq_vals extends ArrayList implements ASN1Object {
   public AttributeList_Seq_vals() {
   }

   public AttributeList_Seq_vals(Collection value) {
      super(value);
   }

   public AttributeList_Seq_vals(AttributeValue[] value) {
