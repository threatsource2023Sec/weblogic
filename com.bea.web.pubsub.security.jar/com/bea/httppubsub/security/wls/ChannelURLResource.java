...
public final class ChannelURLResource extends ResourceBase {
   ...
   private static final Resource TOP = new ChannelURLResource((String[])null, 0, (String)null, (String)null, false);
   ...
   private static void setDoMappingToLowerCase(boolean mapping) {
      doMappingToLowerCase = mapping;
   }

   private static void setEnforceStrictURLPattern(boolean enforce) {
      enforceStrictURLPattern = enforce;
   }

   public ChannelURLResource(String application, String contextPathArg, String uriArg, String httpMethod, String transportType) {
   ...
   public ChannelURLResource(String application, String contextPathArg, String uriArg, String httpMethod, String transportType, boolean areWebAppFilesCaseInsensitive) {
      this.suffix = null;
      this.httpMethod = null;
      this.URIUnchanged = true;
      if (application != null && application.length() == 0) {
         throw new InvalidParameterException("application arg is empty");
      } else {
         String uri = uriArg;
         String contextPath = contextPathArg;
         setDoMappingToLowerCase(areWebAppFilesCaseInsensitive);
         setEnforceStrictURLPattern(LegacyEnforceStrictURLPatternManager.getEnforceStrictURLPattern());
   ...
   private ChannelURLResource(String[] values, int length, String httpMethod, String suffix, boolean URIUnchanged) {
      this.suffix = null;
      this.httpMethod = null;
      this.URIUnchanged = true;
   ...
   private Resource makeParentBackwardCompatible() {
      switch (this.length) {
         ...
         case 2:
         default:
            return new ChannelURLResource(this.values, this.length - 1, this.httpMethod, this.suffix, this.URIUnchanged);
         case 3:
            ...
            if (uri.startsWith("*.")) {
               ...
               if (uri.endsWith("/")) {
                  ...
                  if (finalSlash == 0) {
                     ...
                     return new ChannelURLResource(this.values, 2, this.httpMethod, this.suffix, false);
                  }
               }
            }
      }
   ...
   private ChannelURLResource urlResourceWithNewURI(String newURI, String httpMethod, String newSuffix, boolean URIUnchanged) {
      int size = 3;
      if (httpMethod != null) {
         size = 4;
      }

      return new ChannelURLResource(new String[]{this.values[0], this.values[1], newURI, httpMethod}, size, httpMethod, newSuffix, URIUnchanged);
   }

   private ChannelURLResource urlResourceWithNewURI(String newURI, String httpMethod, String newSuffix) {
   ...
   public boolean equals(Object obj) {
      if (!super.equals(obj)) {
         ...
         ChannelURLResource r = (ChannelURLResource)obj;
