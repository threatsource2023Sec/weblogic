...
public abstract class FullMarshallerImpl extends UnmarshallerImpl implements Marshaller {
   protected FullMarshallerImpl(String jsonTypeDescription, Class javaType) {
      super(jsonTypeDescription, javaType);
   }

   protected FullMarshallerImpl(String jsonTypeDescription, Class javaType, TypeInfo docType) {
