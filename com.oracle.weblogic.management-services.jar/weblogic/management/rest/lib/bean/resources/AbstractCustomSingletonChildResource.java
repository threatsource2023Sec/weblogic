...
public abstract class AbstractCustomSingletonChildResource extends AbstractCustomResource implements GetterResource {
   ...
   protected boolean supportsPost() throws Exception {
      if (!this.isEditableTree()) {
         ...
         return this._supportsCreate() || this._supportsUpdate();
      }
   }
