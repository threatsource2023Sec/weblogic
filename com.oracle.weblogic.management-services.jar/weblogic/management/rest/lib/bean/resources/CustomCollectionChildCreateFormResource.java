...
public abstract class CustomCollectionChildCreateFormResource extends AbstractCustomCreateFormResource {
   protected String getPropertyName() throws Exception {
      return StringUtil.getPlural(this.getSingularPropertyName());
   }
