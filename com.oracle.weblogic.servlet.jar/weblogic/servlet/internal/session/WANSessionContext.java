...
public final class WANSessionContext extends ReplicatedSessionContext {
   ...
   public WANSessionContext(WebAppServletContext sci, SessionConfigManager scm) {
      super(sci, scm);
   }
   ...
   protected ReplicatedSessionData instantiateReplicatedSessionData(String sessionID, boolean isNew) {
      return new WANSessionData(sessionID, this, isNew);
   }
   ...
   public SessionData getSessionInternal(String incomingid, ServletRequestImpl req, ServletResponseImpl res) {
      ...
      if (data == null && req != null && res != null) {
         WANSessionData wsd = (WANSessionData)this.createReplicatedSessionData(id, false);
