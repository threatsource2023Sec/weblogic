...
public class XIncludeHandler implements XMLComponent, XMLDocumentFilter, XMLDTDFilter {
      ...
      if (this.getState() == 2) {
         ...
         if (var2.length() == 0 && XINCLUDE_PARSE_XML.equals(var3)) {
            if (var4 != null) {
               ...
               String var61 = this.fXIncludeMessageFormatter.formatMessage(var58, "XPointerStreamability", (Object[])null);
               this.reportResourceError("XMLResourceError", new Object[]{var2, var61});
               return false;
            }
         ...
         if (!var3.equals(XINCLUDE_PARSE_XML)) {
            if (var3.equals(XINCLUDE_PARSE_TEXT)) {
               var9 = var1.getValue(XINCLUDE_ATTR_ENCODING);
               var8.setEncoding(var9);
               XIncludeTextReader var64 = null;
               ...
               try {
                  ...
                  if (!this.fIsXML11) {
                     ...
                     var64 = this.fXInclude10TextReader;
                  } else {
                     if (this.fXInclude11TextReader == null) {
                     ...
                     var64 = this.fXInclude11TextReader;
                  }

                  var64.setErrorReporter(this.fErrorReporter);
                  var64.parse();
               } catch (MalformedByteSequenceException var49) {
                  this.fErrorReporter.reportError(var49.getDomain(), var49.getKey(), var49.getArguments(), (short)2, var49);
               } catch (CharConversionException var50) {
                  this.fErrorReporter.reportError("http://www.w3.org/TR/1998/REC-xml-19980210", "CharConversionFailure", (Object[])null, (short)2, var50);
               } catch (IOException var51) {
                  if (this.fHasIncludeReportedContent) {
                     throw new XNIException(var51);
                  }

                  this.reportResourceError("TextResourceError", new Object[]{var2, var51.getMessage()}, var51);
                  boolean var14 = false;
                  return var14;
               } finally {
                  if (var64 != null) {
            ...
            if (var4 != null && this.fXPointerChildConfig == null || var4 == null && this.fXIncludeChildConfig == null) {
               var9 = "org.python.apache.xerces.parsers.XIncludeParserConfiguration";
               if (var4 != null) {
                  var9 = "org.python.apache.xerces.parsers.XPointerParserConfiguration";
               }
               ...
               this.fChildConfig.setFeature("http://apache.org/xml/features/xinclude/fixup-language", this.fFixupLanguage);
               if (var4 != null) {
                  XPointerHandler var10 = (XPointerHandler)this.fChildConfig.getProperty("http://apache.org/xml/properties/internal/xpointer-handler");
                  this.fXPtrProcessor = var10;
                  ...
                  var10.setHref(var2);
                  var10.setXIncludeLocator(this.fXIncludeLocator);
                  var10.setDocumentHandler(this.getDocumentHandler());
                  this.fXPointerChildConfig = this.fChildConfig;
               } else {
                  XIncludeHandler var60 = (XIncludeHandler)this.fChildConfig.getProperty("http://apache.org/xml/properties/internal/xinclude-handler");
                  var60.setParent(this);
                  var60.setHref(var2);
                  var60.setXIncludeLocator(this.fXIncludeLocator);
                  var60.setDocumentHandler(this.getDocumentHandler());
            ...
            try {
               try {
                  ...
                  Locale var62 = this.fErrorReporter != null ? this.fErrorReporter.getLocale() : null;
                  String var63 = this.fXIncludeMessageFormatter.formatMessage(var62, "XPointerResolutionUnsuccessful", (Object[])null);
                  this.reportResourceError("XMLResourceError", new Object[]{var2, var63});
                  var11 = false;
                  return var11;
               } catch (XNIException var53) {
                  this.fXIncludeLocator.setLocator(this.fDocLocation);
                  if (this.fErrorReporter != null) {
                     this.fErrorReporter.setDocumentLocator(this.fDocLocation);
                  }
               ...
               this.reportResourceError("XMLResourceError", new Object[]{var2, var54.getMessage()}, var54);
               var11 = false;
            } finally {
   ...
   private String escapeHref(String var1) {
      ...
      for(var4 = 0; var4 < var2; ++var4) {
         ...
         if (gNeedEscaping[var5]) {
            var3.append('%');
            var3.append(gAfterEscaping1[var5]);
            var3.append(gAfterEscaping2[var5]);
         } else {
      ...
      if (var4 < var2) {
         ...
         while(true) {
            if (var6 >= var2) {
               ...
               byte[] var12;
               try {
                  var12 = var1.substring(var4).getBytes("UTF-8");
               ...
               for(var4 = 0; var4 < var2; ++var4) {
                  byte var9 = var12[var4];
                  if (var9 < 0) {
                     var5 = var9 + 256;
                     var3.append('%');
                     var3.append(gHexChs[var5 >> 4]);
                     var3.append(gHexChs[var5 & 15]);
                  } else if (gNeedEscaping[var9]) {
                     var3.append('%');
                     var3.append(gAfterEscaping1[var9]);
                     var3.append(gAfterEscaping2[var9]);
                  } else {
                     var3.append((char)var9);
                  }
               }

               return var3.length() != var2 ? var3.toString() : var1;
            }

            var5 = var1.charAt(var6);
            if ((var5 < 32 || var5 > 126) && (var5 < 160 || var5 > 55295) && (var5 < 63744 || var5 > 64975) && (var5 < 65008 || var5 > 65519)) {
               ...
               var7 = XMLChar.supplemental((char)var5, (char)var7);
