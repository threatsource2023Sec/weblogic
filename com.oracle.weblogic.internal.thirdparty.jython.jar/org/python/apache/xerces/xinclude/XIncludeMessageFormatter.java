...
public class XIncludeMessageFormatter implements MessageFormatter {
   ...
   public String formatMessage(Locale var1, String var2, Object[] var3) throws MissingResourceException {
      ...
      if (var1 != this.fLocale) {
         this.fResourceBundle = ResourceBundle.getBundle("org.python.apache.xerces.impl.msg.XIncludeMessages", var1);
         this.fLocale = var1;
      }
      ...
      if (var4 == null) {
         ...
         throw new MissingResourceException(var4, "org.python.apache.xerces.impl.msg.XIncludeMessages", var2);
      } else {
         return var4;
      }
   }
