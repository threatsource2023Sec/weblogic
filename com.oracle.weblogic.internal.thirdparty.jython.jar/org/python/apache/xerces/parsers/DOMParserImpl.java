...
import org.python.apache.xerces.dom.DOMStringListImpl;
...
public class DOMParserImpl extends AbstractDOMParser implements LSParser, DOMConfiguration {
   ...
   public DOMParserImpl(String var1, String var2) {
      this((XMLParserConfiguration)ObjectFactory.createObject("org.python.apache.xerces.xni.parser.XMLParserConfiguration", var1));
      if (var2 != null) {
   ...
   public DOMParserImpl(SymbolTable var1) {
      this((XMLParserConfiguration)ObjectFactory.createObject("org.python.apache.xerces.xni.parser.XMLParserConfiguration", "org.python.apache.xerces.parsers.XIncludeAwareParserConfiguration"));
            ...
            if (var1.equalsIgnoreCase("comments")) {
               ...
               if (var1.equalsIgnoreCase("namespaces")) {
                  ...
                  if (var1.equalsIgnoreCase("validate")) {
                     ...
                     this.fConfiguration.setProperty("http://apache.org/xml/properties/dom/document-class-name", "org.python.apache.xerces.dom.PSVIDocumentImpl");
                  } else {
                     String var4;
