...
final class DOMResultBuilder implements DOMDocumentHandler {
   ...
   public void startElement(QName var1, XMLAttributes var2, Augmentations var3) throws XNIException {
      ...
      int var6;
      if (this.fDocumentImpl == null) {
         var5 = this.fDocument.createElementNS(var1.uri, var1.rawname);

         for(var6 = 0; var6 < var4; ++var6) {
            var2.getName(var6, this.fAttributeQName);
            var5.setAttributeNS(this.fAttributeQName.uri, this.fAttributeQName.rawname, var2.getValue(var6));
         }
      } else {
         var5 = this.fDocumentImpl.createElementNS(var1.uri, var1.rawname, var1.localpart);
               ...
               if (var9 == null) {
                  ...
                  if (var10 != null) {
                     ...
                     if (((XSSimpleType)var10).isIDType()) {
                        ((ElementImpl)var5).setIdAttributeNode(var7, true);
                     }
                  }
               } else {
                  var7.setType(var9);
