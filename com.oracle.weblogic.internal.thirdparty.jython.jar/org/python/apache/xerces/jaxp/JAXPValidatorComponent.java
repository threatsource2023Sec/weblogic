...
import org.python.apache.xerces.impl.xs.opti.DefaultXMLDocumentHandler;
import org.python.apache.xerces.util.AttributesProxy;
import org.python.apache.xerces.util.AugmentationsImpl;
import org.python.apache.xerces.util.ErrorHandlerProxy;
import org.python.apache.xerces.util.ErrorHandlerWrapper;
import org.python.apache.xerces.util.LocatorProxy;
...
final class JAXPValidatorComponent extends TeeXMLDocumentFilterImpl implements XMLComponent {
   ...
   private void updateAttributes(Attributes var1) {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         if (var5 == -1) {
            int var7 = var4.indexOf(58);
            String var8;
            if (var7 < 0) {
               var8 = null;
            } else {
               var8 = this.symbolize(var4.substring(0, var7));
            }

            var5 = this.fCurrentAttributes.addAttribute(new QName(var8, this.symbolize(var1.getLocalName(var3)), this.symbolize(var4), this.symbolize(var1.getURI(var3))), var1.getType(var3), var6);
