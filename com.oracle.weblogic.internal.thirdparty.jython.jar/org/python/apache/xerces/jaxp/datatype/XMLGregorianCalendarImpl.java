...
class XMLGregorianCalendarImpl extends XMLGregorianCalendar implements Serializable, Cloneable {
   ...
   protected XMLGregorianCalendarImpl(String var1) throws IllegalArgumentException {
      ...
      if (var1.indexOf(84) != -1) {
         var2 = "%Y-%M-%DT%h:%m:%s%z";
      } else if (var4 >= 3 && var1.charAt(2) == ':') {
         var2 = "%h:%m:%s%z";
      } else if (var1.startsWith("--")) {
         if (var4 >= 3 && var1.charAt(2) == '-') {
            var2 = "---%D%z";
         } else if (var4 == 4 || var4 >= 6 && (var1.charAt(4) == '+' || var1.charAt(4) == '-' && (var1.charAt(5) == '-' || var4 == 10))) {
            var2 = "--%M--%z";
            var5 = new Parser(var2, var1);
   ...
   public void add(Duration var1) {
      ...
      int var21 = this.getDay();
      if (var21 == Integer.MIN_VALUE) {
         var2[2] = true;
         var21 = MIN_FIELD_VALUE[2];
      }

      BigInteger var22 = sanitize(var1.getField(DatatypeConstants.DAYS), var3);
      int var23 = maximumDayInMonthFor(this.getEonAndYear(), this.getMonth());
      BigInteger var24;
      if (var21 > var23) {
         var24 = BigInteger.valueOf((long)var23);
      } else if (var21 < 1) {
         var24 = BigInteger.ONE;
      } else {
         var24 = BigInteger.valueOf((long)var21);
      }

      BigInteger var25 = var24.add(var22).add(var7);

      while(true) {
         byte var27;
         int var30;
         if (var25.compareTo(BigInteger.ONE) < 0) {
            BigInteger var26 = null;
            if (this.month >= 2) {
               var26 = BigInteger.valueOf((long)maximumDayInMonthFor(this.getEonAndYear(), this.getMonth() - 1));
            } else {
               var26 = BigInteger.valueOf((long)maximumDayInMonthFor(this.getEonAndYear().subtract(BigInteger.valueOf(1L)), 12));
            }
         ...
         int var28 = this.getMonth() + var27;
         var30 = (var28 - 1) % 12;
         int var29;
         if (var30 < 0) {
            var30 = 12 + var30 + 1;
            var29 = BigDecimal.valueOf((long)(var28 - 1)).divide(new BigDecimal(TWELVE), 0).intValue();
         } else {
            var29 = (var28 - 1) / 12;
            ++var30;
         }
   ...
   public GregorianCalendar toGregorianCalendar() {
      ...
      TimeZone var2 = this.getTimeZone(Integer.MIN_VALUE);
      Locale var3 = Locale.getDefault();
      var1 = new GregorianCalendar(var2, var3);
      var1.clear();
      ...
      if (this.year != Integer.MIN_VALUE) {
         if (this.eon == null) {
            ...
            BigInteger var4 = this.getEonAndYear();
            var1.set(0, var4.signum() == -1 ? 0 : 1);
            var1.set(1, var4.abs().intValue());
         }
      }
   ...
   private String toString(BigDecimal var1) {
      ...
      if (var3 == 0) {
         ...
         if (var4 == 0) {
            ...
            StringBuffer var5;
            if (var4 > 0) {
               var5 = new StringBuffer(var2);
               var5.insert(var4, '.');
            } else {
               var5 = new StringBuffer(3 - var4 + var2.length());
               var5.append("0.");
