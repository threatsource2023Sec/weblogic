...
class DurationImpl extends Duration implements Serializable {
   ...
   protected DurationImpl(String var1) throws IllegalArgumentException {
      if (var1 == null) {
         ...
         var3[0] = 0;
         boolean var6;
         if (var4 != var3[0] && var1.charAt(var3[0]) == '-') {
            int var10002 = var3[0]++;
            var6 = false;
         } else {
            var6 = true;
         ...
         int[] var9;
         for(var9 = new int[3]; var4 != var3[0] && isDigit(var2.charAt(var3[0])) && var7 < 3; var8[var7++] = parsePiece(var2, var3)) {
            var9[var7] = var3[0];
         }
         ...
         int[] var12;
         for(var12 = new int[3]; var4 != var3[0] && isDigitOrPeriod(var2.charAt(var3[0])) && var10 < 3; var11[var10++] = parsePiece(var2, var3)) {
            var12[var10] = var3[0];
         }
         ...
         if (var5 && var10 == 0) {
            ...
            this.signum = this.calcSignum(var6);
         }
      }
   }
