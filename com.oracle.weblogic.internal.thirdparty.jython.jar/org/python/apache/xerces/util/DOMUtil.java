...
import org.python.apache.xerces.impl.xs.opti.NodeImpl;
...
public class DOMUtil {
   ...
   public static void setHidden(Node var0) {
      ...
      } else if (var0 instanceof org.python.apache.xerces.dom.NodeImpl) {
         ((org.python.apache.xerces.dom.NodeImpl)var0).setReadOnly(true, false);
      }
   ...
   public static void setVisible(Node var0) {
      if (var0 instanceof NodeImpl) {
         ...
         ((org.python.apache.xerces.dom.NodeImpl)var0).setReadOnly(false, false);
      }
   ...
   public static boolean isHidden(Node var0) {
      if (var0 instanceof NodeImpl) {
         ...
         return var0 instanceof org.python.apache.xerces.dom.NodeImpl ? ((org.python.apache.xerces.dom.NodeImpl)var0).getReadOnly() : false;
      }
   }
