...
import org.python.apache.xerces.dom.DOMInputImpl;
import org.python.apache.xerces.jaxp.SAXParserFactoryImpl;
...
import org.python.apache.xml.resolver.Catalog;
import org.python.apache.xml.resolver.CatalogManager;
import org.python.apache.xml.resolver.readers.SAXCatalogReader;
...
public class XMLCatalogResolver implements XMLEntityResolver, EntityResolver2, LSResourceResolver {
   ...
   private void init(String[] var1, boolean var2) {
      ...
      this.fResolverCatalogManager.setCatalogClassName("org.python.apache.xml.resolver.Catalog");
   ...
   private void attachReaderToCatalog(Catalog var1) {
      ...
      var3.setCatalogParser("urn:oasis:names:tc:entity:xmlns:xml:catalog", "catalog", "org.python.apache.xml.resolver.readers.OASISXMLCatalogReader");
