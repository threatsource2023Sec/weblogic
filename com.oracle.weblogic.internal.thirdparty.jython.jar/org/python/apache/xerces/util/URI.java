...
public class URI implements Serializable {
         ...
         if (var1 == 0) {
            ...
            if (var2 + 1 < var1 && isDigit(var0.charAt(var2 + 1))) {
               ...
               for(int var4 = 0; var4 < var1; ++var4) {
                  ...
                  if (var5 == '.') {
                     if (!isAlphanum(var0.charAt(var4 - 1))) {
                        return false;
                     }

                     if (var4 + 1 < var1 && !isAlphanum(var0.charAt(var4 + 1))) {
                        return false;
                     }

                     var3 = 0;
                  } else {
                     if (!isAlphanum(var5) && var5 != '-') {
                        return false;
                     }
   ...
   public static boolean isWellFormedIPv4Address(String var0) {
      ...
      for(int var4 = 0; var4 < var1; ++var4) {
         ...
         if (var5 != '.') {
            ...
            if (var3 == 3) {
               char var6 = var0.charAt(var4 - 2);
               char var7 = var0.charAt(var4 - 1);
               if (var6 >= '2' && (var6 != '2' || var7 >= '5' && (var7 != '5' || var5 > '5'))) {
                  return false;
               }
            }
         } else {
            if (var4 > 0 && !isDigit(var0.charAt(var4 - 1)) || var4 + 1 < var1 && !isDigit(var0.charAt(var4 + 1))) {
               return false;
            }
   ...
   private static int scanHexSequence(String var0, int var1, int var2, int[] var3) {
      ...
      for(int var5 = var1; var1 < var2; ++var1) {
         ...
         if (var6 == ':') {
            ...
            if (var4 == 0 || var1 + 1 < var2 && var0.charAt(var1 + 1) == ':') {
               return var1;
            }
            ...
            if (!isHex(var6)) {
               if (var6 == '.' && var4 < 4 && var4 > 0 && var3[0] <= 6) {
                  int var7 = var1 - var4 - 1;
                  return var7 >= var5 ? var7 : var7 + 1;
               }
