...
public abstract class XMLScanner implements XMLComponent {
   ...
   protected void scanXMLDeclOrTextDecl(boolean var1, String[] var2) throws IOException, XNIException {
      ...
      int var6 = 0;
      boolean var7 = false;
      boolean var8 = this.fEntityScanner.skipDeclSpaces();
      XMLEntityManager.ScannedEntity var9 = this.fEntityManager.getCurrentEntity();
      boolean var10 = var9.literal;

      for(var9.literal = false; this.fEntityScanner.peekChar() != 63; var8 = this.fEntityScanner.skipDeclSpaces()) {
         var7 = true;
         String var11 = this.scanPseudoAttribute(var1, this.fString);
         switch (var6) {
            case 0:
               if (var11 == fVersionSymbol) {
                  if (!var8) {
            ...
            case 1:
               if (var11 == fEncodingSymbol) {
                  ...
                  if (!var1 && var11 == fStandaloneSymbol) {
                     if (!var8) {
