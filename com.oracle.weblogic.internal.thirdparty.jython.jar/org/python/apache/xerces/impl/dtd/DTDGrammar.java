...
import org.python.apache.xerces.impl.dtd.models.CMAny;
import org.python.apache.xerces.impl.dtd.models.CMBinOp;
import org.python.apache.xerces.impl.dtd.models.CMLeaf;
import org.python.apache.xerces.impl.dtd.models.CMNode;
import org.python.apache.xerces.impl.dtd.models.CMUniOp;
import org.python.apache.xerces.impl.dtd.models.ContentModelValidator;
import org.python.apache.xerces.impl.dtd.models.DFAContentModel;
import org.python.apache.xerces.impl.dtd.models.MixedContentModel;
import org.python.apache.xerces.impl.dtd.models.SimpleContentModel;
...
public class DTDGrammar implements XMLDTDHandler, XMLDTDContentModelHandler, EntityState, Grammar {
   ...
   public void endDTD(Augmentations var1) throws XNIException {
      ...
      if (this.fGrammarDescription.getRootName() == null) {
         boolean var2 = false;
         String var3 = null;
         int var4 = this.fElementDeclCount;
         ArrayList var5 = new ArrayList(var4);

         for(int var6 = 0; var6 < var4; ++var6) {
            int var7 = var6 >> 8;
            int var8 = var6 & 255;
            var3 = this.fElementDeclName[var7][var8].rawname;
            var5.add(var3);
         }
