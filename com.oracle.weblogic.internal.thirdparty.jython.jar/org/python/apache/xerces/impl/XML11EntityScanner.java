...
public class XML11EntityScanner extends XMLEntityScanner {
   ...
   public String scanNmtoken() throws IOException {
         ...
         if (XML11Char.isXML11Name(var2)) {
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               ...
               if (var3 == this.fCurrentEntity.ch.length) {
                  var4 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var1, var4, 0, var3);
                  this.fCurrentEntity.ch = var4;
               } else {
            ...
            char var6 = this.fCurrentEntity.ch[this.fCurrentEntity.position];
            ...
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               int var8 = this.fCurrentEntity.position - var1;
               if (var8 == this.fCurrentEntity.ch.length) {
                  char[] var5 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var1, var5, 0, var8);
                  this.fCurrentEntity.ch = var5;
               } else {
                  System.arraycopy(this.fCurrentEntity.ch, var1, this.fCurrentEntity.ch, 0, var8);
               }
      ...
      String var7 = null;
      if (var2 > 0) {
         var7 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, var1, var2);
      }
      ...
      if (XML11Char.isXML11NameStart(var2)) {
         if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
            ...
            if (this.load(1, false)) {
               ++this.fCurrentEntity.columnNumber;
               String var8 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, 0, 1);
               return var8;
            }
         }
      } else {
      ...
      while(true) {
         ...
         if (XML11Char.isXML11Name(var2)) {
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               var3 = this.fCurrentEntity.position - var1;
               if (var3 == this.fCurrentEntity.ch.length) {
                  var7 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var1, var7, 0, var3);
            ...
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               int var9 = this.fCurrentEntity.position - var1;
               if (var9 == this.fCurrentEntity.ch.length) {
                  char[] var5 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var1, var5, 0, var9);
                  this.fCurrentEntity.ch = var5;
               } else {
                  System.arraycopy(this.fCurrentEntity.ch, var1, this.fCurrentEntity.ch, 0, var9);
               }
   ...
   public boolean scanQName(QName var1) throws IOException {
         ...
         if (XML11Char.isXML11Name(var3)) {
            ...
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               ...
               if (var6 == this.fCurrentEntity.ch.length) {
                  var7 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var2, var7, 0, var6);
                  this.fCurrentEntity.ch = var7;
               } else {
            ...
            if (++this.fCurrentEntity.position == this.fCurrentEntity.count) {
               int var16 = this.fCurrentEntity.position - var2;
               if (var16 == this.fCurrentEntity.ch.length) {
                  char[] var8 = new char[this.fCurrentEntity.ch.length << 1];
                  System.arraycopy(this.fCurrentEntity.ch, var2, var8, 0, var16);
                  this.fCurrentEntity.ch = var8;
               } else {
                  System.arraycopy(this.fCurrentEntity.ch, var2, this.fCurrentEntity.ch, 0, var16);
               }
      ...
      if (var6 <= 0) {
         ...
         if (var4 != -1) {
            int var10 = var4 - var2;
            var17 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, var2, var10);
            ...
            var18 = this.fSymbolTable.addSymbol(this.fCurrentEntity.ch, var4 + 1, var11);
         } else {
            var18 = var9;
         }
