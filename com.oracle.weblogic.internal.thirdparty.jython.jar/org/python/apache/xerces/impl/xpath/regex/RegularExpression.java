      ...
      if (isSet(this.options, 512)) {
         ...
         if (this.operations != null && this.operations.type == 7 && this.operations.getChild().type == 0) {
            if (isSet(this.options, 4)) {
               var10 = var6.start;
               var9 = this.match(var6, this.operations, var6.start, 1, this.options);
            } else {
               boolean var15 = true;

               for(var10 = var6.start; var10 <= var8; ++var10) {
                  char var16 = var1[var10];
                  if (isEOLChar(var16)) {
                     var15 = true;
                  } else {
                     if (var15 && 0 <= (var9 = this.match(var6, this.operations, var10, 1, this.options))) {
                        break;
                     }
            ...
            for(var10 = var6.start; var10 <= var8; ++var10) {
               ...
               if (REUtil.isHighSurrogate(var12) && var10 + 1 < var6.limit) {
                  var12 = REUtil.composeFromSurrogates(var12, var1[var10 + 1]);
               }

               if (var11.match(var12) && 0 <= (var9 = this.match(var6, this.operations, var10, 1, this.options))) {
                  break;
               }
            }
         } else {
            for(var10 = var6.start; var10 <= var8 && 0 > (var9 = this.match(var6, this.operations, var10, 1, this.options)); ++var10) {
            }
         }

         if (var9 >= 0) {
            if (var6.match != null) {
               var6.match.setBeginning(0, var10);
               var6.match.setEnd(0, var9);
            }
   ...
   public boolean matches(String var1, int var2, int var3, Match var4) {
      ...
      if (isSet(this.options, 512)) {
         ...
         if (this.operations != null && this.operations.type == 7 && this.operations.getChild().type == 0) {
            ...
            for(var10 = var6.start; var10 <= var8; ++var10) {
               int var12 = var1.charAt(var10);
               if (REUtil.isHighSurrogate(var12) && var10 + 1 < var6.limit) {
                  var12 = REUtil.composeFromSurrogates(var12, var1.charAt(var10 + 1));
               }
      ...
      if (isSet(this.options, 512)) {
         ...
         if (this.operations != null && this.operations.type == 7 && this.operations.getChild().type == 0) {
            if (isSet(this.options, 4)) {
               ...
               for(var10 = var6.start; var10 <= var8; ++var10) {
                  char var16 = var1.setIndex(var10);
                  if (isEOLChar(var16)) {
                     var15 = true;
                  } else {
                     if (var15 && 0 <= (var9 = this.match(var6, this.operations, var10, 1, this.options))) {
            ...
            for(var10 = var6.start; var10 <= var8; ++var10) {
               int var12 = var1.setIndex(var10);
               if (REUtil.isHighSurrogate(var12) && var10 + 1 < var6.limit) {
                  var12 = REUtil.composeFromSurrogates(var12, var1.setIndex(var10 + 1));
               }
