   ...
   protected RangeToken parseCharacterClass(boolean var1) throws ParseException {
      ...
      while(true) {
         ...
         label183: {
            if ((var7 = this.read()) != 1) {
               var3 = false;
               if (var7 == 0 && this.chardata == 93 && !var6) {
                  if (var2) {
         ...
         if (!var9) {
            if (var7 == 0) {
               ...
               if (var8 == 45 && this.chardata != 93 && !var6) {
                  throw this.ex("parser.cc.8", this.offset - 2);
               }
            }

            if (this.read() != 0 || this.chardata != 45 || var8 == 45 && var6) {
               ...
               if (var7 == 0 && this.chardata == 93) {
                  ...
                  if (this.isSet(2) && (var8 <= 65535 || var12 <= 65535)) {
                     RegexParser.addCaseInsensitiveCharRange(var5, var8, var12);
                  } else {
