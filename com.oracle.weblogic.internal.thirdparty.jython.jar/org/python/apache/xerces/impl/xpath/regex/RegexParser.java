...
class RegexParser {
   ...
   public void setLocale(Locale var1) {
      try {
         if (var1 != null) {
            this.resources = ResourceBundle.getBundle("org.python.apache.xerces.impl.xpath.regex.message", var1);
         } else {
            this.resources = ResourceBundle.getBundle("org.python.apache.xerces.impl.xpath.regex.message");
         }
   ...
   final void next() {
      if (this.offset >= this.regexlen) {
         ...
         char var1 = this.regex.charAt(this.offset++);
         this.chardata = var1;
         byte var2;
         if (this.context == 1) {
            switch (var1) {
               ...
               default:
                  if (REUtil.isHighSurrogate(var1) && this.offset < this.regexlen) {
                     char var3 = this.regex.charAt(this.offset);
                     if (REUtil.isLowSurrogate(var3)) {
                        this.chardata = REUtil.composeFromSurrogates(var1, var3);
                        ++this.offset;
                     }
                  }
            ...
            switch (var1) {
               ...
               case '(':
                  ...
                  if (this.offset < this.regexlen && this.regex.charAt(this.offset) == '?') {
                     ...
                     var1 = this.regex.charAt(this.offset++);
                     switch (var1) {
                        case '!':
                           var2 = 15;
                           break;
                        ...
                        case '[':
                           ...
                           break;
                        default:
                           if (var1 != '-' && ('a' > var1 || var1 > 'z') && ('A' > var1 || var1 > 'Z')) {
                              if (var1 != '(') {
   ...
   protected RangeToken parseCharacterClass(boolean var1) throws ParseException {
      ...
      int var6;
      for(boolean var5 = true; (var6 = this.read()) != 1 && (var6 != 0 || this.chardata != 93 || var5); var5 = false) {
   ...
   protected RangeToken parseSetOperations() throws ParseException {
      ...
      int var3;
      while((var3 = this.read()) != 7) {
         int var2 = this.chardata;
         if ((var3 != 0 || var2 != 45 && var2 != 38) && var3 != 4) {
   ...
   protected static final void addCaseInsensitiveCharRange(RangeToken var0, int var1, int var2) {
      ...
      var0.addRange(var3, var4);

      for(int var5 = var3; var5 <= var4; ++var5) {
         int[] var6 = CaseInsensitiveMap.get(var5);
         if (var6 != null) {
            for(int var7 = 0; var7 < var6.length; var7 += 2) {
               var0.addRange(var6[var7], var6[var7]);
            }
         }
      }
