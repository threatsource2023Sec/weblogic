      ...
      if (categories.size() == 0) {
         ...
         synchronized(var2) {
            ...
            for(int var5 = 0; var5 < 65536; ++var5) {
               int var6 = Character.getType((char)var5);
               if (var6 == 21 || var6 == 22) {
                  if (var5 == 171 || var5 == 8216 || var5 == 8219 || var5 == 8220 || var5 == 8223 || var5 == 8249) {
                     var6 = 29;
                  }

                  if (var5 == 187 || var5 == 8217 || var5 == 8221 || var5 == 8250) {
                     var6 = 30;
                  }
               }

               var3[var6].addRange(var5, var5);
               byte var21;
               switch (var6) {
                  case 0:
                  case 15:
                  ...
                  case 17:
                  default:
                     throw new RuntimeException("org.apache.xerces.utils.regex.Token#getRange(): Unknown Unicode category: " + var6);
                  case 20:
                  case 21:
                  case 22:
                  case 23:
               ...
               if (var1.type == 1) {
                  ...
                  if (var2 == 0) {
                     ...
                     if ((((Token)var3).type == 0 || ((Token)var3).type == 10) && (var1.type == 0 || var1.type == 10)) {
                        int var4 = var1.type == 0 ? 2 : var1.getString().length();
                        StringBuffer var5;
                        int var6;
                        if (((Token)var3).type == 0) {
                           var5 = new StringBuffer(2 + var4);
                           var6 = ((Token)var3).getChar();
                           if (var6 >= 65536) {
                              var5.append(REUtil.decomposeToSurrogates(var6));
                           } else {
                           ...
                           var5 = new StringBuffer(((Token)var3).getString().length() + var4);
                           var5.append(((Token)var3).getString());
                        }
                        ...
                        if (var1.type == 0) {
                           ...
                           var5.append(var1.getString());
                        }

                        ((StringToken)var3).string = new String(var5);
                     } else {
                        this.children.addElement(var1);
                     }
                  }
         ...
         if (this.type == 1) {
            if (this.children.size() == 2) {
               ...
               if (var6.type == 3 && var6.getChild(0) == var5) {
                  var4 = var5.toString(var1) + "+";
               } else if (var6.type == 9 && var6.getChild(0) == var5) {
                  var4 = var5.toString(var1) + "+?";
               } else {
                  var4 = var5.toString(var1) + var6.toString(var1);
               }
            } else {
               var2 = new StringBuffer();

               for(var3 = 0; var3 < this.children.size(); ++var3) {
                  var2.append(((Token)this.children.elementAt(var3)).toString(var1));
               }
            ...
            if (this.children.size() == 2 && this.getChild(1).type == 7) {
               var4 = this.getChild(0).toString(var1) + "?";
            } else if (this.children.size() == 2 && this.getChild(0).type == 7) {
               var4 = this.getChild(1).toString(var1) + "??";
            } else {
               var2 = new StringBuffer();
               var2.append(((Token)this.children.elementAt(0)).toString(var1));

               for(var3 = 1; var3 < this.children.size(); ++var3) {
                  var2.append('|');
                  var2.append(((Token)this.children.elementAt(var3)).toString(var1));
               }
