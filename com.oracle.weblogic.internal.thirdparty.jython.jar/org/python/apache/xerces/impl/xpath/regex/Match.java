...
public class Match implements Cloneable {
   ...
   public String getCapturedText(int var1) {
      if (this.beginpos == null) {
         ...
         int var2 = this.beginpos[var1];
         int var3 = this.endpos[var1];
         if (var2 >= 0 && var3 >= 0) {
            String var4;
            if (this.ciSource != null) {
               var4 = REUtil.substring(this.ciSource, var2, var3);
            } else if (this.strSource != null) {
               var4 = this.strSource.substring(var2, var3);
            } else {
               var4 = new String(this.charSource, var2, var3 - var2);
            }
