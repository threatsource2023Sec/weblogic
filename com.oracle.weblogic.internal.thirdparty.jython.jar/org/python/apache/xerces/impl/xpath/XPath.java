   ...
   private static class Scanner {
      ...
      public boolean scanExpr(SymbolTable var1, Tokens var2, String var3, int var4, int var5) throws XPathException {
         ...
         while(true) {
            if (var4 != var5) {
               int var7;
               for(var7 = var3.charAt(var4); var7 == 32 || var7 == 10 || var7 == 9 || var7 == 13; var7 = var3.charAt(var4)) {
                  ++var4;
                  if (var4 == var5) {
                     break;
                  }
               ...
               if (var4 != var5) {
                  byte var8 = var7 >= 128 ? 25 : fASCIICharMap[var7];
                  int var12;
                  String var13;
                  String var14;
                  char var17;
                  switch (var8) {
                     ...
                     case 4:
                        ...
                        int var10;
                        for(var10 = var4; var17 != var9; var17 = var3.charAt(var4)) {
                           ++var4;
                           if (var4 == var5) {
                              return false;
                           }
                        ...
                        var6 = true;
                        var2.addToken(var1.addSymbol(var3.substring(var10, var10 + var11)));
                        ++var4;
                        if (var4 == var5) {
                        }
                        continue;
                     case 5:
                        ...
                        if (var4 < var5) {
                           var7 = var3.charAt(var4);
                        } else {
                           var7 = -1;
                        }

                        var13 = var1.addSymbol(var3.substring(var12, var4));
                        if (var7 != 58) {
                           var14 = XMLSymbols.EMPTY_STRING;
                        } else {
                           var14 = var13;
                           ++var4;
                           if (var4 == var5) {
                     ...
                     case 25:
                        ...
                        while(var7 == 32 || var7 == 10 || var7 == 9 || var7 == 13) {
                           ++var4;
                           if (var4 == var5) {
                              break;
                           }
                        ...
                        if (var6) {
                           if (var13 == fAndSymbol) {
                              ...
                              var6 = false;
                           } else if (var13 == fOrSymbol) {
                              this.addToken(var2, 17);
                              var6 = false;
                           } else if (var13 == fModSymbol) {
                        ...
                        if (var7 == 40 && !var15 && !var16) {
                           if (var13 == fCommentSymbol) {
                              this.addToken(var2, 12);
                           } else if (var13 == fTextSymbol) {
                              this.addToken(var2, 13);
                           } else if (var13 == fPISymbol) {
                              this.addToken(var2, 14);
                           } else if (var13 == fNodeSymbol) {
                        ...
                        if (var16 || var7 == 58 && var4 + 1 < var5 && var3.charAt(var4 + 1) == ':') {
                           if (var13 == fAncestorSymbol) {
                              this.addToken(var2, 33);
                           } else if (var13 == fAncestorOrSelfSymbol) {
                              this.addToken(var2, 34);
                           } else if (var13 == fAttributeSymbol) {
                              this.addToken(var2, 35);
                           } else if (var13 == fChildSymbol) {
                              this.addToken(var2, 36);
                           } else if (var13 == fDescendantSymbol) {
                              this.addToken(var2, 37);
                           } else if (var13 == fDescendantOrSelfSymbol) {
                              this.addToken(var2, 38);
                           } else if (var13 == fFollowingSymbol) {
                              this.addToken(var2, 39);
                           } else if (var13 == fFollowingSiblingSymbol) {
                              this.addToken(var2, 40);
                           } else if (var13 == fNamespaceSymbol) {
                              this.addToken(var2, 41);
                           } else if (var13 == fParentSymbol) {
                              this.addToken(var2, 42);
                           } else if (var13 == fPrecedingSymbol) {
                              this.addToken(var2, 43);
                           } else if (var13 == fPrecedingSiblingSymbol) {
                              this.addToken(var2, 44);
                           } else {
                              if (var13 != fSelfSymbol) {
                                 return false;
                              }
