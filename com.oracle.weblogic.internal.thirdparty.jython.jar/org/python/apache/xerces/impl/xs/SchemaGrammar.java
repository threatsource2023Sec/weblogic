...
import org.python.apache.xerces.impl.xs.util.ObjectListImpl;
...
import org.python.apache.xerces.xni.grammars.XSGrammar;
...
import org.python.apache.xerces.xs.XSWildcard;
...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
   ...
   public SchemaGrammar(SchemaGrammar var1) {
      ...
      if (this.fRGCount > 0) {
         ...
         System.arraycopy(var1.fRGLocators, 0, this.fRGLocators, 0, this.fRGCount);
      }
   ...
   public static final class Schema4Annotations extends SchemaGrammar {
      ...
      private Schema4Annotations() {
         ...
         var4.setValues("#AnonType_" + SchemaSymbols.ELT_ANNOTATION, this.fTargetNamespace, SchemaGrammar.fAnyType, (short)2, (short)0, (short)3, (short)2, false, var7, (XSSimpleType)null, var15, new XSObjectListImpl((XSObject[])null, 0));
         var4.setName("#AnonType_" + SchemaSymbols.ELT_ANNOTATION);
         var4.setIsAnonymous();
         var5.setValues("#AnonType_" + SchemaSymbols.ELT_DOCUMENTATION, this.fTargetNamespace, SchemaGrammar.fAnyType, (short)2, (short)0, (short)3, (short)3, false, var8, (XSSimpleType)null, var17, new XSObjectListImpl((XSObject[])null, 0));
         var5.setName("#AnonType_" + SchemaSymbols.ELT_DOCUMENTATION);
         var5.setIsAnonymous();
         var6.setValues("#AnonType_" + SchemaSymbols.ELT_APPINFO, this.fTargetNamespace, SchemaGrammar.fAnyType, (short)2, (short)0, (short)3, (short)3, false, var9, (XSSimpleType)null, var17, new XSObjectListImpl((XSObject[])null, 0));
   ...
   public static class BuiltinSchemaGrammar extends SchemaGrammar {
      private static final String EXTENDED_SCHEMA_FACTORY_CLASS = "org.python.apache.xerces.impl.dv.xs.ExtendedSchemaDVFactoryImpl";
      ...
      public BuiltinSchemaGrammar(int var1, short var2) {
         ...
         if (var2 == 1) {
            ...
            var3 = SchemaDVFactory.getInstance("org.python.apache.xerces.impl.dv.xs.ExtendedSchemaDVFactoryImpl");
         }
