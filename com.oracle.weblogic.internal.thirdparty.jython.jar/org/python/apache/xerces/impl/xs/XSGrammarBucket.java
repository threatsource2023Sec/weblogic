               ...
               if (var8 == null) {
                  ...
                  if (var9 != null) {
                     for(var10 = var9.size() - 1; var10 >= 0; --var10) {
                        var8 = (SchemaGrammar)var9.elementAt(var10);
         ...
         if (!var2) {
            ...
            if (var5 == null) {
               ...
               for(int var7 = 0; var7 < var6.size(); ++var7) {
                  ...
                  SchemaGrammar var9 = this.getGrammar(var8.fTargetNamespace);
                  if (var9 == null) {
                     Vector var10 = var8.getImportedGrammars();
                     if (var10 != null) {
                        for(var11 = var10.size() - 1; var11 >= 0; --var11) {
                           var9 = (SchemaGrammar)var10.elementAt(var11);
