...
import org.python.apache.xerces.impl.xs.SchemaNamespaceSupport;
...
import org.python.apache.xerces.impl.xs.opti.SchemaDOM;
import org.python.apache.xerces.impl.xs.opti.SchemaDOMParser;
import org.python.apache.xerces.impl.xs.opti.SchemaParsingConfig;
import org.python.apache.xerces.impl.xs.util.SimpleLocator;
import org.python.apache.xerces.impl.xs.util.XSInputSource;
...
import org.python.apache.xerces.util.DefaultErrorHandler;
...
import org.python.apache.xerces.xni.grammars.XMLSchemaDescription;
...
import org.python.apache.xerces.xs.XSParticle;
import org.python.apache.xerces.xs.XSSimpleTypeDefinition;
import org.python.apache.xerces.xs.XSTerm;
...
public class XSDHandler {
   ...
   public SchemaGrammar parseSchema(XMLInputSource var1, XSDDescription var2, Hashtable var3) throws IOException {
      ...
      if (var7 == null) {
         return var1 instanceof XSInputSource ? this.fGrammarBucket.getGrammar(var2.getTargetNamespace()) : var4;
      } else {
         if (var6 == 3) {
         ...
         if (this.fRoot == null) {
            ...
            for(int var17 = this.fAllTNSs.size() - 1; var17 >= 0; --var17) {
               String var18 = (String)this.fAllTNSs.elementAt(var17);
               Vector var11 = (Vector)this.fImportMap.get(var18);
               SchemaGrammar var12 = this.fGrammarBucket.getGrammar(this.emptyString2Null(var18));
               if (var12 != null) {
                  int var13 = 0;

                  for(int var14 = 0; var14 < var11.size(); ++var14) {
                     SchemaGrammar var15 = this.fGrammarBucket.getGrammar((String)var11.elementAt(var14));
                     if (var15 != null) {
                        var11.setElementAt(var15, var13++);
                     }
                  }
   ...
   private Vector expandGrammars(SchemaGrammar[] var1) {
      ...
      for(int var4 = 0; var4 < var2.size(); ++var4) {
         SchemaGrammar var5 = (SchemaGrammar)var2.elementAt(var4);
         Vector var6 = var5.getImportedGrammars();
         if (var6 != null) {
            for(int var7 = var6.size() - 1; var7 >= 0; --var7) {
               SchemaGrammar var8 = (SchemaGrammar)var6.elementAt(var7);
   ...
   private void addNewImportedGrammars(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      if (var3 != null) {
         ...
         if (var4 == null) {
            var4 = (Vector)var3.clone();
            var2.setImportedGrammars(var4);
         } else {
            this.updateImportList(var3, var4);
         }
      }
   ...
   private void addGlobalElementDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSElementDecl)var3.item(var5);
         var7 = var2.getGlobalElementDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalElementDecl(var6);
         } else if (var7 != var6) {
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         var6 = (XSElementDecl)var8.item(var9 + 1);
         var7 = var2.getGlobalElementDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalElementDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addGlobalAttributeDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      XSAttributeDecl var7;
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSAttributeDecl)var3.item(var5);
         var7 = var2.getGlobalAttributeDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalAttributeDecl(var6);
         } else if (var7 != var6 && !this.fTolerateDuplicates) {
            this.reportSharingError(var6.getNamespace(), var6.getName());
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         String var12 = var10.substring(0, var11);
         String var13 = var10.substring(var11 + 1, var10.length());
         var6 = (XSAttributeDecl)var8.item(var9 + 1);
         var7 = var2.getGlobalAttributeDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalAttributeDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addGlobalAttributeGroupDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      XSAttributeGroupDecl var7;
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSAttributeGroupDecl)var3.item(var5);
         var7 = var2.getGlobalAttributeGroupDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalAttributeGroupDecl(var6);
         } else if (var7 != var6 && !this.fTolerateDuplicates) {
            this.reportSharingError(var6.getNamespace(), var6.getName());
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         String var12 = var10.substring(0, var11);
         String var13 = var10.substring(var11 + 1, var10.length());
         var6 = (XSAttributeGroupDecl)var8.item(var9 + 1);
         var7 = var2.getGlobalAttributeGroupDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalAttributeGroupDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addGlobalNotationDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      XSNotationDecl var7;
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSNotationDecl)var3.item(var5);
         var7 = var2.getGlobalNotationDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalNotationDecl(var6);
         } else if (var7 != var6 && !this.fTolerateDuplicates) {
            this.reportSharingError(var6.getNamespace(), var6.getName());
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         String var12 = var10.substring(0, var11);
         String var13 = var10.substring(var11 + 1, var10.length());
         var6 = (XSNotationDecl)var8.item(var9 + 1);
         var7 = var2.getGlobalNotationDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalNotationDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addGlobalGroupDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      XSGroupDecl var7;
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSGroupDecl)var3.item(var5);
         var7 = var2.getGlobalGroupDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalGroupDecl(var6);
         } else if (var6 != var7 && !this.fTolerateDuplicates) {
            this.reportSharingError(var6.getNamespace(), var6.getName());
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         String var12 = var10.substring(0, var11);
         String var13 = var10.substring(var11 + 1, var10.length());
         var6 = (XSGroupDecl)var8.item(var9 + 1);
         var7 = var2.getGlobalGroupDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalGroupDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addGlobalTypeDecls(SchemaGrammar var1, SchemaGrammar var2) {
      ...
      XSTypeDefinition var7;
      for(int var5 = 0; var5 < var4; ++var5) {
         var6 = (XSTypeDefinition)var3.item(var5);
         var7 = var2.getGlobalTypeDecl(var6.getName());
         if (var7 == null) {
            var2.addGlobalTypeDecl(var6);
         } else if (var7 != var6 && !this.fTolerateDuplicates) {
            this.reportSharingError(var6.getNamespace(), var6.getName());
         }
      }
      ...
      for(int var9 = 0; var9 < var4; var9 += 2) {
         ...
         String var12 = var10.substring(0, var11);
         String var13 = var10.substring(var11 + 1, var10.length());
         var6 = (XSTypeDefinition)var8.item(var9 + 1);
         var7 = var2.getGlobalTypeDecl(var13, var12);
         if (var7 == null) {
            var2.addGlobalTypeDecl(var6, var12);
         } else if (var7 != var6) {
         }
      }
   ...
   private void addRelatedType(XSTypeDefinition var1, Vector var2, String var3, Hashtable var4) {
      if (!var1.getAnonymous()) {
         if (!var1.getNamespace().equals(SchemaSymbols.URI_SCHEMAFORSCHEMA) && !var2.contains(var1)) {
   ...
   private void addImportList(SchemaGrammar var1, Vector var2, Vector var3) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         SchemaGrammar var6 = this.fGrammarBucket.getGrammar((String)var3.elementAt(var5));
         if (var6 != null) {
            var2.add(var6);
         }
      }
   ...
   private void updateImportList(SchemaGrammar var1, Vector var2, Vector var3) {
      ...
      for(int var5 = 0; var5 < var4; ++var5) {
         SchemaGrammar var6 = this.fGrammarBucket.getGrammar((String)var3.elementAt(var5));
         if (var6 != null && !this.containedImportedGrammar(var2, var6)) {
            var2.add(var6);
         }
      }
   ...
   private boolean containedImportedGrammar(Vector var1, SchemaGrammar var2) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         SchemaGrammar var5 = (SchemaGrammar)var1.elementAt(var4);
         if (this.null2EmptyString(var5.getTargetNamespace()).equals(this.null2EmptyString(var2.getTargetNamespace()))) {
            return true;
         }
      }
   ...
   private boolean removeParticle(XSModelGroupImpl var1, XSParticleDecl var2) {
      for(int var3 = 0; var3 < var1.fParticleCount; ++var3) {
         XSParticleDecl var4 = var1.fParticles[var3];
         if (var4 == var2) {
            for(int var5 = var3; var5 < var1.fParticleCount - 1; ++var5) {
         ...
         if (var4.fType == 3 && this.removeParticle((XSModelGroupImpl)var4.fValue, var2)) {
            return true;
         }
      }
