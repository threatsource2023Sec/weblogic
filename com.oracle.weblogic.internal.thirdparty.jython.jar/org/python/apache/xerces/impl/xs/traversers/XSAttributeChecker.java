...
import org.python.apache.xerces.impl.xs.util.XIntPool;
...
public class XSAttributeChecker {
         ...
         switch (var4) {
            ...
            case -11:
               if (var6.equals("##any")) {
                  ...
                  var8 = new StringTokenizer(var6, " \n\t\r");

                  try {
                     while(var8.hasMoreTokens()) {
                        var10 = var8.nextToken();
                        String var21;
                        if (var10.equals("##local")) {
                           var21 = null;
                        } else if (var10.equals("##targetNamespace")) {
                           var21 = var5.fTargetNamespace;
                        } else {
                           fExtraDVs[0].validate((String)var10, var5.fValidationContext, (ValidatedInfo)null);
                           var21 = this.fSymbolTable.addSymbol(var10);
                        }
            ...
            case -9:
               ...
               try {
                  QName var12;
                  for(var8 = new StringTokenizer(var6, " \n\t\r"); var8.hasMoreTokens(); var11.addElement(var12)) {
                     var10 = var8.nextToken();
                     var12 = (QName)fExtraDVs[2].validate((String)var10, var5.fValidationContext, (ValidatedInfo)null);
            ...
            case -5:
               ...
               if (var6.equals("#all")) {
                  ...
                  while(var8.hasMoreTokens()) {
                     var10 = var8.nextToken();
                     if (var10.equals("extension")) {
                        var9 |= 1;
                     } else if (var10.equals("restriction")) {
                        var9 |= 2;
                     } else if (var10.equals("list")) {
                        var9 |= 16;
                     } else {
                        if (!var10.equals("union")) {
            ...
            case -4:
               ...
               if (var6.equals("#all")) {
                  ...
                  while(var8.hasMoreTokens()) {
                     var10 = var8.nextToken();
                     if (var10.equals("list")) {
                        var9 |= 16;
                     } else if (var10.equals("union")) {
                        var9 |= 8;
                     } else {
                        if (!var10.equals("restriction")) {
      ...
      while(true) {
         ...
         do {
            ...
            do {
               ...
               var8 = var7.getGlobalAttributeDecl(var6);
            } while(var8 == null);

            var9 = (XSSimpleType)var8.getTypeDefinition();
         } while(var9 == null);

         Vector var10 = (Vector)var3.getValue();
         String var11 = (String)var10.elementAt(0);
         int var12 = var10.size();

         for(int var13 = 1; var13 < var12; var13 += 2) {
            String var14 = (String)var10.elementAt(var13);

            try {
               var9.validate((String)((String)var10.elementAt(var13 + 1)), (ValidationContext)null, (ValidatedInfo)null);
            } catch (InvalidDatatypeValueException var16) {
               this.reportSchemaError("s4s-att-invalid-value", new Object[]{var14, var11, var16.getMessage()}, (Element)null);
            }
         }
      }
   }
   ...
   public void resolveNamespace(Element var1, Attr[] var2, SchemaNamespaceSupport var3) {
      ...
      for(int var6 = 0; var6 < var4; ++var6) {
         var5 = var2[var6];
         String var7 = DOMUtil.getName(var5);
         String var8 = null;
         if (var7.equals(XMLSymbols.PREFIX_XMLNS)) {
            var8 = XMLSymbols.EMPTY_STRING;
         } else if (var7.startsWith("xmlns:")) {
            var8 = this.fSymbolTable.addSymbol(DOMUtil.getLocalName(var5));
         }

         if (var8 != null) {
            String var9 = this.fSymbolTable.addSymbol(DOMUtil.getValue(var5));
            var3.declarePrefix(var8, var9.length() != 0 ? var9 : null);
         }
      }
