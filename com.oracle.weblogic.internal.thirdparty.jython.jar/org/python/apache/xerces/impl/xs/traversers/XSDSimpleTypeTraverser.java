   ...
   private XSSimpleType getSimpleType(String var1, Element var2, Object[] var3, XSDocumentInfo var4, SchemaGrammar var5) {
      ...
      if (var8 == null) {
         ...
         if (var14 && var18 != null && var18.size() > 0) {
            var23 = var18.size();
            var34 = new ArrayList(var23);

            for(int var24 = 0; var24 < var23; ++var24) {
               var35 = this.findDTValidator(var8, var1, (QName)var18.elementAt(var24), (short)8, var4);
               if (var35 != null) {
                  if (var35.getVariety() == 3) {
                     var25 = var35.getMemberTypes();

                     for(int var26 = 0; var26 < var25.getLength(); ++var26) {
                        var34.add(var25.item(var26));
                     }
                  } else {
                     var34.add(var35);
                  }
                  ...
                  do {
                     ...
                     if (var35 != null) {
                        if (var35.getVariety() == 3) {
                           ...
                           for(var23 = 0; var23 < var25.getLength(); ++var23) {
                              var34.add(var25.item(var23));
                           }
                        } else {
                           var34.add(var35);
                        }
         ...
         if ((var12 || var13) && var32 == null) {
            ...
            if (var13 && this.isListDatatype(var32)) {
               ...
               if (var12 && var19 != null) {
                  XSDAbstractTraverser.FacetInfo var38 = this.traverseFacets(var19, var32, var4);
