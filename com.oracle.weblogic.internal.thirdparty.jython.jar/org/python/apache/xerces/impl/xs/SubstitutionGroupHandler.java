...
public class SubstitutionGroupHandler {
   ...
   public void addSubstitutionGroup(XSElementDecl[] var1) {
      for(int var2 = var1.length - 1; var2 >= 0; --var2) {
         XSElementDecl var3 = var1[var2];
         XSElementDecl var4 = var3.fSubGroup;
         Vector var5 = (Vector)this.fSubGroupsB.get(var4);
         if (var5 == null) {
            var5 = new Vector();
            this.fSubGroupsB.put(var4, var5);
         }
   ...
   private OneSubGroup[] getSubGroupB(XSElementDecl var1, OneSubGroup var2) {
      ...
      if (var3 == null) {
         ...
         for(int var6 = var4.size() - 1; var6 >= 0; --var6) {
            XSElementDecl var7 = (XSElementDecl)var4.elementAt(var6);
            if (this.getDBMethods(var7.fType, var1.fType, var2)) {
               short var8 = var2.dMethod;
               short var9 = var2.bMethod;
               var5.addElement(new OneSubGroup(var7, var2.dMethod, var2.bMethod));
               OneSubGroup[] var10 = this.getSubGroupB(var7, var2);

               for(int var11 = var10.length - 1; var11 >= 0; --var11) {
                  short var12 = (short)(var8 | var10[var11].dMethod);
                  short var13 = (short)(var9 | var10[var11].bMethod);
                  if ((var12 & var13) == 0) {
                     var5.addElement(new OneSubGroup(var10[var11].sub, var12, var13));
                  }
               }
            }
         }
