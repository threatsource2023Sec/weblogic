...
import org.python.apache.xerces.impl.io.UCSReader;
import org.python.apache.xerces.impl.io.UTF16Reader;
...
import org.python.apache.xerces.util.XMLEntityDescriptionImpl;
...
public class XMLEntityManager implements XMLComponent, XMLEntityResolver {
         ...
         if (var8 == null) {
            ...
            if (var8.equals("UTF-8")) {
               ...
               if (var25 >= 2) {
                  int var28 = var24[0];
                  int var29 = var24[1];
                  if (var28 == 254 && var29 == 255) {
                     var10 = Boolean.TRUE;
                     var22.skip(2L);
                  } else if (var28 == 255 && var29 == 254) {
                     var10 = Boolean.FALSE;
                     var22.skip(2L);
                  } else if (var25 == 4) {
                     int var30 = var24[2];
                     int var31 = var24[3];
                     if (var28 == 0 && var29 == 60 && var30 == 0 && var31 == 63) {
                        var10 = Boolean.TRUE;
                     }

                     if (var28 == 60 && var29 == 0 && var30 == 63 && var31 == 0) {
                        var10 = Boolean.FALSE;
                     }
                  }
               }
   ...
   private static synchronized URI getUserDir() throws URI.MalformedURIException {
      ...
      if (var0.length() == 0) {
         ...
         gUserDirURI = new URI("file", "", var3.toString(), (String)null, (String)null);
         return gUserDirURI;
      }
   }
   ...
   private static class EncodingInfo {
      ...
      static {
         UTF_16_BIG_ENDIAN = new EncodingInfo("UTF-16", Boolean.TRUE, false);
         UTF_16_BIG_ENDIAN_WITH_BOM = new EncodingInfo("UTF-16", Boolean.TRUE, true);
         UTF_16_LITTLE_ENDIAN = new EncodingInfo("UTF-16", Boolean.FALSE, false);
         UTF_16_LITTLE_ENDIAN_WITH_BOM = new EncodingInfo("UTF-16", Boolean.FALSE, true);
