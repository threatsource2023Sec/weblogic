...
public class ExtendedSchemaDVFactoryImpl extends BaseSchemaDVFactory {
   ...
   static void createBuiltInTypes() {
      ...
      XSSimpleTypeDecl var0 = (XSSimpleTypeDecl)fBuiltInTypes.get("duration");
      fBuiltInTypes.put("yearMonthDuration", new XSSimpleTypeDecl(var0, "yearMonthDuration", (short)27, (short)1, false, false, false, true, (short)46));
      fBuiltInTypes.put("dayTimeDuration", new XSSimpleTypeDecl(var0, "dayTimeDuration", (short)28, (short)1, false, false, false, true, (short)47));
   }
