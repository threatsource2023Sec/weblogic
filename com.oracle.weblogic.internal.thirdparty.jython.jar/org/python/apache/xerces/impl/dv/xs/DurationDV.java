...
public class DurationDV extends AbstractDateTimeDV {
   ...
   protected short compareDates(AbstractDateTimeDV.DateTimeData var1, AbstractDateTimeDV.DateTimeData var2, boolean var3) {
      boolean var4 = true;
      short var5 = this.compareOrder(var1, var2);
      if (var5 == 0) {
         return 0;
      } else {
         ...
         var5 = this.compareOrder(var7, var8);
         if (var5 == 2) {
            return 2;
         } else {
            ...
            var5 = this.compareResults(var5, var9, var3);
            if (var5 == 2) {
               return 2;
            } else {
   ...
   protected double parseSecond(String var1, int var2, int var3) throws NumberFormatException {
      ...
      if (var4 + 1 == var3) {
         ...
         double var7 = Double.parseDouble(var1.substring(var2, var3));
         if (var7 == Double.POSITIVE_INFINITY) {
            throw new NumberFormatException("'" + var1 + "' has wrong format");
         } else {
            return var7;
         }
