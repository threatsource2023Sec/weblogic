...
import org.python.apache.xerces.jaxp.datatype.DatatypeFactoryImpl;
import org.python.apache.xerces.xs.datatypes.XSDateTime;
...
public abstract class AbstractDateTimeDV extends TypeValidator {
   ...
   protected short compareDates(DateTimeData var1, DateTimeData var2, boolean var3) {
      if (var1.utc == var2.utc) {
         ...
         DateTimeData var4 = new DateTimeData((String)null, this);
         short var5;
         short var6;
         if (var1.utc == 90) {
            this.cloneDate(var2, var4);
            var4.timezoneHr = 14;
            var4.timezoneMin = 0;
            var4.utc = 43;
            this.normalize(var4);
            var5 = this.compareOrder(var1, var4);
            if (var5 == -1) {
               return var5;
            } else {
               this.cloneDate(var2, var4);
               ...
               var4.utc = 45;
               this.normalize(var4);
               var6 = this.compareOrder(var1, var4);
               return var6 == 1 ? var6 : 2;
            }
         } else if (var2.utc == 90) {
            this.cloneDate(var1, var4);
            var4.timezoneHr = -14;
            var4.timezoneMin = 0;
            var4.utc = 45;
            this.normalize(var4);
            var5 = this.compareOrder(var4, var2);
            if (var5 == -1) {
               return var5;
            } else {
               this.cloneDate(var1, var4);
               ...
               var4.utc = 43;
               this.normalize(var4);
               var6 = this.compareOrder(var4, var2);
               return var6 == 1 ? var6 : 2;
            }
         } else {
            return 2;
   ...
   protected int parseIntYear(String var1, int var2) {
      ...
      int var10;
      for(int var9 = var8 / var3; var6 < var2; var4 -= var10) {
