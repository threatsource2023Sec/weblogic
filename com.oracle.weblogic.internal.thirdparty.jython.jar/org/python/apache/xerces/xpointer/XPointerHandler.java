   ...
   private class Scanner {
      ...
      private boolean scanExpr(SymbolTable var1, Tokens var2, String var3, int var4, int var5) throws XNIException {
         ...
         while(true) {
            if (var4 != var5) {
               int var13;
               for(var13 = var3.charAt(var4); var13 == 32 || var13 == 10 || var13 == 9 || var13 == 13; var13 = var3.charAt(var4)) {
                  ++var4;
                  if (var4 == var5) {
                     break;
                  }
               ...
               if (var4 != var5) {
                  byte var14 = var13 >= 128 ? 14 : this.fASCIICharMap[var13];
                  switch (var14) {
                     case 1:
                     case 2:
                     case 3:
                     ...
                     case 14:
                        ...
                        if (var6 == 0) {
                           ...
                           if (var4 < var5) {
                              var13 = var3.charAt(var4);
                           } else {
                              var13 = -1;
                           }

                           var9 = var1.addSymbol(var3.substring(var15, var4));
                           var10 = XMLSymbols.EMPTY_STRING;
                           if (var13 == 58) {
                              ++var4;
                              if (var4 == var5) {
                                 return false;
                        ...
                        if (var6 > 0 && var7 == 0 && var9 != null) {
                           int var16 = var4;
                           var4 = this.scanData(var3, var12, var5, var4);
                           if (var4 == var16) {
                           ...
                           var11 = var1.addSymbol(var12.toString());
                           this.addToken(var2, 4);
                           var2.addToken(var11);
                           var6 = 0;
                           var12.delete(0, var12.length());
                           continue;
                        }
