...
public class RangeImpl implements Range {
   ...
   public void insertNode(Node var1) throws DOMException, RangeException {
      if (var1 != null) {
         ...
         if (this.fStartContainer.getNodeType() == 3) {
            Node var4 = this.fStartContainer.getParentNode();
            var3 = var4.getChildNodes().getLength();
            Node var5 = this.fStartContainer.cloneNode(false);
            ((TextImpl)var5).setNodeValueInternal(var5.getNodeValue().substring(this.fStartOffset));
            ((TextImpl)this.fStartContainer).setNodeValueInternal(this.fStartContainer.getNodeValue().substring(0, this.fStartOffset));
            Node var6 = this.fStartContainer.getNextSibling();
            if (var6 != null) {
               if (var4 != null) {
                  var4.insertBefore(var1, var6);
                  var4.insertBefore(var5, var6);
               }
            } else if (var4 != null) {
            ...
            if (this.fEndContainer == this.fStartContainer) {
               this.fEndContainer = var5;
               this.fEndOffset -= this.fStartOffset;
            } else if (this.fEndContainer == var4) {
               this.fEndOffset += var4.getChildNodes().getLength() - var3;
            }

            this.signalSplitData(this.fStartContainer, var5, this.fStartOffset);
         } else {
            if (this.fEndContainer == this.fStartContainer) {
               var3 = this.fEndContainer.getChildNodes().getLength();
            }

            Node var7 = this.fStartContainer.getFirstChild();
            boolean var8 = false;

            for(int var9 = 0; var9 < this.fStartOffset && var7 != null; ++var9) {
               var7 = var7.getNextSibling();
            }

            if (var7 != null) {
               this.fStartContainer.insertBefore(var1, var7);
            } else {
               this.fStartContainer.appendChild(var1);
            }

            if (this.fEndContainer == this.fStartContainer && this.fEndOffset != 0) {
               this.fEndOffset += this.fEndContainer.getChildNodes().getLength() - var3;
            }
         }
   ...
   private Node traverseCharacterDataNode(Node var1, boolean var2, int var3) {
      ...
      String var7;
      if (var2) {
         var5 = this.getStartOffset();
         var6 = var4.substring(var5);
         var7 = var4.substring(0, var5);
      } else {
         var5 = this.getEndOffset();
         var6 = var4.substring(0, var5);
         var7 = var4.substring(var5);
      }

      if (var3 != 2) {
         var1.setNodeValue(var7);
      }
