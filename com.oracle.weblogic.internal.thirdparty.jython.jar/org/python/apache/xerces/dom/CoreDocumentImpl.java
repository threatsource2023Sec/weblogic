...
public class CoreDocumentImpl extends ParentNode implements Document {
   ...
   public Object getFeature(String var1, String var2) {
      ...
      if (var1.equalsIgnoreCase("+XPath") && (var3 || var2.equals("3.0"))) {
         if (this.fXPathEvaluator != null) {
            ...
            try {
               Class var4 = ObjectFactory.findProviderClass("org.python.apache.xpath.domapi.XPathEvaluatorImpl", ObjectFactory.findClassLoader(), true);
   ...
   private Node importNode(Node var1, boolean var2, boolean var3, HashMap var4) throws DOMException {
      ...
      switch (var7) {
         case 1:
            boolean var18 = var1.getOwnerDocument().getImplementation().hasFeature("XML", "2.0");
            Element var23;
            if (var18 && var1.getLocalName() != null) {
               var23 = this.createElementNS(var1.getNamespaceURI(), var1.getNodeName());
            } else {
               var23 = this.createElement(var1.getNodeName());
            }
            ...
            if (var10 != null) {
               ...
               for(var12 = 0; var12 < var24; ++var12) {
                  ...
                  if (var13.getSpecified() || var3) {
                     ...
                     if (var18 && var13.getLocalName() != null) {
                        var23.setAttributeNodeNS(var14);
                     } else {
                        var23.setAttributeNode(var14);
                     }
                  }
               }
            }
            ...
            if (var4 != null) {
               Object var25 = var4.get(var1);
               if (var25 != null) {
                  if (this.identifiers == null) {
                     this.identifiers = new Hashtable();
                  }

                  this.identifiers.put(var25, var23);
               }
            }
         ...
         case 2:
            ...
            if (var1 instanceof AttrImpl) {
               AttrImpl var22 = (AttrImpl)var1;
               if (var22.hasStringValue()) {
                  AttrImpl var17 = (AttrImpl)var5;
                  var17.setValue(var22.getValue());
                  var2 = false;
               } else {
                  var2 = true;
               }
         ...
         case 5:
            ...
            break;
         case 6:
            Entity var21 = (Entity)var1;
            EntityImpl var16 = (EntityImpl)this.createEntity(var1.getNodeName());
            var16.setPublicId(var21.getPublicId());
            var16.setSystemId(var21.getSystemId());
            var16.setNotationName(var21.getNotationName());
            var16.isReadOnly(false);
            var5 = var16;
            break;
         case 7:
         ...
         case 9:
         default:
            var20 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", (Object[])null);
            throw new DOMException((short)9, var20);
         case 10:
            if (!var3) {
               var20 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NOT_SUPPORTED_ERR", (Object[])null);
               throw new DOMException((short)9, var20);
            ...
            DocumentType var19 = (DocumentType)var1;
            DocumentTypeImpl var15 = (DocumentTypeImpl)this.createDocumentType(var19.getNodeName(), var19.getPublicId(), var19.getSystemId());
            var15.setInternalSubset(var19.getInternalSubset());
            var10 = var19.getEntities();
            NamedNodeMap var11 = var15.getEntities();
            if (var10 != null) {
            ...
            var10 = var19.getNotations();
            var11 = var15.getNotations();
            if (var10 != null) {
               for(var12 = 0; var12 < var10.getLength(); ++var12) {
                  var11.setNamedItem(this.importNode(var10.item(var12), true, true, var4));
               }
         ...
         case 11:
            ...
            break;
         case 12:
            Notation var9 = (Notation)var1;
            NotationImpl var8 = (NotationImpl)this.createNotation(var1.getNodeName());
            var8.setPublicId(var9.getPublicId());
            var8.setSystemId(var9.getSystemId());
            var5 = var8;
      }
      ...
      if (var2) {
         for(Node var26 = var1.getFirstChild(); var26 != null; var26 = var26.getNextSibling()) {
            ((Node)var5).appendChild(this.importNode(var26, true, var3, var4));
         }
      }
   ...
   public Node adoptNode(Node var1) {
      ...
      if (var1 == null) {
         ...
         switch (var3.getNodeType()) {
            case 1:
               var2 = var3.getUserDataRecord();
               var11 = var3.getParentNode();
               if (var11 != null) {
               ...
               if (var2 != null) {
                  this.setUserDataTable(var3, var2);
               }

               ((ElementImpl)var3).reconcileDefaultAttributes();
               break;
            case 2:
               AttrImpl var12 = (AttrImpl)var3;
            ...
            case 5:
               ...
               Node var13;
               while((var13 = var3.getFirstChild()) != null) {
                  var3.removeChild(var13);
               }
               ...
               if (this.docType != null) {
                  ...
                  Node var7 = var6.getNamedItem(var3.getNodeName());
                  if (var7 != null) {
         ...
         if (var2 != null) {
            this.callUserDataHandlers(var1, (Node)null, (short)5, var2);
         }
