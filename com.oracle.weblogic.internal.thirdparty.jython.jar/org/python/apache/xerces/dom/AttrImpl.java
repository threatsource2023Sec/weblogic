...
public class AttrImpl extends NodeImpl implements Attr, TypeInfo {
   ...
   public void normalize() {
      if (!this.isNormalized() && !this.hasStringValue()) {
         ...
         Object var3;
         for(Object var2 = var1; var2 != null; var2 = var3) {
            var3 = ((Node)var2).getNextSibling();
            if (((Node)var2).getNodeType() == 3) {
               if (var3 != null && ((Node)var3).getNodeType() == 3) {
                  ((Text)var2).appendData(((Node)var3).getNodeValue());
                  this.removeChild((Node)var3);
                  var3 = var2;
               } else if (((Node)var2).getNodeValue() == null || ((Node)var2).getNodeValue().length() == 0) {
