...
import org.python.apache.xerces.parsers.DOMParserImpl;
...
public class CoreDOMImplementationImpl implements DOMImplementation, DOMImplementationLS {
   ...
   public Object getFeature(String var1, String var2) {
      if (singleton.hasFeature(var1, var2)) {
         ...
         try {
            Class var3 = ObjectFactory.findProviderClass("org.python.apache.xpath.domapi.XPathEvaluatorImpl", ObjectFactory.findClassLoader(), true);
   ...
   public LSParser createLSParser(short var1, String var2) throws DOMException {
      if (var1 == 1 && (var2 == null || "http://www.w3.org/2001/XMLSchema".equals(var2) || "http://www.w3.org/TR/REC-xml".equals(var2))) {
         return var2 != null && var2.equals("http://www.w3.org/TR/REC-xml") ? new DOMParserImpl("org.python.apache.xerces.parsers.DTDConfiguration", var2) : new DOMParserImpl("org.python.apache.xerces.parsers.XIncludeAwareParserConfiguration", var2);
      } else {
   ...
   public LSSerializer createLSSerializer() {
      try {
         Class var1 = ObjectFactory.findProviderClass("org.python.apache.xml.serializer.dom3.LSSerializerImpl", ObjectFactory.findClassLoader(), true);
   ...
   synchronized RevalidationHandler getValidator(String var1, String var2) {
      ...
      if (var1 == "http://www.w3.org/2001/XMLSchema") {
         ...
         return (RevalidationHandler)ObjectFactory.newInstance("org.python.apache.xerces.impl.xs.XMLSchemaValidator", ObjectFactory.findClassLoader(), true);
         ...
         if ("1.1".equals(var2)) {
            ...
            return (RevalidationHandler)ObjectFactory.newInstance("org.python.apache.xerces.impl.dtd.XML11DTDValidator", ObjectFactory.findClassLoader(), true);
         } else {
            ...
            return (RevalidationHandler)ObjectFactory.newInstance("org.python.apache.xerces.impl.dtd.XMLDTDValidator", ObjectFactory.findClassLoader(), true);
         }
      } else {
         return null;
      }
   ...
   final synchronized XMLDTDLoader getDTDLoader(String var1) {
      ...
      if ("1.1".equals(var1)) {
         ...
         return (XMLDTDLoader)ObjectFactory.newInstance("org.python.apache.xerces.impl.dtd.XML11DTDProcessor", ObjectFactory.findClassLoader(), true);
      } else {
