...
import org.python.apache.xerces.impl.dtd.XMLDTDLoader;
   ...
   protected final void namespaceFixUp(ElementImpl var1, AttributeMap var2) {
      ...
      if (var2 != null) {
         for(var3 = 0; var3 < var2.getLength(); ++var3) {
            var4 = (Attr)var2.getItem(var3);
            var5 = var4.getNamespaceURI();
            if (var5 != null && var5.equals(NamespaceContext.XMLNS_URI)) {
               var6 = var4.getNodeValue();
               if (var6 == null) {
                  var6 = XMLSymbols.EMPTY_STRING;
               }

               if (this.fDocument.errorChecking && var6.equals(NamespaceContext.XMLNS_URI)) {
                  this.fLocator.fRelatedNode = var4;
                  var7 = DOMMessageFormatter.formatMessage("http://www.w3.org/TR/1998/REC-xml-19980210", "CantBindXMLNS", (Object[])null);
                  reportDOMError(this.fErrorHandler, this.fError, this.fLocator, var7, (short)2, "CantBindXMLNS");
               } else {
                  var8 = var4.getPrefix();
                  var8 = var8 != null && var8.length() != 0 ? this.fSymbolTable.addSymbol(var8) : XMLSymbols.EMPTY_STRING;
                  var7 = this.fSymbolTable.addSymbol(var4.getLocalName());
                  if (var8 == XMLSymbols.PREFIX_XMLNS) {
                     var6 = this.fSymbolTable.addSymbol(var6);
                     if (var6.length() != 0) {
                        this.fNamespaceContext.declarePrefix(var7, var6);
                     }
                  } else {
                     var6 = this.fSymbolTable.addSymbol(var6);
                     this.fNamespaceContext.declarePrefix(XMLSymbols.EMPTY_STRING, var6.length() != 0 ? var6 : null);
                  }
               }
            }
         }
      ...
      if (var5 != null) {
         ...
         var8 = var8 != null && var8.length() != 0 ? this.fSymbolTable.addSymbol(var8) : XMLSymbols.EMPTY_STRING;
         if (this.fNamespaceContext.getURI(var8) != var5) {
            this.addNamespaceDecl(var8, var5, var1);
            this.fLocalNSBinder.declarePrefix(var8, var5);
            this.fNamespaceContext.declarePrefix(var8, var5);
         }
      ...
      if (var2 != null) {
         ...
         for(var3 = 0; var3 < this.fAttributeList.size(); ++var3) {
            var4 = (Attr)this.fAttributeList.get(var3);
            this.fLocator.fRelatedNode = var4;
            var4.normalize();
            var6 = var4.getValue();
            var5 = var4.getNamespaceURI();
            ...
            String var9;
            if (this.fDocument.errorChecking && (this.fConfiguration.features & 256) != 0) {
               isAttrValueWF(this.fErrorHandler, this.fError, this.fLocator, var2, var4, var6, this.fDocument.isXML11Version());
               if (this.fDocument.isXMLVersionChanged()) {
                  boolean var12;
                  if (this.fNamespaceValidation) {
                     var12 = CoreDocumentImpl.isValidQName(var4.getPrefix(), var4.getLocalName(), this.fDocument.isXML11Version());
                  } else {
                     var12 = CoreDocumentImpl.isXMLName(var4.getNodeName(), this.fDocument.isXML11Version());
                  }

                  if (!var12) {
                     var9 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "wf-invalid-character-in-node-name", new Object[]{"Attr", var4.getNodeName()});
            ...
            if (var5 == null) {
               ((AttrImpl)var4).setIdAttribute(false);
               if (var4.getLocalName() == null) {
                  if (this.fNamespaceValidation) {
                     var7 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NullLocalAttrName", new Object[]{var4.getNodeName()});
                     reportDOMError(this.fErrorHandler, this.fError, this.fLocator, var7, (short)3, "NullLocalAttrName");
                  } else {
                     var7 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NullLocalAttrName", new Object[]{var4.getNodeName()});
                     reportDOMError(this.fErrorHandler, this.fError, this.fLocator, var7, (short)2, "NullLocalAttrName");
                  }
               }
            } else {
               var8 = var4.getPrefix();
               var8 = var8 != null && var8.length() != 0 ? this.fSymbolTable.addSymbol(var8) : XMLSymbols.EMPTY_STRING;
               this.fSymbolTable.addSymbol(var4.getLocalName());
               if (var5 == null || !var5.equals(NamespaceContext.XMLNS_URI)) {
                  ((AttrImpl)var4).setIdAttribute(false);
                  var5 = this.fSymbolTable.addSymbol(var5);
                  var7 = this.fNamespaceContext.getURI(var8);
                  if (var8 == XMLSymbols.EMPTY_STRING || var7 != var5) {
                     var9 = this.fNamespaceContext.getPrefix(var5);
                     if (var9 != null && var9 != XMLSymbols.EMPTY_STRING) {
                        var8 = var9;
                     } else {
                        if (var8 == XMLSymbols.EMPTY_STRING || this.fLocalNSBinder.getURI(var8) != null) {
                           int var10 = 1;

                           for(var8 = this.fSymbolTable.addSymbol("NS" + var10++); this.fLocalNSBinder.getURI(var8) != null; var8 = this.fSymbolTable.addSymbol("NS" + var10++)) {
                           }
                        }

                        this.addNamespaceDecl(var8, var5, var1);
                        var6 = this.fSymbolTable.addSymbol(var6);
                        this.fLocalNSBinder.declarePrefix(var8, var6);
                        this.fNamespaceContext.declarePrefix(var8, var5);
                     }
