   ...
   private void setName(String var1, String var2) {
      ...
      if (var2 == null) {
         ...
         if (var4 < 0) {
            ...
            if (this.ownerDocument.errorChecking) {
               if (var1 == null || var6.equals("xml") && !var1.equals(NamespaceContext.XML_URI)) {
                  var3 = DOMMessageFormatter.formatMessage("http://www.w3.org/dom/DOMTR", "NAMESPACE_ERR", (Object[])null);
                  throw new DOMException((short)14, var3);
               }

               this.ownerDocument.checkQName(var6, this.localName);
               this.ownerDocument.checkDOMNSErr(var6, var1);
            }
         }
