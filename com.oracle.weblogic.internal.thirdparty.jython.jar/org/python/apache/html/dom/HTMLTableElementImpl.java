...
public class HTMLTableElementImpl extends HTMLElementImpl implements HTMLTableElement {
   ...
   void insertRowX(int var1, HTMLTableRowElementImpl var2) {
      ...
      for(Node var4 = this.getFirstChild(); var4 != null; var4 = var4.getNextSibling()) {
         if (var4 instanceof HTMLTableRowElement) {
            if (var1 == 0) {
               this.insertBefore(var2, var4);
               return;
            }
         } else if (var4 instanceof HTMLTableSectionElementImpl) {
            var3 = var4;
            var1 = ((HTMLTableSectionElementImpl)var4).insertRowX(var1, var2);
            if (var1 < 0) {
               return;
            }
         }
