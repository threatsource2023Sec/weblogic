...
public class HTMLDocumentImpl extends DocumentImpl implements HTMLDocument {
   ...
   public synchronized HTMLElement getHead() {
      ...
      synchronized(var1) {
         Node var3;
         for(var3 = var1.getFirstChild(); var3 != null && !(var3 instanceof HTMLHeadElement); var3 = var3.getNextSibling()) {
         }
         ...
         if (var3 != null) {
            synchronized(var3) {
               ...
               while(true) {
                  ...
                  var3.insertBefore(var5, var3.getFirstChild());
                  var5 = var6;
               }
            }

            HTMLElement var7 = (HTMLElement)var3;
            return var7;
         }

         var11 = new HTMLHeadElementImpl(this, "HEAD");
         var1.insertBefore(var11, var1.getFirstChild());
      }
   ...
   public synchronized HTMLElement getBody() {
      ...
      synchronized(var1) {
         Node var4;
         for(var4 = var2.getNextSibling(); var4 != null && !(var4 instanceof HTMLBodyElement) && !(var4 instanceof HTMLFrameSetElement); var4 = var4.getNextSibling()) {
         }

         if (var4 != null) {
            synchronized(var4) {
               Node var6 = var2.getNextSibling();
               ...
               while(true) {
                  ...
                  Node var7 = var6.getNextSibling();
                  var4.insertBefore(var6, var4.getFirstChild());
                  var6 = var7;
               }
            }

            HTMLElement var8 = (HTMLElement)var4;
            return var8;
         }
   ...
   public synchronized void setBody(HTMLElement var1) {
      synchronized(var1) {
         Element var3 = this.getDocumentElement();
         ...
         synchronized(var3) {
            ...
            if (var6.getLength() > 0) {
               ...
               synchronized(var7) {
                  for(Object var9 = var4; var9 != null; var9 = ((Node)var9).getNextSibling()) {
                     if (var9 instanceof Element) {
                        if (var9 != var7) {
                           var3.insertBefore(var1, (Node)var9);
                        } else {
                           var3.replaceChild(var1, var7);
                        }
   ...
   private static void populateElementType(String var0, String var1) {
      try {
         _elementTypesHTML.put(var0, ObjectFactory.findProviderClass("org.python.apache.html.dom." + var1, (class$org$apache$html$dom$HTMLDocumentImpl == null ? (class$org$apache$html$dom$HTMLDocumentImpl = class$("org.python.apache.html.dom.HTMLDocumentImpl")) : class$org$apache$html$dom$HTMLDocumentImpl).getClassLoader(), true));
   ...
   static {
      _elemClassSigHTML = new Class[]{class$org$apache$html$dom$HTMLDocumentImpl == null ? (class$org$apache$html$dom$HTMLDocumentImpl = class$("org.python.apache.html.dom.HTMLDocumentImpl")) : class$org$apache$html$dom$HTMLDocumentImpl, class$java$lang$String == null ? (class$java$lang$String = class$("java.lang.String")) : class$java$lang$String};
   }
}
