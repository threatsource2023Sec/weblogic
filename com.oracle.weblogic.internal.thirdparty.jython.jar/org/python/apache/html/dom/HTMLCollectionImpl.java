      ...
      synchronized(var1) {
         ...
         for(Node var4 = var1.getFirstChild(); var4 != null; var4 = var4.getNextSibling()) {
            if (var4 instanceof Element) {
               if (this.collectionMatch((Element)var4, (String)null)) {
                  ++var3;
               } else if (this.recurse()) {
                  var3 += this.getLength((Element)var4);
               }
            }
         }
         ...
         for(Node var4 = var1.getFirstChild(); var4 != null; var4 = var4.getNextSibling()) {
            if (var4 instanceof Element) {
               if (this.collectionMatch((Element)var4, (String)null)) {
                  ...
                  Node var6 = this.item((Element)var4, var2);
                  if (var6 != null) {
                     return var6;
                  }
               }
   ...
   private Node namedItem(Element var1, String var2) {
      synchronized(var1) {
         ...
         for(var4 = var1.getFirstChild(); var4 != null; var4 = var4.getNextSibling()) {
            if (var4 instanceof Element) {
               if (this.collectionMatch((Element)var4, var2)) {
                  return var4;
               }

               if (this.recurse()) {
                  Node var6 = this.namedItem((Element)var4, var2);
                  if (var6 != null) {
                     return var6;
                  }
               }
   ...
   protected boolean collectionMatch(Element var1, String var2) {
      synchronized(var1) {
         ...
         switch (this._lookingFor) {
            case -3:
               var4 = var1 instanceof HTMLTableCellElement;
               break;
            case -2:
               var4 = var1 instanceof HTMLTableSectionElement && var1.getTagName().equals("TBODY");
               break;
            case -1:
               var4 = var1 instanceof HTMLAreaElement;
            case 0:
            default:
               break;
            case 1:
               var4 = var1 instanceof HTMLAnchorElement && var1.getAttribute("name").length() > 0;
               break;
            case 2:
               var4 = var1 instanceof HTMLFormElement;
               break;
            case 3:
               var4 = var1 instanceof HTMLImageElement;
               break;
            case 4:
               var4 = var1 instanceof HTMLAppletElement || var1 instanceof HTMLObjectElement && ("application/java".equals(var1.getAttribute("codetype")) || var1.getAttribute("classid").startsWith("java:"));
               break;
            case 5:
               var4 = (var1 instanceof HTMLAnchorElement || var1 instanceof HTMLAreaElement) && var1.getAttribute("href").length() > 0;
               break;
            case 6:
               var4 = var1 instanceof HTMLOptionElement;
               break;
            case 7:
               var4 = var1 instanceof HTMLTableRowElement;
               break;
            case 8:
               var4 = var1 instanceof HTMLFormControl;
         }
         ...
         if (var4 && var2 != null) {
            ...
            var4 = var2.equals(var1.getAttribute("id"));
         }
