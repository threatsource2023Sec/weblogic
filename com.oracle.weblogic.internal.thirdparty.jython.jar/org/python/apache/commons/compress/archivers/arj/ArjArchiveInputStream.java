package org.python.apache.commons.compress.archivers.arj;
...
import org.python.apache.commons.compress.archivers.ArchiveException;
         ...
         try {
            ...
            try {
               ...
               while((extendedHeaderSize = this.read16(this.in)) > 0) {
                  extendedHeaderBytes = new byte[extendedHeaderSize];
                  this.readFully(this.in, (byte[])extendedHeaderBytes);
                  long extendedHeaderCrc32 = 4294967295L & (long)this.read32(this.in);
                  CRC32 crc32 = new CRC32();
