...
import org.python.apache.commons.compress.utils.CountingOutputStream;
...
public class TarArchiveOutputStream extends ArchiveOutputStream {
   ...
   public void putArchiveEntry(ArchiveEntry archiveEntry) throws IOException {
      if (this.finished) {
         ...
         boolean paxHeaderContainsLinkPath = linkName != null && linkName.length() > 0 && this.handleLongName(entry, linkName, paxHeaders, "linkpath", (byte)75, "link name");
   ...
   void writePaxHeaders(TarArchiveEntry entry, String entryName, Map headers) throws IOException {
      ...
      while(var7.hasNext()) {
         Map.Entry h = (Map.Entry)var7.next();
