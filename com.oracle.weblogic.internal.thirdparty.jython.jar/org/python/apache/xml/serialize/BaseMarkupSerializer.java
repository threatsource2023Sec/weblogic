...
import org.python.apache.xerces.dom.DOMLocatorImpl;
...
public abstract class BaseMarkupSerializer implements ContentHandler, DocumentHandler, LexicalHandler, DTDHandler, DeclHandler, DOMSerializer, Serializer {
      ...
      try {
         ...
         if (!var4.inCData && !var4.doCData) {
            ...
            for(int var7 = var2; var7 < var6; ++var7) {
               ...
               } else if ((var8 < ' ' || !this._encodingInfo.isPrintable(var8) || var8 == 127) && var8 != '\n' && var8 != '\r' && var8 != '\t') {
   ...
   public void processingInstructionIO(String var1, String var2) throws IOException {
      ...
      if (var4 >= 0) {
         this.fStrBuffer.append("<?").append(var1.substring(0, var4));
      } else {
      ...
      if (var2 != null) {
         ...
         var4 = var2.indexOf("?>");
         if (var4 >= 0) {
            this.fStrBuffer.append(var2.substring(0, var4));
         } else {
   ...
   public void comment(String var1) throws IOException {
      if (!this._format.getOmitComments()) {
         ...
         if (var3 >= 0) {
            this.fStrBuffer.append("<!--").append(var1.substring(0, var3)).append("-->");
         } else {
         ...
         if (this.isDocumentState()) {
            ...
            if (this._indenting && !var2.preserveSpace) {
         ...
         this.fStrBuffer.setLength(0);
         var2.afterComment = true;
         var2.afterElement = false;
      }
   }
   ...
   protected void printCDATAText(String var1) throws IOException {
      ...
      for(int var3 = 0; var3 < var2; ++var3) {
         ...
         } else if ((var4 < ' ' || !this._encodingInfo.isPrintable(var4) || var4 == 127) && var4 != '\n' && var4 != '\r' && var4 != '\t') {
            this._printer.printText("]]>&#x");
   ...
   protected ElementState enterElementState(String var1, String var2, String var3, boolean var4) {
      if (this._elementStateCount + 1 == this._elementStates.length) {
         ElementState[] var5 = new ElementState[this._elementStates.length + 10];

         for(int var6 = 0; var6 < this._elementStates.length; ++var6) {
            var5[var6] = this._elementStates[var6];
         }

         for(int var7 = this._elementStates.length; var7 < var5.length; ++var7) {
            var5[var7] = new ElementState();
         }

         this._elementStates = var5;
      }

      ++this._elementStateCount;
      ElementState var8 = this._elementStates[this._elementStateCount];
      var8.namespaceURI = var1;
      var8.localName = var2;
      var8.rawName = var3;
      var8.preserveSpace = var4;
      var8.empty = true;
      var8.afterElement = false;
      var8.afterComment = false;
      var8.doCData = var8.inCData = false;
      var8.unescaped = false;
      var8.prefixes = this._prefixes;
      this._prefixes = null;
      return var8;
   }
