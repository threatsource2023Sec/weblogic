   ...
   private static void initialize() {
      ...
      if (_byName == null) {
         try {
            ...
            var0 = (class$org$apache$xml$serialize$HTMLdtd == null ? (class$org$apache$xml$serialize$HTMLdtd = class$("org.python.apache.xml.serialize.HTMLdtd")) : class$org$apache$xml$serialize$HTMLdtd).getResourceAsStream("HTMLEntities.res");
            if (var0 == null) {
                     ...
                     if (var2.length() != 0 && var2.charAt(0) != '#') {
                        ...
                        if (var3 > 1) {
                           ...
                           if (var3 < var2.length()) {
                              ...
                              var3 = var5.indexOf(32);
                              if (var3 > 0) {
                                 var5 = var5.substring(0, var3);
                              }

                              int var6 = Integer.parseInt(var5);
                              defineEntity(var4, (char)var6);
                           }
                        }
