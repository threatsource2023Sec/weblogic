...
public abstract class SerializerFactory {
   ...
   public static void registerSerializerFactory(SerializerFactory var0) {
      Hashtable var1 = _factories;
      synchronized(var1) {
         String var2 = var0.getSupportedMethod();
         _factories.put(var2, var0);
      }
   }
   ...
   static {
      ...
      registerSerializerFactory(var0);
      String var1 = SecuritySupport.getSystemProperty("org.python.apache.xml.serialize.factories");
      if (var1 != null) {
         ...
         while(var2.hasMoreTokens()) {
            ...
            try {
               SerializerFactory var6 = (SerializerFactory)ObjectFactory.newInstance(var3, (class$org$apache$xml$serialize$SerializerFactory == null ? (class$org$apache$xml$serialize$SerializerFactory = class$("org.python.apache.xml.serialize.SerializerFactory")) : class$org$apache$xml$serialize$SerializerFactory).getClassLoader(), true);
