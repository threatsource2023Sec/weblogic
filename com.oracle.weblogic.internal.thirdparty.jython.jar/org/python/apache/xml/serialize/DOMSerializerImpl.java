...
import org.python.apache.xerces.dom.DOMNormalizer;
...
public class DOMSerializerImpl implements LSSerializer, DOMConfiguration {
   ...
   private void prepareForSerialization(XMLSerializer var1, Node var2) {
      ...
      if ((this.features & 2) != 0) {
         Node var3 = var2;
         boolean var4 = true;
         Document var5 = var2.getNodeType() == 9 ? (Document)var2 : var2.getOwnerDocument();

         try {
            java.lang.reflect.Method var6 = var5.getClass().getMethod("isXMLVersionChanged()");
            if (var6 != null) {
               var4 = (Boolean)var6.invoke(var5, (Object[])null);
            }
         ...
         if (var2.getFirstChild() == null) {
            this.verify(var2, var4, false);
         } else {
            for(; var2 != null; var2 = var8) {
               this.verify(var2, var4, false);
               var8 = var2.getFirstChild();

               while(var8 == null) {
                  var8 = var2.getNextSibling();
                  if (var8 == null) {
