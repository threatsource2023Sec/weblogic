...
public class InfoCmp {
   ...
   public static String getInfoCmp(String terminal) throws IOException, InterruptedException {
      String caps = (String)CAPS.get(terminal);
      if (caps == null) {
         Process p = (new ProcessBuilder(new String[]{"infocmp", terminal})).start();
