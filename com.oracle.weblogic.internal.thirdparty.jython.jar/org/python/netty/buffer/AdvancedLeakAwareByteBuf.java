...
final class AdvancedLeakAwareByteBuf extends SimpleLeakAwareByteBuf {
   private static final String PROP_ACQUIRE_AND_RELEASE_ONLY = "org.python.netty.leakDetection.acquireAndReleaseOnly";
   private static final boolean ACQUIRE_AND_RELEASE_ONLY = SystemPropertyUtil.getBoolean("org.python.netty.leakDetection.acquireAndReleaseOnly", false);
   ...
   static {
      if (logger.isDebugEnabled()) {
         logger.debug("-D{}: {}", "org.python.netty.leakDetection.acquireAndReleaseOnly", ACQUIRE_AND_RELEASE_ONLY);
      }
