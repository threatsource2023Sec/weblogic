...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
   ...
   private void checkPermittedDN(X500Name var1) throws NameConstraintValidatorException {
      this.checkPermittedDN(this.permittedSubtreesDN, ASN1Sequence.getInstance(var1.toASN1Primitive()));
   }

   private void checkExcludedDN(X500Name var1) throws NameConstraintValidatorException {
