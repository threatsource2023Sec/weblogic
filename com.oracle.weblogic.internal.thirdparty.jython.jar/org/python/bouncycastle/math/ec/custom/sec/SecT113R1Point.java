         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  var21 = var20.square().add(var20).add(var3).add(var2.getA());
                  if (var21.isZero()) {
                     return new SecT113R1Point(var2, var21, var2.getB().sqrt(), this.withCompression);
                  }
               ...
               return new SecT113R1Point(var2, var21, var23, new ECFieldElement[]{var24}, this.withCompression);
            }
         }
      }
   }
