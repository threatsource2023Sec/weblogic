         ...
         if (var3.isZero()) {
            ...
            if (var16.isZero()) {
               ...
               if (var4.isZero()) {
                  ...
                  if (var21.isZero()) {
                     return new SecT193R2Point(var2, var21, var2.getB().sqrt(), this.withCompression);
                  }
               ...
               return new SecT193R2Point(var2, var21, var23, new ECFieldElement[]{var24}, this.withCompression);
            }
         }
      }
   }
