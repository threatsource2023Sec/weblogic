...
import org.python.bouncycastle.math.raw.Nat448;
...
public class SecT409Field {
   ...
   protected static void implMulwAcc(long[] var0, long var1, long[] var3, int var4) {
      ...
      for(int var6 = 0; var6 < 7; ++var6) {
         ...
         int var9 = (int)var7;
         long var10 = 0L;
         long var12 = var5[var9 & 7] ^ var5[var9 >>> 3 & 7] << 3;
         int var14 = 54;

         do {
            var9 = (int)(var7 >>> var14);
            long var15 = var5[var9 & 7] ^ var5[var9 >>> 3 & 7] << 3;
            var12 ^= var15 << var14;
            var10 ^= var15 >>> -var14;
            var14 -= 6;
         } while(var14 > 0);

         var3[var4 + var6] ^= var12 & 576460752303423487L;
         var3[var4 + var6 + 1] ^= var12 >>> 59 ^ var10 << 5;
      }
