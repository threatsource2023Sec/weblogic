   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            SecP160R2Field.reduce32(var12, var7);
            var12 = Nat.shiftUpBits(5, var8, 3, 0, var5);
            SecP160R2Field.reduce32(var12, var5);
            SecP160R2FieldElement var14 = new SecP160R2FieldElement(var8);
            SecP160R2Field.square(var6, var14.x);
            SecP160R2Field.subtract(var14.x, var7, var14.x);
            SecP160R2Field.subtract(var14.x, var7, var14.x);
            SecP160R2FieldElement var15 = new SecP160R2FieldElement(var7);
            SecP160R2Field.subtract(var7, var14.x, var15.x);
            SecP160R2Field.multiply(var15.x, var6, var15.x);
            SecP160R2Field.subtract(var15.x, var5, var15.x);
            SecP160R2FieldElement var16 = new SecP160R2FieldElement(var6);
