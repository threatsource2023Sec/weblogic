   ...
   public ECPoint add(ECPoint var1) {
      if (this.isInfinity()) {
         ...
         if (var13) {
            ...
            var15 = var11;
            SecP192R1Field.square(var7.x, var11);
            var14 = var10;
            SecP192R1Field.multiply(var11, var5.x, var10);
            SecP192R1Field.multiply(var11, var7.x, var11);
            SecP192R1Field.multiply(var11, var6.x, var11);
         }
         ...
         if (var16) {
            ...
            var18 = var12;
            SecP192R1Field.square(var8.x, var12);
            var17 = var9;
            SecP192R1Field.multiply(var12, var3.x, var9);
            SecP192R1Field.multiply(var12, var8.x, var12);
            SecP192R1Field.multiply(var12, var4.x, var12);
         }

         int[] var19 = Nat192.create();
         SecP192R1Field.subtract(var17, var14, var19);
         SecP192R1Field.subtract(var18, var15, var10);
         if (Nat192.isZero(var19)) {
            return Nat192.isZero(var10) ? this.twice() : var2.getInfinity();
         } else {
            SecP192R1Field.square(var19, var11);
            int[] var22 = Nat192.create();
            SecP192R1Field.multiply(var11, var19, var22);
            SecP192R1Field.multiply(var11, var17, var11);
            SecP192R1Field.negate(var22, var22);
            Nat192.mul(var18, var22, var9);
            int var24 = Nat192.addBothTo(var11, var11, var22);
            SecP192R1Field.reduce32(var24, var22);
            SecP192R1FieldElement var25 = new SecP192R1FieldElement(var12);
            SecP192R1Field.square(var10, var25.x);
            SecP192R1Field.subtract(var25.x, var22, var25.x);
            SecP192R1FieldElement var26 = new SecP192R1FieldElement(var22);
            SecP192R1Field.subtract(var11, var25.x, var26.x);
            SecP192R1Field.multiplyAddToExt(var26.x, var10, var9);
            SecP192R1Field.reduce(var9, var26.x);
            SecP192R1FieldElement var27 = new SecP192R1FieldElement(var19);
            if (!var13) {
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            SecP192R1Field.square(var2.x, var7);
            int[] var8 = Nat192.create();
            SecP192R1Field.square(var7, var8);
            boolean var9 = var4.isOne();
            int[] var10 = var4.x;
            if (!var9) {
               var10 = var6;
               SecP192R1Field.square(var4.x, var6);
            }

            SecP192R1Field.subtract(var3.x, var10, var5);
            SecP192R1Field.add(var3.x, var10, var6);
            SecP192R1Field.multiply(var6, var5, var6);
            int var12 = Nat192.addBothTo(var6, var6, var6);
            SecP192R1Field.reduce32(var12, var6);
            SecP192R1Field.multiply(var7, var3.x, var7);
            var12 = Nat.shiftUpBits(6, var7, 2, 0);
            SecP192R1Field.reduce32(var12, var7);
            var12 = Nat.shiftUpBits(6, var8, 3, 0, var5);
            SecP192R1Field.reduce32(var12, var5);
            SecP192R1FieldElement var14 = new SecP192R1FieldElement(var8);
            SecP192R1Field.square(var6, var14.x);
            SecP192R1Field.subtract(var14.x, var7, var14.x);
            SecP192R1Field.subtract(var14.x, var7, var14.x);
            SecP192R1FieldElement var15 = new SecP192R1FieldElement(var7);
            SecP192R1Field.subtract(var7, var14.x, var15.x);
            SecP192R1Field.multiply(var15.x, var6, var15.x);
            SecP192R1Field.subtract(var15.x, var5, var15.x);
            SecP192R1FieldElement var16 = new SecP192R1FieldElement(var6);
