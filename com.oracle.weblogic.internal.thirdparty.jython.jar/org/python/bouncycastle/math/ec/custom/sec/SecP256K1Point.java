   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            var8 = Nat.shiftUpBits(8, var5, 2, 0);
            SecP256K1Field.reduce32(var8, var5);
            int[] var10 = Nat256.create();
            var8 = Nat.shiftUpBits(8, var6, 3, 0, var10);
            SecP256K1Field.reduce32(var8, var10);
            SecP256K1FieldElement var11 = new SecP256K1FieldElement(var6);
            SecP256K1Field.square(var7, var11.x);
            SecP256K1Field.subtract(var11.x, var5, var11.x);
            SecP256K1Field.subtract(var11.x, var5, var11.x);
            SecP256K1FieldElement var12 = new SecP256K1FieldElement(var5);
            SecP256K1Field.subtract(var5, var11.x, var12.x);
            SecP256K1Field.multiply(var12.x, var7, var12.x);
