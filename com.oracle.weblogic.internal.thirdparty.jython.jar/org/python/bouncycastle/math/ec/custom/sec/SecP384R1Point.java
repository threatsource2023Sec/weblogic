...
import org.python.bouncycastle.math.raw.Nat384;
   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            var12 = Nat.shiftUpBits(12, var7, 2, 0);
            SecP384R1Field.reduce32(var12, var7);
            var12 = Nat.shiftUpBits(12, var8, 3, 0, var5);
            SecP384R1Field.reduce32(var12, var5);
            SecP384R1FieldElement var14 = new SecP384R1FieldElement(var8);
            SecP384R1Field.square(var6, var14.x);
            SecP384R1Field.subtract(var14.x, var7, var14.x);
            SecP384R1Field.subtract(var14.x, var7, var14.x);
            SecP384R1FieldElement var15 = new SecP384R1FieldElement(var7);
            SecP384R1Field.subtract(var7, var14.x, var15.x);
            SecP384R1Field.multiply(var15.x, var6, var15.x);
            SecP384R1Field.subtract(var15.x, var5, var15.x);
            SecP384R1FieldElement var16 = new SecP384R1FieldElement(var6);
