...
import org.python.bouncycastle.math.raw.Nat320;
...
public class SecT283Field {
   ...
   protected static void implMulw(long var0, long var2, long[] var4, int var5) {
      ...
      int var7 = (int)var0;
      long var8 = 0L;
      long var10 = var6[var7 & 7];
      int var12 = 48;

      do {
         var7 = (int)(var0 >>> var12);
         long var13 = var6[var7 & 7] ^ var6[var7 >>> 3 & 7] << 3 ^ var6[var7 >>> 6 & 7] << 6;
         var10 ^= var13 << var12;
         var8 ^= var13 >>> -var12;
         var12 -= 9;
      } while(var12 > 0);

      var8 ^= (var0 & 72198606942111744L & var2 << 7 >> 63) >>> 8;
      var4[var5] = var10 & 144115188075855871L;
      var4[var5 + 1] = var10 >>> 57 ^ var8 << 7;
   }
