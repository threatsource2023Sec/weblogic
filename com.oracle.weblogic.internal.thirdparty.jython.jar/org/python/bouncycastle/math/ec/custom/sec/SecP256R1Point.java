   ...
   public ECPoint twice() {
      if (this.isInfinity()) {
         ...
         if (var2.isZero()) {
            ...
            var12 = Nat.shiftUpBits(8, var7, 2, 0);
            SecP256R1Field.reduce32(var12, var7);
            var12 = Nat.shiftUpBits(8, var8, 3, 0, var5);
            SecP256R1Field.reduce32(var12, var5);
            SecP256R1FieldElement var14 = new SecP256R1FieldElement(var8);
            SecP256R1Field.square(var6, var14.x);
            SecP256R1Field.subtract(var14.x, var7, var14.x);
            SecP256R1Field.subtract(var14.x, var7, var14.x);
            SecP256R1FieldElement var15 = new SecP256R1FieldElement(var7);
            SecP256R1Field.subtract(var7, var14.x, var15.x);
            SecP256R1Field.multiply(var15.x, var6, var15.x);
            SecP256R1Field.subtract(var15.x, var5, var15.x);
            SecP256R1FieldElement var16 = new SecP256R1FieldElement(var6);
