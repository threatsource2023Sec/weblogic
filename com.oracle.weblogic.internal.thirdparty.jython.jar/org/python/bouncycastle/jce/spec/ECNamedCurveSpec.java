...
public class ECNamedCurveSpec extends java.security.spec.ECParameterSpec {
   ...
   private static ECPoint convertPoint(org.python.bouncycastle.math.ec.ECPoint var0) {
      var0 = var0.normalize();
      return new ECPoint(var0.getAffineXCoord().toBigInteger(), var0.getAffineYCoord().toBigInteger());
   }

   public ECNamedCurveSpec(String var1, ECCurve var2, org.python.bouncycastle.math.ec.ECPoint var3, BigInteger var4) {
   ...
   public ECNamedCurveSpec(String var1, ECCurve var2, org.python.bouncycastle.math.ec.ECPoint var3, BigInteger var4, BigInteger var5) {
   ...
   public ECNamedCurveSpec(String var1, ECCurve var2, org.python.bouncycastle.math.ec.ECPoint var3, BigInteger var4, BigInteger var5, byte[] var6) {
