...
public class Chacha20Poly1305 implements TlsCipher {
   ...
   protected KeyParameter initRecord(StreamCipher var1, boolean var2, long var3, byte[] var5) {
   ...
   protected KeyParameter generateRecordMACKey(StreamCipher var1) {
   ...
   protected byte[] calculateRecordMAC(KeyParameter var1, byte[] var2, byte[] var3, int var4, int var5) {
   ...
   protected void updateRecordMACLength(Mac var1, int var2) {
      byte[] var3 = Pack.longToLittleEndian((long)var2 & 4294967295L);
      var1.update(var3, 0, var3.length);
   }

   protected void updateRecordMACText(Mac var1, byte[] var2, int var3, int var4) {
