...
import org.python.bouncycastle.util.Shorts;
...
public class TlsUtils {
   ...
   public static Vector getAllSignatureAlgorithms() {
      ...
      var0.addElement(Shorts.valueOf((short)0));
      var0.addElement(Shorts.valueOf((short)1));
      var0.addElement(Shorts.valueOf((short)2));
      var0.addElement(Shorts.valueOf((short)3));
      return var0;
   }
   ...
   static void validateKeyUsage(org.python.bouncycastle.asn1.x509.Certificate var0, int var1) throws IOException {
   ...
   static short getClientCertificateType(Certificate var0, Certificate var1) throws IOException {
      if (var0.isEmpty()) {
         ...
         org.python.bouncycastle.asn1.x509.Certificate var2 = var0.getCertificateAt(0);
   ...
   public static boolean isValidCipherSuiteForSignatureAlgorithms(int var0, Vector var1) {
      int var2;
      try {
         var2 = getKeyExchangeAlgorithm(var0);
      ...
      switch (var2) {
         ...
         case 4:
         case 22:
            return var1.contains(Shorts.valueOf((short)2));
         case 5:
         case 6:
         case 19:
         case 23:
            return var1.contains(Shorts.valueOf((short)1));
         case 7:
         case 8:
         case 9:
         case 10:
         ...
         case 12:
         case 20:
            return var1.contains(Shorts.valueOf((short)0));
         case 17:
            return var1.contains(Shorts.valueOf((short)3));
      }
   }
   ...
   public static Vector getUsableSignatureAlgorithms(Vector var0) {
      if (var0 == null) {
         ...
         var1.addElement(Shorts.valueOf((short)0));

         for(int var2 = 0; var2 < var0.size(); ++var2) {
            SignatureAndHashAlgorithm var3 = (SignatureAndHashAlgorithm)var0.elementAt(var2);
            Short var4 = Shorts.valueOf(var3.getSignature());
