...
public final class TnepresEngine extends SerpentEngineBase {
   ...
   protected int[] makeWorkingKey(byte[] var1) throws IllegalArgumentException {
      ...
      for(var8 = var1.length - 4; var8 > 0; var8 -= 4) {
         var2[var4++] = Pack.bigEndianToInt(var1, var8);
      }
   ...
   protected void encryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      this.X3 = Pack.bigEndianToInt(var1, var2);
      this.X2 = Pack.bigEndianToInt(var1, var2 + 4);
      this.X1 = Pack.bigEndianToInt(var1, var2 + 8);
      this.X0 = Pack.bigEndianToInt(var1, var2 + 12);
      ...
      Pack.intToBigEndian(this.wKey[131] ^ this.X3, var3, var4);
      Pack.intToBigEndian(this.wKey[130] ^ this.X2, var3, var4 + 4);
      Pack.intToBigEndian(this.wKey[129] ^ this.X1, var3, var4 + 8);
      Pack.intToBigEndian(this.wKey[128] ^ this.X0, var3, var4 + 12);
   }

   protected void decryptBlock(byte[] var1, int var2, byte[] var3, int var4) {
      this.X3 = this.wKey[131] ^ Pack.bigEndianToInt(var1, var2);
      this.X2 = this.wKey[130] ^ Pack.bigEndianToInt(var1, var2 + 4);
      this.X1 = this.wKey[129] ^ Pack.bigEndianToInt(var1, var2 + 8);
      this.X0 = this.wKey[128] ^ Pack.bigEndianToInt(var1, var2 + 12);
      ...
      this.inverseLT();
      this.ib0(this.X0, this.X1, this.X2, this.X3);
      Pack.intToBigEndian(this.X3 ^ this.wKey[3], var3, var4);
      Pack.intToBigEndian(this.X2 ^ this.wKey[2], var3, var4 + 4);
      Pack.intToBigEndian(this.X1 ^ this.wKey[1], var3, var4 + 8);
      Pack.intToBigEndian(this.X0 ^ this.wKey[0], var3, var4 + 12);
   }
}
