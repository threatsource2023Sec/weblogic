...
public class AESEngine implements BlockCipher {
   ...
   private void encryptBlock(int[][] var1) {
      ...
      int var8;
      int var9;
      for(var6 = this.C3 ^ var1[0][3]; var5 < this.ROUNDS - 1; var6 = T0[var6 & 255] ^ shift(T0[var7 >> 8 & 255], 24) ^ shift(T0[var8 >> 16 & 255], 16) ^ shift(T0[var9 >> 24 & 255], 8) ^ var1[var5++][3]) {
         var7 = T0[var2 & 255] ^ shift(T0[var3 >> 8 & 255], 24) ^ shift(T0[var4 >> 16 & 255], 16) ^ shift(T0[var6 >> 24 & 255], 8) ^ var1[var5][0];
         var8 = T0[var3 & 255] ^ shift(T0[var4 >> 8 & 255], 24) ^ shift(T0[var6 >> 16 & 255], 16) ^ shift(T0[var2 >> 24 & 255], 8) ^ var1[var5][1];
         var9 = T0[var4 & 255] ^ shift(T0[var6 >> 8 & 255], 24) ^ shift(T0[var2 >> 16 & 255], 16) ^ shift(T0[var3 >> 24 & 255], 8) ^ var1[var5][2];
         var6 = T0[var6 & 255] ^ shift(T0[var2 >> 8 & 255], 24) ^ shift(T0[var3 >> 16 & 255], 16) ^ shift(T0[var4 >> 24 & 255], 8) ^ var1[var5++][3];
         var2 = T0[var7 & 255] ^ shift(T0[var8 >> 8 & 255], 24) ^ shift(T0[var9 >> 16 & 255], 16) ^ shift(T0[var6 >> 24 & 255], 8) ^ var1[var5][0];
         var3 = T0[var8 & 255] ^ shift(T0[var9 >> 8 & 255], 24) ^ shift(T0[var6 >> 16 & 255], 16) ^ shift(T0[var7 >> 24 & 255], 8) ^ var1[var5][1];
         var4 = T0[var9 & 255] ^ shift(T0[var6 >> 8 & 255], 24) ^ shift(T0[var7 >> 16 & 255], 16) ^ shift(T0[var8 >> 24 & 255], 8) ^ var1[var5][2];
      }
      ...
      var9 = T0[var4 & 255] ^ shift(T0[var6 >> 8 & 255], 24) ^ shift(T0[var2 >> 16 & 255], 16) ^ shift(T0[var3 >> 24 & 255], 8) ^ var1[var5][2];
      var6 = T0[var6 & 255] ^ shift(T0[var2 >> 8 & 255], 24) ^ shift(T0[var3 >> 16 & 255], 16) ^ shift(T0[var4 >> 24 & 255], 8) ^ var1[var5++][3];
      this.C0 = S[var7 & 255] & 255 ^ (S[var8 >> 8 & 255] & 255) << 8 ^ (this.s[var9 >> 16 & 255] & 255) << 16 ^ this.s[var6 >> 24 & 255] << 24 ^ var1[var5][0];
      this.C1 = this.s[var8 & 255] & 255 ^ (S[var9 >> 8 & 255] & 255) << 8 ^ (S[var6 >> 16 & 255] & 255) << 16 ^ this.s[var7 >> 24 & 255] << 24 ^ var1[var5][1];
      this.C2 = this.s[var9 & 255] & 255 ^ (S[var6 >> 8 & 255] & 255) << 8 ^ (S[var7 >> 16 & 255] & 255) << 16 ^ S[var8 >> 24 & 255] << 24 ^ var1[var5][2];
      this.C3 = this.s[var6 & 255] & 255 ^ (this.s[var7 >> 8 & 255] & 255) << 8 ^ (this.s[var8 >> 16 & 255] & 255) << 16 ^ S[var9 >> 24 & 255] << 24 ^ var1[var5][3];
   }
   ...
   private void decryptBlock(int[][] var1) {
      ...
      int var8;
      int var9;
      for(var6 = this.C3 ^ var1[this.ROUNDS][3]; var5 > 1; var6 = Tinv0[var6 & 255] ^ shift(Tinv0[var9 >> 8 & 255], 24) ^ shift(Tinv0[var8 >> 16 & 255], 16) ^ shift(Tinv0[var7 >> 24 & 255], 8) ^ var1[var5--][3]) {
         var7 = Tinv0[var2 & 255] ^ shift(Tinv0[var6 >> 8 & 255], 24) ^ shift(Tinv0[var4 >> 16 & 255], 16) ^ shift(Tinv0[var3 >> 24 & 255], 8) ^ var1[var5][0];
         var8 = Tinv0[var3 & 255] ^ shift(Tinv0[var2 >> 8 & 255], 24) ^ shift(Tinv0[var6 >> 16 & 255], 16) ^ shift(Tinv0[var4 >> 24 & 255], 8) ^ var1[var5][1];
         var9 = Tinv0[var4 & 255] ^ shift(Tinv0[var3 >> 8 & 255], 24) ^ shift(Tinv0[var2 >> 16 & 255], 16) ^ shift(Tinv0[var6 >> 24 & 255], 8) ^ var1[var5][2];
         var6 = Tinv0[var6 & 255] ^ shift(Tinv0[var4 >> 8 & 255], 24) ^ shift(Tinv0[var3 >> 16 & 255], 16) ^ shift(Tinv0[var2 >> 24 & 255], 8) ^ var1[var5--][3];
         var2 = Tinv0[var7 & 255] ^ shift(Tinv0[var6 >> 8 & 255], 24) ^ shift(Tinv0[var9 >> 16 & 255], 16) ^ shift(Tinv0[var8 >> 24 & 255], 8) ^ var1[var5][0];
         var3 = Tinv0[var8 & 255] ^ shift(Tinv0[var7 >> 8 & 255], 24) ^ shift(Tinv0[var6 >> 16 & 255], 16) ^ shift(Tinv0[var9 >> 24 & 255], 8) ^ var1[var5][1];
         var4 = Tinv0[var9 & 255] ^ shift(Tinv0[var8 >> 8 & 255], 24) ^ shift(Tinv0[var7 >> 16 & 255], 16) ^ shift(Tinv0[var6 >> 24 & 255], 8) ^ var1[var5][2];
      }
      ...
      var9 = Tinv0[var4 & 255] ^ shift(Tinv0[var3 >> 8 & 255], 24) ^ shift(Tinv0[var2 >> 16 & 255], 16) ^ shift(Tinv0[var6 >> 24 & 255], 8) ^ var1[var5][2];
      var6 = Tinv0[var6 & 255] ^ shift(Tinv0[var4 >> 8 & 255], 24) ^ shift(Tinv0[var3 >> 16 & 255], 16) ^ shift(Tinv0[var2 >> 24 & 255], 8) ^ var1[var5][3];
      this.C0 = Si[var7 & 255] & 255 ^ (this.s[var6 >> 8 & 255] & 255) << 8 ^ (this.s[var9 >> 16 & 255] & 255) << 16 ^ Si[var8 >> 24 & 255] << 24 ^ var1[0][0];
      this.C1 = this.s[var8 & 255] & 255 ^ (this.s[var7 >> 8 & 255] & 255) << 8 ^ (Si[var6 >> 16 & 255] & 255) << 16 ^ this.s[var9 >> 24 & 255] << 24 ^ var1[0][1];
      this.C2 = this.s[var9 & 255] & 255 ^ (Si[var8 >> 8 & 255] & 255) << 8 ^ (Si[var7 >> 16 & 255] & 255) << 16 ^ this.s[var6 >> 24 & 255] << 24 ^ var1[0][2];
      this.C3 = Si[var6 & 255] & 255 ^ (this.s[var9 >> 8 & 255] & 255) << 8 ^ (this.s[var8 >> 16 & 255] & 255) << 16 ^ this.s[var7 >> 24 & 255] << 24 ^ var1[0][3];
   }
}
