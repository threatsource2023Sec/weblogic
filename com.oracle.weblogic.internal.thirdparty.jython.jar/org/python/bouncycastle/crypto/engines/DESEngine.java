...
public class DESEngine implements BlockCipher {
   ...
   protected void desFunc(int[] var1, byte[] var2, int var3, byte[] var4, int var5) {
      int var6 = (var2[var3 + 0] & 255) << 24;
      var6 |= (var2[var3 + 1] & 255) << 16;
      var6 |= (var2[var3 + 2] & 255) << 8;
      var6 |= var2[var3 + 3] & 255;
      int var7 = (var2[var3 + 4] & 255) << 24;
      var7 |= (var2[var3 + 5] & 255) << 16;
      var7 |= (var2[var3 + 6] & 255) << 8;
      var7 |= var2[var3 + 7] & 255;
      int var8 = (var6 >>> 4 ^ var7) & 252645135;
      var7 ^= var8;
      var6 ^= var8 << 4;
      var8 = (var6 >>> 16 ^ var7) & '\uffff';
      var7 ^= var8;
      var6 ^= var8 << 16;
      var8 = (var7 >>> 2 ^ var6) & 858993459;
      var6 ^= var8;
      var7 ^= var8 << 2;
      var8 = (var7 >>> 8 ^ var6) & 16711935;
      var6 ^= var8;
      var7 ^= var8 << 8;
      var7 = (var7 << 1 | var7 >>> 31 & 1) & -1;
      var8 = (var6 ^ var7) & -1431655766;
      var6 ^= var8;
      var7 ^= var8;
      var6 = (var6 << 1 | var6 >>> 31 & 1) & -1;

      for(int var9 = 0; var9 < 8; ++var9) {
         var8 = var7 << 28 | var7 >>> 4;
         var8 ^= var1[var9 * 4 + 0];
         int var10 = SP7[var8 & 63];
         var10 |= SP5[var8 >>> 8 & 63];
         var10 |= SP3[var8 >>> 16 & 63];
         var10 |= SP1[var8 >>> 24 & 63];
         var8 = var7 ^ var1[var9 * 4 + 1];
         var10 |= SP8[var8 & 63];
         var10 |= SP6[var8 >>> 8 & 63];
         var10 |= SP4[var8 >>> 16 & 63];
         var10 |= SP2[var8 >>> 24 & 63];
         var6 ^= var10;
         var8 = var6 << 28 | var6 >>> 4;
         var8 ^= var1[var9 * 4 + 2];
         var10 = SP7[var8 & 63];
      ...
      var7 ^= var8;
      var6 = var6 << 31 | var6 >>> 1;
      var8 = (var6 >>> 8 ^ var7) & 16711935;
      var7 ^= var8;
      var6 ^= var8 << 8;
      var8 = (var6 >>> 2 ^ var7) & 858993459;
      var7 ^= var8;
      var6 ^= var8 << 2;
      var8 = (var7 >>> 16 ^ var6) & '\uffff';
      var6 ^= var8;
      var7 ^= var8 << 16;
      var8 = (var7 >>> 4 ^ var6) & 252645135;
      var6 ^= var8;
      var7 ^= var8 << 4;
      ...
      var4[var5 + 4] = (byte)(var6 >>> 24 & 255);
      var4[var5 + 5] = (byte)(var6 >>> 16 & 255);
      var4[var5 + 6] = (byte)(var6 >>> 8 & 255);
      var4[var5 + 7] = (byte)(var6 & 255);
   }
}
