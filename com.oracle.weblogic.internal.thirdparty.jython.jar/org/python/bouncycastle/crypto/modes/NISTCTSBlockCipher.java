...
public class NISTCTSBlockCipher extends BufferedBlockCipher {
   ...
   public NISTCTSBlockCipher(int var1, BlockCipher var2) {
      this.type = var1;
      this.cipher = new CBCBlockCipher(var2);
            ...
            if (this.bufOff > var3) {
               ...
               if (this.type == 3 || this.type == 2 && (this.buf.length - this.bufOff) % var3 != 0) {
                  if (this.cipher instanceof CBCBlockCipher) {
                     var7 = ((CBCBlockCipher)this.cipher).getUnderlyingCipher();
                     var7.processBlock(this.buf, 0, var5, 0);
                  } else {
                     this.cipher.processBlock(this.buf, 0, var5, 0);
                  }

                  for(int var10 = var3; var10 != this.bufOff; ++var10) {
                     var6[var10 - var3] = (byte)(var5[var10 - var3] ^ this.buf[var10]);
                  }
                  ...
                  var7 = ((CBCBlockCipher)this.cipher).getUnderlyingCipher();
                  var7.processBlock(this.buf, this.bufOff - var3, var6, 0);
                  System.arraycopy(this.buf, 0, var5, 0, var3);
                  if (var4 != var3) {
                     System.arraycopy(var6, var4, var5, var4, var3 - var4);
                  }
