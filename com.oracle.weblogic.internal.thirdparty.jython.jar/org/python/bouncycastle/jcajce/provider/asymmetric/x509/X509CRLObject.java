...
class X509CRLObject extends X509CRL {
   ...
   protected X509CRLObject(JcaJceHelper var1, CertificateList var2) throws CRLException {
      this.bcHelper = var1;
      this.c = var2;

      try {
         this.sigAlgName = X509SignatureUtil.getSignatureName(var2.getSignatureAlgorithm());
         if (var2.getSignatureAlgorithm().getParameters() != null) {
            this.sigAlgParams = var2.getSignatureAlgorithm().getParameters().toASN1Primitive().getEncoded("DER");
         } else {
         ...
         throw new CRLException("CRL contents invalid: " + var4);
      }
   }
   ...
   public void verify(PublicKey var1) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
      Signature var2;
      try {
         var2 = this.bcHelper.createSignature(this.getSigAlgName());
      } catch (Exception var4) {
