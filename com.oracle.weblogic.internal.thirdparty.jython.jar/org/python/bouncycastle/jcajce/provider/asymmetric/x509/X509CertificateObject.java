...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier {
   ...
   public X509CertificateObject(JcaJceHelper var1, Certificate var2) throws CertificateParsingException {
      this.bcHelper = var1;
      this.c = var2;

      byte[] var3;
      try {
         var3 = this.getExtensionBytes("2.5.29.19");
         if (var3 != null) {
            this.basicConstraints = BasicConstraints.getInstance(ASN1Primitive.fromByteArray(var3));
         }
      } catch (Exception var7) {
         throw new CertificateParsingException("cannot construct BasicConstraints: " + var7);
      }

      try {
         var3 = this.getExtensionBytes("2.5.29.15");
         if (var3 != null) {
            DERBitString var4 = DERBitString.getInstance(ASN1Primitive.fromByteArray(var3));
            var3 = var4.getBytes();
            int var5 = var3.length * 8 - var4.getPadBits();
            this.keyUsage = new boolean[var5 < 9 ? 9 : var5];

            for(int var6 = 0; var6 != var5; ++var6) {
               this.keyUsage[var6] = (var3[var6 / 8] & 128 >>> var6 % 8) != 0;
            }
         } else {
            this.keyUsage = null;
         }
         ...
         throw new CertificateParsingException("cannot construct KeyUsage: " + var8);
      }
   }
   ...
   public final void verify(PublicKey var1) throws CertificateException, NoSuchAlgorithmException, InvalidKeyException, NoSuchProviderException, SignatureException {
      ...
      Signature var3;
      try {
         var3 = this.bcHelper.createSignature(var2);
      } catch (Exception var5) {
