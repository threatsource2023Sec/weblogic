...
import org.python.bouncycastle.crypto.parsers.ECIESPublicKeyParser;
...
public class IESCipher extends CipherSpi {
   ...
   public int engineGetOutputSize(int var1) {
      if (this.key == null) {
         ...
         if (this.otherKeyParameter == null) {
            var3 = 2 * (((ECKeyParameters)this.key).getParameters().getCurve().getFieldSize() + 7) / 8;
         } else {
            var3 = 0;
         }
         ...
         if (this.state != 1 && this.state != 3) {
            ...
            return this.buffer.size() + var2 + 1 + var3 + var4;
         }
      }
   }
      ...
      if (this.ivLength != 0 && (var5 == null || var5.length != this.ivLength)) {
         ...
         if (var1 != 1 && var1 != 3) {
            ...
            if (var2 instanceof PrivateKey) {
               ...
               var6 = (IESKey)var2;
               this.otherKeyParameter = ECUtils.generatePublicKeyParameter(var6.getPublic());
               this.key = ECUtil.generatePrivateKeyParameter(var6.getPrivate());
            }
            ...
            this.otherKeyParameter = ECUtil.generatePrivateKeyParameter(var6.getPrivate());
         }
      ...
      if (this.otherKeyParameter == null) {
         if (this.state != 1 && this.state != 3) {
            if (this.state != 2 && this.state != 4) {
               ...
               try {
                  this.engine.init(this.key, (CipherParameters)var5, (KeyParser)(new ECIESPublicKeyParser(var6)));
            ...
            ECKeyPairGenerator var7 = new ECKeyPairGenerator();
            var7.init(new ECKeyGenerationParameters(var6, this.random));
            final boolean var8 = this.engineSpec.getPointCompression();
            EphemeralKeyPairGenerator var9 = new EphemeralKeyPairGenerator(var7, new KeyEncoder() {
               public byte[] getEncoded(AsymmetricKeyParameter var1) {
                  return ((ECPublicKeyParameters)var1).getQ().getEncoded(var8);
               }
            });
   ...
   public static class ECIESwithCipher extends IESCipher {
      public ECIESwithCipher(BlockCipher var1, int var2) {
         super(new IESEngine(new ECDHBasicAgreement(), new KDF2BytesGenerator(DigestFactory.createSHA1()), new HMac(DigestFactory.createSHA1()), new PaddedBufferedBlockCipher(var1)), var2);
      }
   }
