...
public class PyFileIODerived extends PyFileIO implements Slotted, FinalizablePyObjectDerived, TraverseprocDerived {
   ...
   public PyObject __enter__() {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__() : super.__enter__();
   }

   public PyObject fileno() {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("fileno");
      return impl != null ? impl.__get__(this, self_type).__call__() : super.fileno();
   }

   public long seek(long pos, int whence) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("seek");
      return impl != null ? impl.__get__(this, self_type).__call__((PyObject)Py.newLong(pos), (PyObject)Py.newInteger(whence)).asLong() : super.seek(pos, whence);
   }

   public long tell() {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("tell");
      return impl != null ? impl.__get__(this, self_type).__call__().asLong() : super.tell();
   }

   public long truncate(long size) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("truncate");
      return impl != null ? impl.__get__(this, self_type).__call__((PyObject)Py.newLong(size)).asLong() : super.truncate(size);
   }

   public long truncate() {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("truncate");
      return impl != null ? impl.__get__(this, self_type).__call__().asLong() : super.truncate();
   }
   ...
   public boolean seekable() {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__().__nonzero__() : super.seekable();
   }
   ...
   public void _checkSeekable(String msg) {
      ...
      if (impl != null) {
         ...
         impl.__get__(this, self_type).__call__((PyObject)pymsg);
      } else {
   ...
   public boolean readable() {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__().__nonzero__() : super.readable();
   }
   ...
   public boolean writable() {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__().__nonzero__() : super.writable();
   }
   ...
   public boolean __exit__(PyObject type, PyObject value, PyObject traceback) {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__(type, value, traceback).__nonzero__() : super.__exit__(type, value, traceback);
   }

   public boolean isatty() {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("isatty");
      return impl != null ? impl.__get__(this, self_type).__call__().__nonzero__() : super.isatty();
   }

   public PyObject readline() {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("readline");
      return impl != null ? impl.__get__(this, self_type).__call__(Py.None) : super.readline();
   }

   public PyObject readline(int limit) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("readline");
      return impl != null ? impl.__get__(this, self_type).__call__((PyObject)Py.newInteger(limit)) : super.readline(limit);
   }
   ...
   public PyObject readall() {
      ...
      return impl != null ? impl.__get__(this, self_type).__call__() : super.readall();
   }

   public PyObject read(int n) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("read");
      return impl != null ? impl.__get__(this, self_type).__call__((PyObject)Py.newInteger(n)) : super.read(n);
   }

   public PyObject readinto(PyObject b) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("readinto");
      return impl != null ? impl.__get__(this, self_type).__call__(b) : super.readinto(b);
   }

   public PyObject write(PyObject b) {
      PyType self_type = this.getType();
      PyObject impl = self_type.lookup("write");
      return impl != null ? impl.__get__(this, self_type).__call__(b) : super.write(b);
   }
}
