      ...
      while(true) {
         ...
         for(var27 = this.readUnsignedShort(var3); var27 > 0; --var27) {
            ...
            if ("LocalVariableTable".equals(var28)) {
               ...
               var38 = this.a(var1, var2, var3 + 8, true);
               ...
               var40 = this.a(var1, var2, var3 + 8, false);
         ...
         while(var3 < var10) {
            ...
            if (var47 != null) {
               ...
               if ((var2.b & 2) == 0 && var47.b > 0) {
                  var1.visitLineNumber(var47.b, var47);

                  while(var49 != null) {
                     var1.visitLineNumber(var49.b, var47);
                     var49 = var49.k;
                  }
               }
            }

            while(var25 != null && (var25.o == var44 || var25.o == -1)) {
               if (var25.o != -1) {
                  if (var20 && !var21) {
            ...
            switch (ClassWriter.a[var46]) {
               ...
               case 6:
               case 7:
                  var31 = this.a[this.readUnsignedShort(var3 + 1)];
                  boolean var55 = var4[var31 - 1] == 11;
                  var54 = this.readClass(var31, var5);
                  var31 = this.a[this.readUnsignedShort(var31 + 2)];
               ...
               case 8:
                  var31 = this.a[this.readUnsignedShort(var3 + 1)];
                  var51 = var2.d[this.readUnsignedShort(var31)];
               ...
               case 18:
                  ...
                  if (var46 != 167 && var46 != 168) {
                     ...
                     if (var22 != 0 && (var25 == null || var25.o != var44 + 3)) {
            ...
            for(var3 += 5; var38 != null && var14 < var38.length && var43 <= var44; var43 = var14 < var38.length && this.readByte(var38[var14]) >= 67 ? this.readUnsignedShort(var38[var14] + 1) : -1) {
               if (var43 == var44) {
                  var31 = this.a(var2, var38[var14]);
                  this.a(var31 + 2, var5, true, var1.visitInsnAnnotation(var2.i, var2.j, this.readUTF8(var31, var5), true));
               }
            ...
            while(var40 != null && var41 < var40.length && var17 <= var44) {
               if (var17 == var44) {
                  var31 = this.a(var2, var40[var41]);
                  this.a(var31 + 2, var5, true, var1.visitInsnAnnotation(var2.i, var2.j, this.readUTF8(var31, var5), false));
               }
         ...
         if (var38 != null) {
            for(var44 = 0; var44 < var38.length; ++var44) {
               if (this.readByte(var38[var44]) >> 1 == 32) {
                  var29 = this.a(var2, var38[var44]);
                  this.a(var29 + 2, var5, true, var1.visitLocalVariableAnnotation(var2.i, var2.j, var2.l, var2.m, var2.n, this.readUTF8(var29, var5), true));
               }
            }
         }
         ...
         if (var40 != null) {
            for(var44 = 0; var44 < var40.length; ++var44) {
               if (this.readByte(var40[var44]) >> 1 == 32) {
                  var29 = this.a(var2, var40[var44]);
                  this.a(var29 + 2, var5, true, var1.visitLocalVariableAnnotation(var2.i, var2.j, var2.l, var2.m, var2.n, this.readUTF8(var29, var5), false));
               }
            }
         }
