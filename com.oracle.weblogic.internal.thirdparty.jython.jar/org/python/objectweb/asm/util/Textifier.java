...
import org.python.objectweb.asm.TypeReference;
...
public class Textifier extends Printer {
   ...
   // $FF: synthetic field
   static Class class$org$objectweb$asm$util$Textifier = class$("org.python.objectweb.asm.util.Textifier");
   ...
   public Textifier visitParameterAnnotation(int var1, String var2, boolean var3) {
      ...
      this.text.add(new Integer(var1));
      this.text.add("\n");
      return var4;
   }
