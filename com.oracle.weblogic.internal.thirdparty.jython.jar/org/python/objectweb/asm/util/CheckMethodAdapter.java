...
public class CheckMethodAdapter extends MethodVisitor {
   ...
   public void visitLabel(Label var1) {
      ...
      if (this.labels.get(var1) != null) {
         ...
         this.labels.put(var1, new Integer(this.insnCount));
   ...
   private static Field getLabelField(String var0) {
      try {
         Field var1 = class$org$objectweb$asm$Label.getDeclaredField(var0);
   ...
   private static void _clinit_() {
      class$org$objectweb$asm$util$CheckMethodAdapter = class$("org.python.objectweb.asm.util.CheckMethodAdapter");
      class$org$objectweb$asm$Label = class$("org.python.objectweb.asm.Label");
   }
}
