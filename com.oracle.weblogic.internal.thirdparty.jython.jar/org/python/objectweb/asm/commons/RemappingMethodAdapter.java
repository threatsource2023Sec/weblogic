...
public class RemappingMethodAdapter extends LocalVariablesSorter {
   ...
   protected RemappingMethodAdapter(int var1, int var2, String var3, MethodVisitor var4, Remapper var5) {
   ...
   public AnnotationVisitor visitTypeAnnotation(int var1, TypePath var2, String var3, boolean var4) {
      ...
      return (AnnotationVisitor)(var5 == null ? var5 : new RemappingAnnotationAdapter(var5, this.remapper));
   }
   ...
   public AnnotationVisitor visitLocalVariableAnnotation(int var1, TypePath var2, Label[] var3, Label[] var4, int[] var5, String var6, boolean var7) {
      ...
      return (AnnotationVisitor)(var8 == null ? var8 : new RemappingAnnotationAdapter(var8, this.remapper));
   }
}
