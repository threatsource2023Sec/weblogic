...
public class GeneratorAdapter extends LocalVariablesSorter {
   ...
   public GeneratorAdapter(int var1, Method var2, MethodVisitor var3) {
      this(var3, var1, (String)null, var2.getDescriptor());
   }

   public GeneratorAdapter(int var1, Method var2, String var3, Type[] var4, ClassVisitor var5) {
      this(var1, var2, var5.visitMethod(var1, var2.getName(), var2.getDescriptor(), var3, getInternalNames(var4)));
   }
   ...
   public void tableSwitch(int[] var1, TableSwitchGenerator var2, boolean var3) {
      ...
      if (var1.length > 0) {
         ...
         if (var3) {
            ...
            var10 = new Label[var6];

            for(var11 = 0; var11 < var6; ++var11) {
               var10[var11] = this.newLabel();
            }

            this.mv.visitLookupSwitchInsn(var13, var1, var10);

            for(var11 = 0; var11 < var6; ++var11) {
               this.mark(var10[var11]);
               var2.generateCase(var1[var11], var5);
            }
         }
      }
   ...
   private static void _clinit_() {
      class$org$objectweb$asm$commons$GeneratorAdapter = class$("org.python.objectweb.asm.commons.GeneratorAdapter");
   }
}
