   ...
   public void accept(SignatureVisitor var1) {
      ...
      if (var2.charAt(0) == '<') {
         ...
         do {
            ...
            if (var6 == 'L' || var6 == '[' || var6 == 'T') {
               var4 = a(var2, var4, var1.visitClassBound());
            }

            while((var6 = var2.charAt(var4++)) == ':') {
               var4 = a(var2, var4, var1.visitInterfaceBound());
            }
         } while(var6 != '>');
      } else {
         var4 = 0;
      ...
      if (var2.charAt(var4) == '(') {
         ...
         while(var2.charAt(var4) != ')') {
            var4 = a(var2, var4, var1.visitParameterType());
         }

         for(var4 = a(var2, var4 + 1, var1.visitReturnType()); var4 < var3; var4 = a(var2, var4 + 1, var1.visitExceptionType())) {
         }
      } else {
         for(var4 = a(var2, var4, var1.visitSuperclass()); var4 < var3; var4 = a(var2, var4, var1.visitInterface())) {
         }
      }
