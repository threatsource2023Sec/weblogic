...
public class PyArrayTest extends TestCase {
   ...
   public void testToJava() {
      ...
      Assert.assertArrayEquals(new int[]{0, 2, 4, 6, 8}, (int[])((int[])pyobj.__tojava__(int[].class)));
      Assert.assertArrayEquals(new Integer[]{0, 2, 4, 6, 8}, (Object[])((Object[])pyobj.__tojava__(Object[].class)));
   }
}
