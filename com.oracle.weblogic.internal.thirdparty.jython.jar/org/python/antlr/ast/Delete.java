...
public class Delete extends stmt {
   ...
   public Delete(Token token, java.util.List targets) {
      super(token);
      this.lineno = -1;
      this.col_offset = -1;
   ...
   public Delete(Integer ttype, Token token, java.util.List targets) {
      super(ttype, token);
      this.lineno = -1;
      this.col_offset = -1;
      this.targets = targets;
   ...
   public Delete(PythonTree tree, java.util.List targets) {
      super(tree);
      this.lineno = -1;
      this.col_offset = -1;
      this.targets = targets;
   ...
   static {
      PyType.addBuilder(Delete.class, new PyExposer());
      TYPE = PyType.fromClass(Delete.class);
      fields = new PyString[]{new PyString("targets")};
      attributes = new PyString[]{new PyString("lineno"), new PyString("col_offset")};
   }

   private static class Delete___init___exposer extends PyBuiltinMethod {
      public Delete___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public Delete___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new Delete___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((Delete)this.self).Delete___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((Delete)var1).toString();
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Delete)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Delete)var1).setLineno((Integer)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Delete)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Delete)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class targets_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Delete)var1).setTargets((PyObject)var2);
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Delete)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         Delete var4 = new Delete(this.for_type);
         if (var1) {
            var4.Delete___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new DeleteDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new Delete___init___exposer("__init__")};
         PyDataDescr[] var2 = new PyDataDescr[]{new repr_descriptor(), new lineno_descriptor(), new col_offset_descriptor(), new __dict___descriptor(), new targets_descriptor(), new _fields_descriptor(), new _attributes_descriptor()};
         super("_ast.Delete", Delete.class, stmt.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
