...
public class While extends stmt {
   ...
   public void While___init__(PyObject[] args, String[] keywords) {
      ArgParser ap = new ArgParser("While", args, keywords, new String[]{"test", "body", "orelse", "lineno", "col_offset"}, 3, true);
   ...
   public While(Token token, expr test, java.util.List body, java.util.List orelse) {
      super(token);
      this.lineno = -1;
      this.col_offset = -1;
      this.test = test;
   ...
   public While(Integer ttype, Token token, expr test, java.util.List body, java.util.List orelse) {
      super(ttype, token);
      this.lineno = -1;
      this.col_offset = -1;
      this.test = test;
   ...
   public While(PythonTree tree, expr test, java.util.List body, java.util.List orelse) {
      super(tree);
      this.lineno = -1;
      this.col_offset = -1;
      this.test = test;
   ...
   static {
      PyType.addBuilder(While.class, new PyExposer());
      TYPE = PyType.fromClass(While.class);
   ...
   private static class While___init___exposer extends PyBuiltinMethod {
      public While___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public While___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new While___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((While)this.self).While___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((While)var1).toString();
   ...
   private static class orelse_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((While)var1).setOrelse((PyObject)var2);
      }
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((While)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((While)var1).setLineno((Integer)var2);
      }
   ...
   private static class test_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((While)var1).setTest((PyObject)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((While)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((While)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class body_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((While)var1).setBody((PyObject)var2);
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((While)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         While var4 = new While(this.for_type);
         if (var1) {
            var4.While___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new WhileDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new While___init___exposer("__init__")};
         ...
         super("_ast.While", While.class, stmt.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
