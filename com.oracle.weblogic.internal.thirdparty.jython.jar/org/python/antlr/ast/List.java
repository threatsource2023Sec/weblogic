...
public class List extends expr implements Context {
   ...
   public void List___init__(PyObject[] args, String[] keywords) {
      ArgParser ap = new ArgParser("List", args, keywords, new String[]{"elts", "ctx", "lineno", "col_offset"}, 2, true);
   ...
   public List(Token token, java.util.List elts, expr_contextType ctx) {
      super(token);
      this.lineno = -1;
      this.col_offset = -1;
      this.elts = elts;
   ...
   public List(Integer ttype, Token token, java.util.List elts, expr_contextType ctx) {
      super(ttype, token);
      this.lineno = -1;
      this.col_offset = -1;
      this.elts = elts;
   ...
   public List(PythonTree tree, java.util.List elts, expr_contextType ctx) {
      super(tree);
      this.lineno = -1;
      this.col_offset = -1;
      this.elts = elts;
   ...
   static {
      PyType.addBuilder(List.class, new PyExposer());
      TYPE = PyType.fromClass(List.class);
   ...
   private static class List___init___exposer extends PyBuiltinMethod {
      ...
      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((List)this.self).List___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((List)var1).toString();
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((List)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((List)var1).setLineno((Integer)var2);
      }
   ...
   private static class ctx_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((List)var1).setCtx((PyObject)var2);
      }
   ...
   private static class elts_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((List)var1).setElts((PyObject)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((List)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((List)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((List)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         List var4 = new List(this.for_type);
         if (var1) {
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new ListDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new List___init___exposer("__init__")};
         ...
         super("_ast.List", List.class, expr.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
