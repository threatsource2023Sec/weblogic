...
public class Import extends stmt {
   ...
   public Import(Token token, java.util.List names) {
      super(token);
      this.lineno = -1;
      this.col_offset = -1;
      this.names = names;
   ...
   public Import(Integer ttype, Token token, java.util.List names) {
      super(ttype, token);
      this.lineno = -1;
      this.col_offset = -1;
      this.names = names;
   ...
   public Import(PythonTree tree, java.util.List names) {
      super(tree);
      this.lineno = -1;
      this.col_offset = -1;
      this.names = names;
   ...
   static {
      PyType.addBuilder(Import.class, new PyExposer());
      TYPE = PyType.fromClass(Import.class);
      fields = new PyString[]{new PyString("names")};
      attributes = new PyString[]{new PyString("lineno"), new PyString("col_offset")};
   }

   private static class Import___init___exposer extends PyBuiltinMethod {
      public Import___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public Import___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new Import___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((Import)this.self).Import___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((Import)var1).toString();
   ...
   private static class names_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Import)var1).setNames((PyObject)var2);
      }
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Import)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Import)var1).setLineno((Integer)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Import)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Import)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Import)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         Import var4 = new Import(this.for_type);
         if (var1) {
            var4.Import___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new ImportDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new Import___init___exposer("__init__")};
         ...
         super("_ast.Import", Import.class, stmt.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
