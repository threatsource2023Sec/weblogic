...
public class Interactive extends mod {
   ...
   public Interactive(Token token, java.util.List body) {
      super(token);
      this.body = body;
      if (body == null) {
   ...
   public Interactive(Integer ttype, Token token, java.util.List body) {
      super(ttype, token);
      this.body = body;
      if (body == null) {
         this.body = new ArrayList();
   ...
   public Interactive(PythonTree tree, java.util.List body) {
      super(tree);
      this.body = body;
      if (body == null) {
         this.body = new ArrayList();
   ...
   static {
      PyType.addBuilder(Interactive.class, new PyExposer());
      TYPE = PyType.fromClass(Interactive.class);
      fields = new PyString[]{new PyString("body")};
      attributes = new PyString[0];
   }

   private static class Interactive___init___exposer extends PyBuiltinMethod {
      public Interactive___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public Interactive___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new Interactive___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((Interactive)this.self).Interactive___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((Interactive)var1).toString();
   ...
   private static class body_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Interactive)var1).getBody();
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Interactive)var1).setBody((PyObject)var2);
      }
   ...
   private static class __dict___descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Interactive)var1).getDict();
      }
   ...
   private static class _fields_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Interactive)var1).get_fields();
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Interactive)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         Interactive var4 = new Interactive(this.for_type);
         if (var1) {
            var4.Interactive___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new InteractiveDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new Interactive___init___exposer("__init__")};
         ...
         super("_ast.Interactive", Interactive.class, mod.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
