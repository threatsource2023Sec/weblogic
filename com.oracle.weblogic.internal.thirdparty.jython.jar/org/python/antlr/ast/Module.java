...
public class Module extends mod {
   ...
   public Module(Token token, java.util.List body) {
      super(token);
      this.body = body;
      if (body == null) {
   ...
   public Module(Integer ttype, Token token, java.util.List body) {
      super(ttype, token);
      this.body = body;
      if (body == null) {
         this.body = new ArrayList();
   ...
   public Module(PythonTree tree, java.util.List body) {
      super(tree);
      this.body = body;
      if (body == null) {
         this.body = new ArrayList();
   ...
   static {
      PyType.addBuilder(Module.class, new PyExposer());
      TYPE = PyType.fromClass(Module.class);
   ...
   private static class Module___init___exposer extends PyBuiltinMethod {
      ...
      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((Module)this.self).Module___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((Module)var1).toString();
   ...
   private static class body_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Module)var1).setBody((PyObject)var2);
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((Module)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         Module var4 = new Module(this.for_type);
         if (var1) {
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new ModuleDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new Module___init___exposer("__init__")};
         ...
         super("_ast.Module", Module.class, mod.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
