...
public class ListComp extends expr {
   ...
   public void ListComp___init__(PyObject[] args, String[] keywords) {
      ArgParser ap = new ArgParser("ListComp", args, keywords, new String[]{"elt", "generators", "lineno", "col_offset"}, 2, true);
   ...
   public ListComp(Token token, expr elt, java.util.List generators) {
      super(token);
      this.lineno = -1;
      this.col_offset = -1;
      this.elt = elt;
   ...
   public ListComp(Integer ttype, Token token, expr elt, java.util.List generators) {
      super(ttype, token);
      this.lineno = -1;
      this.col_offset = -1;
      this.elt = elt;
   ...
   public ListComp(PythonTree tree, expr elt, java.util.List generators) {
      super(tree);
      this.lineno = -1;
      this.col_offset = -1;
      this.elt = elt;
   ...
   static {
      PyType.addBuilder(ListComp.class, new PyExposer());
      TYPE = PyType.fromClass(ListComp.class);
   ...
   private static class ListComp___init___exposer extends PyBuiltinMethod {
      public ListComp___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public ListComp___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new ListComp___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((ListComp)this.self).ListComp___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((ListComp)var1).toString();
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((ListComp)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((ListComp)var1).setLineno((Integer)var2);
      }
   ...
   private static class generators_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((ListComp)var1).getGenerators();
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((ListComp)var1).setGenerators((PyObject)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((ListComp)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((ListComp)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class elt_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((ListComp)var1).setElt((PyObject)var2);
      }
   ...
   private static class _fields_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((ListComp)var1).get_fields();
      }
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((ListComp)var1).get_attributes();
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         ListComp var4 = new ListComp(this.for_type);
         if (var1) {
            var4.ListComp___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new ListCompDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new ListComp___init___exposer("__init__")};
         ...
         super("_ast.ListComp", ListComp.class, expr.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
