...
public class Expr extends stmt {
   ...
   private static class Expr___init___exposer extends PyBuiltinMethod {
      public Expr___init___exposer(String var1) {
         super(var1);
         super.doc = "";
      }

      public Expr___init___exposer(PyType var1, PyObject var2, PyBuiltinCallable.Info var3) {
         super(var1, var2, var3);
         super.doc = "";
      }

      public PyBuiltinCallable bind(PyObject var1) {
         return new Expr___init___exposer(this.getType(), var1, this.info);
      }

      public PyObject __call__(PyObject[] var1, String[] var2) {
         ((Expr)this.self).Expr___init__(var1, var2);
         return Py.None;
      }
   }
   ...
   private static class repr_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         String var10000 = ((Expr)var1).toString();
   ...
   private static class lineno_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Expr)var1).getLineno());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Expr)var1).setLineno((Integer)var2);
      }
   ...
   private static class col_offset_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return Py.newInteger(((Expr)var1).getCol_offset());
      }
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Expr)var1).setCol_offset((Integer)var2);
      }
   ...
   private static class value_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public void invokeSet(PyObject var1, Object var2) {
         ((Expr)var1).setValue((PyObject)var2);
      }
   ...
   private static class exposed___new__ extends PyOverridableNew {
      ...
      public PyObject createOfType(boolean var1, PyObject[] var2, String[] var3) {
         Expr var4 = new Expr(this.for_type);
         if (var1) {
            var4.Expr___init__(var2, var3);
         }
      ...
      public PyObject createOfSubtype(PyType var1) {
         return new ExprDerived(var1);
      }
   }

   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         PyBuiltinMethod[] var1 = new PyBuiltinMethod[]{new Expr___init___exposer("__init__")};
         ...
         super("_ast.Expr", Expr.class, stmt.class, (boolean)1, (String)null, var1, var2, new exposed___new__());
      }
   }
}
