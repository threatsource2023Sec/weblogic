...
public abstract class VisitorBase implements VisitorIF {
   public Object visitModule(Module node) throws Exception {
      Object ret = this.unhandled_node(node);
      this.traverse(node);
      return ret;
   }
   ...
   protected abstract Object unhandled_node(PythonTree var1) throws Exception;

   public abstract void traverse(PythonTree var1) throws Exception;
}
