...
public abstract class cmpop extends PythonTree {
   ...
   static {
      PyType.addBuilder(cmpop.class, new PyExposer());
      TYPE = PyType.fromClass(cmpop.class);
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((cmpop)var1).get_attributes();
      }
   ...
   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         ...
         super("_ast.cmpop", cmpop.class, AST.class, (boolean)1, (String)null, var1, var2, (PyNewWrapper)null);
      }
   }
}
