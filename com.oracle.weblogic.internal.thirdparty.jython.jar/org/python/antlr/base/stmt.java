...
public abstract class stmt extends PythonTree {
   ...
   static {
      PyType.addBuilder(stmt.class, new PyExposer());
      TYPE = PyType.fromClass(stmt.class);
   ...
   private static class _attributes_descriptor extends PyDataDescr implements ExposeAsSuperclass {
      ...
      public Object invokeGet(PyObject var1) {
         return ((stmt)var1).get_attributes();
      }
   ...
   private static class PyExposer extends BaseTypeBuilder {
      public PyExposer() {
         ...
         super("_ast.stmt", stmt.class, AST.class, (boolean)1, (String)null, var1, var2, (PyNewWrapper)null);
      }
   }
}
