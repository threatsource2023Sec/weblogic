...
public abstract class BaseRecognizer {
   ...
   public static List getRuleInvocationStack(Throwable e, String recognizerClassName) {
      ...
      for(int i = stack.length - 1; i >= 0; --i) {
         ...
         if (!t.getClassName().startsWith("org.python.antlr.runtime.") && !t.getMethodName().equals("nextToken") && t.getClassName().equals(recognizerClassName)) {
   ...
   public int getRuleMemoization(int ruleIndex, int ruleStartIndex) {
      ...
      Integer stopIndexI = (Integer)this.state.ruleMemo[ruleIndex].get(new Integer(ruleStartIndex));
