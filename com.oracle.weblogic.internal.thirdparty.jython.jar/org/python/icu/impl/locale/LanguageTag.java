   ...
   public static LanguageTag parseLocale(BaseLocale baseLocale, LocaleExtensions localeExtensions) {
      ...
      if (variant.length() > 0) {
         ...
         while(!varitr.isDone()) {
            ...
            extensions.add(canonicalizeVariant(var));
            varitr.next();
         }

         if (extensions != null) {
            tag._variants = extensions;
            hasSubtag = true;
         }
      ...
      Set locextKeys = localeExtensions.getKeys();
      Iterator var18 = locextKeys.iterator();

      while(var18.hasNext()) {
         Character locextKey = (Character)var18.next();
