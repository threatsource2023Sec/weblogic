...
public final class InternalLocaleBuilder {
   ...
   private InternalLocaleBuilder setExtensions(List bcpExtensions, String privateuse) {
      ...
      if (bcpExtensions != null && bcpExtensions.size() > 0) {
         ...
         Iterator var4 = bcpExtensions.iterator();

         while(var4.hasNext()) {
            String bcpExt = (String)var4.next();
   ...
   public InternalLocaleBuilder setLocale(BaseLocale base, LocaleExtensions extensions) throws LocaleSyntaxException {
      ...
      if (language.length() > 0 && !LanguageTag.isLanguage(language)) {
         ...
         if (extKeys != null) {
            ...
            while(true) {
               while(var8.hasNext()) {
                  Character key = (Character)var8.next();
                  ...
                  if (e instanceof UnicodeLocaleExtension) {
                     ...
                     Iterator var12;
                     String ukey;
                     for(var12 = ue.getUnicodeLocaleAttributes().iterator(); var12.hasNext(); this._uattributes.add(new CaseInsensitiveString(ukey))) {
                        ukey = (String)var12.next();
                        if (this._uattributes == null) {
                           this._uattributes = new HashSet(4);
                        }
                     }

                     for(var12 = ue.getUnicodeLocaleKeys().iterator(); var12.hasNext(); this._ukeywords.put(new CaseInsensitiveString(ukey), ue.getUnicodeLocaleType(ukey))) {
                        ukey = (String)var12.next();
                        if (this._ukeywords == null) {
                           this._ukeywords = new HashMap(4);
                        }
