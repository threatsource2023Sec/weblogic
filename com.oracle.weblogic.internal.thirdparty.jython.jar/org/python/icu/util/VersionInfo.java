...
public final class VersionInfo implements Comparable {
   ...
   public static final VersionInfo ICU_VERSION = getInstance(59, 1, 0, 0);
   /** @deprecated */
   @Deprecated
   public static final String ICU_DATA_VERSION_PATH = "59b";
   /** @deprecated */
   @Deprecated
   public static final VersionInfo ICU_DATA_VERSION = getInstance(59, 1, 0, 0);
   ...
   static String getTZDataVersion() {
      if (TZDATA_VERSION == null) {
         ...
         synchronized(VersionInfo.class) {
            if (TZDATA_VERSION == null) {
               UResourceBundle tzbundle = UResourceBundle.getBundleInstance("org/python/icu/impl/data/icudt59b", "zoneinfo64");
