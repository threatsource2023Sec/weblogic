      ...
      if (this.hasMoreTokens()) {
         ...
         do {
            ...
            if (this.m_tokenStart_.length == result) {
               ...
               p = temptokenindex.length;
               int newsize = p + 100;
               this.m_tokenStart_ = new int[newsize];
               this.m_tokenLimit_ = new int[newsize];
               System.arraycopy(temptokenindex, 0, this.m_tokenStart_, 0, p);
               System.arraycopy(temptokensize, 0, this.m_tokenLimit_, 0, p);
            }
