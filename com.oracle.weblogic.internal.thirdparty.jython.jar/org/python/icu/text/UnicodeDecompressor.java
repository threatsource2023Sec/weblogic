      ...
      if (charBuffer.length >= 2 && charBufferLimit - charBufferStart >= 2) {
         ...
         if (this.fBufferLength > 0) {
            ...
            if (this.fBufferLength != 3) {
               normalizedBase = this.fBuffer.length - this.fBufferLength;
               if (byteBufferLimit - byteBufferStart < normalizedBase) {
                  normalizedBase = byteBufferLimit - byteBufferStart;
               }

               System.arraycopy(byteBuffer, byteBufferStart, this.fBuffer, this.fBufferLength, normalizedBase);
            }
            ...
            bytePos = byteBufferStart + normalizedBase;
         }
                  ...
                  while(true) {
                     ...
                     switch (aByte) {
                        ...
                        case 8:
                           ...
                           normalizedBase = byteBuffer[bytePos++] & 255;
                           charBuffer[ucPos++] = (char)(normalizedBase + (normalizedBase >= 0 && normalizedBase < 128 ? sOffsets[aByte - 1] : this.fOffsets[aByte - 1] - 128));
                           break;
                        case 11:
