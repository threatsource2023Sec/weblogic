...
final class GeneralRange implements Serializable {
   ...
   static GeneralRange from(Range range) {
      ...
      Comparable upperEndpoint = range.hasUpperBound() ? range.upperEndpoint() : null;
   ...
   boolean tooLow(@Nullable Object t) {
      if (!this.hasLowerBound()) {
         ...
         Object lbound = this.getLowerEndpoint();
   ...
   boolean tooHigh(@Nullable Object t) {
      if (!this.hasUpperBound()) {
         ...
         Object ubound = this.getUpperEndpoint();
   ...
   GeneralRange intersect(GeneralRange other) {
      ...
      Object lowEnd = this.getLowerEndpoint();
      ...
      Object upEnd = this.getUpperEndpoint();
   ...
   GeneralRange reverse() {
      GeneralRange result = this.reverse;
      if (result == null) {
