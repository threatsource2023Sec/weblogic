...
public class Finalizer implements Runnable {
   ...
   private static final String FINALIZABLE_REFERENCE = "org.python.google.common.base.FinalizableReference";
   ...
   public static void startFinalizer(Class finalizableReferenceClass, ReferenceQueue queue, PhantomReference frqReference) {
      if (!finalizableReferenceClass.getName().equals("org.python.google.common.base.FinalizableReference")) {
