...
@Filename("unittest/test/dummy.py")
public class dummy$py extends PyFunctionTable implements PyRunnable {
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new dummy$py("unittest/test/dummy$py")).getMain()), var0);
   }
