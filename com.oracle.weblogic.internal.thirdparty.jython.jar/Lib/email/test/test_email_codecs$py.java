...
@Filename("email/test/test_email_codecs.py")
public class test_email_codecs$py extends PyFunctionTable implements PyRunnable {
   static test_email_codecs$py self;
   ...
   public test_email_codecs$py(String var1) {
      self = this;
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new test_email_codecs$py("email/test/test_email_codecs$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(test_email_codecs$py.class);
   }
