...
@Filename("encodings/iso2022_jp_2004.py")
public class iso2022_jp_2004$py extends PyFunctionTable implements PyRunnable {
   static iso2022_jp_2004$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setline(7);
      PyObject var3 = imp.importOne("_codecs_iso2022", var1, -1);
      var1.setlocal("_codecs_iso2022", var3);
      var3 = null;
      ...
      var3 = null;
      var1.setline(10);
      var3 = var1.getname("_codecs_iso2022").__getattr__("getcodec").__call__((ThreadState)var2, (PyObject)PyString.fromInterned("iso2022_jp_2004"));
   ...
   public PyObject getregentry$6(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("iso2022_jp_2004"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public iso2022_jp_2004$py(String var1) {
      self = this;
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new iso2022_jp_2004$py("encodings/iso2022_jp_2004$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(iso2022_jp_2004$py.class);
   }
