...
@Filename("encodings/gb2312.py")
public class gb2312$py extends PyFunctionTable implements PyRunnable {
   static gb2312$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      ...
      var3 = null;
      var1.setline(10);
      var3 = var1.getname("_codecs_cn").__getattr__("getcodec").__call__((ThreadState)var2, (PyObject)PyString.fromInterned("gb2312"));
   ...
   public PyObject getregentry$6(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("gb2312"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new gb2312$py("encodings/gb2312$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(gb2312$py.class);
   }
