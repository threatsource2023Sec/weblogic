...
@Filename("encodings/iso8859_10.py")
public class iso8859_10$py extends PyFunctionTable implements PyRunnable {
   static iso8859_10$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python Character Mapping Codec iso8859_10 generated from 'MAPPINGS/ISO8859/8859-10.TXT' with gencodec.py.\n\n"));
      var1.setline(3);
      PyString.fromInterned(" Python Character Mapping Codec iso8859_10 generated from 'MAPPINGS/ISO8859/8859-10.TXT' with gencodec.py.\n\n");
      var1.setline(5);
   ...
   public PyObject getregentry$10(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("iso8859-10"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public iso8859_10$py(String var1) {
      self = this;
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new iso8859_10$py("encodings/iso8859_10$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(iso8859_10$py.class);
   }
