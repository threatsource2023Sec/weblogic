...
@Filename("encodings/utf_32_le.py")
public class utf_32_le$py extends PyFunctionTable implements PyRunnable {
   static utf_32_le$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      ...
      var3 = null;
      var1.setline(8);
      var3 = var1.getname("codecs").__getattr__("utf_32_le_encode");
   ...
   public PyObject decode$1(PyFrame var1, ThreadState var2) {
      var1.setline(11);
      PyObject var3 = var1.getglobal("codecs").__getattr__("utf_32_le_decode").__call__(var2, var1.getlocal(0), var1.getlocal(1), var1.getglobal("True"));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject encode$3(PyFrame var1, ThreadState var2) {
      var1.setline(15);
      PyObject var3 = var1.getglobal("codecs").__getattr__("utf_32_le_encode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject IncrementalDecoder$4(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(18);
      PyObject var3 = var1.getname("codecs").__getattr__("utf_32_le_decode");
   ...
   public PyObject StreamWriter$5(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(21);
      PyObject var3 = var1.getname("codecs").__getattr__("utf_32_le_encode");
      var1.setlocal("encode", var3);
      var3 = null;
      return var1.getf_locals();
   }
   ...
   public PyObject getregentry$7(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("utf-32-le"), var1.getglobal("encode"), var1.getglobal("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public utf_32_le$py(String var1) {
      self = this;
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new utf_32_le$py("encodings/utf_32_le$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(utf_32_le$py.class);
   }
