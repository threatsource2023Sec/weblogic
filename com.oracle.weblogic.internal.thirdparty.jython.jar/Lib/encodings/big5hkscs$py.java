...
@Filename("encodings/big5hkscs.py")
public class big5hkscs$py extends PyFunctionTable implements PyRunnable {
   static big5hkscs$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setline(7);
      PyObject var3 = imp.importOne("_codecs_hk", var1, -1);
      var1.setlocal("_codecs_hk", var3);
      var3 = null;
      ...
      var3 = null;
      var1.setline(10);
      var3 = var1.getname("_codecs_hk").__getattr__("getcodec").__call__((ThreadState)var2, (PyObject)PyString.fromInterned("big5hkscs"));
   ...
   public PyObject getregentry$6(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("big5hkscs"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public big5hkscs$py(String var1) {
      self = this;
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new big5hkscs$py("encodings/big5hkscs$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(big5hkscs$py.class);
   }
