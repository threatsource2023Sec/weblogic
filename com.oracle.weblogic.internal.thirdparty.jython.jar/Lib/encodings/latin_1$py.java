...
@Filename("encodings/latin_1.py")
public class latin_1$py extends PyFunctionTable implements PyRunnable {
   static latin_1$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python 'latin-1' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n"));
      var1.setline(8);
      PyString.fromInterned(" Python 'latin-1' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n");
      var1.setline(9);
   ...
   public PyObject Codec$1(PyFrame var1, ThreadState var2) {
      ...
      var1.setline(17);
      PyObject var3 = var1.getname("codecs").__getattr__("latin_1_encode");
      var1.setlocal("encode", var3);
      var3 = null;
      var1.setline(18);
      var3 = var1.getname("codecs").__getattr__("latin_1_decode");
   ...
   public PyObject encode$3(PyFrame var1, ThreadState var2) {
      var1.setline(22);
      PyObject var3 = var1.getglobal("codecs").__getattr__("latin_1_encode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject decode$5(PyFrame var1, ThreadState var2) {
      var1.setline(26);
      PyObject var3 = var1.getglobal("codecs").__getattr__("latin_1_decode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject StreamConverter$8(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(36);
      PyObject var3 = var1.getname("codecs").__getattr__("latin_1_decode");
      var1.setlocal("encode", var3);
      var3 = null;
      var1.setline(37);
      var3 = var1.getname("codecs").__getattr__("latin_1_encode");
      var1.setlocal("decode", var3);
      var3 = null;
      return var1.getf_locals();
   }
   ...
   public PyObject getregentry$9(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("iso8859-1"), var1.getglobal("Codec").__getattr__("encode"), var1.getglobal("Codec").__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new latin_1$py("encodings/latin_1$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(latin_1$py.class);
   }
