...
@Filename("encodings/utf_16_le.py")
public class utf_16_le$py extends PyFunctionTable implements PyRunnable {
   static utf_16_le$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python 'utf-16-le' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n"));
      var1.setline(8);
      PyString.fromInterned(" Python 'utf-16-le' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n");
      var1.setline(9);
      PyObject var3 = imp.importOne("codecs", var1, -1);
      var1.setlocal("codecs", var3);
      var3 = null;
      var1.setline(13);
      var3 = var1.getname("codecs").__getattr__("utf_16_le_encode");
   ...
   public PyObject decode$1(PyFrame var1, ThreadState var2) {
      var1.setline(16);
      PyObject var3 = var1.getglobal("codecs").__getattr__("utf_16_le_decode").__call__(var2, var1.getlocal(0), var1.getlocal(1), var1.getglobal("True"));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject encode$3(PyFrame var1, ThreadState var2) {
      var1.setline(20);
      PyObject var3 = var1.getglobal("codecs").__getattr__("utf_16_le_encode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject IncrementalDecoder$4(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(23);
      PyObject var3 = var1.getname("codecs").__getattr__("utf_16_le_decode");
   ...
   public PyObject StreamWriter$5(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(26);
      PyObject var3 = var1.getname("codecs").__getattr__("utf_16_le_encode");
      var1.setlocal("encode", var3);
      var3 = null;
      return var1.getf_locals();
   }
   ...
   public PyObject getregentry$7(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("utf-16-le"), var1.getglobal("encode"), var1.getglobal("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public utf_16_le$py(String var1) {
      self = this;
      ...
      encode$3 = Py.newCode(3, var2, var1, "encode", 19, false, false, self, 3, (String[])null, (String[])null, 0, 4097);
      var2 = new String[0];
      IncrementalDecoder$4 = Py.newCode(0, var2, var1, "IncrementalDecoder", 22, false, false, self, 4, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      StreamWriter$5 = Py.newCode(0, var2, var1, "StreamWriter", 25, false, false, self, 5, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      StreamReader$6 = Py.newCode(0, var2, var1, "StreamReader", 28, false, false, self, 6, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      getregentry$7 = Py.newCode(0, var2, var1, "getregentry", 33, false, false, self, 7, (String[])null, (String[])null, 0, 4097);
   }
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new utf_16_le$py("encodings/utf_16_le$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(utf_16_le$py.class);
   }
