...
@Filename("encodings/euc_kr.py")
public class euc_kr$py extends PyFunctionTable implements PyRunnable {
   static euc_kr$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setline(7);
      PyObject var3 = imp.importOne("_codecs_kr", var1, -1);
      var1.setlocal("_codecs_kr", var3);
      var3 = null;
      ...
      var3 = null;
      var1.setline(10);
      var3 = var1.getname("_codecs_kr").__getattr__("getcodec").__call__((ThreadState)var2, (PyObject)PyString.fromInterned("euc_kr"));
   ...
   public PyObject getregentry$6(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("euc_kr"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new euc_kr$py("encodings/euc_kr$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(euc_kr$py.class);
   }
