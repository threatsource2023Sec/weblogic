...
@Filename("encodings/gb18030.py")
public class gb18030$py extends PyFunctionTable implements PyRunnable {
   static gb18030$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setline(7);
      PyObject var3 = imp.importOne("_codecs_cn", var1, -1);
      var1.setlocal("_codecs_cn", var3);
      var3 = null;
      ...
      var3 = null;
      var1.setline(10);
      var3 = var1.getname("_codecs_cn").__getattr__("getcodec").__call__((ThreadState)var2, (PyObject)PyString.fromInterned("gb18030"));
   ...
   public PyObject getregentry$6(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("gb18030"), var1.getglobal("Codec").__call__(var2).__getattr__("encode"), var1.getglobal("Codec").__call__(var2).__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new gb18030$py("encodings/gb18030$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(gb18030$py.class);
   }
