...
@Filename("encodings/hex_codec.py")
public class hex_codec$py extends PyFunctionTable implements PyRunnable {
   static hex_codec$py self;
   static final PyCode f$0;
   static final PyCode hex_encode$1;
   static final PyCode hex_decode$2;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python 'hex_codec' Codec - 2-digit hex content transfer encoding\n\n    Unlike most of the other codecs which target Unicode, this codec\n    will return Python string objects for both encode and decode.\n\n    Written by Marc-Andre Lemburg (mal@lemburg.com).\n\n"));
      var1.setline(8);
      PyString.fromInterned(" Python 'hex_codec' Codec - 2-digit hex content transfer encoding\n\n    Unlike most of the other codecs which target Unicode, this codec\n    will return Python string objects for both encode and decode.\n\n    Written by Marc-Andre Lemburg (mal@lemburg.com).\n\n");
      var1.setline(9);
      ...
      PyFunction var6 = new PyFunction(var1.f_globals, var5, hex_encode$1, PyString.fromInterned(" Encodes the object input and returns a tuple (output\n        object, length consumed).\n\n        errors defines the error handling to apply. It defaults to\n        'strict' handling which is the only currently supported\n        error handling for this codec.\n\n    "));
      var1.setlocal("hex_encode", var6);
      var3 = null;
      var1.setline(27);
      var5 = new PyObject[]{PyString.fromInterned("strict")};
      var6 = new PyFunction(var1.f_globals, var5, hex_decode$2, PyString.fromInterned(" Decodes the object input and returns a tuple (output\n        object, length consumed).\n\n        input must be an object which provides the bf_getreadbuf\n        buffer slot. Python strings, buffer objects and memory\n        mapped files are examples of objects providing this slot.\n\n        errors defines the error handling to apply. It defaults to\n        'strict' handling which is the only currently supported\n        error handling for this codec.\n\n    "));
      var1.setlocal("hex_decode", var6);
      var3 = null;
      var1.setline(45);
   ...
   public PyObject hex_encode$1(PyFrame var1, ThreadState var2) {
      var1.setline(22);
      ...
      var1.setline(24);
      var3 = var1.getglobal("binascii").__getattr__("b2a_hex").__call__(var2, var1.getlocal(0));
   ...
   public PyObject hex_decode$2(PyFrame var1, ThreadState var2) {
      var1.setline(40);
      ...
      var1.setline(42);
      var3 = var1.getglobal("binascii").__getattr__("a2b_hex").__call__(var2, var1.getlocal(0));
      var1.setlocal(2, var3);
      var3 = null;
      var1.setline(43);
      PyTuple var4 = new PyTuple(new PyObject[]{var1.getlocal(2), var1.getglobal("len").__call__(var2, var1.getlocal(0))});
   ...
   public PyObject encode$4(PyFrame var1, ThreadState var2) {
      var1.setline(48);
      PyObject var3 = var1.getglobal("hex_encode").__call__(var2, var1.getlocal(1), var1.getlocal(2));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject decode$5(PyFrame var1, ThreadState var2) {
      var1.setline(50);
      PyObject var3 = var1.getglobal("hex_decode").__call__(var2, var1.getlocal(1), var1.getlocal(2));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject encode$7(PyFrame var1, ThreadState var2) {
      ...
      var1.setline(55);
      var3 = var1.getglobal("binascii").__getattr__("b2a_hex").__call__(var2, var1.getlocal(1));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject decode$9(PyFrame var1, ThreadState var2) {
      ...
      var1.setline(60);
      var3 = var1.getglobal("binascii").__getattr__("a2b_hex").__call__(var2, var1.getlocal(1));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject getregentry$12(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("hex"), var1.getglobal("hex_encode"), var1.getglobal("hex_decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamWriter"), var1.getglobal("StreamReader")};
   ...
   public hex_codec$py(String var1) {
      self = this;
      String[] var2 = new String[0];
      f$0 = Py.newCode(0, var2, var1, "<module>", 0, false, false, self, 0, (String[])null, (String[])null, 0, 4096);
      var2 = new String[]{"input", "errors", "output"};
      hex_encode$1 = Py.newCode(2, var2, var1, "hex_encode", 13, false, false, self, 1, (String[])null, (String[])null, 0, 4097);
      var2 = new String[]{"input", "errors", "output"};
      hex_decode$2 = Py.newCode(2, var2, var1, "hex_decode", 27, false, false, self, 2, (String[])null, (String[])null, 0, 4097);
      var2 = new String[0];
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new hex_codec$py("encodings/hex_codec$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(hex_codec$py.class);
   }
   ...
   public PyObject call_function(int var1, PyFrame var2, ThreadState var3) {
      switch (var1) {
         ...
         case 1:
            return this.hex_encode$1(var2, var3);
         case 2:
            return this.hex_decode$2(var2, var3);
         case 3:
