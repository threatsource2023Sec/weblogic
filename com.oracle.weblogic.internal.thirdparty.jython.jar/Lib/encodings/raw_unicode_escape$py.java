...
@Filename("encodings/raw_unicode_escape.py")
public class raw_unicode_escape$py extends PyFunctionTable implements PyRunnable {
   static raw_unicode_escape$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python 'raw-unicode-escape' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n"));
      var1.setline(8);
      PyString.fromInterned(" Python 'raw-unicode-escape' Codec\n\n\nWritten by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n");
      var1.setline(9);
   ...
   public PyObject Codec$1(PyFrame var1, ThreadState var2) {
      ...
      var1.setline(17);
      PyObject var3 = var1.getname("codecs").__getattr__("raw_unicode_escape_encode");
      var1.setlocal("encode", var3);
      var3 = null;
      var1.setline(18);
      var3 = var1.getname("codecs").__getattr__("raw_unicode_escape_decode");
   ...
   public PyObject encode$3(PyFrame var1, ThreadState var2) {
      var1.setline(22);
      PyObject var3 = var1.getglobal("codecs").__getattr__("raw_unicode_escape_encode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject decode$5(PyFrame var1, ThreadState var2) {
      var1.setline(26);
      PyObject var3 = var1.getglobal("codecs").__getattr__("raw_unicode_escape_decode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject getregentry$8(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("raw-unicode-escape"), var1.getglobal("Codec").__getattr__("encode"), var1.getglobal("Codec").__getattr__("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamWriter"), var1.getglobal("StreamReader")};
   ...
   public raw_unicode_escape$py(String var1) {
      self = this;
      ...
      var2 = new String[0];
      getregentry$8 = Py.newCode(0, var2, var1, "getregentry", 36, false, false, self, 8, (String[])null, (String[])null, 0, 4097);
   }
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new raw_unicode_escape$py("encodings/raw_unicode_escape$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(raw_unicode_escape$py.class);
   }
