...
@Filename("encodings/mbcs.py")
public class mbcs$py extends PyFunctionTable implements PyRunnable {
   static mbcs$py self;
   ...
   public PyObject f$0(PyFrame var1, ThreadState var2) {
      var1.setglobal("__doc__", PyString.fromInterned(" Python 'mbcs' Codec for Windows\n\n\nCloned by Mark Hammond (mhammond@skippinet.com.au) from ascii.py,\nwhich was written by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n"));
      var1.setline(9);
      PyString.fromInterned(" Python 'mbcs' Codec for Windows\n\n\nCloned by Mark Hammond (mhammond@skippinet.com.au) from ascii.py,\nwhich was written by Marc-Andre Lemburg (mal@lemburg.com).\n\n(c) Copyright CNRI, All Rights Reserved. NO WARRANTY.\n\n");
      var1.setline(12);
      String[] var3 = new String[]{"mbcs_encode", "mbcs_decode"};
      PyObject[] var5 = imp.importFrom("codecs", var3, var1, -1);
      PyObject var4 = var5[0];
      var1.setlocal("mbcs_encode", var4);
      var4 = null;
      var4 = var5[1];
      var1.setlocal("mbcs_decode", var4);
      var4 = null;
      var1.setline(14);
      ...
      var3 = null;
      var1.setline(18);
      var6 = var1.getname("mbcs_encode");
      var1.setlocal("encode", var6);
      var3 = null;
      var1.setline(20);
      var5 = new PyObject[]{PyString.fromInterned("strict")};
      PyFunction var7 = new PyFunction(var1.f_globals, var5, decode$1, (PyObject)null);
      ...
      var7 = new PyFunction(var1.f_globals, var5, getregentry$7, (PyObject)null);
      var1.setlocal("getregentry", var7);
      var3 = null;
      var1.f_lasti = -1;
      return Py.None;
   }
   ...
   public PyObject decode$1(PyFrame var1, ThreadState var2) {
      var1.setline(21);
      PyObject var3 = var1.getglobal("mbcs_decode").__call__(var2, var1.getlocal(0), var1.getlocal(1), var1.getglobal("True"));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject encode$3(PyFrame var1, ThreadState var2) {
      var1.setline(25);
      PyObject var3 = var1.getglobal("mbcs_encode").__call__(var2, var1.getlocal(1), var1.getlocal(0).__getattr__("errors")).__getitem__(Py.newInteger(0));
      var1.f_lasti = -1;
      return var3;
   }
   ...
   public PyObject IncrementalDecoder$4(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(28);
      PyObject var3 = var1.getname("mbcs_decode");
   ...
   public PyObject StreamWriter$5(PyFrame var1, ThreadState var2) {
      var1.setlocal("__module__", var1.getname("__name__"));
      var1.setline(31);
      PyObject var3 = var1.getname("mbcs_encode");
   ...
   public PyObject getregentry$7(PyFrame var1, ThreadState var2) {
      ...
      PyObject[] var3 = new PyObject[]{PyString.fromInterned("mbcs"), var1.getglobal("encode"), var1.getglobal("decode"), var1.getglobal("IncrementalEncoder"), var1.getglobal("IncrementalDecoder"), var1.getglobal("StreamReader"), var1.getglobal("StreamWriter")};
   ...
   public mbcs$py(String var1) {
      self = this;
      String[] var2 = new String[0];
      f$0 = Py.newCode(0, var2, var1, "<module>", 0, false, false, self, 0, (String[])null, (String[])null, 0, 4096);
      var2 = new String[]{"input", "errors"};
      decode$1 = Py.newCode(2, var2, var1, "decode", 20, false, false, self, 1, (String[])null, (String[])null, 0, 4097);
      var2 = new String[0];
      IncrementalEncoder$2 = Py.newCode(0, var2, var1, "IncrementalEncoder", 23, false, false, self, 2, (String[])null, (String[])null, 0, 4096);
      var2 = new String[]{"self", "input", "final"};
      encode$3 = Py.newCode(3, var2, var1, "encode", 24, false, false, self, 3, (String[])null, (String[])null, 0, 4097);
      var2 = new String[0];
      IncrementalDecoder$4 = Py.newCode(0, var2, var1, "IncrementalDecoder", 27, false, false, self, 4, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      StreamWriter$5 = Py.newCode(0, var2, var1, "StreamWriter", 30, false, false, self, 5, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      StreamReader$6 = Py.newCode(0, var2, var1, "StreamReader", 33, false, false, self, 6, (String[])null, (String[])null, 0, 4096);
      var2 = new String[0];
      getregentry$7 = Py.newCode(0, var2, var1, "getregentry", 38, false, false, self, 7, (String[])null, (String[])null, 0, 4097);
   }
   ...
   public static void main(String[] var0) {
      Py.runMain(CodeLoader.createSimpleBootstrap((new mbcs$py("encodings/mbcs$py")).getMain()), var0);
   }

   public static CodeBootstrap getCodeBootstrap() {
      return PyRunnableBootstrap.getFilenameConstructorReflectionBootstrap(mbcs$py.class);
   }
