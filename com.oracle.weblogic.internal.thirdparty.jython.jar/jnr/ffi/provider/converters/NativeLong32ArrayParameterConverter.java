...
public class NativeLong32ArrayParameterConverter implements ToNativeConverter {
   private static final ToNativeConverter IN = new NativeLong32ArrayParameterConverter(2);
   ...
   public static final class Out extends NativeLong32ArrayParameterConverter implements ToNativeConverter.PostInvocation {
