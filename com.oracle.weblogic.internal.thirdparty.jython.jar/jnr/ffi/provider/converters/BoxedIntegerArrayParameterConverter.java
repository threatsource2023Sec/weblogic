...
public class BoxedIntegerArrayParameterConverter implements ToNativeConverter {
   private static final ToNativeConverter IN = new BoxedIntegerArrayParameterConverter(2);
   ...
   public static final class Out extends BoxedIntegerArrayParameterConverter implements ToNativeConverter.PostInvocation {
