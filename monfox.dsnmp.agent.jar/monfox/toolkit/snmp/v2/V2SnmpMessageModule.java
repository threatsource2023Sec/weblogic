...
public class V2SnmpMessageModule implements SnmpMessageModule {
   private SnmpPDUCoder a;
   private SnmpMetadata b;
   private static final String c = "$Id: V2SnmpMessageModule.java,v 1.7 2002/02/05 23:18:05 sking Exp $";
   public static int d;

   public V2SnmpMessageModule() {
      this((SnmpMetadata)null);
   }

   public V2SnmpMessageModule(SnmpMetadata var1) {
      this.a = null;
      this.b = null;
      this.b = var1;
   ...
   public SnmpMessage decodeMessage(int var1, BERBuffer var2) throws SnmpCoderException {
      ...
      try {
         ...
         V2CSnmpSecurityParameters var7 = new V2CSnmpSecurityParameters(var3);
