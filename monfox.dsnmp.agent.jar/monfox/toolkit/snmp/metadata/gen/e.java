...
class e {
   ...
   protected void addBooleanAttribute(Element var1, String var2, boolean var3) {
      if (var1 != null) {
         if (var3) {
            var1.addAttribute(var2, c("\u001bh\u001f["));
            if (Message.d == 0) {
               return;
            }
         }

         var1.addAttribute(var2, c("\t{\u0006Ml"));
      }
   ...
   protected void addModRefsToModule(Element var1) {
      if (this.c.size() > 0) {
         Element var2 = new Element(c("\"u\u000eKe\nH\u000fXz"));
         var1.addContent(var2);
         Enumeration var3 = this.c.elements();

         while(var3.hasMoreElements()) {
            String var4 = (String)var3.nextElement();
            Element var5 = new Element(c("\"u\u000eKe\nH\u000fX"));
            var5.addAttribute(c("\u0001{\u0007["), var4);
   ...
   protected void addParseInfo(int var1, int var2, Element var3) {
      ...
      if (var3.getAttribute(c("\u001fs")) == null) {
         var3.addAttribute(c("\u001fs"), "" + var1 + "," + var2 + "," + var4);
      }
   ...
   public final Symbol CUP$xsnmp_parser$do_action(int param1, lr_parser param2, Stack param3, int param4) throws Exception {
