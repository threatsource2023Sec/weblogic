...
public interface FairShareRequestClassType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(FairShareRequestClassType.class.getClassLoader(), "schemacom_bea_xml.system.conn_mon").resolveHandle("fairsharerequestclasstype16e1type");
   ...
   BigInteger getFairShare();

   XmlInteger xgetFairShare();

   void setFairShare(BigInteger var1);

   void xsetFairShare(XmlInteger var1);
