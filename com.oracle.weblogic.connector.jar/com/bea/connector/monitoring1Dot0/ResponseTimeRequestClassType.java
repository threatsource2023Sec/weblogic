...
public interface ResponseTimeRequestClassType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ResponseTimeRequestClassType.class.getClassLoader(), "schemacom_bea_xml.system.conn_mon").resolveHandle("responsetimerequestclasstype7ed0type");
   ...
   BigInteger getGoalMs();

   XmlInteger xgetGoalMs();

   void setGoalMs(BigInteger var1);

   void xsetGoalMs(XmlInteger var1);
