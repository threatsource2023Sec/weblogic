   ...
   private static void doIt(String[] args) throws BuildException {
      ...
      if (args.length >= 1 && args.length <= 3) {
         ...
         try {
            ...
            System.out.println("Could not create file " + outputfilename + ". " + var27);
            throw new BuildException();
         } catch (IOException var28) {
            System.out.println("Error creating file " + outputfilename + ". " + var28);
            throw new BuildException();
         }
         ...
         while(true) {
            ...
            try {
               ...
               System.out.println("Finished! " + var31);
               break;
            }
         ...
         if (!written_classheader) {
            ...
            try {
               ...
               System.out.println("Unable to write output file " + var30);
               throw new BuildException();
            }
         }
      } else {
