...
public class DeletePartitionFromEnvCommand implements CommandRevertInterface {
   ...
   public DeletePartitionFromEnvCommand() {
      ...
      if (runtime == null) {
         ...
         if (partition == null) {
            ...
            if (environment == null) {
               ...
               logger.log(Level.INFO, "Adding back partition {0} to environment {1}", new Object[]{this.partitionName, this.environmentName});
      ...
      if (runtime == null) {
         ...
         if (partition == null) {
            ...
            if (environment == null) {
               ...
               logger.log(Level.INFO, "Delete partition {0} from environment {1}", new Object[]{this.partitionName, this.environmentName});
