...
public class DisassociatePartitionsCommand implements CommandRevertInterface {
   ...
   public DisassociatePartitionsCommand() {
            ...
            if (lifecyclePartition1 == null) {
               ...
               if (lifecyclePartition2 == null) {
                  ...
                  if (environment == null) {
                     ...
                     logger.log(Level.INFO, "Reassociate partition1 {0} to partition2 {1}", new Object[]{this.partition1, this.partition2});
            ...
            if (lifecyclePartition1 == null) {
               ...
               if (lifecyclePartition2 == null) {
                  ...
                  if (environment == null) {
                     ...
                     logger.log(Level.INFO, "Disassociate partition1 {0} from partition2 {1}. Partition1 properties {2}", new Object[]{this.partition1, this.partition2, this.associateProperties});
