...
public interface XsdPositiveIntegerType extends XmlPositiveInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdPositiveIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdpositiveintegertype028ftype");
