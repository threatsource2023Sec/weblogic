...
public interface EjbNameType extends XsdNMTOKENType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(EjbNameType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("ejbnametypea34etype");
