...
public interface ErrorCodeType extends XsdPositiveIntegerType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ErrorCodeType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("errorcodetype0a25type");
