...
public interface MethodIntfType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(MethodIntfType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("methodintftypefea4type");
   ...
   public static final class Enum extends StringEnumAbstractBase {
      ...
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("Home", 1), new Enum("Remote", 2), new Enum("LocalHome", 3), new Enum("Local", 4), new Enum("ServiceEndpoint", 5)});
