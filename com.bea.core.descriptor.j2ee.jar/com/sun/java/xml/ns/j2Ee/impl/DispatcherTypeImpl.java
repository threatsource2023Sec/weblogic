...
public class DispatcherTypeImpl extends JavaStringEnumerationHolderEx implements DispatcherType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DispatcherTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DispatcherTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
