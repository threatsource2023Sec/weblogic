...
public class QnameScopeTypeImpl extends JavaStringEnumerationHolderEx implements QnameScopeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public QnameScopeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected QnameScopeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
