...
public class ResourceadapterTypeImpl extends XmlComplexContentImpl implements ResourceadapterType {
   ...
   private static final QName RESOURCEADAPTERCLASS$0 = new QName("http://java.sun.com/xml/ns/j2ee", "resourceadapter-class");
   private static final QName CONFIGPROPERTY$2 = new QName("http://java.sun.com/xml/ns/j2ee", "config-property");
   private static final QName OUTBOUNDRESOURCEADAPTER$4 = new QName("http://java.sun.com/xml/ns/j2ee", "outbound-resourceadapter");
   private static final QName INBOUNDRESOURCEADAPTER$6 = new QName("http://java.sun.com/xml/ns/j2ee", "inbound-resourceadapter");
   private static final QName ADMINOBJECT$8 = new QName("http://java.sun.com/xml/ns/j2ee", "adminobject");
   private static final QName SECURITYPERMISSION$10 = new QName("http://java.sun.com/xml/ns/j2ee", "security-permission");
