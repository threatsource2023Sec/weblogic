...
public class LocalTypeImpl extends JavaStringHolderEx implements LocalType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public LocalTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected LocalTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
