...
import com.sun.java.xml.ns.j2Ee.WarPathType;
import javax.xml.namespace.QName;

public class WarPathTypeImpl extends JavaStringHolderEx implements WarPathType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WarPathTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WarPathTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
