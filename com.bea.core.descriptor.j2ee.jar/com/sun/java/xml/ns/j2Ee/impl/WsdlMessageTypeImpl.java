...
public class WsdlMessageTypeImpl extends JavaQNameHolderEx implements WsdlMessageType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WsdlMessageTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WsdlMessageTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
