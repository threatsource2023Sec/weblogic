...
public class ServletNameTypeImpl extends JavaStringHolderEx implements ServletNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ServletNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ServletNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
