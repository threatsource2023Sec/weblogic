...
public class XsdAnyURITypeImpl extends JavaUriHolderEx implements XsdAnyURIType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public XsdAnyURITypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected XsdAnyURITypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
