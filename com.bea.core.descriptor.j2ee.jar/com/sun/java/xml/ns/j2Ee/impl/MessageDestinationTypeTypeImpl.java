...
public class MessageDestinationTypeTypeImpl extends JavaStringHolderEx implements MessageDestinationTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MessageDestinationTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MessageDestinationTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
