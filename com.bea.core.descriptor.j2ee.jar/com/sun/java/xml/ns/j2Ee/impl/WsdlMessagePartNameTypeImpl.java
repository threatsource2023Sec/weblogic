...
public class WsdlMessagePartNameTypeImpl extends JavaStringHolderEx implements WsdlMessagePartNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public WsdlMessagePartNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected WsdlMessagePartNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
