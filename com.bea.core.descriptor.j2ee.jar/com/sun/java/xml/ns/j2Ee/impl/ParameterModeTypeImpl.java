...
public class ParameterModeTypeImpl extends JavaStringEnumerationHolderEx implements ParameterModeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ParameterModeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ParameterModeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
