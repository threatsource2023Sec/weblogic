...
public interface XsdQNameType extends XmlQName {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdQNameType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdqnametypeb4a6type");
