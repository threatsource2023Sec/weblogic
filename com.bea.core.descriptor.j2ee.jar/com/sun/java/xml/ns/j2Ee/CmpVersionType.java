...
public interface CmpVersionType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(CmpVersionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("cmpversiontype8f32type");
