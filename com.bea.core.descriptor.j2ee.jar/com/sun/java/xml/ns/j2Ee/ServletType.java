...
public interface ServletType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ServletType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("servlettypeefa6type");
   ...
   void setLoadOnStartup(XsdIntegerType var1);

   XsdIntegerType addNewLoadOnStartup();
