...
public interface ServletLinkType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ServletLinkType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("servletlinktype6bd5type");
