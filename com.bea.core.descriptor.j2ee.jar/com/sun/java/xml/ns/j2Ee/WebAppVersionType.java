...
public interface WebAppVersionType extends XmlToken {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(WebAppVersionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("webappversiontype9f94type");
   Enum X_2_4 = WebAppVersionType.Enum.forString("2.4");
   int INT_X_2_4 = 1;
   ...
   public static final class Enum extends StringEnumAbstractBase {
      ...
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("2.4", 1)});
