...
public interface XsdNonNegativeIntegerType extends XmlNonNegativeInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdNonNegativeIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdnonnegativeintegertype6e86type");
