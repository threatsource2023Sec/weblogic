...
public interface XsdAnyURIType extends XmlAnyURI {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdAnyURIType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdanyuritypea3aatype");
