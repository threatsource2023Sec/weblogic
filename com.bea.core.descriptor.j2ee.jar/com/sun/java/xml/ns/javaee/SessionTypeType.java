...
public interface SessionTypeType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SessionTypeType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("sessiontypetypee97etype");
   Enum SINGLETON = SessionTypeType.Enum.forString("Singleton");
   ...
   public static final class Enum extends StringEnumAbstractBase {
      static final int INT_SINGLETON = 1;
      static final int INT_STATEFUL = 2;
      static final int INT_STATELESS = 3;
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("Singleton", 1), new Enum("Stateful", 2), new Enum("Stateless", 3)});
