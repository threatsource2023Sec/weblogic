...
public interface EjbRefNameType extends JndiNameType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(EjbRefNameType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("ejbrefnametype9d62type");
