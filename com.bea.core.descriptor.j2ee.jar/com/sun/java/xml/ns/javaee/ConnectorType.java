...
public interface ConnectorType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ConnectorType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("connectortyped108type");
   ...
   FullyQualifiedClassType[] getRequiredWorkContextArray();

   FullyQualifiedClassType getRequiredWorkContextArray(int var1);

   int sizeOfRequiredWorkContextArray();

   void setRequiredWorkContextArray(FullyQualifiedClassType[] var1);

   void setRequiredWorkContextArray(int var1, FullyQualifiedClassType var2);

   FullyQualifiedClassType insertNewRequiredWorkContext(int var1);

   FullyQualifiedClassType addNewRequiredWorkContext();
