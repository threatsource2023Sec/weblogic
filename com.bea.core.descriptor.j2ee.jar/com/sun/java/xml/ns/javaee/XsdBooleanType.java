...
public interface XsdBooleanType extends XmlBoolean {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdBooleanType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdbooleantypeb84ctype");
