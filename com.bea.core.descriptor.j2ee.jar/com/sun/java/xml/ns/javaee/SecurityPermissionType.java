...
public interface SecurityPermissionType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(SecurityPermissionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("securitypermissiontype0b37type");
   ...
   XsdStringType getSecurityPermissionSpec();

   void setSecurityPermissionSpec(XsdStringType var1);

   XsdStringType addNewSecurityPermissionSpec();
