...
public class CookieCommentTypeImpl extends JavaStringHolderEx implements CookieCommentType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CookieCommentTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CookieCommentTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
