...
public class CookieNameTypeImpl extends JavaStringHolderEx implements CookieNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CookieNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CookieNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
