...
import com.sun.java.xml.ns.javaee.TrackingModeType;
...
public class SessionConfigTypeImpl extends XmlComplexContentImpl implements SessionConfigType {
   ...
   private static final QName SESSIONTIMEOUT$0 = new QName("http://java.sun.com/xml/ns/javaee", "session-timeout");
   private static final QName COOKIECONFIG$2 = new QName("http://java.sun.com/xml/ns/javaee", "cookie-config");
   private static final QName TRACKINGMODE$4 = new QName("http://java.sun.com/xml/ns/javaee", "tracking-mode");
