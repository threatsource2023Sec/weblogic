...
public class XsdIntegerTypeImpl extends JavaIntegerHolderEx implements XsdIntegerType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public XsdIntegerTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected XsdIntegerTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
