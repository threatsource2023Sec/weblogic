...
import com.sun.java.xml.ns.javaee.CmpFieldType;
import com.sun.java.xml.ns.javaee.CmpVersionType;
...
import com.sun.java.xml.ns.javaee.EntityBeanType;
...
import com.sun.java.xml.ns.javaee.PersistenceTypeType;
import com.sun.java.xml.ns.javaee.PersistenceUnitRefType;
import com.sun.java.xml.ns.javaee.QueryType;
...
public class EntityBeanTypeImpl extends XmlComplexContentImpl implements EntityBeanType {
   ...
   private static final QName EJBCLASS$18 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-class");
   private static final QName PERSISTENCETYPE$20 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-type");
   private static final QName PRIMKEYCLASS$22 = new QName("http://java.sun.com/xml/ns/javaee", "prim-key-class");
   private static final QName REENTRANT$24 = new QName("http://java.sun.com/xml/ns/javaee", "reentrant");
   private static final QName CMPVERSION$26 = new QName("http://java.sun.com/xml/ns/javaee", "cmp-version");
   private static final QName ABSTRACTSCHEMANAME$28 = new QName("http://java.sun.com/xml/ns/javaee", "abstract-schema-name");
   private static final QName CMPFIELD$30 = new QName("http://java.sun.com/xml/ns/javaee", "cmp-field");
   private static final QName PRIMKEYFIELD$32 = new QName("http://java.sun.com/xml/ns/javaee", "primkey-field");
   private static final QName ENVENTRY$34 = new QName("http://java.sun.com/xml/ns/javaee", "env-entry");
   private static final QName EJBREF$36 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-ref");
   private static final QName EJBLOCALREF$38 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-local-ref");
   private static final QName SERVICEREF$40 = new QName("http://java.sun.com/xml/ns/javaee", "service-ref");
   private static final QName RESOURCEREF$42 = new QName("http://java.sun.com/xml/ns/javaee", "resource-ref");
   private static final QName RESOURCEENVREF$44 = new QName("http://java.sun.com/xml/ns/javaee", "resource-env-ref");
   private static final QName MESSAGEDESTINATIONREF$46 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination-ref");
   private static final QName PERSISTENCECONTEXTREF$48 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-context-ref");
   private static final QName PERSISTENCEUNITREF$50 = new QName("http://java.sun.com/xml/ns/javaee", "persistence-unit-ref");
   private static final QName POSTCONSTRUCT$52 = new QName("http://java.sun.com/xml/ns/javaee", "post-construct");
   private static final QName PREDESTROY$54 = new QName("http://java.sun.com/xml/ns/javaee", "pre-destroy");
   private static final QName DATASOURCE$56 = new QName("http://java.sun.com/xml/ns/javaee", "data-source");
   private static final QName SECURITYROLEREF$58 = new QName("http://java.sun.com/xml/ns/javaee", "security-role-ref");
   private static final QName SECURITYIDENTITY$60 = new QName("http://java.sun.com/xml/ns/javaee", "security-identity");
   private static final QName QUERY$62 = new QName("http://java.sun.com/xml/ns/javaee", "query");
   ...
   public SecurityRoleRefType[] getSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(SECURITYROLEREF$58, targetList);
   ...
   public SecurityRoleRefType getSecurityRoleRefArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (SecurityRoleRefType)this.get_store().find_element_user(SECURITYROLEREF$58, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYROLEREF$58);
      }
   }

   public void setSecurityRoleRefArray(SecurityRoleRefType[] securityRoleRefArray) {
      this.check_orphaned();
      this.arraySetterHelper(securityRoleRefArray, SECURITYROLEREF$58);
   }

   public void setSecurityRoleRefArray(int i, SecurityRoleRefType securityRoleRef) {
      this.generatedSetterHelperImpl(securityRoleRef, SECURITYROLEREF$58, i, (short)2);
   }
   ...
   public SecurityRoleRefType insertNewSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().insert_element_user(SECURITYROLEREF$58, i);
         return target;
      }
   }
   ...
   public SecurityRoleRefType addNewSecurityRoleRef() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().add_element_user(SECURITYROLEREF$58);
         return target;
      }
   }
   ...
   public void removeSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYROLEREF$58, i);
      }
   }
   ...
   public SecurityIdentityType getSecurityIdentity() {
      synchronized(this.monitor()) {
         ...
         target = (SecurityIdentityType)this.get_store().find_element_user(SECURITYIDENTITY$60, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYIDENTITY$60) != 0;
      }
   }

   public void setSecurityIdentity(SecurityIdentityType securityIdentity) {
      this.generatedSetterHelperImpl(securityIdentity, SECURITYIDENTITY$60, 0, (short)1);
   }
   ...
   public SecurityIdentityType addNewSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityIdentityType target = null;
         target = (SecurityIdentityType)this.get_store().add_element_user(SECURITYIDENTITY$60);
         return target;
      }
   }
   ...
   public void unsetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYIDENTITY$60, 0);
      }
   }
   ...
   public QueryType[] getQueryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(QUERY$62, targetList);
   ...
   public QueryType getQueryArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (QueryType)this.get_store().find_element_user(QUERY$62, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfQueryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(QUERY$62);
      }
   }

   public void setQueryArray(QueryType[] queryArray) {
      this.check_orphaned();
      this.arraySetterHelper(queryArray, QUERY$62);
   }

   public void setQueryArray(int i, QueryType query) {
      this.generatedSetterHelperImpl(query, QUERY$62, i, (short)2);
   }
   ...
   public QueryType insertNewQuery(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         QueryType target = null;
         target = (QueryType)this.get_store().insert_element_user(QUERY$62, i);
         return target;
      }
   }
   ...
   public QueryType addNewQuery() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         QueryType target = null;
         target = (QueryType)this.get_store().add_element_user(QUERY$62);
         return target;
      }
   }
   ...
   public void removeQuery(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(QUERY$62, i);
      }
   }
   ...
   public java.lang.String getId() {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(ID$64);
   ...
   public XmlID xgetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlID target = null;
         target = (XmlID)this.get_store().find_attribute_user(ID$64);
         return target;
      }
   }
   ...
   public boolean isSetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().find_attribute_user(ID$64) != null;
      }
   }
   ...
   public void setId(java.lang.String id) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(ID$64);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_attribute_user(ID$64);
         }
   ...
   public void xsetId(XmlID id) {
      synchronized(this.monitor()) {
         ...
         target = (XmlID)this.get_store().find_attribute_user(ID$64);
         if (target == null) {
            target = (XmlID)this.get_store().add_attribute_user(ID$64);
         }
   ...
   public void unsetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_attribute(ID$64);
      }
   }
}
