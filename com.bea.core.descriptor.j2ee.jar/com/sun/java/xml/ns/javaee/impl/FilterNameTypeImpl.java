...
public class FilterNameTypeImpl extends JavaStringHolderEx implements FilterNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FilterNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FilterNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
