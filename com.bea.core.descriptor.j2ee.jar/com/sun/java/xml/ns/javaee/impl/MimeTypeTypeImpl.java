...
public class MimeTypeTypeImpl extends JavaStringHolderEx implements MimeTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MimeTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MimeTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
