...
public class TrackingModeTypeImpl extends JavaStringEnumerationHolderEx implements TrackingModeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TrackingModeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TrackingModeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
