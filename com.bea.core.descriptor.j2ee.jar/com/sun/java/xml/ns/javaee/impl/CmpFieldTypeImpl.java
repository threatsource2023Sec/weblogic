...
public class CmpFieldTypeImpl extends XmlComplexContentImpl implements CmpFieldType {
   private static final long serialVersionUID = 1L;
   private static final QName DESCRIPTION$0 = new QName("http://java.sun.com/xml/ns/javaee", "description");
   private static final QName FIELDNAME$2 = new QName("http://java.sun.com/xml/ns/javaee", "field-name");
   private static final QName ID$4 = new QName("", "id");

   public CmpFieldTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public JavaIdentifierType getFieldName() {
      synchronized(this.monitor()) {
         ...
         target = (JavaIdentifierType)this.get_store().find_element_user(FIELDNAME$2, 0);
         return target == null ? null : target;
      }
   }

   public void setFieldName(JavaIdentifierType fieldName) {
      this.generatedSetterHelperImpl(fieldName, FIELDNAME$2, 0, (short)1);
   }

   public JavaIdentifierType addNewFieldName() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JavaIdentifierType target = null;
         target = (JavaIdentifierType)this.get_store().add_element_user(FIELDNAME$2);
         return target;
      }
   }
