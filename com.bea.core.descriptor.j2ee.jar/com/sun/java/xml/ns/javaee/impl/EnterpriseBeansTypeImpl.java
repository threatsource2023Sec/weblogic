...
public class EnterpriseBeansTypeImpl extends XmlComplexContentImpl implements EnterpriseBeansType {
   ...
   private static final QName SESSION$0 = new QName("http://java.sun.com/xml/ns/javaee", "session");
   private static final QName ENTITY$2 = new QName("http://java.sun.com/xml/ns/javaee", "entity");
   private static final QName MESSAGEDRIVEN$4 = new QName("http://java.sun.com/xml/ns/javaee", "message-driven");
