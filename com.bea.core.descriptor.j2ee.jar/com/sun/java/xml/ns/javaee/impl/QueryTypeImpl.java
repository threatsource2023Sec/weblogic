...
import com.sun.java.xml.ns.javaee.QueryMethodType;
import com.sun.java.xml.ns.javaee.QueryType;
import com.sun.java.xml.ns.javaee.ResultTypeMappingType;
...
public class QueryTypeImpl extends XmlComplexContentImpl implements QueryType {
   ...
   private static final QName QUERYMETHOD$2 = new QName("http://java.sun.com/xml/ns/javaee", "query-method");
   private static final QName RESULTTYPEMAPPING$4 = new QName("http://java.sun.com/xml/ns/javaee", "result-type-mapping");
   private static final QName EJBQL$6 = new QName("http://java.sun.com/xml/ns/javaee", "ejb-ql");
