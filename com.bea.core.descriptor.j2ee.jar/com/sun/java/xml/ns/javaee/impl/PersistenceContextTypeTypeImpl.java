...
public class PersistenceContextTypeTypeImpl extends JavaStringEnumerationHolderEx implements PersistenceContextTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PersistenceContextTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PersistenceContextTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
