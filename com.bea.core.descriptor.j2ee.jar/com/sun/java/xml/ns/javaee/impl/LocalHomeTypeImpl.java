...
public class LocalHomeTypeImpl extends JavaStringHolderEx implements LocalHomeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public LocalHomeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected LocalHomeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
