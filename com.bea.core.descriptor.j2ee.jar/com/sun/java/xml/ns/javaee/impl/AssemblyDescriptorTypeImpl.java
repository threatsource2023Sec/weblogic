...
import com.sun.java.xml.ns.javaee.ContainerTransactionType;
import com.sun.java.xml.ns.javaee.ExcludeListType;
import com.sun.java.xml.ns.javaee.InterceptorBindingType;
import com.sun.java.xml.ns.javaee.MessageDestinationType;
import com.sun.java.xml.ns.javaee.MethodPermissionType;
...
public class AssemblyDescriptorTypeImpl extends XmlComplexContentImpl implements AssemblyDescriptorType {
   ...
   private static final QName SECURITYROLE$0 = new QName("http://java.sun.com/xml/ns/javaee", "security-role");
   private static final QName METHODPERMISSION$2 = new QName("http://java.sun.com/xml/ns/javaee", "method-permission");
   private static final QName CONTAINERTRANSACTION$4 = new QName("http://java.sun.com/xml/ns/javaee", "container-transaction");
   private static final QName INTERCEPTORBINDING$6 = new QName("http://java.sun.com/xml/ns/javaee", "interceptor-binding");
   private static final QName MESSAGEDESTINATION$8 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination");
   private static final QName EXCLUDELIST$10 = new QName("http://java.sun.com/xml/ns/javaee", "exclude-list");
   private static final QName APPLICATIONEXCEPTION$12 = new QName("http://java.sun.com/xml/ns/javaee", "application-exception");
