...
public class PersistenceTypeTypeImpl extends JavaStringEnumerationHolderEx implements PersistenceTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PersistenceTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PersistenceTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
