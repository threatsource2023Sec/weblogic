...
public class PropertyTypeImpl extends XmlComplexContentImpl implements PropertyType {
   ...
   private static final QName VALUE$2 = new QName("http://java.sun.com/xml/ns/javaee", "value");
   ...
   public XsdStringType getValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdStringType target = null;
         target = (XsdStringType)this.get_store().find_element_user(VALUE$2, 0);
         return target == null ? null : target;
      }
   }
   ...
   public XsdStringType addNewValue() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdStringType target = null;
         target = (XsdStringType)this.get_store().add_element_user(VALUE$2);
         return target;
      }
   }
