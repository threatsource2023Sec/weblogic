...
public class JspPropertyGroupTypeImpl extends XmlComplexContentImpl implements JspPropertyGroupType {
   ...
   private static final QName URLPATTERN$6 = new QName("http://java.sun.com/xml/ns/javaee", "url-pattern");
   private static final QName ELIGNORED$8 = new QName("http://java.sun.com/xml/ns/javaee", "el-ignored");
   private static final QName PAGEENCODING$10 = new QName("http://java.sun.com/xml/ns/javaee", "page-encoding");
   private static final QName SCRIPTINGINVALID$12 = new QName("http://java.sun.com/xml/ns/javaee", "scripting-invalid");
   private static final QName ISXML$14 = new QName("http://java.sun.com/xml/ns/javaee", "is-xml");
   private static final QName INCLUDEPRELUDE$16 = new QName("http://java.sun.com/xml/ns/javaee", "include-prelude");
   private static final QName INCLUDECODA$18 = new QName("http://java.sun.com/xml/ns/javaee", "include-coda");
   private static final QName DEFERREDSYNTAXALLOWEDASLITERAL$20 = new QName("http://java.sun.com/xml/ns/javaee", "deferred-syntax-allowed-as-literal");
   private static final QName TRIMDIRECTIVEWHITESPACES$22 = new QName("http://java.sun.com/xml/ns/javaee", "trim-directive-whitespaces");
   private static final QName DEFAULTCONTENTTYPE$24 = new QName("http://java.sun.com/xml/ns/javaee", "default-content-type");
   private static final QName BUFFER$26 = new QName("http://java.sun.com/xml/ns/javaee", "buffer");
   private static final QName ERRORONUNDECLAREDNAMESPACE$28 = new QName("http://java.sun.com/xml/ns/javaee", "error-on-undeclared-namespace");
