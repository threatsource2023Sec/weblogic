...
public class CookieDomainTypeImpl extends JavaStringHolderEx implements CookieDomainType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CookieDomainTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CookieDomainTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
