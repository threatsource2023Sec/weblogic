...
import com.sun.java.xml.ns.javaee.MessageDestinationUsageType;
...
public class MessageDestinationRefTypeImpl extends XmlComplexContentImpl implements MessageDestinationRefType {
   ...
   private static final QName MESSAGEDESTINATIONREFNAME$2 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination-ref-name");
   private static final QName MESSAGEDESTINATIONTYPE$4 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination-type");
   private static final QName MESSAGEDESTINATIONUSAGE$6 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination-usage");
   private static final QName MESSAGEDESTINATIONLINK$8 = new QName("http://java.sun.com/xml/ns/javaee", "message-destination-link");
   ...
   private static final QName LOOKUPNAME$14 = new QName("http://java.sun.com/xml/ns/javaee", "lookup-name");
