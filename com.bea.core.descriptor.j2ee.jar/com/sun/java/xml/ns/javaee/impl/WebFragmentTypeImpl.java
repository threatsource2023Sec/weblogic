...
public class WebFragmentTypeImpl extends XmlComplexContentImpl implements WebFragmentType {
   ...
   private static final QName ORDERING$66 = new QName("http://java.sun.com/xml/ns/javaee", "ordering");
   ...
   public OrderingType[] getOrderingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(ORDERING$66, targetList);
   ...
   public OrderingType getOrderingArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (OrderingType)this.get_store().find_element_user(ORDERING$66, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfOrderingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(ORDERING$66);
      }
   }

   public void setOrderingArray(OrderingType[] orderingArray) {
      this.check_orphaned();
      this.arraySetterHelper(orderingArray, ORDERING$66);
   }

   public void setOrderingArray(int i, OrderingType ordering) {
      this.generatedSetterHelperImpl(ordering, ORDERING$66, i, (short)2);
   }
   ...
   public OrderingType insertNewOrdering(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         OrderingType target = null;
         target = (OrderingType)this.get_store().insert_element_user(ORDERING$66, i);
         return target;
      }
   }
   ...
   public OrderingType addNewOrdering() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         OrderingType target = null;
         target = (OrderingType)this.get_store().add_element_user(ORDERING$66);
         return target;
      }
   }
   ...
   public void removeOrdering(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ORDERING$66, i);
      }
   }
