...
public class EjbRefTypeTypeImpl extends JavaStringEnumerationHolderEx implements EjbRefTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EjbRefTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EjbRefTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
