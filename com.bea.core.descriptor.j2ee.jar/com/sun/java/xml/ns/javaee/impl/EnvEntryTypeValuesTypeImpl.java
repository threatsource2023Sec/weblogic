...
public class EnvEntryTypeValuesTypeImpl extends JavaStringHolderEx implements EnvEntryTypeValuesType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EnvEntryTypeValuesTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EnvEntryTypeValuesTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
