...
public class TimeUnitTypeTypeImpl extends JavaStringEnumerationHolderEx implements TimeUnitTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TimeUnitTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TimeUnitTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
