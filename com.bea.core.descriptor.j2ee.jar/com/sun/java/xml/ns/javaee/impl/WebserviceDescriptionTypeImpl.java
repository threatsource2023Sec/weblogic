...
public class WebserviceDescriptionTypeImpl extends XmlComplexContentImpl implements WebserviceDescriptionType {
   ...
   private static final QName WEBSERVICEDESCRIPTIONNAME$6 = new QName("http://java.sun.com/xml/ns/javaee", "webservice-description-name");
   private static final QName WSDLFILE$8 = new QName("http://java.sun.com/xml/ns/javaee", "wsdl-file");
   private static final QName JAXRPCMAPPINGFILE$10 = new QName("http://java.sun.com/xml/ns/javaee", "jaxrpc-mapping-file");
   private static final QName PORTCOMPONENT$12 = new QName("http://java.sun.com/xml/ns/javaee", "port-component");
