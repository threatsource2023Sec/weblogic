...
public class SecurityConstraintTypeImpl extends XmlComplexContentImpl implements SecurityConstraintType {
   ...
   private static final QName DISPLAYNAME$0 = new QName("http://java.sun.com/xml/ns/javaee", "display-name");
   private static final QName WEBRESOURCECOLLECTION$2 = new QName("http://java.sun.com/xml/ns/javaee", "web-resource-collection");
   private static final QName AUTHCONSTRAINT$4 = new QName("http://java.sun.com/xml/ns/javaee", "auth-constraint");
   private static final QName USERDATACONSTRAINT$6 = new QName("http://java.sun.com/xml/ns/javaee", "user-data-constraint");
