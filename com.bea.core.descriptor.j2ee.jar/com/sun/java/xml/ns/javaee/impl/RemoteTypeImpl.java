...
public class RemoteTypeImpl extends JavaStringHolderEx implements RemoteType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RemoteTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RemoteTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
