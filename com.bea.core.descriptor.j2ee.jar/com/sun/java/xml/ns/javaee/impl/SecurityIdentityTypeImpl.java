...
public class SecurityIdentityTypeImpl extends XmlComplexContentImpl implements SecurityIdentityType {
   ...
   private static final QName USECALLERIDENTITY$2 = new QName("http://java.sun.com/xml/ns/javaee", "use-caller-identity");
   private static final QName RUNAS$4 = new QName("http://java.sun.com/xml/ns/javaee", "run-as");
