...
public class XsdStringTypeImpl extends JavaStringHolderEx implements XsdStringType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public XsdStringTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected XsdStringTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
