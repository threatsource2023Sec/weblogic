...
public class AddressingResponsesTypeImpl extends JavaStringEnumerationHolderEx implements AddressingResponsesType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public AddressingResponsesTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected AddressingResponsesTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
