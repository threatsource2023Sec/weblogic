...
public class CmpVersionTypeImpl extends JavaStringEnumerationHolderEx implements CmpVersionType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CmpVersionTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CmpVersionTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
