...
public class CookiePathTypeImpl extends JavaStringHolderEx implements CookiePathType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CookiePathTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CookiePathTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
