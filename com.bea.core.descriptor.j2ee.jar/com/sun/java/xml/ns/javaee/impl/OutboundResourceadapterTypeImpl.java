...
public class OutboundResourceadapterTypeImpl extends XmlComplexContentImpl implements OutboundResourceadapterType {
   ...
   private static final QName CONNECTIONDEFINITION$0 = new QName("http://java.sun.com/xml/ns/javaee", "connection-definition");
   private static final QName TRANSACTIONSUPPORT$2 = new QName("http://java.sun.com/xml/ns/javaee", "transaction-support");
   private static final QName AUTHENTICATIONMECHANISM$4 = new QName("http://java.sun.com/xml/ns/javaee", "authentication-mechanism");
   private static final QName REAUTHENTICATIONSUPPORT$6 = new QName("http://java.sun.com/xml/ns/javaee", "reauthentication-support");
