...
public class WebResourceCollectionTypeImpl extends XmlComplexContentImpl implements WebResourceCollectionType {
   ...
   private static final QName WEBRESOURCENAME$0 = new QName("http://java.sun.com/xml/ns/javaee", "web-resource-name");
   private static final QName DESCRIPTION$2 = new QName("http://java.sun.com/xml/ns/javaee", "description");
   private static final QName URLPATTERN$4 = new QName("http://java.sun.com/xml/ns/javaee", "url-pattern");
   private static final QName HTTPMETHOD$6 = new QName("http://java.sun.com/xml/ns/javaee", "http-method");
   private static final QName HTTPMETHODOMISSION$8 = new QName("http://java.sun.com/xml/ns/javaee", "http-method-omission");
