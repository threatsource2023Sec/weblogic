...
public interface GenericBooleanType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(GenericBooleanType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("genericbooleantypee5edtype");
