...
public interface DescriptionType extends XsdStringType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DescriptionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("descriptiontype63b7type");
