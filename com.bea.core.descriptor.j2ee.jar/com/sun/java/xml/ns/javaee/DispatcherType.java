...
public interface DispatcherType extends String {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(DispatcherType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("dispatchertype7dd4type");
   ...
   Enum ASYNC = DispatcherType.Enum.forString("ASYNC");
   ...
   public static final class Enum extends StringEnumAbstractBase {
      ...
      static final int INT_ASYNC = 4;
      static final int INT_ERROR = 5;
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("FORWARD", 1), new Enum("INCLUDE", 2), new Enum("REQUEST", 3), new Enum("ASYNC", 4), new Enum("ERROR", 5)});
