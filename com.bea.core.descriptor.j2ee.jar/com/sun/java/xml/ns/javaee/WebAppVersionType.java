...
public interface WebAppVersionType extends XmlToken {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(WebAppVersionType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("webappversiontype132etype");
   Enum X_3_0 = WebAppVersionType.Enum.forString("3.0");
   int INT_X_3_0 = 1;
   ...
   public static final class Enum extends StringEnumAbstractBase {
      static final int INT_X_3_0 = 1;
      public static final StringEnumAbstractBase.Table table = new StringEnumAbstractBase.Table(new Enum[]{new Enum("3.0", 1)});
