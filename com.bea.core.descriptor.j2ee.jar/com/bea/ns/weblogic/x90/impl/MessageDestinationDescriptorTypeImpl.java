...
import com.bea.ns.weblogic.x90.DestinationJndiNameType;
import com.bea.ns.weblogic.x90.InitialContextFactoryType;
import com.bea.ns.weblogic.x90.MessageDestinationDescriptorType;
import com.bea.ns.weblogic.x90.MessageDestinationNameType;
import com.bea.ns.weblogic.x90.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://www.bea.com/ns/weblogic/90", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://www.bea.com/ns/weblogic/90", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://www.bea.com/ns/weblogic/90", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://www.bea.com/ns/weblogic/90", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://www.bea.com/ns/weblogic/90", "destination-resource-link");
