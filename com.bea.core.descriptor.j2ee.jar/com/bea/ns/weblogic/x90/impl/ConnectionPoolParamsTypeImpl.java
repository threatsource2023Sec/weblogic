...
public class ConnectionPoolParamsTypeImpl extends XmlComplexContentImpl implements ConnectionPoolParamsType {
   ...
   public XsdPositiveIntegerType getShrinkFrequencySeconds() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdPositiveIntegerType target = null;
         target = (XsdPositiveIntegerType)this.get_store().find_element_user(SHRINKFREQUENCYSECONDS$8, 0);
         return target == null ? null : target;
      }
   }
   ...
   public void setShrinkFrequencySeconds(XsdPositiveIntegerType shrinkFrequencySeconds) {
   ...
   public XsdPositiveIntegerType addNewShrinkFrequencySeconds() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdPositiveIntegerType target = null;
         target = (XsdPositiveIntegerType)this.get_store().add_element_user(SHRINKFREQUENCYSECONDS$8);
         return target;
      }
   }
   ...
   public XsdNonNegativeIntegerType getConnectionReserveTimeoutSeconds() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdNonNegativeIntegerType target = null;
         target = (XsdNonNegativeIntegerType)this.get_store().find_element_user(CONNECTIONRESERVETIMEOUTSECONDS$16, 0);
         return target == null ? null : target;
      }
   }
   ...
   public void setConnectionReserveTimeoutSeconds(XsdNonNegativeIntegerType connectionReserveTimeoutSeconds) {
   ...
   public XsdNonNegativeIntegerType addNewConnectionReserveTimeoutSeconds() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XsdNonNegativeIntegerType target = null;
         target = (XsdNonNegativeIntegerType)this.get_store().add_element_user(CONNECTIONRESERVETIMEOUTSECONDS$16);
         return target;
      }
   }
