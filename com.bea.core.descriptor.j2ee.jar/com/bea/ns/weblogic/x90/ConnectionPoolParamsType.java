...
public interface ConnectionPoolParamsType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ConnectionPoolParamsType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("connectionpoolparamstype1264type");
   ...
   void setShrinkFrequencySeconds(XsdPositiveIntegerType var1);
   ...
   void setConnectionReserveTimeoutSeconds(XsdNonNegativeIntegerType var1);
