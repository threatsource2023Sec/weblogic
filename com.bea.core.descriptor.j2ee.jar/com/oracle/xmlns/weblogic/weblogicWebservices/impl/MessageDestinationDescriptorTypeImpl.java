...
import com.oracle.xmlns.weblogic.weblogicWebservices.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.weblogicWebservices.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.weblogicWebservices.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.weblogicWebservices.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.weblogicWebservices.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "destination-resource-link");
