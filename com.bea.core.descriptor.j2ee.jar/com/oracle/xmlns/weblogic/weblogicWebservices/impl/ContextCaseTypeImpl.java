...
import com.oracle.xmlns.weblogic.weblogicWebservices.ContextCaseType;
import com.oracle.xmlns.weblogic.weblogicWebservices.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicWebservices.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName USERNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "user-name");
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-webservices", "fair-share-request-class");
