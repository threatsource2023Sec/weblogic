...
public class TrueFalseTypeImpl extends JavaBooleanHolderEx implements TrueFalseType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TrueFalseTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TrueFalseTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
