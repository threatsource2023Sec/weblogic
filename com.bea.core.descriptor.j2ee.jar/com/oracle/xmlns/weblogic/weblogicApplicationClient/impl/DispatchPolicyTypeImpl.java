...
public class DispatchPolicyTypeImpl extends JavaStringHolderEx implements DispatchPolicyType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public DispatchPolicyTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected DispatchPolicyTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
