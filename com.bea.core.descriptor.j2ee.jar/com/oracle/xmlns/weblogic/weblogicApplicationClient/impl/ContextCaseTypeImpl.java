...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.ContextCaseType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName USERNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "user-name");
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "fair-share-request-class");
