...
public class ServiceReferenceDescriptionTypeImpl extends XmlComplexContentImpl implements ServiceReferenceDescriptionType {
   ...
   private static final QName SERVICEREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "service-ref-name");
   private static final QName WSDLURL$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "wsdl-url");
   ...
   private static final QName PORTINFO$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "port-info");
