...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.ContextRequestClassType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.DispatchPolicyType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.MaxThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.MinThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.ResponseTimeRequestClassType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.WorkManagerShutdownTriggerType;
import com.oracle.xmlns.weblogic.weblogicApplicationClient.WorkManagerType;
...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "context-request-class");
   private static final QName REQUESTCLASSNAME$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "request-class-name");
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "ignore-stuck-threads");
