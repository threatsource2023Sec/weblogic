...
import com.oracle.xmlns.weblogic.weblogicApplicationClient.RunAsPrincipalNameType;
import javax.xml.namespace.QName;

public class RunAsPrincipalNameTypeImpl extends JavaStringHolderEx implements RunAsPrincipalNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RunAsPrincipalNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RunAsPrincipalNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
