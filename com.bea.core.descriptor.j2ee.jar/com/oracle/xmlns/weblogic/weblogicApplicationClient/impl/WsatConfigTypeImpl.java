...
public class WsatConfigTypeImpl extends XmlComplexContentImpl implements WsatConfigType {
   ...
   private static final QName ENABLED$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "enabled");
   private static final QName FLOWTYPE$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "flow-type");
   private static final QName VERSION$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application-client", "version");
