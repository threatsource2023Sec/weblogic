...
public interface ManagedScheduledExecutorServiceType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(ManagedScheduledExecutorServiceType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("managedscheduledexecutorservicetyped414type");
