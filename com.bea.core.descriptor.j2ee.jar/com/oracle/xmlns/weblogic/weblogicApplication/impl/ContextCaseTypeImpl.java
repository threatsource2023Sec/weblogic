...
import com.oracle.xmlns.weblogic.weblogicApplication.ContextCaseType;
import com.oracle.xmlns.weblogic.weblogicApplication.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicApplication.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "fair-share-request-class");
