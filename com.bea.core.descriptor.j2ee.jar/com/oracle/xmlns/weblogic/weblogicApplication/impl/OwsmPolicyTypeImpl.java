...
public class OwsmPolicyTypeImpl extends XmlComplexContentImpl implements OwsmPolicyType {
   ...
   private static final QName URI$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "uri");
   private static final QName STATUS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "status");
   private static final QName CATEGORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "category");
   private static final QName SECURITYCONFIGURATIONPROPERTY$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "security-configuration-property");
