...
import com.oracle.xmlns.weblogic.weblogicApplication.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.weblogicApplication.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.weblogicApplication.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.weblogicApplication.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.weblogicApplication.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-application", "destination-resource-link");
