...
import com.oracle.xmlns.weblogic.jdbcDataSource.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.jdbcDataSource.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.jdbcDataSource.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.jdbcDataSource.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.jdbcDataSource.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "destination-resource-link");
