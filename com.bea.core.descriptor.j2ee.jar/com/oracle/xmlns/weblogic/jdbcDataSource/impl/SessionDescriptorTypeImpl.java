...
public class SessionDescriptorTypeImpl extends XmlComplexContentImpl implements SessionDescriptorType {
   ...
   private static final QName MAXSAVEPOSTSIZE$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "max-save-post-size");
   private static final QName SAVEPOSTTIMEOUTSECS$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "save-post-timeout-secs");
   private static final QName SAVEPOSTTIMEOUTINTERVALSECS$8 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "save-post-timeout-interval-secs");
   private static final QName DEBUGENABLED$10 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "debug-enabled");
   private static final QName IDLENGTH$12 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "id-length");
   private static final QName AUTHCOOKIEIDLENGTH$14 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "auth-cookie-id-length");
   private static final QName TRACKINGENABLED$16 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "tracking-enabled");
   private static final QName CACHESIZE$18 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cache-size");
   private static final QName MAXINMEMORYSESSIONS$20 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "max-in-memory-sessions");
   private static final QName COOKIESENABLED$22 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookies-enabled");
   private static final QName COOKIENAME$24 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-name");
   private static final QName COOKIEPATH$26 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-path");
   private static final QName COOKIEDOMAIN$28 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-domain");
   private static final QName COOKIECOMMENT$30 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-comment");
   private static final QName COOKIESECURE$32 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-secure");
   private static final QName COOKIEMAXAGESECS$34 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-max-age-secs");
   private static final QName COOKIEHTTPONLY$36 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "cookie-http-only");
   private static final QName PERSISTENTSTORETYPE$38 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-store-type");
   private static final QName PERSISTENTSTORECOOKIENAME$40 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-store-cookie-name");
   private static final QName PERSISTENTSTOREDIR$42 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-store-dir");
   private static final QName PERSISTENTSTOREPOOL$44 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-store-pool");
   private static final QName PERSISTENTDATASOURCEJNDINAME$46 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-data-source-jndi-name");
   private static final QName PERSISTENTSESSIONFLUSHINTERVAL$48 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-session-flush-interval");
   private static final QName PERSISTENTSESSIONFLUSHTHRESHOLD$50 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-session-flush-threshold");
   private static final QName PERSISTENTASYNCQUEUETIMEOUT$52 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-async-queue-timeout");
   private static final QName PERSISTENTSTORETABLE$54 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "persistent-store-table");
   private static final QName JDBCCOLUMNNAMEMAXINACTIVEINTERVAL$56 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "jdbc-column-name-max-inactive-interval");
   private static final QName URLREWRITINGENABLED$58 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "url-rewriting-enabled");
   private static final QName HTTPPROXYCACHINGOFCOOKIES$60 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "http-proxy-caching-of-cookies");
   private static final QName ENCODESESSIONIDINQUERYPARAMS$62 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "encode-session-id-in-query-params");
   private static final QName MONITORINGATTRIBUTENAME$64 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "monitoring-attribute-name");
   private static final QName SHARINGENABLED$66 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "sharing-enabled");
   private static final QName INVALIDATEONRELOGIN$68 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "invalidate-on-relogin");
