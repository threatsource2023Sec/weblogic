...
import com.oracle.xmlns.weblogic.jdbcDataSource.ServiceReferenceDescriptionType;
...
public class ServiceReferenceDescriptionTypeImpl extends XmlComplexContentImpl implements ServiceReferenceDescriptionType {
   ...
   private static final QName SERVICEREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "service-ref-name");
   private static final QName WSDLURL$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "wsdl-url");
   private static final QName CALLPROPERTY$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "call-property");
   private static final QName PORTINFO$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "port-info");
