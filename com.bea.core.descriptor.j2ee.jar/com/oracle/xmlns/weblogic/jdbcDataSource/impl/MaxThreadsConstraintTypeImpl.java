...
public class MaxThreadsConstraintTypeImpl extends XmlComplexContentImpl implements MaxThreadsConstraintType {
   ...
   private static final QName COUNT$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "count");
   private static final QName POOLNAME$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "pool-name");
   private static final QName QUEUESIZE$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "queue-size");
