...
import com.oracle.xmlns.weblogic.jdbcDataSource.DefaultResourcePrincipalType;
import com.oracle.xmlns.weblogic.jdbcDataSource.ResourceDescriptionType;
...
public class ResourceDescriptionTypeImpl extends XmlComplexContentImpl implements ResourceDescriptionType {
   ...
   private static final QName RESREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "res-ref-name");
   private static final QName JNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "jndi-name");
   private static final QName RESOURCELINK$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "resource-link");
   private static final QName DEFAULTRESOURCEPRINCIPAL$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "default-resource-principal");
