...
import com.oracle.xmlns.weblogic.jdbcDataSource.CapacityType;
import com.oracle.xmlns.weblogic.jdbcDataSource.ContextRequestClassType;
import com.oracle.xmlns.weblogic.jdbcDataSource.DispatchPolicyType;
import com.oracle.xmlns.weblogic.jdbcDataSource.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.jdbcDataSource.MaxThreadsConstraintType;
import com.oracle.xmlns.weblogic.jdbcDataSource.MinThreadsConstraintType;
import com.oracle.xmlns.weblogic.jdbcDataSource.ResponseTimeRequestClassType;
import com.oracle.xmlns.weblogic.jdbcDataSource.WorkManagerShutdownTriggerType;
import com.oracle.xmlns.weblogic.jdbcDataSource.WorkManagerType;
...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "context-request-class");
   private static final QName REQUESTCLASSNAME$8 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "request-class-name");
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "ignore-stuck-threads");
