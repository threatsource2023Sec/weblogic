...
import com.oracle.xmlns.weblogic.jdbcDataSource.ContextCaseType;
import com.oracle.xmlns.weblogic.jdbcDataSource.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.jdbcDataSource.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName USERNAME$0 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "user-name");
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/jdbc-data-source", "fair-share-request-class");
