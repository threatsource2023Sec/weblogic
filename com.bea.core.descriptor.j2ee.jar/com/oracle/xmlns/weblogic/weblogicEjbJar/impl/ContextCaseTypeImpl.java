...
import com.oracle.xmlns.weblogic.weblogicEjbJar.ContextCaseType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.GroupNameType;
...
public class ContextCaseTypeImpl extends XmlComplexContentImpl implements ContextCaseType {
   ...
   private static final QName USERNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "user-name");
   private static final QName GROUPNAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "group-name");
   private static final QName RESPONSETIMEREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "fair-share-request-class");
