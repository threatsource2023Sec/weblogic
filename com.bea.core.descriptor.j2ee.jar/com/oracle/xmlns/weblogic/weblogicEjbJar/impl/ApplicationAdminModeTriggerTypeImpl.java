...
import com.oracle.xmlns.weblogic.weblogicEjbJar.ApplicationAdminModeTriggerType;
...
public class ApplicationAdminModeTriggerTypeImpl extends XmlComplexContentImpl implements ApplicationAdminModeTriggerType {
   ...
   private static final QName MAXSTUCKTHREADTIME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "max-stuck-thread-time");
   private static final QName STUCKTHREADCOUNT$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "stuck-thread-count");
