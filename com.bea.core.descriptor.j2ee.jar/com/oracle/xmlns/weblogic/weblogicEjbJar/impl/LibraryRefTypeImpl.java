...
import com.oracle.xmlns.weblogic.weblogicEjbJar.LibraryRefType;
import javax.xml.namespace.QName;

public class LibraryRefTypeImpl extends XmlComplexContentImpl implements LibraryRefType {
   private static final long serialVersionUID = 1L;
   private static final QName LIBRARYNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "library-name");
   private static final QName SPECIFICATIONVERSION$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "specification-version");
   private static final QName IMPLEMENTATIONVERSION$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "implementation-version");
   private static final QName EXACTMATCH$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "exact-match");
   private static final QName CONTEXTROOT$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "context-root");
