...
import com.oracle.xmlns.weblogic.weblogicEjbJar.CapacityType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.ContextRequestClassType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.DispatchPolicyType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.FairShareRequestClassType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.MaxThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.MinThreadsConstraintType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.ResponseTimeRequestClassType;
import com.oracle.xmlns.weblogic.weblogicEjbJar.WorkManagerShutdownTriggerType;
...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "context-request-class");
   private static final QName REQUESTCLASSNAME$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "request-class-name");
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "ignore-stuck-threads");
