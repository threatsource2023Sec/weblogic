...
public class ManagedThreadFactoryTypeImpl extends XmlComplexContentImpl implements ManagedThreadFactoryType {
   ...
   private static final QName MAXCONCURRENTNEWTHREADS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "max-concurrent-new-threads");
   private static final QName PRIORITY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-ejb-jar", "priority");
