...
import com.oracle.xmlns.weblogic.weblogicWebApp.OperationInfoType;
import com.oracle.xmlns.weblogic.weblogicWebApp.OwsmPolicyType;
import com.oracle.xmlns.weblogic.weblogicWebApp.PortInfoType;
import com.oracle.xmlns.weblogic.weblogicWebApp.PropertyNamevalueType;
import com.oracle.xmlns.weblogic.weblogicWebApp.WsatConfigType;
...
public class PortInfoTypeImpl extends XmlComplexContentImpl implements PortInfoType {
   ...
   private static final QName PORTNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "port-name");
   private static final QName STUBPROPERTY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "stub-property");
   private static final QName CALLPROPERTY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "call-property");
   private static final QName WSATCONFIG$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "wsat-config");
   private static final QName OWSMPOLICY$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "owsm-policy");
   private static final QName OPERATION$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "operation");
