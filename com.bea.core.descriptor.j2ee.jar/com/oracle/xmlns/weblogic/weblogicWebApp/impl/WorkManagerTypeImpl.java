...
public class WorkManagerTypeImpl extends XmlComplexContentImpl implements WorkManagerType {
   ...
   private static final QName NAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "name");
   private static final QName RESPONSETIMEREQUESTCLASS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "response-time-request-class");
   private static final QName FAIRSHAREREQUESTCLASS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "fair-share-request-class");
   private static final QName CONTEXTREQUESTCLASS$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "context-request-class");
   ...
   private static final QName MINTHREADSCONSTRAINT$10 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "min-threads-constraint");
   private static final QName MINTHREADSCONSTRAINTNAME$12 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "min-threads-constraint-name");
   private static final QName MAXTHREADSCONSTRAINT$14 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "max-threads-constraint");
   private static final QName MAXTHREADSCONSTRAINTNAME$16 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "max-threads-constraint-name");
   private static final QName CAPACITY$18 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "capacity");
   private static final QName CAPACITYNAME$20 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "capacity-name");
   private static final QName WORKMANAGERSHUTDOWNTRIGGER$22 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "work-manager-shutdown-trigger");
   private static final QName IGNORESTUCKTHREADS$24 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "ignore-stuck-threads");
