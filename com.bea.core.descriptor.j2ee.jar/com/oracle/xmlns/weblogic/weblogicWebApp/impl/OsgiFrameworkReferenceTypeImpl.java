...
public class OsgiFrameworkReferenceTypeImpl extends XmlComplexContentImpl implements OsgiFrameworkReferenceType {
   ...
   private static final QName BUNDLESDIRECTORY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "bundles-directory");
   private static final QName APPLICATIONBUNDLESYMBOLICNAME$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "application-bundle-symbolic-name");
   private static final QName APPLICATIONBUNDLEVERSION$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-web-app", "application-bundle-version");
