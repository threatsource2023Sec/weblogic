...
import com.oracle.xmlns.weblogic.weblogicRdbmsJar.ManagedExecutorServiceType;
...
public class ManagedExecutorServiceTypeImpl extends XmlComplexContentImpl implements ManagedExecutorServiceType {
   ...
   private static final QName DISPATCHPOLICY$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "dispatch-policy");
   private static final QName MAXCONCURRENTLONGRUNNINGREQUESTS$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "max-concurrent-long-running-requests");
   private static final QName LONGRUNNINGPRIORITY$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-rdbms-jar", "long-running-priority");
