...
import com.oracle.xmlns.weblogic.weblogicConnector.DestinationJndiNameType;
import com.oracle.xmlns.weblogic.weblogicConnector.InitialContextFactoryType;
import com.oracle.xmlns.weblogic.weblogicConnector.MessageDestinationDescriptorType;
import com.oracle.xmlns.weblogic.weblogicConnector.MessageDestinationNameType;
import com.oracle.xmlns.weblogic.weblogicConnector.ProviderUrlType;
...
public class MessageDestinationDescriptorTypeImpl extends XmlComplexContentImpl implements MessageDestinationDescriptorType {
   ...
   private static final QName MESSAGEDESTINATIONNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "message-destination-name");
   private static final QName DESTINATIONJNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "destination-jndi-name");
   private static final QName INITIALCONTEXTFACTORY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "initial-context-factory");
   private static final QName PROVIDERURL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "provider-url");
   private static final QName DESTINATIONRESOURCELINK$8 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "destination-resource-link");
