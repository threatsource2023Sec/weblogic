...
import com.oracle.xmlns.weblogic.weblogicConnector.SecurityPermissionType;
...
public class SecurityPermissionTypeImpl extends XmlComplexContentImpl implements SecurityPermissionType {
   ...
   private static final QName SECURITYPERMISSIONSPEC$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "security-permission-spec");
