...
import com.oracle.xmlns.weblogic.weblogicConnector.ManagedThreadFactoryType;
...
public class ManagedThreadFactoryTypeImpl extends XmlComplexContentImpl implements ManagedThreadFactoryType {
   ...
   private static final QName MAXCONCURRENTNEWTHREADS$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "max-concurrent-new-threads");
   private static final QName PRIORITY$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "priority");
