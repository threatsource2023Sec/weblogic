...
import com.oracle.xmlns.weblogic.weblogicConnector.DefaultResourcePrincipalType;
import com.oracle.xmlns.weblogic.weblogicConnector.ResourceDescriptionType;
...
public class ResourceDescriptionTypeImpl extends XmlComplexContentImpl implements ResourceDescriptionType {
   ...
   private static final QName RESREFNAME$0 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "res-ref-name");
   private static final QName JNDINAME$2 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "jndi-name");
   private static final QName RESOURCELINK$4 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "resource-link");
   private static final QName DEFAULTRESOURCEPRINCIPAL$6 = new QName("http://xmlns.oracle.com/weblogic/weblogic-connector", "default-resource-principal");
