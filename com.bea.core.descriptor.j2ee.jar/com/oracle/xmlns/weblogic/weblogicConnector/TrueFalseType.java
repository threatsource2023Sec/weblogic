...
public interface TrueFalseType extends XsdBooleanType {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(TrueFalseType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("truefalsetype6ffctype");
