...
public class UserDataConstraintBeanImpl extends AbstractDescriptorBean implements UserDataConstraintBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private String _TransportGuarantee;
   private static SchemaHelper2 _schemaHelper;

   public UserDataConstraintBeanImpl() {
      this._initializeProperty(-1);
   }

   public UserDataConstraintBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public UserDataConstraintBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private UserDataConstraintBeanImpl bean;

      protected Helper(UserDataConstraintBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("TransportGuarantee") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            UserDataConstraintBeanImpl otherTyped = (UserDataConstraintBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            UserDataConstraintBeanImpl original = (UserDataConstraintBeanImpl)event.getSourceBean();
            UserDataConstraintBeanImpl proposed = (UserDataConstraintBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            UserDataConstraintBeanImpl copy = (UserDataConstraintBeanImpl)initialCopy;
