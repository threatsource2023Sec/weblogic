...
public class LicenseBeanImpl extends AbstractDescriptorBean implements LicenseBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private boolean _LicenseRequired;
   private static SchemaHelper2 _schemaHelper;

   public LicenseBeanImpl() {
      this._initializeProperty(-1);
   }

   public LicenseBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public LicenseBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setLicenseRequired(boolean param0) {
      boolean _oldVal = this._LicenseRequired;
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private LicenseBeanImpl bean;

      protected Helper(LicenseBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("LicenseRequired") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isLicenseRequiredSet()) {
               ...
               buf.append(String.valueOf(this.bean.isLicenseRequired()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            LicenseBeanImpl otherTyped = (LicenseBeanImpl)other;
            this.computeDiff("Descriptions", this.bean.getDescriptions(), otherTyped.getDescriptions(), false);
            this.computeDiff("Id", this.bean.getId(), otherTyped.getId(), false);
            this.computeDiff("LicenseRequired", this.bean.isLicenseRequired(), otherTyped.isLicenseRequired(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            LicenseBeanImpl original = (LicenseBeanImpl)event.getSourceBean();
            LicenseBeanImpl proposed = (LicenseBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("LicenseRequired")) {
                  original.setLicenseRequired(proposed.isLicenseRequired());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            LicenseBeanImpl copy = (LicenseBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("LicenseRequired")) && this.bean.isLicenseRequiredSet()) {
               copy.setLicenseRequired(this.bean.isLicenseRequired());
            }
