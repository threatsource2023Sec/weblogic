...
public class ServletMappingBeanImpl extends AbstractDescriptorBean implements ServletMappingBean, Serializable {
   private String _Id;
   private String _ServletName;
   private String[] _UrlPatterns;
   private static SchemaHelper2 _schemaHelper;

   public ServletMappingBeanImpl() {
      this._initializeProperty(-1);
   }

   public ServletMappingBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ServletMappingBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setUrlPatterns(String[] param0) {
      ...
      WebXmlValidator.validateServletURLPatterns(param0);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private ServletMappingBeanImpl bean;

      protected Helper(ServletMappingBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ServletMappingBeanImpl otherTyped = (ServletMappingBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ServletMappingBeanImpl original = (ServletMappingBeanImpl)event.getSourceBean();
            ServletMappingBeanImpl proposed = (ServletMappingBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ServletMappingBeanImpl copy = (ServletMappingBeanImpl)initialCopy;
