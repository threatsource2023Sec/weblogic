...
public class AuthConstraintBeanImpl extends AbstractDescriptorBean implements AuthConstraintBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private String[] _RoleNames;
   private static SchemaHelper2 _schemaHelper;

   public AuthConstraintBeanImpl() {
      this._initializeProperty(-1);
   }

   public AuthConstraintBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public AuthConstraintBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AuthConstraintBeanImpl bean;

      protected Helper(AuthConstraintBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("RoleNames") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AuthConstraintBeanImpl otherTyped = (AuthConstraintBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AuthConstraintBeanImpl original = (AuthConstraintBeanImpl)event.getSourceBean();
            AuthConstraintBeanImpl proposed = (AuthConstraintBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AuthConstraintBeanImpl copy = (AuthConstraintBeanImpl)initialCopy;
