...
public class InterceptorOrderBeanImpl extends AbstractDescriptorBean implements InterceptorOrderBean, Serializable {
   private String _Id;
   private String[] _InterceptorClasses;
   private static SchemaHelper2 _schemaHelper;

   public InterceptorOrderBeanImpl() {
      this._initializeProperty(-1);
   }

   public InterceptorOrderBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public InterceptorOrderBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private InterceptorOrderBeanImpl bean;

      protected Helper(InterceptorOrderBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Id")) {
            ...
            return propName.equals("InterceptorClasses") ? 0 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            InterceptorOrderBeanImpl otherTyped = (InterceptorOrderBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            InterceptorOrderBeanImpl original = (InterceptorOrderBeanImpl)event.getSourceBean();
            InterceptorOrderBeanImpl proposed = (InterceptorOrderBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            InterceptorOrderBeanImpl copy = (InterceptorOrderBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("InterceptorClasses")) && this.bean.isInterceptorClassesSet()) {
               Object o = this.bean.getInterceptorClasses();
