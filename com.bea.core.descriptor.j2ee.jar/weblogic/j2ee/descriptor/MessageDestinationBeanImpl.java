...
public class MessageDestinationBeanImpl extends AbstractDescriptorBean implements MessageDestinationBean, Serializable {
   ...
   public MessageDestinationBeanImpl() {
      this._initializeProperty(-1);
   }

   public MessageDestinationBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public MessageDestinationBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private MessageDestinationBeanImpl bean;

      protected Helper(MessageDestinationBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("MessageDestinationName") ? 3 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            MessageDestinationBeanImpl otherTyped = (MessageDestinationBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            MessageDestinationBeanImpl original = (MessageDestinationBeanImpl)event.getSourceBean();
            MessageDestinationBeanImpl proposed = (MessageDestinationBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            MessageDestinationBeanImpl copy = (MessageDestinationBeanImpl)initialCopy;
