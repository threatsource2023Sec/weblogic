...
public class ServiceRefHandlerBeanImpl extends AbstractDescriptorBean implements ServiceRefHandlerBean, Serializable {
   ...
   public ServiceRefHandlerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ServiceRefHandlerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public boolean isPortNamesInherited() {
      return false;
   }
   ...
   public void addPortName(String param0) {
      this._getHelper()._ensureNonNull(param0);
      String[] _new;
      if (this._isSet(8)) {
         _new = (String[])((String[])this._getHelper()._extendArray(this.getPortNames(), String.class, param0));
      } else {
         _new = new String[]{param0};
      }

      try {
         this.setPortNames(_new);
      } catch (Exception var4) {
         if (var4 instanceof RuntimeException) {
            throw (RuntimeException)var4;
         } else {
   ...
   public void removePortName(String param0) {
      String[] _old = this.getPortNames();
      String[] _new = (String[])((String[])this._getHelper()._removeElement(_old, String.class, param0));
      if (_new.length != _old.length) {
         try {
            this.setPortNames(_new);
   ...
   public void setPortNames(String[] param0) {
      param0 = param0 == null ? new String[0] : param0;
      param0 = this._getHelper()._trimElements(param0);
      String[] _oldVal = this._PortNames;
      this._PortNames = param0;
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      ...
      protected Helper(ServiceRefHandlerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("AdministeredObjects")) {
            ...
            return 17;
         } else if (propName.equals("PortNames")) {
            return 8;
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isPortNamesSet()) {
               buf.append("PortNames");
               buf.append(Arrays.toString(ArrayUtils.copyAndSort(this.bean.getPortNames())));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ServiceRefHandlerBeanImpl otherTyped = (ServiceRefHandlerBeanImpl)other;
            ...
            this.computeDiff("PortNames", this.bean.getPortNames(), otherTyped.getPortNames(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ServiceRefHandlerBeanImpl original = (ServiceRefHandlerBeanImpl)event.getSourceBean();
            ServiceRefHandlerBeanImpl proposed = (ServiceRefHandlerBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("PortNames")) {
                  if (type == 2) {
                     update.resetAddedObject(update.getAddedObject());
                     original.addPortName((String)update.getAddedObject());
                  } else {
                     if (type != 3) {
                        throw new AssertionError("Invalid type: " + type);
                     }

                     original.removePortName((String)update.getRemovedObject());
                  }

                  if (original.getPortNames() == null || original.getPortNames().length == 0) {
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ServiceRefHandlerBeanImpl copy = (ServiceRefHandlerBeanImpl)initialCopy;
            super.finishCopy(copy, includeObsolete, excludeProps);
            int i;
            if ((excludeProps == null || !excludeProps.contains("AdministeredObjects")) && this.bean.isAdministeredObjectsSet() && !copy._isSet(26)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("ConnectionFactories")) && this.bean.isConnectionFactoriesSet() && !copy._isSet(25)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("EjbLocalRefs")) && this.bean.isEjbLocalRefsSet() && !copy._isSet(11)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("EjbRefs")) && this.bean.isEjbRefsSet() && !copy._isSet(10)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("EnvEntries")) && this.bean.isEnvEntriesSet() && !copy._isSet(9)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("JmsConnectionFactories")) && this.bean.isJmsConnectionFactoriesSet() && !copy._isSet(22)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("JmsDestinations")) && this.bean.isJmsDestinationsSet() && !copy._isSet(23)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("MailSessions")) && this.bean.isMailSessionsSet() && !copy._isSet(24)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("MessageDestinationRefs")) && this.bean.isMessageDestinationRefsSet() && !copy._isSet(15)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("PersistenceContextRefs")) && this.bean.isPersistenceContextRefsSet() && !copy._isSet(16)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("PersistenceUnitRefs")) && this.bean.isPersistenceUnitRefsSet() && !copy._isSet(17)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("PortNames")) && this.bean.isPortNamesSet()) {
               o = this.bean.getPortNames();
               copy.setPortNames(o == null ? null : (String[])((String[])((String[])((String[])o)).clone()));
            }

            LifecycleCallbackBean[] oldPreDestroys;
            LifecycleCallbackBean[] newPreDestroys;
            if ((excludeProps == null || !excludeProps.contains("PostConstructs")) && this.bean.isPostConstructsSet() && !copy._isSet(19)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("PreDestroys")) && this.bean.isPreDestroysSet() && !copy._isSet(20)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("ResourceEnvRefs")) && this.bean.isResourceEnvRefsSet() && !copy._isSet(14)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("ResourceRefs")) && this.bean.isResourceRefsSet() && !copy._isSet(13)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("ServiceRefs")) && this.bean.isServiceRefsSet() && !copy._isSet(12)) {
