...
public class ResponseTimeRequestClassBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ResponseTimeRequestClassBean beanTreeNode;

   public ResponseTimeRequestClassBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
