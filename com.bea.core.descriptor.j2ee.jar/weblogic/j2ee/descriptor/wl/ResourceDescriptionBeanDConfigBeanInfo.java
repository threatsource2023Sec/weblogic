...
public class ResourceDescriptionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ResourceDescriptionBean beanTreeNode;

   public ResourceDescriptionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (ResourceDescriptionBean)btn;
      this.beanTree = btn;
   ...
   public void initKeyPropertyValue(String value) {
      this.setResRefName(value);
   }

   public String getDCBProperties() {
      StringBuffer sb = new StringBuffer();
      sb.append("ResRefName: ");
      sb.append(this.beanTreeNode.getResRefName());
      sb.append("\n");
      sb.append("JNDIName: ");
   ...
   public void setResRefName(String value) {
      this.beanTreeNode.setResRefName(value);
   ...
   public DefaultResourcePrincipalBean getDefaultResourcePrincipal() {
      return this.beanTreeNode.getDefaultResourcePrincipal();
   }
