...
public class PropertyNamevalueBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private PropertyNamevalueBean beanTreeNode;

   public PropertyNamevalueBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (PropertyNamevalueBean)btn;
      this.beanTree = btn;
