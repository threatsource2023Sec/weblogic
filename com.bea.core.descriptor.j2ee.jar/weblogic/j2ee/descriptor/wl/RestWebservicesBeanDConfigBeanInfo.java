...
public class RestWebservicesBeanDConfigBeanInfo extends BasicDConfigBeanRoot {
   private static final boolean debug = Debug.isDebug("config");
   private RestWebservicesBean beanTreeNode;

   public RestWebservicesBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
   ...
   public RestWebservicesBeanDConfigBeanInfo(DDBeanRoot root, WebLogicDeploymentConfiguration dc, DescriptorBean beanTree, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
   ...
   public RestWebservicesBeanDConfigBeanInfo(DDBeanRoot root, WebLogicDeploymentConfiguration dc, String name, DescriptorSupport ds) throws InvalidModuleException, IOException {
      super(root, dc, name, ds);
