...
public class WorkManagerShutdownTriggerBeanImpl extends AbstractDescriptorBean implements WorkManagerShutdownTriggerBean, Serializable {
   private String _Id;
   private int _MaxStuckThreadTime;
   private int _StuckThreadCount;
   private static SchemaHelper2 _schemaHelper;

   public WorkManagerShutdownTriggerBeanImpl() {
      this._initializeProperty(-1);
   }

   public WorkManagerShutdownTriggerBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public WorkManagerShutdownTriggerBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private WorkManagerShutdownTriggerBeanImpl bean;

      protected Helper(WorkManagerShutdownTriggerBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            WorkManagerShutdownTriggerBeanImpl otherTyped = (WorkManagerShutdownTriggerBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            WorkManagerShutdownTriggerBeanImpl original = (WorkManagerShutdownTriggerBeanImpl)event.getSourceBean();
            WorkManagerShutdownTriggerBeanImpl proposed = (WorkManagerShutdownTriggerBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            WorkManagerShutdownTriggerBeanImpl copy = (WorkManagerShutdownTriggerBeanImpl)initialCopy;
