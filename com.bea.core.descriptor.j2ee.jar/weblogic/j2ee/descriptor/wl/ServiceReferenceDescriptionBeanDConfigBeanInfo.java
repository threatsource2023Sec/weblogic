...
public class ServiceReferenceDescriptionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ServiceReferenceDescriptionBean beanTreeNode;

   public ServiceReferenceDescriptionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
