...
public class RestWebserviceDescriptionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private RestWebserviceDescriptionBean beanTreeNode;

   public RestWebserviceDescriptionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
