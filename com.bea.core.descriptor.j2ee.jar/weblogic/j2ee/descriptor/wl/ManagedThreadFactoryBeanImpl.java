...
public class ManagedThreadFactoryBeanImpl extends SettableBeanImpl implements ManagedThreadFactoryBean, Serializable {
   private String _Id;
   ...
   public ManagedThreadFactoryBeanImpl() {
      this._initializeProperty(-1);
   }

   public ManagedThreadFactoryBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ManagedThreadFactoryBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends SettableBeanImpl.Helper {
      private ManagedThreadFactoryBeanImpl bean;

      protected Helper(ManagedThreadFactoryBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Id")) {
            ...
            return propName.equals("Priority") ? 2 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ManagedThreadFactoryBeanImpl otherTyped = (ManagedThreadFactoryBeanImpl)other;
            this.computeDiff("Id", this.bean.getId(), otherTyped.getId(), false);
            this.computeDiff("MaxConcurrentNewThreads", this.bean.getMaxConcurrentNewThreads(), otherTyped.getMaxConcurrentNewThreads(), false);
            this.computeDiff("Name", this.bean.getName(), otherTyped.getName(), false);
            this.computeDiff("Priority", this.bean.getPriority(), otherTyped.getPriority(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ManagedThreadFactoryBeanImpl original = (ManagedThreadFactoryBeanImpl)event.getSourceBean();
            ManagedThreadFactoryBeanImpl proposed = (ManagedThreadFactoryBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ManagedThreadFactoryBeanImpl copy = (ManagedThreadFactoryBeanImpl)initialCopy;
