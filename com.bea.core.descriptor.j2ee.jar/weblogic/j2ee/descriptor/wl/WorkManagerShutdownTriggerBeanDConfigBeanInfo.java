...
public class WorkManagerShutdownTriggerBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private WorkManagerShutdownTriggerBean beanTreeNode;

   public WorkManagerShutdownTriggerBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (WorkManagerShutdownTriggerBean)btn;
      this.beanTree = btn;
