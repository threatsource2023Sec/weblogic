...
public class RunAsRoleAssignmentBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private RunAsRoleAssignmentBean beanTreeNode;

   public RunAsRoleAssignmentBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
