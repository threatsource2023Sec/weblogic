...
public class SecurityRoleAssignmentBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private SecurityRoleAssignmentBean beanTreeNode;

   public SecurityRoleAssignmentBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (SecurityRoleAssignmentBean)btn;
      this.beanTree = btn;
