...
public class EjbReferenceDescriptionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private EjbReferenceDescriptionBean beanTreeNode;

   public EjbReferenceDescriptionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
