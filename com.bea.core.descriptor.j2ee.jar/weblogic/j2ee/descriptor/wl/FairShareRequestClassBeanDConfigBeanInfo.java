...
public class FairShareRequestClassBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private FairShareRequestClassBean beanTreeNode;

   public FairShareRequestClassBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
      this.beanTreeNode = (FairShareRequestClassBean)btn;
      this.beanTree = btn;
   ...
   public void setFairShare(int value) {
      this.beanTreeNode.setFairShare(value);
