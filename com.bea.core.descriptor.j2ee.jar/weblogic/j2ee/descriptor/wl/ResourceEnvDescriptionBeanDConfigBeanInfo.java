...
public class ResourceEnvDescriptionBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ResourceEnvDescriptionBean beanTreeNode;

   public ResourceEnvDescriptionBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
