...
public interface ManagedBeanBean extends J2eeEnvironmentBean, InterceptorMethodsBean {
   String getManagedBeanName();

   void setManagedBeanName(String var1);

   String getManagedBeanClass();

   void setManagedBeanClass(String var1);
