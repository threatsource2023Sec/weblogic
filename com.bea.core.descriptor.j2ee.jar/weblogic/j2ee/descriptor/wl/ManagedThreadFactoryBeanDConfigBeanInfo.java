...
public class ManagedThreadFactoryBeanDConfigBeanInfo extends BasicDConfigBean {
   private static final boolean debug = Debug.isDebug("config");
   private ManagedThreadFactoryBean beanTreeNode;

   public ManagedThreadFactoryBeanDConfigBeanInfo(DDBean ddb, DescriptorBean btn, DConfigBean parent) throws ConfigurationException {
      super(ddb);
