...
public class OperationInfoBeanImpl extends AbstractDescriptorBean implements OperationInfoBean, Serializable {
   private String _Name;
   private WSATConfigBean _WSATConfig;
   private static SchemaHelper2 _schemaHelper;

   public OperationInfoBeanImpl() {
      this._initializeProperty(-1);
   }

   public OperationInfoBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public OperationInfoBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private OperationInfoBeanImpl bean;

      protected Helper(OperationInfoBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            OperationInfoBeanImpl otherTyped = (OperationInfoBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            OperationInfoBeanImpl original = (OperationInfoBeanImpl)event.getSourceBean();
            OperationInfoBeanImpl proposed = (OperationInfoBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            OperationInfoBeanImpl copy = (OperationInfoBeanImpl)initialCopy;
