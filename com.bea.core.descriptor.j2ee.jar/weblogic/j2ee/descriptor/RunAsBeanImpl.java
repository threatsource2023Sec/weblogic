...
public class RunAsBeanImpl extends AbstractDescriptorBean implements RunAsBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private String _RoleName;
   private static SchemaHelper2 _schemaHelper;

   public RunAsBeanImpl() {
      this._initializeProperty(-1);
   }

   public RunAsBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public RunAsBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private RunAsBeanImpl bean;

      protected Helper(RunAsBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            RunAsBeanImpl otherTyped = (RunAsBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            RunAsBeanImpl original = (RunAsBeanImpl)event.getSourceBean();
            RunAsBeanImpl proposed = (RunAsBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            RunAsBeanImpl copy = (RunAsBeanImpl)initialCopy;
