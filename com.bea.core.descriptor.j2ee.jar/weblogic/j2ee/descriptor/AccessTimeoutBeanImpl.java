...
public class AccessTimeoutBeanImpl extends AbstractDescriptorBean implements AccessTimeoutBean, Serializable {
   private String _Id;
   private long _Timeout;
   private String _Unit;
   private static SchemaHelper2 _schemaHelper;

   public AccessTimeoutBeanImpl() {
      this._initializeProperty(-1);
   }

   public AccessTimeoutBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public AccessTimeoutBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AccessTimeoutBeanImpl bean;

      protected Helper(AccessTimeoutBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AccessTimeoutBeanImpl otherTyped = (AccessTimeoutBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AccessTimeoutBeanImpl original = (AccessTimeoutBeanImpl)event.getSourceBean();
            AccessTimeoutBeanImpl proposed = (AccessTimeoutBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AccessTimeoutBeanImpl copy = (AccessTimeoutBeanImpl)initialCopy;
