...
public class JmsDestinationBeanImpl extends AbstractDescriptorBean implements JmsDestinationBean, Serializable {
   ...
   public JmsDestinationBeanImpl() {
      this._initializeProperty(-1);
   }

   public JmsDestinationBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public JmsDestinationBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public void setInterfaceName(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String[] _set = new String[]{"javax.jms.Queue", "javax.jms.Topic"};
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private JmsDestinationBeanImpl bean;

      protected Helper(JmsDestinationBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            JmsDestinationBeanImpl otherTyped = (JmsDestinationBeanImpl)other;
            ...
            this.computeDiff("DestinationName", this.bean.getDestinationName(), otherTyped.getDestinationName(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            JmsDestinationBeanImpl original = (JmsDestinationBeanImpl)event.getSourceBean();
            JmsDestinationBeanImpl proposed = (JmsDestinationBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            JmsDestinationBeanImpl copy = (JmsDestinationBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("Properties")) && this.bean.isPropertiesSet() && !copy._isSet(6)) {
