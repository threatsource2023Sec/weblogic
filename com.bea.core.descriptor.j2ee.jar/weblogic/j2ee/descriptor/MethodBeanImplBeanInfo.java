...
public class MethodBeanImplBeanInfo extends BeanInfoImpl {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.j2ee.descriptor.MethodBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.j2ee.descriptor.MethodBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Descriptions")) {
         ...
         currentResult = new PropertyDescriptor("Descriptions", MethodBean.class, getterName, setterName);
      ...
      if (!descriptors.containsKey("MethodIntf")) {
         ...
         currentResult.setValue("description", " ");
         currentResult.setValue("legalValues", new Object[]{"Home", "Remote", "Local", "LocalHome", "ServiceEndpoint", "Timer", "MessageEndpoint", "LifecycleCallback"});
         currentResult.setValue("exclude", Boolean.TRUE);
         currentResult.setValue("owner", "");
      }
   ...
   private void fillinCollectionMethodInfos(Map descriptors) throws IntrospectionException, NoSuchMethodException {
      Method mth = MethodBean.class.getMethod("addDescription", String.class);
      String methodKey = BeanInfoHelper.buildMethodKey(mth);
      MethodDescriptor currentResult;
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
      ...
      mth = MethodBean.class.getMethod("removeDescription", String.class);
      methodKey = BeanInfoHelper.buildMethodKey(mth);
      if (!descriptors.containsKey(methodKey)) {
         currentResult = new MethodDescriptor(mth, (ParameterDescriptor[])null);
         descriptors.put(methodKey, currentResult);
