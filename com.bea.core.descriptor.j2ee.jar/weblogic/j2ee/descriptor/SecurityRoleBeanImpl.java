...
public class SecurityRoleBeanImpl extends AbstractDescriptorBean implements SecurityRoleBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private String _RoleName;
   private static SchemaHelper2 _schemaHelper;

   public SecurityRoleBeanImpl() {
      this._initializeProperty(-1);
   }

   public SecurityRoleBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SecurityRoleBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private SecurityRoleBeanImpl bean;

      protected Helper(SecurityRoleBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SecurityRoleBeanImpl otherTyped = (SecurityRoleBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SecurityRoleBeanImpl original = (SecurityRoleBeanImpl)event.getSourceBean();
            SecurityRoleBeanImpl proposed = (SecurityRoleBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SecurityRoleBeanImpl copy = (SecurityRoleBeanImpl)initialCopy;
