...
public class AdminObjectBeanImpl extends AbstractDescriptorBean implements AdminObjectBean, Serializable {
   ...
   public AdminObjectBeanImpl() {
      this._initializeProperty(-1);
   }

   public AdminObjectBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public AdminObjectBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
      ...
      public int getPropertyIndex(String s) {
         switch (s.length()) {
            ...
            case 15:
               ...
               break;
            case 17:
               if (s.equals("adminobject-class")) {
                  return 1;
               }
               break;
            case 21:
               if (s.equals("adminobject-interface")) {
                  return 0;
               }
         }
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AdminObjectBeanImpl bean;

      protected Helper(AdminObjectBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AdminObjectBeanImpl otherTyped = (AdminObjectBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AdminObjectBeanImpl original = (AdminObjectBeanImpl)event.getSourceBean();
            AdminObjectBeanImpl proposed = (AdminObjectBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AdminObjectBeanImpl copy = (AdminObjectBeanImpl)initialCopy;
