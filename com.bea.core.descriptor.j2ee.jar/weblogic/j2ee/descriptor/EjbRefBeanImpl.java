...
public class EjbRefBeanImpl extends AbstractDescriptorBean implements EjbRefBean, Serializable {
   ...
   public EjbRefBeanImpl() {
      this._initializeProperty(-1);
   }

   public EjbRefBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public EjbRefBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private EjbRefBeanImpl bean;

      protected Helper(EjbRefBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("Remote") ? 4 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            EjbRefBeanImpl otherTyped = (EjbRefBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            EjbRefBeanImpl original = (EjbRefBeanImpl)event.getSourceBean();
            EjbRefBeanImpl proposed = (EjbRefBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            EjbRefBeanImpl copy = (EjbRefBeanImpl)initialCopy;
