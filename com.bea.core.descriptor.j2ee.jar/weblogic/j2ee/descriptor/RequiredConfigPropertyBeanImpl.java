...
public class RequiredConfigPropertyBeanImpl extends AbstractDescriptorBean implements RequiredConfigPropertyBean, Serializable {
   private String _ConfigPropertyName;
   private String[] _Descriptions;
   private String _Id;
   private static SchemaHelper2 _schemaHelper;

   public RequiredConfigPropertyBeanImpl() {
      this._initializeProperty(-1);
   }

   public RequiredConfigPropertyBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public RequiredConfigPropertyBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private RequiredConfigPropertyBeanImpl bean;

      protected Helper(RequiredConfigPropertyBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            RequiredConfigPropertyBeanImpl otherTyped = (RequiredConfigPropertyBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            RequiredConfigPropertyBeanImpl original = (RequiredConfigPropertyBeanImpl)event.getSourceBean();
            RequiredConfigPropertyBeanImpl proposed = (RequiredConfigPropertyBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            RequiredConfigPropertyBeanImpl copy = (RequiredConfigPropertyBeanImpl)initialCopy;
