...
public class SecurityRoleRefBeanImpl extends AbstractDescriptorBean implements SecurityRoleRefBean, Serializable {
   ...
   public SecurityRoleRefBeanImpl() {
      this._initializeProperty(-1);
   }

   public SecurityRoleRefBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SecurityRoleRefBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public boolean isRoleLinkInherited() {
      return false;
   }

   public boolean isRoleLinkSet() {
      return this._isSet(2);
   }

   public void setRoleLink(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String _oldVal = this._RoleLink;
      this._RoleLink = param0;
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private SecurityRoleRefBeanImpl bean;

      protected Helper(SecurityRoleRefBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return 3;
         } else if (propName.equals("RoleLink")) {
            return 2;
         } else {
            return propName.equals("RoleName") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isRoleLinkSet()) {
               buf.append("RoleLink");
               buf.append(String.valueOf(this.bean.getRoleLink()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SecurityRoleRefBeanImpl otherTyped = (SecurityRoleRefBeanImpl)other;
            this.computeDiff("Descriptions", this.bean.getDescriptions(), otherTyped.getDescriptions(), false);
            this.computeDiff("Id", this.bean.getId(), otherTyped.getId(), false);
            this.computeDiff("RoleLink", this.bean.getRoleLink(), otherTyped.getRoleLink(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SecurityRoleRefBeanImpl original = (SecurityRoleRefBeanImpl)event.getSourceBean();
            SecurityRoleRefBeanImpl proposed = (SecurityRoleRefBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("RoleLink")) {
                  original.setRoleLink(proposed.getRoleLink());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SecurityRoleRefBeanImpl copy = (SecurityRoleRefBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("RoleLink")) && this.bean.isRoleLinkSet()) {
               copy.setRoleLink(this.bean.getRoleLink());
            }
