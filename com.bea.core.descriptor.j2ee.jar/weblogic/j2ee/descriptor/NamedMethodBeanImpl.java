...
public class NamedMethodBeanImpl extends AbstractDescriptorBean implements NamedMethodBean, Serializable {
   private String _Id;
   private String _MethodName;
   private MethodParamsBean _MethodParams;
   private static SchemaHelper2 _schemaHelper;

   public NamedMethodBeanImpl() {
      this._initializeProperty(-1);
   }

   public NamedMethodBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public NamedMethodBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private NamedMethodBeanImpl bean;

      protected Helper(NamedMethodBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            NamedMethodBeanImpl otherTyped = (NamedMethodBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            NamedMethodBeanImpl original = (NamedMethodBeanImpl)event.getSourceBean();
            NamedMethodBeanImpl proposed = (NamedMethodBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            NamedMethodBeanImpl copy = (NamedMethodBeanImpl)initialCopy;
