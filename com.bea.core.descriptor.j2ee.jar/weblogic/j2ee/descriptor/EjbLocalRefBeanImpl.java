...
public class EjbLocalRefBeanImpl extends AbstractDescriptorBean implements EjbLocalRefBean, Serializable {
   ...
   public EjbLocalRefBeanImpl() {
      this._initializeProperty(-1);
   }

   public EjbLocalRefBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public EjbLocalRefBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public String getEjbRefType() {
      return !this._isSet(2) ? null : this._EjbRefType;
   }

   public boolean isEjbRefTypeInherited() {
      return false;
   }

   public boolean isEjbRefTypeSet() {
      return this._isSet(2);
   }

   public void setEjbRefType(String param0) {
      if (param0 == null) {
         this._unSet(2);
      } else {
         param0 = param0 == null ? null : param0.trim();
         String[] _set = new String[]{"Entity", "Session"};
         param0 = LegalChecks.checkInEnum("EjbRefType", param0, _set);
         String _oldVal = this._EjbRefType;
         this._EjbRefType = param0;
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private EjbLocalRefBeanImpl bean;

      protected Helper(EjbLocalRefBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            return 0;
         } else if (propName.equals("EjbLink")) {
            return 5;
         } else if (propName.equals("EjbRefName")) {
            return 1;
         } else if (propName.equals("EjbRefType")) {
            return 2;
            ...
            return propName.equals("MappedName") ? 6 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isEjbRefTypeSet()) {
               buf.append("EjbRefType");
               buf.append(String.valueOf(this.bean.getEjbRefType()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            EjbLocalRefBeanImpl otherTyped = (EjbLocalRefBeanImpl)other;
            ...
            this.computeDiff("EjbRefType", this.bean.getEjbRefType(), otherTyped.getEjbRefType(), false);
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            EjbLocalRefBeanImpl original = (EjbLocalRefBeanImpl)event.getSourceBean();
            EjbLocalRefBeanImpl proposed = (EjbLocalRefBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("EjbLink")) {
                  original.setEjbLink(proposed.getEjbLink());
                  original._conditionalUnset(update.isUnsetUpdate(), 5);
               } else if (prop.equals("EjbRefName")) {
                  original.setEjbRefName(proposed.getEjbRefName());
                  original._conditionalUnset(update.isUnsetUpdate(), 1);
               } else if (prop.equals("EjbRefType")) {
                  original.setEjbRefType(proposed.getEjbRefType());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            EjbLocalRefBeanImpl copy = (EjbLocalRefBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("EjbRefType")) && this.bean.isEjbRefTypeSet()) {
               copy.setEjbRefType(this.bean.getEjbRefType());
            }
