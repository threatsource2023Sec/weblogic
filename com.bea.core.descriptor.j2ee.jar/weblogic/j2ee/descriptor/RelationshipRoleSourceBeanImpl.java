...
public class RelationshipRoleSourceBeanImpl extends AbstractDescriptorBean implements RelationshipRoleSourceBean, Serializable {
   private String[] _Descriptions;
   private String _EjbName;
   private String _Id;
   private static SchemaHelper2 _schemaHelper;

   public RelationshipRoleSourceBeanImpl() {
      this._initializeProperty(-1);
   }

   public RelationshipRoleSourceBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public RelationshipRoleSourceBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private RelationshipRoleSourceBeanImpl bean;

      protected Helper(RelationshipRoleSourceBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            RelationshipRoleSourceBeanImpl otherTyped = (RelationshipRoleSourceBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            RelationshipRoleSourceBeanImpl original = (RelationshipRoleSourceBeanImpl)event.getSourceBean();
            RelationshipRoleSourceBeanImpl proposed = (RelationshipRoleSourceBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            RelationshipRoleSourceBeanImpl copy = (RelationshipRoleSourceBeanImpl)initialCopy;
