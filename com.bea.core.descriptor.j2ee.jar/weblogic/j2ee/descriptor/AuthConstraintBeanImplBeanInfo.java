...
public class AuthConstraintBeanImplBeanInfo extends BeanInfoImpl {
   ...
   protected BeanDescriptor buildBeanDescriptor() {
      ...
      try {
         beanClass = Class.forName("weblogic.j2ee.descriptor.AuthConstraintBeanImpl");
      ...
      beanDescriptor.setValue("interfaceclassname", "weblogic.j2ee.descriptor.AuthConstraintBean");
   ...
   protected void buildPropertyDescriptors(Map descriptors) throws IntrospectionException {
      ...
      if (!descriptors.containsKey("Id")) {
         ...
         currentResult = new PropertyDescriptor("Id", AuthConstraintBean.class, getterName, setterName);
