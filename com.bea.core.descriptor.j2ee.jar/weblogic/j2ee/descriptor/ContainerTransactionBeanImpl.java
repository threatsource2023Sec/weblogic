...
public class ContainerTransactionBeanImpl extends AbstractDescriptorBean implements ContainerTransactionBean, Serializable {
   ...
   public ContainerTransactionBeanImpl() {
      this._initializeProperty(-1);
   }

   public ContainerTransactionBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public ContainerTransactionBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public boolean isTransAttributeInherited() {
      return false;
   }

   public boolean isTransAttributeSet() {
      return this._isSet(2);
   }

   public void setTransAttribute(String param0) {
      param0 = param0 == null ? null : param0.trim();
      String[] _set = new String[]{"NotSupported", "Supports", "Required", "RequiresNew", "Mandatory", "Never"};
      param0 = LegalChecks.checkInEnum("TransAttribute", param0, _set);
      String _oldVal = this._TransAttribute;
      this._TransAttribute = param0;
   ...
   public void _validate() throws IllegalArgumentException {
      super._validate();
      LegalChecks.checkIsSet("TransAttribute", this.isTransAttributeSet());
   }
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private ContainerTransactionBeanImpl bean;

      protected Helper(ContainerTransactionBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("TransAttribute") ? 2 : super.getPropertyIndex(propName);
         }
      }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            if (this.bean.isTransAttributeSet()) {
               buf.append("TransAttribute");
               buf.append(String.valueOf(this.bean.getTransAttribute()));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            ContainerTransactionBeanImpl otherTyped = (ContainerTransactionBeanImpl)other;
            ...
            this.computeDiff("TransAttribute", this.bean.getTransAttribute(), otherTyped.getTransAttribute(), false);
         } catch (Exception var3) {
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            ContainerTransactionBeanImpl original = (ContainerTransactionBeanImpl)event.getSourceBean();
            ContainerTransactionBeanImpl proposed = (ContainerTransactionBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("TransAttribute")) {
                  original.setTransAttribute(proposed.getTransAttribute());
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            ContainerTransactionBeanImpl copy = (ContainerTransactionBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("TransAttribute")) && this.bean.isTransAttributeSet()) {
               copy.setTransAttribute(this.bean.getTransAttribute());
            }
