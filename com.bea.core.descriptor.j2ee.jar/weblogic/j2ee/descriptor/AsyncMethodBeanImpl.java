...
public class AsyncMethodBeanImpl extends AbstractDescriptorBean implements AsyncMethodBean, Serializable {
   private String _Id;
   private String _MethodName;
   private MethodParamsBean _MethodParams;
   private static SchemaHelper2 _schemaHelper;

   public AsyncMethodBeanImpl() {
      this._initializeProperty(-1);
   }

   public AsyncMethodBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public AsyncMethodBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AsyncMethodBeanImpl bean;

      protected Helper(AsyncMethodBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AsyncMethodBeanImpl otherTyped = (AsyncMethodBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AsyncMethodBeanImpl original = (AsyncMethodBeanImpl)event.getSourceBean();
            AsyncMethodBeanImpl proposed = (AsyncMethodBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AsyncMethodBeanImpl copy = (AsyncMethodBeanImpl)initialCopy;
