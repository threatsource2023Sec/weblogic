...
public class AroundTimeoutBeanImpl extends AbstractDescriptorBean implements AroundTimeoutBean, Serializable {
   private String _ClassName;
   private String _MethodName;
   private static SchemaHelper2 _schemaHelper;

   public AroundTimeoutBeanImpl() {
      this._initializeProperty(-1);
   }

   public AroundTimeoutBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public AroundTimeoutBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private AroundTimeoutBeanImpl bean;

      protected Helper(AroundTimeoutBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            AroundTimeoutBeanImpl otherTyped = (AroundTimeoutBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            AroundTimeoutBeanImpl original = (AroundTimeoutBeanImpl)event.getSourceBean();
            AroundTimeoutBeanImpl proposed = (AroundTimeoutBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            AroundTimeoutBeanImpl copy = (AroundTimeoutBeanImpl)initialCopy;
