...
public class SecurityIdentityBeanImpl extends AbstractDescriptorBean implements SecurityIdentityBean, Serializable {
   private String[] _Descriptions;
   private String _Id;
   private RunAsBean _RunAs;
   private EmptyBean _UseCallerIdentity;
   private static SchemaHelper2 _schemaHelper;

   public SecurityIdentityBeanImpl() {
      this._initializeProperty(-1);
   }

   public SecurityIdentityBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public SecurityIdentityBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   public EmptyBean getUseCallerIdentity() {
   ...
   public void setUseCallerIdentity(EmptyBean param0) throws InvalidAttributeValueException {
      if (param0 != null && this.getUseCallerIdentity() != null && param0 != this.getUseCallerIdentity()) {
         throw new BeanAlreadyExistsException(this.getUseCallerIdentity() + " has already been created");
      } else {
         if (param0 != null) {
         ...
         EmptyBean _oldVal = this._UseCallerIdentity;
         this._UseCallerIdentity = param0;
         this._postSet(1, _oldVal, param0);
      }
   }

   public EmptyBean createUseCallerIdentity() {
      EmptyBeanImpl _val = new EmptyBeanImpl(this, -1);

      try {
         this.setUseCallerIdentity(_val);
         return _val;
   ...
   public void destroyUseCallerIdentity(EmptyBean param0) {
      try {
         AbstractDescriptorBean _child = (AbstractDescriptorBean)this._UseCallerIdentity;
         if (_child != null) {
            ...
            if (_refs != null && _refs.size() > 0) {
               ...
               this.setUseCallerIdentity((EmptyBean)null);
               this._unSet(1);
            }
         }
      } catch (Exception var4) {
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      private SecurityIdentityBeanImpl bean;

      protected Helper(SecurityIdentityBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      public int getPropertyIndex(String propName) {
         if (propName.equals("Descriptions")) {
            ...
            return propName.equals("UseCallerIdentity") ? 1 : super.getPropertyIndex(propName);
         }
      }
      ...
      public Iterator getChildren() {
         ...
         if (this.bean.getUseCallerIdentity() != null) {
            iterators.add(new ArrayIterator(new EmptyBean[]{this.bean.getUseCallerIdentity()}));
         }
      ...
      protected long computeHashValue(CRC32 crc) {
         try {
            ...
            childValue = this.computeChildHashValue(this.bean.getUseCallerIdentity());
            if (childValue != 0L) {
               buf.append(String.valueOf(childValue));
            }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            SecurityIdentityBeanImpl otherTyped = (SecurityIdentityBeanImpl)other;
            ...
            this.computeChildDiff("UseCallerIdentity", this.bean.getUseCallerIdentity(), otherTyped.getUseCallerIdentity(), false);
         } catch (Exception var3) {
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            SecurityIdentityBeanImpl original = (SecurityIdentityBeanImpl)event.getSourceBean();
            SecurityIdentityBeanImpl proposed = (SecurityIdentityBeanImpl)event.getProposedBean();
            ...
            if (!update.isDerivedUpdate()) {
               ...
               } else if (prop.equals("UseCallerIdentity")) {
                  if (type == 2) {
                     original.setUseCallerIdentity((EmptyBean)this.createCopy((AbstractDescriptorBean)proposed.getUseCallerIdentity()));
                  } else {
                     if (type != 3) {
                        throw new AssertionError("Invalid type: " + type);
                     }

                     original._destroySingleton("UseCallerIdentity", (DescriptorBean)original.getUseCallerIdentity());
                  }
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            SecurityIdentityBeanImpl copy = (SecurityIdentityBeanImpl)initialCopy;
            ...
            if ((excludeProps == null || !excludeProps.contains("RunAs")) && this.bean.isRunAsSet() && !copy._isSet(2)) {
            ...
            if ((excludeProps == null || !excludeProps.contains("UseCallerIdentity")) && this.bean.isUseCallerIdentitySet() && !copy._isSet(1)) {
               Object o = this.bean.getUseCallerIdentity();
               copy.setUseCallerIdentity((EmptyBean)null);
               copy.setUseCallerIdentity(o == null ? null : (EmptyBean)this.createCopy((AbstractDescriptorBean)o, includeObsolete));
            }
      ...
      protected void inferSubTree(Class clazz, Object annotation) {
         ...
         this.inferSubTree(this.bean.getUseCallerIdentity(), clazz, annotation);
      }
   }
}
