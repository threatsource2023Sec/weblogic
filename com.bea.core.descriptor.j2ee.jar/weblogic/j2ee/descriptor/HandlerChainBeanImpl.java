...
public class HandlerChainBeanImpl extends AbstractDescriptorBean implements HandlerChainBean, Serializable {
   ...
   public HandlerChainBeanImpl(DescriptorBean param0, int param1) {
      super(param0, param1);
      this._initializeProperty(-1);
   }

   public HandlerChainBeanImpl(DescriptorBean param0, int param1, boolean param2) {
      super(param0, param1);
   ...
   protected static class Helper extends AbstractDescriptorBeanHelper {
      ...
      protected Helper(HandlerChainBeanImpl bean) {
         super(bean);
         this.bean = bean;
      }
      ...
      protected void computeDiff(AbstractDescriptorBean other) {
         try {
            ...
            HandlerChainBeanImpl otherTyped = (HandlerChainBeanImpl)other;
      ...
      protected void applyPropertyUpdate(BeanUpdateEvent event, BeanUpdateEvent.PropertyUpdate update) {
         try {
            HandlerChainBeanImpl original = (HandlerChainBeanImpl)event.getSourceBean();
            HandlerChainBeanImpl proposed = (HandlerChainBeanImpl)event.getProposedBean();
      ...
      protected AbstractDescriptorBean finishCopy(AbstractDescriptorBean initialCopy, boolean includeObsolete, List excludeProps) {
         try {
            HandlerChainBeanImpl copy = (HandlerChainBeanImpl)initialCopy;
