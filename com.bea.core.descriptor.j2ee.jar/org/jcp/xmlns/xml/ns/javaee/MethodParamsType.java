...
public interface MethodParamsType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(MethodParamsType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("methodparamstypefecbtype");
   ...
   public static final class Factory {
      ...
      public static MethodParamsType parse(java.lang.String xmlAsString) throws XmlException {
         return (MethodParamsType)XmlBeans.getContextTypeLoader().parse(xmlAsString, MethodParamsType.type, (XmlOptions)null);
      }

      public static MethodParamsType parse(java.lang.String xmlAsString, XmlOptions options) throws XmlException {
