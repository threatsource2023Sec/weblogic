...
public interface InterceptorType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(InterceptorType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("interceptortype9f78type");
   ...
   LifecycleCallbackType[] getAroundConstructArray();

   LifecycleCallbackType getAroundConstructArray(int var1);

   int sizeOfAroundConstructArray();

   void setAroundConstructArray(LifecycleCallbackType[] var1);

   void setAroundConstructArray(int var1, LifecycleCallbackType var2);

   LifecycleCallbackType insertNewAroundConstruct(int var1);

   LifecycleCallbackType addNewAroundConstruct();

   void removeAroundConstruct(int var1);
