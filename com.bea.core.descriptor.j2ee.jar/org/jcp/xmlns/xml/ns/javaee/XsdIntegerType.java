...
public interface XsdIntegerType extends XmlInteger {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(XsdIntegerType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("xsdintegertype09f6type");
