...
public interface MessageDrivenBeanType extends XmlObject {
   SchemaType type = (SchemaType)XmlBeans.typeSystemForClassLoader(MessageDrivenBeanType.class.getClassLoader(), "schemacom_bea_xml.system.com_bea_core_descriptor_j2ee_3_0_0_0").resolveHandle("messagedrivenbeantype6deatype");
   ...
   void setMessagingType(FullyQualifiedClassType var1);

   FullyQualifiedClassType addNewMessagingType();
   ...
   void setActivationConfig(ActivationConfigType var1);
   ...
   public static final class Factory {
      public static MessageDrivenBeanType newInstance() {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().newInstance(MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType newInstance(XmlOptions options) {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().newInstance(MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(java.lang.String xmlAsString) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(xmlAsString, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(java.lang.String xmlAsString, XmlOptions options) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(xmlAsString, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(File file) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(file, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(File file, XmlOptions options) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(file, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(URL u) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(u, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(URL u, XmlOptions options) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(u, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(InputStream is) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(is, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(InputStream is, XmlOptions options) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(is, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(Reader r) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(r, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(Reader r, XmlOptions options) throws XmlException, IOException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(r, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(XMLStreamReader sr) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(sr, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(XMLStreamReader sr, XmlOptions options) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(sr, MessageDrivenBeanType.type, options);
      }

      public static MessageDrivenBeanType parse(Node node) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(node, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      public static MessageDrivenBeanType parse(Node node, XmlOptions options) throws XmlException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(node, MessageDrivenBeanType.type, options);
      }

      /** @deprecated */
      public static MessageDrivenBeanType parse(XMLInputStream xis) throws XmlException, XMLStreamException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(xis, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      /** @deprecated */
      public static MessageDrivenBeanType parse(XMLInputStream xis, XmlOptions options) throws XmlException, XMLStreamException {
         return (MessageDrivenBeanType)XmlBeans.getContextTypeLoader().parse(xis, MessageDrivenBeanType.type, options);
      }

      /** @deprecated */
      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xis) throws XmlException, XMLStreamException {
         return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xis, MessageDrivenBeanType.type, (XmlOptions)null);
      }

      /** @deprecated */
      public static XMLInputStream newValidatingXMLInputStream(XMLInputStream xis, XmlOptions options) throws XmlException, XMLStreamException {
         return XmlBeans.getContextTypeLoader().newValidatingXMLInputStream(xis, MessageDrivenBeanType.type, options);
      }
