...
public class ErrorCodeTypeImpl extends JavaIntegerHolderEx implements ErrorCodeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ErrorCodeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ErrorCodeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
