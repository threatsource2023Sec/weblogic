...
public class SessionTypeTypeImpl extends JavaStringEnumerationHolderEx implements SessionTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public SessionTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected SessionTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
