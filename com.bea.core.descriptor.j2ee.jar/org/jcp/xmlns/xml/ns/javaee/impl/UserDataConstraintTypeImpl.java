...
import org.jcp.xmlns.xml.ns.javaee.TransportGuaranteeType;
import org.jcp.xmlns.xml.ns.javaee.UserDataConstraintType;

public class UserDataConstraintTypeImpl extends XmlComplexContentImpl implements UserDataConstraintType {
   private static final long serialVersionUID = 1L;
   private static final QName DESCRIPTION$0 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "description");
   private static final QName TRANSPORTGUARANTEE$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "transport-guarantee");
   private static final QName ID$4 = new QName("", "id");

   public UserDataConstraintTypeImpl(SchemaType sType) {
      super(sType);
   }
   ...
   public TransportGuaranteeType getTransportGuarantee() {
      synchronized(this.monitor()) {
         ...
         target = (TransportGuaranteeType)this.get_store().find_element_user(TRANSPORTGUARANTEE$2, 0);
         return target == null ? null : target;
      }
   }

   public void setTransportGuarantee(TransportGuaranteeType transportGuarantee) {
      this.generatedSetterHelperImpl(transportGuarantee, TRANSPORTGUARANTEE$2, 0, (short)1);
   }
   ...
   public TransportGuaranteeType addNewTransportGuarantee() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         TransportGuaranteeType target = null;
         target = (TransportGuaranteeType)this.get_store().add_element_user(TRANSPORTGUARANTEE$2);
         return target;
      }
   }
