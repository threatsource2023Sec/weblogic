...
public class WebAppTypeImpl extends XmlComplexContentImpl implements WebAppType {
   ...
   private static final QName DEFAULTCONTEXTPATH$76 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "default-context-path");
   private static final QName REQUESTCHARACTERENCODING$78 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "request-character-encoding");
   private static final QName RESPONSECHARACTERENCODING$80 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "response-character-encoding");
   private static final QName DENYUNCOVEREDHTTPMETHODS$82 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "deny-uncovered-http-methods");
   private static final QName ABSOLUTEORDERING$84 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "absolute-ordering");
   private static final QName VERSION$86 = new QName("", "version");
   private static final QName ID$88 = new QName("", "id");
   private static final QName METADATACOMPLETE$90 = new QName("", "metadata-complete");
   ...
   public String[] getDefaultContextPathArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(DEFAULTCONTEXTPATH$76, targetList);
         String[] result = new String[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public String getDefaultContextPathArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().find_element_user(DEFAULTCONTEXTPATH$76, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfDefaultContextPathArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(DEFAULTCONTEXTPATH$76);
      }
   }

   public void setDefaultContextPathArray(String[] defaultContextPathArray) {
      this.check_orphaned();
      this.arraySetterHelper(defaultContextPathArray, DEFAULTCONTEXTPATH$76);
   }

   public void setDefaultContextPathArray(int i, String defaultContextPath) {
      this.generatedSetterHelperImpl(defaultContextPath, DEFAULTCONTEXTPATH$76, i, (short)2);
   }

   public String insertNewDefaultContextPath(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().insert_element_user(DEFAULTCONTEXTPATH$76, i);
         return target;
      }
   }

   public String addNewDefaultContextPath() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().add_element_user(DEFAULTCONTEXTPATH$76);
         return target;
      }
   }

   public void removeDefaultContextPath(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(DEFAULTCONTEXTPATH$76, i);
      }
   }

   public String[] getRequestCharacterEncodingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(REQUESTCHARACTERENCODING$78, targetList);
         String[] result = new String[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public String getRequestCharacterEncodingArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().find_element_user(REQUESTCHARACTERENCODING$78, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfRequestCharacterEncodingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(REQUESTCHARACTERENCODING$78);
      }
   }

   public void setRequestCharacterEncodingArray(String[] requestCharacterEncodingArray) {
      this.check_orphaned();
      this.arraySetterHelper(requestCharacterEncodingArray, REQUESTCHARACTERENCODING$78);
   }

   public void setRequestCharacterEncodingArray(int i, String requestCharacterEncoding) {
      this.generatedSetterHelperImpl(requestCharacterEncoding, REQUESTCHARACTERENCODING$78, i, (short)2);
   }

   public String insertNewRequestCharacterEncoding(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().insert_element_user(REQUESTCHARACTERENCODING$78, i);
         return target;
      }
   }

   public String addNewRequestCharacterEncoding() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().add_element_user(REQUESTCHARACTERENCODING$78);
         return target;
      }
   }

   public void removeRequestCharacterEncoding(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(REQUESTCHARACTERENCODING$78, i);
      }
   }

   public String[] getResponseCharacterEncodingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(RESPONSECHARACTERENCODING$80, targetList);
         String[] result = new String[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public String getResponseCharacterEncodingArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().find_element_user(RESPONSECHARACTERENCODING$80, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfResponseCharacterEncodingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(RESPONSECHARACTERENCODING$80);
      }
   }

   public void setResponseCharacterEncodingArray(String[] responseCharacterEncodingArray) {
      this.check_orphaned();
      this.arraySetterHelper(responseCharacterEncodingArray, RESPONSECHARACTERENCODING$80);
   }

   public void setResponseCharacterEncodingArray(int i, String responseCharacterEncoding) {
      this.generatedSetterHelperImpl(responseCharacterEncoding, RESPONSECHARACTERENCODING$80, i, (short)2);
   }

   public String insertNewResponseCharacterEncoding(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().insert_element_user(RESPONSECHARACTERENCODING$80, i);
         return target;
      }
   }

   public String addNewResponseCharacterEncoding() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         String target = null;
         target = (String)this.get_store().add_element_user(RESPONSECHARACTERENCODING$80);
         return target;
      }
   }

   public void removeResponseCharacterEncoding(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(RESPONSECHARACTERENCODING$80, i);
      }
   }
   ...
   public EmptyType[] getDenyUncoveredHttpMethodsArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(DENYUNCOVEREDHTTPMETHODS$82, targetList);
         EmptyType[] result = new EmptyType[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public EmptyType getDenyUncoveredHttpMethodsArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         EmptyType target = null;
         target = (EmptyType)this.get_store().find_element_user(DENYUNCOVEREDHTTPMETHODS$82, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfDenyUncoveredHttpMethodsArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(DENYUNCOVEREDHTTPMETHODS$82);
      }
   }

   public void setDenyUncoveredHttpMethodsArray(EmptyType[] denyUncoveredHttpMethodsArray) {
      this.check_orphaned();
      this.arraySetterHelper(denyUncoveredHttpMethodsArray, DENYUNCOVEREDHTTPMETHODS$82);
   }

   public void setDenyUncoveredHttpMethodsArray(int i, EmptyType denyUncoveredHttpMethods) {
      this.generatedSetterHelperImpl(denyUncoveredHttpMethods, DENYUNCOVEREDHTTPMETHODS$82, i, (short)2);
   }
   ...
   public EmptyType insertNewDenyUncoveredHttpMethods(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         EmptyType target = null;
         target = (EmptyType)this.get_store().insert_element_user(DENYUNCOVEREDHTTPMETHODS$82, i);
         return target;
      }
   }
   ...
   public EmptyType addNewDenyUncoveredHttpMethods() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         EmptyType target = null;
         target = (EmptyType)this.get_store().add_element_user(DENYUNCOVEREDHTTPMETHODS$82);
         return target;
      }
   }
   ...
   public void removeDenyUncoveredHttpMethods(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(DENYUNCOVEREDHTTPMETHODS$82, i);
      }
   }
   ...
   public AbsoluteOrderingType[] getAbsoluteOrderingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(ABSOLUTEORDERING$84, targetList);
   ...
   public AbsoluteOrderingType getAbsoluteOrderingArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (AbsoluteOrderingType)this.get_store().find_element_user(ABSOLUTEORDERING$84, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfAbsoluteOrderingArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(ABSOLUTEORDERING$84);
      }
   }

   public void setAbsoluteOrderingArray(AbsoluteOrderingType[] absoluteOrderingArray) {
      this.check_orphaned();
      this.arraySetterHelper(absoluteOrderingArray, ABSOLUTEORDERING$84);
   }

   public void setAbsoluteOrderingArray(int i, AbsoluteOrderingType absoluteOrdering) {
      this.generatedSetterHelperImpl(absoluteOrdering, ABSOLUTEORDERING$84, i, (short)2);
   }
   ...
   public AbsoluteOrderingType insertNewAbsoluteOrdering(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AbsoluteOrderingType target = null;
         target = (AbsoluteOrderingType)this.get_store().insert_element_user(ABSOLUTEORDERING$84, i);
         return target;
      }
   }
   ...
   public AbsoluteOrderingType addNewAbsoluteOrdering() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AbsoluteOrderingType target = null;
         target = (AbsoluteOrderingType)this.get_store().add_element_user(ABSOLUTEORDERING$84);
         return target;
      }
   }
   ...
   public void removeAbsoluteOrdering(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ABSOLUTEORDERING$84, i);
      }
   }
   ...
   public WebAppVersionType.Enum getVersion() {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(VERSION$86);
   ...
   public WebAppVersionType xgetVersion() {
      synchronized(this.monitor()) {
         ...
         target = (WebAppVersionType)this.get_store().find_attribute_user(VERSION$86);
         return target;
      }
   }
   ...
   public void setVersion(WebAppVersionType.Enum version) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(VERSION$86);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_attribute_user(VERSION$86);
         }
   ...
   public void xsetVersion(WebAppVersionType version) {
      synchronized(this.monitor()) {
         ...
         target = (WebAppVersionType)this.get_store().find_attribute_user(VERSION$86);
         if (target == null) {
            target = (WebAppVersionType)this.get_store().add_attribute_user(VERSION$86);
         }
   ...
   public java.lang.String getId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_attribute_user(ID$88);
   ...
   public XmlID xgetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlID target = null;
         target = (XmlID)this.get_store().find_attribute_user(ID$88);
         return target;
      }
   }
   ...
   public boolean isSetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().find_attribute_user(ID$88) != null;
      }
   }
   ...
   public void setId(java.lang.String id) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(ID$88);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_attribute_user(ID$88);
         }
   ...
   public void xsetId(XmlID id) {
      synchronized(this.monitor()) {
         ...
         target = (XmlID)this.get_store().find_attribute_user(ID$88);
         if (target == null) {
            target = (XmlID)this.get_store().add_attribute_user(ID$88);
         }
   ...
   public void unsetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_attribute(ID$88);
      }
   }
   ...
   public boolean getMetadataComplete() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_attribute_user(METADATACOMPLETE$90);
   ...
   public XmlBoolean xgetMetadataComplete() {
      synchronized(this.monitor()) {
         ...
         target = (XmlBoolean)this.get_store().find_attribute_user(METADATACOMPLETE$90);
         return target;
      }
   }
   ...
   public boolean isSetMetadataComplete() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().find_attribute_user(METADATACOMPLETE$90) != null;
      }
   }
   ...
   public void setMetadataComplete(boolean metadataComplete) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(METADATACOMPLETE$90);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_attribute_user(METADATACOMPLETE$90);
         }
   ...
   public void xsetMetadataComplete(XmlBoolean metadataComplete) {
      synchronized(this.monitor()) {
         ...
         target = (XmlBoolean)this.get_store().find_attribute_user(METADATACOMPLETE$90);
         if (target == null) {
            target = (XmlBoolean)this.get_store().add_attribute_user(METADATACOMPLETE$90);
         }
   ...
   public void unsetMetadataComplete() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_attribute(METADATACOMPLETE$90);
      }
   }
}
