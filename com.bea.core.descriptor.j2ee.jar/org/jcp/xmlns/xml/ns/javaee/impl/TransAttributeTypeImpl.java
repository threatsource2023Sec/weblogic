...
public class TransAttributeTypeImpl extends JavaStringEnumerationHolderEx implements TransAttributeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TransAttributeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TransAttributeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
