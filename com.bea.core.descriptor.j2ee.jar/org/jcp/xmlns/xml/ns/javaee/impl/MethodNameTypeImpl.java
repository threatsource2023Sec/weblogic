...
public class MethodNameTypeImpl extends JavaStringHolderEx implements MethodNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MethodNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MethodNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
