...
public class PersistenceContextSynchronizationTypeImpl extends JavaStringEnumerationHolderEx implements PersistenceContextSynchronizationType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public PersistenceContextSynchronizationTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected PersistenceContextSynchronizationTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
