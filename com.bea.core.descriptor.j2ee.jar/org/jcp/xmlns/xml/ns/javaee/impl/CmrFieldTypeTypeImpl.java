...
public class CmrFieldTypeTypeImpl extends JavaStringEnumerationHolderEx implements CmrFieldTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CmrFieldTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CmrFieldTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
