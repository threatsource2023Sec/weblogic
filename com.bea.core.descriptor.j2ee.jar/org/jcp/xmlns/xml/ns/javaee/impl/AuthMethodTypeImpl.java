...
public class AuthMethodTypeImpl extends JavaStringHolderEx implements AuthMethodType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public AuthMethodTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected AuthMethodTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
