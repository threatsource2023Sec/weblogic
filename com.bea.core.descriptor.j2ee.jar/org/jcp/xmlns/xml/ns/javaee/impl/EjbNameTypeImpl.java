...
public class EjbNameTypeImpl extends JavaStringHolderEx implements EjbNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EjbNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EjbNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
