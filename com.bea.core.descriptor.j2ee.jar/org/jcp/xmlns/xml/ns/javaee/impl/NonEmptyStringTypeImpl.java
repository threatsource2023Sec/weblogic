...
import org.jcp.xmlns.xml.ns.javaee.NonEmptyStringType;

public class NonEmptyStringTypeImpl extends JavaStringHolderEx implements NonEmptyStringType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public NonEmptyStringTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected NonEmptyStringTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
