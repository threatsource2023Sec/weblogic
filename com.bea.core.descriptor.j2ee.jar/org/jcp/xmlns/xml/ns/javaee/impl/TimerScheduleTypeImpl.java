...
public class TimerScheduleTypeImpl extends XmlComplexContentImpl implements TimerScheduleType {
   ...
   private static final QName SECOND$0 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "second");
   private static final QName MINUTE$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "minute");
   private static final QName HOUR$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "hour");
