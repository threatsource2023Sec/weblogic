...
public class MethodIntfTypeImpl extends JavaStringEnumerationHolderEx implements MethodIntfType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MethodIntfTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MethodIntfTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
