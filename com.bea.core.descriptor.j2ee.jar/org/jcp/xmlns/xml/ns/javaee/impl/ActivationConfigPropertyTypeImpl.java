...
public class ActivationConfigPropertyTypeImpl extends XmlComplexContentImpl implements ActivationConfigPropertyType {
   ...
   private static final QName ACTIVATIONCONFIGPROPERTYNAME$0 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "activation-config-property-name");
   private static final QName ACTIVATIONCONFIGPROPERTYVALUE$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "activation-config-property-value");
