...
import org.jcp.xmlns.xml.ns.javaee.ConfigPropertyNameType;
import org.jcp.xmlns.xml.ns.javaee.ConfigPropertyType;
import org.jcp.xmlns.xml.ns.javaee.ConfigPropertyTypeType;
...
public class ConfigPropertyTypeImpl extends XmlComplexContentImpl implements ConfigPropertyType {
   ...
   private static final QName CONFIGPROPERTYNAME$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-name");
   private static final QName CONFIGPROPERTYTYPE$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-type");
   private static final QName CONFIGPROPERTYVALUE$6 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-value");
   private static final QName CONFIGPROPERTYIGNORE$8 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-ignore");
   private static final QName CONFIGPROPERTYSUPPORTSDYNAMICUPDATES$10 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-supports-dynamic-updates");
   private static final QName CONFIGPROPERTYCONFIDENTIAL$12 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property-confidential");
