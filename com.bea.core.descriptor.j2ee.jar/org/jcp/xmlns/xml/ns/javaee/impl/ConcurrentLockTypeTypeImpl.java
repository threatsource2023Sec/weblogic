...
public class ConcurrentLockTypeTypeImpl extends JavaStringEnumerationHolderEx implements ConcurrentLockTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConcurrentLockTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConcurrentLockTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
