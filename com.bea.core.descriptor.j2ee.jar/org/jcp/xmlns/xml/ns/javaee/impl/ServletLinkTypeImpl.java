...
import org.jcp.xmlns.xml.ns.javaee.ServletLinkType;

public class ServletLinkTypeImpl extends JavaStringHolderEx implements ServletLinkType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ServletLinkTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ServletLinkTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
