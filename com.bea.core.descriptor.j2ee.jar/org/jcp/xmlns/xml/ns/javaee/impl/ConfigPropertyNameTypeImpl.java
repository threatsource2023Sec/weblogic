...
public class ConfigPropertyNameTypeImpl extends JavaStringHolderEx implements ConfigPropertyNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConfigPropertyNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConfigPropertyNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
