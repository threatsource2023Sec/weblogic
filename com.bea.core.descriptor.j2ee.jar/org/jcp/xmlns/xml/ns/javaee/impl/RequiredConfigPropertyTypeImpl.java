...
public class RequiredConfigPropertyTypeImpl extends XmlComplexContentImpl implements RequiredConfigPropertyType {
   ...
   public RequiredConfigPropertyTypeImpl(SchemaType sType) {
      super(sType);
   }
