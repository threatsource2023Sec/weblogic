...
public class MultiplicityTypeImpl extends JavaStringEnumerationHolderEx implements MultiplicityType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public MultiplicityTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected MultiplicityTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
