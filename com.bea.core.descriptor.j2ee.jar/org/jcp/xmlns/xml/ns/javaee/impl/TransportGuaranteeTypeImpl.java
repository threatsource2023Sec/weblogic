...
public class TransportGuaranteeTypeImpl extends JavaStringEnumerationHolderEx implements TransportGuaranteeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public TransportGuaranteeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected TransportGuaranteeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
