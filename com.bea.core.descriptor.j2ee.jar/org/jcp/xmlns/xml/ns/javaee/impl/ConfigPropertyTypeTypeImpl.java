...
public class ConfigPropertyTypeTypeImpl extends JavaStringEnumerationHolderEx implements ConfigPropertyTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ConfigPropertyTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ConfigPropertyTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
