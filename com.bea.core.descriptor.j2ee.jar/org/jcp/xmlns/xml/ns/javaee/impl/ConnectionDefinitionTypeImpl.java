...
public class ConnectionDefinitionTypeImpl extends XmlComplexContentImpl implements ConnectionDefinitionType {
   ...
   private static final QName MANAGEDCONNECTIONFACTORYCLASS$0 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "managedconnectionfactory-class");
   private static final QName CONFIGPROPERTY$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "config-property");
   private static final QName CONNECTIONFACTORYINTERFACE$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connectionfactory-interface");
   private static final QName CONNECTIONFACTORYIMPLCLASS$6 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connectionfactory-impl-class");
   private static final QName CONNECTIONINTERFACE$8 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connection-interface");
   private static final QName CONNECTIONIMPLCLASS$10 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connection-impl-class");
