...
public class FullyQualifiedClassTypeImpl extends JavaStringHolderEx implements FullyQualifiedClassType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public FullyQualifiedClassTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected FullyQualifiedClassTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
