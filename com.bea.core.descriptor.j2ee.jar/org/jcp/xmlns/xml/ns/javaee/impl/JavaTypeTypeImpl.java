...
import org.jcp.xmlns.xml.ns.javaee.JavaTypeType;

public class JavaTypeTypeImpl extends JavaStringHolderEx implements JavaTypeType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JavaTypeTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JavaTypeTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
