...
import org.jcp.xmlns.xml.ns.javaee.AsyncMethodType;
import org.jcp.xmlns.xml.ns.javaee.ConcurrencyManagementTypeType;
...
import org.jcp.xmlns.xml.ns.javaee.DependsOnType;
...
import org.jcp.xmlns.xml.ns.javaee.SessionTypeType;
import org.jcp.xmlns.xml.ns.javaee.StatefulTimeoutType;
import org.jcp.xmlns.xml.ns.javaee.TimerType;
import org.jcp.xmlns.xml.ns.javaee.TransactionTypeType;
...
public class SessionBeanTypeImpl extends XmlComplexContentImpl implements SessionBeanType {
   ...
   private static final QName BUSINESSLOCAL$18 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "business-local");
   private static final QName BUSINESSREMOTE$20 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "business-remote");
   private static final QName LOCALBEAN$22 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "local-bean");
   private static final QName SERVICEENDPOINT$24 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "service-endpoint");
   private static final QName EJBCLASS$26 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-class");
   private static final QName SESSIONTYPE$28 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "session-type");
   private static final QName STATEFULTIMEOUT$30 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "stateful-timeout");
   private static final QName TIMEOUTMETHOD$32 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "timeout-method");
   private static final QName TIMER$34 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "timer");
   private static final QName INITONSTARTUP$36 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "init-on-startup");
   private static final QName CONCURRENCYMANAGEMENTTYPE$38 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "concurrency-management-type");
   private static final QName CONCURRENTMETHOD$40 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "concurrent-method");
   private static final QName DEPENDSON$42 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "depends-on");
   private static final QName INITMETHOD$44 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "init-method");
   private static final QName REMOVEMETHOD$46 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "remove-method");
   private static final QName ASYNCMETHOD$48 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "async-method");
   private static final QName TRANSACTIONTYPE$50 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "transaction-type");
   private static final QName AFTERBEGINMETHOD$52 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "after-begin-method");
   private static final QName BEFORECOMPLETIONMETHOD$54 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "before-completion-method");
   private static final QName AFTERCOMPLETIONMETHOD$56 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "after-completion-method");
   private static final QName AROUNDINVOKE$58 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "around-invoke");
   private static final QName AROUNDTIMEOUT$60 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "around-timeout");
   private static final QName ENVENTRY$62 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "env-entry");
   private static final QName EJBREF$64 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-ref");
   private static final QName EJBLOCALREF$66 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-local-ref");
   private static final QName SERVICEREF$68 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "service-ref");
   private static final QName RESOURCEREF$70 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "resource-ref");
   private static final QName RESOURCEENVREF$72 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "resource-env-ref");
   private static final QName MESSAGEDESTINATIONREF$74 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "message-destination-ref");
   private static final QName PERSISTENCECONTEXTREF$76 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "persistence-context-ref");
   private static final QName PERSISTENCEUNITREF$78 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "persistence-unit-ref");
   private static final QName POSTCONSTRUCT$80 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "post-construct");
   private static final QName PREDESTROY$82 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "pre-destroy");
   private static final QName DATASOURCE$84 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "data-source");
   private static final QName JMSCONNECTIONFACTORY$86 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "jms-connection-factory");
   private static final QName JMSDESTINATION$88 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "jms-destination");
   private static final QName MAILSESSION$90 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "mail-session");
   private static final QName CONNECTIONFACTORY$92 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connection-factory");
   private static final QName ADMINISTEREDOBJECT$94 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "administered-object");
   private static final QName POSTACTIVATE$96 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "post-activate");
   private static final QName PREPASSIVATE$98 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "pre-passivate");
   private static final QName SECURITYROLEREF$100 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "security-role-ref");
   private static final QName SECURITYIDENTITY$102 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "security-identity");
   private static final QName PASSIVATIONCAPABLE$104 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "passivation-capable");
   ...
   public JmsConnectionFactoryType[] getJmsConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(JMSCONNECTIONFACTORY$86, targetList);
   ...
   public JmsConnectionFactoryType getJmsConnectionFactoryArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (JmsConnectionFactoryType)this.get_store().find_element_user(JMSCONNECTIONFACTORY$86, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfJmsConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(JMSCONNECTIONFACTORY$86);
      }
   }

   public void setJmsConnectionFactoryArray(JmsConnectionFactoryType[] jmsConnectionFactoryArray) {
      this.check_orphaned();
      this.arraySetterHelper(jmsConnectionFactoryArray, JMSCONNECTIONFACTORY$86);
   }

   public void setJmsConnectionFactoryArray(int i, JmsConnectionFactoryType jmsConnectionFactory) {
      this.generatedSetterHelperImpl(jmsConnectionFactory, JMSCONNECTIONFACTORY$86, i, (short)2);
   }
   ...
   public JmsConnectionFactoryType insertNewJmsConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsConnectionFactoryType target = null;
         target = (JmsConnectionFactoryType)this.get_store().insert_element_user(JMSCONNECTIONFACTORY$86, i);
         return target;
      }
   }
   ...
   public JmsConnectionFactoryType addNewJmsConnectionFactory() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsConnectionFactoryType target = null;
         target = (JmsConnectionFactoryType)this.get_store().add_element_user(JMSCONNECTIONFACTORY$86);
         return target;
      }
   }
   ...
   public void removeJmsConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(JMSCONNECTIONFACTORY$86, i);
      }
   }
   ...
   public JmsDestinationType[] getJmsDestinationArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(JMSDESTINATION$88, targetList);
   ...
   public JmsDestinationType getJmsDestinationArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (JmsDestinationType)this.get_store().find_element_user(JMSDESTINATION$88, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfJmsDestinationArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(JMSDESTINATION$88);
      }
   }

   public void setJmsDestinationArray(JmsDestinationType[] jmsDestinationArray) {
      this.check_orphaned();
      this.arraySetterHelper(jmsDestinationArray, JMSDESTINATION$88);
   }

   public void setJmsDestinationArray(int i, JmsDestinationType jmsDestination) {
      this.generatedSetterHelperImpl(jmsDestination, JMSDESTINATION$88, i, (short)2);
   }
   ...
   public JmsDestinationType insertNewJmsDestination(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsDestinationType target = null;
         target = (JmsDestinationType)this.get_store().insert_element_user(JMSDESTINATION$88, i);
         return target;
      }
   }
   ...
   public JmsDestinationType addNewJmsDestination() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsDestinationType target = null;
         target = (JmsDestinationType)this.get_store().add_element_user(JMSDESTINATION$88);
         return target;
      }
   }
   ...
   public void removeJmsDestination(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(JMSDESTINATION$88, i);
      }
   }
   ...
   public MailSessionType[] getMailSessionArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(MAILSESSION$90, targetList);
   ...
   public MailSessionType getMailSessionArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (MailSessionType)this.get_store().find_element_user(MAILSESSION$90, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfMailSessionArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(MAILSESSION$90);
      }
   }

   public void setMailSessionArray(MailSessionType[] mailSessionArray) {
      this.check_orphaned();
      this.arraySetterHelper(mailSessionArray, MAILSESSION$90);
   }

   public void setMailSessionArray(int i, MailSessionType mailSession) {
      this.generatedSetterHelperImpl(mailSession, MAILSESSION$90, i, (short)2);
   }
   ...
   public MailSessionType insertNewMailSession(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         MailSessionType target = null;
         target = (MailSessionType)this.get_store().insert_element_user(MAILSESSION$90, i);
         return target;
      }
   }
   ...
   public MailSessionType addNewMailSession() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         MailSessionType target = null;
         target = (MailSessionType)this.get_store().add_element_user(MAILSESSION$90);
         return target;
      }
   }
   ...
   public void removeMailSession(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(MAILSESSION$90, i);
      }
   }
   ...
   public ConnectionFactoryResourceType[] getConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(CONNECTIONFACTORY$92, targetList);
   ...
   public ConnectionFactoryResourceType getConnectionFactoryArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (ConnectionFactoryResourceType)this.get_store().find_element_user(CONNECTIONFACTORY$92, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(CONNECTIONFACTORY$92);
      }
   }

   public void setConnectionFactoryArray(ConnectionFactoryResourceType[] connectionFactoryArray) {
      this.check_orphaned();
      this.arraySetterHelper(connectionFactoryArray, CONNECTIONFACTORY$92);
   }

   public void setConnectionFactoryArray(int i, ConnectionFactoryResourceType connectionFactory) {
      this.generatedSetterHelperImpl(connectionFactory, CONNECTIONFACTORY$92, i, (short)2);
   }
   ...
   public ConnectionFactoryResourceType insertNewConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ConnectionFactoryResourceType target = null;
         target = (ConnectionFactoryResourceType)this.get_store().insert_element_user(CONNECTIONFACTORY$92, i);
         return target;
      }
   }
   ...
   public ConnectionFactoryResourceType addNewConnectionFactory() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ConnectionFactoryResourceType target = null;
         target = (ConnectionFactoryResourceType)this.get_store().add_element_user(CONNECTIONFACTORY$92);
         return target;
      }
   }
   ...
   public void removeConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(CONNECTIONFACTORY$92, i);
      }
   }
   ...
   public AdministeredObjectType[] getAdministeredObjectArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(ADMINISTEREDOBJECT$94, targetList);
   ...
   public AdministeredObjectType getAdministeredObjectArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (AdministeredObjectType)this.get_store().find_element_user(ADMINISTEREDOBJECT$94, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfAdministeredObjectArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(ADMINISTEREDOBJECT$94);
      }
   }

   public void setAdministeredObjectArray(AdministeredObjectType[] administeredObjectArray) {
      this.check_orphaned();
      this.arraySetterHelper(administeredObjectArray, ADMINISTEREDOBJECT$94);
   }

   public void setAdministeredObjectArray(int i, AdministeredObjectType administeredObject) {
      this.generatedSetterHelperImpl(administeredObject, ADMINISTEREDOBJECT$94, i, (short)2);
   }
   ...
   public AdministeredObjectType insertNewAdministeredObject(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AdministeredObjectType target = null;
         target = (AdministeredObjectType)this.get_store().insert_element_user(ADMINISTEREDOBJECT$94, i);
         return target;
      }
   }
   ...
   public AdministeredObjectType addNewAdministeredObject() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AdministeredObjectType target = null;
         target = (AdministeredObjectType)this.get_store().add_element_user(ADMINISTEREDOBJECT$94);
         return target;
      }
   }
   ...
   public void removeAdministeredObject(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ADMINISTEREDOBJECT$94, i);
      }
   }
   ...
   public LifecycleCallbackType[] getPostActivateArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(POSTACTIVATE$96, targetList);
         LifecycleCallbackType[] result = new LifecycleCallbackType[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public LifecycleCallbackType getPostActivateArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().find_element_user(POSTACTIVATE$96, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfPostActivateArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(POSTACTIVATE$96);
      }
   }

   public void setPostActivateArray(LifecycleCallbackType[] postActivateArray) {
      this.check_orphaned();
      this.arraySetterHelper(postActivateArray, POSTACTIVATE$96);
   }

   public void setPostActivateArray(int i, LifecycleCallbackType postActivate) {
      this.generatedSetterHelperImpl(postActivate, POSTACTIVATE$96, i, (short)2);
   }
   ...
   public LifecycleCallbackType insertNewPostActivate(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().insert_element_user(POSTACTIVATE$96, i);
         return target;
      }
   }
   ...
   public LifecycleCallbackType addNewPostActivate() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().add_element_user(POSTACTIVATE$96);
         return target;
      }
   }
   ...
   public void removePostActivate(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(POSTACTIVATE$96, i);
      }
   }
   ...
   public LifecycleCallbackType[] getPrePassivateArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(PREPASSIVATE$98, targetList);
         LifecycleCallbackType[] result = new LifecycleCallbackType[targetList.size()];
         targetList.toArray(result);
         return result;
      }
   ...
   public LifecycleCallbackType getPrePassivateArray(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().find_element_user(PREPASSIVATE$98, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfPrePassivateArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(PREPASSIVATE$98);
      }
   }

   public void setPrePassivateArray(LifecycleCallbackType[] prePassivateArray) {
      this.check_orphaned();
      this.arraySetterHelper(prePassivateArray, PREPASSIVATE$98);
   }

   public void setPrePassivateArray(int i, LifecycleCallbackType prePassivate) {
      this.generatedSetterHelperImpl(prePassivate, PREPASSIVATE$98, i, (short)2);
   }
   ...
   public LifecycleCallbackType insertNewPrePassivate(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().insert_element_user(PREPASSIVATE$98, i);
         return target;
      }
   }
   ...
   public LifecycleCallbackType addNewPrePassivate() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         LifecycleCallbackType target = null;
         target = (LifecycleCallbackType)this.get_store().add_element_user(PREPASSIVATE$98);
         return target;
      }
   }
   ...
   public void removePrePassivate(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(PREPASSIVATE$98, i);
      }
   }
   ...
   public SecurityRoleRefType[] getSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(SECURITYROLEREF$100, targetList);
   ...
   public SecurityRoleRefType getSecurityRoleRefArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (SecurityRoleRefType)this.get_store().find_element_user(SECURITYROLEREF$100, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYROLEREF$100);
      }
   }

   public void setSecurityRoleRefArray(SecurityRoleRefType[] securityRoleRefArray) {
      this.check_orphaned();
      this.arraySetterHelper(securityRoleRefArray, SECURITYROLEREF$100);
   }

   public void setSecurityRoleRefArray(int i, SecurityRoleRefType securityRoleRef) {
      this.generatedSetterHelperImpl(securityRoleRef, SECURITYROLEREF$100, i, (short)2);
   }
   ...
   public SecurityRoleRefType insertNewSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().insert_element_user(SECURITYROLEREF$100, i);
         return target;
      }
   }
   ...
   public SecurityRoleRefType addNewSecurityRoleRef() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().add_element_user(SECURITYROLEREF$100);
         return target;
      }
   }
   ...
   public void removeSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYROLEREF$100, i);
      }
   }
   ...
   public SecurityIdentityType getSecurityIdentity() {
      synchronized(this.monitor()) {
         ...
         target = (SecurityIdentityType)this.get_store().find_element_user(SECURITYIDENTITY$102, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYIDENTITY$102) != 0;
      }
   }

   public void setSecurityIdentity(SecurityIdentityType securityIdentity) {
      this.generatedSetterHelperImpl(securityIdentity, SECURITYIDENTITY$102, 0, (short)1);
   }
   ...
   public SecurityIdentityType addNewSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityIdentityType target = null;
         target = (SecurityIdentityType)this.get_store().add_element_user(SECURITYIDENTITY$102);
         return target;
      }
   }
   ...
   public void unsetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYIDENTITY$102, 0);
      }
   }
   ...
   public boolean getPassivationCapable() {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(PASSIVATIONCAPABLE$104, 0);
         return target == null ? false : target.getBooleanValue();
      }
   }

   public XmlBoolean xgetPassivationCapable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean target = null;
         target = (XmlBoolean)this.get_store().find_element_user(PASSIVATIONCAPABLE$104, 0);
         return target;
      }
   }
   ...
   public boolean isSetPassivationCapable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(PASSIVATIONCAPABLE$104) != 0;
      }
   }
   ...
   public void setPassivationCapable(boolean passivationCapable) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_element_user(PASSIVATIONCAPABLE$104, 0);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_element_user(PASSIVATIONCAPABLE$104);
         }

         target.setBooleanValue(passivationCapable);
      }
   }

   public void xsetPassivationCapable(XmlBoolean passivationCapable) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlBoolean target = null;
         target = (XmlBoolean)this.get_store().find_element_user(PASSIVATIONCAPABLE$104, 0);
         if (target == null) {
            target = (XmlBoolean)this.get_store().add_element_user(PASSIVATIONCAPABLE$104);
         }

         target.set(passivationCapable);
      }
   }
   ...
   public void unsetPassivationCapable() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(PASSIVATIONCAPABLE$104, 0);
      }
   }
   ...
   public String getId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SimpleValue target = null;
         target = (SimpleValue)this.get_store().find_attribute_user(ID$106);
   ...
   public XmlID xgetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         XmlID target = null;
         target = (XmlID)this.get_store().find_attribute_user(ID$106);
         return target;
      }
   }
   ...
   public boolean isSetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().find_attribute_user(ID$106) != null;
      }
   }
   ...
   public void setId(String id) {
      synchronized(this.monitor()) {
         ...
         target = (SimpleValue)this.get_store().find_attribute_user(ID$106);
         if (target == null) {
            target = (SimpleValue)this.get_store().add_attribute_user(ID$106);
         }
   ...
   public void xsetId(XmlID id) {
      synchronized(this.monitor()) {
         ...
         target = (XmlID)this.get_store().find_attribute_user(ID$106);
         if (target == null) {
            target = (XmlID)this.get_store().add_attribute_user(ID$106);
         }
   ...
   public void unsetId() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_attribute(ID$106);
      }
   }
}
