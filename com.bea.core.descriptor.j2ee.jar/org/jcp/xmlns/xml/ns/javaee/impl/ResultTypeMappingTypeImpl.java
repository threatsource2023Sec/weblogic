...
public class ResultTypeMappingTypeImpl extends JavaStringEnumerationHolderEx implements ResultTypeMappingType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public ResultTypeMappingTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected ResultTypeMappingTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
