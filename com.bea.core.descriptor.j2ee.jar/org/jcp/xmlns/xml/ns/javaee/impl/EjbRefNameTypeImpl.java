...
public class EjbRefNameTypeImpl extends JavaStringHolderEx implements EjbRefNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public EjbRefNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected EjbRefNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
