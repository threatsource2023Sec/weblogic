...
import org.jcp.xmlns.xml.ns.javaee.CmrFieldType;
import org.jcp.xmlns.xml.ns.javaee.DescriptionType;
import org.jcp.xmlns.xml.ns.javaee.EjbRelationshipRoleType;
import org.jcp.xmlns.xml.ns.javaee.EmptyType;
import org.jcp.xmlns.xml.ns.javaee.MultiplicityType;
import org.jcp.xmlns.xml.ns.javaee.RelationshipRoleSourceType;
...
public class EjbRelationshipRoleTypeImpl extends XmlComplexContentImpl implements EjbRelationshipRoleType {
   ...
   private static final QName EJBRELATIONSHIPROLENAME$2 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-relationship-role-name");
   private static final QName MULTIPLICITY$4 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "multiplicity");
   private static final QName CASCADEDELETE$6 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "cascade-delete");
   private static final QName RELATIONSHIPROLESOURCE$8 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "relationship-role-source");
   private static final QName CMRFIELD$10 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "cmr-field");
