...
public class RelationshipRoleSourceTypeImpl extends XmlComplexContentImpl implements RelationshipRoleSourceType {
   ...
   public RelationshipRoleSourceTypeImpl(SchemaType sType) {
      super(sType);
   }
