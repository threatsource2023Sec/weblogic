...
public class MessageDrivenBeanTypeImpl extends XmlComplexContentImpl implements MessageDrivenBeanType {
   ...
   private static final QName EJBCLASS$10 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-class");
   private static final QName MESSAGINGTYPE$12 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "messaging-type");
   private static final QName TIMEOUTMETHOD$14 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "timeout-method");
   private static final QName TIMER$16 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "timer");
   private static final QName TRANSACTIONTYPE$18 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "transaction-type");
   private static final QName MESSAGEDESTINATIONTYPE$20 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "message-destination-type");
   private static final QName MESSAGEDESTINATIONLINK$22 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "message-destination-link");
   private static final QName ACTIVATIONCONFIG$24 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "activation-config");
   private static final QName AROUNDINVOKE$26 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "around-invoke");
   private static final QName AROUNDTIMEOUT$28 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "around-timeout");
   private static final QName ENVENTRY$30 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "env-entry");
   private static final QName EJBREF$32 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-ref");
   private static final QName EJBLOCALREF$34 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "ejb-local-ref");
   private static final QName SERVICEREF$36 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "service-ref");
   private static final QName RESOURCEREF$38 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "resource-ref");
   private static final QName RESOURCEENVREF$40 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "resource-env-ref");
   private static final QName MESSAGEDESTINATIONREF$42 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "message-destination-ref");
   private static final QName PERSISTENCECONTEXTREF$44 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "persistence-context-ref");
   private static final QName PERSISTENCEUNITREF$46 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "persistence-unit-ref");
   private static final QName POSTCONSTRUCT$48 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "post-construct");
   private static final QName PREDESTROY$50 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "pre-destroy");
   private static final QName DATASOURCE$52 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "data-source");
   private static final QName JMSCONNECTIONFACTORY$54 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "jms-connection-factory");
   private static final QName JMSDESTINATION$56 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "jms-destination");
   private static final QName MAILSESSION$58 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "mail-session");
   private static final QName CONNECTIONFACTORY$60 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "connection-factory");
   private static final QName ADMINISTEREDOBJECT$62 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "administered-object");
   private static final QName SECURITYROLEREF$64 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "security-role-ref");
   private static final QName SECURITYIDENTITY$66 = new QName("http://xmlns.jcp.org/xml/ns/javaee", "security-identity");
   ...
   public JmsConnectionFactoryType[] getJmsConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(JMSCONNECTIONFACTORY$54, targetList);
   ...
   public JmsConnectionFactoryType getJmsConnectionFactoryArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (JmsConnectionFactoryType)this.get_store().find_element_user(JMSCONNECTIONFACTORY$54, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfJmsConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(JMSCONNECTIONFACTORY$54);
      }
   }

   public void setJmsConnectionFactoryArray(JmsConnectionFactoryType[] jmsConnectionFactoryArray) {
      this.check_orphaned();
      this.arraySetterHelper(jmsConnectionFactoryArray, JMSCONNECTIONFACTORY$54);
   }

   public void setJmsConnectionFactoryArray(int i, JmsConnectionFactoryType jmsConnectionFactory) {
      this.generatedSetterHelperImpl(jmsConnectionFactory, JMSCONNECTIONFACTORY$54, i, (short)2);
   }
   ...
   public JmsConnectionFactoryType insertNewJmsConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsConnectionFactoryType target = null;
         target = (JmsConnectionFactoryType)this.get_store().insert_element_user(JMSCONNECTIONFACTORY$54, i);
         return target;
      }
   }
   ...
   public JmsConnectionFactoryType addNewJmsConnectionFactory() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsConnectionFactoryType target = null;
         target = (JmsConnectionFactoryType)this.get_store().add_element_user(JMSCONNECTIONFACTORY$54);
         return target;
      }
   }
   ...
   public void removeJmsConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(JMSCONNECTIONFACTORY$54, i);
      }
   }
   ...
   public JmsDestinationType[] getJmsDestinationArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(JMSDESTINATION$56, targetList);
   ...
   public JmsDestinationType getJmsDestinationArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (JmsDestinationType)this.get_store().find_element_user(JMSDESTINATION$56, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfJmsDestinationArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(JMSDESTINATION$56);
      }
   }

   public void setJmsDestinationArray(JmsDestinationType[] jmsDestinationArray) {
      this.check_orphaned();
      this.arraySetterHelper(jmsDestinationArray, JMSDESTINATION$56);
   }

   public void setJmsDestinationArray(int i, JmsDestinationType jmsDestination) {
      this.generatedSetterHelperImpl(jmsDestination, JMSDESTINATION$56, i, (short)2);
   }
   ...
   public JmsDestinationType insertNewJmsDestination(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsDestinationType target = null;
         target = (JmsDestinationType)this.get_store().insert_element_user(JMSDESTINATION$56, i);
         return target;
      }
   }
   ...
   public JmsDestinationType addNewJmsDestination() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         JmsDestinationType target = null;
         target = (JmsDestinationType)this.get_store().add_element_user(JMSDESTINATION$56);
         return target;
      }
   }
   ...
   public void removeJmsDestination(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(JMSDESTINATION$56, i);
      }
   }
   ...
   public MailSessionType[] getMailSessionArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(MAILSESSION$58, targetList);
   ...
   public MailSessionType getMailSessionArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (MailSessionType)this.get_store().find_element_user(MAILSESSION$58, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfMailSessionArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(MAILSESSION$58);
      }
   }

   public void setMailSessionArray(MailSessionType[] mailSessionArray) {
      this.check_orphaned();
      this.arraySetterHelper(mailSessionArray, MAILSESSION$58);
   }

   public void setMailSessionArray(int i, MailSessionType mailSession) {
      this.generatedSetterHelperImpl(mailSession, MAILSESSION$58, i, (short)2);
   }
   ...
   public MailSessionType insertNewMailSession(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         MailSessionType target = null;
         target = (MailSessionType)this.get_store().insert_element_user(MAILSESSION$58, i);
         return target;
      }
   }
   ...
   public MailSessionType addNewMailSession() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         MailSessionType target = null;
         target = (MailSessionType)this.get_store().add_element_user(MAILSESSION$58);
         return target;
      }
   }
   ...
   public void removeMailSession(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(MAILSESSION$58, i);
      }
   }
   ...
   public ConnectionFactoryResourceType[] getConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(CONNECTIONFACTORY$60, targetList);
   ...
   public ConnectionFactoryResourceType getConnectionFactoryArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (ConnectionFactoryResourceType)this.get_store().find_element_user(CONNECTIONFACTORY$60, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfConnectionFactoryArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(CONNECTIONFACTORY$60);
      }
   }

   public void setConnectionFactoryArray(ConnectionFactoryResourceType[] connectionFactoryArray) {
      this.check_orphaned();
      this.arraySetterHelper(connectionFactoryArray, CONNECTIONFACTORY$60);
   }

   public void setConnectionFactoryArray(int i, ConnectionFactoryResourceType connectionFactory) {
      this.generatedSetterHelperImpl(connectionFactory, CONNECTIONFACTORY$60, i, (short)2);
   }
   ...
   public ConnectionFactoryResourceType insertNewConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ConnectionFactoryResourceType target = null;
         target = (ConnectionFactoryResourceType)this.get_store().insert_element_user(CONNECTIONFACTORY$60, i);
         return target;
      }
   }
   ...
   public ConnectionFactoryResourceType addNewConnectionFactory() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         ConnectionFactoryResourceType target = null;
         target = (ConnectionFactoryResourceType)this.get_store().add_element_user(CONNECTIONFACTORY$60);
         return target;
      }
   }
   ...
   public void removeConnectionFactory(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(CONNECTIONFACTORY$60, i);
      }
   }
   ...
   public AdministeredObjectType[] getAdministeredObjectArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(ADMINISTEREDOBJECT$62, targetList);
   ...
   public AdministeredObjectType getAdministeredObjectArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (AdministeredObjectType)this.get_store().find_element_user(ADMINISTEREDOBJECT$62, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfAdministeredObjectArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(ADMINISTEREDOBJECT$62);
      }
   }

   public void setAdministeredObjectArray(AdministeredObjectType[] administeredObjectArray) {
      this.check_orphaned();
      this.arraySetterHelper(administeredObjectArray, ADMINISTEREDOBJECT$62);
   }

   public void setAdministeredObjectArray(int i, AdministeredObjectType administeredObject) {
      this.generatedSetterHelperImpl(administeredObject, ADMINISTEREDOBJECT$62, i, (short)2);
   }
   ...
   public AdministeredObjectType insertNewAdministeredObject(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AdministeredObjectType target = null;
         target = (AdministeredObjectType)this.get_store().insert_element_user(ADMINISTEREDOBJECT$62, i);
         return target;
      }
   }
   ...
   public AdministeredObjectType addNewAdministeredObject() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         AdministeredObjectType target = null;
         target = (AdministeredObjectType)this.get_store().add_element_user(ADMINISTEREDOBJECT$62);
         return target;
      }
   }
   ...
   public void removeAdministeredObject(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(ADMINISTEREDOBJECT$62, i);
      }
   }
   ...
   public SecurityRoleRefType[] getSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         List targetList = new ArrayList();
         this.get_store().find_all_element_users(SECURITYROLEREF$64, targetList);
   ...
   public SecurityRoleRefType getSecurityRoleRefArray(int i) {
      synchronized(this.monitor()) {
         ...
         target = (SecurityRoleRefType)this.get_store().find_element_user(SECURITYROLEREF$64, i);
         if (target == null) {
            throw new IndexOutOfBoundsException();
         } else {
            return target;
   ...
   public int sizeOfSecurityRoleRefArray() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYROLEREF$64);
      }
   }

   public void setSecurityRoleRefArray(SecurityRoleRefType[] securityRoleRefArray) {
      this.check_orphaned();
      this.arraySetterHelper(securityRoleRefArray, SECURITYROLEREF$64);
   }

   public void setSecurityRoleRefArray(int i, SecurityRoleRefType securityRoleRef) {
      this.generatedSetterHelperImpl(securityRoleRef, SECURITYROLEREF$64, i, (short)2);
   }
   ...
   public SecurityRoleRefType insertNewSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().insert_element_user(SECURITYROLEREF$64, i);
         return target;
      }
   }
   ...
   public SecurityRoleRefType addNewSecurityRoleRef() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityRoleRefType target = null;
         target = (SecurityRoleRefType)this.get_store().add_element_user(SECURITYROLEREF$64);
         return target;
      }
   }
   ...
   public void removeSecurityRoleRef(int i) {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYROLEREF$64, i);
      }
   }
   ...
   public SecurityIdentityType getSecurityIdentity() {
      synchronized(this.monitor()) {
         ...
         target = (SecurityIdentityType)this.get_store().find_element_user(SECURITYIDENTITY$66, 0);
         return target == null ? null : target;
      }
   }
   ...
   public boolean isSetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         return this.get_store().count_elements(SECURITYIDENTITY$66) != 0;
      }
   }

   public void setSecurityIdentity(SecurityIdentityType securityIdentity) {
      this.generatedSetterHelperImpl(securityIdentity, SECURITYIDENTITY$66, 0, (short)1);
   }
   ...
   public SecurityIdentityType addNewSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         SecurityIdentityType target = null;
         target = (SecurityIdentityType)this.get_store().add_element_user(SECURITYIDENTITY$66);
         return target;
      }
   }
   ...
   public void unsetSecurityIdentity() {
      synchronized(this.monitor()) {
         this.check_orphaned();
         this.get_store().remove_element(SECURITYIDENTITY$66, 0);
      }
   }
