...
public class JspFileTypeImpl extends JavaStringHolderEx implements JspFileType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public JspFileTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected JspFileTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
