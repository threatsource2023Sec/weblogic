...
public class CredentialInterfaceTypeImpl extends JavaStringEnumerationHolderEx implements CredentialInterfaceType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public CredentialInterfaceTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected CredentialInterfaceTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
