...
public class RoleNameTypeImpl extends JavaStringHolderEx implements RoleNameType {
   private static final long serialVersionUID = 1L;
   private static final QName ID$0 = new QName("", "id");

   public RoleNameTypeImpl(SchemaType sType) {
      super(sType, true);
   }

   protected RoleNameTypeImpl(SchemaType sType, boolean b) {
      super(sType, b);
   }
