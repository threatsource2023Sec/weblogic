...
public class ExtendedPatternFormatter extends PatternFormatter {
   ...
   private String getMethod(LogEvent event, String format) {
      ...
      String result = StackIntrospector.getCallerMethod(class$org$apache$log$Logger == null ? (class$org$apache$log$Logger = class$("org.apache.log.Logger")) : class$org$apache$log$Logger);
