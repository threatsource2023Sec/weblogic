...
public class IntrospectorTestCase3 extends BaseTestCase {
   ...
   public static Test suite() {
      return new TestSuite(class$org$apache$velocity$test$IntrospectorTestCase3 == null ? (class$org$apache$velocity$test$IntrospectorTestCase3 = class$("org.apache.velocity.test.IntrospectorTestCase3")) : class$org$apache$velocity$test$IntrospectorTestCase3);
   }
   ...
   public void testSimple() throws Exception {
      ...
      Method method = RuntimeSingleton.getIntrospector().getMethod(class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider == null ? (class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider = class$("org.apache.velocity.test.IntrospectorTestCase3$MethodProvider")) : class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider, "lii", listIntInt);
      String result = (String)method.invoke(mp, listIntInt);
      Assert.assertTrue(result.equals("lii"));
      method = RuntimeSingleton.getIntrospector().getMethod(class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider == null ? (class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider = class$("org.apache.velocity.test.IntrospectorTestCase3$MethodProvider")) : class$org$apache$velocity$test$IntrospectorTestCase3$MethodProvider, "ii", intInt);
