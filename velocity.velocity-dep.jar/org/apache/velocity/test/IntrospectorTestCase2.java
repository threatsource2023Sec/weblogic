...
public class IntrospectorTestCase2 extends BaseTestCase {
   ...
   public void runTest() {
      try {
         ...
         Method method = RuntimeSingleton.getIntrospector().getMethod(class$org$apache$velocity$test$IntrospectorTestCase2$Tester == null ? (class$org$apache$velocity$test$IntrospectorTestCase2$Tester = class$("org.apache.velocity.test.IntrospectorTestCase2$Tester")) : class$org$apache$velocity$test$IntrospectorTestCase2$Tester, "find", params);
         if (method == null) {
         ...
         method = RuntimeSingleton.getIntrospector().getMethod(class$org$apache$velocity$test$IntrospectorTestCase2$Tester2 == null ? (class$org$apache$velocity$test$IntrospectorTestCase2$Tester2 = class$("org.apache.velocity.test.IntrospectorTestCase2$Tester2")) : class$org$apache$velocity$test$IntrospectorTestCase2$Tester2, "find", params);
         if (method != null) {
